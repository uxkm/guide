...
const apiSections = [
  {
    title: 'API · Props',
    description:
      'React에서는 camelCase prop을 사용합니다. Vue의 offset-top · offset-bottom은 offsetTop · offsetBottom입니다.',
  ...
  },
  {
    ...
    tables: [{ columns: affixAttrColumns, rows: affixAttrs, codeColumn: 'name' }],
  },
  {
    title: 'API · 마크업 구조',
    tables: [{ columns: affixMarkupColumns, rows: affixMarkup, codeColumn: 'name' }],
  },
  {
    title: '클래스 · 스킨',
    description:
      'OOCSS 구조 클래스와 스킨 클래스입니다. affix_bar-actions 안의 버튼은 Button 컴포넌트로 조합합니다.',
    tables: [{ columns: affixClassColumns, rows: affixClasses, codeColumn: 'name' }],
  },
  {
    title: '디자인 토큰',
    tables: [{ columns: affixTokenColumns, rows: affixTokens, codeColumn: 'name' }],
  },
];

/** Docs·Canvas 동일 — Controls가 잘못된 target의 Affix를 추가하지 않도록 */
function affixDemo(node) {
...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '스크롤 시 지정한 위치에 요소를 고정하는 컴포넌트입니다. 툴바·앵커 내비게이션·액션 버튼 등에 사용하며, target으로 스크롤 컨테이너를 지정할 수 있습니다.',
      },
    },
    apiSections,
  },
...
export const Offset = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          '`offsetTop`으로 뷰포트(또는 컨테이너) 상단과의 간격을 지정합니다. 고정 헤더 아래에 붙일 때 사용합니다.',
      },
      source: {
        language: 'tsx',
        code: `import Affix from '@uxkm/ui-react/components/Affix.jsx';
...
export const Bottom = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          '`offsetBottom`을 지정하면 요소가 컨테이너 하단에 고정됩니다. 모바일 하단 액션 바에 활용합니다.',
      },
      source: {
        language: 'tsx',
        code: `import Affix from '@uxkm/ui-react/components/Affix.jsx';
...
export const Window = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          '`target`을 생략하면 window 스크롤을 기준으로 동작합니다. Docs에서는 미리보기 안에서 확인할 수 있도록 페이지형 스크롤 영역으로 시연합니다.',
      },
      source: {
        language: 'tsx',
        code: `import Affix from '@uxkm/ui-react/components/Affix.jsx';
