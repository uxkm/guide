...
export default function Flex({
  ...
  const rootClass = useMemo(() => {
    ...
    if (resolvedGap) classes.push(`flex_gap-${resolvedGap}`);
    ...
    return classes;
  }, [resolvedDirection, resolvedDirectionMd, resolvedDirectionLg, wrap, cols, colsMd, colsLg, ratio, itemSpan, itemSpanMd, itemSpanLg, resolvedGap, resolvedAlign, resolvedJustify, equal, autoFit]);

  return (
    <div ref={rootRef} className={cn(rootClass, className)} {...normalizeDomProps(rest)}>
      {children}
    </div>
  );
}
