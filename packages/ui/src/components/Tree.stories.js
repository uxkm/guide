...
const apiSections = [
  {
    ...
    tables: [
      { columns: treePropColumns, rows: treeProps, codeColumn: "name" },
    ],
  },
  {
    title: "API · TreeNode Props",
    tables: [
      { columns: treeNodePropColumns, rows: treeNodeProps, codeColumn: "name" },
    ],
  },
  {
    title: "API · Tree Slots",
    tables: [
      { columns: treeSlotColumns, rows: treeSlots, codeColumn: "name" },
    ],
  },
  {
    title: "API · TreeNode Slots",
    tables: [
      { columns: treeSlotColumns, rows: treeNodeSlots, codeColumn: "name" },
    ],
  },
  {
    title: "클래스 · 속성",
    ...
    tables: [
      { columns: treeClassColumns, rows: treeClasses, codeColumn: "name" },
    ],
  },
  {
    title: "디자인 토큰",
    tables: [
      { columns: treeTokenColumns, rows: treeTokens, codeColumn: "name" },
    ],
  },
];
