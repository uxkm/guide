...
const apiSections = [
  {
    title: "API · Props",
    tables: [
      { columns: switchPropColumns, rows: switchProps, codeColumn: "name" },
    ],
  },
  {
    title: "API · Slots",
    tables: [
      { columns: switchSlotColumns, rows: switchSlots, codeColumn: "name" },
    ],
  },
  {
    title: "클래스 · 속성",
    ...
    tables: [
      { columns: switchClassColumns, rows: switchClasses, codeColumn: "name" },
    ],
  },
  {
    title: "디자인 토큰",
    tables: [
      { columns: switchTokenColumns, rows: switchTokens, codeColumn: "name" },
    ],
  },
];
