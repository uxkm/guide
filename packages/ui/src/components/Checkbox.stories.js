...
const apiSections = [
  {
    title: "API · Props",
    tables: [
      { columns: checkboxPropColumns, rows: checkboxProps, codeColumn: "name" },
    ],
  },
  {
    title: "API · Slots",
    tables: [
      { columns: checkboxSlotColumns, rows: checkboxSlots, codeColumn: "name" },
    ],
  },
  {
    title: "클래스 · 속성",
    ...
    tables: [
      { columns: checkboxClassColumns, rows: checkboxClasses, codeColumn: "name" },
    ],
  },
  {
    title: "디자인 토큰",
    tables: [
      { columns: checkboxTokenColumns, rows: checkboxTokens, codeColumn: "name" },
    ],
  },
];
...
export const Form = {
  ...
  render: withDocsCanvasRender(() => ({
    components: { Checkbox, FormLayout },
