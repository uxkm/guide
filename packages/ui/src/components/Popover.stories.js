...
export const Basic = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Popover와 #trigger 슬롯으로 트리거와 패널을 구성합니다. panel-label을 지정하면 popover_header에 제목이 표시되고, 클릭 시 패널이 열립니다. 바깥 클릭 · popover_close · Esc로 닫을 수 있습니다.",
      },
      source: {
        code: `<script setup>
...
export const NoLabel = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "panel-label을 생략하면 popover_header 없이 popover_body만 표시됩니다. popover_close-floating이 패널 우측 상단에 배치되고, 본문은 상단부터 시작합니다.",
      },
      source: {
        code: `<script setup>
import Button from "@uxkm/ui/components/Button.vue";
...
<template>
 ...
 <Popover size="sm" panel-label="작은 Popover">
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="Small" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>작은 패널입니다. 짧은 안내에 적합합니다.</p>
 </Popover>
 <Popover panel-label="기본 Popover">
 <template #trigger>
 <Button class="popover_trigger" variant="outline" label="Medium" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>기본 크기 패널입니다.</p>
 </Popover>
 <Popover size="lg" panel-label="큰 Popover">
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="lg" label="Large" aria-haspopup="dialog" aria-expanded="false" />
 </template>
...
export const Offset = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "offset prop(none · sm · md · lg)으로 전 방향 간격을, offset-top · offset-right · offset-bottom · offset-left로 방향별 간격을 조절합니다.",
      },
      source: {
        code: `<script setup>
import Button from "@uxkm/ui/components/Button.vue";
...
<template>
 ...
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="none" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>간격 없음</p>
 </Popover>
 <Popover offset="sm" panel-label="sm">
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="sm" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>좁은 간격</p>
 </Popover>
 <Popover panel-label="md">
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="md" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>기본 간격</p>
 </Popover>
 <Popover offset="lg" panel-label="lg">
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="lg" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>넓은 간격</p>
 </Popover>
 </div>
 ...
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="위" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>위쪽 간격</p>
 </Popover>
 </div>
 ...
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="왼쪽" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>왼쪽 간격</p>
 </Popover>
 </div>
 ...
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="아래" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>아래쪽 간격</p>
 </Popover>
 </div>
 ...
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="오른쪽" aria-haspopup="dialog" aria-expanded="false" />
 </template>
 <p>오른쪽 간격</p>
 </Popover>
 </div>
...
export const Footer = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "`#footer` 슬롯·popover_footer에 확인·취소 등 액션 버튼을 배치합니다. data-popover-close로 닫을 수 있습니다.",
      },
      source: {
        code: `<script setup>
import Button from "@uxkm/ui/components/Button.vue";
...
export const ArrowAnchor = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "arrow-anchor(content · target · mixed)와 panel-align, arrow-target-align으로 패널·화살표를 독립 조합합니다.",
      },
      source: {
        code: `<script setup>
import Button from "@uxkm/ui/components/Button.vue";
...
<template>
 ...
 <template #trigger>
 <Button class="popover_trigger" variant="outline" size="sm" label="S" aria-haspopup="dialog" aria-expanded="false" />
 </template>
...
export const NoArrow = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "no-arrow prop으로 popover_arrow를 숨깁니다. popover_no-arrow 클래스와 대응됩니다.",
      },
      source: {
        code: `<script setup>
import Button from "@uxkm/ui/components/Button.vue";
