...
const rootClasses = computed(() =>
  [
    'modal',
    props.size !== 'md' && `modal_${props.size}`,
    props.scrollable && 'modal_scrollable',
...
const footerClasses = computed(() =>
  [
    'modal_footer',
    props.footerAlign !== 'end' && `modal_footer-${props.footerAlign}`,
    props.footerAlign === 'even' &&
      props.footerRatio !== '1-1' &&
      `modal_footer-even-${props.footerRatio}`,
    props.footerNoPadBottom && 'modal_footer-no-pad-b',
  ].filter(Boolean),
);
