...
const props = defineProps({
  ...
  round: Boolean,
  ariaLabel: { type: String, default: '페이지 이동' },
});
...
const classes = computed(() =>
  [
    'pagination',
    props.simple && 'pagination_simple',
    props.minimal && 'pagination_minimal',
    resolvedSize.value !== 'md' && `pagination_${resolvedSize.value}`,
    props.round && 'pagination_round',
  ].filter(Boolean),
);
