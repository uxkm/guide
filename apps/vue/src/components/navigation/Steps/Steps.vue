...
const classes = computed(() =>
  [
    'steps',
    direction.value === 'vertical' && 'steps_vertical',
    size.value !== 'md' && `steps_${size.value}`,
    props.dot && 'steps_dot',
    props.iconStyle && 'steps_icon-style',
    props.navigable && 'steps_navigable',
    props.align === 'center' && 'steps_align-center',
  ].filter(Boolean),
);
