...
const props = defineProps({
  ...
  vertical: Boolean, dashed: Boolean, plain: Boolean,
  orient: { type: String, default: undefined }, orientation: { type: String, default: '' }, label: String
});
...
const classes = computed(() => [
  'divider', props.vertical && 'divider_vertical', props.dashed && 'divider_dashed',
  props.plain && 'divider_plain', orientations.has(resolvedOrient.value) && resolvedOrient.value && `divider_orient-${resolvedOrient.value}`,
  attrs.class
].filter(Boolean));
</script>
