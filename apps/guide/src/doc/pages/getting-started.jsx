    ...
    <>
      <PageIntro title="설치 및 사용" lead={(
        ...
        <GuideSection
          ...
          title="프로덕션 빌드"
          description="pnpm build 결과물은 apps/guide/dist/ 폴더에 생성됩니다. 정적 호스팅에 해당 내용을 배포하면 됩니다."
        >
          <GuideCodeBlock>pnpm build</GuideCodeBlock>
        </GuideSection>

        <GuideSection headingId="styles-heading" title="스타일 적용">
          <p><strong>이 가이드</strong>는 Vite 빌드 시 <TypoText variant="code" tag="span" label="@uxkm/ui/scss/main.scss" />가 자동으로 번들됩니다.</p>
          <p>
        ...
        <GuideSection
          ...
          title="React 사용 예시"
          description="가이드와 동일하게 @uxkm/ui-react 컴포넌트를 import해 사용합니다."
        >
