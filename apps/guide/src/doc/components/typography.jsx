...
import TypoText from '@uxkm/ui-react/components/TypoText.jsx';
    ...
    <>
      <div className="page_intro">
        ...
        <DemoSection
          ...
          title="제목"
          description="typo_title-1 ~ typo_title-5 클래스로 5단계 제목 스케일을 적용합니다. 시맨틱 heading 태그와 함께 사용합니다."
          stack
          code={titleCode}
        >
          <div className="typo_stack-lg">
        ...
        <DemoSection
          ...
          title="본문"
          description="기본 본문은 별도 클래스 없이 p 태그를 사용합니다. 단락 간격이 필요하면 typo_paragraph를 사용합니다."
          stack
          code={textCode}
        >
          <p>
        ...
        <DemoSection
          ...
          title="색상 타입"
          description="color_muted, color_success 등 공통 색상 클래스를 적용합니다. 버튼·배지·알림 등 모든 컴포넌트에서 동일한 클래스명을 사용합니다."
          stack
          code={colorCode}
        >
          <TypoText color="default" label="기본 텍스트 (Default)" />
        ...
        <DemoSection
          ...
          title="크기"
          description="base(0.875rem)는 클래스 없이 기본 적용됩니다. xs, sm, lg, xl만 size_* 클래스를 사용합니다."
          stack
          code={sizeCode}
        >
          <TypoText size="xs" label="Extra Small — 0.75rem" />
        ...
        <DemoSection
          headingId="sub-sup-small-heading"
          title="아래첨자 · 위첨자 · 소문자"
          description="sub · sup · small 시맨틱 태그에 typo_sub · typo_sup · typo_small 클래스를 적용합니다."
          stack
          code={subSupSmallCode}
        >
          <p>
        ...
        <DemoSection
          headingId="blockquote-heading"
          title="인용"
          description="blockquote 태그에 typo_blockquote 클래스를 적용합니다."
          stack
          code={blockquoteCode}
        >
          <TypoText
        ...
        <DemoSection
          ...
          title="목록"
          description="본문 prose 목록은 ul · ol에 typo_list · typo_list-ordered 클래스를 적용합니다. UI 리스트(아바타, 인터랙티브 항목 등)는 List 컴포넌트를 사용하세요."
          stack
          code={listCode}
        >
          <ul className="typo_list">
        ...
        <DemoSection
          headingId="lead-heading"
          title="리드 · 캡션 · 레이블"
          description="typo_lead · typo_caption · typo_label · typo_overline로 보조 텍스트 위계를 표현합니다."
          stack
          code={leadCode}
        >
          <div style={{ maxWidth: '32rem', width: '100%' }}>
        ...
        <DemoSection
          headingId="title-color-heading"
          title="제목 색상"
          description="제목에도 공통 color_* 클래스를 조합할 수 있습니다."
          stack
          code={titleColorCode}
        >
          <TypoTitle level={3} color="primary" label="Primary 제목" />
        ...
        <DemoSection
          headingId="kbd-heading"
          title="키보드 · 코드 블록"
          description="typo_kbd · typo_pre · typo_code로 단축키와 코드를 표시합니다."
          stack
          code={kbdCode}
        >
          <p>
        ...
        <DemoSection
          headingId="nested-list-heading"
          title="중첩 목록"
          description="typo_list · typo_list-ordered에 하위 ul · ol을 중첩할 수 있습니다."
          stack
          code={nestedListCode}
        >
          <ul className="typo_list">
        ...
        <DemoSection
          ...
          title="제목 + 본문 조합"
          description="typo_stack, typo_stack-lg로 제목과 본문을 묶어 간격을 맞춥니다."
          stack
          code={stackCode}
        >
          <div className="typo_stack-lg" style={{ maxWidth: '28rem' }}>
        ...
        <ApiSection headingId="api-title-props-heading" title="API · TypoTitle Props">
          <ApiTable columns={typoTitlePropColumns} rows={typoTitleProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-text-props-heading" title="API · TypoText Props">
          <ApiTable columns={typoTextPropColumns} rows={typoTextProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-title-children-heading" title="API · TypoTitle Children">
          <ApiTable columns={typoTitleSlotColumns} rows={typoTitleSlots} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-text-children-heading" title="API · TypoText Children">
          <ApiTable columns={typoTextSlotColumns} rows={typoTextSlots} codeColumn="name" />
        </ApiSection>
        ...
        >
          <ApiTable columns={typographyClassColumns} rows={typographyClasses} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="tokens-heading" title="디자인 토큰">
          <ApiTable columns={typographyTokenColumns} rows={typographyTokens} codeColumn="name" />
        </ApiSection>
    </>
  );
}
