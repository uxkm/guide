...
import Affix from '@uxkm/ui-react/components/Affix.jsx';
...
const basicCode = `import Affix from '@uxkm/ui-react/components/Affix.jsx';
import Button from '@uxkm/ui-react/components/Button.jsx';
...
const offsetCode = `import Affix from '@uxkm/ui-react/components/Affix.jsx';
import Button from '@uxkm/ui-react/components/Button.jsx';
...
export function OffsetExample() {
  return (
    <Affix target="#affix-scroll-offset" offsetTop={12} skin="bar">
      ...
      <span className="affix_bar-label">서식</span>
    </Affix>
  );
}`;

const anchorCode = `import Affix from '@uxkm/ui-react/components/Affix.jsx';
...
const bottomCode = `import Affix from '@uxkm/ui-react/components/Affix.jsx';
import Button from '@uxkm/ui-react/components/Button.jsx';
...
const windowCode = `import Affix from '@uxkm/ui-react/components/Affix.jsx';
import Button from '@uxkm/ui-react/components/Button.jsx';
  ...
  return (
    <>
      ...
      <DemoSection
        ...
        title="상단 오프셋"
        description="offsetTop으로 뷰포트(또는 컨테이너) 상단과의 간격을 지정합니다. 고정 헤더 아래에 붙일 때 사용합니다."
        code={offsetCode}
      >
        <div className="affix_demo-narrow">
          <div id="affix-scroll-offset" className="affix_demo-scroll">
            <div className="affix_demo-content">
              ...
              <Affix target="#affix-scroll-offset" offsetTop={12} skin="bar">
                <Button variant="ghost" size="sm" iconOnly ariaLabel="굵게" iconBefore={BoldIcon} />
                <Button variant="ghost" size="sm" iconOnly ariaLabel="기울임" iconBefore={ItalicIcon} />
                <Button variant="ghost" size="sm" iconOnly ariaLabel="밑줄" iconBefore={UnderlineIcon} />
                <span
      ...
      <DemoSection
        ...
        title="하단 고정"
        description="offsetBottom을 지정하면 요소가 컨테이너 하단에 고정됩니다. 모바일 하단 액션 바에 활용합니다."
        code={bottomCode}
      >
        <div className="affix_demo-narrow">
      ...
      <DemoSection
        ...
        title="페이지 스크롤"
        description="target을 생략하면 window 스크롤을 기준으로 동작합니다. 이 섹션 아래로 페이지를 스크롤하면 배너가 상단에 고정됩니다."
        code={windowCode}
      >
        <div className="affix_demo-narrow">
          <p
      ...
      <ApiSection headingId="api-props-heading" title="API · Props">
        <ApiTable columns={affixPropColumns} rows={affixProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-children-heading" title="API · Children">
        <ApiTable columns={affixChildColumns} rows={affixChildren} codeColumn="name" />
      </ApiSection>
      ...
      <ApiSection headingId="api-attrs-heading" title="API · Data Attributes">
        ...
        <p className="form_field-hint" style={{ marginTop: 'var(--space-md)' }}>
          Affix는 HTML 마크업 + JS 초기화 방식입니다. React 앱에서는 문서 로드 시{' '}
      ...
      <ApiSection headingId="tokens-heading" title="디자인 토큰">
        <ApiTable columns={affixTokenColumns} rows={affixTokens} codeColumn="name" />
      </ApiSection>
    </>
  );
}
