  ...
  return (
    <>
      <div className="page_intro">
        <h1>Popover</h1>
        <p className="lead">
          클릭·호버로 트리거 옆에 떠 있는 정보 패널 컴포넌트입니다. 짧은 설명·확인·간단한 폼 등
          Dropdown보다 풍부한 콘텐츠를 표시할 때 사용하며, 
          <code className="typo_code">aria-haspopup=&quot;dialog&quot;</code> · 
          <code className="typo_code">role=&quot;dialog&quot;</code>로 접근성을 보장합니다.
        </p>
      </div>
...
<Popover
    ...
    >
      ...
      <section className="section" aria-labelledby="usage-heading">
        ...
        <p>
          <code className="typo_code">Popover</code> 컴포넌트로 트리거·패널·접근성 속성을 조합합니다.
          <code className="typo_code">trigger</code> · <code className="typo_code">placement</code> · 
          <code className="typo_code">title</code> prop과 <code className="typo_code">triggerContent</code> · 
          <code className="typo_code">footer</code> prop으로 데모와 동일하게 구성할 수 있습니다.
        </p>
      ...
      <ApiSection headingId="api-children-heading" title="API · Children">
        <ApiTable columns={popoverChildColumns} rows={popoverChildren} codeColumn="name" />
      </ApiSection>
