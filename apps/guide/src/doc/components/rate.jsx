...
const typeCode = `import Rate from '@uxkm/ui-react/components/Rate.jsx';
...
const basicCode = `import Rate from '@uxkm/ui-react/components/Rate.jsx';

export function BasicExample() {
  return <Rate legend="배송 속도" value={3} name="rate-basic" />;
}`;
const sizeCode = `import Rate from '@uxkm/ui-react/components/Rate.jsx';
...
const colorCode = `import Rate from '@uxkm/ui-react/components/Rate.jsx';
...
const halfCode = `import Rate from '@uxkm/ui-react/components/Rate.jsx';
...
const clearCode = `import Rate from '@uxkm/ui-react/components/Rate.jsx';

export function ClearExample() {
  return <Rate clearable legend="만족도 — rate_clearable" value={4} name="rate-clear" />;
}`;
const readonlyCode = `import Rate from '@uxkm/ui-react/components/Rate.jsx';
...
const stateCode = `import Rate from '@uxkm/ui-react/components/Rate.jsx';
