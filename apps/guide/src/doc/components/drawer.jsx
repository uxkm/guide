...
const menuCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Drawer from '@uxkm/ui-react/components/Drawer.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const openOnLoadCode = `import Drawer from '@uxkm/ui-react/components/Drawer.jsx';
...
const dragSheetCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Drawer from '@uxkm/ui-react/components/Drawer.jsx';
  ...
  return (
    <>
      <div className="page_intro">
        <h1>Drawer</h1>
        <p className="lead">
          화면 가장자리에서 슬라이드되어 나타나는 패널 컴포넌트입니다. 상세 보기·폼·모바일 메뉴·필터·설정
          등 보조 UI에 사용하며, 기본 위치는 오른쪽(<code className="typo_code">drawer_placement-right</code>)입니다.
          방향별 슬라이드·백드롭 페이드 애니메이션과 <code className="typo_code">role=&quot;dialog&quot;</code> · <code className="typo_code">aria-modal</code> 접근성을 제공합니다.
        </p>
      </div>
...
<>
      ...
      <section className="section" aria-labelledby="usage-heading">
        ...
        <p>
          트리거 버튼과 Drawer 루트를 <code className="typo_code">id</code> · <code className="typo_code">aria-controls</code>로
      ...
      <ApiSection headingId="api-children-heading" title="API · Children">
        <ApiTable columns={drawerChildColumns} rows={drawerChildren} codeColumn="name" />
      </ApiSection>
