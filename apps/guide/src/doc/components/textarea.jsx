...
const basicCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
const standaloneCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
const sizeCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
const widthCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
const rowsCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
const resizeCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
const requiredCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
const countCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
const stateCode = `import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
<div className="form_field">
      ...
      <p className="form_field-hint">500자 이내로 작성해 주세요.</p>
        ...
        <DemoSection
          ...
          title="단독 사용"
          description="form_field 없이 textarea만 사용할 수 있습니다. 메모·댓글 입력 등 간단한 다중 입력에 적합합니다."
          stack
          code={standaloneCode}
        >
<>
...
<FormLayout layout="vertical" compact noValidate aria-labelledby="example-heading">
      ...
      <ApiSection headingId="api-children-heading" title="API · Children">
        <ApiTable columns={textareaChildColumns} rows={textareaChildren} codeColumn="name" />
      </ApiSection>
      ...
      <ApiSection headingId="tokens-heading" title="디자인 토큰">
        <ApiTable columns={textareaTokenColumns} rows={textareaTokens} codeColumn="name" />
      </ApiSection>
    </>
  );
}
