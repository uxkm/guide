...
const basicCode = `import Stat from '@uxkm/ui-react/components/Stat.jsx';
...
const prefixCode = `import Stat from '@uxkm/ui-react/components/Stat.jsx';
...
const trendCode = `import Stat from '@uxkm/ui-react/components/Stat.jsx';
...
const sizeCode = `import Stat from '@uxkm/ui-react/components/Stat.jsx';
...
const layoutCode = `import Stat from '@uxkm/ui-react/components/Stat.jsx';
...
const iconCode = `import Stat from '@uxkm/ui-react/components/Stat.jsx';
...
const skinCode = `import Stat from '@uxkm/ui-react/components/Stat.jsx';
...
const groupCode = `import Stat from '@uxkm/ui-react/components/Stat.jsx';
...
const contextCode = `import Card from '@uxkm/ui-react/components/Card.jsx';
import CardBody from '@uxkm/ui-react/components/CardBody.jsx';
import CardFooter from '@uxkm/ui-react/components/CardFooter.jsx';
import CardHeader from '@uxkm/ui-react/components/CardHeader.jsx';
import Stat from '@uxkm/ui-react/components/Stat.jsx';
  ...
  return (
    <>
      <div className="page_intro">
          <h1>Stat</h1>
          <p className="lead">핵심 수치와 지표를 강조하여 표시하는 통계 컴포넌트입니다. 대시보드·요약 카드·KPI 영역에 사용합니다.</p>
        </div>

        <DemoSection
          headingId="basic-heading"
          title="기본"
          description="title · value · description으로 지표를 구성합니다."
          code={basicCode}
        >
          <Stat
            title="총 사용자"
        ...
        <DemoSection
          ...
          title="접두 · 접미"
          description="prefix · suffix로 통화·단위를 표시합니다."
          code={prefixCode}
        >
          <Stat title="총 매출" prefix="₩" value="4,280,000" description="+8.2%" trendColor="success" />
        ...
        <DemoSection
          ...
          title="추세"
          description="trend로 증감 방향을 아이콘과 함께 표시합니다."
          code={trendCode}
        >
          <Stat
            title="월간 매출"
        ...
        <DemoSection
          ...
          title="크기"
          description="size로 수치 스케일을 조절합니다."
          code={sizeCode}
        >
          <Stat size="sm" card title="Small" value="1,024" />
          <Stat card title="Medium" value="8,192" />
        ...
        <DemoSection
          ...
          title="레이아웃"
          description="stat_horizontal · stat_inline · stat_row로 배치를 변경합니다."
          stack
          code={layoutCode}
        >
          <Stat className="stat_horizontal" card title="활성 세션" value="342" />
        ...
        <DemoSection
          ...
          title="아이콘"
          description="stat_icon · stat_icon-wrap으로 지표에 시각적 단서를 추가합니다."
          code={iconCode}
        >
          <Stat card>
            <span className="stat_icon color_primary">
        ...
        <DemoSection
          ...
          title="스킨"
          description="card · shadow · stat_borderless · stat_accent로 외형을 조절합니다."
          code={skinCode}
        >
          <div className="stat_group stat_group-2">
            <Stat card title="기본 카드" value="1,200" />
        ...
        <DemoSection
          ...
          title="그룹"
          description="stat_group으로 여러 지표를 그리드로 배치합니다."
          stack
          code={groupCode}
        >
          <div className="stat_group">
          ...
          <div className="stat_group stat_group-4 stat_group-divider stat_card stat_shadow" style={{ padding: 'var(--space-lg)' }}>
            <Stat title="방문" value="24.5K" />
            <Stat title="페이지뷰" value="89.2K" />
            <Stat title="전환" value="1,842" />
            <Stat title="매출" value="₩12M" />
        ...
        <DemoSection
          ...
          title="카드 혼합"
          description="card 본문 안에 stat_group을 배치하는 대시보드 패턴입니다."
          code={contextCode}
        >
          <Card variant="shadow">
            <CardHeader title="이번 달 요약" subtitle="2024년 6월" />
            ...
            <CardFooter between>
              <span className="color_muted size_sm">실시간 갱신</span>
              <a href="#" className="link color_primary size_sm" onClick={(e) => e.preventDefault()}>상세 보기</a>
            </CardFooter>
          </Card>
        </DemoSection>

        <ApiSection headingId="api-props-heading" title="API · Props">
          <ApiTable columns={statPropColumns} rows={statProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-children-heading" title="API · Children">
          <ApiTable columns={statSlotColumns} rows={statSlots} codeColumn="name" />
        </ApiSection>
        ...
        >
          <ApiTable columns={statClassColumns} rows={statClasses} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="tokens-heading" title="디자인 토큰">
          <ApiTable columns={statTokenColumns} rows={statTokens} codeColumn="name" />
        </ApiSection>
    </>
  );
}
