...
const typeSelectCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
...
const typeTextCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const typeIconTextCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const typeIconTextVerticalCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const typeIconTextVerticalEqualCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const typeTextIconCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const typeIconOnlyCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const typeIconOnlySizeCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const variantCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
...
const shapeRoundCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const widthCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const stateCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
...
const groupCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
...
const tagCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
    ...
    <>
      <div className="page_intro">
        ...
        <DemoSection
          ...
          title="기본 유형"
          description="btn_filled · btn_outline · btn_ghost · btn_text 네 가지 기본 스킨을 제공합니다."
          stack
          code={basicCode}
        >
          <div className="btn_row btn_row-wrap">
        ...
        <DemoSection
          headingId="type-select-heading"
          title="셀렉트 박스형"
          description="btn_select 클래스로 셀렉트 박스처럼 표시합니다. btn_select-text는 배경·테두리 없는 텍스트 형태입니다. 드롭다운·팝오버 트리거로 사용하며 aria-haspopup과 aria-expanded를 지정합니다."
          stack
          code={typeSelectCode}
        >
          <div className="btn_row btn_row-wrap">
        ...
        <DemoSection
          headingId="type-text-heading"
          title="텍스트 버튼"
          description="btn_text 계열 스킨으로 배경·테두리 없이 표시합니다. primary, muted, danger 등 색상 변형과 아이콘·크기·상태 조합을 지원합니다."
          stack
          code={typeTextCode}
        >
          <div className="btn_row btn_row-wrap">
          ...
          <div className="btn_row btn_row-wrap">
            <Button variant="text" color="danger" label="삭제" iconBefore={(
              <>
              <Icon name="trash" />
              </>
            )} />
            <Button variant="text" color="success" label="완료" iconBefore={(
              <>
              <Icon name="check-circle" />
              </>
            )} />
            <Button variant="text" color="warning" label="주의" iconAfter={(
              <>
              <Icon name="alert-triangle" />
              </>
            )} />
            <Button variant="text" color="muted" label="자세히" iconAfter={(
              <>
          ...
          <div className="btn_row btn_row-wrap">
            <Button variant="text" color="primary" label="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
            <Button variant="text" color="primary" label="다운로드" iconBefore={(
              <>
              <Icon name="download" />
              </>
            )} />
            <Button variant="text" color="primary" label="링크 열기" iconBefore={(
              <>
              <Icon name="external-link" />
              </>
            )} />
            <Button variant="text" color="primary" label="설정" iconBefore={(
              <>
              <Icon name="settings" />
              </>
            )} />
          ...
          <div className="btn_row btn_row-wrap">
            <Button variant="text" color="primary" label="다음" iconAfter={(
              <>
              <Icon name="chevron-right" />
              </>
            )} />
            <Button variant="text" color="primary" label="전체 보기" iconAfter={(
              <>
              <Icon name="chevron-right" />
              </>
            )} />
            <Button variant="text" color="primary" label="삭제" iconAfter={(
              <>
              <Icon name="trash" />
              </>
            )} />
            <Button variant="text" color="primary" label="새로고침" iconAfter={(
              <>
              <Icon name="refresh" />
              </>
            )} />
          ...
          <div className="btn_row btn_row-wrap">
            ...
            <Button variant="text" color="primary" label="Medium" />
            <Button variant="text" color="primary" size="lg" label="Large" />
            <Button variant="text" color="primary" size="sm" label="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
            <Button variant="text" color="primary" size="lg" label="다음" iconAfter={(
              <>
              <Icon name="chevron-right" />
              </>
            )} />
          ...
          <div className="btn_row btn_row-wrap">
            <Button variant="text" color="primary" iconOnly ariaLabel="검색" iconBefore={(
              <>
              <Icon name="search" />
              </>
            )} />
            <Button variant="text" color="primary" iconOnly ariaLabel="편집" iconBefore={(
              <>
              <Icon name="edit" />
              </>
            )} />
            <Button variant="text" color="primary" iconOnly size="sm" ariaLabel="닫기" iconBefore={(
              <>
              <Icon name="close" />
              </>
            )} />
            <Button variant="text" color="primary" disabled label="비활성" />
            <Button variant="text" color="primary" disabled label="비활성" iconAfter={(
              <>
              <Icon name="chevron-right" />
              </>
            )} />
        ...
        <DemoSection
          headingId="type-icon-text-heading"
          title="아이콘 + 텍스트"
          description="아이콘과 함께 사용하는 텍스트도 btn_label 클래스로 감쌉니다."
          code={typeIconTextCode}
        >
          <Button variant="filled" color="primary" label="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
          <Button variant="filled" color="default" label="다운로드" iconBefore={(
              <>
              <Icon name="download" />
              </>
            )} />
          <Button variant="outline" color="primary" label="새 항목" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
        ...
        <DemoSection
          headingId="type-icon-text-vertical-heading"
          title="아이콘 + 텍스트 (세로)"
          description="btn_vertical 클래스로 아이콘을 위·텍스트를 아래에 배치합니다. 하단 탭·퀵 액션 등에 사용합니다."
          stack
          code={typeIconTextVerticalCode}
        >
          <div className="btn_row btn_row-wrap">
            <Button variant="filled" color="primary" vertical label="홈" iconBefore={(
              <>
              <Icon name="home" />
              </>
            )} />
            <Button variant="filled" color="default" vertical label="검색" iconBefore={(
              <>
              <Icon name="search" />
              </>
            )} />
            <Button variant="ghost" vertical label="마이" iconBefore={(
              <>
              <Icon name="user" />
              </>
            )} />
            <Button variant="text" color="primary" vertical label="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
            <Button variant="outline" color="primary" vertical label="다운로드" iconBefore={(
              <>
              <Icon name="download" />
              </>
            )} />
          ...
          <div className="btn_row btn_row-wrap">
            <Button variant="filled" color="primary" vertical size="sm" label="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
            <Button variant="filled" color="primary" vertical label="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
            <Button variant="filled" color="primary" vertical size="lg" label="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
          ...
          <div className="btn_row btn_row-wrap">
            <Button variant="filled" color="default" vertical round label="가이드" iconBefore={(
              <>
              <Icon name="book" />
              </>
            )} />
            <Button variant="filled" color="primary" vertical round label="즐겨찾기" iconBefore={(
              <>
              <Icon name="star" />
              </>
            )} />
            <Button variant="ghost" vertical disabled label="삭제" iconBefore={(
              <>
              <Icon name="trash" />
              </>
            )} />
        ...
        <DemoSection
          headingId="type-icon-text-vertical-equal-heading"
          title="아이콘 + 텍스트 (세로) · 균등 배분"
          description="btn_vertical과 btn_row-equal을 함께 사용하면 부모 100% 너비에서 버튼을 균등 분배합니다. 하단 탭 바 등에 사용합니다."
          stack
          code={typeIconTextVerticalEqualCode}
        >
          <div className="btn_row-equal" role="toolbar" aria-label="하단 탭 바">
            <Button variant="text" color="primary" vertical label="홈" iconBefore={(
              <>
              <Icon name="home" />
              </>
            )} />
            <Button variant="text" color="primary" vertical label="카테고리" iconBefore={(
              <>
              <Icon name="grid" />
              </>
            )} />
            <Button variant="filled" color="primary" vertical label="장바구니" iconBefore={(
              <>
              <Icon name="cart" />
              </>
            )} />
            <Button variant="text" color="primary" vertical label="마이" iconBefore={(
              <>
              <Icon name="user" />
              </>
            )} />
        ...
        <DemoSection
          headingId="type-text-icon-heading"
          title="텍스트 + 아이콘"
          description="텍스트를 앞에 두고 아이콘을 뒤에 배치합니다. 텍스트는 btn_label로 감쌉니다."
          code={typeTextIconCode}
        >
          <Button variant="filled" color="primary" label="다음" iconAfter={(
              <>
              <Icon name="chevron-right" />
              </>
            )} />
          <Button variant="filled" color="default" label="자세히 보기" iconAfter={(
              <>
              <Icon name="external-link" />
              </>
            )} />
          <Button variant="text" color="primary" label="링크 이동" iconAfter={(
              <>
              <Icon name="chevron-right" />
              </>
            )} />
        ...
        <DemoSection
          headingId="type-icon-only-heading"
          title="아이콘 버튼"
          description="텍스트 없이 아이콘만 표시합니다. btn_icon-only와 함께 사용하며, 접근성을 위해 aria-label을 반드시 지정합니다."
          code={typeIconOnlyCode}
        >
          <Button variant="filled" color="primary" iconOnly ariaLabel="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
          <Button variant="filled" color="default" iconOnly ariaLabel="설정" iconBefore={(
              <>
              <Icon name="settings" />
              </>
            )} />
          <Button variant="ghost" iconOnly ariaLabel="검색" iconBefore={(
              <>
              <Icon name="search" />
              </>
            )} />
          <Button variant="outline" color="primary" iconOnly ariaLabel="편집" iconBefore={(
              <>
              <Icon name="edit" />
              </>
            )} />
          <Button variant="filled" color="danger" iconOnly ariaLabel="삭제" iconBefore={(
              <>
              <Icon name="trash" />
              </>
            )} />
          <Button variant="filled" color="primary" iconOnly disabled ariaLabel="추가" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
        ...
        <DemoSection
          headingId="type-icon-only-size-heading"
          title="아이콘 버튼 크기"
          description="btn_sm, medium, btn_lg 세 가지 크기를 지원합니다."
          code={typeIconOnlySizeCode}
        >
          <Button variant="filled" color="primary" iconOnly size="sm" ariaLabel="추가 (small)" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
          <Button variant="filled" color="primary" iconOnly ariaLabel="추가 (medium)" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
          <Button variant="filled" color="primary" iconOnly size="lg" ariaLabel="추가 (large)" iconBefore={(
              <>
              <Icon name="plus" />
              </>
            )} />
          <Button variant="filled" color="default" iconOnly size="sm" ariaLabel="다운로드 (small)" iconBefore={(
              <>
              <Icon name="download" />
              </>
            )} />
          <Button variant="filled" color="default" iconOnly ariaLabel="다운로드 (medium)">
            <Icon name="download" />
          </Button>
          <Button variant="filled" color="default" iconOnly size="lg" ariaLabel="다운로드 (large)">
            <Icon name="download" />
          </Button>
        </DemoSection>
        ...
        <DemoSection
          ...
          title="색상 변형"
          description="상황에 맞는 색상 변형을 사용합니다."
          code={variantCode}
        >
          <Button variant="filled" color="success" label="Success" />
          <Button variant="filled" color="danger" label="Danger" />
        ...
        <DemoSection
          ...
          title="크기"
          description="small, medium, large 세 가지 크기를 지원합니다."
          code={sizeCode}
        >
          <Button variant="filled" color="primary" size="sm" label="Small" />
          <Button variant="filled" color="primary" label="Medium" />
        ...
        <DemoSection
          headingId="shape-round-heading"
          title="라운드"
          description="btn_round 클래스로 pill(캡슐) 형태의 둥근 모서리를 적용합니다. btn_icon-only와 조합하면 원형 아이콘 버튼이 됩니다."
          stack
          code={shapeRoundCode}
        >
          <div className="btn_row btn_row-wrap">
          ...
          <div className="btn_row btn_row-wrap">
            <Button variant="filled" color="primary" round iconOnly ariaLabel="추가">
              <Icon name="plus" />
            </Button>
            <Button variant="filled" color="default" round iconOnly ariaLabel="설정">
              <Icon name="settings" />
            </Button>
            <Button variant="outline" color="primary" round iconOnly size="sm" ariaLabel="검색">
              <Icon name="search" />
            </Button>
            <Button variant="filled" color="danger" round iconOnly size="lg" ariaLabel="삭제">
              <Icon name="trash" />
            </Button>
          </div>
          <div className="btn_group btn_group-round btn_group-fit" role="group" aria-label="라운드 버튼 그룹">
        ...
        <DemoSection
          ...
          title="너비"
          description="부모 영역 기준으로 너비를 조절합니다. btn_block은 가로 전체, btn_row-equal은 부모 100% 너비에서 버튼을 균등 분배, btn_grow는 비율 분배, btn_fit은 콘텐츠 너비를 유지합니다."
          stack
          code={widthCode}
        >
          <Button variant="filled" color="primary" block label="전체 너비 버튼" />
        ...
        <DemoSection
          ...
          title="상태"
          description="disabled, is-disabled, is-loading 상태를 표현합니다. 비활성은 스킨별로, 로딩은 텍스트·아이콘 버튼 모두 적용할 수 있습니다."
          stack
          code={stateCode}
        >
          <div className="btn_row btn_row-wrap">
        ...
        <DemoSection
          ...
          title="버튼 그룹"
          description="가로·세로 방향으로 버튼을 묶습니다. btn_group-fit은 콘텐츠 크기 맞춤, btn_group-block은 전체 너비 균등 분배, btn_group-align-start·center·end로 그룹 정렬을 지정합니다."
          stack
          code={groupCode}
        >
          <div className="btn_group btn_group-fit btn_group-align-start" role="group" aria-label="가로 버튼 그룹 small 좌측">
          ...
          <div className="btn_stack">
            ...
            <p className="btn_stack-text">최신 버전 v2.0 · <a href="#">릴리스 노트</a></p>
          </div>
        </DemoSection>
        ...
        <ApiSection headingId="api-children-heading" title="API · Children">
          <ApiTable columns={buttonSlotColumns} rows={buttonSlots} codeColumn="name" />
        </ApiSection>
