...
const basicCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const noHeaderCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const minimalCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
...
const weekCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarNav from '@uxkm/ui-react/components/CalendarNav.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const wheelCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import CalendarGroup from '@uxkm/ui-react/components/CalendarGroup.jsx';
import CalendarWheel from '@uxkm/ui-react/components/CalendarWheel.jsx';
import CalendarWheelColumn from '@uxkm/ui-react/components/CalendarWheelColumn.jsx';
...
const rangeCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const eventCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const skinCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarGroup from '@uxkm/ui-react/components/CalendarGroup.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const sizeCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarGroup from '@uxkm/ui-react/components/CalendarGroup.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const footerCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarFooter from '@uxkm/ui-react/components/CalendarFooter.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const dualCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarGroup from '@uxkm/ui-react/components/CalendarGroup.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
const agendaCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
...
const stateCode = `import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
  ...
  return (
    <>
      <div className="page_intro">
          <h1>Calendar</h1>
          <p className="lead">날짜를 월·주 단위 그리드, 세로 일정 목록, iOS 스타일 휠(년·월·일)로 표시하는 캘린더 컴포넌트입니다. 다양한 레이아웃과 단일·범위 선택을 지원합니다.</p>
        </div>
      ...
      <CalendarMonth partial={14} today={7} selected={9} />
        ...
        >
          <Calendar agenda shadow role="feed" ariaLabel="2024년 6월 일정">
              ...
              <CalendarHeader title="6월 14일 ~ 20일" prevLabel="이전 주" nextLabel="다음 주" />
          ...
          <Calendar agenda borderless className="calendar_agenda_compact" role="feed" ariaLabel="2024년 6월 15일 일정 (컴팩트)">

              <CalendarHeader title="6월 15일 (토)" showNav={false} />
        ...
        >
          <Calendar readonly ariaLabel="읽기 전용 캘린더">
              ...
              <CalendarHeader title="읽기 전용" showNav={false} />
          ...
          <Calendar disabled ariaLabel="비활성 캘린더">

              <CalendarHeader title="비활성" showNav={false} />
        ...
        <ApiSection headingId="api-props-heading" title="API · Calendar Props">
          <ApiTable columns={calendarPropColumns} rows={calendarProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-header-props-heading" title="API · CalendarHeader Props">
          <ApiTable columns={calendarHeaderPropColumns} rows={calendarHeaderProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-nav-props-heading" title="API · CalendarNav Props">
          <ApiTable columns={calendarNavPropColumns} rows={calendarNavProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-weekdays-props-heading" title="API · CalendarWeekdays Props">
          <ApiTable columns={calendarWeekdaysPropColumns} rows={calendarWeekdaysProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-month-props-heading" title="API · CalendarMonth Props">
          <ApiTable columns={calendarMonthPropColumns} rows={calendarMonthProps} codeColumn="name" />
          <p className="form_field-hint" style={{ marginTop: 'var(--space-md)' }}>
            <code className="typo_code">CalendarMonth</code>는 <code className="typo_code">CalendarGrid</code> + <code className="typo_code">CalendarDay</code>를 묶는 편의 컴포넌트입니다.
          </p>
        </ApiSection>

        <ApiSection headingId="api-grid-props-heading" title="API · CalendarGrid Props">
          <ApiTable columns={calendarGridPropColumns} rows={calendarGridProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-day-props-heading" title="API · CalendarDay Props">
          <ApiTable columns={calendarDayPropColumns} rows={calendarDayProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-wheel-props-heading" title="API · CalendarWheel Props">
          <ApiTable columns={calendarWheelPropColumns} rows={calendarWheelProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-wheel-col-props-heading" title="API · CalendarWheelColumn Props">
        ...
        <ApiSection headingId="tokens-heading" title="디자인 토큰">
          <ApiTable columns={calendarTokenColumns} rows={calendarTokens} codeColumn="name" />
        </ApiSection>
    </>
  );
}
