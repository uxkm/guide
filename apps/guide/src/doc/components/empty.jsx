...
const basicCode = `import Empty from '@uxkm/ui-react/components/Empty.jsx';
...
const customCode = `import Empty from '@uxkm/ui-react/components/Empty.jsx';
...
const sizeCode = `import Empty from '@uxkm/ui-react/components/Empty.jsx';
...
const simpleCode = `import Empty from '@uxkm/ui-react/components/Empty.jsx';

export function SimpleExample() {
  return <Empty simple size="sm" description="일정 없음" />;
}`;
const blockCode = `import Empty from '@uxkm/ui-react/components/Empty.jsx';
