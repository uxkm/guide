...
import InputClearable from '@uxkm/ui-react/components/InputClearable.jsx';
import {
  inputChildColumns,
  inputChildren,
  inputClassColumns,
...
const standaloneCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
import Input from '@uxkm/ui-react/components/Input.jsx';
...
const typeCode = `import Input from '@uxkm/ui-react/components/Input.jsx';
...
const kindCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Input from '@uxkm/ui-react/components/Input.jsx';
...
const sizeCode = `import Input from '@uxkm/ui-react/components/Input.jsx';
...
const widthCode = `import Input from '@uxkm/ui-react/components/Input.jsx';
...
const groupCode = `import Input from '@uxkm/ui-react/components/Input.jsx';
...
const requiredCode = `import Input from '@uxkm/ui-react/components/Input.jsx';
...
const stateCode = `import Input from '@uxkm/ui-react/components/Input.jsx';
...
const clearableCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Icon from '@uxkm/ui-react/components/Icon.jsx';
import Input from '@uxkm/ui-react/components/Input.jsx';
    ...
    <>
      <div className="page_intro">
        ...
        <DemoSection
          ...
          title="단독 사용"
          description="form_field 래퍼 없이 <code>input_field</code>로 레이블과 input을 묶을 수 있습니다. 접근 가능한 이름은 반드시 지정합니다. 보이는 레이블이 있으면 <code>label.form_field-label</code> + <code>htmlFor</code>를, 아이콘만 있는 검색창·툴바 등에는 <code>label.input_group</code>으로 input을 감싸고 <code>input_group-label_hidden</code>으로 이름을 제공합니다."
          stack
          code={standaloneCode}
        >
          <>
        ...
        <ApiSection headingId="api-props-heading" title="API · Props">
          ...
          <p className="form_field-hint" style={{ marginTop: 'var(--space-md)' }}>
            ...
            <code className="typo_code">autoComplete</code>, <code className="typo_code">onBlur</code> 등)는
            루트 <code className="typo_code">input</code> 요소에 그대로 전달됩니다.
          </p>
        </ApiSection>

        <ApiSection headingId="api-children-heading" title="API · Children">
          <ApiTable columns={inputChildColumns} rows={inputChildren} codeColumn="name" />
        </ApiSection>
