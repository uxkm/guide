...
import Progress from '@uxkm/ui-react/components/Progress.jsx';
import ProgressCircle from '@uxkm/ui-react/components/ProgressCircle.jsx';
...
const basicCode = `import Progress from '@uxkm/ui-react/components/Progress.jsx';
...
const labelCode = `import Progress from '@uxkm/ui-react/components/Progress.jsx';
...
const colorCode = `import Progress from '@uxkm/ui-react/components/Progress.jsx';
...
const sizeCode = `import Progress from '@uxkm/ui-react/components/Progress.jsx';
...
const stripedCode = `import Progress from '@uxkm/ui-react/components/Progress.jsx';
...
const indeterminateCode = `import Progress from '@uxkm/ui-react/components/Progress.jsx';
...
const insideCode = `import Progress from '@uxkm/ui-react/components/Progress.jsx';
...
const circleCode = `import ProgressCircle from '@uxkm/ui-react/components/ProgressCircle.jsx';
...
const widthCode = `import Progress from '@uxkm/ui-react/components/Progress.jsx';
  ...
  return (
    <>
      ...
      <DemoSection
        ...
        title="기본"
        description="`progress` · `progress_track` · `progress_bar`로 트랙과 채움 막대를 구성합니다. `progress_bar`의 `style=&quot;width: …&quot;` 또는 CSS 변수로 진행률을 제어합니다."
        stack
        code={basicCode}
      >
<>
      ...
      <DemoSection
        ...
        title="레이블 · 값"
        description="`progress_header`에 `progress_label` · `progress_value`를 함께 배치합니다."
        stack
        code={labelCode}
      >
<>
...
<>
      ...
      <DemoSection
        ...
        title="크기"
        description="`progress_sm` · `progress`(기본) · `progress_lg` 세 가지 높이를 지원합니다."
        stack
        code={sizeCode}
      >
<>
      ...
      <DemoSection
        ...
        title="줄무늬 · 애니메이션"
        description="`progress_striped`로 줄무늬 패턴을, `progress_animated`와 함께 사용하면 흐르는 애니메이션을 적용합니다."
        stack
        code={stripedCode}
      >
<>
      ...
      <DemoSection
        ...
        title="불확정"
        description="진행률을 알 수 없을 때 `is-indeterminate`를 사용합니다. `aria-valuenow`를 생략하거나 `aria-busy=&quot;true&quot;`를 함께 지정합니다."
        stack
...
<>
      ...
      <DemoSection
        ...
        title="바 안 텍스트"
        description="`progress_inside`로 막대 안에 퍼센트를 표시합니다. 막대가 좁을 때는 텍스트가 잘릴 수 있으니 충분한 너비를 확보합니다."
        stack
        code={insideCode}
      >
<>
      ...
      <DemoSection
        ...
        title="원형"
        description="`progress_circle`로 원형 진행률을 표시합니다. `style=&quot;--progress-percent: …&quot;`로 채움 비율을 지정합니다."
        code={circleCode}
      >
<>
      <ProgressCircle percent={25} />
      ...
      <DemoSection
        ...
        title="너비"
        description="`progress_fit`은 최대 너비를 제한하고, `progress_block`은 부모 너비 전체를 사용합니다."
        stack
        code={widthCode}
      >
<>
      ...
      <section className="section" aria-labelledby="usage-heading">
        ...
        <p>
          선형 Progress는 <code className="typo_code">progress_track</code>에
          <code className="typo_code">role=&quot;progressbar&quot;</code>를 지정하고,
          <code className="typo_code">progress_bar</code>의
          <code className="typo_code">style=&quot;width: ...&quot;</code>로 진행률을 제어합니다. 원형은
          <code className="typo_code">--progress-percent</code> CSS 변수를 사용합니다.
        </p>
      ...
      <ApiSection headingId="api-children-heading" title="API · Children">
        <ApiTable columns={progressChildColumns} rows={progressChildren} codeColumn="name" />
      </ApiSection>
      ...
      >
        ...
        <p className="form_field-hint" style={{ marginTop: 'var(--space-md)' }}>
          진행률은 <code className="typo_code">progress_bar</code>의
          <code className="typo_code">width</code> 또는 JS로 업데이트합니다.
