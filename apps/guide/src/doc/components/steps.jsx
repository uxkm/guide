...
import Steps from '@uxkm/ui-react/components/Steps.jsx';
...
const basicCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const simpleCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const verticalCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const dotCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const iconStyleCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const navigableCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const errorCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const alignCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const sizeCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
...
const stateCode = `import Steps from '@uxkm/ui-react/components/Steps.jsx';
import StepsItem from '@uxkm/ui-react/components/StepsItem.jsx';
  ...
  return (
    <>
      <div className="page_intro">
        <h1>Steps</h1>
        <p className="lead">다단계 프로세스·마법사·주문 흐름을 단계별로 표시하는 컴포넌트입니다. <code className="typo_code">ol</code> 시맨틱 구조와 <code className="typo_code">{'aria-current="step"'}</code>으로 접근성을 지원합니다.</p>
      </div>

      <DemoSection
        headingId="basic-heading"
        title="기본"
        description="가로형 단계 표시입니다. is-finished · is-active · is-wait로 진행 상태를 구분합니다."
        code={basicCode}
      >
        <Steps ariaLabel="주문 진행 단계">
          <StepsItem title="장바구니" description="상품 확인" status="finished" />
      ...
      <DemoSection
        ...
        title="간단"
        description="제목만 표시하는 간결한 단계입니다. 설명이 없는 짧은 플로우에 적합합니다."
        code={simpleCode}
      >
        <Steps ariaLabel="회원가입 단계">
          <StepsItem title="이메일 인증" status="finished" />
      ...
      <DemoSection
        ...
        title="세로형"
        description="steps_vertical로 사이드바·폼 마법사에 적합한 세로 레이아웃을 적용합니다."
        code={verticalCode}
      >
        <Steps direction="vertical" className="steps_demo-narrow" ariaLabel="프로젝트 생성 단계">
          <StepsItem title="기본 정보" description="프로젝트 이름과 설명을 입력합니다." status="finished" />
      ...
      <DemoSection
        ...
        title="도트"
        description="steps_dot으로 작은 원형 마커를 사용합니다. 밀도 높은 UI·모바일에 적합합니다."
        code={dotCode}
      >
        <Steps dot ariaLabel="배송 추적 단계">
          <StepsItem title="주문 접수" description="6월 20일 09:12" status="finished" />
      ...
      <DemoSection
        ...
        title="아이콘"
        description="steps_icon-style로 단계 유형을 아이콘으로 표시합니다. 완료 단계는 체크 아이콘으로 대체합니다."
        code={iconStyleCode}
      >
        <Steps iconStyle ariaLabel="온보딩 단계">
          <StepsItem title="계정 생성" description="이메일 인증 완료" status="finished" />
      ...
      <DemoSection
        ...
        title="오류"
        description="is-error로 실패·검증 오류 단계를 표시합니다. 오류 아이콘 또는 번호를 함께 사용합니다."
        code={errorCode}
      >
        <Steps ariaLabel="결제 단계 — 오류">
          <StepsItem title="주문 확인" description="상품 및 수량 확인" status="finished" />
      ...
      <DemoSection
        ...
        title="가운데 정렬"
        description="steps_align-center로 단계 제목과 설명을 가운데 정렬합니다. 대시보드·온보딩 헤더에 적합합니다."
        code={alignCode}
      >
        <Steps align="center" ariaLabel="출시 단계">
          <StepsItem title="기획" description="요구사항 정의" status="finished" />
      ...
      <DemoSection
        ...
        title="크기"
        description="steps_sm · steps_lg로 인디케이터와 텍스트 스케일을 조절합니다."
        code={sizeCode}
        stack
      >
        <Steps size="sm" ariaLabel="Small 단계">
      ...
      <DemoSection
        ...
        title="상태 요약"
        description={'각 상태 클래스의 시각적 의미입니다. 현재 단계에는 aria-current="step"을 함께 지정합니다.'}
        code={stateCode}
        stack
      >
        <Steps ariaLabel="상태 예시 — 완료">
      ...
      <ApiSection headingId="api-props-heading" title="API · Steps Props">
        <ApiTable columns={stepsPropColumns} rows={stepsProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-item-props-heading" title="API · StepsItem Props">
        <ApiTable columns={stepsItemPropColumns} rows={stepsItemProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-children-heading" title="API · Steps Children">
        <ApiTable columns={stepsChildColumns} rows={stepsChildren} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-item-children-heading" title="API · StepsItem Children">
        <ApiTable columns={stepsItemChildColumns} rows={stepsItemChildren} codeColumn="name" />
      </ApiSection>
      ...
      >
        <ApiTable columns={stepsClassColumns} rows={stepsClasses} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="tokens-heading" title="디자인 토큰">
        <ApiTable columns={stepsTokenColumns} rows={stepsTokens} codeColumn="name" />
      </ApiSection>
    </>
  );
}
