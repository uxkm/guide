...
const basicCode = `import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
const descOnlyCode = `import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
const noIconCode = `import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
const sizeCode = `import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
const closeCode = `import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
const actionsCode = `import Alert from '@uxkm/ui-react/components/Alert.jsx';
import Button from '@uxkm/ui-react/components/Button.jsx';
import Link from '@uxkm/ui-react/components/Link.jsx';
...
const bannerCode = `import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
const contextCode = `import Alert from '@uxkm/ui-react/components/Alert.jsx';
import Link from '@uxkm/ui-react/components/Link.jsx';
  ...
  return (
    <>
      ...
      <DemoSection
        ...
        title="기본"
        description="공통 color_* 클래스로 info · success · warning · error 네 가지 의미를 표현합니다."
        stack
        code={basicCode}
      >
<>
      ...
      <DemoSection
        headingId="desc-only-heading"
        title="설명만"
        description="제목 없이 alert_desc만으로 짧은 메시지를 표시합니다."
        stack
        code={descOnlyCode}
      >
<>
      ...
      <DemoSection
        headingId="no-icon-heading"
        title="아이콘 없음"
        description="alert_icon을 생략해 텍스트만 표시합니다. 간단한 안내에 적합합니다."
        stack
        code={noIconCode}
      >
<>
      ...
      <DemoSection
        ...
        title="크기"
        description="alert_sm · alert_lg로 스케일을 조절합니다."
        stack
        code={sizeCode}
      >
<>
      ...
      <DemoSection
        ...
        title="닫기 가능"
        description="alert_close 버튼으로 사용자가 알림을 닫을 수 있습니다. aria-label로 닫기 동작을 설명합니다."
        stack
        code={closeCode}
      >
<>
...
<>
      ...
      <DemoSection
        headingId="banner-heading"
        title="배너"
        description="alert_banner로 페이지 상단 전체 너비 알림을 표시합니다. 좌우 테두리와 모서리 반경을 제거합니다."
        stack
        code={bannerCode}
      >
<Alert
    ...
    />
      ...
      <DemoSection
        ...
        title="문맥 속 사용"
        description="폼·카드 등 다른 컴포넌트와 함께 사용합니다. 설명 안에 링크를 포함할 수 있습니다."
        stack
        code={contextCode}
      >
<>
      ...
      <ApiSection headingId="api-props-heading" title="API · Props">
        <ApiTable columns={alertPropColumns} rows={alertProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-children-heading" title="API · Children">
        <ApiTable columns={alertChildColumns} rows={alertChildren} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-events-heading" title="API · Events">
        <ApiTable columns={alertEventColumns} rows={alertEvents} codeColumn="name" />
      </ApiSection>
      ...
      >
        <ApiTable columns={alertClassColumns} rows={alertClasses} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="tokens-heading" title="디자인 토큰">
        <ApiTable columns={alertTokenColumns} rows={alertTokens} codeColumn="name" />
      </ApiSection>
    </>
  );
}
