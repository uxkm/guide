...
import BackTop from '@uxkm/ui-react/components/BackTop.jsx';
...
const basicCode = `import BackTop from '@uxkm/ui-react/components/BackTop.jsx';
...
const visibilityCode = `import BackTop from '@uxkm/ui-react/components/BackTop.jsx';
...
const sizeCode = `import BackTop from '@uxkm/ui-react/components/BackTop.jsx';
...
const customCode = `import BackTop from '@uxkm/ui-react/components/BackTop.jsx';
...
const windowCode = `import BackTop from '@uxkm/ui-react/components/BackTop.jsx';
...
export default function BackTopDoc() {
  return (
    <>
      <div className="page_intro">
        <h1>Back Top</h1>
        <p className="lead">
          긴 콘텐츠를 스크롤한 뒤 페이지(또는 지정 영역) 맨 위로 빠르게 이동하는 플로팅 버튼입니다.{' '}
          <code className="typo_code">target</code>으로 스크롤 컨테이너를 지정하고,{' '}
          <code className="typo_code">visibilityHeight</code>으로 표시 임계값을 조절할 수 있습니다.
        </p>
      </div>
      ...
      <DemoSection
        ...
        title="기본"
        description="data-back-top과 data-target으로 스크롤 영역을 연결합니다. 영역을 일정 이상 스크롤하면 우측 하단에 버튼이 나타납니다."
        code={basicCode}
      >
        <div className="back_top_demo-wrap">
          <div className="back_top_demo-scroll" id="back-top-scroll-basic">
      ...
      <DemoSection
        ...
        title="표시 임계값"
        description="visibilityHeight으로 버튼이 나타나는 스크롤 거리(px)를 지정합니다. 기본값은 400px입니다."
        code={visibilityCode}
      >
        <div className="back_top_demo-wrap">
          <div className="back_top_demo-scroll" id="back-top-scroll-visibility">
      ...
      <DemoSection
        ...
        title="크기"
        description="back_top_sm · back_top_lg 클래스로 버튼 크기를 조절합니다."
        code={sizeCode}
        stack
      >
        <div className="back_top_demo-wrap">
      ...
      <DemoSection
        ...
        title="커스텀 콘텐츠"
        description="버튼 안에 아이콘과 텍스트를 함께 넣을 수 있습니다. pill 형태로 자동 확장됩니다."
        code={customCode}
      >
        <div className="back_top_demo-wrap">
          <div className="back_top_demo-scroll" id="back-top-scroll-custom">
      ...
      <DemoSection
        ...
        title="페이지 스크롤"
        description="target을 생략하면 window 스크롤을 기준으로 동작합니다. 이 페이지를 아래로 스크롤하면 우측 하단에 버튼이 나타납니다."
        code={windowCode}
      >
        <p style={{ margin: 0, fontSize: 'var(--text-size-sm)', color: 'var(--color-text-muted)' }}>
      ...
      <ApiSection headingId="api-props-heading" title="API · Props">
        <ApiTable columns={backTopPropColumns} rows={backTopProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-children-heading" title="API · Children">
        <ApiTable columns={backTopChildColumns} rows={backTopChildren} codeColumn="name" />
      </ApiSection>
      ...
      >
        <ApiTable columns={backTopClassColumns} rows={backTopClasses} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="tokens-heading" title="디자인 토큰">
        <ApiTable columns={backTopTokenColumns} rows={backTopTokens} codeColumn="name" />
      </ApiSection>
    </>
  );
}
