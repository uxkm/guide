...
import Pagination from '@uxkm/ui-react/components/Pagination.jsx';
import {
...
const basicCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';

export function BasicExample() {
  return <Pagination current={1} total={50} pageSize={10} />;
}`;

const minimalCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';

export function MinimalExample() {
  return <Pagination current={4} total={50} pageSize={10} minimal />;
}`;

const sizeCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';
...
const roundCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';

export function RoundExample() {
  return <Pagination current={7} total={80} pageSize={10} round />;
}`;

const ellipsisCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';

export function EllipsisExample() {
  return <Pagination current={10} total={500} pageSize={10} />;
}`;

const simpleCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';
...
const toolbarCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';
...
const alignCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';
...
const stateCode = `import Pagination from '@uxkm/ui-react/components/Pagination.jsx';
