...
import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
...
const standaloneCode = `import CollapseExternal from '@uxkm/ui-react/components/CollapseExternal.jsx';
...
const linksCode = `import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
import CollapsePanel from '@uxkm/ui-react/components/CollapsePanel.jsx';
import Link from '@uxkm/ui-react/components/Link.jsx';
...
const basicCode = `import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
import CollapsePanel from '@uxkm/ui-react/components/CollapsePanel.jsx';
...
const accordionModeCode = `import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
import CollapsePanel from '@uxkm/ui-react/components/CollapsePanel.jsx';
...
const skinCode = `import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
import CollapsePanel from '@uxkm/ui-react/components/CollapsePanel.jsx';
...
const extraCode = `import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
import CollapsePanel from '@uxkm/ui-react/components/CollapsePanel.jsx';
...
const disabledCode = `import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
import CollapsePanel from '@uxkm/ui-react/components/CollapsePanel.jsx';
...
const slideCode = `import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
import CollapseExternal from '@uxkm/ui-react/components/CollapseExternal.jsx';
import CollapsePanel from '@uxkm/ui-react/components/CollapsePanel.jsx';
...
const sizeCode = `import Collapse from '@uxkm/ui-react/components/Collapse.jsx';
import CollapsePanel from '@uxkm/ui-react/components/CollapsePanel.jsx';
  ...
  return (
    <>
      ...
      <DemoSection
        ...
        title="외부 트리거"
        description="CollapseExternal로 버튼과 접힘 영역을 연결합니다. 상세 설명·추가 옵션 등에 적합합니다."
        code={standaloneCode}
      >
        <CollapseExternal
          triggerLabel="주문 상세 보기"
      ...
      <DemoSection
        ...
        title="아코디언 모드"
        description="accordion prop을 지정하면 한 번에 하나의 패널만 열립니다."
      ...
      <DemoSection
        ...
        title="스킨"
        description="collapse_ghost · collapse_card로 외형을 조절합니다."
        code={skinCode}
        stack
      >
        <Collapse variant="ghost" narrow>
      ...
      <DemoSection
        ...
        title="보조 텍스트"
        description="extra prop으로 트리거 오른쪽에 메타 정보를 표시합니다."
        code={extraCode}
      >
        <Collapse narrow>
      ...
      <DemoSection
        ...
        title="비활성"
        description="disabled prop을 지정하면 is-disabled 클래스와 함께 트리거가 비활성화됩니다."
        code={disabledCode}
      >
        <Collapse narrow>
          <CollapsePanel label="공개 문서" open content="누구나 열람할 수 있는 가이드 문서입니다." />
      ...
      <DemoSection
        ...
        title="크기"
        description="size prop으로 트리거와 본문 패딩을 조절합니다."
        code={sizeCode}
        stack
      >
        <Collapse size="sm" narrow>
      ...
      <ApiSection headingId="api-external-props-heading" title="API · CollapseExternal Props">
        <ApiTable columns={collapseExternalPropColumns} rows={collapseExternalProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-external-children-heading" title="API · CollapseExternal Children">
        <ApiTable columns={collapseExternalChildColumns} rows={collapseExternalChildren} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-group-props-heading" title="API · Collapse Props">
        <ApiTable columns={collapsePropColumns} rows={collapseProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-panel-props-heading" title="API · CollapsePanel Props">
        <ApiTable columns={collapsePanelPropColumns} rows={collapsePanelProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-panel-children-heading" title="API · CollapsePanel Children">
        <ApiTable columns={collapsePanelChildColumns} rows={collapsePanelChildren} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-children-heading" title="API · Collapse Children">
        <ApiTable columns={collapseChildColumns} rows={collapseChildren} codeColumn="name" />
      </ApiSection>
