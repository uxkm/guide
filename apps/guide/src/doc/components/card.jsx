    ...
    <>
      <div className="page_intro">
        ...
        <DemoSection
          ...
          title="미디어"
          description="media prop으로 상단 이미지·썸네일(card_media) 영역을 추가합니다."
          code={mediaCode}
        >
          <Card
            hoverable
