...
const slotCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Tooltip from '@uxkm/ui-react/components/Tooltip.jsx';
...
const inlineCode = `import Link from '@uxkm/ui-react/components/Link.jsx';
import Tooltip from '@uxkm/ui-react/components/Tooltip.jsx';
...
const clickCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Tooltip from '@uxkm/ui-react/components/Tooltip.jsx';
...
const inverseCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Tooltip from '@uxkm/ui-react/components/Tooltip.jsx';
...
const disabledCode = `import Button from '@uxkm/ui-react/components/Button.jsx';
import Tooltip from '@uxkm/ui-react/components/Tooltip.jsx';
  ...
  return (
    <>
      <div className="page_intro">
        <h1>Tooltip</h1>
        <p className="lead">
          호버·포커스 시 트리거 근처에 짧은 설명을 띄우는 Tooltip 컴포넌트입니다. 용어 정의·아이콘 버튼
          보조 설명·비활성 요소 이유 안내 등에 사용하며, 
          <code className="typo_code">role=&quot;tooltip&quot;</code> · <code className="typo_code">aria-describedby</code>로
          접근성을 보장합니다.
        </p>
      </div>
...
<Tooltip
    ...
    />
      ...
      <section className="section" aria-labelledby="usage-heading">
        ...
        <p>
          Tooltip 컴포넌트로 트리거와 말풍선을 감쌉니다. <code className="typo_code">content</code>
          prop 또는 children으로 텍스트를 넣고, <code className="typo_code">trigger</code> ·
          <code className="typo_code">placement</code> · <code className="typo_code">inverse</code> prop과
          <code className="typo_code">triggerContent</code> prop으로 데모와 동일하게 구성할 수 있습니다.
        </p>
      ...
      <ApiSection headingId="api-children-heading" title="API · Children">
        <ApiTable columns={tooltipChildColumns} rows={tooltipChildren} codeColumn="name" />
      </ApiSection>
