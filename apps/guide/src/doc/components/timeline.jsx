...
const basicCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const simpleCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const outlineCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const iconCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const cardCode = `import Tag from '@uxkm/ui-react/components/Tag.jsx';
import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const labelCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const alternateCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const horizontalCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const sizeCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
const stateCode = `import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
  ...
  return (
    <>
      <div className="page_intro">
        <h1>Timeline</h1>
        <p className="lead">시간 순서에 따른 이벤트·활동을 표시하는 타임라인 컴포넌트입니다.</p>
      </div>

        <DemoSection
          headingId="basic-heading"
          title="기본"
          description="timeline_dot에 공통 color_* 클래스로 이벤트 유형을 구분합니다."
          stack
          code={basicCode}
        >
          <Timeline>
        ...
        <DemoSection
          ...
          title="간단"
          description="제목만 표시하는 간결한 타임라인입니다."
          stack
          code={simpleCode}
        >
          <Timeline>
        ...
        <DemoSection
          ...
          title="아웃라인 도트"
          description="timeline_dot-outline으로 속이 빈 원형 마커를 사용합니다. 밀도 높은 목록에 적합합니다."
          stack
          code={outlineCode}
        >
          <Timeline>
        ...
        <DemoSection
          ...
          title="아이콘 도트"
          description="timeline_icon과 icon_circle을 조합해 이벤트 유형을 아이콘으로 표시합니다."
          stack
          code={iconCode}
        >
          <Timeline icon iconSize="sm">
        ...
        <DemoSection
          ...
          title="카드형"
          description="timeline_card로 콘텐츠 영역에 카드 스타일을 적용합니다. timeline_meta로 태그·액션을 함께 표시할 수 있습니다."
          stack
          code={cardCode}
        >
          <Timeline card>
        ...
        <DemoSection
          ...
          title="날짜 레이블"
          description="timeline_label-col과 timeline_label로 왼쪽에 기간·날짜 열을 배치합니다."
          stack
          code={labelCode}
        >
          <Timeline labelCol>
        ...
        <DemoSection
          headingId="alternate-heading"
          title="좌우 교차"
          description="timeline_alternate로 768px 이상에서 중앙 축을 기준으로 항목이 좌우로 교차 배치됩니다."
          stack
          code={alternateCode}
        >
          <Timeline alternate>
        ...
        <DemoSection
          ...
          title="가로형"
          description="timeline_horizontal로 단계·프로세스 흐름을 가로로 표시합니다. 768px 미만에서는 세로형으로 표시됩니다."
          stack
          code={horizontalCode}
        >
          <Timeline horizontal>
        ...
        <DemoSection
          ...
          title="크기"
          description="timeline_sm · timeline_lg로 간격과 텍스트 크기를 조절합니다."
          stack
          code={sizeCode}
        >
          <div>
            <p style={{ fontSize: 'var(--text-size-sm)', color: 'var(--color-text-muted)', margin: '0 0 0.75rem' }}>Small</p>
            <Timeline size="sm">
              <TimelineItem color="primary" title="알림 발송" time="10:30" />
              <TimelineItem color="success" title="수신 확인" time="10:31" />
            </Timeline>
          ...
          <div>
            <p style={{ fontSize: 'var(--text-size-sm)', color: 'var(--color-text-muted)', margin: '0 0 0.75rem' }}>Large</p>
            <Timeline size="lg">
        ...
        <DemoSection
          ...
          title="상태"
          description="is-active로 현재 진행 항목, is-pending으로 예정·미완료 항목을 표시합니다."
          stack
          code={stateCode}
        >
          <Timeline>
        ...
        <ApiSection headingId="api-props-heading" title="API · Timeline Props">
          <ApiTable columns={timelinePropColumns} rows={timelineProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-item-props-heading" title="API · TimelineItem Props">
          <ApiTable columns={timelineItemPropColumns} rows={timelineItemProps} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-children-heading" title="API · Timeline Children">
          <ApiTable columns={timelineSlotColumns} rows={timelineSlots} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-item-children-heading" title="API · TimelineItem Children">
          <ApiTable columns={timelineItemSlotColumns} rows={timelineItemSlots} codeColumn="name" />
        </ApiSection>
        ...
        >
          <ApiTable columns={timelineClassColumns} rows={timelineClasses} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="tokens-heading" title="디자인 토큰">
          <ApiTable columns={timelineTokenColumns} rows={timelineTokens} codeColumn="name" />
        </ApiSection>
    </>
  );
}
