    ...
    <>
      <div className="page_intro">
        ...
        <DemoSection
          ...
          title="크기"
          description="기본 크기는 icon 클래스만 사용합니다. icon_sm · md(기본) · icon_lg · icon_xl로 스케일을 조절합니다."
          code={sizeCode}
        >
          <Icon size="sm">
            <path d="M12 5v14M5 12h14" />
        ...
        <DemoSection
          ...
          title="텍스트와 함께"
          description="inline prop으로 icon_inline 클래스를 적용해 텍스트와 수직 정렬을 맞춥니다. 텍스트에는 ml_sm으로 간격을 둡니다. 의미 있는 아이콘은 ariaLabel을 지정합니다."
          stack
          code={inlineCode}
        >
          <p>
        ...
        <DemoSection
          ...
          title="원형 · 사각 배경"
          description="circle · square prop으로 icon_circle · icon_square 배경을 적용합니다. color로 색상을 지정합니다."
          code={circleCode}
        >
          <Icon circle color="primary" size="sm">
            <path d="M12 5v14M5 12h14" />
        ...
        <DemoSection
          ...
          title="아이콘 버튼"
          description="button prop으로 icon_button 클릭 가능한 아이콘 버튼을 만듭니다. ariaLabel을 반드시 지정합니다."
          code={buttonCode}
        >
          <Icon button color="primary" ariaLabel="검색">
            <circle cx="11" cy="11" r="8" />
        ...
        <DemoSection
          ...
          title="펄스"
          description="pulse prop으로 icon_pulse 알림·상태 강조 애니메이션을 적용합니다. circle과 함께 사용합니다."
          code={pulseCode}
        >
          <Icon circle pulse color="primary" size="sm">
            <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
        ...
        <DemoSection
          ...
          title="로딩"
          description="spin prop으로 icon_spin 회전 애니메이션을 적용합니다. 로딩 상태 표시에 사용합니다."
          code={spinCode}
        >
          <Icon spin color="primary">
            <path d="M21 12a9 9 0 1 1-6.219-8.56" />
        ...
        <DemoSection
          ...
          title="자주 쓰는 아이콘"
          description="프로젝트에서 제공하는 stroke SVG 아이콘 전체입니다. viewBox 0 0 24 24 · stroke-width 2 기준입니다. name prop으로 common-icons 갤러리 키를 지정합니다."
          stack
          code={galleryCode}
        >
          <div className="icon_grid">
        ...
        <ApiSection headingId="api-props-heading" title="API · Props">
          ...
          <p className="form_field-hint" style={{ marginTop: 'var(--space-md)' }}>
            ...
            의미 있는 아이콘·버튼은 <code className="typo_code">ariaLabel</code>을 지정하세요.
          </p>
        </ApiSection>
