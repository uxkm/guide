...
import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
...
const basicCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
const multipleCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
const flushCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
const borderedCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
const cardCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
const extraCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
const disabledCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
const slideCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
const sizeCode = `import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
  ...
  return (
    <>
      ...
      <DemoSection
        ...
        title="다중 열기"
        description="multiple prop을 지정하면 여러 패널을 동시에 펼칠 수 있습니다."
        code={multipleCode}
      >
        <Accordion narrow multiple>
          <AccordionItem label="알림" open content="이메일·푸시 알림 수신 여부를 설정합니다." />
      ...
      <DemoSection
        headingId="flush-heading"
        title="플러시"
        description="accordion_flush로 외곽 테두리 없이 구분선만 표시합니다. 사이드바·설정 목록에 적합합니다."
        code={flushCode}
      >
        <Accordion variant="flush" narrow>
          <AccordionItem label="일반" open content="언어, 시간대, 테마 등 기본 환경 설정입니다." />
      ...
      <DemoSection
        ...
        title="보더"
        description="accordion_bordered로 항목을 한 덩어리로 붙입니다. 설정·목록형 UI에 적합합니다."
        code={borderedCode}
      >
        <Accordion variant="bordered" narrow>
          <AccordionItem label="알림" open content="이메일·푸시 알림 수신 여부를 설정합니다." />
      ...
      <DemoSection
        ...
        title="보조 정보"
        description="extra prop으로 배지·메타 텍스트를 트리거 오른쪽에 배치합니다."
        code={extraCode}
      >
        <Accordion narrow>
          <AccordionItem
      ...
      <ApiSection headingId="api-props-heading" title="API · Accordion Props">
        <ApiTable columns={accordionPropColumns} rows={accordionProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-item-props-heading" title="API · AccordionItem Props">
        <ApiTable columns={accordionItemPropColumns} rows={accordionItemProps} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-children-heading" title="API · Accordion Children">
        <ApiTable columns={accordionChildColumns} rows={accordionChildren} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="api-item-children-heading" title="API · AccordionItem Children">
        <ApiTable columns={accordionItemChildColumns} rows={accordionItemChildren} codeColumn="name" />
      </ApiSection>
      ...
      >
        <ApiTable columns={accordionClassColumns} rows={accordionClasses} codeColumn="name" />
      </ApiSection>

      <ApiSection headingId="tokens-heading" title="디자인 토큰">
        <ApiTable columns={accordionTokenColumns} rows={accordionTokens} codeColumn="name" />
      </ApiSection>
    </>
  );
}
