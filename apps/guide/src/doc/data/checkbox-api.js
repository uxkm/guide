...
export const checkboxProps = [
  ...
  { name: 'ariaLabel', type: 'string', default: '—', description: '라벨 없는 단독 체크박스 시 필수' },
  { name: 'className', type: 'string', default: '—', description: 'checkbox 루트에 추가 클래스' },
  { name: 'onChange', type: '(event) => void', default: '—', description: '체크 상태 변경 콜백' },
  ripplePropChoice,
];

export const checkboxChildColumns = [
...
/** @deprecated 가이드·Storybook은 checkboxChildColumns · checkboxChildren 사용 */
export const checkboxSlotColumns = checkboxChildColumns;

/** @deprecated */
export const checkboxSlots = checkboxChildren;
