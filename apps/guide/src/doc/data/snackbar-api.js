...
export const snackbarRegionProps = [
  {
    ...
    description: 'document.body에 포털 렌더링되는 고정 위치. start와 end는 RTL에서도 논리 방향을 따름',
  },
...
export const snackbarClasses = [
  ...
  { name: 'snackbar_region', description: 'document.body에 포털 렌더링되는 고정 위치와 다중 Snackbar 스택 컨테이너' },
