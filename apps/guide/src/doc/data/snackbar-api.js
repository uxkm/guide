...
export const snackbarProps = [
  ...
  { name: 'message', type: 'string', default: '—', description: '메시지. default 슬롯이 있으면 대체됨' },
  { name: 'closable', type: 'boolean', default: 'false', description: '닫기 버튼과 내부 포커스 상태의 Escape 닫기 지원' },
  { name: 'close-label', type: 'string', default: '알림 닫기', description: '닫기 버튼의 접근성 라벨' },
  { name: 'show-icon', type: 'boolean', default: 'true', description: '의미 색상에 대응하는 기본 아이콘 표시' },
  ...
  { name: 'action-label', type: 'string', default: '—', description: '기본 액션 버튼 레이블' },
  { name: 'close-on-action', type: 'boolean', default: 'true', description: '기본 액션 실행 후 닫기' },
  { name: 'ripple', type: 'boolean', default: 'true', description: '닫기·기본 액션 버튼의 클릭 파장' },
];

export const snackbarRegionProps = [
  { name: 'placement', type: `'top-start' | 'top-center' | 'top-end' | 'middle-start' | 'middle-end' | 'bottom-start' | 'bottom-center' | 'bottom-end'`, default: 'bottom-center', description: '고정 위치. start와 end는 RTL에서도 논리 방향을 따름' },
  { name: 'label', type: 'string', default: '—', description: 'Snackbar 영역의 접근성 라벨' },
  { name: 'default slot', type: 'VNode', default: '—', description: '같은 위치에 세로로 쌓을 Snackbar 목록' },
  { name: 'class', type: 'string', default: '—', description: 'snackbar_region에 추가 클래스' },
];

export const snackbarSlotColumns = [
  { key: 'name', label: '슬롯' },
  { key: 'description', label: '설명' },
];

export const snackbarSlots = [
  { name: 'default', description: '메시지 콘텐츠 (message prop 대체)' },
  { name: 'icon', description: '커스텀 아이콘' },
  { name: 'action', description: '버튼·링크 등 후속 동작. close 함수를 slot prop으로 제공' },
];
...
export const snackbarEvents = [
  { name: 'action(event)', description: '기본 액션 버튼 클릭 시' },
  { name: 'close(reason, event)', description: "퇴장 후 호출. reason은 'close' · 'action' · 'timeout'" },
];
...
export const snackbarClasses = [
  ...
  { name: 'data-ripple · data-ripple="false"', description: '클릭 파장 활성·비활성' },
];
