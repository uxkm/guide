...
export const flexProps = [
  { name: 'direction', type: `'row' | 'col'`, default: 'row', description: '기본 배치 방향' },
  { name: 'direction-md', type: `'row' | 'col'`, default: '—', description: 'md 이상 배치 방향' },
  { name: 'direction-lg', type: `'row' | 'col'`, default: '—', description: 'lg 이상 배치 방향' },
  { name: 'wrap', type: 'boolean', default: 'false', description: '항목 줄바꿈 (flex_wrap)' },
  ...
  { name: 'ratio', type: `'1-1' | '2-1' | '1-2' | '3-1' | '1-1-1' | '1-2-1'`, default: '—', description: '자식 grow 비율 (flex_ratio-*)' },
...
export const flexItemProps = [
  { name: 'as', type: 'string', default: 'div', description: 'FlexItem이 렌더링할 HTML 요소 (header, aside, section, footer 등)' },
...
export const flexItemSlots = [{ name: 'default', description: 'FlexItem 내부 콘텐츠' }];
