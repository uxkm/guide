import{r as m,u as $e,c as Je,n as Ke,j as e,a as Z,Q as et,T as it}from"./iframe-Ec8Bs185.js";import{A as v}from"./Avatar-BmtskyAp.js";import{w as l}from"./story-renders-Bo_F9MSp.js";import{a as at}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const tt=m.createContext({tag:"ul",variant:"default"}),rt={default:"ul",bullet:"ul",ordered:"ol",definition:"dl"},lt={bullet:"list_bullet",ordered:"list_ordered",definition:"list_definition"},ot=new Set(["md","compact"]),nt=new Set(["default","bullet","ordered","definition"]),ct=new Set(["ul","ol","dl","div"]),dt=new Set(["block","inline"]),mt=new Set(["left","right"]);function s({bordered:i,split:o,block:p,size:k="md",variant:y="default",tag:u,layout:h="block",inlineLabelWidth:L,inlineGap:x,descAlign:_="left",children:A,className:f,style:n,role:c,...g}){const D=m.useRef(null),C=ot.has(k)?k:"md",d=nt.has(y)?y:"default",j=u!=null&&ct.has(u)?u:rt[d]??"ul",b=dt.has(h)?h:"block",S=mt.has(_)?_:"left",w=m.useMemo(()=>{const a=["list"],P=lt[d];return P&&a.push(P),i&&a.push("list_bordered"),o&&a.push("list_divider"),p&&a.push("list_block"),C==="compact"&&a.push("list_compact"),b==="inline"&&a.push("list_inline"),d==="definition"&&S==="right"&&a.push("list_desc-right"),a},[d,i,o,p,C,b,S]);function $(a,P,se){return et("List",a,P,{...se,class:Z(w,se.class)},{defaults:{size:"md",variant:"default",layout:"block",descAlign:"left"},booleanProps:new Set(["bordered","split","block"]),selfClosing:!1})}$e($,{bordered:i,split:o,block:p,size:C,variant:d,tag:u,layout:b,inlineLabelWidth:L,inlineGap:x,descAlign:S},Je({default:A}),D,{className:f,style:n,role:c,...g});const N=m.useMemo(()=>{const a={};return b==="inline"&&(L&&(a["--list-inline-label-width"]=L),x&&(a["--list-inline-gap"]=x)),n&&typeof n=="object"&&!Array.isArray(n)&&Object.assign(a,n),Object.keys(a).length?a:void 0},[b,L,x,n]),I=c!==void 0?c:j==="div"?"list":void 0,J=m.useMemo(()=>({tag:j,variant:d}),[j,d]),{class:te,...K}=g,ee=Ke(K),B=j;return e.jsx(tt.Provider,{value:J,children:e.jsx(B,{ref:D,className:Z(w,f),style:N,role:I,...ee,children:A})})}s.__docgenInfo={description:"",methods:[],displayName:"List",props:{size:{defaultValue:{value:"'md'",computed:!1},required:!1},variant:{defaultValue:{value:"'default'",computed:!1},required:!1},layout:{defaultValue:{value:"'block'",computed:!1},required:!1},descAlign:{defaultValue:{value:"'left'",computed:!1},required:!1}}};const pt=new Set(["auto","li","dt","dd"]);function t({title:i,description:o,meta:p,tag:k="auto",prefix:y,extra:u,actions:h,children:L,className:x,role:_,...A}){const f=m.useRef(null),n=m.useContext(tt)??{tag:"ul"},c=pt.has(k)?k:"auto",g=c==="auto"&&n.tag==="dl"&&!!(i&&o),D=m.useMemo(()=>{if(g)return null;if(c!=="auto")return c;if(n.tag==="dl"){if(i&&!o)return"dt";if(o&&!i)return"dd"}return n.tag==="div"?"div":"li"},[g,c,n.tag,i,o]),C=_!==void 0?_:n.tag==="div"?"listitem":void 0;function d(N,I,J){var B;const te=it(I),K=!!((B=I.prefix)!=null&&B.call(I)),ee=N.tag==="auto"&&n.tag==="dl"&&N.title&&N.description;return et("ListItem",N,I,J,{labelProp:"title",defaults:{tag:"auto"},selfClosing:ee||!K&&!te})}$e(d,{title:i,description:o,meta:p,tag:c},Je({default:L,prefix:y,extra:u,actions:h}),f,{className:x,role:_,...A});const j=!!(i||o||p||L),{class:b,...S}=A,w=Ke(S);if(g)return e.jsxs(m.Fragment,{children:[e.jsx("dt",{ref:f,className:Z("list_title",x),...w,children:i}),e.jsx("dd",{className:"list_desc","data-demo-fragment-part":!0,children:o})]});const $=D||"li";return e.jsxs($,{ref:f,className:Z("list_item",x),role:C,...w,children:[y,j?e.jsx("div",{className:"list_content",children:L??e.jsxs(e.Fragment,{children:[i?e.jsx("span",{className:"list_title",children:i}):null,p?e.jsx("span",{className:"list_meta",children:p}):null,o?e.jsx("span",{className:"list_desc",children:o}):null]})}):null,u?e.jsx("span",{className:"list_extra",children:u}):null,h?e.jsx("span",{className:"list_action",children:h}):null]})}t.__docgenInfo={description:"",methods:[],displayName:"ListItem",props:{tag:{defaultValue:{value:"'auto'",computed:!1},required:!1}}};const st=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ut=[{name:"bordered",type:"boolean",default:"false",description:"테두리 (list_bordered)"},{name:"split",type:"boolean",default:"false",description:"항목 구분선 (list_divider)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100% (list_block, inline 레이아웃에서 auto 너비 덮어씀)"},{name:"size",type:"'md' | 'compact'",default:"md",description:"compact는 list_compact"},{name:"variant",type:"'default' | 'bullet' | 'ordered' | 'definition'",default:"default",description:"목록 유형 — bullet · ordered · definition 스킨 클래스 자동 적용"},{name:"tag",type:"'ul' | 'ol' | 'dl' | 'div'",default:"variant 기준",description:'루트 태그 — 미지정 시 variant에 따라 ul · ol · dl 결정, div는 role="list"'},{name:"layout",type:"'block' | 'inline'",default:"block",description:"block은 전체 너비 세로 배치, inline은 너비 auto + 제목·내용 가로 배치 (list_inline)"},{name:"inlineLabelWidth",type:"string",default:"—",description:'인라인 정의 목록 dt 열 너비 (layout="inline"일 때, --list-inline-label-width)'},{name:"inlineGap",type:"string",default:"—",description:'인라인 정의 목록 dt · dd 열 간격 (layout="inline"일 때, --list-inline-gap)'},{name:"descAlign",type:"'left' | 'right'",default:"left",description:'정의 목록 dd 텍스트 정렬 (variant="definition"일 때, right는 list_desc-right)'},{name:"className",type:"string",default:"—",description:"list 루트에 추가 클래스 (list_bullet 등 스킨 조합)"}],Lt=st,xt=[{name:"title",type:"string",default:"—",description:"항목 제목 (list_title)"},{name:"description",type:"string",default:"—",description:"설명 (list_desc)"},{name:"meta",type:"string",default:"—",description:"보조 메타 (list_meta)"},{name:"tag",type:"'auto' | 'li' | 'dt' | 'dd'",default:"auto",description:"항목 태그 — auto는 ul/ol→li, div→div+role=listitem, dl+title·description→dt·dd"},{name:"className",type:"string",default:"—",description:"항목(li · dt · dd)에 추가 클래스"}],It=[{key:"name",label:"Children"},{key:"description",label:"설명"}],ht=[{name:"children",description:"ListItem 자식 (Vue default 슬롯 대응)"}],_t=[{key:"name",label:"Children / Prop"},{key:"description",label:"설명"}],ft=[{name:"prefix",description:"앞쪽 아바타·아이콘 등 (Vue #prefix 슬롯 대응)"},{name:"title",description:"항목 제목 (list_title)"},{name:"description",description:"설명 (list_desc)"},{name:"meta",description:"보조 메타 (list_meta)"},{name:"extra",description:"우측 보조 텍스트 (Vue #extra 슬롯 대응, list_extra)"},{name:"actions",description:"우측 액션 (Vue #actions 슬롯 대응, list_action)"},{name:"children",description:"본문 (title·description 대체, Vue default 슬롯 대응)"}],gt=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],jt=[{name:"list",description:"리스트 루트"},{name:"list_bordered · list_divider · list_compact",description:"스타일 변형"},{name:"list_bullet · list_bullet-circle · list_bullet-square",description:"불릿 목록 (ul)"},{name:"list_ordered · list_ordered-alpha · list_ordered-roman · list_ordered-upper-alpha · list_ordered-upper-roman",description:"번호 목록 (ol) — 소문자·대문자 알파벳·로마 숫자"},{name:"list_ordered-outline · list_ordered-dash",description:"계층 번호 — 뎁스별 1.1 · 1-1 형식 (중첩 ol에 동일 클래스 적용)"},{name:"list_ordered-depth",description:"뎁스별 번호 형식 자동 전환 (1 → a → i → 1 …)"},{name:"list_definition",description:"정의 목록 (dl) — dt · dd 용어-설명 쌍"},{name:"list_inline",description:'인라인 배치 — width auto, 제목·내용 가로 (layout="inline")'},{name:"list_block",description:"부모 너비 100% (block prop)"},{name:"list_desc-right",description:'정의 목록 dd 우측 정렬 (descAlign="right")'},{name:"list_item",description:"항목 (li · div[role=listitem])"},{name:"list_content · list_title · list_desc · list_meta",description:"항목 콘텐츠 파트"},{name:"list_extra · list_action",description:"우측 영역"},{name:"list_interactive",description:"클릭 가능 항목"},{name:"list_link",description:"항목 링크·버튼 — data-ripple 로 파장"},...at],bt=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Nt=[{name:"--list-gap",default:"var(--space-xs)",description:"항목 간격"},{name:"--list-item-padding-y · --list-item-padding-x",default:"0.65rem · 1rem",description:"항목 패딩"},{name:"--list-title-size · --list-desc-size · --list-meta-size",default:"—",description:"텍스트 크기"},{name:"--list-inline-label-width · --list-inline-gap",default:"8rem · var(--space-md)",description:"인라인 정의 목록 열 너비 · 열 간격"}],vt=e.jsxs("svg",{className:"icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5","aria-hidden":"true",children:[e.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),e.jsx("circle",{cx:"8.5",cy:"8.5",r:"1.5"}),e.jsx("path",{d:"M21 15l-5-5L5 21"})]}),kt=[{title:"API · List Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 inline-label-width · desc-align은 inlineLabelWidth · descAlign로 다룹니다.",tables:[{columns:st,rows:ut,codeColumn:"name"}]},{title:"API · ListItem Props",tables:[{columns:Lt,rows:xt,codeColumn:"name"}]},{title:"API · List Children",description:"Vue default 슬롯은 React children에 대응합니다.",tables:[{columns:It,rows:ht,codeColumn:"name"}]},{title:"API · ListItem Children",description:"Vue prefix · extra · actions · default 슬롯은 React prefix · extra · actions · children prop에 대응합니다.",tables:[{columns:_t,rows:ft,codeColumn:"name"}]},{title:"클래스 · 속성",description:"List · ListItem이 렌더하는 OOCSS 클래스입니다. className으로 스킨 클래스를 조합합니다.",tables:[{columns:gt,rows:jt,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:bt,rows:Nt,codeColumn:"name"}]}],r={bordered:!1,split:!1,block:!1,size:"md",variant:"default",tag:"ul",layout:"block",descAlign:"left"},Dt={title:"Components/데이터 표시/List",id:"components-list",component:s,subcomponents:{ListItem:t},tags:["autodocs"],argTypes:{bordered:{control:"boolean",type:{name:"boolean",summary:"boolean"}},split:{control:"boolean",type:{name:"boolean",summary:"boolean"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},size:{control:"select",options:["md","compact"],type:{name:"enum",summary:"'md' | 'compact'"}},variant:{control:"select",options:["default","bullet","ordered","definition"],type:{name:"enum",summary:"'default' | 'bullet' | 'ordered' | 'definition'"}},tag:{control:"select",options:["ul","ol","dl","div"],type:{name:"enum",summary:"'ul' | 'ol' | 'dl' | 'div'"}},layout:{control:"select",options:["block","inline"],type:{name:"enum",summary:"'block' | 'inline'"}},inlineLabelWidth:{control:"text",type:{name:"string",summary:"string"}},inlineGap:{control:"text",type:{name:"string",summary:"string"}},descAlign:{control:"select",options:["left","right"],type:{name:"enum",summary:"'left' | 'right'"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:kt,docs:{description:{component:"목록·정의 목록·네비게이션 리스트를 구성하는 컴포넌트입니다."}}}},O={parameters:{controls:{disable:!1}},args:{...r},render:i=>e.jsxs(s,{...i,children:[e.jsx(t,{title:"항목 1",description:"설명"}),e.jsx(t,{title:"항목 2",description:"설명"})]})},R={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"list_title · list_meta · list_desc로 항목 내용을 구성합니다."},source:{code:`import Avatar from '@uxkm/ui-react/components/Avatar.jsx';
...
}`,language:"tsx"}}},args:{...r},render:l(e.jsxs(s,{className:"list_bullet",children:[e.jsx(t,{title:"HTML 마크업",description:"시맨틱 태그와 ARIA 속성을 사용합니다."}),e.jsx(t,{title:"SCSS 스타일",description:"OOCSS 패턴으로 구조와 스킨을 분리합니다."}),e.jsx(t,{title:"접근성",description:"WCAG 2.2 AA 기준을 준수합니다."})]}))},V={name:"불릿 변형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"circle · square 마커와 중첩 목록을 지원합니다."},source:{code:`import List from '@uxkm/ui-react/components/List.jsx';
import ListItem from '@uxkm/ui-react/components/ListItem.jsx';
...
}`,language:"tsx"}}},args:{...r},render:l(e.jsxs(e.Fragment,{children:[e.jsxs(s,{className:"list_bullet list_bullet-circle",children:[e.jsx(t,{children:"원형 마커 항목 A"}),e.jsx(t,{children:"원형 마커 항목 B"})]}),e.jsxs(s,{className:"list_bullet list_bullet-square",children:[e.jsx(t,{children:"사각 마커 항목 A"}),e.jsx(t,{children:"사각 마커 항목 B"})]}),e.jsxs(s,{className:"list_bullet",children:[e.jsxs(t,{children:["레이아웃",e.jsxs(s,{className:"list_bullet",children:[e.jsx(t,{children:"Container"}),e.jsx(t,{children:"Grid"})]})]}),e.jsxs(t,{children:["기본 요소",e.jsxs(s,{className:"list_bullet",children:[e.jsx(t,{children:"Button"}),e.jsx(t,{children:"Typography"})]})]})]})]}))},H={name:"번호",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:'tag="ol"과 list_ordered 클래스로 순서 목록을 만듭니다.'},source:{code:`import List from '@uxkm/ui-react/components/List.jsx';
import ListItem from '@uxkm/ui-react/components/ListItem.jsx';
...
}`,...(re=(ae=O.parameters)==null?void 0:ae.docs)==null?void 0:re.source}}};var le,oe,ne;R.parameters={...R.parameters,docs:{...(le=R.parameters)==null?void 0:le.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: false
...
}`,...(ne=(oe=R.parameters)==null?void 0:oe.docs)==null?void 0:ne.source}}};var ce,de,me;E.parameters={...E.parameters,docs:{...(ce=E.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  name: '불릿',
  parameters: {
    controls: {
      disable: false
...
}`,...(me=(de=E.parameters)==null?void 0:de.docs)==null?void 0:me.source}}};var pe,ue,Le;T.parameters={...T.parameters,docs:{...(pe=T.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  name: '불릿 · 본문',
  parameters: {
    controls: {
      disable: false
...
}`,...(Le=(ue=T.parameters)==null?void 0:ue.docs)==null?void 0:Le.source}}};var xe,Ie,he;V.parameters={...V.parameters,docs:{...(xe=V.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  name: '불릿 변형',
  parameters: {
    controls: {
      disable: false
...
}`,...(he=(Ie=V.parameters)==null?void 0:Ie.docs)==null?void 0:he.source}}};var _e,fe,ge;H.parameters={...H.parameters,docs:{...(_e=H.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  name: '번호',
  parameters: {
    controls: {
      disable: false
...
}`,...(ge=(fe=H.parameters)==null?void 0:fe.docs)==null?void 0:ge.source}}};var je,be,Ne;G.parameters={...G.parameters,docs:{...(je=G.parameters)==null?void 0:je.docs,source:{originalSource:`{
  name: '번호 변형',
  parameters: {
    controls: {
      disable: false
...
}`,...(Ne=(be=G.parameters)==null?void 0:be.docs)==null?void 0:Ne.source}}};var ve,ke,ye;W.parameters={...W.parameters,docs:{...(ve=W.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  name: '번호 · 계층',
  parameters: {
    controls: {
      disable: false
...
}`,...(ye=(ke=W.parameters)==null?void 0:ke.docs)==null?void 0:ye.source}}};var Ae,Ce,Se;z.parameters={...z.parameters,docs:{...(Ae=z.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  name: '불릿 · 링크',
  parameters: {
    controls: {
      disable: false
...
}`,...(Se=(Ce=z.parameters)==null?void 0:Ce.docs)==null?void 0:Se.source}}};var we,De,Be;U.parameters={...U.parameters,docs:{...(we=U.parameters)==null?void 0:we.docs,source:{originalSource:`{
  name: '테두리',
  parameters: {
    controls: {
      disable: false
...
}`,...(Be=(De=U.parameters)==null?void 0:De.docs)==null?void 0:Be.source}}};var Pe,Oe,Re;q.parameters={...q.parameters,docs:{...(Pe=q.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  name: '링크',
  parameters: {
    controls: {
      disable: false
...
}`,...(Re=(Oe=q.parameters)==null?void 0:Oe.docs)==null?void 0:Re.source}}};var Ee,Te,Ve;M.parameters={...M.parameters,docs:{...(Ee=M.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  name: '버튼',
  parameters: {
    controls: {
      disable: false
...
}`,...(Ve=(Te=M.parameters)==null?void 0:Te.docs)==null?void 0:Ve.source}}};var He,Ge,We;F.parameters={...F.parameters,docs:{...(He=F.parameters)==null?void 0:He.docs,source:{originalSource:`{
  name: '카드 혼합',
  parameters: {
    controls: {
      disable: false
...
}`,...(We=(Ge=F.parameters)==null?void 0:Ge.docs)==null?void 0:We.source}}};var ze,Ue,qe;X.parameters={...X.parameters,docs:{...(ze=X.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  name: '정의 목록',
  parameters: {
    controls: {
      disable: false
...
}`,...(qe=(Ue=X.parameters)==null?void 0:Ue.docs)==null?void 0:qe.source}}};var Me,Fe,Xe;Q.parameters={...Q.parameters,docs:{...(Me=Q.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  name: '정의 목록 · 인라인',
  parameters: {
    controls: {
      disable: false
...
}`,...(Xe=(Fe=Q.parameters)==null?void 0:Fe.docs)==null?void 0:Xe.source}}};var Qe,Ye,Ze;Y.parameters={...Y.parameters,docs:{...(Qe=Y.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  name: '정의 목록 · 값 우측 정렬',
  parameters: {
    controls: {
      disable: false
...
}`,...(Ze=(Ye=Y.parameters)==null?void 0:Ye.docs)==null?void 0:Ze.source}}};const Bt=["Playground","Basic","Bullet","BulletRich","BulletVariant","Ordered","OrderedVariant","OrderedHierarchical","BulletLink","Bordered","Link","Button","Card","Definition","DefinitionInline","DefinitionDescAlign"];export{R as Basic,U as Bordered,E as Bullet,z as BulletLink,T as BulletRich,V as BulletVariant,M as Button,F as Card,X as Definition,Y as DefinitionDescAlign,Q as DefinitionInline,q as Link,H as Ordered,W as OrderedHierarchical,G as OrderedVariant,O as Playground,Bt as __namedExportsOrder,Dt as default};
