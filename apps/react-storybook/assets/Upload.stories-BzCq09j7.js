import{r as h,d as _a,y as ga,a as L,n as ba,j as a,I as e,B as o}from"./iframe-Ec8Bs185.js";import{a as j}from"./avatar-sample-Dq40Sw96.js";import{A as fa}from"./Avatar-BmtskyAp.js";import{w as l}from"./story-renders-Bo_F9MSp.js";import{g as xa,a as va}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const Na=new Set(["button","drag","list","picture-card","avatar"]),ha=new Set(["sm","md","lg"]);function s({ripple:i,variant:y="button",disabled:d,fit:v,size:z="md",multiple:I,accept:U,inputId:B,hint:n,dragover:N,error:p,trigger:ea,cards:sa,children:k,className:w,onChange:C,...P}){const S=h.useRef(null),{rippleAttrs:ra,childRippleAttrs:na}=_a({ripple:i},{mode:"container"}),r=Na.has(y)?y:"button",c=ha.has(z)?z:"md";ga({ripple:i,variant:r,disabled:d,fit:v,size:c,multiple:I,accept:U,inputId:B,hint:typeof n=="string"?n:void 0,dragover:N,error:p},S,{className:w,onChange:C,...P});const oa=h.useMemo(()=>{const t=["upload"];return v&&t.push("upload_fit"),c==="sm"&&t.push("upload_sm"),c==="lg"&&t.push("upload_lg"),d&&t.push("is-disabled"),t},[v,c,d]),la=h.useMemo(()=>r==="drag"?L("upload_dropzone",N&&"is-dragover",p&&"is-error"):r==="picture-card"?"upload_card upload_card-trigger":r==="avatar"?"upload_avatar":"upload_trigger",[r,N,p]),{class:Sa,onChange:La,...ta}=P,ia=ba(ta),da=r!=="list",pa=r==="button"||r==="drag",ca=r==="list"||k!=null,ma=r==="picture-card",ua=typeof n=="string"||n==null?n?a.jsx("p",{className:"upload_hint",children:n}):null:n;return a.jsxs("div",{ref:S,className:L(oa,w),...ra,children:[da?a.jsxs("label",{className:la,"data-demo-slot":"trigger",...na,children:[a.jsx("input",{id:B||void 0,type:"file",className:"upload_input",tabIndex:-1,disabled:d,multiple:I||void 0,accept:U||void 0,"aria-invalid":p?"true":void 0,onChange:C,...ia}),ea]}):null,pa?a.jsx("div",{"data-demo-slot":"hint",children:ua}):null,ca?a.jsx("div",{"data-demo-slot":"default",children:k}):null,ma?a.jsx("div",{className:"upload_cards","data-demo-slot":"cards",children:sa}):null]})}s.__docgenInfo={description:"",methods:[],displayName:"Upload",props:{variant:{defaultValue:{value:"'button'",computed:!1},required:!1},size:{defaultValue:{value:"'md'",computed:!1},required:!1}}};const ja=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ya=[{name:"variant",type:"'button' | 'drag' | 'list' | 'picture-card' | 'avatar'",default:"button",description:"업로드 UI 유형"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"upload_sm · upload_lg"},{name:"disabled",type:"boolean",default:"false",description:"비활성 (is-disabled)"},{name:"fit",type:"boolean",default:"false",description:"콘텐츠 너비 (upload_fit)"},{name:"multiple",type:"boolean",default:"false",description:"다중 파일 선택"},{name:"accept",type:"string",default:"—",description:"input accept 속성"},{name:"inputId",type:"string",default:"—",description:"file input id"},{name:"hint",type:"string",default:"—",description:"button·drag variant 힌트 텍스트"},{name:"dragover",type:"boolean",default:"false",description:"드래그 오버 상태 (is-dragover)"},{name:"error",type:"boolean",default:"false",description:"오류 (is-error)"},{name:"className",type:"string",default:"—",description:"upload 루트에 추가 클래스"},{name:"trigger",type:"ReactNode",default:"—",description:"업로드 트리거 UI (children 대체)"},{name:"cards",type:"ReactNode",default:"—",description:"이미지 카드 그리드 콘텐츠"},xa],za=[{key:"name",label:"Children"},{key:"description",label:"설명"}],Ia=[{name:"trigger",description:"업로드 트리거 UI (button·drag·picture-card·avatar)"},{name:"hint",description:"힌트 텍스트 (hint prop 대체)"},{name:"default",description:"파일 목록 (list variant)"},{name:"cards",description:"이미지 카드 그리드 (picture-card)"}],Ua=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ba=[{name:"upload",description:"루트"},{name:"upload_sm · upload_lg · upload_fit",description:"크기·너비"},{name:"upload_trigger · upload_dropzone · upload_input",description:"button·drag 트리거"},{name:"upload_card · upload_cards · upload_avatar",description:"picture-card·avatar"},{name:"upload_list · upload_item · upload_item-info",description:"목록 variant"},{name:"upload_hint · upload_progress",description:"힌트·진행률"},{name:"is-dragover · is-error · is-disabled",description:"상태"},...va],ka=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],wa=[{name:"--upload-max-width",default:"var(--input-max-width)",description:"최대 너비"},{name:"--upload-dropzone-padding · --upload-dropzone-icon-size",default:"—",description:"드롭존"},{name:"--upload-card-size · --upload-list-gap",default:"6.5rem · var(--space-xs)",description:"카드·목록"}],Ca=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 input-id · picture-card는 inputId · picture-card로 다룹니다.",tables:[{columns:ja,rows:ya,codeColumn:"name"}]},{title:"API · Children",description:"Vue 슬롯에 대응하는 React prop·children입니다.",tables:[{columns:za,rows:Ia,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Ua,rows:Ba,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:ka,rows:wa,codeColumn:"name"}]}],Pa={variant:"button",disabled:!1,fit:!1,size:"md",multiple:!1,accept:"",inputId:"",hint:"",dragover:!1,error:!1},Ea={title:"Components/폼/Upload",id:"components-upload",component:s,tags:["autodocs"],argTypes:{variant:{control:"select",options:["button","drag","list","picture-card","avatar"],type:{name:"enum",summary:"'button' | 'drag' | 'list' | 'picture-card' | 'avatar'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},fit:{control:"boolean",type:{name:"boolean",summary:"boolean"}},size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},multiple:{control:"boolean",type:{name:"boolean",summary:"boolean"}},accept:{control:"text",type:{name:"string",summary:"string"}},inputId:{control:"text",type:{name:"string",summary:"string"}},hint:{control:"text",type:{name:"string",summary:"string"}},dragover:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Ca,docs:{description:{component:"파일 업로드 UI를 구성하는 Upload 컴포넌트입니다."}}}},m={parameters:{controls:{disable:!1}},args:{...Pa},render:i=>a.jsx(s,{...i,trigger:a.jsx("span",{className:"btn btn_outline color_primary",children:a.jsx("span",{className:"btn_label",children:"파일 선택"})})})},u={name:"버튼 업로드",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"`label.upload_trigger` 안에 `span.btn`으로 버튼 스킨을 적용합니다. `button` 요소는 label 안에 넣지 않습니다."},source:{code:`import Upload from '@uxkm/ui-react/components/Upload.jsx';
...
}`,language:"tsx"}}},render:l(a.jsx(s,{variant:"picture-card",accept:"image/*",hint:"최대 5장 · JPG, PNG",trigger:a.jsxs(a.Fragment,{children:[a.jsx(e,{name:"plus",size:"lg"}),a.jsx("span",{children:"업로드"})]}),cards:a.jsxs(a.Fragment,{children:[a.jsxs("div",{className:"upload_card",children:[a.jsx("img",{className:"upload_card-image",src:j,alt:"미리보기 1"}),a.jsxs("div",{className:"upload_card-actions",children:[a.jsx(o,{variant:"ghost",iconOnly:!0,size:"sm",ariaLabel:"미리보기",iconBefore:a.jsx(e,{name:"eye"})}),a.jsx(o,{variant:"ghost",iconOnly:!0,size:"sm",ariaLabel:"삭제",iconBefore:a.jsx(e,{name:"trash"})})]})]}),a.jsxs("div",{className:"upload_card",children:[a.jsx("img",{className:"upload_card-image",src:j,alt:"미리보기 2"}),a.jsxs("div",{className:"upload_card-actions",children:[a.jsx(o,{variant:"ghost",iconOnly:!0,size:"sm",ariaLabel:"미리보기",iconBefore:a.jsx(e,{name:"eye"})}),a.jsx(o,{variant:"ghost",iconOnly:!0,size:"sm",ariaLabel:"삭제",iconBefore:a.jsx(e,{name:"trash"})})]})]})]})}))},f={name:"아바타 업로드",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"`upload_avatar`로 프로필 이미지 변경 UI를 구성합니다. Avatar 컴포넌트와 조합합니다."},source:{code:`import { avatarSample } from '@images';
...
}`,...(F=(D=m.parameters)==null?void 0:D.docs)==null?void 0:F.source}}};var A,R,M;u.parameters={...u.parameters,docs:{...(A=u.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: '버튼 업로드',
  parameters: {
    controls: {
      disable: false
...
}`,...(M=(R=u.parameters)==null?void 0:R.docs)==null?void 0:M.source}}};var E,G,J;_.parameters={..._.parameters,docs:{...(E=_.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: '드래그 앤 드롭',
  parameters: {
    controls: {
      disable: false
...
}`,...(J=(G=_.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var V,T,X;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: '파일 목록',
  parameters: {
    controls: {
      disable: false
...
}`,...(X=(T=g.parameters)==null?void 0:T.docs)==null?void 0:X.source}}};var q,H,Z;b.parameters={...b.parameters,docs:{...(q=b.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: '사진 카드',
  parameters: {
    controls: {
      disable: false
...
}`,...(Z=(H=b.parameters)==null?void 0:H.docs)==null?void 0:Z.source}}};var K,Q,W;f.parameters={...f.parameters,docs:{...(K=f.parameters)==null?void 0:K.docs,source:{originalSource:`{
  name: '아바타 업로드',
  parameters: {
    controls: {
      disable: false
...
}`,...(W=(Q=f.parameters)==null?void 0:Q.docs)==null?void 0:W.source}}};var Y,$,aa;x.parameters={...x.parameters,docs:{...(Y=x.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  name: '폼 필드',
  parameters: {
    controls: {
      disable: false
...
}`,...(aa=($=x.parameters)==null?void 0:$.docs)==null?void 0:aa.source}}};const Ga=["Playground","ButtonDemo","Dropzone","ListDemo","Card","AvatarDemo","Form"];export{f as AvatarDemo,u as ButtonDemo,b as Card,_ as Dropzone,x as Form,g as ListDemo,m as Playground,Ga as __namedExportsOrder,Ea as default};
