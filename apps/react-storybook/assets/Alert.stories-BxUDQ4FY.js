...
}`,language:"tsx"}}},render:t(e.jsxs(e.Fragment,{children:[e.jsx(r,{color:"info",title:"정보",description:"변경 사항이 저장되었습니다."}),e.jsx(r,{color:"success",title:"성공",description:"요청이 성공적으로 처리되었습니다."}),e.jsx(r,{color:"warning",title:"주의",description:"세션이 곧 만료됩니다. 저장해 주세요."}),e.jsx(r,{color:"danger",title:"오류",description:"네트워크 연결을 확인해 주세요."})]}))},m={name:"설명만",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"제목 없이 alert_desc만으로 짧은 메시지를 표시합니다."},source:{code:`import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
}`,language:"tsx"}}},render:t(e.jsxs(e.Fragment,{children:[e.jsx(r,{showIcon:!1,color:"warning",title:"점검 안내",description:"오늘 02:00~04:00 서비스 점검이 예정되어 있습니다."}),e.jsx(r,{showIcon:!1,color:"info",description:"이 페이지는 데모 목적으로만 사용됩니다."})]}))},p={name:"크기",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"alert_sm · alert_lg로 스케일을 조절합니다."},source:{code:`import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
}`,language:"tsx"}}},render:t(e.jsxs(e.Fragment,{children:[e.jsx(r,{size:"sm",color:"info",title:"Small",description:"폼 필드 아래 등 좁은 영역에 사용합니다."}),e.jsx(r,{color:"info",title:"Medium",description:"기본 크기입니다."}),e.jsx(r,{size:"lg",color:"info",title:"Large",description:"페이지 상단 등 눈에 띄는 안내에 사용합니다."})]}))},u={name:"닫기 가능",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"alert_close 버튼으로 사용자가 알림을 닫을 수 있습니다. aria-label로 닫기 동작을 설명합니다."},source:{code:`import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
}`,language:"tsx"}}},render:t(e.jsxs(e.Fragment,{children:[e.jsx(r,{closable:!0,color:"info",title:"새 소식",description:"대시보드가 새롭게 개편되었습니다."}),e.jsx(r,{closable:!0,color:"warning",description:"브라우저가 오래되었습니다. 최신 버전으로 업데이트해 주세요."})]}))},f={name:"액션",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"alert_actions로 확인·취소 등 후속 동작 버튼을 배치합니다."},source:{code:`import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
}`,language:"tsx"}}},render:t(e.jsxs(e.Fragment,{children:[e.jsx(r,{color:"danger",title:"저장 실패",description:"변경 사항을 저장하지 못했습니다. 다시 시도해 주세요.",actions:e.jsxs("div",{className:"alert_actions",children:[e.jsx(A,{variant:"filled",color:"danger",size:"sm",label:"다시 시도"}),e.jsx(A,{variant:"ghost",size:"sm",label:"취소"})]})}),e.jsx(r,{color:"info",title:"이용 약관 변경",description:"2026년 3월 1일부터 새 약관이 적용됩니다.",actions:e.jsxs("div",{className:"alert_actions",children:[e.jsx(ae,{href:"#",size:"sm",label:"약관 보기"}),e.jsx(A,{variant:"text",color:"primary",size:"sm",label:"동의하기"})]})})]}))},x={name:"배너",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"alert_banner로 페이지 상단 전체 너비 알림을 표시합니다. 좌우 테두리와 모서리 반경을 제거합니다."},source:{code:`import Alert from '@uxkm/ui-react/components/Alert.jsx';
...
}`,language:"tsx"}}},render:t(e.jsx(r,{className:"alert_banner",color:"warning",closable:!0,description:"시스템 점검으로 일부 기능이 제한될 수 있습니다."}))},g={name:"문맥 속 사용",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"폼·카드 등 다른 컴포넌트와 함께 사용합니다. 설명 안에 링크를 포함할 수 있습니다."},source:{code:`import Alert from '@uxkm/ui-react/components/Alert.jsx';
import Link from '@uxkm/ui-react/components/Link.jsx';
...
}`,language:"tsx"}}},render:t(e.jsxs(e.Fragment,{children:[e.jsxs(r,{color:"info",title:"업데이트 안내",children:["새 버전이 출시되었습니다. ",e.jsx(ae,{href:"#",size:"sm",label:"릴리스 노트 보기"})]}),e.jsxs("form",{className:"form_layout",noValidate:!0,children:[e.jsx(r,{color:"danger",title:"입력 내용을 확인해 주세요",description:"이메일 형식과 비밀번호 조건을 수정한 뒤 다시 시도해 주세요."}),e.jsxs("div",{className:"form_field",children:[e.jsx("label",{className:"form_label",htmlFor:"alert-ex-email",children:"이메일"}),e.jsx("input",{type:"email",className:"input is-error",id:"alert-ex-email",defaultValue:"invalid-email","aria-invalid":"true"})]})]})]}))};var I,L,E;n.parameters={...n.parameters,docs:{...(I=n.parameters)==null?void 0:I.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(E=(L=n.parameters)==null?void 0:L.docs)==null?void 0:E.source}}};var R,D,V;c.parameters={...c.parameters,docs:{...(R=c.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: false
...
}`,...(re=(ee=x.parameters)==null?void 0:ee.docs)==null?void 0:re.source}}};var te,oe,se;g.parameters={...g.parameters,docs:{...(te=g.parameters)==null?void 0:te.docs,source:{originalSource:`{
  name: '문맥 속 사용',
  parameters: {
    controls: {
      disable: false
...
}`,...(se=(oe=g.parameters)==null?void 0:oe.docs)==null?void 0:se.source}}};const Je=["Playground","Basic","DescOnly","NoIcon","Size","Close","Actions","Banner","Context"];export{f as Actions,x as Banner,c as Basic,u as Close,g as Context,m as DescOnly,d as NoIcon,n as Playground,p as Size,Je as __namedExportsOrder,Ge as default};
