import{j as a,B as c}from"./iframe-Ec8Bs185.js";import{A as na}from"./Avatar-BmtskyAp.js";import{C as i,a as r,b as o,c as e,S as ma}from"./Stat-CUh9KOnM.js";import{T as k}from"./Tag-B1xbtJCd.js";import{T as pa}from"./TagGroup-C5ZtGGKW.js";import{w as s}from"./story-renders-Bo_F9MSp.js";import{c as Ca,a as ua}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const b=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],xa=[{name:"variant",type:"'bordered' | 'shadow' | 'flat'",default:"bordered",description:"카드 스킨. flat은 card_ghost"},{name:"size",type:"'sm' | 'md' | 'lg' | 'compact'",default:"md",description:"card_sm · card_lg · card_compact"},{name:"hoverable",type:"boolean",default:"false",description:"호버 상승 효과 (card_hover)"},{name:"title",type:"string",default:"—",description:"내장 헤더 제목 (CardHeader 없이 사용 시)"},{name:"subtitle",type:"string",default:"—",description:"내장 헤더 부제"},{name:"tag",type:"string",default:"article",description:"루트 HTML 태그"},Ca],ha=b,ya=[{name:"title",type:"string",default:"—",description:"제목 (card_title)"},{name:"subtitle",type:"string",default:"—",description:"부제 (card_subtitle)"}],va=b,_a=[{name:"between",type:"boolean",default:"false",description:"양끝 정렬 (card_footer-between)"}],l=[{key:"name",label:"Children / Prop"},{key:"description",label:"설명"}],Ba=[{name:"media",description:"상단 미디어 영역 (Vue #media 슬롯 대응, card_media)"},{name:"header",description:"헤더 콘텐츠 (Vue #header 슬롯 대응, title·subtitle prop 대체)"},{name:"extra",description:"헤더 우측 액션 (Vue #extra 슬롯 대응, card_extra)"},{name:"children",description:"CardBody · CardFooter 등 (Vue default 슬롯 대응)"}],fa=[{name:"children",description:"헤더 메인 콘텐츠 (title·subtitle prop 대체)"},{name:"extra",description:"헤더 우측 액션 (Vue #extra 슬롯 대응)"}],ga=[{name:"children",description:"카드 본문 (Vue default 슬롯 대응)"}],ka=[{name:"children",description:"카드 푸터 (Vue default 슬롯 대응)"}],ba=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],ja=[{name:"card",description:"카드 루트"},{name:"card_shadow · card_ghost · card_borderless",description:"스킨 변형"},{name:"card_sm · card_lg · card_compact",description:"크기·패딩"},{name:"card_hover · card_clickable · card_accent",description:"인터랙션·강조"},{name:"card_header · card_body · card_footer · card_media",description:"구조 파트"},{name:"card_title · card_subtitle · card_extra",description:"헤더 파트"},{name:"card_footer-between",description:"푸터 양끝 정렬"},{name:"card_deck · card_deck-2 · card_deck-3",description:"카드 그리드"},{name:"is-disabled",description:"비활성 상태"},...ua],Na=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],wa=[{name:"--card-padding · --card-padding-sm · --card-padding-lg",default:"—",description:"카드 패딩"},{name:"--card-radius · --card-border-color · --card-shadow",default:"—",description:"모서리·테두리·그림자"},{name:"--card-title-size · --card-subtitle-size",default:"—",description:"제목·부제 타이포"},{name:"--card-accent-width · --card-hover-translate",default:"3px · -2px",description:"강조선·호버 이동"}],za=a.jsxs("svg",{className:"icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5","aria-hidden":"true",children:[a.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),a.jsx("circle",{cx:"8.5",cy:"8.5",r:"1.5"}),a.jsx("path",{d:"M21 15l-5-5L5 21"})]}),Ha=a.jsxs("svg",{className:"icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5","aria-hidden":"true",children:[a.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),a.jsx("path",{d:"M14 2v6h6"})]}),Sa=a.jsx("svg",{className:"icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:a.jsx("path",{d:"M13 2L3 14h9l-1 8 10-12h-9l1-8z"})}),Fa=a.jsx("svg",{className:"icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:a.jsx("path",{d:"M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"})}),Aa=a.jsxs("svg",{className:"icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:[a.jsx("circle",{cx:"12",cy:"12",r:"1"}),a.jsx("circle",{cx:"19",cy:"12",r:"1"}),a.jsx("circle",{cx:"5",cy:"12",r:"1"})]}),Pa=[{title:"API · Card Props",description:"React에서는 camelCase prop을 사용합니다. Vue media · header · extra 슬롯은 media · header · extra prop에 대응합니다.",tables:[{columns:b,rows:xa,codeColumn:"name"}]},{title:"API · CardHeader Props",tables:[{columns:ha,rows:ya,codeColumn:"name"}]},{title:"API · CardFooter Props",tables:[{columns:va,rows:_a,codeColumn:"name"}]},{title:"API · Card Children",description:"Vue 슬롯(media · header · extra · default)에 대응하는 React prop·children입니다.",tables:[{columns:l,rows:Ba,codeColumn:"name"}]},{title:"API · CardHeader Children",description:"Vue default · extra 슬롯에 대응하는 React children·extra prop입니다.",tables:[{columns:l,rows:fa,codeColumn:"name"}]},{title:"API · CardBody Children",description:"Vue default 슬롯에 대응하는 React children입니다.",tables:[{columns:l,rows:ga,codeColumn:"name"}]},{title:"API · CardFooter Children",description:"Vue default 슬롯에 대응하는 React children입니다.",tables:[{columns:l,rows:ka,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ba,rows:ja,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Na,rows:wa,codeColumn:"name"}]}],d={variant:"bordered",size:"md",hoverable:!1,title:"제목",subtitle:"부제목",tag:"article"},La={title:"Components/데이터 표시/Card",id:"components-card",component:e,subcomponents:{CardHeader:o,CardBody:r,CardFooter:i},tags:["autodocs"],argTypes:{variant:{control:"select",options:["bordered","shadow","flat"],type:{name:"enum",summary:"'bordered' | 'shadow' | 'flat'"}},size:{control:"select",options:["sm","md","lg","compact"],type:{name:"enum",summary:"'sm' | 'md' | 'lg' | 'compact'"}},hoverable:{control:"boolean",type:{name:"boolean",summary:"boolean"}},title:{control:"text",type:{name:"string",summary:"string"}},subtitle:{control:"text",type:{name:"string",summary:"string"}},tag:{control:"select",options:["article","section","div"],type:{name:"enum",summary:"'article' | 'section' | 'div'"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Pa,docs:{description:{component:"콘텐츠 블록을 담는 카드 컴포넌트입니다."}}}},n={parameters:{controls:{disable:!1}},args:{...d},render:t=>a.jsxs(e,{...t,children:[a.jsx(o,{title:"카드 제목"}),a.jsx(r,{children:a.jsx("p",{children:"카드 본문입니다."})})]})},m={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"card_header · card_body · card_footer 구조를 가집니다."},source:{code:`import Button from '@uxkm/ui-react/components/Button.jsx';
...
}`,language:"tsx"}}},args:{...d},render:s(a.jsxs(e,{style:{maxWidth:360,width:"100%"},children:[a.jsx(o,{title:"카드 제목",subtitle:"부제목 또는 메타 정보"}),a.jsx(r,{children:"카드 본문 영역입니다. 관련 콘텐츠, 설명, 데이터를 담을 수 있습니다."}),a.jsxs(i,{children:[a.jsx(c,{variant:"filled",color:"primary",size:"sm",label:"확인"}),a.jsx(c,{variant:"ghost",size:"sm",label:"취소"})]})]}))},p={name:"간단",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"header나 footer 없이 body만 사용하는 단순 카드입니다."},source:{code:`import Card from '@uxkm/ui-react/components/Card.jsx';
import CardBody from '@uxkm/ui-react/components/CardBody.jsx';
...
}`,language:"tsx"}}},args:{...d},render:s(a.jsxs("div",{className:"card_deck card_deck-2",children:[a.jsxs(e,{size:"sm",children:[a.jsx(o,{title:"Small"}),a.jsx(r,{children:"작은 카드 — 좁은 패딩과 작은 제목."})]}),a.jsxs(e,{children:[a.jsx(o,{title:"Medium"}),a.jsx(r,{children:"기본 크기 카드입니다."})]}),a.jsxs(e,{size:"lg",children:[a.jsx(o,{title:"Large"}),a.jsx(r,{children:"큰 카드 — 넓은 패딩과 큰 제목."})]})]}))},x={name:"강조 테두리",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"card_accent와 color_*로 왼쪽 강조선을 적용합니다."},source:{code:`import Card from '@uxkm/ui-react/components/Card.jsx';
import CardBody from '@uxkm/ui-react/components/CardBody.jsx';
...
}`,language:"tsx"}}},args:{...d},render:s(a.jsxs(e,{hoverable:!0,variant:"shadow",style:{maxWidth:320,width:"100%"},media:a.jsx("div",{className:"card_media card_media-placeholder",role:"img","aria-label":"프로젝트 썸네일",children:za}),children:[a.jsxs(o,{children:[a.jsxs("div",{className:"card_header-row",children:[a.jsx("h3",{className:"card_title",children:"프로젝트 Alpha"}),a.jsx(k,{size:"sm",color:"primary",label:"진행 중"})]}),a.jsx("p",{className:"card_subtitle",children:"업데이트 · 2일 전"})]}),a.jsx(r,{children:"디자인 시스템 구축 및 컴포넌트 라이브러리 개발 프로젝트입니다."}),a.jsxs(i,{between:!0,children:[a.jsx("span",{className:"color_muted size_sm",children:"3명 참여"}),a.jsx(c,{variant:"text",color:"primary",size:"sm",label:"자세히"})]})]}))},y={name:"가로",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"card_horizontal로 미디어와 콘텐츠를 나란히 배치합니다. card_inner로 본문을 감쌉니다."},source:{code:`import Card from '@uxkm/ui-react/components/Card.jsx';
import CardBody from '@uxkm/ui-react/components/CardBody.jsx';
import CardFooter from '@uxkm/ui-react/components/CardFooter.jsx';
import CardHeader from '@uxkm/ui-react/components/CardHeader.jsx';
...
}`,language:"tsx"}}},args:{...d},render:s(a.jsx(e,{className:"card_horizontal",variant:"shadow",style:{maxWidth:480,width:"100%"},media:a.jsx("div",{className:"card_media card_media-placeholder",role:"img","aria-label":"문서 썸네일",children:Ha}),children:a.jsxs("div",{className:"card_inner",children:[a.jsx(o,{title:"가이드 문서"}),a.jsx(r,{children:"HTML 컴포넌트 사용법과 접근성 가이드를 확인하세요."}),a.jsx(i,{children:a.jsx("a",{href:"#",className:"link color_primary size_sm",onClick:t=>t.preventDefault(),children:"문서 보기"})})]})}))},v={name:"아이콘 · 통계",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"card_icon · card_stat으로 기능 소개·지표 카드를 구성합니다."},source:{code:`import Card from '@uxkm/ui-react/components/Card.jsx';
import CardBody from '@uxkm/ui-react/components/CardBody.jsx';
...
}`,language:"tsx"}}},args:{...d},render:s(a.jsxs(e,{variant:"shadow",style:{maxWidth:320,width:"100%"},children:[a.jsx(o,{extra:a.jsx(c,{variant:"ghost",size:"sm",iconOnly:!0,ariaLabel:"더 보기",iconBefore:Aa}),children:a.jsxs("div",{className:"card_header-row",children:[a.jsx(na,{color:"primary",initials:"홍",ariaHidden:!0}),a.jsxs("div",{children:[a.jsx("h3",{className:"card_title",children:"홍길동"}),a.jsx("p",{className:"card_subtitle",children:"프론트엔드 개발자"})]})]})}),a.jsx(r,{children:a.jsxs(pa,{tight:!0,children:[a.jsx(k,{size:"sm",color:"primary",label:"React"}),a.jsx(k,{size:"sm",color:"primary",label:"TypeScript"}),a.jsx(k,{size:"sm",color:"default",label:"SCSS"})]})}),a.jsxs(i,{between:!0,children:[a.jsx("span",{className:"color_muted size_sm",children:"서울 · 온라인"}),a.jsx(c,{variant:"outline",color:"primary",size:"sm",label:"팔로우"})]})]}))},B={name:"클릭 가능",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"a 태그 또는 card_clickable로 전체 카드를 링크·버튼으로 만듭니다. hoverable과 함께 사용합니다."},source:{code:`import Card from '@uxkm/ui-react/components/Card.jsx';
import CardBody from '@uxkm/ui-react/components/CardBody.jsx';
...
}`,language:"tsx"}}},args:{...d},render:s(a.jsx(e,{className:"is-disabled",style:{maxWidth:280,width:"100%"},children:a.jsxs(r,{children:[a.jsx("h3",{className:"card_title",children:"비활성 카드"}),a.jsx("p",{className:"card_subtitle",children:"현재 이용할 수 없습니다."})]})}))},g={name:"카드 그리드",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"card_deck으로 여러 카드를 그리드로 배치합니다. card_deck-2 · card_deck-3로 열 수를 조절합니다."},source:{code:`import Card from '@uxkm/ui-react/components/Card.jsx';
import CardBody from '@uxkm/ui-react/components/CardBody.jsx';
import CardHeader from '@uxkm/ui-react/components/CardHeader.jsx';
...
}`,language:"tsx"}}},args:{...d},render:s(a.jsxs("div",{className:"card_deck",children:[a.jsxs(e,{hoverable:!0,children:[a.jsx(o,{title:"Feature A"}),a.jsx(r,{children:"빠른 성능과 가벼운 번들 크기."})]}),a.jsxs(e,{hoverable:!0,children:[a.jsx(o,{title:"Feature B"}),a.jsx(r,{children:"접근성을 고려한 마크업 구조."})]}),a.jsxs(e,{hoverable:!0,children:[a.jsx(o,{title:"Feature C"}),a.jsx(r,{children:"Pure SCSS로 커스터마이즈 가능."})]})]}))};var j,N,w;n.parameters={...n.parameters,docs:{...(j=n.parameters)==null?void 0:j.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(w=(N=n.parameters)==null?void 0:N.docs)==null?void 0:w.source}}};var z,H,S;m.parameters={...m.parameters,docs:{...(z=m.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: false
...
}`,...(S=(H=m.parameters)==null?void 0:H.docs)==null?void 0:S.source}}};var F,A,P;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: '간단',
  parameters: {
    controls: {
      disable: false
...
}`,...(P=(A=p.parameters)==null?void 0:A.docs)==null?void 0:P.source}}};var T,W,I;C.parameters={...C.parameters,docs:{...(T=C.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: '스킨',
  parameters: {
    controls: {
      disable: false
...
}`,...(I=(W=C.parameters)==null?void 0:W.docs)==null?void 0:I.source}}};var M,D,E;u.parameters={...u.parameters,docs:{...(M=u.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: '크기',
  parameters: {
    controls: {
      disable: false
...
}`,...(E=(D=u.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};var R,G,L;x.parameters={...x.parameters,docs:{...(R=x.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: '강조 테두리',
  parameters: {
    controls: {
      disable: false
...
}`,...(L=(G=x.parameters)==null?void 0:G.docs)==null?void 0:L.source}}};var V,O,K;h.parameters={...h.parameters,docs:{...(V=h.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: '미디어',
  parameters: {
    controls: {
      disable: false
...
}`,...(K=(O=h.parameters)==null?void 0:O.docs)==null?void 0:K.source}}};var q,J,Q;y.parameters={...y.parameters,docs:{...(q=y.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: '가로',
  parameters: {
    controls: {
      disable: false
...
}`,...(aa=($=_.parameters)==null?void 0:$.docs)==null?void 0:aa.source}}};var ra,ea,da;B.parameters={...B.parameters,docs:{...(ra=B.parameters)==null?void 0:ra.docs,source:{originalSource:`{
  name: '클릭 가능',
  parameters: {
    controls: {
      disable: false
...
}`,...(da=(ea=B.parameters)==null?void 0:ea.docs)==null?void 0:da.source}}};var oa,sa,ta;f.parameters={...f.parameters,docs:{...(oa=f.parameters)==null?void 0:oa.docs,source:{originalSource:`{
  name: '비활성',
  parameters: {
    controls: {
      disable: false
...
}`,...(ta=(sa=f.parameters)==null?void 0:sa.docs)==null?void 0:ta.source}}};var ca,ia,la;g.parameters={...g.parameters,docs:{...(ca=g.parameters)==null?void 0:ca.docs,source:{originalSource:`{
  name: '카드 그리드',
  parameters: {
    controls: {
      disable: false
...
}`,...(la=(ia=g.parameters)==null?void 0:ia.docs)==null?void 0:la.source}}};const Va=["Playground","Basic","Simple","Skin","Size","Accent","Media","Horizontal","Icon","Profile","Clickable","Disabled","Grid"];export{x as Accent,m as Basic,B as Clickable,f as Disabled,g as Grid,y as Horizontal,v as Icon,h as Media,n as Playground,_ as Profile,p as Simple,u as Size,C as Skin,Va as __namedExportsOrder,La as default};
