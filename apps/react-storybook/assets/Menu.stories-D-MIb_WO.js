import{r as p,u as k,c as y,n as je,j as e,a as g,b as C,d as _e,B as Pe,I}from"./iframe-Ec8Bs185.js";import{w as i}from"./story-renders-Bo_F9MSp.js";import{r as ke,a as Be}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const De=new Set(["vertical","horizontal","inline"]),ze=C("Menu",{defaults:{mode:"vertical"},booleanProps:new Set(["bordered","compact","dark"]),selfClosing:!1});function u({mode:t="vertical",bordered:o,compact:a,dark:s,ariaLabel:r,children:l,className:b,...M}){const f=p.useRef(null),c=De.has(t)?t:"vertical";k(ze,{mode:c,bordered:o,compact:a,dark:s,ariaLabel:r},y({default:l}),f,{className:b,...M});const x=p.useMemo(()=>{const d=["menu",`menu_${c}`];return o&&d.push("menu_bordered"),a&&d.push("menu_compact"),s&&d.push("menu_dark"),d},[c,o,a,s]),{class:v,...W}=M,S=je(W);return e.jsx("nav",{ref:f,className:g(x,b),"aria-label":r,"data-menu-selectable":"",...S,children:e.jsx("ul",{className:"menu_list",children:l})})}u.__docgenInfo={description:"",methods:[],displayName:"Menu",props:{mode:{defaultValue:{value:"'vertical'",computed:!1},required:!1}}};const Re=C("MenuDivider",{selfClosing:!0});function _({className:t,...o}){const a=p.useRef(null);return k(Re,{},y({}),a,{className:t,...o}),e.jsx("li",{ref:a,className:g("menu_divider",t),role:"separator",...o})}_.__docgenInfo={description:"",methods:[],displayName:"MenuDivider"};const Ee=C("MenuGroup",{selfClosing:!0});function H({title:t,className:o,...a}){const s=p.useRef(null);return k(Ee,{title:t},y({}),s,{className:o,...a}),e.jsx("li",{ref:s,className:g("menu_group",o),role:"presentation",...a,children:e.jsx("span",{className:"menu_group-title",children:t})})}H.__docgenInfo={description:"",methods:[],displayName:"MenuGroup"};const Ae=C("MenuItem",{booleanProps:new Set(["active","disabled","ripple"]),selfClosing:!1});function n({ripple:t,label:o,href:a,active:s,disabled:r,color:l,icon:b,extra:M,children:f,className:c,onClick:x,...v}){const{rippleAttrs:W}=_e({ripple:t}),S=p.useRef(null),d=f??o,ye=d!=null&&d!=="";k(Ae,{ripple:t,label:o,href:a,active:s,disabled:r,color:l},y({default:d,icon:b,extra:M}),S,{className:c,onClick:x,...v});const Ce=p.useMemo(()=>{const m=["menu_item"];return r&&m.push("is-disabled"),m},[r]),Se=p.useMemo(()=>{const m=["menu_link"];return s&&m.push("is-active"),r&&m.push("is-disabled"),l&&m.push(`color_${l}`),m},[s,r,l]),h=a&&!r?"a":r?"span":"button",{class:tn,...we}=v,Ne=je(we),Le=m=>{h==="a"&&m.preventDefault(),x==null||x(m)};return e.jsx("li",{ref:S,className:g(Ce,c),...Ne,children:e.jsxs(h,{...W,className:g(Se),href:h==="a"?a||"#":void 0,type:h==="button"?"button":void 0,"aria-current":s?"page":void 0,"aria-disabled":r?"true":void 0,disabled:h==="button"?r:void 0,tabIndex:r&&h==="a"?-1:void 0,onClick:Le,children:[b,ye?e.jsx("span",{className:"menu_label",children:d}):null,M]})})}n.__docgenInfo={description:"",methods:[],displayName:"MenuItem"};const Ge=C("MenuSubmenu",{booleanProps:new Set(["expanded"]),selfClosing:!1});function j({ripple:t,label:o,expanded:a,submenuId:s,icon:r,children:l,className:b,...M}){const{rippleAttrs:f}=_e({ripple:t}),c=p.useRef(null),x=p.useId().replace(/:/g,""),v=s||`menu-sub-${x}`;return k(Ge,{ripple:t,label:o,expanded:a,submenuId:s},y({default:l,icon:r}),c,{className:b,...M}),e.jsxs("li",{ref:c,className:g("menu_item","menu_item-submenu",b),"aria-expanded":a?"true":"false",...M,children:[e.jsx(Pe,{variant:"text",className:"menu_link",expanded:!!a,"aria-controls":v,iconBefore:r,iconAfter:e.jsx(I,{name:"chevron-down",className:"menu_arrow"}),...f,children:o?e.jsx("span",{className:"menu_label",children:o}):null}),e.jsx("ul",{id:v,className:"menu_submenu",children:l})]})}j.__docgenInfo={description:"",methods:[],displayName:"MenuSubmenu"};const V=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],He=[{name:"mode",type:"'vertical' | 'horizontal' | 'inline'",default:"vertical",description:"menu_vertical · menu_horizontal · menu_inline"},{name:"bordered",type:"boolean",default:"false",description:"menu_bordered"},{name:"compact",type:"boolean",default:"false",description:"menu_compact"},{name:"dark",type:"boolean",default:"false",description:"menu_dark"},{name:"ariaLabel",type:"string",default:"—",description:"nav aria-label"},{name:"children",type:"ReactNode",default:"—",description:"MenuItem · MenuSubmenu 등"},{name:"className",type:"string",default:"—",description:"루트 요소 추가 클래스"}],Ve=V,We=[{name:"label",type:"string",default:"—",description:"항목 텍스트"},{name:"href",type:"string",default:"—",description:"링크 URL (a 태그)"},{name:"active",type:"boolean",default:"false",description:"is-active · aria-current"},{name:"disabled",type:"boolean",default:"false",description:"is-disabled"},{name:"color",type:"string",default:"—",description:"color_* (예: danger)"},{name:"icon",type:"ReactNode",default:"—",description:"menu_icon"},{name:"extra",type:"ReactNode",default:"—",description:"menu_extra (배지 등)"},{name:"children",type:"ReactNode",default:"—",description:"항목 텍스트 (label 대체)"},{name:"className",type:"string",default:"—",description:"루트 요소 추가 클래스"},ke],$e=V,Te=[{name:"label",type:"string",default:"—",description:"서브메뉴 제목"},{name:"expanded",type:"boolean",default:"false",description:"펼침 (aria-expanded)"},{name:"submenuId",type:"string",default:"—",description:"menu_submenu id (aria-controls)"},{name:"icon",type:"ReactNode",default:"—",description:"menu_icon"},{name:"children",type:"ReactNode",default:"—",description:"하위 MenuItem"},{name:"className",type:"string",default:"—",description:"루트 요소 추가 클래스"},ke],Fe=V,Oe=[{name:"title",type:"string",default:"—",description:"그룹 제목 (menu_group-title, 필수)"}],$=[{key:"name",label:"Prop / Children"},{key:"description",label:"설명"}],qe=[{name:"children",description:"MenuItem · MenuSubmenu 등"}],Je=$,Ue=[{name:"icon",description:"menu_icon (ReactNode prop)"},{name:"children",description:"항목 텍스트 (label 대체)"},{name:"extra",description:"menu_extra (배지 등)"}],Ke=$,Qe=[{name:"icon",description:"menu_icon (ReactNode prop)"},{name:"children",description:"하위 MenuItem"}],Xe=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ye=[{name:"menu · menu_list · menu_item · menu_link",description:"루트·목록·항목·링크"},{name:"menu_vertical · menu_horizontal · menu_inline",description:"배치 모드"},{name:"menu_icon · menu_label · menu_extra · menu_arrow",description:"항목 파트"},{name:"menu_item-submenu · menu_submenu",description:"서브메뉴"},{name:"menu_group · menu_group-title · menu_divider",description:"그룹·구분선"},{name:"menu_bordered · menu_compact · menu_dark",description:"스타일 변형"},{name:"is-active · is-disabled",description:"상태"},{name:"data-menu-selectable",description:"선택 가능 메뉴 JS"},...Be],Ze=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],en=[{name:"--menu-item-height · --menu-item-padding-x",default:"—",description:"항목 크기·패딩"},{name:"--menu-gap · --menu-radius",default:"—",description:"간격·모서리"},{name:"--menu-sub-indent",default:"—",description:"서브메뉴 들여쓰기"}],nn=[{title:"API · Menu Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 aria-label · submenu-id는 ariaLabel · submenuId로 다룹니다.",tables:[{columns:V,rows:He,codeColumn:"name"}]},{title:"API · MenuItem Props",tables:[{columns:Ve,rows:We,codeColumn:"name"}]},{title:"API · MenuSubmenu Props",tables:[{columns:$e,rows:Te,codeColumn:"name"}]},{title:"API · MenuGroup Props",tables:[{columns:Fe,rows:Oe,codeColumn:"name"}]},{title:"API · Menu Children",tables:[{columns:$,rows:qe,codeColumn:"name"}]},{title:"API · MenuItem Children",tables:[{columns:Je,rows:Ue,codeColumn:"name"}]},{title:"API · MenuSubmenu Children",tables:[{columns:Ke,rows:Qe,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Xe,rows:Ye,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Ze,rows:en,codeColumn:"name"}]}],an={mode:"vertical",bordered:!1,compact:!1,dark:!1,ariaLabel:"접근성 라벨"},ln={title:"Components/네비게이션/Menu",id:"components-menu",component:u,subcomponents:{MenuItem:n,MenuGroup:H,MenuDivider:_,MenuSubmenu:j},tags:["autodocs"],argTypes:{mode:{control:"select",options:["vertical","horizontal","inline"],type:{name:"enum",summary:"'vertical' | 'horizontal' | 'inline'"}},bordered:{control:"boolean",type:{name:"boolean",summary:"boolean"}},compact:{control:"boolean",type:{name:"boolean",summary:"boolean"}},dark:{control:"boolean",type:{name:"boolean",summary:"boolean"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"fullscreen",apiSections:nn,docs:{description:{component:"내비게이션·사이드바·드롭다운에 쓰는 Menu 컴포넌트입니다."}}}},w={parameters:{controls:{disable:!1}},args:{...an},render:t=>e.jsxs(u,{...t,children:[e.jsx(n,{label:"항목 1"}),e.jsx(n,{label:"항목 2"}),e.jsx(_,{}),e.jsx(n,{label:"항목 3"})]})},N={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:'menu_vertical · menu_bordered로 세로 메뉴를 구성합니다. is-active와 aria-current="page"로 선택 항목을 표시합니다.'},source:{code:`import Menu from '@uxkm/ui-react/components/Menu.jsx';
...
}`,language:"tsx"}}},render:i(e.jsxs(u,{mode:"vertical",bordered:!0,ariaLabel:"주요 메뉴",children:[e.jsx(n,{label:"대시보드",active:!0}),e.jsx(n,{label:"분석"}),e.jsx(n,{label:"사용자"}),e.jsx(n,{label:"설정"})]}))},L={name:"수평",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"menu_horizontal로 상단 탭·툴바 형태의 메뉴를 만듭니다."},source:{code:`import Menu from '@uxkm/ui-react/components/Menu.jsx';
import MenuItem from '@uxkm/ui-react/components/MenuItem.jsx';
...
}`,language:"tsx"}}},render:i(e.jsxs(u,{mode:"horizontal",bordered:!0,ariaLabel:"상단 메뉴",children:[e.jsx(n,{label:"홈",active:!0}),e.jsxs(j,{label:"컴포넌트",expanded:!1,submenuId:"menu-sub-h-components",children:[e.jsx(n,{label:"Button"}),e.jsx(n,{label:"Input"}),e.jsx(n,{label:"Select"})]}),e.jsx(n,{label:"토큰"}),e.jsx(n,{label:"접근성"})]}))},A={name:"사이드바 레이아웃",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"수직 메뉴를 사이드바로 배치하고 콘텐츠 영역과 함께 사용하는 예시입니다."},source:{code:`import Icon from '@uxkm/ui-react/components/Icon.jsx';
import Menu from '@uxkm/ui-react/components/Menu.jsx';
import MenuItem from '@uxkm/ui-react/components/MenuItem.jsx';
import MenuSubmenu from '@uxkm/ui-react/components/MenuSubmenu.jsx';
...
}`,language:"tsx"}}},render:i(e.jsxs("div",{className:"menu_demo-row",children:[e.jsx("div",{className:"menu_demo-sidebar",children:e.jsxs(u,{mode:"vertical",bordered:!0,compact:!0,ariaLabel:"앱 사이드바",children:[e.jsx(n,{label:"개요",active:!0,icon:e.jsx(I,{name:"grid"})}),e.jsxs(j,{label:"문서",expanded:!0,submenuId:"menu-sub-sidebar",icon:e.jsxs("svg",{className:"menu_icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:[e.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),e.jsx("path",{d:"M14 2v6h6"})]}),children:[e.jsx(n,{label:"시작하기"}),e.jsx(n,{label:"컴포넌트"})]}),e.jsx(n,{label:"설정",icon:e.jsx(I,{name:"settings"})})]})}),e.jsx("div",{className:"menu_demo-content",children:e.jsx("p",{style:{margin:0},children:"선택한 메뉴에 해당하는 콘텐츠 영역입니다. 사이드바 메뉴와 함께 레이아웃을 구성할 때 사용합니다."})})]}))},G={name:"변형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"menu_compact · menu_dark로 밀도와 배경을 조절합니다."},source:{code:`import Menu from '@uxkm/ui-react/components/Menu.jsx';
import MenuItem from '@uxkm/ui-react/components/MenuItem.jsx';
...
}`,language:"tsx"}}},render:i(e.jsxs(e.Fragment,{children:[e.jsxs(u,{mode:"vertical",bordered:!0,compact:!0,ariaLabel:"컴팩트 메뉴",children:[e.jsx(n,{label:"항목 A",active:!0}),e.jsx(n,{label:"항목 B"}),e.jsx(n,{label:"항목 C"})]}),e.jsxs(u,{mode:"vertical",bordered:!0,dark:!0,ariaLabel:"다크 서피스 메뉴",children:[e.jsx(n,{label:"항목 A",active:!0}),e.jsx(n,{label:"항목 B"}),e.jsx(n,{label:"항목 C"})]})]}))};var T,F,O;w.parameters={...w.parameters,docs:{...(T=w.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(O=(F=w.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};var q,J,U;N.parameters={...N.parameters,docs:{...(q=N.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: false
...
}`,...(U=(J=N.parameters)==null?void 0:J.docs)==null?void 0:U.source}}};var K,Q,X;L.parameters={...L.parameters,docs:{...(K=L.parameters)==null?void 0:K.docs,source:{originalSource:`{
  name: '수평',
  parameters: {
    controls: {
      disable: false
...
}`,...(ee=(Z=P.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var ne,ae,te;B.parameters={...B.parameters,docs:{...(ne=B.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  name: '서브메뉴',
  parameters: {
    controls: {
      disable: false
...
}`,...(te=(ae=B.parameters)==null?void 0:ae.docs)==null?void 0:te.source}}};var oe,re,se;D.parameters={...D.parameters,docs:{...(oe=D.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  name: '구분선 · 그룹',
  parameters: {
    controls: {
      disable: false
...
}`,...(se=(re=D.parameters)==null?void 0:re.docs)==null?void 0:se.source}}};var ue,le,me;z.parameters={...z.parameters,docs:{...(ue=z.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  name: '비활성',
  parameters: {
    controls: {
      disable: false
...
}`,...(Me=(be=E.parameters)==null?void 0:be.docs)==null?void 0:Me.source}}};var xe,Ie,fe;A.parameters={...A.parameters,docs:{...(xe=A.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  name: '사이드바 레이아웃',
  parameters: {
    controls: {
      disable: false
...
}`,...(fe=(Ie=A.parameters)==null?void 0:Ie.docs)==null?void 0:fe.source}}};var ve,he,ge;G.parameters={...G.parameters,docs:{...(ve=G.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  name: '변형',
  parameters: {
    controls: {
      disable: false
...
}`,...(ge=(he=G.parameters)==null?void 0:he.docs)==null?void 0:ge.source}}};const mn=["Playground","Basic","Horizontal","IconDemo","Submenu","Group","Disabled","BadgeDemo","HorizontalSubmenu","Layout","Variant"];export{R as BadgeDemo,N as Basic,z as Disabled,D as Group,L as Horizontal,E as HorizontalSubmenu,P as IconDemo,A as Layout,w as Playground,B as Submenu,G as Variant,mn as __namedExportsOrder,ln as default};
