import{r as x,L as we,N as S,n as he,j as e,a as A,B as r,I as C}from"./iframe-Ec8Bs185.js";import{A as je}from"./Avatar-BmtskyAp.js";import{w as _e}from"./story-renders-Bo_F9MSp.js";import"./preload-helper-DUxc-Dqw.js";const fe=new Set(["end","top"]);function n({open:a,disabled:l,placement:m,fit:u,maxVisibleItems:d,menuWidth:c,menuMinWidth:g,triggerContent:de,children:pe,className:B,...k}){const I=x.useRef(null),me=`dropdown-menu-${x.useId().replace(/:/g,"")}`,b=fe.has(m)?m:void 0;we({open:a,disabled:l,placement:b,fit:u,maxVisibleItems:d,menuWidth:c,menuMinWidth:g},I,{className:B,...k});const ue=x.useMemo(()=>{const s=["dropdown"];return a&&s.push("is-open"),l&&s.push("is-disabled"),b==="end"&&s.push("dropdown_placement-end"),b==="top"&&s.push("dropdown_placement-top"),u&&s.push("dropdown_fit"),s},[a,l,b,u]),ce=x.useMemo(()=>{const s=["dropdown_menu"];return d!=null&&s.push("dropdown_menu-scrollable"),s},[d]),ge=x.useMemo(()=>{const s={};return d!=null&&(s["--dropdown-max-visible-items"]=d),c!=null&&(s.width=S(c)),g!=null&&(s.minWidth=S(g)),s},[d,c,g]),{class:Ee,...xe}=k,be=he(xe);return e.jsxs("div",{ref:I,className:A(ue,B),"data-dropdown":"",...be,children:[e.jsx("div",{"data-demo-slot":"trigger",children:de}),e.jsx("div",{id:me,className:A(ce),style:ge,role:"menu","data-demo-slot":"default",children:pe})]})}n.__docgenInfo={description:"",methods:[],displayName:"Dropdown"};const ve=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Ne=[{name:"open",type:"boolean",default:"false",description:"열림 (is-open)"},{name:"disabled",type:"boolean",default:"false",description:"is-disabled"},{name:"placement",type:"'end' | 'top'",default:"—",description:"dropdown_placement-end · dropdown_placement-top"},{name:"fit",type:"boolean",default:"false",description:"dropdown_fit — 트리거 너비 맞춤"},{name:"maxVisibleItems",type:"number",default:"—",description:"패널에 보이는 최대 항목 수. 초과 시 dropdown_menu-scrollable로 목록 스크롤"},{name:"menuWidth",type:"string | number",default:"—",description:"패널 가로 너비 (숫자는 rem)"},{name:"menuMinWidth",type:"string | number",default:"—",description:"패널 최소 가로 너비 (숫자는 rem)"},{name:"triggerContent",type:"ReactNode",default:"—",description:"트리거 버튼·링크 (dropdown_trigger)"},{name:"children",type:"ReactNode",default:"—",description:"메뉴 패널 (dropdown_menu, 보통 Menu)"},{name:"className",type:"string",default:"—",description:"루트 요소 추가 클래스"}],De=[{key:"name",label:"Prop / Children"},{key:"description",label:"설명"}],Me=[{name:"triggerContent",description:"트리거 버튼·링크 (Vue #trigger 슬롯)"},{name:"children",description:"메뉴 패널 (dropdown_menu, 보통 Menu)"}],ye=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ce=[{name:"dropdown · dropdown_menu",description:"루트·메뉴 패널"},{name:"dropdown_placement-end · dropdown_placement-top · dropdown_fit",description:"배치·너비"},{name:"dropdown_menu-scrollable",description:"maxVisibleItems 지정 시 — menu_list 스크롤"},{name:"data-dropdown · data-dropdown-close-on-select",description:"JS 연동"},{name:"is-open · is-disabled",description:"상태"},{name:'role="menu"',description:"메뉴 시맨틱"}],Be=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ke=[{name:"--dropdown-min-width · --dropdown-menu-width",default:"10rem · auto",description:"패널 최소·기본 너비"},{name:"--dropdown-offset",default:"—",description:"트리거와 패널 간격"},{name:"--dropdown-max-visible-items",default:"—",description:"maxVisibleItems prop으로 주입 — 스크롤 높이 계산"},{name:"--dropdown-item-line-height",default:"1.4",description:"항목 높이 계산용 줄 높이"},{name:"--z-dropdown",default:"100",description:"레이어 순서"}],Ie=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 max-visible-items · menu-width · menu-min-width는 maxVisibleItems · menuWidth · menuMinWidth로 다룹니다. Vue `#trigger` 슬롯은 triggerContent prop입니다.",tables:[{columns:ve,rows:Ne,codeColumn:"name"}]},{title:"API · Children",description:"Vue 슬롯에 대응하는 React prop·children입니다.",tables:[{columns:De,rows:Me,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ye,rows:Ce,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Be,rows:ke,codeColumn:"name"}]}];function Se(a){return e.jsx("div",{className:"dropdown_demo-stage",children:a})}function i(a){const l=()=>Se(a);return _e(l,l)}function t({ariaLabel:a,children:l}){return e.jsx("nav",{className:"menu menu_vertical menu_compact","aria-label":a,"data-menu-selectable":"",children:e.jsx("ul",{className:"menu_list",role:"none",children:l})})}function o({label:a,active:l,disabled:m,color:u,icon:d,extra:c}){const g=["menu_link",l&&"is-active",m&&"is-disabled",u&&`color_${u}`].filter(Boolean).join(" ");return e.jsx("li",{className:["menu_item",m&&"is-disabled"].filter(Boolean).join(" "),children:e.jsxs("button",{type:"button",className:g,"aria-current":l?"page":void 0,"aria-disabled":m?"true":void 0,disabled:m||void 0,children:[d,a!=null?e.jsx("span",{className:"menu_label",children:a}):null,c]})})}const p=e.jsx(C,{name:"chevron-down",className:"btn_select-caret","aria-hidden":"true"}),Ae=e.jsxs("svg",{className:"icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:[e.jsx("circle",{cx:"12",cy:"12",r:"1"}),e.jsx("circle",{cx:"19",cy:"12",r:"1"}),e.jsx("circle",{cx:"5",cy:"12",r:"1"})]}),Pe={open:!0,disabled:!1,placement:void 0,fit:!1,maxVisibleItems:void 0},We={title:"Components/네비게이션/Dropdown",id:"components-dropdown",component:n,tags:["autodocs"],argTypes:{open:{control:"boolean",type:{name:"boolean",summary:"boolean"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placement:{control:"select",options:["end","top"],type:{name:"enum",summary:"'end' | 'top'"}},fit:{control:"boolean",type:{name:"boolean",summary:"boolean"}},maxVisibleItems:{control:"number",type:{name:"number",summary:"number"}},menuWidth:{control:"text",type:{name:"union",summary:"string | number"}},menuMinWidth:{control:"text",type:{name:"union",summary:"string | number"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Ie,docs:{description:{component:"트리거와 메뉴 패널로 구성되는 Dropdown 컴포넌트입니다."}}}},w={parameters:{controls:{disable:!1}},args:{...Pe},render:a=>e.jsx("div",{className:"dropdown_demo-stage",children:e.jsx(n,{...a,triggerContent:e.jsx(r,{className:"dropdown_trigger",label:"드롭다운",variant:"outline",haspopup:"menu"}),children:e.jsxs(t,{ariaLabel:"드롭다운 메뉴",children:[e.jsx(o,{label:"항목 1"}),e.jsx(o,{label:"항목 2"}),e.jsx(o,{label:"항목 3"})]})})})},h={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"dropdown · dropdown_trigger · dropdown_menu으로 트리거와 패널을 구성합니다. 패널 안에는 menu_vertical · menu_compact를 배치합니다."},source:{code:`import Button from '@uxkm/ui-react/components/Button.jsx';
...
}`,...(E=(L=w.parameters)==null?void 0:L.docs)==null?void 0:E.source}}};var V,T,z;h.parameters={...h.parameters,docs:{...(V=h.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: false
...
}`,...(z=(T=h.parameters)==null?void 0:T.docs)==null?void 0:z.source}}};var O,W,H;j.parameters={...j.parameters,docs:{...(O=j.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: '열린 상태',
  parameters: {
    controls: {
      disable: false
...
}`,...(U=(Q=v.parameters)==null?void 0:Q.docs)==null?void 0:U.source}}};var X,Y,Z;N.parameters={...N.parameters,docs:{...(X=N.parameters)==null?void 0:X.docs,source:{originalSource:`{
  name: '메뉴 구성',
  parameters: {
    controls: {
      disable: false
...
}`,...(Z=(Y=N.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,oe,ne;D.parameters={...D.parameters,docs:{...(ee=D.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  name: '스크롤 · 너비',
  parameters: {
    controls: {
      disable: false
...
}`,...(ne=(oe=D.parameters)==null?void 0:oe.docs)==null?void 0:ne.source}}};var re,te,ae;M.parameters={...M.parameters,docs:{...(re=M.parameters)==null?void 0:re.docs,source:{originalSource:`{
  name: '비활성',
  parameters: {
    controls: {
      disable: false
...
}`,...(ae=(te=M.parameters)==null?void 0:te.docs)==null?void 0:ae.source}}};var se,le,ie;y.parameters={...y.parameters,docs:{...(se=y.parameters)==null?void 0:se.docs,source:{originalSource:`{
  name: '조합 예시',
  parameters: {
    controls: {
      disable: false
...
}`,...(ie=(le=y.parameters)==null?void 0:le.docs)==null?void 0:ie.source}}};const He=["Playground","Basic","Open","Trigger","SelectTrigger","Placement","MenuDemo","Scroll","Disabled","Example"];export{h as Basic,M as Disabled,y as Example,N as MenuDemo,j as Open,v as Placement,w as Playground,D as Scroll,f as SelectTrigger,_ as Trigger,He as __namedExportsOrder,We as default};
