import{r as N,u as ie,c as se,n as re,j as e,a as O,b as oe,B as u}from"./iframe-Ec8Bs185.js";import{w as ne}from"./story-renders-Bo_F9MSp.js";import"./preload-helper-DUxc-Dqw.js";function T(a,o){const t=parseInt(a,10);return Number.isFinite(t)?t:o}function le(a){let o=a.parentElement;for(;o;){const t=getComputedStyle(o),p=t.transform,f=t.filter,m=t.backdropFilter||t.webkitBackdropFilter,i=t.perspective,r=t.contain,n=t.willChange,c=!!(p&&p!=="none"),h=!!(f&&f!=="none"||m&&m!=="none"),g=!!(i&&i!=="none"),y=!!(r&&/paint|layout|strict|content/.test(r)),w=!!(n&&/transform|filter|perspective/.test(n));if(c||h||g||y||w)return o.getBoundingClientRect();if(o===document.documentElement)break;o=o.parentElement}return{left:0,top:0,right:window.innerWidth,bottom:window.innerHeight,width:window.innerWidth,height:window.innerHeight}}function fe(a){if(a.dataset.affixInit)return()=>{};const o=a.getAttribute("data-target");let t=null;if(o)try{t=document.querySelector(o)}catch{t=null}const p=T(a.getAttribute("data-offset-top"),0),f=a.hasAttribute("data-offset-bottom"),m=f?T(a.getAttribute("data-offset-bottom"),0):0,i=a.querySelector(".affix_target");if(!i)return()=>{};a.dataset.affixInit="1";let r=a.querySelector(".affix_placeholder");r||(r=document.createElement("div"),r.className="affix_placeholder",r.setAttribute("aria-hidden","true"),a.insertBefore(r,i));let n=!1,c=!1;function h(){return t?t.getBoundingClientRect():{top:0,bottom:window.innerHeight,left:0,right:window.innerWidth}}function g(){i.style.position="",i.style.top="",i.style.bottom="",i.style.left="",i.style.width="",i.style.zIndex=""}function y(s,l,d){const _=le(i),E=f?s.bottom-i.offsetHeight-m:s.top+p;i.style.position="fixed",i.style.width=`${l}px`,i.style.left=`${d-_.left}px`,i.style.top=`${E-_.top}px`,i.style.bottom="",i.style.zIndex=getComputedStyle(a).getPropertyValue("--affix-z-index").trim()||"10"}function w(s,l){if(s===n){s&&l&&y(l.targetRect,l.width,l.left);return}if(n=s,a.classList.toggle("is-affixed",n),i.classList.toggle("is-fixed",n),n){const d=i.offsetHeight;r.style.height=`${d}px`,r.style.width=`${l.width}px`,r.hidden=!1,y(l.targetRect,l.width,l.left)}else r.hidden=!0,r.style.height="",r.style.width="",g()}function x(){c||(c=!0,requestAnimationFrame(()=>{c=!1;const s=h(),l=a.getBoundingClientRect(),d=n?r.getBoundingClientRect():l,_=d.width||l.width,E=d.left,ee={targetRect:s,width:_,left:E};let v=n;if(f){if(v=s.bottom-d.bottom<=m,v&&t){const R=i.offsetHeight;d.bottom-s.top<R+m&&(v=!1)}}else if(v=d.top-s.top<=p,v&&t){const R=i.offsetHeight;s.bottom-d.top<R+p&&(v=!1)}w(v,ee)}))}const k=t||window;return k.addEventListener("scroll",x,{passive:!0}),t&&window.addEventListener("scroll",x,{passive:!0,capture:!0}),window.addEventListener("resize",x,{passive:!0}),x(),()=>{k.removeEventListener("scroll",x),t&&window.removeEventListener("scroll",x,{capture:!0}),window.removeEventListener("resize",x),delete a.dataset.affixInit,a.classList.remove("is-affixed"),i.classList.remove("is-fixed"),r.hidden=!0,r.style.height="",r.style.width="",g()}}const ce=new Set(["","bar","anchor"]),de=oe("Affix",{defaults:{offsetTop:0,interactive:!0},booleanProps:new Set(["interactive"]),selfClosing:!1});function b({target:a,offsetTop:o=0,offsetBottom:t,skin:p="",interactive:f=!0,children:m,className:i,style:r,...n}){const c=N.useRef(null),h=ce.has(p)?p:"";ie(de,{target:a,offsetTop:o,offsetBottom:t,skin:h||void 0,interactive:f},se({default:m}),c,{className:i,style:r,...n});const g=N.useMemo(()=>{const s=["affix_target"];return h==="bar"&&s.push("affix_bar"),h==="anchor"&&s.push("affix_anchor"),s},[h]),y=N.useMemo(()=>{const s={};return f&&(s["data-affix"]=""),a&&(s["data-target"]=a),o!=null&&Number(o)!==0&&(s["data-offset-top"]=String(o)),t!=null&&t!==""&&(s["data-offset-bottom"]=String(t)),s},[f,a,o,t]);N.useEffect(()=>{if(!(!f||!c.current))return fe(c.current)},[f,a,o,t]);const{class:w,...x}=n,k=re(x);return e.jsxs("div",{ref:c,className:O("affix",i),style:r,...y,...k,children:[e.jsx("div",{className:"affix_placeholder","aria-hidden":"true",hidden:!0}),e.jsx("div",{className:O(g),children:m})]})}b.__docgenInfo={description:"",methods:[],displayName:"Affix",props:{offsetTop:{defaultValue:{value:"0",computed:!1},required:!1},skin:{defaultValue:{value:"''",computed:!1},required:!1},interactive:{defaultValue:{value:"true",computed:!1},required:!1}}};const pe=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],me=[{name:"target",type:"string",default:"—",description:"스크롤 컨테이너 선택자 (data-target). 생략 시 window"},{name:"offsetTop",type:"number | string",default:"0",description:"상단 고정 시 상단 여백(px, data-offset-top)"},{name:"offsetBottom",type:"number | string",default:"—",description:"하단 고정 시 하단 여백(px, data-offset-bottom). 지정 시 하단 고정 모드"},{name:"skin",type:"'' | 'bar' | 'anchor'",default:"—",description:"affix_bar · affix_anchor 스킨"},{name:"interactive",type:"boolean",default:"true",description:"false면 data-affix 미부여(초기화 비활성)"},{name:"children",type:"ReactNode",default:"—",description:"고정 대상 콘텐츠 (라벨·버튼·앵커 링크 등)"},{name:"className",type:"string",default:"—",description:"루트 요소 추가 클래스"}],xe=[{key:"name",label:"Prop / Children"},{key:"description",label:"설명"}],ue=[{name:"children",description:"고정 대상 콘텐츠 (라벨·버튼·앵커 링크 등)"}],he=[{key:"name",label:"속성"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],be=[{name:"data-affix",type:"boolean",default:"—",description:"Affix 활성화. 루트 .affix 요소에 지정"},{name:"data-target",type:"string",default:"window",description:"스크롤 컨테이너 CSS 선택자. 생략 시 window 스크롤 기준"},{name:"data-offset-top",type:"number",default:"0",description:"상단 고정 시 뷰포트·컨테이너 상단과의 간격(px)"},{name:"data-offset-bottom",type:"number",default:"0",description:"하단 고정 시 하단과의 간격(px). 속성을 지정하면 하단 고정 모드"}],ve=[{key:"name",label:"요소"},{key:"description",label:"설명"}],ge=[{name:".affix",description:"루트 래퍼. data-affix · data-target · data-offset-* 속성을 지정"},{name:".affix_placeholder",description:'고정 시 레이아웃 점프 방지용 플레이스홀더 (aria-hidden="true", hidden)'},{name:".affix_target",description:"실제 고정·해제되는 대상. affix_bar 또는 affix_anchor 스킨과 조합"}],ye=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],je=[{name:"affix_bar",description:"액션 바 스킨. 라벨 + 버튼 영역"},{name:"affix_bar-label",description:"바 좌측 라벨"},{name:"affix_bar-actions",description:"바 우측 버튼 그룹. Button 컴포넌트 조합"},{name:"affix_anchor",description:"섹션 앵커 링크 내비게이션 스킨"},{name:"is-affixed",description:"고정 상태 (루트 .affix에 JS가 자동 추가)"},{name:"is-fixed",description:"고정 상태 (.affix_target에 JS가 자동 추가)"}],we=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ke=[{name:"--affix-z-index",default:"10",description:"고정 바 z-index"},{name:"--affix-bar-gap",default:"var(--space-sm)",description:"바 내부 간격"},{name:"--affix-bar-padding-y · --affix-bar-padding-x",default:"var(--space-sm) · var(--space-md)",description:"바 패딩"},{name:"--affix-bar-bg",default:"var(--color-surface)",description:"바 배경"},{name:"--affix-bar-border",default:"var(--color-border-subtle)",description:"바 테두리"},{name:"--affix-bar-shadow",default:"0 1px 4px rgb(0 0 0 / 0.08)",description:"바 그림자"}],_e=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 offset-top · offset-bottom은 offsetTop · offsetBottom입니다.",tables:[{columns:pe,rows:me,codeColumn:"name"}]},{title:"API · Children",description:"Vue default 슬롯은 React children으로 다룹니다.",tables:[{columns:xe,rows:ue,codeColumn:"name"}]},{title:"API · Data Attributes",tables:[{columns:he,rows:be,codeColumn:"name"}]},{title:"API · 마크업 구조",tables:[{columns:ve,rows:ge,codeColumn:"name"}]},{title:"클래스 · 스킨",description:"OOCSS 구조 클래스와 스킨 클래스입니다. affix_bar-actions 안의 버튼은 Button 컴포넌트로 조합합니다.",tables:[{columns:ye,rows:je,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:we,rows:ke,codeColumn:"name"}]}];function j(a){return ne(a,a)}const Ne={offsetTop:0,skin:"bar",interactive:!0},ze={title:"Components/기타/Affix",id:"components-affix",component:b,tags:["autodocs"],parameters:{controls:{disable:!1},layout:"padded",docs:{description:{component:"스크롤 시 지정한 위치에 요소를 고정하는 컴포넌트입니다. 툴바·앵커 내비게이션·액션 버튼 등에 사용하며, target으로 스크롤 컨테이너를 지정할 수 있습니다."}},apiSections:_e},argTypes:{target:{control:"text",description:"스크롤 컨테이너 선택자 (data-target). 생략 시 window",type:{name:"string",summary:"string"}},offsetTop:{control:"number",description:"상단 고정 시 상단 여백(px)",type:{name:"number",summary:"number | string"}},offsetBottom:{control:"number",description:"하단 고정 시 하단 여백(px). 지정 시 하단 고정 모드",type:{name:"number",summary:"number | string"}},skin:{control:"select",options:["bar","anchor"],description:"affix_bar · affix_anchor 스킨",type:{name:"enum",summary:"'bar' | 'anchor'"}},interactive:{control:"boolean",description:"false면 data-affix 미부여(초기화 비활성)",type:{name:"boolean",summary:"boolean"}}}},A={parameters:{controls:{disable:!1}},args:{...Ne},render:a=>e.jsx("div",{className:"affix_demo-narrow",children:e.jsx("div",{id:"affix-scroll-playground",className:"affix_demo-scroll",children:e.jsxs("div",{className:"affix_demo-content",children:[e.jsx("p",{children:"스크롤하면 상단에 고정됩니다. Controls로 offsetTop · skin을 조절하세요."}),e.jsxs(b,{...a,target:"#affix-scroll-playground",children:[e.jsx("span",{className:"affix_bar-label",children:"주문 #ORD-2024"}),e.jsxs("div",{className:"affix_bar-actions",children:[e.jsx(u,{variant:"outline",size:"sm",label:"취소"}),e.jsx(u,{variant:"filled",color:"primary",size:"sm",label:"결제"})]})]}),e.jsx("p",{children:"추가 콘텐츠 — 스크롤해 보세요."}),e.jsx("p",{children:"배송지 · 결제 수단 · 상품 정보"}),e.jsx("p",{children:"교환·반품 안내"}),e.jsx("p",{children:"고객센터 · FAQ · 이용약관"})]})})})},B={name:"기본",parameters:{controls:{disable:!0},demoPreview:{stack:!1},docs:{description:{story:"`data-affix`와 `data-target`으로 스크롤 영역을 연결합니다. 영역을 스크롤하면 `.affix_target`이 상단에 고정됩니다."},source:{language:"tsx",code:`import Affix from '@uxkm/ui-react/components/Affix.jsx';
...
}`,...(Z=(Y=P.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};const Se=["Playground","Basic","Offset","Anchor","Bottom","Window"];export{z as Anchor,B as Basic,S as Bottom,C as Offset,A as Playground,P as Window,Se as __namedExportsOrder,ze as default};
