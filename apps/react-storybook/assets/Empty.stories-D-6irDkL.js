import{r as k,D as X,n as Y,j as e,a as $,B as ee}from"./iframe-Ec8Bs185.js";import{w as s}from"./story-renders-Bo_F9MSp.js";import"./preload-helper-DUxc-Dqw.js";const te=new Set(["sm","md","lg"]);function se(){return e.jsxs("svg",{viewBox:"0 0 64 41",fill:"none","aria-hidden":"true",children:[e.jsx("ellipse",{cx:"32",cy:"34",rx:"30",ry:"5",fill:"currentColor",opacity:"0.12"}),e.jsx("path",{d:"M55 13 45 2.5A2 2 0 0 0 43.2 2H20.8a2 2 0 0 0-1.8 1.5L9 13v9h46v-9Z",stroke:"currentColor",strokeWidth:"2",strokeLinejoin:"round"}),e.jsx("path",{d:"M9 22v9.5A3.5 3.5 0 0 0 12.5 35h39a3.5 3.5 0 0 0 3.5-3.5V22",stroke:"currentColor",strokeWidth:"2",strokeLinejoin:"round"}),e.jsx("path",{d:"M24 22v-4.5c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2V22",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})]})}function t({description:r,size:x="md",simple:a,block:y,image:H,footer:h,children:Z,className:g,style:f,...v}){const b=k.useRef(null),i=te.has(x)?x:"md",E=Z??r,q=!a,J=h!=null;X({description:typeof r=="string"?r:void 0,size:i,simple:a,block:y},b,{className:g,style:f,...v});const K=k.useMemo(()=>{const o=["empty"];return i==="sm"&&o.push("empty_sm"),i==="lg"&&o.push("empty_lg"),a&&o.push("empty_simple"),y&&o.push("empty_block"),o},[i,a,y]),{class:ue,...Q}=v,U=Y(Q);return e.jsxs("div",{ref:b,className:$(K,g),style:f,role:"status",...U,children:[q?e.jsx("div",{className:"empty_image","aria-hidden":"true","data-demo-slot":"image",children:H??e.jsx(se,{})}):null,E?e.jsx("p",{className:"empty_desc",children:E}):null,J?e.jsx("div",{className:"empty_footer","data-demo-slot":"footer",children:h}):null]})}t.__docgenInfo={description:"",methods:[],displayName:"Empty",props:{size:{defaultValue:{value:"'md'",computed:!1},required:!1}}};const re=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],oe=[{name:"description",type:"string",default:"—",description:"설명 텍스트. description 슬롯으로 대체"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"empty_sm · empty_lg"},{name:"simple",type:"boolean",default:"false",description:"아이콘 숨김 (empty_simple)"},{name:"block",type:"boolean",default:"false",description:"가운데 블록 정렬 (empty_block)"},{name:"image",type:"ReactNode",default:"—",description:"커스텀 이미지·아이콘 (empty_image)"},{name:"footer",type:"ReactNode",default:"—",description:"하단 액션 영역 (empty_footer)"},{name:"className",type:"string",default:"—",description:"empty 루트에 추가 클래스"}],ae=[{key:"name",label:"Children"},{key:"description",label:"설명"}],ie=[{name:"image",description:"일러스트·아이콘 (empty_image)"},{name:"children",description:"설명 (description prop 대체, Vue description 슬롯 대응)"},{name:"footer",description:"액션 버튼·링크 (empty_footer)"}],me=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],ne=[{name:"empty · empty_image · empty_desc · empty_footer",description:"루트·이미지·설명·푸터"},{name:"empty_sm · empty_lg · empty_simple · empty_block",description:"크기·변형"},{name:'role="status"',description:"빈 상태 시맨틱"}],ce=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],pe=[{name:"--empty-gap · --empty-padding-y · --empty-padding-x",default:"—",description:"간격·패딩"},{name:"--empty-image-size · --empty-image-size-sm · --empty-image-size-lg",default:"4rem · 3rem · 5rem",description:"아이콘 크기"},{name:"--empty-desc-size · --empty-desc-max-width",default:"var(--text-size-sm) · 20rem",description:"설명 타이포"}],de=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다.",tables:[{columns:re,rows:oe,codeColumn:"name"}]},{title:"API · Children",description:"Vue 슬롯에 대응하는 React prop·children입니다.",tables:[{columns:ae,rows:ie,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:me,rows:ne,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:ce,rows:pe,codeColumn:"name"}]}],le={description:"설명 텍스트입니다.",size:"md",simple:!1,block:!1},ge={title:"Components/피드백/Empty",id:"components-empty",component:t,tags:["autodocs"],argTypes:{description:{control:"text",type:{name:"string",summary:"string"}},size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},simple:{control:"boolean",type:{name:"boolean",summary:"boolean"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:de,docs:{description:{component:"데이터·결과가 없을 때 표시하는 Empty 상태 컴포넌트입니다."}}}},m={parameters:{controls:{disable:!1}},args:{...le},render:r=>e.jsx(t,{...r})},n={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"`empty_image` · `empty_desc`로 아이콘과 설명을 표시합니다."},source:{code:`import Empty from '@uxkm/ui-react/components/Empty.jsx';

export function BasicExample() {
  return <Empty description="데이터가 없습니다" />;
}`,language:"tsx"}}},render:s(e.jsx(t,{description:"데이터가 없습니다"}))},c={name:"액션",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"`empty_footer`에 버튼·링크를 배치해 다음 행동을 유도합니다."},source:{code:`import Button from '@uxkm/ui-react/components/Button.jsx';
...
}`,language:"tsx"}}},render:s(e.jsxs(e.Fragment,{children:[e.jsx(t,{size:"sm",description:"Small"}),e.jsx(t,{description:"Medium (기본)",style:{marginTop:"var(--space-md)"}}),e.jsx(t,{size:"lg",description:"Large",style:{marginTop:"var(--space-md)"}})]}))},l={name:"설명만",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"`empty_simple`은 아이콘 없이 짧은 안내만 표시합니다. 테이블·목록 셀 등 좁은 영역에 적합합니다."},source:{code:`import Empty from '@uxkm/ui-react/components/Empty.jsx';

export function SimpleExample() {
  return <Empty simple size="sm" description="일정 없음" />;
}`,language:"tsx"}}},render:s(e.jsx(t,{simple:!0,size:"sm",description:"일정 없음"}))},u={name:"블록 · 컨테이너",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"`empty_block`은 카드·테이블 등 부모 너비 안에서 가운데 정렬합니다."},source:{code:`import Empty from '@uxkm/ui-react/components/Empty.jsx';
...
}`,language:"tsx"}}},render:s(e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"card card_shadow",style:{maxWidth:"var(--input-max-width)",width:"100%"},children:[e.jsx("div",{className:"card_header",children:e.jsx("h3",{className:"card_title",children:"알림 목록"})}),e.jsx("div",{className:"card_body",children:e.jsx(t,{block:!0,description:"새 알림이 없습니다"})})]}),e.jsx("div",{className:"table_wrap",style:{maxWidth:"var(--input-max-width)",width:"100%",marginTop:"var(--space-md)"},children:e.jsxs("table",{className:"table table_bordered",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{scope:"col",children:"이름"}),e.jsx("th",{scope:"col",children:"상태"}),e.jsx("th",{scope:"col",children:"날짜"})]})}),e.jsx("tbody",{children:e.jsx("tr",{children:e.jsx("td",{colSpan:3,style:{padding:0,border:"none"},children:e.jsx(t,{block:!0,simple:!0,size:"sm",description:"표시할 항목이 없습니다"})})})})]})})]}))};var _,j,w;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
