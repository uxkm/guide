import{r as v,u as ye,c as be,n as je,j as e,a as M,b as ve}from"./iframe-Ec8Bs185.js";import{T as j}from"./Tag-B1xbtJCd.js";import{w as r}from"./story-renders-Bo_F9MSp.js";import"./preload-helper-DUxc-Dqw.js";const he=new Set(["sm","md"]),Se=new Set(["sm","md","lg"]),ze=ve("Timeline",{defaults:{size:"md",tag:"ol",iconSize:"md"},booleanProps:new Set(["card","alternate","horizontal","labelCol","icon"]),skipProps:["tag"],selfClosing:!1});function t({card:l,alternate:n,horizontal:s,labelCol:a,icon:c,iconSize:u="md",size:b="md",tag:T="ol",children:x,className:g,...f}){const I=v.useRef(null),y=he.has(u)?u:"md",d=Se.has(b)?b:"md";ye(ze,{card:l,alternate:n,horizontal:s,labelCol:a,icon:c,iconSize:y,size:d,tag:T},be({default:x}),I,{className:g,...f});const _=v.useMemo(()=>{const m=["timeline"];return l&&m.push("timeline_card"),n&&m.push("timeline_alternate"),s&&m.push("timeline_horizontal"),a&&m.push("timeline_label-col"),c&&m.push("timeline_icon"),c&&y==="sm"&&m.push("timeline_icon-sm"),d==="sm"&&m.push("timeline_sm"),d==="lg"&&m.push("timeline_lg"),m},[l,n,s,a,c,y,d]),{class:L,...Q}=f,V=je(Q),H=T||"ol";return e.jsx(H,{ref:I,className:M(_,g),...V,children:x})}t.__docgenInfo={description:"",methods:[],displayName:"Timeline",props:{iconSize:{defaultValue:{value:"'md'",computed:!1},required:!1},size:{defaultValue:{value:"'md'",computed:!1},required:!1},tag:{defaultValue:{value:"'ol'",computed:!1},required:!1}}};const Ce=ve("TimelineItem",{defaults:{color:"primary"},booleanProps:new Set(["active","pending","outline"]),selfClosing:!1});function i({color:l="primary",title:n,description:s,time:a,datetime:c,label:u,labelDatetime:b,active:T,pending:x,outline:g,dot:f,meta:I,children:y,className:d,..._}){const L=v.useRef(null);ye(Ce,{color:l,title:n,description:s,time:a,datetime:c,label:u,labelDatetime:b,active:T,pending:x,outline:g},be({default:y,dot:f,meta:I}),L,{className:d,..._});const Q=v.useMemo(()=>{const p=["timeline_item"];return T&&p.push("is-active"),x&&p.push("is-pending"),p},[T,x]),V=v.useMemo(()=>{const p=["timeline_dot"];return g&&p.push("timeline_dot-outline"),l&&p.push(`color_${l}`),p},[g,l]),{class:H,...m}=_,ke=je(m);return e.jsxs("li",{ref:L,className:M(Q,d),...ke,children:[u?e.jsx("time",{className:"timeline_label",dateTime:b,children:u}):null,f?e.jsx("span",{className:"timeline_dot","aria-hidden":"true",children:f}):e.jsx("span",{className:M(V),"aria-hidden":"true"}),e.jsxs("div",{className:"timeline_content",children:[y??e.jsxs(e.Fragment,{children:[a?e.jsx("time",{className:"timeline_time",dateTime:c,children:a}):null,n?e.jsx("p",{className:"timeline_title",children:n}):null,s?e.jsx("p",{className:"timeline_desc",children:s}):null]}),I?e.jsx("div",{className:"timeline_meta",children:I}):null]})]})}i.__docgenInfo={description:"",methods:[],displayName:"TimelineItem",props:{color:{defaultValue:{value:"'primary'",computed:!1},required:!1}}};const _e=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],we=[{name:"card",type:"boolean",default:"false",description:"카드형 콘텐츠 (timeline_card)"},{name:"alternate",type:"boolean",default:"false",description:"좌우 교차 배치 (timeline_alternate)"},{name:"horizontal",type:"boolean",default:"false",description:"가로 타임라인 (timeline_horizontal)"},{name:"labelCol",type:"boolean",default:"false",description:"좌측 라벨 열 (timeline_label-col)"},{name:"icon",type:"boolean",default:"false",description:"아이콘 점 모드 (timeline_icon)"},{name:"iconSize",type:"'sm' | 'md'",default:"md",description:"icon 모드 점 크기 (timeline_icon-sm)"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"timeline_sm · timeline_lg"},{name:"tag",type:"'ol' | 'ul'",default:"ol",description:"루트 태그"},{name:"className",type:"string",default:"—",description:"timeline 루트에 추가 클래스"}],Ae=_e,Pe=[{name:"color",type:"string",default:"primary",description:"점 색상 color_*"},{name:"title",type:"string",default:"—",description:"이벤트 제목 (timeline_title)"},{name:"description",type:"string",default:"—",description:"설명 (timeline_desc)"},{name:"time",type:"string",default:"—",description:"시간 텍스트 (timeline_time)"},{name:"datetime",type:"string",default:"—",description:"time 요소 datetime 속성"},{name:"label",type:"string",default:"—",description:"좌측 라벨 (timeline_label)"},{name:"labelDatetime",type:"string",default:"—",description:"라벨 datetime 속성"},{name:"active",type:"boolean",default:"false",description:"진행 중 (is-active)"},{name:"pending",type:"boolean",default:"false",description:"대기·미완료 (is-pending)"},{name:"outline",type:"boolean",default:"false",description:"테두리 점 (timeline_dot-outline)"},{name:"className",type:"string",default:"—",description:"timeline_item에 추가 클래스"}],De=[{key:"name",label:"Children"},{key:"description",label:"설명"}],Re=[{name:"children",description:"TimelineItem 자식 (Vue default 슬롯 대응)"}],Ee=[{key:"name",label:"Children / Prop"},{key:"description",label:"설명"}],Le=[{name:"title",description:"이벤트 제목 (timeline_title)"},{name:"description",description:"설명 (timeline_desc)"},{name:"time",description:"시간 텍스트 (timeline_time)"},{name:"children",description:"콘텐츠 (title·description 대체, Vue default 슬롯 대응)"},{name:"dot",description:"커스텀 점·아이콘 (Vue #dot 슬롯 대응)"},{name:"meta",description:"하단 메타 (Vue #meta 슬롯 대응, timeline_meta)"}],Qe=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ve=[{name:"timeline",description:"타임라인 루트"},{name:"timeline_card · timeline_alternate · timeline_horizontal",description:"레이아웃 변형"},{name:"timeline_label-col · timeline_icon · timeline_icon-sm",description:"라벨 열·아이콘 모드"},{name:"timeline_sm · timeline_lg",description:"크기"},{name:"timeline_item · timeline_dot · timeline_content",description:"항목 구조"},{name:"timeline_label · timeline_time · timeline_title · timeline_desc",description:"텍스트 파트"},{name:"is-active · is-pending",description:"상태"}],Me=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],He=[{name:"--timeline-gap",default:"var(--space-lg)",description:"항목 간격"},{name:"--timeline-dot-size · --timeline-line-width",default:"10px · 2px",description:"점·연결선"},{name:"--timeline-label-width",default:"4.5rem",description:"라벨 열 너비"},{name:"--timeline-title-size · --timeline-desc-size",default:"—",description:"제목·설명 크기"}],Ne=[{title:"API · Timeline Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 label-col · icon-size는 labelCol · iconSize로 다룹니다.",tables:[{columns:_e,rows:we,codeColumn:"name"}]},{title:"API · TimelineItem Props",description:"Vue의 label-datetime은 labelDatetime, HTML datetime 속성은 datetime prop으로 전달합니다.",tables:[{columns:Ae,rows:Pe,codeColumn:"name"}]},{title:"API · Timeline Children",description:"Vue default 슬롯은 React children에 대응합니다.",tables:[{columns:De,rows:Re,codeColumn:"name"}]},{title:"API · TimelineItem Children",description:"Vue dot · meta · default 슬롯은 React dot · meta · children prop에 대응합니다.",tables:[{columns:Ee,rows:Le,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Qe,rows:Ve,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Me,rows:He,codeColumn:"name"}]}],o={card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},Xe={title:"Components/데이터 표시/Timeline",id:"components-timeline",component:t,subcomponents:{TimelineItem:i},tags:["autodocs"],argTypes:{card:{control:"boolean",type:{name:"boolean",summary:"boolean"}},alternate:{control:"boolean",type:{name:"boolean",summary:"boolean"}},horizontal:{control:"boolean",type:{name:"boolean",summary:"boolean"}},labelCol:{control:"boolean",type:{name:"boolean",summary:"boolean"}},icon:{control:"boolean",type:{name:"boolean",summary:"boolean"}},iconSize:{control:"select",options:["sm","md"],type:{name:"enum",summary:"'sm' | 'md'"}},size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},tag:{control:"select",options:["ol","ul"],type:{name:"enum",summary:"'ol' | 'ul'"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Ne,docs:{description:{component:"시간순 이벤트·프로세스 흐름을 표시하는 타임라인 컴포넌트입니다."}}}},k={parameters:{controls:{disable:!1}},args:{...o},render:l=>e.jsxs(t,{...l,children:[e.jsx(i,{title:"이벤트 1",time:"09:00"}),e.jsx(i,{title:"이벤트 2",time:"10:30"})]})},h={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"timeline_dot에 공통 color_* 클래스로 이벤트 유형을 구분합니다."},source:{code:`import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
...
}`,language:"tsx"}}},args:{...o},render:r(e.jsxs(t,{alternate:!0,children:[e.jsx(i,{color:"primary",time:"2024년 3월",datetime:"2024-03",title:"회사 설립",description:"UXKM 팀이 공식적으로 출범했습니다."}),e.jsx(i,{color:"primary",time:"2024년 6월",datetime:"2024-06",title:"컴포넌트 가이드 오픈",description:"HTML 컴포넌트 라이브러리 문서를 공개했습니다."}),e.jsx(i,{color:"success",time:"2024년 9월",datetime:"2024-09",title:"1,000 스타 달성",description:"GitHub 저장소가 1,000 스타를 돌파했습니다."}),e.jsx(i,{color:"info",time:"2025년 1월",datetime:"2025-01",title:"v2 로드맵 공개",description:"다크 모드 · RTL · 접근성 강화 계획을 발표했습니다."})]}))},D={name:"가로형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"timeline_horizontal로 단계·프로세스 흐름을 가로로 표시합니다. 768px 미만에서는 세로형으로 표시됩니다."},source:{code:`import Timeline from '@uxkm/ui-react/components/Timeline.jsx';
import TimelineItem from '@uxkm/ui-react/components/TimelineItem.jsx';
...
}`,language:"tsx"}}},args:{...o},render:r(e.jsxs(t,{children:[e.jsx(i,{color:"success",title:"계정 생성",time:"완료"}),e.jsx(i,{color:"success",title:"프로필 설정",time:"완료"}),e.jsx(i,{color:"primary",title:"팀 초대",time:"진행 중",active:!0}),e.jsx(i,{title:"첫 프로젝트 생성",time:"대기",pending:!0})]}))};var N,G,O;k.parameters={...k.parameters,docs:{...(N=k.parameters)==null?void 0:N.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(O=(G=k.parameters)==null?void 0:G.docs)==null?void 0:O.source}}};var U,B,X;h.parameters={...h.parameters,docs:{...(U=h.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: false
...
}`,...(X=(B=h.parameters)==null?void 0:B.docs)==null?void 0:X.source}}};var F,q,K;S.parameters={...S.parameters,docs:{...(F=S.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: '간단',
  parameters: {
    controls: {
      disable: false
...
}`,...(K=(q=S.parameters)==null?void 0:q.docs)==null?void 0:K.source}}};var W,Z,$;z.parameters={...z.parameters,docs:{...(W=z.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: '아웃라인 도트',
  parameters: {
    controls: {
      disable: false
...
}`,...($=(Z=z.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var J,Y,ee;C.parameters={...C.parameters,docs:{...(J=C.parameters)==null?void 0:J.docs,source:{originalSource:`{
  name: '아이콘 도트',
  parameters: {
    controls: {
      disable: false
...
}`,...(ee=(Y=C.parameters)==null?void 0:Y.docs)==null?void 0:ee.source}}};var ie,te,me;w.parameters={...w.parameters,docs:{...(ie=w.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  name: '카드형',
  parameters: {
    controls: {
      disable: false
...
}`,...(me=(te=w.parameters)==null?void 0:te.docs)==null?void 0:me.source}}};var oe,le,re;A.parameters={...A.parameters,docs:{...(oe=A.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  name: '날짜 레이블',
  parameters: {
    controls: {
      disable: false
...
}`,...(re=(le=A.parameters)==null?void 0:le.docs)==null?void 0:re.source}}};var ne,se,ae;P.parameters={...P.parameters,docs:{...(ne=P.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  name: '좌우 교차',
  parameters: {
    controls: {
      disable: false
...
}`,...(ae=(se=P.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};var ce,de,pe;D.parameters={...D.parameters,docs:{...(ce=D.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  name: '가로형',
  parameters: {
    controls: {
      disable: false
...
}`,...(pe=(de=D.parameters)==null?void 0:de.docs)==null?void 0:pe.source}}};var ue,Te,xe;R.parameters={...R.parameters,docs:{...(ue=R.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  name: '크기',
  parameters: {
    controls: {
      disable: false
...
}`,...(xe=(Te=R.parameters)==null?void 0:Te.docs)==null?void 0:xe.source}}};var ge,fe,Ie;E.parameters={...E.parameters,docs:{...(ge=E.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  name: '상태',
  parameters: {
    controls: {
      disable: false
...
}`,...(Ie=(fe=E.parameters)==null?void 0:fe.docs)==null?void 0:Ie.source}}};const Fe=["Playground","Basic","Simple","Outline","IconDot","Card","Label","Alternate","Horizontal","Size","State"];export{P as Alternate,h as Basic,w as Card,D as Horizontal,C as IconDot,A as Label,z as Outline,k as Playground,S as Simple,R as Size,E as State,Fe as __namedExportsOrder,Xe as default};
