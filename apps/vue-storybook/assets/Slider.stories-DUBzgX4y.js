import{k as ge,l as Ee,u as ke,a as Le,h as I,b as ze,x as M,o as r,c as i,t as k,g as m,e as C,w as $,_ as T,p as t,s as L,q as W,d as Fe,r as Ve,i as Pe,j as f}from"./iframe-BHuoLYUS.js";import{w as n,s as Re}from"./story-renders-C_n8_MI3.js";import{_ as Ne}from"./FormLayout-Dpm6QfjY.js";import{h as Ie,a as Me}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const $e={key:0,class:"slider_header"},Te={key:1,class:"slider_control"},We=["min","max","step","value","disabled"],Oe=["min","max","step","value","disabled"],je={key:3,class:"slider_hint"},s=Object.assign({inheritAttrs:!1},{__name:"Slider",props:{ripple:ge,min:{type:Number,default:0},max:{type:Number,default:100},value:{type:Number,default:50},step:Number,disabled:Boolean,vertical:Boolean,label:String,showValue:Boolean,stepper:Boolean,stepperAlways:Boolean,valueSuffix:String,hint:String,decreaseLabel:String,increaseLabel:String,size:{type:String,default:"md",validator:e=>["sm","md","lg"].includes(e)},modelValue:Number},emits:["update:modelValue"],setup(e,{emit:g}){const a=e,{rippleAttrs:_e,childRippleAttrs:z}=Ee(a,{mode:"container"}),Ae=g,Se=ke(),d=Le(),F=I(null),o=`slider-${Math.random().toString(36).slice(2,9)}`,c=I(a.modelValue??a.value),we=Pe("Slider",{defaults:{min:0,max:100,value:50,size:"md"},booleanProps:new Set(["disabled","vertical","showValue","stepper","stepperAlways"]),skipProps:["modelValue"],selfClosing:!0});ze(we,a,Se,F,d);const p=f(()=>a.modelValue??c.value);M(()=>a.modelValue,l=>{l!=null&&(c.value=l)}),M(()=>a.value,l=>{a.modelValue==null&&(c.value=l)});function V(l){c.value=l,Ae("update:modelValue",l)}const xe=f(()=>{const l=["slider"];return a.size==="sm"&&l.push("slider_sm"),a.size==="lg"&&l.push("slider_lg"),a.vertical&&l.push("slider_vertical"),a.stepper&&l.push("slider_stepper"),a.stepperAlways&&l.push("slider_stepper_always"),d.class&&l.push(d.class),l}),De=f(()=>{const l=a.valueSuffix??"";return`${p.value}${l}`});function P(l){const u=a.step??1,E=Math.min(a.max,Math.max(a.min,p.value+l*u));V(E)}const R=f(()=>{const{class:l,...u}=d;return u});function N(l){V(Number(l.target.value))}return(l,u)=>(r(),i("div",t({ref_key:"rootRef",ref:F,class:xe.value},L(_e)),[e.label||e.showValue?(r(),i("div",$e,[e.label?(r(),i("label",{key:0,class:"slider_label",for:o},k(e.label),1)):m("",!0),e.showValue?(r(),i("output",{key:1,class:"slider_value",for:o},k(De.value),1)):m("",!0)])):m("",!0),e.stepper?(r(),i("div",Te,[C(W,t(L(z),{variant:"ghost",size:"sm","icon-only":"",class:"slider_step slider_step-decrease","aria-label":e.decreaseLabel||"값 줄이기",disabled:e.disabled,onClick:u[0]||(u[0]=E=>P(-1))}),{"icon-before":$(()=>[C(T,{name:"minus",size:"sm",class:"slider_step-icon"})]),_:1},16,["aria-label","disabled"]),Fe("input",t({id:o,type:"range",class:"slider_input",min:e.min,max:e.max,step:e.step,value:p.value,disabled:e.disabled},R.value,{onInput:N}),null,16,We),C(W,t(L(z),{variant:"ghost",size:"sm","icon-only":"",class:"slider_step slider_step-increase","aria-label":e.increaseLabel||"값 늘리기",disabled:e.disabled,onClick:u[1]||(u[1]=E=>P(1))}),{"icon-before":$(()=>[C(T,{name:"plus",size:"sm",class:"slider_step-icon"})]),_:1},16,["aria-label","disabled"])])):(r(),i("input",t({key:2,id:o,type:"range",class:"slider_input",min:e.min,max:e.max,step:e.step,value:p.value,disabled:e.disabled},R.value,{onInput:N}),null,16,Oe)),e.hint?(r(),i("p",je,k(e.hint),1)):m("",!0),Ve(l.$slots,"default")],16))}});s.__docgenInfo=Object.assign({displayName:s.name??s.__name},{exportName:"default",displayName:"Slider",description:"",tags:{},props:[{name:"ripple",description:"클릭 파장(ripple). true 활성 · false 비활성 · 미지정 시 컴포넌트 기본",type:{name:"rippleProp"}},{name:"min",type:{name:"number"},defaultValue:{func:!1,value:"0"}},{name:"max",type:{name:"number"},defaultValue:{func:!1,value:"100"}},{name:"value",type:{name:"number"},defaultValue:{func:!1,value:"50"}},{name:"step",type:{name:"number"}},{name:"disabled",type:{name:"boolean"}},{name:"vertical",type:{name:"boolean"}},{name:"label",type:{name:"string"}},{name:"showValue",type:{name:"boolean"}},{name:"stepper",type:{name:"boolean"}},{name:"stepperAlways",type:{name:"boolean"}},{name:"valueSuffix",type:{name:"string"}},{name:"hint",type:{name:"string"}},{name:"decreaseLabel",type:{name:"string"}},{name:"increaseLabel",type:{name:"string"}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md","lg"]},{name:"modelValue",type:{name:"number"}}],events:[{name:"update:modelValue"}],slots:[{name:"default"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Slider.vue"]});const Ue=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],He=[{name:"model-value",type:"number",default:"—",description:"v-model 바인딩 값"},{name:"value",type:"number",default:"50",description:"model-value 없을 때 기본값"},{name:"min",type:"number",default:"0",description:"최솟값"},{name:"max",type:"number",default:"100",description:"최댓값"},{name:"step",type:"number",default:"—",description:"증감 단위"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"slider_sm · slider_lg"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"vertical",type:"boolean",default:"false",description:"세로 슬라이더"},{name:"label",type:"string",default:"—",description:"상단 라벨"},{name:"show-value",type:"boolean",default:"false",description:"현재 값 output 표시"},{name:"value-suffix",type:"string",default:"—",description:"값 뒤 단위 (%, px 등)"},{name:"hint",type:"string",default:"—",description:"하단 힌트 텍스트"},{name:"stepper",type:"boolean",default:"false",description:"± 스텝 버튼 (slider_stepper)"},{name:"stepper-always",type:"boolean",default:"false",description:"스텝 버튼 항상 표시"},{name:"decrease-label",type:"string",default:"값 줄이기",description:"감소 버튼 aria-label"},{name:"increase-label",type:"string",default:"값 늘리기",description:"증가 버튼 aria-label"},Ie],qe=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Ge=[{name:"default",description:"추가 콘텐츠 (눈금 등)"}],Je=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ke=[{name:"slider",description:"슬라이더 루트"},{name:"slider_sm · slider_lg · slider_vertical",description:"크기·방향"},{name:"slider_stepper · slider_stepper_always",description:"스텝 버튼 모드"},{name:"slider_header · slider_label · slider_value · slider_hint",description:"헤더·힌트"},{name:"slider_input · slider_control · slider_step",description:"range·스텝 버튼"},{name:"slider_ticks · slider_tick",description:"눈금 (HTML 마크업)"},...Me],Qe=[{key:"name",label:"이벤트"},{key:"description",label:"설명"}],Xe=[{name:"update:modelValue",description:"값 변경 시 (v-model)"}],Ye=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Ze=[{name:"--slider-track-height · --slider-thumb-size",default:"4px · 14px",description:"트랙·썸 크기 (md)"},{name:"--slider-max-width",default:"var(--input-max-width)",description:"최대 너비"},{name:"--slider-step-size",default:"2.25rem",description:"스텝 버튼 크기"}],el=[{title:"API · Props",tables:[{columns:Ue,rows:He,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:qe,rows:Ge,codeColumn:"name"}]},{title:"API · Events",tables:[{columns:Qe,rows:Xe,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Je,rows:Ke,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Ye,rows:Ze,codeColumn:"name"}]}],rl={title:"Components/폼/Slider",id:"components-slider",component:s,tags:["autodocs"],argTypes:{min:{control:"number",type:{name:"number",summary:"number"}},max:{control:"number",type:{name:"number",summary:"number"}},value:{control:"number",type:{name:"number",summary:"number"}},step:{control:"number",type:{name:"number",summary:"number"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},vertical:{control:"boolean",type:{name:"boolean",summary:"boolean"}},label:{control:"text",type:{name:"string",summary:"string"}},showValue:{control:"boolean",type:{name:"boolean",summary:"boolean"}},stepper:{control:"boolean",type:{name:"boolean",summary:"boolean"}},stepperAlways:{control:"boolean",type:{name:"boolean",summary:"boolean"}},valueSuffix:{control:"text",type:{name:"string",summary:"string"}},hint:{control:"text",type:{name:"string",summary:"string"}},decreaseLabel:{control:"text",type:{name:"string",summary:"string"}},increaseLabel:{control:"text",type:{name:"string",summary:"string"}},size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},modelValue:{control:"number",type:{name:"number",summary:"number"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:el}},b={parameters:{controls:{disable:!1}},args:{min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:"라벨",showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:(e,g)=>({components:{Slider:s},setup(){return{args:Re(g)}},template:'<Slider v-bind="args" />'})},v={name:"유형",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"접근 가능한 이름 지정 방식별 예시입니다. 보이는 레이블이 있으면 `label for` 또는 `aria-labelledby`를, 레이블 없이 아이콘·단독 UI만 있으면 `aria-label`을 사용합니다. 보조 설명은 `aria-describedby`, 스크린 리더용 값 표현은 `aria-valuetext`와 `output`을 조합합니다."},source:{code:`<script setup>
...
</template>`,language:"vue"}}},args:{min:0,max:100,value:50,step:1,label:"라벨",valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:n(()=>({components:{Slider:s},template:`<Slider
      id="slider-type-label"
      class="slider_fit"
      label="label + for — 기본"
      :value="40"
...
<template>
  ...
  show-value
  />
</template>`,language:"vue"}}},args:{min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:"라벨",showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:n(()=>({components:{Slider:s},template:`<Slider id="slider-volume" class="slider_fit" label="볼륨" :value="60" show-value />
      <Slider
      id="slider-brightness"
      class="slider_fit"
      label="밝기"
...
</template>`,language:"vue"}}},args:{min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:"라벨",showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:n(()=>({components:{Slider:s},template:`<Slider id="slider-size-sm" class="slider_sm slider_fit" label="Small — slider_sm" :value="30" show-value />
      <Slider id="slider-size-md" class="slider_fit" label="Medium — 기본" :value="50" show-value />
...
<template>
  ...
  show-value
  />
</template>`,language:"vue"}}},args:{min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:"라벨",showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:n(()=>({components:{Slider:s},template:`<Slider id="slider-width-fit" class="slider_fit" label="slider_fit — 최대 320px" :value="45" show-value />
      <Slider
      id="slider-width-block"
      class="slider_block"
      style="max-width: 480px;"
...
<template>
  ...
  disabled
  />
</template>`,language:"vue"}}},args:{min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:"라벨",showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:n(()=>({components:{Slider:s},template:`<Slider
      class="slider_fit"
      stepper
      label="볼륨 — slider_stepper"
      :value="60"
...
</template>`,language:"vue"}}},args:{min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:"라벨",showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:n(()=>({components:{Slider:s},template:`<Slider id="slider-color-primary" class="color_primary slider_fit" label="Primary" :value="60" show-value />
      <Slider id="slider-color-success" class="color_success slider_fit" label="Success" :value="70" show-value />
      <Slider id="slider-color-danger" class="color_danger slider_fit" label="Danger" :value="40" show-value />
...
</template>`,language:"vue"}}},args:{min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:"라벨",showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:n(()=>({components:{Slider:s},template:`<Slider class="slider_fit" label="기본" :value="50" show-value />
...
<template>
  ...
  <FormLayout layout="horizontal" fit>
    <div class="form_field">
...
</template>`,language:"vue"}}},args:{min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:"라벨",showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:"값",hint:"값",decreaseLabel:"라벨",increaseLabel:"라벨",size:"md"},render:n(()=>({components:{FormLayout:Ne,Slider:s},template:`<FormLayout layout="vertical" fit>
        <div class="form_field">
          <label class="form_field-label" for="slider-form-opacity">불투명도</label>
          <Slider id="slider-form-opacity" :value="85" data-slider-suffix="%" />
          <p class="form_field-hint">0~100% 사이 값</p>
      ...
      </FormLayout>`}))};var O,j,U;b.parameters={...b.parameters,docs:{...(O=b.parameters)==null?void 0:O.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(U=(j=b.parameters)==null?void 0:j.docs)==null?void 0:U.source}}};var H,q,G;v.parameters={...v.parameters,docs:{...(H=v.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: "유형",
  parameters: {
    controls: {
      disable: false
...
}`,...(Z=(Y=y.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,le,ae;h.parameters={...h.parameters,docs:{...(ee=h.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    controls: {
      disable: false
...
}`,...(ae=(le=h.parameters)==null?void 0:le.docs)==null?void 0:ae.source}}};var se,ne,ue;_.parameters={..._.parameters,docs:{...(se=_.parameters)==null?void 0:se.docs,source:{originalSource:`{
  name: "너비",
  parameters: {
    controls: {
      disable: false
...
}`,...(ce=(oe=S.parameters)==null?void 0:oe.docs)==null?void 0:ce.source}}};var pe,me,Ce;w.parameters={...w.parameters,docs:{...(pe=w.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  name: "색상",
  parameters: {
    controls: {
      disable: false
...
}`,...(Ce=(me=w.parameters)==null?void 0:me.docs)==null?void 0:Ce.source}}};var fe,be,ve;x.parameters={...x.parameters,docs:{...(fe=x.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  name: "상태",
  parameters: {
    controls: {
      disable: false
...
}`,...(ve=(be=x.parameters)==null?void 0:be.docs)==null?void 0:ve.source}}};var Be,ye,he;D.parameters={...D.parameters,docs:{...(Be=D.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  name: "폼 레이아웃",
  parameters: {
    controls: {
      disable: false
...
}`,...(he=(ye=D.parameters)==null?void 0:ye.docs)==null?void 0:he.source}}};const il=["Playground","Type","Basic","Label","Size","Width","Step","Stepper","Color","State","Form"];export{B as Basic,w as Color,D as Form,y as Label,b as Playground,h as Size,x as State,A as Step,S as Stepper,v as Type,_ as Width,il as __namedExportsOrder,rl as default};
