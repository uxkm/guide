import{u as se,a as re,b as ce,o,m as De,w as Te,r as E,n as _,y as Ae,h as de,i as pe,j as x,c as a,t as c,g as r,d as fe}from"./iframe-BHuoLYUS.js";import{w as m,s as Ie}from"./story-renders-C_n8_MI3.js";import{_ as ge}from"./Tag-D0MNLatk.js";import"./preload-helper-PMqzWbAN.js";const n=Object.assign({inheritAttrs:!1},{__name:"Timeline",props:{card:Boolean,alternate:Boolean,horizontal:Boolean,labelCol:Boolean,icon:Boolean,iconSize:{type:String,default:"md",validator:e=>["sm","md"].includes(e)},size:{type:String,default:"md",validator:e=>["sm","md","lg"].includes(e)},tag:{type:String,default:"ol"}},setup(e){const i=e,v=se(),C=re(),s=de(null),z=pe("Timeline",{defaults:{size:"md",tag:"ol",iconSize:"md"},booleanProps:new Set(["card","alternate","horizontal","labelCol","icon"]),skipProps:["tag"],selfClosing:!1});ce(z,i,v,s,C);const k=x(()=>{const l=["timeline"];return i.card&&l.push("timeline_card"),i.alternate&&l.push("timeline_alternate"),i.horizontal&&l.push("timeline_horizontal"),i.labelCol&&l.push("timeline_label-col"),i.icon&&l.push("timeline_icon"),i.icon&&i.iconSize==="sm"&&l.push("timeline_icon-sm"),i.size==="sm"&&l.push("timeline_sm"),i.size==="lg"&&l.push("timeline_lg"),C.class&&l.push(C.class),l});return(l,t)=>(o(),De(Ae(e.tag),{ref_key:"rootRef",ref:s,class:_(k.value)},{default:Te(()=>[E(l.$slots,"default")]),_:3},8,["class"]))}});n.__docgenInfo=Object.assign({displayName:n.name??n.__name},{exportName:"default",displayName:"Timeline",description:"",tags:{},props:[{name:"card",type:{name:"boolean"}},{name:"alternate",type:{name:"boolean"}},{name:"horizontal",type:{name:"boolean"}},{name:"labelCol",type:{name:"boolean"}},{name:"icon",type:{name:"boolean"}},{name:"iconSize",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md"]},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md","lg"]},{name:"tag",type:{name:"string"},defaultValue:{func:!1,value:"'ol'"}}],slots:[{name:"default"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Timeline.vue"]});const ye=["datetime"],be={key:1,class:"timeline_dot","aria-hidden":"true"},Ee={class:"timeline_content"},ve=["datetime"],ze={key:1,class:"timeline_title"},ke={key:2,class:"timeline_desc"},_e={key:0,class:"timeline_meta"},u=Object.assign({inheritAttrs:!1},{__name:"TimelineItem",props:{color:{type:String,default:"primary"},title:String,description:String,time:String,datetime:String,label:String,labelDatetime:String,active:Boolean,pending:Boolean,outline:Boolean},setup(e){const i=e,v=se(),C=re(),s=de(null),z=pe("TimelineItem",{defaults:{color:"primary"},booleanProps:new Set(["active","pending","outline"]),selfClosing:!1});ce(z,i,v,s,C);const k=x(()=>{const t=["timeline_item"];return i.active&&t.push("is-active"),i.pending&&t.push("is-pending"),C.class&&t.push(C.class),t}),l=x(()=>{const t=["timeline_dot"];return i.outline&&t.push("timeline_dot-outline"),i.color&&t.push(`color_${i.color}`),t});return(t,Me)=>(o(),a("li",{ref_key:"rootRef",ref:s,class:_(k.value)},[e.label?(o(),a("time",{key:0,class:"timeline_label",datetime:e.labelDatetime},c(e.label),9,ye)):r("",!0),t.$slots.dot?(o(),a("span",be,[E(t.$slots,"dot")])):(o(),a("span",{key:2,class:_(l.value),"aria-hidden":"true"},null,2)),fe("div",Ee,[E(t.$slots,"default",{},()=>[e.time?(o(),a("time",{key:0,class:"timeline_time",datetime:e.datetime},c(e.time),9,ve)):r("",!0),e.title?(o(),a("p",ze,c(e.title),1)):r("",!0),e.description?(o(),a("p",ke,c(e.description),1)):r("",!0)]),t.$slots.meta?(o(),a("div",_e,[E(t.$slots,"meta")])):r("",!0)])],2))}});u.__docgenInfo=Object.assign({displayName:u.name??u.__name},{exportName:"default",displayName:"TimelineItem",description:"",tags:{},props:[{name:"color",type:{name:"string"},defaultValue:{func:!1,value:"'primary'"}},{name:"title",type:{name:"string"}},{name:"description",type:{name:"string"}},{name:"time",type:{name:"string"}},{name:"datetime",type:{name:"string"}},{name:"label",type:{name:"string"}},{name:"labelDatetime",type:{name:"string"}},{name:"active",type:{name:"boolean"}},{name:"pending",type:{name:"boolean"}},{name:"outline",type:{name:"boolean"}}],slots:[{name:"dot"},{name:"default"},{name:"meta"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/TimelineItem.vue"]});const Be=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],xe=[{name:"card",type:"boolean",default:"false",description:"카드형 콘텐츠 (timeline_card)"},{name:"alternate",type:"boolean",default:"false",description:"좌우 교차 배치 (timeline_alternate)"},{name:"horizontal",type:"boolean",default:"false",description:"가로 타임라인 (timeline_horizontal)"},{name:"label-col",type:"boolean",default:"false",description:"좌측 라벨 열 (timeline_label-col)"},{name:"icon",type:"boolean",default:"false",description:"아이콘 점 모드 (timeline_icon)"},{name:"icon-size",type:"'sm' | 'md'",default:"md",description:"icon 모드 점 크기 (timeline_icon-sm)"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"timeline_sm · timeline_lg"},{name:"tag",type:"string",default:"ol",description:"루트 태그 (ol · ul)"}],Se=Be,he=[{name:"color",type:"string",default:"primary",description:"점 색상 color_*"},{name:"title",type:"string",default:"—",description:"이벤트 제목 (timeline_title)"},{name:"description",type:"string",default:"—",description:"설명 (timeline_desc)"},{name:"time",type:"string",default:"—",description:"시간 텍스트 (timeline_time)"},{name:"datetime",type:"string",default:"—",description:"time 요소 datetime 속성"},{name:"label",type:"string",default:"—",description:"좌측 라벨 (timeline_label)"},{name:"label-datetime",type:"string",default:"—",description:"라벨 datetime 속성"},{name:"active",type:"boolean",default:"false",description:"진행 중 (is-active)"},{name:"pending",type:"boolean",default:"false",description:"대기·미완료 (is-pending)"},{name:"outline",type:"boolean",default:"false",description:"테두리 점 (timeline_dot-outline)"}],S=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Fe=[{name:"default",description:"TimelineItem 자식"}],we=[{name:"default",description:"콘텐츠 (title·description 대체)"},{name:"dot",description:"커스텀 점·아이콘"},{name:"meta",description:"하단 메타 (timeline_meta)"}],Pe=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Re=[{name:"timeline",description:"타임라인 루트"},{name:"timeline_card · timeline_alternate · timeline_horizontal",description:"레이아웃 변형"},{name:"timeline_label-col · timeline_icon · timeline_icon-sm",description:"라벨 열·아이콘 모드"},{name:"timeline_sm · timeline_lg",description:"크기"},{name:"timeline_item · timeline_dot · timeline_content",description:"항목 구조"},{name:"timeline_label · timeline_time · timeline_title · timeline_desc",description:"텍스트 파트"},{name:"is-active · is-pending",description:"상태"}],Qe=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Le=[{name:"--timeline-gap",default:"var(--space-lg)",description:"항목 간격"},{name:"--timeline-dot-size · --timeline-line-width",default:"10px · 2px",description:"점·연결선"},{name:"--timeline-label-width",default:"4.5rem",description:"라벨 열 너비"},{name:"--timeline-title-size · --timeline-desc-size",default:"—",description:"제목·설명 크기"}],Ue=[{title:"API · Timeline Props",tables:[{columns:Be,rows:xe,codeColumn:"name"}]},{title:"API · TimelineItem Props",tables:[{columns:Se,rows:he,codeColumn:"name"}]},{title:"API · Timeline Slots",tables:[{columns:S,rows:Fe,codeColumn:"name"}]},{title:"API · TimelineItem Slots",tables:[{columns:S,rows:we,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Pe,rows:Re,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Qe,rows:Le,codeColumn:"name"}]}],$e={title:"Components/데이터 표시/Timeline",id:"components-timeline",component:n,subcomponents:{TimelineItem:u},tags:["autodocs"],argTypes:{card:{control:"boolean",type:{name:"boolean",summary:"boolean"}},alternate:{control:"boolean",type:{name:"boolean",summary:"boolean"}},horizontal:{control:"boolean",type:{name:"boolean",summary:"boolean"}},labelCol:{control:"boolean",type:{name:"boolean",summary:"boolean"}},icon:{control:"boolean",type:{name:"boolean",summary:"boolean"}},iconSize:{control:"select",options:["sm","md"],type:{name:"enum",summary:"'sm' | 'md'"}},size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},tag:{control:"select",options:["ol","ul"],type:{name:"enum",summary:"'ol' | 'ul'"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Ue}},d={parameters:{controls:{disable:!1}},args:{card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},render:(e,i)=>({components:{Timeline:n,TimelineItem:u},setup(){return{args:Ie(i)}},template:`<Timeline v-bind="args">
...
</template>`,language:"vue"}}},args:{iconSize:"md",size:"md",tag:"ol"},render:m(()=>({components:{Timeline:n,TimelineItem:u},template:`<Timeline>
        <TimelineItem
        color="primary"
        time="2024-06-01 10:00"
        datetime="2024-06-01"
...
</template>`,language:"vue"}}},args:{card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},render:m(()=>({components:{Timeline:n,TimelineItem:u},template:`<Timeline>
        <TimelineItem color="primary" title="주문 접수" time="오전 9:12" datetime="2024-06-20" />
        <TimelineItem color="primary" title="배송 준비 중" time="오전 11:45" datetime="2024-06-20" />
        <TimelineItem color="success" title="배송 완료" time="오후 2:30" datetime="2024-06-21" />
...
</template>`,language:"vue"}}},args:{card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},render:m(()=>({components:{Timeline:n,TimelineItem:u},template:`<Timeline icon icon-size="sm">
        <TimelineItem color="primary" time="2024-06-01" datetime="2024-06-01" title="팀원 합류" description="프론트엔드 개발자 2명이 프로젝트에 참여했습니다." />
        <TimelineItem color="success" time="2024-06-10" datetime="2024-06-10" title="QA 통과" description="회귀 테스트 142건 모두 통과했습니다." />
        <TimelineItem color="warning" time="2024-06-15" datetime="2024-06-15" title="일정 지연 알림" description="외부 API 연동 이슈로 1주일 일정이 조정되었습니다." />
        <TimelineItem color="danger" time="2024-06-18" datetime="2024-06-18" title="배포 롤백" description="결제 모듈 오류로 이전 버전으로 롤백했습니다." />
...
</template>`,language:"vue"}}},args:{card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},render:m(()=>({components:{Tag:ge,Timeline:n,TimelineItem:u},template:`        <Timeline card>
        <TimelineItem color="primary" time="2024-06-20 09:00" datetime="2024-06-20" title="디자인 시스템 v2.0 릴리스" description="타이포그래피·컬러 토큰이 업데이트되었습니다. 기존 컴포넌트와 하위 호환됩니다.">
        <template #meta>
        <Tag color="primary" label="Release" />
        <Tag color="default" label="Design" />
...
</template>`,language:"vue"}}},args:{card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},render:m(()=>({components:{Timeline:n,TimelineItem:u},template:`<Timeline label-col>
        <TimelineItem label="2024 Q1" label-datetime="2024-01" color="primary" title="알파 버전 출시" description="내부 테스트용 알파 빌드를 배포했습니다." />
        <TimelineItem label="2024 Q2" label-datetime="2024-04" color="primary" title="베타 공개" description="선택 파트너사 대상 베타 프로그램을 시작했습니다." />
        <TimelineItem label="2024 Q3" label-datetime="2024-07" color="success" title="정식 출시" description="GA 버전이 프로덕션에 배포되었습니다." />
        <TimelineItem label="2024 Q4" label-datetime="2024-10" color="primary" title="엔터프라이즈 기능" description="SSO · 감사 로그 · 역할 기반 접근 제어를 추가합니다." />
...
</template>`,language:"vue"}}},args:{card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},render:m(()=>({components:{Timeline:n,TimelineItem:u},template:`<Timeline alternate>
        <TimelineItem color="primary" time="2024년 3월" datetime="2024-03" title="회사 설립" description="UXKM 팀이 공식적으로 출범했습니다." />
        <TimelineItem color="primary" time="2024년 6월" datetime="2024-06" title="컴포넌트 가이드 오픈" description="HTML 컴포넌트 라이브러리 문서를 공개했습니다." />
        <TimelineItem color="success" time="2024년 9월" datetime="2024-09" title="1,000 스타 달성" description="GitHub 저장소가 1,000 스타를 돌파했습니다." />
        <TimelineItem color="info" time="2025년 1월" datetime="2025-01" title="v2 로드맵 공개" description="다크 모드 · RTL · 접근성 강화 계획을 발표했습니다." />
...
</template>`,language:"vue"}}},args:{card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},render:m(()=>({components:{Timeline:n,TimelineItem:u},template:`<Timeline horizontal>
        <TimelineItem color="success" title="신청" time="6/20" datetime="2024-06-20" />
        <TimelineItem color="success" title="심사" time="6/21" datetime="2024-06-21" />
        <TimelineItem color="primary" title="승인" time="진행 중" datetime="2024-06-22" active />
        <TimelineItem title="완료" time="예정" pending />
      </Timeline>`}))},y={name:"크기",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"timeline_sm · timeline_lg로 간격과 텍스트 크기를 조절합니다."},source:{code:`<script setup>
import Timeline from '@uxkm/ui/components/Timeline.vue';
import TimelineItem from '@uxkm/ui/components/TimelineItem.vue';
<\/script>
...
</template>`,language:"vue"}}},args:{card:!1,alternate:!1,horizontal:!1,labelCol:!1,icon:!1,iconSize:"md",size:"md",tag:"ol"},render:m(()=>({components:{Timeline:n,TimelineItem:u},template:`<div>
        <p style="font-size: var(--text-size-sm); color: var(--color-text-muted); margin: 0 0 0.75rem;">Small</p>
        <Timeline size="sm">
          <TimelineItem color="primary" title="알림 발송" time="10:30" />
          <TimelineItem color="success" title="수신 확인" time="10:31" />
...
}`,...(Q=(R=p.parameters)==null?void 0:R.docs)==null?void 0:Q.source}}};var L,U,M;B.parameters={...B.parameters,docs:{...(L=B.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: "간단",
  parameters: {
    controls: {
      disable: false
...
}`,...(M=(U=B.parameters)==null?void 0:U.docs)==null?void 0:M.source}}};var O,G,H;D.parameters={...D.parameters,docs:{...(O=D.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: "아웃라인 도트",
  parameters: {
    controls: {
      disable: false
...
}`,...(H=(G=D.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};var V,$,N;T.parameters={...T.parameters,docs:{...(V=T.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: "아이콘 도트",
  parameters: {
    controls: {
      disable: false
...
}`,...(N=($=T.parameters)==null?void 0:$.docs)==null?void 0:N.source}}};var X,j,K;A.parameters={...A.parameters,docs:{...(X=A.parameters)==null?void 0:X.docs,source:{originalSource:`{
  name: "카드형",
  parameters: {
    controls: {
      disable: false
...
}`,...(K=(j=A.parameters)==null?void 0:j.docs)==null?void 0:K.source}}};var W,q,J;f.parameters={...f.parameters,docs:{...(W=f.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: "날짜 레이블",
  parameters: {
    controls: {
      disable: false
...
}`,...(ne=(te=g.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var ue,le,me;y.parameters={...y.parameters,docs:{...(ue=y.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    controls: {
      disable: false
...
}`,...(me=(le=y.parameters)==null?void 0:le.docs)==null?void 0:me.source}}};var oe,ae,Ce;b.parameters={...b.parameters,docs:{...(oe=b.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  name: "상태",
  parameters: {
    controls: {
      disable: false
...
}`,...(Ce=(ae=b.parameters)==null?void 0:ae.docs)==null?void 0:Ce.source}}};const Ne=["Playground","Basic","Simple","Outline","Icon","Card","Label","Alternate","Horizontal","Size","State"];export{I as Alternate,p as Basic,A as Card,g as Horizontal,T as Icon,f as Label,D as Outline,d as Playground,B as Simple,y as Size,b as State,Ne as __namedExportsOrder,$e as default};
