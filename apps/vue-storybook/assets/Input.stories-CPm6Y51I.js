import{_ as e}from"./Input-CJh_gXs9.js";import{w as l,s as ee}from"./story-renders-C_n8_MI3.js";import{_ as N,q as f,Y as le}from"./iframe-BHuoLYUS.js";import{_ as Q}from"./FormLayout-Dpm6QfjY.js";import{_ as ue}from"./Select-Dct-neer.js";import{a as ne}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const ae=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ie=[{name:"model-value",type:"string",default:"—",description:"v-model 바인딩 값"},{name:"type",type:"string",default:"text",description:"input type 속성"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"input_sm · input_lg"},{name:"placeholder",type:"string",default:"—",description:"placeholder 속성"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"error",type:"boolean",default:"false",description:"오류 상태 (is-error, aria-invalid)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100% (input_block)"},{name:"clearable",type:"boolean",default:"false",description:"값이 있을 때 우측 지우기 버튼 (input_clearable). readonly · disabled면 미표시"}],te=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],re=[{name:"prefix",description:"앞쪽 애드온 (input_group-addon)"},{name:"suffix",description:"뒤쪽 애드온"}],pe=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],de=[{name:"input",description:"텍스트 입력 루트"},{name:"input_sm · input_lg · input_block",description:"크기·너비"},{name:"input_masked",description:'마스킹 입력값 표시 시 자동 적용 (type="password" + 값 있음)'},{name:"input_group · input_group-addon",description:"애드온 묶음"},{name:"input_clearable · input_clear",description:"지우기 버튼 래퍼·버튼 (clearable prop)"},{name:"is-error · is-disabled",description:"상태"},...ne],se=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],oe=[{name:"--input-max-width",default:"320px",description:"데모·폼 최대 너비"},{name:"--input-clear-size · --input-clear-offset",default:"—",description:"클리어 버튼"},{name:"--input-font-masked · --input-masked-letter-spacing",default:"—",description:"마스킹 입력"}],me=[{key:"name",label:"이벤트"},{key:"description",label:"설명"}],ce=[{name:"update:modelValue",description:"입력 값 변경 시 (v-model)"}],fe=[{title:"API · Props",tables:[{columns:ae,rows:ie,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:te,rows:re,codeColumn:"name"}]},{title:"API · Events",tables:[{columns:me,rows:ce,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:pe,rows:de,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:se,rows:oe,codeColumn:"name"}]}],xe={title:"Components/폼/Input",id:"components-input",component:e,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placeholder:{control:"text",type:{name:"string",summary:"string"}},type:{control:"select",options:["text","email","password","number","tel","url","search"],type:{name:"enum",summary:"'text' | 'email' | 'password' | 'number' | 'tel' | 'url' | 'search'"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},clearable:{control:"boolean",type:{name:"boolean",summary:"boolean"}},modelValue:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:fe}},u={parameters:{controls:{disable:!1}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:(Ce,Z)=>({components:{Input:e},setup(){return{args:ee(Z)}},template:'<Input v-bind="args" />'})},n={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"레이블과 힌트 텍스트가 포함된 폼 필드입니다."},source:{code:`<script setup>
...
</template>`,language:"vue"}}},args:{size:"md",placeholder:"입력하세요",type:"text",modelValue:""},render:l(()=>({components:{Input:e},template:`<div class="form_field">
        <label class="form_field-label" for="input-name">이름</label>
        <Input id="input-name" placeholder="이름을 입력하세요" clearable />
        <p class="form_field-hint">2~20자 이내로 입력해 주세요.</p>
      </div>`}))},a={name:"단독 사용",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"form_field 래퍼 없이 `input_field`로 레이블과 input을 묶을 수 있습니다. 접근 가능한 이름은 반드시 지정합니다. 보이는 레이블이 있으면 `label.form_field-label` + `for`를, 아이콘만 있는 검색창·툴바 등에는 `label.input_group`으로 input을 감싸고 `input_group-label_hidden`으로 이름을 제공합니다."},source:{code:`<script setup>
...
<template>
  ...
  <p class="form_field-hint">아이콘만 있는 툴바 검색은 <code>label.input_group</code>으로 input을 감싸고, 화면에 보이지 않는 <code>input_group-label_hidden</code>으로 접근 가능한 이름을 지정합니다.</p>
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Button:f,Icon:N,Input:e},template:`        <div class="input_field">
        <label class="form_field-label" for="input-standalone-placeholder">검색어</label>
        <Input id="input-standalone-placeholder" placeholder="플레이스홀더" clearable />
        </div>
        <div class="input_field">
        ...
        <p class="form_field-hint">아이콘만 있는 툴바 검색은 <code>label.input_group</code>으로 input을 감싸고, 화면에 보이지 않는 <code>input_group-label_hidden</code>으로 접근 가능한 이름을 지정합니다.</p>`}))},i={name:"입력 타입",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"HTML input type에 따라 브라우저 기본 UI가 적용됩니다. class=&quot;input&quot;은 모든 타입에 공통으로 사용합니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <Input id="input-type-time" type="time" />
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Input:e},template:`        <div class="form_field">
        <label class="form_field-label" for="input-type-text">텍스트</label>
        <Input id="input-type-text" placeholder="일반 텍스트" />
        </div>
        <div class="form_field">
        ...
        <label class="form_field-label" for="input-type-time">시간</label>
        <Input id="input-type-time" type="time" />
        </div>`}))},t={name:"입력 종류",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"결제·본인인증·사업자 정보 등 도메인별 입력 패턴입니다. 예시는 부모 너비 100%를 기본으로 하며, 필요 시 form_field_fit · input_fit으로 최대 너비를 제한할 수 있습니다. input_split · input_otp · input_group · input_row를 조합해 구성합니다."},source:{code:`<script setup>
...
<template>
  ...
  <p class="form_field-hint">천 단위 구분은 표시용으로 별도 포맷팅합니다.</p>
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Button:f,Input:e,Select:ue},template:`        <div class="form_field">
        <label class="form_field-label" for="input-kind-card-1">카드번호</label>
        <div class="input_split" role="group" aria-labelledby="input-kind-card-1" data-input-split data-input-numeric>
        <Input id="input-kind-card-1" inputmode="numeric" maxlength="4" autocomplete="cc-number" aria-label="카드번호 1~4자리" placeholder="0000" />
        <span class="input_split_sep" aria-hidden="true">-</span>
        ...
        <p class="form_field-hint">천 단위 구분은 표시용으로 별도 포맷팅합니다.</p>
        </div>`}))},r={name:"크기",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"input_sm · input(기본) · input_lg로 padding·font-size를 조절합니다. 너비와는 별개이며 input_fit 등과 자유롭게 조합할 수 있습니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <Input id="input-size-lg" size="lg" placeholder="input_lg" />
        ...
        <label class="form_field-label" for="input-size-lg">Large</label>
        <Input id="input-size-lg" size="lg" placeholder="input_lg" />
        </div>`}))},p={name:"너비",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"크기와 독립적으로 너비를 제어합니다. 기본은 부모 100%, input_fit · input_field_fit · form_field_fit · form_fit으로 --input-max-width(320px)까지 제한합니다."},source:{code:`<script setup>
...
<template>
  ...
  <template #prefix>@</template>
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{FormLayout:Q,Input:e},template:`        <div class="form_field">
        <label class="form_field-label" for="input-width-full-sm">전체 너비 — Small</label>
        <Input id="input-width-full-sm" size="sm" placeholder="width: 100%" />
        </div>
        <div class="form_field">
        ...
        <Input class="input_fit" placeholder="input_group input_fit — Medium" aria-label="아이디">
        <template #prefix>@</template>
        </Input>`}))},d={name:"Input Group",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"input_group으로 앞뒤에 텍스트·아이콘 애드온을 붙일 수 있습니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <template #suffix>KRW</template>
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Input:e},template:`        <Input placeholder="example.com" aria-label="도메인">
        <template #prefix>https://</template>
        </Input>
        <Input placeholder="username" aria-label="사용자명">
        <template #prefix>@</template>
        ...
        <template #prefix>₩</template>
        <template #suffix>KRW</template>
        </Input>`}))},s={name:"필수 필드",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"required 속성과 form_field-required로 필수 입력을 표시합니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <Input id="input-required-name" placeholder="홍길동" required aria-required="true" />
        ...
        <Input id="input-required-name" placeholder="홍길동" required aria-required="true" />
        </div>`}))},o={name:"상태",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"disabled · readonly · is-error · is-success로 입력 상태를 표현합니다. 오류·성공 메시지는 색상만으로 전달하지 않고 텍스트와 aria 속성을 함께 사용합니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <p class="form_field-error" id="input-state-error-msg" role="alert">올바른 이메일 형식이 아닙니다.</p>
        ...
        <Input id="input-state-error" type="email" error model-value="invalid-email" aria-describedby="input-state-error-msg" />
        <p class="form_field-error" id="input-state-error-msg" role="alert">올바른 이메일 형식이 아닙니다.</p>
        </div>`}))},m={name:"입력 삭제",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"clearable prop으로 값이 있을 때 우측에 지우기 버튼을 표시합니다. readonly · disabled 상태에서는 버튼이 나타나지 않습니다."},source:{code:`<script setup>
import Icon from '@uxkm/ui/components/Icon.vue';
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
  ...
  <div class="form_field form_field_fit">
    ...
    <Input id="input-clear-readonly" model-value="수정 불가" readonly clearable />
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Icon:N,Input:e},template:`<div class="form_field form_field_fit">
        <label class="form_field-label" for="input-clear-text">텍스트</label>
        <Input id="input-clear-text" placeholder="입력 후 우측 X 버튼 확인" clearable />
      </div>
      <div class="form_field form_field_fit">
      ...
      <div class="form_field form_field_fit">
        <label class="form_field-label" for="input-clear-readonly">읽기 전용 (삭제 버튼 없음)</label>
        <Input id="input-clear-readonly" model-value="수정 불가" readonly clearable />
      </div>`}))},c={name:"조합 예시",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"유효성 검사 후 성공·실패 상태를 조합한 로그인 폼입니다. aria-invalid · aria-describedby · role=&quot;alert&quot; · role=&quot;status&quot;로 스크린 리더에 피드백을 전달합니다."},source:{code:`<script setup>
...
<template>
  ...
  <div class="form_actions">
    ...
    <Button variant="ghost" size="sm" type="button" label="취소" />
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Alert:le,Button:f,FormLayout:Q,Input:e},template:`        <FormLayout layout="vertical" compact novalidate aria-labelledby="example-heading">
        <Alert
        id="input-ex-form-error"
        color="danger"
        title="입력 내용을 확인해 주세요"
        ...
        </FormLayout>`}))};var C,b,_;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(_=(b=u.parameters)==null?void 0:b.docs)==null?void 0:_.source}}};var B,v,h;n.parameters={...n.parameters,docs:{...(B=n.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: "기본",
  parameters: {
    controls: {
      disable: false
...
}`,...(h=(v=n.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var D,I,x;a.parameters={...a.parameters,docs:{...(D=a.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: "단독 사용",
  parameters: {
    controls: {
      disable: false
...
}`,...(x=(I=a.parameters)==null?void 0:I.docs)==null?void 0:x.source}}};var y,g,A;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: "입력 타입",
  parameters: {
    controls: {
      disable: false
...
}`,...(A=(g=i.parameters)==null?void 0:g.docs)==null?void 0:A.source}}};var k,w,E;t.parameters={...t.parameters,docs:{...(k=t.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: "입력 종류",
  parameters: {
    controls: {
      disable: false
...
}`,...(E=(w=t.parameters)==null?void 0:w.docs)==null?void 0:E.source}}};var z,F,q;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    controls: {
      disable: false
...
}`,...(q=(F=r.parameters)==null?void 0:F.docs)==null?void 0:q.source}}};var S,L,M;p.parameters={...p.parameters,docs:{...(S=p.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: "너비",
  parameters: {
    controls: {
      disable: false
...
}`,...(M=(L=p.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};var P,V,R;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: "Input Group",
  parameters: {
    controls: {
      disable: false
...
}`,...(R=(V=d.parameters)==null?void 0:V.docs)==null?void 0:R.source}}};var Y,T,O;s.parameters={...s.parameters,docs:{...(Y=s.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  name: "필수 필드",
  parameters: {
    controls: {
      disable: false
...
}`,...(O=(T=s.parameters)==null?void 0:T.docs)==null?void 0:O.source}}};var K,U,W;o.parameters={...o.parameters,docs:{...(K=o.parameters)==null?void 0:K.docs,source:{originalSource:`{
  name: "상태",
  parameters: {
    controls: {
      disable: false
...
}`,...(W=(U=o.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};var $,G,X;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "입력 삭제",
  parameters: {
    controls: {
      disable: false
...
}`,...(X=(G=m.parameters)==null?void 0:G.docs)==null?void 0:X.source}}};var H,j,J;c.parameters={...c.parameters,docs:{...(H=c.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: "조합 예시",
  parameters: {
    controls: {
      disable: false
...
}`,...(J=(j=c.parameters)==null?void 0:j.docs)==null?void 0:J.source}}};const ye=["Playground","Basic","Standalone","Type","Kind","Size","Width","Group","Required","State","Clearable","Example"];export{n as Basic,m as Clearable,c as Example,d as Group,t as Kind,u as Playground,s as Required,r as Size,a as Standalone,o as State,i as Type,p as Width,ye as __namedExportsOrder,xe as default};
