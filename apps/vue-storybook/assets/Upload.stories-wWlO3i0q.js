import{k as Q,l as W,u as Y,a as aa,a7 as na,o as l,c as s,p as g,s as y,d as ea,r as u,g as r,t as ta,j as b,h as la,_ as p,Z as sa,$ as oa,q as T}from"./iframe-BHuoLYUS.js";import{w as o,s as ra}from"./story-renders-C_n8_MI3.js";import{_ as pa}from"./Avatar-D6fP_kZ4.js";import{a as X}from"./avatar-sample-Dq40Sw96.js";import{h as ia,a as ua}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const da=["id","disabled","multiple","accept","aria-invalid"],ma={key:1,"data-demo-slot":"hint"},ca={key:0,class:"upload_hint"},Ca={key:2,"data-demo-slot":"default"},fa={key:3,class:"upload_cards","data-demo-slot":"cards"},t=Object.assign({inheritAttrs:!1},{__name:"Upload",props:{ripple:Q,variant:{type:String,default:"button",validator:a=>["button","drag","list","picture-card","avatar"].includes(a)},disabled:Boolean,fit:Boolean,size:{type:String,default:"md",validator:a=>["sm","md","lg"].includes(a)},multiple:Boolean,accept:String,inputId:String,hint:String,dragover:Boolean,error:Boolean},setup(a){const n=a,{rippleAttrs:j,childRippleAttrs:q}=W(n,{mode:"container"});Y();const i=aa(),B=la(null);na(n,B,i);const H=b(()=>{const e=["upload"];return n.fit&&e.push("upload_fit"),n.size==="sm"&&e.push("upload_sm"),n.size==="lg"&&e.push("upload_lg"),n.disabled&&e.push("is-disabled"),i.class&&e.push(i.class),e}),Z=b(()=>{const{class:e,...D}=i;return D}),K=b(()=>n.variant==="drag"?["upload_dropzone",n.dragover?"is-dragover":"",n.error?"is-error":""].filter(Boolean):n.variant==="picture-card"?["upload_card","upload_card-trigger"]:n.variant==="avatar"?["upload_avatar"]:["upload_trigger"]);return(e,D)=>(l(),s("div",g({ref_key:"rootRef",ref:B},y(j),{class:H.value}),[a.variant!=="list"?(l(),s("label",g({key:0},y(q),{class:K.value,"data-demo-slot":"trigger"}),[ea("input",g({id:a.inputId,type:"file",class:"upload_input",tabindex:"-1",disabled:a.disabled,multiple:a.multiple||void 0,accept:a.accept,"aria-invalid":a.error?"true":void 0},Z.value),null,16,da),u(e.$slots,"trigger")],16)):r("",!0),a.variant==="button"||a.variant==="drag"?(l(),s("div",ma,[u(e.$slots,"hint",{},()=>[a.hint?(l(),s("p",ca,ta(a.hint),1)):r("",!0)])])):r("",!0),a.variant==="list"||e.$slots.default?(l(),s("div",Ca,[u(e.$slots,"default")])):r("",!0),a.variant==="picture-card"?(l(),s("div",fa,[u(e.$slots,"cards")])):r("",!0)],16))}});t.__docgenInfo=Object.assign({displayName:t.name??t.__name},{exportName:"default",displayName:"Upload",description:"",tags:{},props:[{name:"ripple",description:"클릭 파장(ripple). true 활성 · false 비활성 · 미지정 시 컴포넌트 기본",type:{name:"rippleProp"}},{name:"variant",type:{name:"string"},defaultValue:{func:!1,value:"'button'"},values:["button","drag","list","picture-card","avatar"]},{name:"disabled",type:{name:"boolean"}},{name:"fit",type:{name:"boolean"}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md","lg"]},{name:"multiple",type:{name:"boolean"}},{name:"accept",type:{name:"string"}},{name:"inputId",type:{name:"string"}},{name:"hint",type:{name:"string"}},{name:"dragover",type:{name:"boolean"}},{name:"error",type:{name:"boolean"}}],slots:[{name:"trigger"},{name:"hint"},{name:"default"},{name:"cards"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Upload.vue"]});const va=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],_a=[{name:"variant",type:"'button' | 'drag' | 'list' | 'picture-card' | 'avatar'",default:"button",description:"업로드 UI 유형"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"upload_sm · upload_lg"},{name:"disabled",type:"boolean",default:"false",description:"비활성 (is-disabled)"},{name:"fit",type:"boolean",default:"false",description:"콘텐츠 너비 (upload_fit)"},{name:"multiple",type:"boolean",default:"false",description:"다중 파일 선택"},{name:"accept",type:"string",default:"—",description:"input accept 속성"},{name:"input-id",type:"string",default:"—",description:"file input id"},{name:"hint",type:"string",default:"—",description:"button·drag variant 힌트 텍스트"},{name:"dragover",type:"boolean",default:"false",description:"드래그 오버 상태 (is-dragover)"},{name:"error",type:"boolean",default:"false",description:"오류 (is-error)"},ia],ga=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],ba=[{name:"trigger",description:"업로드 트리거 UI (button·drag·picture-card·avatar)"},{name:"hint",description:"힌트 텍스트 (hint prop 대체)"},{name:"default",description:"파일 목록 (list variant)"},{name:"cards",description:"이미지 카드 그리드 (picture-card)"}],Ba=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Da=[{name:"upload",description:"루트"},{name:"upload_sm · upload_lg · upload_fit",description:"크기·너비"},{name:"upload_trigger · upload_dropzone · upload_input",description:"button·drag 트리거"},{name:"upload_card · upload_cards · upload_avatar",description:"picture-card·avatar"},{name:"upload_list · upload_item · upload_item-info",description:"목록 variant"},{name:"upload_hint · upload_progress",description:"힌트·진행률"},{name:"is-dragover · is-error · is-disabled",description:"상태"},...ua],ya=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Ia=[{name:"--upload-max-width",default:"var(--input-max-width)",description:"최대 너비"},{name:"--upload-dropzone-padding · --upload-dropzone-icon-size",default:"—",description:"드롭존"},{name:"--upload-card-size · --upload-list-gap",default:"6.5rem · var(--space-xs)",description:"카드·목록"}],ha=[{title:"API · Props",tables:[{columns:va,rows:_a,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:ga,rows:ba,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Ba,rows:Da,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:ya,rows:Ia,codeColumn:"name"}]}],La={title:"Components/폼/Upload",id:"components-upload",component:t,tags:["autodocs"],argTypes:{variant:{control:"select",options:["button","drag","list","picture-card","avatar"],type:{name:"enum",summary:"'button' | 'drag' | 'list' | 'picture-card' | 'avatar'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},fit:{control:"boolean",type:{name:"boolean",summary:"boolean"}},size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},multiple:{control:"boolean",type:{name:"boolean",summary:"boolean"}},accept:{control:"text",type:{name:"string",summary:"string"}},inputId:{control:"text",type:{name:"string",summary:"string"}},hint:{control:"text",type:{name:"string",summary:"string"}},dragover:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:ha}},d={parameters:{controls:{disable:!1}},args:{variant:"button",disabled:!1,fit:!1,size:"md",multiple:!1,accept:"값",inputId:"값",hint:"값",dragover:!1,error:!1},render:(a,n)=>({components:{Upload:t},setup(){return{args:ra(n)}},template:`<Upload v-bind="args">
      <template #trigger>
...
</template>`,language:"vue"}}},args:{variant:"button",disabled:!1,fit:!1,size:"md",multiple:!1,accept:"값",inputId:"값",hint:"값",dragover:!1,error:!1},render:o(()=>({components:{Button:T,Icon:p,List:oa,ListItem:sa,Upload:t},template:`        <Upload variant="button" fit multiple>
        <template #trigger>
        <span class="btn btn_filled color_primary">
        <span class="btn_label">파일 추가</span>
        </span>
...
</template>`,language:"vue"}}},args:{variant:"button",disabled:!1,fit:!1,size:"md",multiple:!1,accept:"값",inputId:"값",hint:"값",dragover:!1,error:!1},render:o(()=>({components:{Button:T,Icon:p,Upload:t},setup(){return{avatarSample:X}},template:`        <Upload variant="picture-card" accept="image/*" hint="최대 5장 · JPG, PNG">
        <template #trigger>
        <Icon name="plus" size="lg" />
        <span>업로드</span>
        </template>
...
</template>`,language:"vue"}}},args:{variant:"button",disabled:!1,fit:!1,size:"md",multiple:!1,accept:"값",inputId:"값",hint:"값",dragover:!1,error:!1},render:o(()=>({components:{Avatar:pa,Icon:p,Upload:t},setup(){return{avatarSample:X}},template:`        <Upload variant="avatar" accept="image/*" input-id="upload-avatar">
        <template #trigger>
        <Avatar size="xl" :src="avatarSample" alt="프로필 사진" />
        <span class="upload_avatar-overlay" aria-hidden="true">
        <Icon name="upload" size="lg" />
...
}`,...($=(N=v.parameters)==null?void 0:N.docs)==null?void 0:$.source}}};var O,J,V;_.parameters={..._.parameters,docs:{...(O=_.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: "폼 필드",
  parameters: {
    controls: {
      disable: false
...
}`,...(V=(J=_.parameters)==null?void 0:J.docs)==null?void 0:V.source}}};const Sa=["Playground","ButtonDemo","Dropzone","ListDemo","Card","AvatarDemo","Form"];export{v as AvatarDemo,m as ButtonDemo,f as Card,c as Dropzone,_ as Form,C as ListDemo,d as Playground,Sa as __namedExportsOrder,La as default};
