...
export function Alert({
  ...
  return (
    <div class={classes} data-component="Alert" role={role} {...props}>
      ...
      <div class="alert_body">
        ...
        {content && <p class="alert_desc">{content}</p>}
        {actions}
      </div>

      {/* closable일 때만 닫기 버튼을 렌더합니다. */}
      {closable && (
        <button type="button" class="alert_close" aria-label={closeLabel} onClick={handleClose}>
          <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
            fill="none"
