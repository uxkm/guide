...
export function Slider({
  ...
  const [innerValue, setInnerValue] = createSignal(clamp(value ?? defaultValue, numericMin, numericMax),
  );
    ...
    >
      ...
      {(label || showValue) && (
        <div class="slider_header">
          {label && (
            <label class="slider_label" htmlFor={inputId}>
              {label}
            </label>
          )}
          {showValue && (
            <output class="slider_value" htmlFor={inputId}>
              {currentValue}
