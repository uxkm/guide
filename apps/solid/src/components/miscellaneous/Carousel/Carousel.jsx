...
export function Carousel({
  ...
  const [isPlaying, setIsPlaying] = createSignal(Boolean(autoplay));
  ...
  createEffect(() => {
    if (swiperRef) {
      const slideCount = swiperRef.querySelectorAll(
      ...
      instanceRef?.destroy(true, true);
      const paginationEl =
        rootRef?.querySelector(':scope > .swiper-pagination') ??
        swiperRef.querySelector('.swiper-pagination');
      ...
      if (showNavigation)
        config.navigation = {
          prevEl: swiperRef.querySelector('.swiper-button-prev'),
          nextEl: swiperRef.querySelector('.swiper-button-next'),
        };
      if (showPagination)
        config.pagination = {
          el: paginationEl,
      ...
      const instance = new Swiper(swiperRef, config);
      ...
      return () => {
        ...
        if (instanceRef === instance) instanceRef = null;
      };
    }
  });
  ...
  function toggleAutoplay() {
    const autoplayApi = instanceRef?.autoplay;
