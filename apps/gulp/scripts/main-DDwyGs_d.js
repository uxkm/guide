//#region ../../packages/interactions/src/behaviors/clickable-card.js
var e = ".checkbox_input, .radio_input";
function t(t) {
	if (!(t.target instanceof Element)) return;
	let n = t.target.closest(".checkbox_card-clickable, .radio_card-clickable");
	if (!n) return;
	let r = n.querySelector(e);
	!(r instanceof HTMLInputElement) || r.disabled || t.target.closest(".checkbox_control, .radio_control") || r.click();
}
function n(t) {
	if (!(t.target instanceof Element)) return;
	let n = t.target.closest("span.checkbox_control, span.radio_control");
	if (!n || n.closest("label.checkbox, label.radio, label.checkbox_control, label.radio_control, .checkbox, .radio")) return;
	let r = n.querySelector(e);
	!(r instanceof HTMLInputElement) || r.disabled || t.target === r || r.click();
}
function r() {
	typeof document > "u" || globalThis.__uxkmClickableCardInitialized || (globalThis.__uxkmClickableCardInitialized = !0, document.addEventListener("click", t), document.addEventListener("click", n));
}
//#endregion
//#region ../../packages/interactions/src/behaviors/ripple.js
var i = /* @__PURE__ */ new WeakMap();
function a() {
	return window.matchMedia("(prefers-reduced-motion: reduce)").matches;
}
function o(e) {
	return !e || e.closest("[data-no-ripple]") || e.disabled || e.matches("label") && e.querySelector("input:disabled, button:disabled") || e.classList.contains("is-disabled") || e.getAttribute("aria-disabled") === "true" ? !0 : !!e.closest(".is-disabled, [aria-disabled=\"true\"]");
}
function s(e, t, n) {
	let r = e.getBoundingClientRect(), a = Math.max(r.width, r.height) * 2, o = document.createElement("span");
	o.className = "ripple_wave", o.style.width = `${a}px`, o.style.height = `${a}px`, o.style.left = `${t - r.left - a / 2}px`, o.style.top = `${n - r.top - a / 2}px`, e.insertBefore(o, e.firstChild), i.set(e, Date.now());
	let s = () => o.remove();
	o.addEventListener("animationend", s, { once: !0 }), window.setTimeout(s, 600);
}
function c(e) {
	return e.target instanceof Element ? e.target.closest("[data-ripple]:not([data-ripple=\"false\"])") : null;
}
function l(e) {
	if (e.pointerType === "mouse" && e.button !== 0) return;
	let t = c(e);
	!t?.isConnected || o(t) || s(t, e.clientX, e.clientY);
}
function u(e) {
	let t = c(e);
	if (!t?.isConnected || o(t)) return;
	let n = i.get(t);
	if (n && Date.now() - n < 500) return;
	let r = t.getBoundingClientRect();
	s(t, r.left + r.width / 2, r.top + r.height / 2);
}
function d() {
	typeof document > "u" || globalThis.__uxkmRippleInitialized || (globalThis.__uxkmRippleInitialized = !0, !a() && (document.addEventListener("pointerdown", l, { passive: !0 }), document.addEventListener("click", u, { passive: !0 })));
}
//#endregion
//#region ../../packages/interactions/src/behaviors/slide-region.js
function f() {
	return typeof window < "u" && window.matchMedia("(prefers-reduced-motion: reduce)").matches;
}
function p(e, t, n) {
	let r = getComputedStyle(e), i = e.matches(".collapse, .collapse_body") || e.closest("[data-collapse]") ? "collapse" : "accordion";
	return r.getPropertyValue(`--${i}-slide-${t}`).trim() || n;
}
function m(e) {
	return `height ${p(e, "duration", "0.28s")} ${p(e, "easing", "ease")}`;
}
function h(e) {
	let t = p(e, "duration", "0.28s"), n = Number.parseFloat(t);
	return Number.isFinite(n) ? /ms$/i.test(t) ? n : n * 1e3 : 280;
}
function g(e) {
	e.classList.remove("is-sliding"), e.style.height = "", e.style.overflow = "", e.style.transition = "";
}
function _(e, t, n = !0) {
	if (!e) return;
	if (e._uxkmSlideCleanup?.(), e._uxkmSlideCleanup = null, g(e), !n || f()) {
		e.hidden = !t, e.inert = !t, e.setAttribute("aria-hidden", String(!t));
		return;
	}
	let r = !1, i, a = () => {
		r || (r = !0, e.removeEventListener("transitionend", o), window.clearTimeout(i), t || (e.hidden = !0), g(e), e._uxkmSlideCleanup = null);
	}, o = (t) => {
		t.target === e && t.propertyName === "height" && a();
	};
	e.hidden = !1, e.inert = !t, e.setAttribute("aria-hidden", String(!t)), e.style.overflow = "hidden", e.style.transition = "none", e.style.height = t ? "0px" : `${e.scrollHeight}px`, e.classList.add("is-sliding"), e.offsetHeight, e.style.transition = m(e), e.style.height = t ? `${e.scrollHeight}px` : "0px", e.addEventListener("transitionend", o), i = window.setTimeout(a, h(e) + 80), e._uxkmSlideCleanup = a;
}
//#endregion
//#region ../../packages/interactions/src/index.js
function v() {
	d(), r();
}
//#endregion
//#region src/components/form/Slider/slider.js
function y(e = document) {
	let t = e.querySelectorAll(".slider");
	return t.forEach((e) => {
		let t = e.querySelector(".slider_input");
		if (!t || t.dataset.sliderReady) return;
		t.dataset.sliderReady = "true";
		let n = e.querySelector(".slider_value"), r = () => {
			let r = Number(t.min || 0), i = Number(t.max || 100), a = Number(t.value);
			e.style.setProperty("--slider-progress", `${i === r ? 0 : (a - r) / (i - r) * 100}%`), n && (n.value = `${a}${t.dataset.sliderSuffix || ""}`);
		};
		t.addEventListener("input", r), e.querySelector(".slider_step-decrease")?.addEventListener("click", () => {
			t.stepDown(), t.dispatchEvent(new Event("input", { bubbles: !0 }));
		}), e.querySelector(".slider_step-increase")?.addEventListener("click", () => {
			t.stepUp(), t.dispatchEvent(new Event("input", { bubbles: !0 }));
		}), r();
	}), t;
}
//#endregion
//#region src/components/form/Rate/rate.js
function b(e = document) {
	let t = e.querySelectorAll(".rate:not(.is-readonly)");
	return t.forEach((e) => {
		if (e.dataset.rateReady) return;
		e.dataset.rateReady = "true";
		let t = e.querySelector(".rate_value"), n = () => {
			let n = e.querySelector(".rate_input:checked")?.value;
			e.classList.toggle("is-rated", n != null), t && (t.textContent = n == null ? "" : `${Number(n)}점`);
		};
		e.querySelectorAll(".rate_input").forEach((e) => e.addEventListener("change", n)), e.querySelectorAll(".rate_star").forEach((e) => {
			let t = e.querySelector(".rate_input-half"), n = e.querySelector(".rate_input:not(.rate_input-half)");
			e.querySelector(".rate_star-half-left")?.addEventListener("click", (e) => {
				e.preventDefault(), e.stopPropagation(), t?.disabled || (t.checked = !0, t.dispatchEvent(new Event("change", { bubbles: !0 })));
			}), e.querySelector(".rate_star-half-right")?.addEventListener("click", (e) => {
				e.preventDefault(), e.stopPropagation(), n?.disabled || (n.checked = !0, n.dispatchEvent(new Event("change", { bubbles: !0 })));
			});
		}), e.querySelector(".rate_clear")?.addEventListener("click", () => {
			e.querySelectorAll(".rate_input").forEach((e) => {
				e.checked = !1;
			}), n();
		}), n();
	}), t;
...
//#endregion
//#region ../html/src/components/form/DatePicker/date-picker.js
function x(e = document) {
	let t = e.querySelectorAll("[data-component=\"DatePicker\"]");
	return t.forEach((e) => {
		let t = e.querySelector(".date_picker_input"), n = e.querySelector(".date_picker_btn"), r = e.querySelector(".date_picker_clear"), i = e.querySelector(".date_picker_panel");
		if (!t || !n || !i || e.dataset.datePickerReady) return;
		e.dataset.datePickerReady = "true";
		let a = e.dataset.value || "", o = /^\d{4}-\d{2}-\d{2}$/.test(a) ? /* @__PURE__ */ new Date(`${a}T00:00:00`) : /* @__PURE__ */ new Date(), s = (e) => String(e).padStart(2, "0"), c = (e) => `${e.getFullYear()}-${s(e.getMonth() + 1)}-${s(e.getDate())}`, l = (e) => e ? new Intl.DateTimeFormat("ko-KR", {
			year: "numeric",
			month: "2-digit",
			day: "2-digit"
		}).format(/* @__PURE__ */ new Date(`${e}T00:00:00`)) : "", u = (r) => {
			e.classList.toggle("is-open", r), i.hidden = !r, t.setAttribute("aria-expanded", String(r)), n.setAttribute("aria-expanded", String(r)), r && requestAnimationFrame(() => i.querySelector(".is-selected:not(:disabled), .calendar_day:not(:disabled)")?.focus());
		}, d = () => {
			e.dataset.value = a, t.value = l(a), r && (r.hidden = !a);
		}, f = (t) => {
			a = t, d(), e.dispatchEvent(new CustomEvent("change", {
				bubbles: !0,
				detail: { value: t }
			}));
		}, p = () => {
			let t = new Date(o.getFullYear(), o.getMonth(), 1), n = new Date(o.getFullYear(), o.getMonth(), 1 - t.getDay()), r = c(/* @__PURE__ */ new Date()), s = Array.from({ length: 42 }, (t, i) => {
				let s = new Date(n);
				s.setDate(n.getDate() + i);
				let l = c(s), u = e.dataset.min && l < e.dataset.min || e.dataset.max && l > e.dataset.max;
				return `<button type="button" class="calendar_day${s.getMonth() === o.getMonth() ? "" : " is-other-month"}${l === r ? " is-today" : ""}${l === a ? " is-selected" : ""}" data-date="${l}"${u ? " disabled" : ""}${l === r ? " aria-current=\"date\"" : ""}${l === a ? " aria-selected=\"true\"" : ""}>${s.getDate()}</button>`;
			}).join("");
			i.innerHTML = `<div class="calendar calendar_borderless"><div class="calendar_header"><button type="button" class="btn btn_ghost btn_icon-only btn_sm" data-date-prev aria-label="이전 달">‹</button><span class="calendar_title" aria-live="polite">${o.getFullYear()}년 ${o.getMonth() + 1}월</span><button type="button" class="btn btn_ghost btn_icon-only btn_sm" data-date-next aria-label="다음 달">›</button></div><div class="calendar_weekdays" aria-hidden="true">${[
				"일",
				"월",
				"화",
				"수",
				...
				"금",
				"토"
			].map((e) => `<span class="calendar_weekday">${e}</span>`).join("")}</div><div class="calendar_grid">${s}</div><div class="calendar_footer"><button type="button" class="btn btn_text color_primary btn_sm" data-date-today>오늘</button><div class="calendar_footer-actions"><button type="button" class="btn btn_ghost btn_sm" data-date-clear>초기화</button></div></div></div>`;
		};
		e.addEventListener("click", (t) => {
			let n = t.target;
			if (n.closest(".date_picker_btn")) {
				u(!e.classList.contains("is-open"));
				return;
			}
			if (n.closest(".date_picker_input")) {
				u(!0);
				return;
			}
			if (n.closest(".date_picker_clear, [data-date-clear]")) {
				f(""), p();
				return;
			}
			if (n.closest("[data-date-prev], [data-date-next]")) {
				o = new Date(o.getFullYear(), o.getMonth() + (n.closest("[data-date-next]") ? 1 : -1), 1), p();
				return;
			}
			if (n.closest("[data-date-today]")) {
				let e = c(/* @__PURE__ */ new Date());
				f(e), o = /* @__PURE__ */ new Date(), p(), u(!1);
				return;
			}
			let r = n.closest("[data-date]");
			r && !r.disabled && (f(r.dataset.date), o = /* @__PURE__ */ new Date(`${r.dataset.date}T00:00:00`), p(), u(!1));
		}), e.addEventListener("keydown", (e) => {
			e.key === "Escape" && u(!1);
		}), document.addEventListener("pointerdown", (t) => {
			e.contains(t.target) || u(!1);
		}), d(), p(), u(!1);
	}), t;
}
//#endregion
//#region src/components/form/DatePicker/date-picker.js
function S(e = document) {
	let t = x(e);
	return t.forEach((e) => {
		let t = e.querySelector("input[type=\"hidden\"]");
		!t || e.dataset.datePickerFormReady || (e.dataset.datePickerFormReady = "true", t.value = e.dataset.value || "", e.addEventListener("change", (n) => {
			t.value = n.detail?.value ?? e.dataset.value ?? "";
		}));
	}), t;
}
//#endregion
//#region ../html/src/components/form/Upload/upload.js
function C(e = document) {
	let t = e.querySelectorAll("[data-component=\"Upload\"]"), n = (e) => e < 1024 ? `${e} B` : e < 1048576 ? `${(e / 1024).toFixed(1)} KB` : `${(e / 1048576).toFixed(1)} MB`;
	return t.forEach((e) => {
		let t = e.querySelector(".upload_input"), r = e.querySelector("[data-upload-list]"), i = e.querySelector("[data-upload-error]"), a = e.querySelector(".upload_dropzone");
		if (!t || !r || e.dataset.uploadReady) return;
		e.dataset.uploadReady = "true";
		let o = [], s = (e) => !t.accept || t.accept.split(",").some((t) => {
			let n = t.trim();
			return n.startsWith(".") ? e.name.toLowerCase().endsWith(n.toLowerCase()) : n.endsWith("/*") ? e.type.startsWith(n.slice(0, -1)) : e.type === n;
		}), c = (t) => {
			i && (i.textContent = t, i.hidden = !1), a?.classList.add("is-error"), e.dispatchEvent(new CustomEvent("uploaderror", {
				bubbles: !0,
				detail: { message: t }
			}));
		}, l = (e) => String(e).replace(/[&<>"']/g, (e) => ({
			"&": "&amp;",
			"<": "&lt;",
			">": "&gt;",
			"\"": "&quot;",
			...
			r.innerHTML = o.map((e, t) => `<li class="upload_item is-done"><span class="upload_item-icon" aria-hidden="true">▧</span><span class="upload_item-body"><span class="upload_item-name">${l(e.name)}</span><span class="upload_item-meta">${n(e.size)} · 선택 완료</span></span><button type="button" class="upload_item-action btn btn_ghost btn_icon-only btn_sm" data-upload-remove="${t}" aria-label="${l(e.name)} 파일 삭제">×</button></li>`).join("");
		}, d = (n) => {
			let r = Array.from(n || []), l = r.find((t) => !s(t) || Number(e.dataset.maxSize) && t.size > Number(e.dataset.maxSize));
			if (l) {
				c(s(l) ? `${l.name}: 파일 크기 제한을 초과했습니다.` : `${l.name}: 허용되지 않는 파일 형식입니다.`);
				return;
			}
			let d = t.multiple ? Number(e.dataset.maxFiles) || Infinity : 1;
			if ((t.multiple ? o.length : 0) + r.length > d) {
				c(`파일은 최대 ${d}개까지 선택할 수 있습니다.`);
				return;
			}
			o = t.multiple ? [...o, ...r] : r.slice(0, 1), i && (i.hidden = !0), a?.classList.remove("is-error"), t.value = "", u(), e.dispatchEvent(new CustomEvent("change", {
				bubbles: !0,
				detail: { files: o }
			}));
		};
		t.addEventListener("change", () => d(t.files)), e.querySelectorAll(".upload_trigger, .upload_dropzone, .upload_card-trigger").forEach((e) => e.addEventListener("keydown", (e) => {
			!t.disabled && (e.key === "Enter" || e.key === " ") && (e.preventDefault(), t.click());
		})), e.addEventListener("click", (t) => {
			let n = t.target.closest("[data-upload-remove]");
			n && (o.splice(Number(n.dataset.uploadRemove), 1), u(), e.dispatchEvent(new CustomEvent("change", {
				bubbles: !0,
				detail: { files: o }
			})));
		}), a && (["dragenter", "dragover"].forEach((e) => a.addEventListener(e, (e) => {
			e.preventDefault(), t.disabled || a.classList.add("is-dragover");
		})), a.addEventListener("dragleave", (e) => {
			a.contains(e.relatedTarget) || a.classList.remove("is-dragover");
		}), a.addEventListener("drop", (e) => {
			e.preventDefault(), a.classList.remove("is-dragover"), d(e.dataTransfer.files);
		}));
	}), t;
}
//#endregion
//#region ../html/src/components/feedback/Alert/alert.js
function w(e = document) {
	let t = e.querySelectorAll("[data-component=\"Alert\"]");
	return t.forEach((e) => {
		e.dataset.alertReady || (e.dataset.alertReady = "true", e.querySelector(".alert_close")?.addEventListener("click", () => {
			e.hidden = !0, e.dispatchEvent(new CustomEvent("close", { bubbles: !0 }));
		}));
	}), t;
}
//#endregion
//#region ../html/src/components/miscellaneous/Accordion/accordion.js
function T(e) {
	return {
		trigger: e.querySelector(".accordion_trigger"),
		panel: e.querySelector(".accordion_panel")
	};
}
function E(e) {
	let { trigger: t } = T(e);
	return e.classList.contains("is-disabled") || t?.disabled || t?.getAttribute("aria-disabled") === "true";
}
function D(e, t, n, r = !0) {
	let { trigger: i, panel: a } = T(e);
	e.classList.toggle("is-open", t), i?.setAttribute("aria-expanded", String(t)), a && (n ? _(a, t, r) : a.hidden = !t);
}
function O(e = document) {
	let t = [...e.querySelectorAll("[data-accordion]")];
	return t.forEach((e) => {
		if (e.dataset.accordionReady === "true") return;
		e.dataset.accordionReady = "true";
		let t = [...e.querySelectorAll(":scope > .accordion_item")], n = e.dataset.effect === "slide", r = e.hasAttribute("data-accordion-multiple");
		t.forEach((i) => {
			let { trigger: a } = T(i);
			a && (D(i, a.getAttribute("aria-expanded") === "true", n, !1), a.addEventListener("click", () => {
				if (E(i)) return;
				let o = a.getAttribute("aria-expanded") !== "true";
				o && !r && t.forEach((e) => {
					let t = T(e).trigger;
					e !== i && !E(e) && t?.getAttribute("aria-expanded") === "true" && D(e, !1, n);
				}), D(i, o, n), e.dispatchEvent(new CustomEvent("accordion:toggle", {
					bubbles: !0,
					detail: {
						item: i,
						open: o
				...
				let n = t.filter((e) => !E(e)).map((e) => T(e).trigger), r = n.indexOf(a), i = null;
				e.key === "ArrowDown" ? i = n[(r + 1) % n.length] : e.key === "ArrowUp" ? i = n[(r - 1 + n.length) % n.length] : e.key === "Home" ? i = n[0] : e.key === "End" && (i = n.at(-1)), i && (e.preventDefault(), i.focus());
			}));
		});
	}), t;
}
//#endregion
//#region ../html/src/components/miscellaneous/Collapse/collapse.js
function k(e) {
	return {
		trigger: e.querySelector(".collapse_trigger"),
		body: e.querySelector(".collapse_body")
	};
}
function A(e) {
	let { trigger: t } = k(e);
...
function j(e, t, n, r = !0) {
	let { trigger: i, body: a } = k(e);
	e.classList.toggle("is-open", t), i?.setAttribute("aria-expanded", String(t)), a && (n ? _(a, t, r) : a.hidden = !t);
}
function M(e) {
	if (e.dataset.collapseReady === "true") return;
	e.dataset.collapseReady = "true";
	let t = [...e.querySelectorAll(":scope > .collapse_panel")], n = e.dataset.effect === "slide", r = e.hasAttribute("data-collapse-accordion");
	t.forEach((i) => {
		let { trigger: a } = k(i);
		a && (j(i, a.getAttribute("aria-expanded") === "true", n, !1), a.addEventListener("click", () => {
			if (A(i)) return;
			let o = a.getAttribute("aria-expanded") !== "true";
			o && r && t.forEach((e) => {
				let t = k(e).trigger;
				e !== i && !A(e) && t?.getAttribute("aria-expanded") === "true" && j(e, !1, n);
			}), j(i, o, n), e.dispatchEvent(new CustomEvent("collapse:toggle", {
				bubbles: !0,
				detail: {
					panel: i,
					open: o
			...
			let n = t.filter((e) => !A(e)).map((e) => k(e).trigger), r = n.indexOf(a), i = null;
			e.key === "ArrowDown" ? i = n[(r + 1) % n.length] : e.key === "ArrowUp" ? i = n[(r - 1 + n.length) % n.length] : e.key === "Home" ? i = n[0] : e.key === "End" && (i = n.at(-1)), i && (e.preventDefault(), i.focus());
		}));
	});
}
function ee(e, t) {
	if (e.dataset.collapseTriggerReady === "true") return;
	let n = e.getAttribute("aria-controls"), r = n ? t.querySelector(`#${CSS.escape(n)}`) ?? document.getElementById(n) : null;
	if (!r?.classList.contains("collapse")) return;
	e.dataset.collapseTriggerReady = "true";
	let i = r.dataset.effect === "slide" || e.dataset.effect === "slide", a = (t, n = !0) => {
		e.setAttribute("aria-expanded", String(t)), r.classList.toggle("is-open", t), i ? _(r, t, n) : r.hidden = !t;
	};
	a(e.getAttribute("aria-expanded") === "true", !1), e.addEventListener("click", () => {
		let t = e.getAttribute("aria-expanded") !== "true";
		a(t), e.dispatchEvent(new CustomEvent("collapse:toggle", {
			bubbles: !0,
			detail: {
				target: r,
				open: t
...
function te(e = document) {
	e.querySelectorAll("[data-collapse]").forEach(M), e.querySelectorAll("[data-collapse-trigger]").forEach((t) => ee(t, e));
}
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/ssr-window.esm.mjs
function ne(e) {
...
function re(e = {}, t = {}) {
	...
	Object.keys(t).filter((e) => n.indexOf(e) < 0).forEach((n) => {
		e[n] === void 0 ? e[n] = t[n] : ne(t[n]) && ne(e[n]) && Object.keys(t[n]).length > 0 && re(e[n], t[n]);
	});
}
var ie = {
	body: {},
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/utils.mjs
function F(e = "") {
	...
	for (let r = 1; r < e.length; r += 1) {
		...
		if (i != null && !le(i)) {
			...
			for (let n = 0, r = e.length; n < r; n += 1) {
				...
				a !== void 0 && a.enumerable && (R(t[r]) && R(i[r]) ? i[r].__swiper__ ? t[r] = i[r] : z(t[r], i[r]) : !R(t[r]) && R(i[r]) ? (t[r] = {}, i[r].__swiper__ ? t[r] = i[r] : z(t[r], i[r])) : t[r] = i[r]);
			}
		}
	}
	return t;
...
function ue({ swiper: e, targetPosition: t, side: n }) {
	let r = P(), i = -e.translate, a = null, o, s = e.params.speed;
	e.wrapperEl.style.scrollSnapType = "none", r.cancelAnimationFrame(e.cssModeFrameID);
	let c = t > i ? "next" : "prev", l = (e, t) => c === "next" && e >= t || c === "prev" && e <= t, u = () => {
		o = (/* @__PURE__ */ new Date()).getTime(), a === null && (a = o);
		let c = Math.max(Math.min((o - a) / s, 1), 0), d = .5 - Math.cos(c * Math.PI) / 2, f = i + d * (t - i);
		if (l(f, t) && (f = t), e.wrapperEl.scrollTo({ [n]: f }), l(f, t)) {
...
function fe(e, t) {
	let n = P(), r = t.contains(e);
	return !r && n.HTMLSlotElement && t instanceof HTMLSlotElement && (r = [...t.assignedElements()].includes(e), r ||= de(e, t)), r;
}
function pe(e) {
	try {
		console.warn(e);
...
function U(e, t = []) {
	...
	return n.classList.add(...Array.isArray(t) ? t : F(t)), n;
}
function me(e) {
	let t = P(), n = N(), r = e.getBoundingClientRect(), i = n.body, a = e.clientTop || i.clientTop || 0, o = e.clientLeft || i.clientLeft || 0, s = e === t ? t.scrollY : e.scrollTop, c = e === t ? t.scrollX : e.scrollLeft;
	return {
		top: r.top + s - a,
		left: r.left + c - o
	};
...
function Y(e, t = "") {
	e.innerHTML = typeof trustedTypes < "u" ? trustedTypes.createPolicy("html", { createHTML: (e) => e }).createHTML(t) : t;
}
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/swiper-core.mjs
var ye;
function be() {
	let e = P(), t = N();
	return {
...
var Se;
function Ce({ userAgent: e } = {}) {
	let t = xe(), n = P(), r = n.navigator.platform, i = e || n.navigator.userAgent, a = {
		ios: !1,
		android: !1
...
function ke({ swiper: e, extendParams: t, on: n, emit: r }) {
	let i = [], a = P(), o = (t, n = {}) => {
...
function Me() {
	...
	let n = e.params, { wrapperEl: r, slidesEl: i, rtlTranslate: a, wrongRTL: o } = e, s = e.virtual && n.virtual.enabled, c = s ? e.virtual.slides.length : e.slides.length, l = H(i, `.${e.params.slideClass}, swiper-slide`), u = s ? e.virtual.slides.length : l.length, d = [], f = [], p = [], m = n.slidesOffsetBefore;
	...
	}), n.centeredSlides && n.cssMode && (B(r, "--swiper-centered-offset-before", ""), B(r, "--swiper-centered-offset-after", ""));
	...
	for (let r = 0; r < u; r += 1) {
		w = 0;
		let i = l[r];
		if (!(i && (C && e.grid.updateSlide(r, i, l), W(i, "display") === "none"))) {
			if (s && n.slidesPerView === "auto") n.virtual.slidesPerViewAutoSlideSize && (w = n.virtual.slidesPerViewAutoSlideSize), w && i && (n.roundLengths && (w = Math.floor(w)), i.style[e.getDirectionLabel("width")] = `${w}px`);
				...
				if (a && (i.style.transform = "none"), o && (i.style.webkitTransform = "none"), n.roundLengths) w = e.isHorizontal() ? _e(i, "width", !0) : _e(i, "height", !0);
				else {
	...
	if (Object.assign(e, {
		...
		B(r, "--swiper-centered-offset-before", `${-d[0]}px`), B(r, "--swiper-centered-offset-after", `${e.size / 2 - p[p.length - 1] / 2}px`);
...
function Ie(e = this && this.translate || 0) {
	...
	for (let e = 0; e < r.length; e += 1) {
		...
		h && (t.visibleSlides.push(c), t.visibleSlidesIndexes.push(e)), Fe(c, h, n.slideVisibleClass), Fe(c, m, n.slideFullyVisibleClass), c.progress = i ? -u : u, c.originalProgress = i ? -d : d;
	}
}
function Le(e) {
	let t = this;
...
function ze() {
	let e = this, { slides: t, params: n, slidesEl: r, activeIndex: i } = e, a = e.virtual && n.virtual.enabled, o = e.grid && n.grid && n.grid.rows > 1, s = (e) => H(r, `.${n.slideClass}${e}, swiper-slide${e}`)[0], c, l, u;
	if (a) {
		if (n.loop) {
	...
	c && (o || (u = ge(c, `.${n.slideClass}, swiper-slide`)[0], n.loop && !u && (u = t[0]), l = he(c, `.${n.slideClass}, swiper-slide`)[0], n.loop)), t.forEach((e) => {
		Re(e, e === c, n.slideActiveClass), Re(e, e === u, n.slideNextClass), Re(e, e === l, n.slidePrevClass);
	}), e.emitSlidesClasses();
}
var Be = (e, t) => {
	...
	else for (let r = Math.max(i - t, 0); r <= Math.min(a + t, n - 1); r += 1) r !== i && (r > a || r < i) && Ve(e, r);
};
function Ue(e) {
...
function We(e) {
	...
	if (c === void 0 && (c = Ue(t)), r.indexOf(n) >= 0) l = r.indexOf(n);
	else {
	...
	Object.assign(t, {
		...
		previousIndex: a,
		activeIndex: c
	}), t.initialized && He(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (o !== f && t.emit("realIndexChange"), t.emit("slideChange"));
}
function Ge(e, t) {
...
function Ze(e = 0, t = this.params.speed, n = !0, r = !0, i) {
	...
	if (u = r && e > c ? c : r && e < l ? l : e, a.updateProgress(u), o.cssMode) {
		...
		if (t === 0) s[e ? "scrollLeft" : "scrollTop"] = -u;
			...
			if (!a.support.smoothScroll) return ue({
				swiper: a,
				targetPosition: -u,
				side: e ? "left" : "top"
			}), !0;
...
function et({ swiper: e, runCallbacks: t, direction: n, step: r }) {
...
function tt(e = !0, t) {
	...
	r.cssMode || (r.autoHeight && n.updateAutoHeight(), et({
		swiper: n,
		runCallbacks: e,
		direction: t,
		step: "Start"
...
function nt(e = !0, t) {
	let n = this, { params: r } = n;
	n.animating = !1, !r.cssMode && (n.setTransition(0), et({
		swiper: n,
		runCallbacks: e,
		direction: t,
		step: "End"
...
function ut() {
	...
	if (t.loop) {
		...
		a = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? e.slideToLoop(a) : i > (s ? (e.slides.length - r) / 2 - (e.params.grid.rows - 1) : e.slides.length - r) ? (e.loopFix(), i = e.getSlideIndex(H(n, `${o}[data-swiper-slide-index="${a}"]`)[0]), I(() => {
			e.slideTo(i);
		})) : e.slideTo(i);
	} else e.slideTo(i);
}
...
function ft(e, t) {
	...
	let a = () => {
		H(i, `.${r.slideClass}, swiper-slide`).forEach((e, t) => {
			e.setAttribute("data-swiper-slide-index", t);
		});
	}, o = () => {
		let e = H(i, `.${r.slideBlankClass}`);
		e.forEach((e) => {
			e.remove();
	...
	let c = r.slidesPerGroup * (s ? r.grid.rows : 1), l = n.slides.length % c !== 0, u = s && n.slides.length % r.grid.rows !== 0, d = (e) => {
		for (let t = 0; t < e; t += 1) {
			let e = n.isElement ? U("swiper-slide", [r.slideBlankClass]) : U("div", [r.slideClass, r.slideBlankClass]);
			n.slidesEl.append(e);
		}
	};
	l ? (r.loopAddBlankSlides ? (d(c - n.slides.length % c), n.recalcSlides(), n.updateSlides()) : pe("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)"), a()) : (u && (r.loopAddBlankSlides ? (d(r.grid.rows - n.slides.length % r.grid.rows), n.recalcSlides(), n.updateSlides()) : pe("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)")), a());
...
function pt({ slideRealIndex: e, slideTo: t = !0, direction: n, setTranslate: r, activeSlideIndex: i, initial: a, byController: o, byMousewheel: s } = {}) {
	let c = this;
	...
	l.length < y + x || c.params.effect === "cards" && l.length < y + x * 2 ? pe("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : S && p.grid.fill === "row" && pe("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
	...
	let O = n === "next" || !n, k = n === "prev" || !n, A = 0, j = 0, M = (S ? l[i].column : i) + (v && r === void 0 ? -y / 2 + .5 : 0);
	if (M < x) {
		A = Math.max(x - M, b);
	...
	if (c.__preventObserver__ = !0, requestAnimationFrame(() => {
		...
		if (C.length > 0 && k) {
			if (e === void 0) {
				let e = c.slidesGrid[D], t = c.slidesGrid[D + A] - e;
				s ? c.setTranslate(c.translate - t) : (c.slideTo(D + Math.ceil(A), 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t));
			} else if (r) {
			...
			if (e === void 0) {
				let e = c.slidesGrid[D], t = c.slidesGrid[D - j] - e;
				s ? c.setTranslate(c.translate - t) : (c.slideTo(D - j, 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t));
			} else {
	...
	if (c.allowSlidePrev = u, c.allowSlideNext = d, c.controller && c.controller.control && !o) {
		...
		Array.isArray(c.controller.control) ? c.controller.control.forEach((e) => {
			...
			...a,
			slideTo: c.controller.control.params.slidesPerView === p.slidesPerView && t
		});
	}
	c.emit("loopFix");
}
...
function bt(e, t, n) {
	let r = P(), { params: i } = e, a = i.edgeSwipeDetection, o = i.edgeSwipeThreshold;
	return a && (n <= o || n >= r.innerWidth - o) ? a === "prevent" && (t.preventDefault(), !0) : !0;
}
function xt(e) {
	let t = this, n = N(), r = e;
	...
	if (r.type === "touchstart") {
		bt(t, r, r.targetTouches[0].pageX);
		return;
	}
	...
	let c = r.target;
	if (a.touchEventsTarget === "wrapper" && !fe(c, t.wrapperEl) || "which" in r && r.which === 3 || "button" in r && r.button > 0 || i.isTouched && i.isMoved) return;
	...
	if (a.noSwiping && (f ? yt(d, c) : c.closest(d))) {
		t.allowClick = !0;
		return;
	}
	...
	Object.assign(i, {
		...
		isScrolling: void 0,
		startMoving: void 0
	}), o.startX = p, o.startY = m, i.touchStartTime = L(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (i.allowThresholdMove = !1);
	let h = !0;
...
function St(e) {
	let t = N(), n = this, r = n.touchEventsData, { params: i, touches: a, rtlTranslate: o, enabled: s } = n;
...
function Ct(e) {
	let t = this, n = t.touchEventsData, r = e;
	r.originalEvent && (r = r.originalEvent);
	let i;
...
function Dt(e) {
	let t = this;
	Be(t, e.target), !(t.params.cssMode || t.params.slidesPerView !== "auto" && !t.params.autoHeight) && t.update();
}
function Ot() {
	let e = this;
...
var kt = (e, t) => {
	let n = N(), { params: r, el: i, wrapperEl: a, device: o } = e, s = !!r.nested, c = t === "on" ? "addEventListener" : "removeEventListener", l = t;
	!i || typeof i == "string" || (n[c]("touchstart", e.onDocumentTouchStart, {
		...
		passive: !1,
		capture: s
	}), n[c]("touchend", e.onTouchEnd, { passive: !0 }), n[c]("pointerup", e.onTouchEnd, { passive: !0 }), n[c]("pointercancel", e.onTouchEnd, { passive: !0 }), n[c]("touchcancel", e.onTouchEnd, { passive: !0 }), n[c]("pointerout", e.onTouchEnd, { passive: !0 }), n[c]("pointerleave", e.onTouchEnd, { passive: !0 }), n[c]("contextmenu", e.onTouchEnd, { passive: !0 }), (r.preventClicks || r.preventClicksPropagation) && i[c]("click", e.onClick, !0), r.cssMode && a[c]("scroll", e.onScroll), r.updateOnWindowResize ? e[l](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", wt, !0) : e[l]("observerUpdate", wt, !0), i[c]("load", e.onLoad, { capture: !0 }));
};
function At() {
	let e = this, { params: t } = e;
	e.onTouchStart = xt.bind(e), e.onTouchMove = St.bind(e), e.onTouchEnd = Ct.bind(e), e.onDocumentTouchStart = Ot.bind(e), t.cssMode && (e.onScroll = Et.bind(e)), e.onClick = Tt.bind(e), e.onLoad = Dt.bind(e), kt(e, "on");
}
function jt() {
	kt(this, "off");
}
...
function Pt() {
	...
	let o = N(), s = r.breakpointsBase === "window" || !r.breakpointsBase ? r.breakpointsBase : "container", c = ["window", "container"].includes(r.breakpointsBase) || !r.breakpointsBase ? e.el : o.querySelector(r.breakpointsBase), l = e.getBreakpoint(a, s, c);
	if (!l || e.currentBreakpoint === l) return;
	let u = (l in a ? a[l] : void 0) || e.originalParams, d = Nt(e, r), f = Nt(e, u), p = e.params.grabCursor, m = u.grabCursor, h = r.enabled;
...
function Ft(e, t = "window", n) {
	if (!e || t === "container" && !n) return;
	let r = !1, i = P(), a = t === "window" ? i.innerHeight : n.clientHeight, o = Object.keys(e).map((e) => {
...
function Rt() {
	let e = this, { classNames: t, params: n, rtl: r, el: i, device: a } = e, o = Lt([
		"initialized",
		n.direction,
...
var Gt = {
	...
	constructor(...t) {
		...
		let a = this;
		a.__swiper__ = !0, a.support = xe(), a.device = we({ userAgent: r.userAgent }), a.browser = De(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], r.modules && Array.isArray(r.modules) && a.modules.push(...r.modules);
		let o = {};
		...
		}), a.params = z({}, z({}, Ut, o), Kt, r), a.originalParams = z({}, a.params), a.passedParams = z({}, r), a.params && a.params.on && Object.keys(a.params.on).forEach((e) => {
	...
	getSlideIndex(e) {
		let { slidesEl: t, params: n } = this, r = G(H(t, `.${n.slideClass}, swiper-slide`)[0]);
		return G(e) - r;
	}
	...
	recalcSlides() {
		...
		e.slides = H(t, `.${n.slideClass}, swiper-slide`);
	}
	enable() {
		let e = this;
	...
	mount(e) {
		...
		let r = () => `.${(t.params.wrapperClass || "").trim().split(" ").join(".")}`, i = n && n.shadowRoot && n.shadowRoot.querySelector ? n.shadowRoot.querySelector(r()) : H(n, r())[0];
		return !i && t.params.createElements && (i = U("div", t.params.wrapperClass), n.append(i), H(n, `.${t.params.slideClass}`).forEach((e) => {
			i.append(e);
		})), Object.assign(t, {
			el: n,
			wrapperEl: i,
			...
			rtlTranslate: t.params.direction === "horizontal" && (n.dir.toLowerCase() === "rtl" || W(n, "direction") === "rtl"),
			wrongRTL: W(i, "display") === "-webkit-box"
		}), !0;
	}
	init(e) {
		let t = this;
		...
		return t.isElement && n.push(...t.hostEl.querySelectorAll("[loading=\"lazy\"]")), n.forEach((e) => {
			e.complete ? Be(t, e) : e.addEventListener("load", (e) => {
				Be(t, e.target);
			});
	...
	destroy(e = !0, t = !0) {
		...
		return n.params === void 0 || n.destroyed ? null : (n.emit("beforeDestroy"), n.initialized = !1, n.detachEvents(), r.loop && n.loopDestroy(), t && (n.removeClasses(), i && typeof i != "string" && i.removeAttribute("style"), a && a.removeAttribute("style"), o && o.length && o.forEach((e) => {
			...
			n.off(e);
		}), e !== !1 && (n.el && typeof n.el != "string" && (n.el.swiper = null), oe(n)), n.destroyed = !0, null);
	}
...
Object.keys(Gt).forEach((e) => {
	Object.keys(Gt[e]).forEach((t) => {
		qt.prototype[t] = Gt[e][t];
	});
}), qt.use([Oe, ke]);
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/virtual.mjs
function Jt({ swiper: e, extendParams: t, on: n, emit: r }) {
	...
	function s(t, n) {
		...
		let i;
		return r.renderSlide ? (i = r.renderSlide.call(e, t, n), typeof i == "string" && (Y(o, i), i = o.children[0])) : i = e.isElement ? U("swiper-slide") : U("div", e.params.slideClass), i.setAttribute("data-swiper-slide-index", n), r.renderSlide || Y(i, t), r.cache && (e.virtual.cache[n] = i), i;
	}
	function c(t, n, i) {
		...
		let j = l ? -g.length : 0, M = l ? g.length * 2 : g.length;
		for (let e = j; e < M; e += 1) if (e >= w && e <= T) {
			let n = A(e);
		...
		H(e.slidesEl, ".swiper-slide, swiper-slide").forEach((t) => {
			t.style[b] = `${E - Math.abs(e.cssOverflowAdjustment())}px`;
		}), D();
	}
	function l(t) {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/keyboard.mjs
function Yt({ swiper: e, extendParams: t, on: n, emit: r }) {
	...
	function o(t) {
		...
		if (!(o.shiftKey || o.altKey || o.ctrlKey || o.metaKey) && !(i.activeElement && (i.activeElement.isContentEditable || i.activeElement.nodeName && (i.activeElement.nodeName.toLowerCase() === "input" || i.activeElement.nodeName.toLowerCase() === "textarea")))) {
			if (e.params.keyboard.onlyInViewport && (l || u || d || f || p || m)) {
				let t = !1;
				if (K(e.el, `.${e.params.slideClass}, swiper-slide`).length > 0 && K(e.el, `.${e.params.slideActiveClass}`).length === 0) return;
				let r = e.el, i = r.clientWidth, o = r.clientHeight, s = a.innerWidth, c = a.innerHeight, l = me(r);
			...
			e.isHorizontal() ? ((l || u || d || f) && (o.preventDefault ? o.preventDefault() : o.returnValue = !1), ((u || f) && !n || (l || d) && n) && e.slideNext(), ((l || d) && !n || (u || f) && n) && e.slidePrev()) : ((l || u || p || m) && (o.preventDefault ? o.preventDefault() : o.returnValue = !1), (u || m) && e.slideNext(), (l || p) && e.slidePrev()), r("keyPress", s);
		}
	}
	function s() {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/mousewheel.mjs
function Xt({ swiper: e, extendParams: t, on: n, emit: r }) {
	...
	function f(t) {
		return e.params.mousewheel.thresholdDelta && t.delta < e.params.mousewheel.thresholdDelta || e.params.mousewheel.thresholdTime && L() - o < e.params.mousewheel.thresholdTime ? !1 : t.delta >= 6 && L() - o < 60 || (t.direction < 0 ? (!e.isEnd || e.params.loop) && !e.animating && (e.slideNext(), r("scroll", t.raw)) : (!e.isBeginning || e.params.loop) && !e.animating && (e.slidePrev(), r("scroll", t.raw)), o = new i.Date().getTime(), !1);
	}
	function p(t) {
	...
	function g() {
		return e.params.cssMode ? (e.wrapperEl.removeEventListener("wheel", m), !0) : !e.mousewheel.enabled && (h("addEventListener"), e.mousewheel.enabled = !0, !0);
	}
	function _() {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/create-element-if-not-defined.mjs
function Zt(e, t, n, r) {
	return e.params.createElements && Object.keys(r).forEach((i) => {
		if (!n[i] && n.auto === !0) {
			let a = H(e.el, `.${r[i]}`)[0];
			a || (a = U("div", r[i]), a.className = r[i], e.el.append(a)), n[i] = a, t[i] = a;
		}
	}), n;
}
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/navigation.mjs
var Qt = "<svg class=\"swiper-navigation-icon\" width=\"11\" height=\"20\" viewBox=\"0 0 11 20\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M0.38296 20.0762C0.111788 19.805 0.111788 19.3654 0.38296 19.0942L9.19758 10.2796L0.38296 1.46497C0.111788 1.19379 0.111788 0.754138 0.38296 0.482966C0.654131 0.211794 1.09379 0.211794 1.36496 0.482966L10.4341 9.55214C10.8359 9.9539 10.8359 10.6053 10.4341 11.007L1.36496 20.0762C1.09379 20.3474 0.654131 20.3474 0.38296 20.0762Z\" fill=\"currentColor\"/></svg>";
function $t({ swiper: e, extendParams: t, on: n, emit: r }) {
	...
	function l() {
		...
		if (e.params.navigation = Zt(e, e.originalParams.navigation, e.params.navigation, {
		...
		let a = (n, r) => {
			if (n) {
				if (t.addIcons && n.matches(".swiper-button-next,.swiper-button-prev") && !n.querySelector("svg")) {
					...
					Y(e, Qt), n.appendChild(e.querySelector("svg")), e.remove();
				}
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/classes-to-selector.mjs
function X(e = "") {
	return `.${e.trim().replace(/([\.:!+\/()[\]])/g, "\\$1").replace(/ /g, ".")}`;
}
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/pagination.mjs
function en({ swiper: e, extendParams: t, on: n, emit: r }) {
	...
	function u(t) {
		let n = t.target.closest(X(e.params.pagination.bulletClass));
		if (!n) return;
		t.preventDefault();
		let r = G(n) * e.params.slidesPerGroup;
		if (e.params.loop) {
	...
	function d() {
		...
		if (e.params.loop ? (u = e.previousRealIndex || 0, l = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex) : e.snapIndex === void 0 ? (u = e.previousIndex || 0, l = e.activeIndex || 0) : (l = e.snapIndex, u = e.previousSnapIndex), n.type === "bullets" && e.pagination.bullets && e.pagination.bullets.length > 0) {
			...
			if (n.dynamicBullets && (a = _e(r[0], e.isHorizontal() ? "width" : "height", !0), i.forEach((t) => {
		...
		i.forEach((t, i) => {
			if (n.type === "fraction" && (t.querySelectorAll(X(n.currentClass)).forEach((e) => {
				e.textContent = n.formatFractionCurrent(l + 1);
			}), t.querySelectorAll(X(n.totalClass)).forEach((e) => {
				...
				let i = (l + 1) / f, a = 1, o = 1;
				r === "horizontal" ? a = i : o = i, t.querySelectorAll(X(n.progressbarFillClass)).forEach((t) => {
					t.style.transform = `translate3d(0,0,0) scaleX(${a}) scaleY(${o})`, t.style.transitionDuration = `${e.params.speed}ms`;
				});
			}
			n.type === "custom" && n.renderCustom ? (Y(t, n.renderCustom(e, l + 1, f)), i === 0 && r("paginationRender", t)) : (i === 0 && r("paginationRender", t), r("paginationUpdate", t)), e.params.watchOverflow && e.enabled && t.classList[e.isLocked ? "add" : "remove"](n.lockClass);
		});
	}
	function f() {
		...
		t.type === "fraction" && (a = t.renderFraction ? t.renderFraction.call(e, t.currentClass, t.totalClass) : `<span class="${t.currentClass}"></span> / <span class="${t.totalClass}"></span>`), t.type === "progressbar" && (a = t.renderProgressbar ? t.renderProgressbar.call(e, t.progressbarFillClass) : `<span class="${t.progressbarFillClass}"></span>`), e.pagination.bullets = [], i.forEach((n) => {
			t.type !== "custom" && Y(n, a || ""), t.type === "bullets" && e.pagination.bullets.push(...n.querySelectorAll(X(t.bulletClass)));
		}), t.type !== "custom" && r("paginationRender", i[0]);
	}
	function p() {
		e.params.pagination = Zt(e, e.originalParams.pagination, e.params.pagination, { el: "swiper-pagination" });
		let t = e.params.pagination;
		if (!t.el) return;
		let n;
		typeof t.el == "string" && e.isElement && (n = e.el.querySelector(t.el)), !n && typeof t.el == "string" && (n = [...document.querySelectorAll(t.el)]), n ||= t.el, !(!n || n.length === 0) && (e.params.uniqueNavElements && typeof t.el == "string" && Array.isArray(n) && n.length > 1 && (n = [...e.el.querySelectorAll(t.el)], n.length > 1 && (n = n.find((t) => K(t, ".swiper")[0] === e.el))), Array.isArray(n) && n.length === 1 && (n = n[0]), Object.assign(e.pagination, { el: n }), n = J(n), n.forEach((n) => {
	...
	n("changeDirection", () => {
		...
		t && (t = J(t), t.forEach((t) => t.classList[e.enabled ? "remove" : "add"](e.params.pagination.lockClass)));
	}), n("lock unlock", () => {
		d();
	}), n("click", (t, n) => {
		let i = n.target, a = J(e.pagination.el);
	...
	let h = () => {
		...
		let { el: t } = e.pagination;
		t && (t = J(t), t.forEach((t) => t.classList.remove(e.params.pagination.paginationDisabledClass))), p(), f(), d();
	}, g = () => {
		e.el.classList.add(e.params.pagination.paginationDisabledClass);
		let { el: t } = e.pagination;
		t && (t = J(t), t.forEach((t) => t.classList.add(e.params.pagination.paginationDisabledClass))), m();
	};
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/scrollbar.mjs
function tn({ swiper: e, extendParams: t, on: n, emit: r }) {
	let i = N(), a = !1, o = null, s = null, c, l, u, d;
	t({ scrollbar: {
		el: null,
		dragSize: "auto",
		hide: !1,
	...
	function g(t) {
		...
		a = (h(t) - me(i)[e.isHorizontal() ? "left" : "top"] - (c === null ? l / 2 : c)) / (u - l), a = Math.max(Math.min(a, 1), 0), r && (a = 1 - a);
	...
	function y(t) {
		...
		a && (a = !1, e.params.cssMode && (e.wrapperEl.style["scroll-snap-type"] = "", o.style.transitionDuration = ""), n.hide && (clearTimeout(s), s = I(() => {
	...
	function C() {
		...
		e.params.scrollbar = Zt(e, e.originalParams.scrollbar, e.params.scrollbar, { el: "swiper-scrollbar" });
		...
		let o;
		a && (o = a.querySelector(X(e.params.scrollbar.dragClass)), o || (o = U("div", e.params.scrollbar.dragClass), a.append(o))), Object.assign(t, {
			el: a,
			dragEl: o
		}), r.draggable && x(), a && a.classList[e.enabled ? "remove" : "add"](...F(e.params.scrollbar.lockClass));
	}
	function w() {
		let t = e.params.scrollbar, n = e.scrollbar.el;
		n && n.classList.remove(...F(e.isHorizontal() ? t.horizontalClass : t.verticalClass)), S();
	}
	n("changeDirection", () => {
		...
		t && t.classList[e.enabled ? "remove" : "add"](...F(e.params.scrollbar.lockClass));
	}), n("destroy", () => {
		w();
	});
	let T = () => {
		e.el.classList.remove(...F(e.params.scrollbar.scrollbarDisabledClass)), e.scrollbar.el && e.scrollbar.el.classList.remove(...F(e.params.scrollbar.scrollbarDisabledClass)), C(), m(), f();
	}, E = () => {
		e.el.classList.add(...F(e.params.scrollbar.scrollbarDisabledClass)), e.scrollbar.el && e.scrollbar.el.classList.add(...F(e.params.scrollbar.scrollbarDisabledClass)), w();
	};
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/parallax.mjs
function nn({ swiper: e, extendParams: t, on: n }) {
	...
	let r = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]", i = (t, n) => {
		...
		let { el: t, slides: n, progress: a, snapGrid: o, isElement: s } = e, c = H(t, r);
		e.isElement && c.push(...H(e.hostEl, r)), c.forEach((e) => {
			i(e, a);
		}), n.forEach((t, n) => {
			let s = t.progress;
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/zoom.mjs
function rn({ swiper: e, extendParams: t, on: n, emit: r }) {
	...
	function S(t) {
		...
		if (l = !1, u = !1, d.push(t), !(d.length < 2)) {
			if (l = !0, f.scaleStart = g(), !f.slideEl) {
				...
				if (r &&= r.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0], f.imageEl = r, r ? f.imageWrapEl = K(f.imageEl, `.${n.containerClass}`)[0] : f.imageWrapEl = void 0, !f.imageWrapEl) {
					f.imageEl = void 0;
					return;
				}
				f.maxRatio = _();
	...
	function k(t) {
		...
		p.isMoved || (p.width = f.imageEl.offsetWidth || f.imageEl.clientWidth, p.height = f.imageEl.offsetHeight || f.imageEl.clientHeight, p.startX = ce(f.imageWrapEl, "x") || 0, p.startY = ce(f.imageWrapEl, "y") || 0, f.slideWidth = f.slideEl.offsetWidth, f.slideHeight = f.slideEl.offsetHeight, f.imageWrapEl.style.transitionDuration = "0ms");
	...
	function ee(t) {
		...
		if (!f.slideEl) {
			t && t.target && (f.slideEl = t.target.closest(`.${e.params.slideClass}, swiper-slide`)), f.slideEl || (e.params.virtual && e.params.virtual.enabled && e.virtual ? f.slideEl = H(e.slidesEl, `.${e.params.slideActiveClass}`)[0] : f.slideEl = e.slides[e.activeIndex]);
			let n = f.slideEl.querySelector(`.${r.containerClass}`);
			n &&= n.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0], f.imageEl = n, n ? f.imageWrapEl = K(f.imageEl, `.${r.containerClass}`)[0] : f.imageWrapEl = void 0;
		}
		if (!f.imageEl || !f.imageWrapEl) return;
		e.params.cssMode && (e.wrapperEl.style.overflow = "hidden", e.wrapperEl.style.touchAction = "none"), f.slideEl.classList.add(`${r.zoomedSlideClass}`);
	...
	function ie() {
		...
		if (t.enabled) return;
		t.enabled = !0;
		let { passiveListener: n, activeListenerWithCapture: r } = re();
	...
	n("init", () => {
		...
		!e.animating && e.params.zoom.enabled && e.zoom.enabled && e.params.zoom.toggle && ne(n);
	}), n("transitionEnd", () => {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/controller.mjs
function an({ swiper: e, extendParams: t, on: n }) {
	t({ controller: {
		control: void 0,
		inverse: !1,
		by: "slide"
	...
	function o(t, n) {
		...
		function o(n) {
			n.destroyed || (n.setTransition(t, e), t !== 0 && (n.transitionStart(), n.params.autoHeight && I(() => {
				n.updateAutoHeight();
			}), q(n.wrapperEl, () => {
				i && n.transitionEnd();
			})));
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/a11y.mjs
function on({ swiper: e, extendParams: t, on: n }) {
	t({ a11y: {
		enabled: !0,
	...
	function y(t) {
		...
		if (!(e.pagination && e.pagination.el && (r === e.pagination.el || e.pagination.el.contains(t.target)) && !t.target.matches(X(e.params.pagination.bulletClass)))) {
			if (e.navigation && e.navigation.prevEl && e.navigation.nextEl) {
				let t = J(e.navigation.prevEl);
				J(e.navigation.nextEl).includes(r) && (e.isEnd && !e.params.loop || e.slideNext(), e.isEnd ? s(n.lastSlideMessage) : s(n.nextSlideMessage)), t.includes(r) && (e.isBeginning && !e.params.loop || e.slidePrev(), e.isBeginning ? s(n.firstSlideMessage) : s(n.prevSlideMessage));
			}
			e.pagination && r.matches(X(e.params.pagination.bulletClass)) && r.click();
		}
	}
	function b() {
		if (e.params.loop || e.params.rewind || !e.navigation) return;
		let { nextEl: t, prevEl: n } = e.navigation;
		n && (e.isBeginning ? (_(n), u(n)) : (v(n), l(n))), t && (e.isEnd ? (_(t), u(t)) : (v(t), l(t)));
	}
	function x() {
	...
	function C() {
		let t = e.params.a11y;
		x() && e.pagination.bullets.forEach((n) => {
			e.params.pagination.clickable && (l(n), e.params.pagination.renderBullet || (d(n, "button"), m(n, t.paginationBulletMessage.replace(/\{\{index\}\}/, G(n) + 1)))), n.matches(X(e.params.pagination.bulletActiveClass)) ? n.setAttribute("aria-current", "true") : n.removeAttribute("aria-current");
		});
	}
	let w = (e, t, n) => {
		l(e), e.tagName !== "BUTTON" && (d(e, "button"), e.addEventListener("keydown", y)), m(e, n), p(e, t);
	}, T = (t) => {
		...
		a = n;
		let r = e.slides.indexOf(n) === e.activeIndex, s = e.params.watchSlidesProgress && e.visibleSlides && e.visibleSlides.includes(n);
		r || s || t.sourceCapabilities && t.sourceCapabilities.firesTouchEvents || (e.isHorizontal() ? e.el.scrollLeft = 0 : e.el.scrollTop = 0, requestAnimationFrame(() => {
			i ||= (e.params.loop ? e.slideToLoop(e.getSlideIndexWhenGrid(parseInt(n.getAttribute("data-swiper-slide-index"))), 0) : e.slideTo(e.getSlideIndexWhenGrid(e.slides.indexOf(n)), 0), !1);
		}));
	}, k = () => {
		let t = e.params.a11y;
		...
		t.slideLabelMessage && e.slides.forEach((r, i) => {
			...
			m(r, t.slideLabelMessage.replace(/\{\{index\}\}/, a + 1).replace(/\{\{slidesLength\}\}/, n));
		});
	}, A = () => {
		let t = e.params.a11y;
		e.el.append(r);
		let n = e.el;
		t.containerRoleDescriptionMessage && f(n, t.containerRoleDescriptionMessage), t.containerMessage && m(n, t.containerMessage), t.containerRole && d(n, t.containerRole);
		let i = e.wrapperEl, a = t.id || i.getAttribute("id") || `swiper-wrapper-${c(16)}`;
		h(i, a), t.wrapperLiveRegion && g(i, e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite"), k();
		let { nextEl: o, prevEl: s } = e.navigation ? e.navigation : {};
		o = J(o), s = J(s), o && o.forEach((e) => w(e, a, t.nextSlideMessage)), s && s.forEach((e) => w(e, a, t.prevSlideMessage)), S() && J(e.pagination.el).forEach((e) => {
			e.addEventListener("keydown", y);
		}), N().addEventListener("visibilitychange", D), e.el.addEventListener("focus", O, !0), e.el.addEventListener("focus", O, !0), e.el.addEventListener("pointerdown", T, !0), e.el.addEventListener("pointerup", E, !0);
	};
	function j() {
		r && r.remove();
		let { nextEl: t, prevEl: n } = e.navigation ? e.navigation : {};
		t = J(t), n = J(n), t && t.forEach((e) => e.removeEventListener("keydown", y)), n && n.forEach((e) => e.removeEventListener("keydown", y)), S() && J(e.pagination.el).forEach((e) => {
			e.removeEventListener("keydown", y);
		}), N().removeEventListener("visibilitychange", D), e.el && typeof e.el != "string" && (e.el.removeEventListener("focus", O, !0), e.el.removeEventListener("pointerdown", T, !0), e.el.removeEventListener("pointerup", E, !0));
	}
	n("beforeInit", () => {
		r = U("span", e.params.a11y.notificationClass), r.setAttribute("aria-live", "assertive"), r.setAttribute("aria-atomic", "true");
	}), n("afterInit", () => {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/history.mjs
function sn({ swiper: e, extendParams: t, on: n }) {
	...
	let r = !1, i = {}, a = (e) => e.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""), o = (e) => {
		...
		let s = e.virtual && e.params.virtual.enabled ? e.slidesEl.querySelector(`[data-swiper-slide-index="${n}"]`) : e.slides[n], c = a(s.getAttribute("data-history"));
		...
		l && l.value === c || (e.params.history.replaceState ? i.history.replaceState({ value: c }, null, c) : i.history.pushState({ value: c }, null, c));
	}, c = (t, n, r) => {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/hash-navigation.mjs
function cn({ swiper: e, extendParams: t, emit: n, on: r }) {
	let i = !1, a = N(), o = P();
	t({ hashNavigation: {
		enabled: !1,
		replaceState: !1,
		...
		getSlideIndex(t, n) {
			...
			return e.getSlideIndex(H(e.slidesEl, `.${e.params.slideClass}[data-hash="${n}"], swiper-slide[data-hash="${n}"]`)[0]);
		}
	} });
	let s = () => {
		n("hashChange");
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/autoplay.mjs
function ln({ swiper: e, extendParams: t, on: n, emit: r, params: i }) {
	e.autoplay = {
		running: !1,
		paused: !1,
		timeLeft: 0
	...
	let a, o, s = i && i.autoplay ? i.autoplay.delay : 3e3, c = i && i.autoplay ? i.autoplay.delay : 3e3, l, u = (/* @__PURE__ */ new Date()).getTime(), d, f, p, m, h, g, _;
	function v(t) {
		!e || e.destroyed || !e.wrapperEl || t.target === e.wrapperEl && (e.wrapperEl.removeEventListener("transitionend", v), !(_ || t.detail && t.detail.bySwiperTouchMove) && T());
	}
	let y = () => {
		...
		let i = b();
		!Number.isNaN(i) && i > 0 && t === void 0 && (n = i, s = i, c = i), l = n;
		let d = e.params.speed, f = () => {
			!e || e.destroyed || (e.params.autoplay.reverseDirection ? !e.isBeginning || e.params.loop || e.params.rewind ? (e.slidePrev(d, !0, !0), r("autoplay")) : e.params.autoplay.stopOnLastSlide || (e.slideTo(e.slides.length - 1, d, !0, !0), r("autoplay")) : !e.isEnd || e.params.loop || e.params.rewind ? (e.slideNext(d, !0, !0), r("autoplay")) : e.params.autoplay.stopOnLastSlide || (e.slideTo(0, d, !0, !0), r("autoplay")), e.params.cssMode && (u = (/* @__PURE__ */ new Date()).getTime(), requestAnimationFrame(() => {
				x();
			})));
		};
		...
		if (e.destroyed || !e.autoplay.running) return;
		clearTimeout(a), t || (g = !0);
		let i = () => {
			r("autoplayPause"), e.params.autoplay.waitForTransition ? e.wrapperEl.addEventListener("transitionend", v) : T();
		};
		if (e.autoplay.paused = !0, n) {
			h && (l = e.params.autoplay.delay), h = !1, i();
			return;
		}
		l = (l || e.params.autoplay.delay) - ((/* @__PURE__ */ new Date()).getTime() - u), !(e.isEnd && l < 0 && !e.params.loop) && (l < 0 && (l = 0), i());
	}, T = () => {
		e.isEnd && l < 0 && !e.params.loop || e.destroyed || !e.autoplay.running || (u = (/* @__PURE__ */ new Date()).getTime(), g ? (g = !1, x(l)) : x(), e.autoplay.paused = !1, r("autoplayResume"));
	}, E = () => {
		if (e.destroyed || !e.autoplay.running) return;
		let t = N();
		t.visibilityState === "hidden" && (g = !0, w(!0)), t.visibilityState === "visible" && T();
	}, D = (t) => {
		t.pointerType === "mouse" && (g = !0, _ = !0, !(e.animating || e.autoplay.paused) && w(!0));
	}, O = (t) => {
		t.pointerType === "mouse" && (_ = !1, e.autoplay.paused && T());
	}, k = () => {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/thumbs.mjs
function un({ swiper: e, extendParams: t, on: n }) {
	...
	function s(t) {
		...
		let r = n.params.slidesPerView === "auto" ? n.slidesPerViewDynamic() : n.params.slidesPerView, i = 1, a = e.params.thumbs.slideThumbActiveClass;
		if (e.params.slidesPerView > 1 && !e.params.centeredSlides && (i = e.params.slidesPerView), e.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), n.slides.forEach((e) => e.classList.remove(a)), n.params.loop || n.params.virtual && n.params.virtual.enabled) for (let t = 0; t < i; t += 1) H(n.slidesEl, `[data-swiper-slide-index="${e.realIndex + t}"]`).forEach((e) => {
			e.classList.add(a);
		});
		else for (let t = 0; t < i; t += 1) n.slides[e.realIndex + t] && n.slides[e.realIndex + t].classList.add(a);
		let o = e.params.thumbs.autoScrollOffset, s = o && !n.params.loop;
		if (e.realIndex !== n.realIndex || s) {
			let i = n.activeIndex, a, c;
			if (n.params.loop) {
				let t = n.slides.find((t) => t.getAttribute("data-swiper-slide-index") === `${e.realIndex}`);
				a = n.slides.indexOf(t), c = e.activeIndex > e.previousIndex ? "next" : "prev";
			} else a = e.realIndex, c = a > e.previousIndex ? "next" : "prev";
			s && (a += c === "next" ? o : -1 * o), n.visibleSlidesIndexes && n.visibleSlidesIndexes.indexOf(a) < 0 && (n.params.centeredSlides ? a = a > i ? a - Math.floor(r / 2) + 1 : a + Math.floor(r / 2) - 1 : a > i && n.params.slidesPerGroup, n.slideTo(a, t ? 0 : void 0));
		}
	}
	n("beforeInit", () => {
		let { thumbs: t } = e.params;
		if (!(!t || !t.swiper)) {
			if (typeof t.swiper == "string" || t.swiper instanceof HTMLElement) {
				let n = N(), r = () => {
					...
					if (r && r.swiper) t.swiper = r.swiper, o(), s(!0);
					else if (r) {
						let n = `${e.params.eventsPrefix}init`, i = (a) => {
							t.swiper = a.detail[0], r.removeEventListener(n, i), o(), s(!0), t.swiper.update(), e.update();
						};
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/free-mode.mjs
function dn({ swiper: e, extendParams: t, emit: n, once: r }) {
	t({ freeMode: {
		enabled: !1,
		momentum: !0,
		momentumRatio: 1,
	...
	function o({ currentPos: t }) {
		if (e.params.cssMode) return;
		let { params: i, wrapperEl: a, rtlTranslate: o, snapGrid: s, touchEventsData: c } = e, l = L() - c.touchStartTime;
		if (t < -e.minTranslate()) {
		...
		if (i.freeMode.momentum) {
			if (c.velocities.length > 1) {
				...
				e.velocity = r / a, e.velocity /= 2, Math.abs(e.velocity) < i.freeMode.minimumVelocity && (e.velocity = 0), (a > 150 || L() - t.time > 300) && (e.velocity = 0);
			} else e.velocity = 0;
			...
			i.freeMode.momentumBounce && d ? (e.updateProgress(f), e.setTransition(t), e.setTranslate(u), e.transitionStart(!0, e.swipeDirection), e.animating = !0, q(a, () => {
				!e || e.destroyed || !c.allowMomentumBounce || (n("momentumBounce"), e.setTransition(i.speed), setTimeout(() => {
					e.setTranslate(f), q(a, () => {
						!e || e.destroyed || e.transitionEnd();
					});
				}, 0));
			})) : e.velocity ? (n("_freeModeNoMomentumRelease"), e.updateProgress(u), e.setTransition(t), e.setTranslate(u), e.transitionStart(!0, e.swipeDirection), e.animating || (e.animating = !0, q(a, () => {
				!e || e.destroyed || e.transitionEnd();
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/grid.mjs
function fn({ swiper: e, extendParams: t, on: n }) {
	...
	n("init", () => {
		...
		initSlides: (t) => {
			...
			a = Math.floor(c / o), r = Math.floor(c / o) === c / o ? c : Math.ceil(c / o) * o, n !== "auto" && s === "row" && (r = Math.max(r, n * o)), i = r / o;
		},
		unsetSlides: () => {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/manipulation.mjs
function pn(e) {
	...
	let i = (e) => {
		if (typeof e == "string") {
			...
			Y(t, e), r.append(t.children[0]), Y(t, "");
		} else r.append(e);
	};
...
function mn(e) {
	...
	let a = r + 1, o = (e) => {
		if (typeof e == "string") {
			let t = document.createElement("div");
			Y(t, e), i.prepend(t.children[0]), Y(t, "");
		} else i.prepend(e);
	};
...
function vn({ swiper: e }) {
	Object.assign(e, {
		appendSlide: pn.bind(e),
		prependSlide: mn.bind(e),
		addSlide: hn.bind(e),
		removeSlide: gn.bind(e),
		removeAllSlides: _n.bind(e)
	});
}
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/effect-init.mjs
function Z(e) {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/effect-target.mjs
function yn(e, t) {
	let n = V(t);
	return n !== t && (n.style.backfaceVisibility = "hidden", n.style["-webkit-backface-visibility"] = "hidden"), n;
}
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/effect-virtual-transition-end.mjs
function bn({ swiper: e, duration: t, transformElements: n, allSlides: r }) {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/effect-fade.mjs
function xn({ swiper: e, extendParams: t, on: n }) {
	t({ fadeEffect: { crossFade: !1 } }), Z({
		effect: "fade",
		swiper: e,
		on: n,
		setTranslate: () => {
			...
			for (let r = 0; r < t.length; r += 1) {
				...
				let o = e.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(t.progress), 0) : 1 + Math.min(Math.max(t.progress, -1), 0), s = yn(n, t);
				s.style.opacity = o, s.style.transform = `translate3d(${i}px, ${a}px, 0px)`;
			}
		},
		setTransition: (t) => {
			let n = e.slides.map((e) => V(e));
			n.forEach((e) => {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/effect-cube.mjs
function Sn({ swiper: e, extendParams: t, on: n }) {
	t({ cubeEffect: {
		slideShadows: !0,
		shadow: !0,
	...
	let r = (e, t, n) => {
		...
		r || (r = U("div", `swiper-slide-shadow-cube swiper-slide-shadow-${n ? "left" : "top"}`.split(" ")), e.append(r)), i || (i = U("div", `swiper-slide-shadow-cube swiper-slide-shadow-${n ? "right" : "bottom"}`.split(" ")), e.append(i)), r && (r.style.opacity = Math.max(-t, 0)), i && (i.style.opacity = Math.max(t, 0));
	};
	Z({
		effect: "cube",
		swiper: e,
		on: n,
		setTranslate: () => {
			let { el: t, wrapperEl: n, slides: i, width: a, height: o, rtlTranslate: s, size: c, browser: l } = e, u = ve(e), d = e.params.cubeEffect, f = e.isHorizontal(), p = e.virtual && e.params.virtual.enabled, m = 0, h;
			d.shadow && (f ? (h = e.wrapperEl.querySelector(".swiper-cube-shadow"), h || (h = U("div", "swiper-cube-shadow"), e.wrapperEl.append(h)), h.style.height = `${a}px`) : (h = t.querySelector(".swiper-cube-shadow"), h || (h = U("div", "swiper-cube-shadow"), t.append(h))));
		...
		recreateShadows: () => {
			...
			e.slides.forEach((e) => {
				let n = Math.max(Math.min(e.progress, 1), -1);
				r(e, n, t);
			});
		},
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/shared/create-shadow.mjs
function Q(e, t, n) {
	let r = `swiper-slide-shadow${n ? `-${n}` : ""}${e ? ` swiper-slide-shadow-${e}` : ""}`, i = V(t), a = i.querySelector(`.${r.split(" ").join(".")}`);
	return a || (a = U("div", r.split(" ")), i.append(a)), a;
}
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/effect-flip.mjs
function Cn({ swiper: e, extendParams: t, on: n }) {
	...
	let r = (t, n) => {
		...
		r ||= Q("flip", t, e.isHorizontal() ? "left" : "top"), i ||= Q("flip", t, e.isHorizontal() ? "right" : "bottom"), r && (r.style.opacity = Math.max(-n, 0)), i && (i.style.opacity = Math.max(n, 0));
	};
	Z({
		effect: "flip",
		swiper: e,
		on: n,
		setTranslate: () => {
			let { slides: t, rtlTranslate: n } = e, i = e.params.flipEffect, a = ve(e);
			for (let o = 0; o < t.length; o += 1) {
				...
				let m = `translate3d(${f}px, ${p}px, 0px) rotateX(${a(d)}deg) rotateY(${a(u)}deg)`, h = yn(i, s);
				h.style.transform = m;
			}
		},
		setTransition: (t) => {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/effect-coverflow.mjs
function wn({ swiper: e, extendParams: t, on: n }) {
	t({ coverflowEffect: {
		rotate: 50,
		stretch: 0,
		depth: 100,
		...
		on: n,
		setTranslate: () => {
			let { width: t, height: n, slides: r, slidesSizesGrid: i } = e, a = e.params.coverflowEffect, o = e.isHorizontal(), s = e.translate, c = o ? -s + t / 2 : -s + n / 2, l = o ? a.rotate : -a.rotate, u = a.depth, d = ve(e);
			for (let e = 0, t = r.length; e < t; e += 1) {
				...
				let b = `translate3d(${v}px,${_}px,${h}px)  rotateX(${d(m)}deg) rotateY(${d(p)}deg) scale(${y})`, x = yn(a, t);
				if (x.style.transform = b, t.style.zIndex = -Math.abs(Math.round(f)) + 1, a.slideShadows) {
					...
					e ||= Q("coverflow", t, o ? "left" : "top"), n ||= Q("coverflow", t, o ? "right" : "bottom"), e && (e.style.opacity = f > 0 ? f : 0), n && (n.style.opacity = -f > 0 ? -f : 0);
				}
			}
		},
		setTransition: (t) => {
			e.slides.map((e) => V(e)).forEach((e) => {
				e.style.transitionDuration = `${t}ms`, e.querySelectorAll(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").forEach((e) => {
					e.style.transitionDuration = `${t}ms`;
				});
			});
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/effect-creative.mjs
function Tn({ swiper: e, extendParams: t, on: n }) {
	...
	Z({
		...
		on: n,
		setTranslate: () => {
			let { slides: t, wrapperEl: n, slidesSizesGrid: i } = e, a = e.params.creativeEffect, { progressMultiplier: o } = a, s = e.params.centeredSlides, c = ve(e);
			if (s) {
			...
			for (let n = 0; n < t.length; n += 1) {
				...
				if (h && g.shadow || !h) {
					...
					if (!e && g.shadow && (e = Q("creative", i)), e) {
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/modules/effect-cards.mjs
	...
	t({ cardsEffect: {
      ...
      `;
				if (i.slideShadows) {
					...
					e ||= Q("cards", l), e && (e.style.opacity = Math.min(Math.max((Math.abs(d) - .5) / .5, 0), 1));
				}
...
//#endregion
//#region ../../node_modules/.pnpm/swiper@12.0.3/node_modules/swiper/swiper-bundle.mjs
var Dn = [
	Jt,
	Yt,
	Xt,
...
qt.use(Dn);
//#endregion
//#region ../html/src/components/miscellaneous/Carousel/carousel.js
function $(e, t, n) {
	let r = Number.parseFloat(e.getAttribute(t) ?? "");
	return Number.isFinite(r) ? r : n;
}
function On(e, t, n) {
	e.classList.toggle("is-autoplay-paused", !n), t.setAttribute("aria-pressed", String(n)), t.setAttribute("aria-label", n ? "슬라이드 정지" : "슬라이드 재생");
}
function kn(e, t, n) {
	let r = Number.isFinite(Number(e)) ? Math.trunc(Number(e)) : 0;
	return t < 1 ? 0 : n ? (r % t + t) % t : Math.min(Math.max(r, 0), t - 1);
}
function An(e, t) {
	if (e.dataset.swiperReady === "true") return;
	let n = e.closest(".carousel"), r = e.querySelectorAll(".swiper-slide");
	if (!n || r.length === 0) return;
	let i = e.dataset.swiperEffect, a = $(e, "data-swiper-grid-rows", 1), o = e.dataset.swiperSlidesPerView === "auto" ? "auto" : $(e, "data-swiper-slides-per-view", 1), s = e.dataset.swiperPagination || "bullets", c = Number(e.dataset.swiperCoverflowSides || 1.5), l = e.hasAttribute("data-swiper-loop") && a <= 1 && (i === "coverflow" ? r.length >= (c === 1 ? 6 : c === 1.5 ? 8 : 10) : o === "auto" ? r.length >= 4 : r.length >= Math.max(2, Math.ceil(Number(o) || 1) + 1 + +!!e.hasAttribute("data-swiper-centered"))), u = kn($(e, "data-swiper-initial-slide", 0), r.length, l);
	function d() {
		let t = $(e, "data-swiper-space-between", 0);
		if (i !== "coverflow") return t;
		let r = e.clientWidth || n.clientWidth;
		if (n.style.setProperty("--carousel-coverflow-gap", `${t}px`), !r) return t;
		let a = (r - t * 2) / 3, o = c === 1 || c === 2 ? c : 1.5, s = (r - a) / (2 * o) - a;
		return n.style.setProperty("--carousel-coverflow-slide-width", `${Math.round(a * 100) / 100}px`), Math.round(s * 100) / 100;
	}
	let f = d(), p = e.querySelector(".swiper-pagination") ?? n.querySelector(":scope > .swiper-pagination"), m = e.dataset.swiperThumbs, h = m ? t.querySelector(m) ?? document.querySelector(m) : null, g = {
		initialSlide: u,
		slidesPerView: i === "coverflow" ? "auto" : o,
		slidesPerGroup: $(e, "data-swiper-slides-per-group", 1),
		spaceBetween: f,
		centeredSlides: e.hasAttribute("data-swiper-centered") || i === "coverflow",
		loop: l,
		grabCursor: !0,
		keyboard: { enabled: !0 },
		watchSlidesProgress: e.hasAttribute("data-swiper-watch-slides-progress") || n.classList.contains("carousel_thumbs")
	}, _ = e.querySelector(".swiper-button-prev"), v = e.querySelector(".swiper-button-next");
	_ && v && (g.navigation = {
		prevEl: _,
		nextEl: v
	}), p && (g.pagination = {
		el: p,
		clickable: !0,
		type: ["fraction", "progressbar"].includes(s) ? s : "bullets",
		...s === "custom" ? { renderBullet: (e, t) => `<span class="${t}">${e + 1}</span>` } : {}
	}), e.hasAttribute("data-swiper-autoplay") && (g.autoplay = {
		delay: $(e, "data-swiper-delay", 4e3),
		disableOnInteraction: !1
	}), a > 1 && (g.grid = {
		rows: a,
		fill: e.dataset.swiperGridFill === "column" ? "column" : "row"
	}), e.hasAttribute("data-swiper-free-mode") && (g.freeMode = !0), n.classList.contains("carousel_thumbs") && (g.slideToClickedSlide = !0), h?.swiper && (g.thumbs = { swiper: h.swiper }), i === "fade" && Object.assign(g, {
		effect: "fade",
		fadeEffect: { crossFade: !0 }
	}), i === "coverflow" && Object.assign(g, {
		effect: "coverflow",
		coverflowEffect: e.dataset.swiperCoverflowStyle === "rise" ? {
			rotate: 0,
			stretch: 0,
			depth: 28,
			scale: .92,
	...
	}), i === "coverflow" && l && Object.assign(g, {
		loopAdditionalSlides: 0,
		loopAddBlankSlides: !1
	}), e.dataset.swiperReady = "true";
	let y = new qt(e, g);
	if (typeof ResizeObserver < "u") {
		let e = new ResizeObserver(() => {
			if (y.destroyed) return e.disconnect();
			y.params.spaceBetween = d(), y.update();
		});
		e.observe(n);
	}
	window.requestAnimationFrame(() => {
		y.destroyed || (y.update(), l && typeof y.slideToLoop == "function" && y.slideToLoop(u, 0, !1));
	});
	let b = n.querySelector("[data-carousel-autoplay-toggle]");
	b && y.autoplay && (On(n, b, !0), b.addEventListener("click", () => {
		y.autoplay.running ? y.autoplay.stop() : y.autoplay.start(), On(n, b, y.autoplay.running);
	}));
}
function jn(e = document) {
	let t = [...e.querySelectorAll(".carousel [data-swiper]")];
	t.filter((e) => !e.hasAttribute("data-swiper-thumbs")).forEach((t) => An(t, e)), t.filter((e) => e.hasAttribute("data-swiper-thumbs")).forEach((t) => An(t, e));
}
//#endregion
//#region ../html/src/components/miscellaneous/Affix/affix.js
function Mn(e, t = 0) {
...
function Nn(e) {
	...
	for (; t && t !== document.documentElement;) {
		...
		if (e.transform && e.transform !== "none" || e.filter && e.filter !== "none" || e.perspective && e.perspective !== "none" || /paint|layout|strict|content/.test(e.contain) || /transform|filter|perspective/.test(e.willChange)) return t.getBoundingClientRect();
		t = t.parentElement;
	}
	return {
		left: 0,
...
function Pn(e) {
	if (!e || e.dataset.affixInit === "true") return () => {};
	let t = null, n = e.dataset.target;
	if (n) try {
		t = document.querySelector(n);
	} catch {
		t = null;
	}
	let r = e.querySelector(".affix_target");
	if (!r) return () => {};
	let i = e.querySelector(".affix_placeholder");
	i || (i = document.createElement("div"), i.className = "affix_placeholder", i.hidden = !0, i.setAttribute("aria-hidden", "true"), e.insertBefore(i, r));
	let a = Mn(e.dataset.offsetTop), o = e.hasAttribute("data-offset-bottom"), s = Mn(e.dataset.offsetBottom), c = t || window, l = !1, u = 0, d = () => t?.getBoundingClientRect() ?? {
		top: 0,
		bottom: window.innerHeight
	}, f = () => Object.assign(r.style, {
		position: "",
		top: "",
		bottom: "",
		left: "",
	...
	function p(t, n) {
		let i = Nn(r), c = o ? t.bottom - r.offsetHeight - s : t.top + a;
		Object.assign(r.style, {
			...
			width: `${n.width}px`,
			zIndex: getComputedStyle(e).getPropertyValue("--affix-z-index").trim() || "10"
		});
	}
	function m(t, n, a) {
		l = t, e.classList.toggle("is-affixed", t), r.classList.toggle("is-fixed", t), t ? (i.hidden = !1, i.style.height = `${r.offsetHeight}px`, i.style.width = `${a.width}px`, p(n, a)) : (i.hidden = !0, i.style.height = "", i.style.width = "", f());
	}
	function h() {
		u ||= requestAnimationFrame(() => {
			u = 0;
			let n = d(), c = e.getBoundingClientRect(), f = l ? i.getBoundingClientRect() : c, p = o ? n.bottom - f.bottom <= s : f.top - n.top <= a;
			p && t && (p = o ? f.bottom - n.top >= r.offsetHeight + s : n.bottom - f.top >= r.offsetHeight + a), m(p, n, f);
		});
	}
	return e.dataset.affixInit = "true", c.addEventListener("scroll", h, { passive: !0 }), t && window.addEventListener("scroll", h, {
		passive: !0,
		capture: !0
	}), window.addEventListener("resize", h, { passive: !0 }), h(), () => {
		cancelAnimationFrame(u), c.removeEventListener("scroll", h), t && window.removeEventListener("scroll", h, { capture: !0 }), window.removeEventListener("resize", h), delete e.dataset.affixInit, m(!1, d(), e.getBoundingClientRect());
	};
}
function Fn(e = document) {
	let t = [...e.querySelectorAll("[data-affix]")].map(Pn);
	return () => t.forEach((e) => e());
}
//#endregion
//#region ../html/src/components/miscellaneous/BackTop/back-top.js
function In(e, t) {
	let n = Number.parseInt(e ?? "", 10);
	return Number.isFinite(n) ? n : t;
}
function Ln(e) {
	if (!e || e.dataset.backTopInit === "true") return () => {};
	let t = null;
	if (e.dataset.target) try {
		t = document.querySelector(e.dataset.target);
	} catch {
		t = null;
	}
	let n = e.querySelector(".back_top_btn");
	if (!n) return () => {};
	let r = In(e.dataset.visibilityHeight, 400), i = t || window, a = () => t ? t.scrollTop : window.scrollY || document.documentElement.scrollTop, o = () => e.classList.toggle("is-visible", a() >= r), s = () => (t || window).scrollTo({
		top: 0,
		behavior: "smooth"
	});
	return e.dataset.backTopInit = "true", n.addEventListener("click", s), i.addEventListener("scroll", o, { passive: !0 }), o(), () => {
		n.removeEventListener("click", s), i.removeEventListener("scroll", o), delete e.dataset.backTopInit, e.classList.remove("is-visible");
	};
}
function Rn(e = document) {
	let t = [...e.querySelectorAll("[data-back-top]")].map(Ln);
	return () => t.forEach((e) => e());
}
v(), y(), b(), S(), C(), w(), O(), te(), jn(), Fn(), Rn();
//#endregion
