const paths = {
  ...
  upload: <><path d="M5 16v5h14v-5" /><path d="M12 17V3m0 0-4 4m4-4 4 4" /></>,
  ...
  heart: <path d="M20.8 5a5.5 5.5 0 0 0-7.8 0L12 6l-1-1a5.5 5.5 0 0 0-7.8 7.8L12 21l8.8-8.2A5.5 5.5 0 0 0 20.8 5Z" />,
  mail: <><rect x="3" y="5" width="18" height="14" rx="2" /><path d="m3 7 9 6 9-6" /></>,
  calendar: <><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M16 3v4M8 3v4M3 10h18" /></>,
  clock: <><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></>,
  link: <><path d="M10 13a5 5 0 0 0 7.5.5l3-3a5 5 0 0 0-7-7l-2 2" /><path d="M14 11a5 5 0 0 0-7.5-.5l-3 3a5 5 0 0 0 7 7l2-2" /></>,
...
export function Icon({
  name = 'plus', children, className = '', title, ariaLabel, color, size = 'md',
  inline = false, spin = false, button = false, circle = false, square = false,
  pulse = false, ripple = true, ...props
}) {
