...
export const SnackbarPlacementContext = createContextId('bottom-center');
...
export const SnackbarRegion = component$(({
  ...
  const region = (
    useContextProvider(SnackbarPlacementContext, resolvedPlacement);
  return (
    <div
        {...props}
  ...
  return portalRoot ? <Portal mount={portalRoot}>{region}</Portal> : region;
});
