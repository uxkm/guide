...
export const Navbar = component$(({
  ...
  const open = useSignal(false); // 반응형 메뉴의 열림 상태입니다.
  ...
  const classes = [
    ...
    open.value && 'is-open.value', // 반응형 메뉴가 열린 상태입니다.
      ...
      <div class="navbar_container">
        ...
        {responsive && (
          <Button
            ...
            iconOnly
            class="navbar_toggle"
            ariaLabel={open.value ? '메뉴 닫기' : '메뉴 열기'}
            aria-expanded={open.value}
            aria-controls={targetId}
            onClick$={() => open.value = !value.value}
            iconBefore={
              <>
                <Icon name="menu" size="sm" class="navbar_toggle-icon-open.value" />
