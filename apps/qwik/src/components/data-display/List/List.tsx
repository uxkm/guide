import { Fragment, component$, createContextId, useContext, useContextProvider } from '@builder.io/qwik';
/**
 * List 원본 구현.
...
export const ListContext = createContextId({ tag: 'ul', variant: 'default' });
...
export const List = component$(({
  ...
  useContextProvider(ListContext, { tag: Root, variant: resolvedVariant });
  return (
    <Root
        {...props}
        class={classes}
