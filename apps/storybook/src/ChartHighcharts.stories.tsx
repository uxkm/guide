...
import ActualChartHighcharts from "../../react/src/components/data-display/ChartHighcharts/ChartHighcharts.jsx";
import { hiddenArgTypes } from "./shared/storyArgTypes";

const ChartHighcharts = ActualChartHighcharts as React.ComponentType<any>;
const monthlyData = [
  { label: "1월", value: 120 },
  { label: "2월", value: 180 },
  { label: "3월", value: 150 },
...
async function checkBasics(canvasElement: HTMLElement) {
  ...
  await expect(
    canvasElement.querySelector(".chart-highcharts_plot"),
  ).not.toBeNull();
...
const meta = {
  title: "데이터 표시/ChartHighcharts",
  component: ChartHighcharts,
  ...
  args: {
    ...
    type: "bar",
    title: "월별 매출",
    description: "Highcharts 기반 상반기 매출",
    unit: "만원",
    height: 320,
  ...
  argTypes: {
    ...
    chartOptions: {
      control: "object",
      description: "Highcharts 옵션 병합 객체",
    },
  },
} satisfies Meta<typeof ChartHighcharts>;
export default meta;
