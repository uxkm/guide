...
export const Auto: Story = { name: '자동 배치', render: () => <Demo><Grid autoFit>{cells(6, 'auto-fit')}</Grid><Grid autoFill>{cells(3, 'auto-fill')}</Grid><Grid equalColumns>{cells(3, 'equal')}</Grid></Demo> };
