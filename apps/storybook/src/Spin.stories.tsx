...
export const Inline: Story = { name: '인라인', render: () => <div className="demo-stack"><div><Spin size="sm" inline color="primary" tip="저장 중…" ariaLabel="저장 중" /></div><Button variant="filled" color="primary" loading disabled aria-busy="true" label="제출 중…" /></div> };
