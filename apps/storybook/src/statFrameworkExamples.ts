...
function makeStatExamples(key: string, code: Code): FrameworkExample[] {
  const react = `import { Stat } from '@uxkm/react/stat';
...
${code.vue}
  ...
  return [
    ...
    { id: 'gulp', label: 'Gulp', fileName: `apps/gulp/src/components/data-display/Stat/stat.njk · ${key}`, code: `{# Stat · ${key} #}\n${code.html}` },
...
export const statFrameworkExamples = {
  ...
  <div class="stat"><div class="stat_header"><span class="stat_label">신규 가입</span><span class="stat_trend color_success">${iconSvg('m6 15 6-6 6 6')}+15.3%</span></div><span class="stat_value">1,234</span></div>
  <div class="stat"><div class="stat_header"><span class="stat_label">이탈률</span><span class="stat_trend color_danger">${iconSvg('M12 3 2.5 20h19L12 3ZM12 9v4m0 3h.01')}+0.3%p</span></div><span class="stat_value">2.4%</span></div>
</div>`,
  ...
  layouts: makeStatExamples('layouts', {
    html: `<div class="stat stat_horizontal stat_card"><span class="stat_label">활성 세션</span><span class="stat_value">342</span></div>
...
<div class="stat stat_row stat_card stat_shadow"><span class="stat_icon-wrap color_primary">${iconSvg('M16 8a4 4 0 1 1-8 0 4 4 0 0 1 8 0ZM4 21a8 8 0 0 1 16 0')}</span><div class="stat_body"><span class="stat_label">신규 사용자</span><span class="stat_value">1,284</span></div></div>`,
    react: `    <>
  ...
  icon: makeStatExamples('icon', {
    html: `<div class="stat_group stat_group-2">
  <div class="stat stat_card"><span class="stat_icon">${iconSvg('m12 3 2.8 5.7 6.2.9-4.5 4.4 1.1 6.2-5.6-3-5.6 3 1.1-6.2L3 9.6l6.2-.9L12 3Z')}</span><span class="stat_label">즐겨찾기</span><span class="stat_value">128</span></div>
  <div class="stat stat_row stat_card"><span class="stat_icon-wrap color_success">${iconSvg('m5 12 4 4L19 6')}</span><div class="stat_body"><span class="stat_label">완료</span><span class="stat_value">84</span></div></div>
</div>`,
    react: `    <div className="stat_group stat_group-2">
