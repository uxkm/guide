...
import ActualChartEcharts from "../../react/src/components/data-display/ChartEcharts/ChartEcharts.jsx";
import { hiddenArgTypes } from "./shared/storyArgTypes";

const ChartEcharts = ActualChartEcharts as React.ComponentType<any>;
const monthlyData = [
  { label: "1월", value: 120 },
  { label: "2월", value: 180 },
  { label: "3월", value: 150 },
...
const meta = {
  ...
  argTypes: {
    ...
    chartOptions: {
      control: "object",
      description: "ECharts option 병합 객체",
    },
  },
