...
export const menuApiSections: ApiSectionData[] = [
  ...
  section('HTML · Gulp', [{ name: 'menu_list · menu_item · menu_link', type: 'class', default: '—', description: '목록과 메뉴 항목 구조입니다.' }, { name: 'menu_submenu · data-menu-submenu-toggle', type: 'class · attribute', default: '—', description: '상호작용 가능한 중첩 메뉴입니다.' }, { name: 'data-menu-selectable', type: 'attribute', default: '있을 때', description: '있을 때만 클릭으로 is-active를 자동 갱신합니다.' }, { name: 'is-active · is-disabled', type: 'class', default: '—', description: '선택과 비활성 상태입니다.' }]),
