...
export const Search: Story = { name: '검색', render: () => <Navbar brand="Docs" items={<Menu><Item label="시작하기" /><Item label="컴포넌트" active /><Item label="패턴" /></Menu>} search={<Input type="search" id="navbar-search-demo" size="sm" placeholder="문서 검색…" autoComplete="off" aria-label="문서 검색" />} actions={<Button variant="filled" color="primary" size="sm" label="GitHub" />} /> };
export const Size: Story = { name: '크기', render: () => <div className="navbar-stack-demo"><Navbar role="presentation" brand="Small" size="sm" items={<Menu><Item label="메뉴" active /></Menu>} /><Navbar role="presentation" brand="Default" items={<Menu><Item label="메뉴" active /></Menu>} /><Navbar role="presentation" brand="Large" size="lg" items={<Menu><Item label="메뉴" active /></Menu>} /></div> };
export const Variant: Story = { name: '스타일 변형', render: () => <div className="navbar-stack-demo"><Navbar role="presentation" brand="Borderless" borderless items={<Menu><Item label="홈" active /><Item label="소개" /></Menu>} /><Navbar role="presentation" brand="Dark Surface" dark items={<Menu><Item label="홈" active /><Item label="소개" /></Menu>} /><div className="navbar-scroll-demo"><Navbar role="presentation" brand="Sticky" sticky items={<Menu><Item label="고정" active /></Menu>} /><div className="navbar-scroll-content"><p>스크롤해 보세요. navbar_sticky는 상단에 고정됩니다.</p><p>콘텐츠 영역 예시입니다.</p><p>추가 콘텐츠…</p><p>추가 콘텐츠…</p></div></div></div> };
