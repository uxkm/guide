import{g as d,r as l,a}from"./gulp-demos-C1efgjoy.js";const p=`<!-- @meta
...
`;function i(n){return n.replace(/<!--\s*@meta[\s\S]*?-->/,"").trim()}const o=a(i(p)),m={title:"설치 및 사용",id:"getting-started",tags:["autodocs"],parameters:{layout:"padded",controls:{disable:!0},docs:{description:{component:"이 가이드 저장소의 설치·실행 방법을 안내합니다. HTML 문서는 Gulp로, 컴포넌트 미리보기는 Storybook으로 확인합니다. 내용은 gulp 가이드(`src/getting-started.html`)와 동일합니다."},...d(o).docs}}},e={render:()=>l(o),parameters:d(o)};var t,c,s;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: () => renderHtml(body),
  parameters: gulpSource(body)
}`,...(s=(c=e.parameters)==null?void 0:c.docs)==null?void 0:s.source}}};const y=["Page"];export{e as Page,y as __namedExportsOrder,m as default};
