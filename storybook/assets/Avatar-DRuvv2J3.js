import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{a as n,c as r,i,n as a,o,r as s,s as c,t as l}from"./Avatar.stories-CB3xDvog.js";import{d as u,i as d,l as f}from"./blocks-DKrjMPN_.js";import{n as p,t as m}from"./FrameworkTabs-duseEU1T.js";import{i as h,r as g}from"./react-CQ14Jk9E.js";import{n as _,t as v}from"./ComponentApiDocs-C9VNL7Yh.js";import{r as y,t as b}from"./dataDisplayApiSections-w1k9tZfi.js";var x;function S(){return(S=e((()=>{x=`<!-- Avatar 원본 구현: 데이터 표시 구조와 시각 상태를 공통 CSS 클래스 및 접근성 속성으로 표현합니다. -->
<!-- 이미지 아바타 -->
...
</w2:group>`},q=Object.fromEntries(Object.keys(U).map(e=>[e,z(e)]))})))()}function Y(e){let t={code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...h(),...e.components};return(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(f,{of:l}),`
...
`,(0,Z.jsx)(t.h2,{id:`사용-기준`,children:`사용 기준`}),`
`,(0,Z.jsxs)(t.ul,{children:[`
`,(0,Z.jsx)(t.li,{children:`사람·조직 식별에 사용합니다. 상태/카운트만 필요하면 Badge, 이름만이면 Typography로 충분합니다.`}),`
`]}),`
...
`]}),`
`,(0,Z.jsx)(m,{examples:V,showFullCode:!0}),`
...
`,(0,Z.jsx)(d,{of:a,sourceState:`none`}),`
`,(0,Z.jsx)(m,{examples:q.basic}),`
`,(0,Z.jsx)(t.h2,{id:`크기`,children:`크기`}),`
`,(0,Z.jsx)(t.p,{children:`small, medium, large, extra large 네 가지 크기를 제공합니다.`}),`
`,(0,Z.jsx)(d,{of:o,sourceState:`none`}),`
`,(0,Z.jsx)(m,{examples:q.sizes}),`
...
`,(0,Z.jsx)(d,{of:n,sourceState:`none`}),`
`,(0,Z.jsx)(m,{examples:q.shapes}),`
`,(0,Z.jsx)(t.h2,{id:`색상`,children:`색상`}),`
`,(0,Z.jsxs)(t.p,{children:[`이니셜·아이콘형 아바타에 공통 `,(0,Z.jsx)(t.code,{children:`color_*`}),` 색상을 적용합니다.`]}),`
`,(0,Z.jsx)(d,{of:s,sourceState:`none`}),`
`,(0,Z.jsx)(m,{examples:q.colors}),`
...
`,(0,Z.jsx)(d,{of:c,sourceState:`none`}),`
`,(0,Z.jsx)(m,{examples:q.badge}),`
...
`,(0,Z.jsx)(d,{of:i,sourceState:`none`}),`
`,(0,Z.jsx)(m,{examples:q.group}),`
`,(0,Z.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,Z.jsxs)(t.p,{children:[`의미 있는 이미지는 `,(0,Z.jsx)(t.code,{children:`alt`}),`로 식별하고, 장식용 아바타는 `,(0,Z.jsx)(t.code,{children:`aria-hidden`}),`으로 숨깁니다. 상태 점(`,(0,Z.jsx)(t.code,{children:`avatar_badge`}),`)은 `,(0,Z.jsx)(t.code,{children:`badgeLabel`}),`로 의미를 전달합니다. `,(0,Z.jsx)(t.code,{children:`AvatarGroup`}),`은 `,(0,Z.jsx)(t.code,{children:`role="group"`}),`과 `,(0,Z.jsx)(t.code,{children:`ariaLabel`}),`로 그룹 목적·인원을 설명합니다.`]}),`
`,(0,Z.jsx)(v,{sections:b})]})}function X(e={}){let{wrapper:t}={...h(),...e.components};return t?(0,Z.jsx)(t,{...e,children:(0,Z.jsx)(Y,{...e})}):Y(e)}var Z;function Q(){return(Q=e((()=>{Z=t(),g(),u(),p(),_(),J(),y(),r()})))()}Q();export{X as default};