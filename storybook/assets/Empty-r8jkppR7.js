...
`,(0,O.jsx)(t.li,{children:`결과 없음·필터 0건처럼 상태가 비었을 때 다음 행동을 안내합니다. 로딩 중에는 Skeleton/Spin을 쓰고 Empty로 대체하지 않습니다.`}),`
`]}),`
...
`]}),`
`,(0,O.jsx)(o,{examples:y,showFullCode:!0}),`
...
`,(0,O.jsx)(o,{examples:b.simple}),`
`,(0,O.jsx)(t.h2,{id:`블록--컨테이너`,children:`블록 · 컨테이너`}),`
`,(0,O.jsx)(r,{of:u,sourceState:`none`}),`
`,(0,O.jsx)(o,{examples:b.block}),`
`,(0,O.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,O.jsxs)(t.p,{children:[`Empty 루트는 `,(0,O.jsx)(t.code,{children:`role="status"`}),`로 상태를 전달하고 장식용 이미지는 `,(0,O.jsx)(t.code,{children:`aria-hidden="true"`}),`로 보조 기술에서 제외합니다. 액션 버튼의 목적은 구체적인 문구로 제공합니다.`]}),`
`,(0,O.jsx)(v,{sections:w})]})}function D(e={}){let{wrapper:t}={...h(),...e.components};return t?(0,O.jsx)(t,{...e,children:(0,O.jsx)(E,{...e})}):E(e)}var O;function k(){return(k=e((()=>{O=t(),g(),n(),a(),_(),x(),T(),c()})))()}k();export{D as default};