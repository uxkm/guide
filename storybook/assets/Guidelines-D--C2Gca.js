...
`,(0,d.jsxs)(t.p,{children:[`각 데모는 `,(0,d.jsx)(t.strong,{children:`새 창`}),`으로 열립니다. 로컬 데모이므로 해당 개발 서버를 실행한 후 이용하세요.`]}),`
`,(0,d.jsx)(o,{label:`프레임워크별 회원가입 데모`,columns:[`프레임워크`,`실행 명령`,`데모 페이지`],rows:[[`Gulp / Nunjucks`,`pnpm dev:gulp`,(0,d.jsx)(t.a,{href:`http://localhost:6102/signup.html`,target:`_blank`,rel:`noopener noreferrer`,children:`Gulp 회원가입 데모 (새 창)`})],[`Vue`,`pnpm dev:vue`,(0,d.jsx)(t.a,{href:`http://localhost:6103/signup`,target:`_blank`,rel:`noopener noreferrer`,children:`Vue 회원가입 데모 (새 창)`})],[`React`,`pnpm dev:react`,(0,d.jsx)(t.a,{href:`http://localhost:6104/signup`,target:`_blank`,rel:`noopener noreferrer`,children:`React 회원가입 데모 (새 창)`})]],codeColumns:[1]}),`
