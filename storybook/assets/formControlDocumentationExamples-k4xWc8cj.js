...
<label class="display_contents"><span class="input_group-label_hidden">추가 요청사항</span><Textarea :rows="3" placeholder="추가 요청사항" /></label>`},size:{html:[`sm`,`md`,`lg`].map(e=>x(`textarea-${e}`,e.toUpperCase(),`<textarea id="textarea-${e}" class="textarea${e===`md`?``:` textarea_${e}`}" rows="3"></textarea>`)).join(`
`),react:"<>{['sm', 'md', 'lg'].map((size) => <div className=\"form_field\" key={size}><label className=\"form_field-label\" htmlFor={`textarea-${size}`}>{size.toUpperCase()}</label><Textarea id={`textarea-${size}`} size={size} rows={3} /></div>)}</>",vue:`<div v-for="size in ['sm', 'md', 'lg']" :key="size" class="form_field"><label class="form_field-label" :for="\`textarea-\${size}\`">{{ size.toUpperCase() }}</label><Textarea :id="\`textarea-\${size}\`" :size="size" :rows="3" /></div>`},width:{html:`${x(`textarea-full`,`전체 너비`,`<textarea id="textarea-full" class="textarea" rows="3"></textarea>`)}<div class="form_field form_field_fit"><label class="form_field-label" for="textarea-fit">제한 너비</label><textarea id="textarea-fit" class="textarea" rows="3"></textarea></div>`,react:`<>
  ${S(`textarea-full`,`전체 너비`,`<Textarea id="textarea-full" rows={3} />`)}
...
</>`,vue:`${C(`textarea-full`,`전체 너비`,`<Textarea id="textarea-full" :rows="3" />`)}<div class="form_field form_field_fit"><label class="form_field-label" for="textarea-fit">제한 너비</label><Textarea id="textarea-fit" :rows="3" /></div>`},resize:{html:[`none`,`vertical`,`horizontal`,`both`].map(e=>x(`textarea-resize-${e}`,e,`<textarea id="textarea-resize-${e}" class="textarea textarea_resize_${e}" rows="3"></textarea>`)).join(`
`),react:"<>{['none', 'vertical', 'horizontal', 'both'].map((resize) => <div className=\"form_field\" key={resize}><label className=\"form_field-label\" htmlFor={`textarea-resize-${resize}`}>{resize}</label><Textarea id={`textarea-resize-${resize}`} resize={resize} rows={3} /></div>)}</>",vue:`<div v-for="resize in ['none', 'vertical', 'horizontal', 'both']" :key="resize" class="form_field"><label class="form_field-label" :for="\`textarea-resize-\${resize}\`">{{ resize }}</label><Textarea :id="\`textarea-resize-\${resize}\`" :resize="resize" :rows="3" /></div>`},required:{html:`<div class="form_field form_field_fit"><label class="form_field-label" for="textarea-required">문의 내용<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span></label><textarea id="textarea-required" class="textarea" rows="4" required aria-required="true"></textarea><p class="form_field-hint">답변에 필요한 내용을 작성해 주세요.</p></div>`,react:`<div className="form_field form_field_fit"><label className="form_field-label" htmlFor="textarea-required">문의 내용<span className="form_field-required"><span aria-hidden="true">*</span><span className="form_field-required-text">필수 항목</span></span></label><Textarea id="textarea-required" rows={4} required aria-required="true" /><p className="form_field-hint">답변에 필요한 내용을 작성해 주세요.</p></div>`,vue:`<div class="form_field form_field_fit"><label class="form_field-label" for="textarea-required">문의 내용<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span></label><Textarea id="textarea-required" :rows="4" required aria-required="true" /><p class="form_field-hint">답변에 필요한 내용을 작성해 주세요.</p></div>`},state:{html:`${x(`textarea-disabled`,`비활성`,`<textarea id="textarea-disabled" class="textarea" rows="3" disabled>수정할 수 없음</textarea>`)}${x(`textarea-readonly`,`읽기 전용`,`<textarea id="textarea-readonly" class="textarea" rows="3" readonly>읽기만 가능</textarea>`)}${x(`textarea-error`,`에러`,`<textarea id="textarea-error" class="textarea is-error" rows="3" aria-invalid="true" aria-describedby="textarea-error-message">너무 짧은 내용</textarea>`,`<p id="textarea-error-message" class="form_field-error" role="alert">10자 이상 입력해 주세요.</p>`)}`,react:`<>
  ${S(`textarea-disabled`,`비활성`,`<Textarea id="textarea-disabled" rows={3} defaultValue="수정할 수 없음" disabled />`)}
  ${S(`textarea-readonly`,`읽기 전용`,`<Textarea id="textarea-readonly" rows={3} defaultValue="읽기만 가능" readOnly />`)}
  ${S(`textarea-error`,`에러`,`<Textarea id="textarea-error" rows={3} error defaultValue="너무 짧은 내용" aria-describedby="textarea-error-message" />`,`<p id="textarea-error-message" className="form_field-error" role="alert">10자 이상 입력해 주세요.</p>`)}
</>`,vue:`${C(`textarea-disabled`,`비활성`,`<Textarea id="textarea-disabled" :rows="3" model-value="수정할 수 없음" disabled />`)}${C(`textarea-readonly`,`읽기 전용`,`<Textarea id="textarea-readonly" :rows="3" model-value="읽기만 가능" readonly />`)}${C(`textarea-error`,`에러`,`<Textarea id="textarea-error" :rows="3" error model-value="너무 짧은 내용" aria-describedby="textarea-error-message" />`,`<p id="textarea-error-message" class="form_field-error" role="alert">10자 이상 입력해 주세요.</p>`)}`},count:{html:x(`textarea-count`,`자기소개`,w(`textarea-count`,{rows:5}),`<p class="form_field-hint">200자 이내로 작성해 주세요.</p>`),react:S(`textarea-count`,`자기소개`,`<Textarea id="textarea-count" rows={5} maxLength={200} showCount />`,`<p className="form_field-hint">200자 이내로 작성해 주세요.</p>`),vue:C(`textarea-count`,`자기소개`,`<Textarea id="textarea-count" :rows="5" :max-length="200" show-count />`,`<p class="form_field-hint">200자 이내로 작성해 주세요.</p>`)},clearable:{html:`${x(`textarea-clear`,`메모`,T(`textarea-clear`,{value:`지울 수 있는 내용`}))}${x(`textarea-clear-count`,`자기소개`,T(`textarea-clear-count`,{value:`글자 수와 지우기를 함께 사용합니다.`,max:200}))}${x(`textarea-clear-readonly`,`읽기 전용`,T(`textarea-clear-readonly`,{value:`수정 불가`,inactive:!0,rows:3}))}`,react:`<>
  ${S(`textarea-clear`,`메모`,`<Textarea id="textarea-clear" rows={4} clearable defaultValue="지울 수 있는 내용" />`)}
  ${S(`textarea-clear-count`,`자기소개`,`<Textarea id="textarea-clear-count" rows={4} clearable showCount maxLength={200} defaultValue="글자 수와 지우기를 함께 사용합니다." />`)}
  ${S(`textarea-clear-readonly`,`읽기 전용`,`<Textarea id="textarea-clear-readonly" rows={3} clearable readOnly defaultValue="수정 불가" />`)}
</>`,vue:`${C(`textarea-clear`,`메모`,`<Textarea id="textarea-clear" :rows="4" clearable model-value="지울 수 있는 내용" />`)}${C(`textarea-clear-count`,`자기소개`,`<Textarea id="textarea-clear-count" :rows="4" clearable show-count :max-length="200" model-value="글자 수와 지우기를 함께 사용합니다." />`)}${C(`textarea-clear-readonly`,`읽기 전용`,`<Textarea id="textarea-clear-readonly" :rows="3" clearable model-value="수정 불가" readonly />`)}`},example:{html:`<form class="form form_vertical form_fit form_compact">${x(`review`,`후기`,w(`review`,{value:`좋아요`,max:300,rows:6,error:!0}).replace(`aria-describedby="review-count"`,`aria-describedby="review-error review-count"`),`<p id="review-error" class="form_field-error" role="alert">후기를 10자 이상 작성해 주세요.</p>`)}<div class="form_actions"><button class="btn btn_filled color_primary" type="submit"><span class="btn_label">등록</span></button><button class="btn btn_ghost" type="button"><span class="btn_label">취소</span></button></div></form>`,react:`<form className="form form_vertical form_fit form_compact" onSubmit={(event) => event.preventDefault()}>${S(`review`,`후기`,`<Textarea id="review" rows={6} showCount maxLength={300} error defaultValue="좋아요" required aria-describedby="review-error" />`,`<p id="review-error" className="form_field-error" role="alert">후기를 10자 이상 작성해 주세요.</p>`)}<div className="form_actions"><button className="btn btn_filled color_primary" type="submit"><span className="btn_label">등록</span></button></div></form>`,vue:`<form class="form form_vertical form_fit form_compact" @submit.prevent>${C(`review`,`후기`,`<Textarea id="review" :rows="6" show-count :max-length="300" error model-value="좋아요" required aria-describedby="review-error" />`,`<p id="review-error" class="form_field-error" role="alert">후기를 10자 이상 작성해 주세요.</p>`)}<div class="form_actions"><button class="btn btn_filled color_primary" type="submit"><span class="btn_label">등록</span></button></div></form>`}},ce=Object.fromEntries(Object.entries(se).map(([e,t])=>[e,ae(e,t)]))})))()}function ue(e,t){return[{id:`html`,label:`HTML`,fileName:"apps/html/src/components/form/Checkbox/Checkbox.html · ${key}",code:t.html},{id:`gulp`,label:`Gulp`,fileName:"apps/gulp/src/components/form/Checkbox/checkbox.njk · ${key}",code:"{# apps/gulp/src/components/form/Checkbox/checkbox.njk #}\\n${source.html}"},{id:`vue`,label:`Vue`,fileName:"@uxkm/vue/checkbox · ${key}",code:t.vue},{id:`nuxt`,label:`Nuxt`,fileName:"@uxkm/vue/checkbox · ${key}",code:t.vue},{id:`react`,label:`React`,fileName:"@uxkm/react/checkbox · ${key}",code:t.react},{id:`next`,label:`Next`,fileName:"@uxkm/react/checkbox · ${key}",code:t.react}]}var de,fe;function pe(){return(pe=e((()=>{de={type:{html:`<div class="checkbox" data-ripple="true">
...
</template>`}},fe=Object.fromEntries(Object.entries(de).map(([e,t])=>[e,ue(e,t)]))})))()}function me(e,t){return[{id:`html`,label:`HTML`,fileName:"apps/html/src/components/form/Radio/Radio.html · ${key}",code:t.html},{id:`gulp`,label:`Gulp`,fileName:"apps/gulp/src/components/form/Radio/radio.njk · ${key}",code:"{# apps/gulp/src/components/form/Radio/radio.njk #}\\n${source.html}"},{id:`vue`,label:`Vue`,fileName:"@uxkm/vue/radio · ${key}",code:t.vue},{id:`nuxt`,label:`Nuxt`,fileName:"@uxkm/vue/radio · ${key}",code:t.vue},{id:`react`,label:`React`,fileName:"@uxkm/react/radio · ${key}",code:t.react},{id:`next`,label:`Next`,fileName:"@uxkm/react/radio · ${key}",code:t.react}]}var he,ge;function _e(){return(_e=e((()=>{he={type:{html:`<div class="radio" data-ripple="true">
...
</template>`}},N=Object.fromEntries(Object.entries(M).map(([e,t])=>[e,be(e,t)]))})))()}function xe(e,t){let n=e===`example`,r=`${n?`import { useState } from 'react';
...
`})))()}var Me;function Ne(){return(Ne=e((()=>{Me=`{# Input 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
...
`})))()}var Re;function ze(){return(ze=e((()=>{Re=`<!-- Textarea 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Be;function Ve(){return(Ve=e((()=>{Be=`{# Textarea 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
...
`})))()}var Ke;function qe(){return(qe=e((()=>{Ke=`<!-- Select 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Je;function Ye(){return(Ye=e((()=>{Je=`{# Select 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
...
`})))()}var et;function tt(){return(tt=e((()=>{et=`<!-- Checkbox 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var nt;function rt(){return(rt=e((()=>{nt=`{# Checkbox 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
...
`})))()}var ct;function lt(){return(lt=e((()=>{ct=`<!-- Radio 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var ut;function dt(){return(dt=e((()=>{ut=`{# Radio 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
{# radio 루트 label이 입력·커스텀 원·텍스트 레이블을 한 클릭 영역으로 묶습니다. #}
<label
...
`})))()}var ft;function pt(){return(pt=e((()=>{ft=`/**
 * Radio 원본 구현.
 * 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다.
 */
...
`})))()}var gt;function _t(){return(_t=e((()=>{gt=`<!-- Switch 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var vt;function yt(){return(yt=e((()=>{vt=`{# Switch 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
{# switch 루트 label에 role="switch" 입력과 트랙·손잡이·레이블을 함께 둡니다. #}
<label
...
`})))()}var bt;function xt(){return(xt=e((()=>{bt=`/**
 * Switch 원본 구현.
 * 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다.
 */
...
`})))()}var wt;function Tt(){return(Tt=e((()=>{wt=`<!-- Slider 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Et;function Dt(){return(Dt=e((()=>{Et=`{# Slider 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
...
`})))()}var Mt;function Nt(){return(Nt=e((()=>{Mt=`<!-- Rate 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Pt;function Ft(){return(Ft=e((()=>{Pt=`{# Rate 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
...
`})))()}var Bt;function Vt(){return(Vt=e((()=>{Bt=`<!-- Upload 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Ht;function Ut(){return(Ut=e((()=>{Ht=`{# Upload 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
...
`})))()}var Jt;function Yt(){return(Yt=e((()=>{Jt=`<!-- DatePicker 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Xt;function Zt(){return(Zt=e((()=>{Xt=`{# DatePicker 원본 구현: 브라우저 DOM 이벤트와 상태 클래스를 연결하고 관련 접근성 속성을 동기화합니다. #}
...
`})))()}function B(e,t,n){return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/${e}/${e}.html`,code:n.html},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/${e}/${t}.njk`,code:n.gulp},{id:`vue`,label:`Vue`,fileName:`apps/vue/src/components/form/${e}/${e}.vue`,code:n.vue},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/${t} → ${e}.vue`,code:n.vue},{id:`react`,label:`React`,fileName:`apps/react/src/components/form/${e}/${e}.jsx`,code:n.react},{id:`next`,label:`Next`,fileName:`@uxkm/react/${t} → ${e}.jsx`,code:n.react}]}function nn(e){let t=Y[e]??Y.basic,n=`<xf:input id="${e}Input" class="input${t.classes?` ${t.classes}`:``}" type="${t.type??`text`}" ref="data:${e}Value"${t.attributes?` ${t.attributes}`:``}></xf:input>`,r=e===`group`?`<w2:group id="${e}Group" class="input_group input_fit">
...
</w2:group>`}function rn(e){let t=X[e]??X.basic,n=`<xf:textarea id="${e}Textarea" class="textarea${t.classes?` ${t.classes}`:``}" ref="data:${e}Value"${t.attributes?` ${t.attributes}`:``}></xf:textarea>`,r=e===`count`||e===`example`?`<w2:group id="${e}Wrap" class="textarea_wrap textarea_show-count">
  ${n}
...
</w2:group>`}function an(e){let t=Z[e]??Z.basic;return`<w2:group id="${e}Field" class="form_field form_field_fit">
...
</w2:group>`}function V(e,t,n){return Object.fromEntries(Object.entries(e).map(([e,r])=>[e,[...r,{id:`websquare`,label:`WebSquare`,fileName:`WebSquare 화면 XML · ${t} · ${e}`,code:`<!-- 화면 XML 루트에 w2, xf, ev 네임스페이스를 선언합니다. -->\n${n(e)}`}]]))}function H(e,t,n={}){let r=[`checkbox`,n.labelEnd&&`checkbox_label-end`,n.button&&`checkbox_button`,n.classes].filter(Boolean).join(` `),i=`<xf:checkbox id="${e}Input" class="checkbox_input" ref="data:${e}Value" trueValue="Y" falseValue="N"${n.attributes?` ${n.attributes}`:``}></xf:checkbox>`,a=`<w2:group id="${e}Control" class="checkbox_control">
  ${i}
...
`,`
  `)}
  ${o}
</w2:group>`}function on(e){switch(e){case`standalone`:return`<w2:group id="standaloneControl" class="checkbox_control" tagname="label" aria-label="항목 선택">
...
</w2:group>`;case`labelEnd`:return H(`labelEnd`,`푸시 알림 받기`,{labelEnd:!0,attributes:`checked="true"`});case`size`:return[H(`sizeSm`,`Small — checkbox_sm`,{classes:`checkbox_sm`,attributes:`checked="true"`}),H(`sizeMd`,`Medium — 기본`,{attributes:`checked="true"`}),H(`sizeLg`,`Large — checkbox_lg`,{classes:`checkbox_lg`,attributes:`checked="true"`})].join(`

`);case`width`:return[H(`widthInline`,`기본 — 인라인 너비`,{attributes:`checked="true"`}),H(`widthBlock`,`checkbox_block — 전체 너비`,{classes:`checkbox_block`,attributes:`checked="true"`})].join(`

`);case`color`:return[H(`colorPrimary`,`Primary`,{classes:`color_primary`,attributes:`checked="true"`}),H(`colorSuccess`,`Success`,{classes:`color_success`,attributes:`checked="true"`})].join(`

`);case`state`:return[H(`stateOff`,`미선택`),H(`stateOn`,`선택됨`,{attributes:`checked="true"`}),H(`stateDisabled`,`비활성`,{attributes:`disabled="true"`})].join(`
...
`);case`group`:case`buttonType`:return`<w2:group id="${e}Group" class="checkbox_group checkbox_group_horizontal" tagname="fieldset">
  ...
  ${H(`${e}A`,`디자인`,{button:e===`buttonType`,attributes:`checked="true"`}).replaceAll(`
`,`
  `)}
  ${H(`${e}B`,`개발`,{button:e===`buttonType`}).replaceAll(`
`,`
  `)}
  ...
  <w2:group id="formField" class="form_field">
    ...
    <w2:group id="formGroup" class="checkbox_group" tagname="fieldset">
      ${H(`formMarketing`,`마케팅 정보 수신`,{attributes:`checked="true"`}).replaceAll(`
`,`
      `)}
      ${H(`formNews`,`뉴스레터 구독`).replaceAll(`
`,`
      `)}
    </w2:group>
  </w2:group>
</w2:group>`;case`type`:return[H(`typeBasic`,`기본 — checkbox`,{attributes:`checked="true"`}),H(`typeLabelEnd`,`레이블 뒤 — checkbox_label-end`,{labelEnd:!0}),H(`typeButton`,`버튼형`,{button:!0,attributes:`checked="true"`})].join(`
...
`);default:return`<w2:group id="basicField" class="form_field">
  ...
  <w2:group id="basicGroup" class="checkbox_group" tagname="fieldset">
    ${H(`basicEmail`,`이메일 알림`,{attributes:`checked="true"`}).replaceAll(`
`,`
    `)}
    ${H(`basicPush`,`푸시 알림`).replaceAll(`
`,`
    `)}
  </w2:group>
</w2:group>`}}function U(e,t,n={}){let r=[`radio`,n.labelEnd&&`radio_label-end`,n.button&&`radio_button`,n.classes].filter(Boolean).join(` `),i=n.name??`${e}Name`,a=`<xf:input id="${e}Input" class="radio_input" type="radio" name="${i}" ref="data:${i}" value="${n.value??e}"${n.attributes?` ${n.attributes}`:``}></xf:input>`,o=`<w2:group id="${e}Control" class="radio_control">
  ${a}
...
`,`
  `)}
  ${s}
</w2:group>`}function sn(e){switch(e){case`standalone`:return`<w2:group id="standaloneGroup" class="radio_group radio_group_horizontal">
...
</w2:group>`;case`labelEnd`:return U(`labelEnd`,`신용카드`,{labelEnd:!0,name:`labelEndPay`,value:`card`,attributes:`checked="true"`});case`size`:return`<w2:group id="sizeGroup" class="radio_group radio_group_horizontal">
  ${U(`sizeSm`,`Small — radio_sm`,{classes:`radio_sm`,name:`size`,value:`sm`,attributes:`checked="true"`}).replaceAll(`
`,`
  `)}
  ${U(`sizeMd`,`Medium — 기본`,{name:`size`,value:`md`}).replaceAll(`
`,`
  `)}
  ${U(`sizeLg`,`Large — radio_lg`,{classes:`radio_lg`,name:`size`,value:`lg`}).replaceAll(`
`,`
  `)}
</w2:group>`;case`width`:return[U(`widthInline`,`기본 — 인라인 너비`,{name:`widthInline`,attributes:`checked="true"`}),U(`widthBlock`,`radio_block — 전체 너비`,{classes:`radio_block`,name:`widthBlock`,attributes:`checked="true"`})].join(`

`);case`color`:return U(`colorPrimary`,`Primary`,{classes:`color_primary`,name:`colorPrimary`,attributes:`checked="true"`});case`state`:return[U(`stateOff`,`미선택`,{name:`state`,value:`off`}),U(`stateOn`,`선택됨`,{name:`state`,value:`on`,attributes:`checked="true"`}),U(`stateDisabled`,`비활성`,{name:`stateDisabled`,attributes:`disabled="true"`})].join(`
...
`);case`group`:case`buttonType`:return`<w2:group id="${e}Group" class="radio_group${e===`buttonType`?` radio_group_horizontal`:``}" tagname="fieldset">
  ...
  ${U(`${e}A`,e===`buttonType`?`전체`:`일반 배송`,{button:e===`buttonType`,name:e,value:`a`,attributes:`checked="true"`}).replaceAll(`
`,`
  `)}
  ${U(`${e}B`,e===`buttonType`?`진행 중`:`빠른 배송`,{button:e===`buttonType`,name:e,value:`b`}).replaceAll(`
`,`
  `)}
  ...
  <w2:group id="formField" class="form_field">
    ...
    <w2:group id="formGroup" class="radio_group" tagname="fieldset">
      ${U(`formEmail`,`이메일`,{name:`formChannel`,value:`email`,attributes:`checked="true"`}).replaceAll(`
`,`
      `)}
      ${U(`formSms`,`SMS`,{name:`formChannel`,value:`sms`}).replaceAll(`
`,`
      `)}
    </w2:group>
  </w2:group>
</w2:group>`;case`type`:return[U(`typeBasic`,`기본 — radio`,{name:`typeBasic`,attributes:`checked="true"`}),U(`typeLabelEnd`,`레이블 뒤 — radio_label-end`,{labelEnd:!0,name:`typeLabelEnd`}),U(`typeButton`,`버튼형`,{button:!0,name:`typeButton`,attributes:`checked="true"`})].join(`
...
`);default:return`<w2:group id="basicField" class="form_field">
  ...
  <w2:group id="basicGroup" class="radio_group" tagname="fieldset">
    ${U(`basicCard`,`신용카드`,{name:`basicPay`,value:`card`,attributes:`checked="true"`}).replaceAll(`
`,`
    `)}
    ${U(`basicBank`,`계좌이체`,{name:`basicPay`,value:`bank`}).replaceAll(`
`,`
    `)}
  </w2:group>
</w2:group>`}}function W(e,t,n={}){let r=[`switch`,n.labelEnd&&`switch_label-end`,n.classes].filter(Boolean).join(` `),i=`<w2:group id="${e}Control" class="switch_control">
...
`,`
  `)}
</w2:group>`}function cn(e){switch(e){case`standalone`:return[W(`standaloneOff`,``,{ariaLabel:`기능 켜기`}),W(`standaloneOn`,``,{ariaLabel:`기능 끄기`,attributes:`checked="true"`})].join(`

`);case`labelEnd`:return W(`labelEnd`,`푸시 알림 받기`,{labelEnd:!0,attributes:`checked="true"`});case`size`:return[W(`sizeSm`,`Small — switch_sm`,{labelEnd:!0,classes:`switch_sm`,attributes:`checked="true"`}),W(`sizeMd`,`Medium — 기본`,{labelEnd:!0,attributes:`checked="true"`}),W(`sizeLg`,`Large — switch_lg`,{labelEnd:!0,classes:`switch_lg`,attributes:`checked="true"`})].join(`

`);case`width`:return[W(`widthInline`,`기본 — 인라인 너비`,{labelEnd:!0,attributes:`checked="true"`}),W(`widthBlock`,`switch_block — 전체 너비`,{labelEnd:!0,classes:`switch_block`,attributes:`checked="true"`})].join(`

`);case`color`:return W(`colorPrimary`,`Primary`,{labelEnd:!0,classes:`color_primary`,attributes:`checked="true"`});case`state`:return[W(`stateOff`,`꺼짐`,{labelEnd:!0}),W(`stateOn`,`켜짐`,{labelEnd:!0,attributes:`checked="true"`}),W(`stateDisabled`,`비활성`,{labelEnd:!0,attributes:`disabled="true"`})].join(`
...
`);case`group`:return`<w2:group id="groupRoot" class="switch_group switch_group_block" tagname="fieldset">
  ...
  ${W(`groupProfile`,`프로필 공개`,{labelEnd:!0,attributes:`checked="true"`}).replaceAll(`
`,`
  `)}
  ${W(`groupActivity`,`활동 기록 표시`,{labelEnd:!0}).replaceAll(`
`,`
  `)}
</w2:group>`;case`form`:return`<w2:group id="formRoot" class="form form_vertical form_fit" tagname="form">
  <w2:group id="formField" class="form_field">
    ...
    <w2:group id="formGroup" class="switch_group switch_group_block" tagname="fieldset">
      ${W(`formEmail`,`이메일 알림`,{labelEnd:!0,attributes:`checked="true"`}).replaceAll(`
`,`
      `)}
      ${W(`formPush`,`푸시 알림`,{labelEnd:!0}).replaceAll(`
`,`
      `)}
    </w2:group>
  </w2:group>
</w2:group>`;case`type`:return[W(`typeBasic`,`기본 — switch`,{attributes:`checked="true"`}),W(`typeLabelEnd`,`레이블 뒤 — switch_label-end`,{labelEnd:!0,attributes:`checked="true"`})].join(`

`);default:return[W(`basicDark`,`다크 모드`,{attributes:`checked="true"`}),W(`basicAuto`,`자동 저장`)].join(`

`)}}function G(e,t,n={}){let r=n.value??`50`,i=[`slider`,n.classes].filter(Boolean).join(` `),a=`<w2:group id="${e}Header" class="slider_header">
...
`,`
  `)}${c}
</w2:group>`}function ln(e){switch(e){case`type`:return[G(`typeBasic`,`기본 — slider`,{value:`40`}),G(`typeStepper`,`스텝 버튼 — slider_stepper`,{value:`40`,stepper:!0,classes:`slider_fit`})].join(`

`);case`label`:return G(`labelShow`,`볼륨`,{value:`70`,hint:`현재 값과 단위를 함께 표시합니다.`});case`size`:return[G(`sizeSm`,`Small`,{classes:`slider_sm`,value:`30`}),G(`sizeMd`,`Medium`,{value:`50`}),G(`sizeLg`,`Large`,{classes:`slider_lg`,value:`70`})].join(`

`);case`width`:return[G(`widthFit`,`제한 너비`,{classes:`slider_fit`,value:`45`}),G(`widthBlock`,`전체 너비`,{classes:`slider_block`,value:`45`})].join(`

`);case`step`:return G(`stepTicks`,`간격 · 눈금`,{value:`40`,attributes:`step="10"`,hint:`step과 눈금으로 선택 단위를 안내합니다.`});case`stepper`:return G(`stepperAlways`,`스텝 버튼`,{value:`55`,stepper:!0,classes:`slider_stepper_always slider_fit`});case`color`:return G(`colorPrimary`,`Primary`,{classes:`color_primary slider_fit`,value:`60`});case`state`:return[G(`stateDefault`,`기본`,{value:`50`}),G(`stateDisabled`,`비활성`,{value:`50`,attributes:`disabled="true"`,classes:`is-disabled`})].join(`

`);case`form`:return`<w2:group id="formRoot" class="form form_vertical form_fit" tagname="form">
  <w2:group id="formField" class="form_field">
    ${G(`formVolume`,`음량`,{value:`65`,classes:`slider_fit`}).replaceAll(`
`,`
    `)}
  </w2:group>
</w2:group>`;default:return G(`basic`,`밝기`,{value:`50`,classes:`slider_fit`,hint:`0에서 100까지 조절합니다.`})}}function K(e,t,n={}){let r=n.count??5,i=n.value??``,a=[`rate`,n.clearable&&`rate_clearable`,n.classes].filter(Boolean).join(` `),o=Array.from({length:r},(t,r)=>{let a=r+1,o=i&&Number(i)>=a?` checked="true"`:``;return`<w2:group id="${e}Star${a}" class="rate_star${Number(i)>=a?` is-filled`:``}" tagname="label">
...
</w2:group>`}function un(e){switch(e){case`type`:return[K(`typeBasic`,`기본 — rate`,{value:`3`}),K(`typeHalf`,`반점 — rate_allow-half`,{value:`3.5`,classes:`rate_allow-half`})].join(`

`);case`size`:return[K(`sizeSm`,`Small`,{classes:`rate_sm`,value:`4`}),K(`sizeMd`,`Medium`,{value:`4`}),K(`sizeLg`,`Large`,{classes:`rate_lg`,value:`4`})].join(`

`);case`color`:return K(`colorWarning`,`만족도`,{classes:`color_warning`,value:`4`});case`half`:return K(`half`,`반점 선택`,{classes:`rate_allow-half`,value:`3.5`});case`clear`:return K(`clear`,`선택 해제`,{value:`3`,clearable:!0});case`readonly`:return K(`readonly`,`평균 평점`,{value:`4`,classes:`is-readonly`,attributes:`disabled="true"`});case`state`:return[K(`stateDefault`,`기본`,{value:`3`}),K(`stateDisabled`,`비활성`,{value:`3`,attributes:`disabled="true"`,classes:`is-disabled`})].join(`

`);case`form`:return`<w2:group id="formRoot" class="form form_vertical form_fit" tagname="form">
  <w2:group id="formField" class="form_field">
    ${K(`formRate`,`서비스 만족도`,{value:`4`}).replaceAll(`
`,`
    `)}
  </w2:group>
</w2:group>`;default:return K(`basic`,`별점`,{value:`3`})}}function q(e,t={}){let n=t.variant??`button`,r=[`upload`,t.classes].filter(Boolean).join(` `),i=`<xf:input id="${e}Input" class="upload_input" type="file" ref="data:${e}Files"${t.attributes?` ${t.attributes}`:``}></xf:input>`;return n===`drag`?`<w2:group id="${e}" class="${r}">
  ...
  <w2:group id="${e}List" class="upload_list" tagname="ul"></w2:group>
</w2:group>`}function dn(e){switch(e){case`dropzone`:return q(`dropzone`,{variant:`drag`,classes:`upload_fit`,attributes:`accept="image/png,image/jpeg,.pdf" multiple="true"`,desc:`PNG, JPG, PDF · 파일당 최대 5MB`});case`list`:return q(`list`,{variant:`list`,classes:`upload_fit`});case`cards`:return q(`cards`,{variant:`picture-card`,attributes:`accept="image/*" multiple="true"`});case`avatar`:return q(`avatar`,{variant:`avatar`,attributes:`accept="image/*"`});case`size`:return[q(`sizeSm`,{variant:`drag`,classes:`upload_sm`,title:`SM 업로드`}),q(`sizeMd`,{variant:`drag`,title:`MD 업로드`}),q(`sizeLg`,{variant:`drag`,classes:`upload_lg`,title:`LG 업로드`})].join(`

`);case`width`:return[q(`widthDefault`,{variant:`drag`,title:`기본 너비 업로드`}),q(`widthFit`,{variant:`drag`,classes:`upload_fit`,title:`제한 너비 업로드`})].join(`

`);case`state`:return[q(`stateDisabled`,{classes:`is-disabled`,attributes:`disabled="true"`}),q(`stateError`,{variant:`drag`,classes:`is-error`,title:`업로드 오류`})].join(`
...
`);case`example`:return`<w2:group id="exampleRoot" class="form form_vertical form_fit" tagname="form">
  <w2:group id="exampleField" class="form_field">
    ...
    ${q(`example`,{attributes:`accept=".pdf,.doc,.docx" multiple="true"`,hint:`PDF·DOC · 최대 3개 · 10MB`}).replaceAll(`
`,`
    `)}
  </w2:group>
</w2:group>`;default:return q(`basic`)}}function J(e,t,n={}){let r=`<w2:group id="${e}" class="${[`date_picker`,n.classes].filter(Boolean).join(` `)}">
...
`,`
  `)}
  ${i}
</w2:group>`}function fn(e){switch(e){case`size`:return[J(`sizeSm`,`Small`,{classes:`date_picker_sm`,value:`2024-06-15`}),J(`sizeMd`,`Medium`,{value:`2024-06-15`}),J(`sizeLg`,`Large`,{classes:`date_picker_lg`,value:`2024-06-15`})].join(`

`);case`width`:return[J(`widthBlock`,`전체 너비`,{classes:`date_picker_block`,value:`2024-06-15`}),J(`widthFit`,`제한 너비`,{classes:`date_picker_fit`,value:`2024-06-15`})].join(`

`);case`limits`:return J(`limits`,`프로모션 기간`,{value:`2024-06-15`,attributes:`minYear="2024" maxYear="2024"`,hint:`2024-06-10 ~ 2024-06-20`});case`state`:return[J(`stateDisabled`,`비활성`,{classes:`is-disabled`,value:`2024-06-15`,attributes:`disabled="true"`}),J(`stateError`,`에러`,{classes:`is-error`,error:`날짜를 선택해 주세요.`})].join(`

`);case`example`:return`<w2:group id="exampleRoot" class="form form_vertical form_fit" tagname="form">
  ${J(`visit`,`방문일`,{classes:`is-error`,error:`방문일을 선택해 주세요.`}).replaceAll(`
`,`
  `)}
</w2:group>`;default:return J(`basic`,`예약일`,{classes:`date_picker_fit`,value:`2024-06-15`,hint:`달력에서 날짜를 선택해 주세요.`})}}var pn,mn,hn,gn,_n,vn,yn,bn,xn,Sn,Y,X,Z,Cn,wn,Tn,En,Dn,On,kn,Q,An,jn;function $(){return($=e((()=>{f(),ie(),le(),pe(),_e(),O(),j(),P(),we(),ke(),je(),Ne(),Fe(),Le(),ze(),Ve(),Ue(),Ge(),qe(),Ye(),Ze(),$e(),tt(),rt(),at(),st(),lt(),dt(),pt(),ht(),_t(),yt(),xt(),Ct(),Tt(),Dt(),kt(),jt(),Nt(),Ft(),Lt(),zt(),Vt(),Ut(),Gt(),qt(),Yt(),Zt(),$t(),tn(),pn=B(`Input`,`input`,{html:Ae,gulp:Me,react:Pe,vue:Ie}),mn=B(`Textarea`,`textarea`,{html:Re,gulp:Be,react:He,vue:We}),hn=B(`Select`,`select`,{html:Ke,gulp:Je,react:Xe,vue:Qe}),gn=B(`Checkbox`,`checkbox`,{html:et,gulp:nt,react:it,vue:ot}),_n=B(`Radio`,`radio`,{html:ct,gulp:ut,react:ft,vue:mt}),vn=B(`Switch`,`switch`,{html:gt,gulp:vt,react:bt,vue:St}),yn=B(`Slider`,`slider`,{html:wt,gulp:Et,react:Ot,vue:At}),bn=B(`Rate`,`rate`,{html:Mt,gulp:Pt,react:It,vue:Rt}),xn=B(`Upload`,`upload`,{html:Bt,gulp:Ht,react:Wt,vue:Kt}),Sn=B(`DatePicker`,`date-picker`,{html:Jt,gulp:Xt,react:Qt,vue:en}),Y={basic:{label:`이름`,attributes:`placeholder="이름을 입력하세요"`},standalone:{label:`검색어`,type:`search`,classes:`input_fit`,attributes:`placeholder="검색어를 입력하세요"`},type:{label:`이메일`,type:`email`,attributes:`placeholder="name@example.com"`},kind:{label:`인증번호`,classes:`input_otp`,attributes:`displayFormat="####" maxlength="4"`},size:{label:`Large`,classes:`input_lg`},width:{label:`제한 너비`,classes:`input_fit`},group:{label:`도메인`,type:`url`,classes:`input_fit`,attributes:`placeholder="example.com"`},required:{label:`이메일`,type:`email`,attributes:`mandatory="true" aria-required="true"`},state:{label:`오류 입력`,attributes:`aria-invalid="true" aria-describedby="inputError"`},clearable:{label:`검색어`,type:`search`,attributes:`placeholder="검색어를 입력하세요"`},example:{label:`사용자 이름`,attributes:`mandatory="true" aria-describedby="inputExampleHint"`}},X={basic:{label:`메시지`,classes:`textarea_resize_none`,attributes:`rows="4" placeholder="메시지를 입력하세요"`},standalone:{label:`자기소개`,classes:`textarea_fit`,attributes:`rows="4"`},size:{label:`Large`,classes:`textarea_lg textarea_resize_none`,attributes:`rows="5"`},width:{label:`제한 너비`,classes:`textarea_fit textarea_resize_none`,attributes:`rows="4"`},resize:{label:`세로 크기 조절`,classes:`textarea_resize_vertical`,attributes:`rows="5"`},required:{label:`문의 내용`,classes:`textarea_resize_none`,attributes:`rows="4" mandatory="true"`},state:{label:`오류 내용`,classes:`textarea_resize_none is-error`,attributes:`rows="4" aria-invalid="true"`},count:{label:`자기소개`,classes:`textarea_resize_none`,attributes:`rows="5" maxlength="200"`},clearable:{label:`메모`,classes:`textarea_resize_none`,attributes:`rows="4"`},example:{label:`문의 내용`,classes:`textarea_resize_none is-error`,attributes:`rows="5" maxlength="500" mandatory="true"`}},Z={basic:{label:`지역`,classes:`input_fit`,attributes:`chooseOption="true"`},standalone:{label:`언어`,classes:`input_fit`},size:{label:`Large`,classes:`input_lg`},width:{label:`제한 너비`,classes:`input_fit`},group:{label:`소속 팀`,attributes:`chooseOption="true"`},multiple:{label:`관심 분야`,attributes:`appearance="minimal" multiple="true"`},required:{label:`문의 유형`,attributes:`mandatory="true" chooseOption="true"`},state:{label:`오류 선택`,classes:`is-error`,attributes:`aria-invalid="true"`},example:{label:`배송 지역`,classes:`input_fit is-error`,attributes:`mandatory="true" chooseOption="true"`}},Cn=V(d,`Input`,nn),wn=V(ce,`Textarea`,rn),Tn=V(re,`Select`,an),En=V(fe,`Checkbox`,on),Dn=V(ge,`Radio`,sn),On=V(D,`Switch`,cn),kn=V(A,`Slider`,ln),Q=V(N,`Rate`,un),An=V(Ce,`Upload`,dn),jn=V(Oe,`DatePicker`,fn)})))()}export{On as _,$ as a,xn as b,_n as c,Q as d,hn as f,vn as g,kn as h,jn as i,Dn as l,yn as m,En as n,pn as o,Tn as p,Sn as r,Cn as s,gn as t,bn as u,mn as v,An as x,wn as y};