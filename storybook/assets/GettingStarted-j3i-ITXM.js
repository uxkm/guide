...
`,(0,u.jsxs)(t.p,{children:[`현재 저장소는 `,(0,u.jsx)(t.code,{children:`pnpm`}),` 워크스페이스에서 여섯 프레임워크 앱과 Storybook을 함께 관리하고, Storybook에서 WebSquare XML 코드 예제를 추가로 제공합니다. 기존 프레임워크별 Storybook의 설치 안내를 통합 저장소의 실제 스크립트와 경로 기준으로 정리했습니다.`]}),`
...
`,(0,u.jsx)(t.p,{children:`각 컴포넌트 문서의 WebSquare 탭에서 XML 호환 마크업을 복사할 수 있습니다. 예제는 공통 CSS 클래스와 접근성 속성을 유지한 fragment이며, WebSquare 화면 XML 루트 안에 배치하는 것을 전제로 합니다.`}),`
`,(0,u.jsxs)(t.p,{children:[(0,u.jsx)(t.strong,{children:`화면`}),`은 페이지 단위 XML 문서이고, `,(0,u.jsx)(t.strong,{children:`scwin`}),`은 WebSquare가 그 화면에 만들어 주는 기본 스크립트 객체명입니다. 버튼 클릭은 `,(0,u.jsx)(t.code,{children:`ev:onclick="scwin...."`}),`으로 화면 스크립트에 연결하고, 입력값은 `,(0,u.jsx)(t.code,{children:`ref="data:..."`}),`로 DataMap·DataList에 바인딩합니다. 객체명은 `,(0,u.jsx)(t.code,{children:`config.xml`}),`의 SPA `,(0,u.jsx)(t.code,{children:`variable`}),`에서 바꿀 수 있으므로, 프로젝트가 다른 이름을 쓰면 예제의 `,(0,u.jsx)(t.code,{children:`scwin`}),`을 치환합니다. UXKM은 WebSquare 엔진과 공통 화면 스크립트를 포함하지 않으므로, 함수 이름과 데이터 경로 규칙은 프로젝트 화면 표준을 따릅니다.`]}),`
`,(0,u.jsxs)(t.p,{children:[(0,u.jsx)(t.code,{children:`xmlns`}),` 선언은 컴포넌트 속성이 아니라 XML 문서 범위의 선언입니다. 화면 루트에서 한 번 선언하고 내부 컴포넌트는 이를 상속합니다. 여러 컴포넌트를 같은 화면에 배치해도 선언을 반복하지 않습니다. 별도 화면 XML이나 WFrame의 `,(0,u.jsx)(t.code,{children:`src`}),`로 불러오는 파일처럼 독립적으로 파싱되는 문서는 각 파일의 루트에서 다시 선언하며, `,(0,u.jsx)(t.code,{children:`ev`}),`와 `,(0,u.jsx)(t.code,{children:`xf`}),`는 해당 접두사를 사용하는 화면에서 추가합니다.`]}),`
`,(0,u.jsxs)(t.ol,{children:[`
`,(0,u.jsxs)(t.li,{children:[`WebSquare 화면이 로드하는 스타일에 `,(0,u.jsx)(t.code,{children:`uxkm.css`}),`를 연결합니다.`]}),`
`,(0,u.jsx)(t.li,{children:`Storybook의 WebSquare 탭에서 XML 조각을 복사해 화면에 배치합니다.`}),`
...
`]}),`
`,(0,u.jsxs)(t.p,{children:[`컴포넌트 탭의 fragment를 기존 화면에 추가할 때는 아래의 `,(0,u.jsx)(t.code,{children:`screenRoot`}),`나 네임스페이스 선언을 함께 복사하지 않습니다. 화면 파일을 새로 만드는 경우에만 프로젝트의 기본 화면 템플릿에서 루트 선언을 한 번 작성합니다.`]}),`
`,(0,u.jsx)(t.p,{children:`화면 XML 루트에서 네임스페이스를 공통 선언하고, 정적 마크업을 WebSquare 컴포넌트와 이벤트로 연결할 때는 다음과 같이 적용할 수 있습니다.`}),`
...
`})}),`
`,(0,u.jsxs)(t.p,{children:[`Storybook의 자동 예제는 CSS와 접근성 구조를 우선 보존합니다. `,(0,u.jsx)(t.code,{children:`w2:trigger`}),`, `,(0,u.jsx)(t.code,{children:`xf:input`}),`, DataList 바인딩처럼 WebSquare 전용 컴포넌트가 필요한 화면은 이 마크업을 기준으로 프로젝트 표준에 맞게 치환합니다.`]}),`
`,(0,u.jsxs)(t.p,{children:[`Container, Grid, Flex처럼 호출 위치의 자식 콘텐츠를 감싸는 구조 컴포넌트는 별도 XML 파일을 WFrame으로 호출하지 않고 현재 화면의 `,(0,u.jsx)(t.code,{children:`w2:group`}),`에 공통 클래스를 직접 적용합니다. WFrame은 공통 메뉴처럼 완성된 별도 화면 XML을 `,(0,u.jsx)(t.code,{children:`src`}),`로 포함해야 할 때 사용합니다.`]}),`
`,(0,u.jsxs)(t.p,{children:[`WebSquare 탭은 화면 XML 작성 기준을 제공하며 WebSquare 런타임, 라이선스 또는 별도 `,(0,u.jsx)(t.code,{children:`apps/websquare`}),` 실행 프로젝트를 포함하지 않습니다.`]}),`
