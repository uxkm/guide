...
`,(0,d.jsx)(t.h2,{id:`회원가입-통합-데모`,children:`회원가입 통합 데모`}),`
`,(0,d.jsx)(t.p,{children:`공통 컴포넌트 52종을 활용한 회원가입 페이지입니다. Gulp·Vue·React에서 동일한 UI와 상단·좌측·하단 레이아웃, 우측 스티키 TOC, Top 버튼을 확인할 수 있습니다.`}),`
`,(0,d.jsxs)(`p`,{children:[(0,d.jsxs)(t.p,{children:[`각 데모는 `,(0,d.jsx)(`strong`,{children:`새 창`}),`으로 열립니다.`,` `]}),`배포된 데모를 바로 이용할 수 있습니다.`]}),`
`,(0,d.jsx)(o,{label:`프레임워크별 회원가입 데모`,columns:[`프레임워크`,`로컬 실행 명령`,`데모 페이지`],rows:[[`Gulp / Nunjucks`,`pnpm dev:gulp`,(0,d.jsx)(t.a,{href:`https://guide.uxkm.io/apps/gulp/signup.html`,target:`_blank`,rel:`noopener noreferrer`,children:`Gulp 회원가입 데모 (새 창)`})],[`Vue`,`pnpm dev:vue`,(0,d.jsx)(t.a,{href:`https://guide.uxkm.io/apps/vue/signup/`,target:`_blank`,rel:`noopener noreferrer`,children:`Vue 회원가입 데모 (새 창)`})],[`React`,`pnpm dev:react`,(0,d.jsx)(t.a,{href:`https://guide.uxkm.io/apps/react/signup/`,target:`_blank`,rel:`noopener noreferrer`,children:`React 회원가입 데모 (새 창)`})]],codeColumns:[1]}),`
...
`]}),`
`,(0,d.jsx)(t.p,{children:`이 표는 저장소 구조 기준의 지원 범위입니다. 특정 컴포넌트의 사용법과 제한은 각 컴포넌트 문서를 참고합니다.`})]})}function u(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,d.jsx)(t,{...e,children:(0,d.jsx)(l,{...e})}):l(e)}var d;function f(){return(f=e((()=>{d=t(),a(),n(),c()})))()}f();export{u as default};