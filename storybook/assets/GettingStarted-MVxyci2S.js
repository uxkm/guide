...
{% endblock %}
`})}),`
`,(0,u.jsx)(t.pre,{children:(0,u.jsx)(t.code,{className:`language-nunjucks`,children:`{% from "components/basic/Button/button.njk" import button %}
...
{% for action in actions %}
  {{ button(variant='filled', color=action.color, label=action.label) }}
{% endfor %}
`})}),`
