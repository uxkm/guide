import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{d as n}from"./iframe-IZ4Y9eS7.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{i,r as a}from"./FormLayout-DqL6i1n7.js";var o,s,c,l;function u(){return(u=e((()=>{o=[{key:`name`,label:`이름`},{key:`description`,label:`설명`},{key:`default`,label:`기본값`},{key:`type`,label:`타입`}],s=(e,t,n)=>({title:e,description:n,tables:[{columns:o,rows:t}]}),c=[{name:`value · defaultValue`,type:`number`,default:`50`,description:`현재 값과 초기값입니다.`},{name:`min · max · step`,type:`number`,default:`0 · 100 · 1`,description:`값의 범위와 증감 단위입니다.`},{name:`size`,type:`'sm' | 'md' | 'lg'`,default:`md`,description:`트랙·썸·값 텍스트 크기입니다.`},{name:`disabled · vertical`,type:`boolean`,default:`false`,description:`비활성 상태와 방향입니다.`},{name:`label · showValue · valueSuffix · hint`,type:`string · boolean`,default:`—`,description:`레이블, 현재 값, 단위 및 보조 설명입니다.`},{name:`stepper · stepperAlways`,type:`boolean`,default:`false`,description:`증감 버튼을 모바일 또는 항상 표시합니다.`},{name:`decreaseLabel · increaseLabel`,type:`string`,default:`값 줄이기 · 값 늘리기`,description:`증감 버튼의 접근 가능한 이름입니다.`},{name:`ripple`,type:`boolean`,default:`true`,description:`Slider 영역과 증감 버튼에 클릭 파장 효과를 표시합니다.`},{name:`className · ...props`,type:`string · range attributes`,default:`—`,description:`루트 클래스와 네이티브 range 속성입니다.`}],l=[s(`React · Next.js API · Props`,c,`Next.js는 @uxkm/react/slider를 재사용합니다.`),s(`React · Next.js API · Events`,[{name:`onChange`,type:`(value: number) => void`,default:`—`,description:`값 변경 콜백입니다.`}]),s(`Vue · Nuxt API`,[{name:`modelValue · update:modelValue`,type:`number · event`,default:`50`,description:`v-model 값과 변경 이벤트입니다.`},...c.slice(1,8)],`Nuxt는 @uxkm/vue/slider를 재사용합니다.`),s(`HTML · Gulp · 클래스`,[{name:`slider · slider_input`,type:`class`,default:`—`,description:`슬라이더 루트와 네이티브 range입니다.`},{name:`slider_header · slider_label · slider_value · slider_hint`,type:`class`,default:`—`,description:`레이블, 값 및 설명입니다.`},{name:`slider_sm · slider_lg · slider_fit · slider_block`,type:`class`,default:`—`,description:`크기와 너비 변형입니다.`},{name:`slider_control · slider_stepper · slider_stepper_always · slider_step`,type:`class`,default:`—`,description:`증감 버튼 구조와 표시 방식입니다.`},{name:`slider_ticks · slider_tick`,type:`class`,default:`—`,description:`눈금 구조입니다.`}]),s(`디자인 토큰`,[{name:`--slider-track-height · --slider-thumb-size`,type:`length`,default:`4px · 14px`,description:`기본 트랙과 썸 크기입니다.`},{name:`--slider-max-width`,type:`length`,default:`var(--input-max-width)`,description:`slider_fit의 최대 너비입니다.`},{name:`--slider-step-size · --slider-step-gap`,type:`length`,default:`2.25rem · var(--space-sm)`,description:`증감 버튼 크기와 간격입니다.`}]),s(`WebSquare API · XML`,[{name:`xf:input[type=range]`,type:`XML element`,default:`type='range'`,description:`범위 입력 컴포넌트입니다. min, max, step, value, disabled 속성을 조합합니다.`},{name:`ref · data:*`,type:`DataCollection binding`,default:`—`,description:`슬라이더 값을 DataMap 경로에 양방향 바인딩합니다.`},{name:`w2:group.slider · slider_control · slider_stepper`,type:`XML element · class`,default:`—`,description:`슬라이더 루트와 증감 버튼 구조를 만듭니다.`},{name:`xf:trigger.slider_step`,type:`XML element · event`,default:`—`,description:`값을 한 단계 줄이거나 늘리는 동작을 실행합니다.`},{name:`ev:onchange`,type:`WebSquare event`,default:`—`,description:`값 변경 후 표시 갱신이나 연관 검증 함수를 실행합니다.`}],`화면 XML 루트에 w2, xf, ev 네임스페이스가 선언되어 있다는 전제의 fragment입니다.`)]})))()}function d({increase:e}){return(0,m.jsxs)(`svg`,{className:`slider_step-icon`,"aria-hidden":`true`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:[(0,m.jsx)(`path`,{d:`M5 12h14`}),e&&(0,m.jsx)(`path`,{d:`M12 5v14`})]})}function f({min:e=0,max:t=100,value:n,defaultValue:r=50,step:i=1,disabled:a=!1,vertical:o=!1,label:s,showValue:c=!1,stepper:l=!1,stepperAlways:u=!1,valueSuffix:f=``,hint:_,decreaseLabel:v=`값 줄이기`,increaseLabel:y=`값 늘리기`,size:b=`md`,id:x,className:S=``,children:C,ripple:w=!0,onChange:T,style:E,...D}){let O=(0,p.useId)(),k=x||O,A=Number(e),j=Number(t),[M,N]=(0,p.useState)(()=>g(n??r,A,j)),P=g(M,A,j),F=h.has(b)?b:`md`,I=j===A?0:(P-A)/(j-A)*100;(0,p.useEffect)(()=>{n!==void 0&&N(g(n,A,j))},[n,A,j]);let L=(0,p.useMemo)(()=>[`slider`,F===`sm`&&`slider_sm`,F===`lg`&&`slider_lg`,o&&`slider_vertical`,l&&`slider_stepper`,u&&`slider_stepper_always`,S].filter(Boolean).join(` `),[F,o,l,u,S]),R=String(D[`data-slider-valuetext-map`]??``).split(`,`).reduce((e,t)=>{let n=t.indexOf(`:`);return n>-1&&(e[t.slice(0,n)]=t.slice(n+1)),e},{})[String(P)]??(D[`data-slider-valuetext-suffix`]?`${P} ${D[`data-slider-valuetext-suffix`]}`:D[`aria-valuetext`]);function z(e){let t=g(e,A,j);N(t),T?.(t)}let B=(0,m.jsx)(`input`,{...D,id:k,type:`range`,className:`slider_input`,min:A,max:j,step:i,value:P,disabled:a,"aria-valuetext":R||void 0,onChange:e=>z(e.target.value)});return(0,m.jsxs)(`div`,{className:L,"data-component":`Slider`,"data-ripple":w?`true`:void 0,style:{"--slider-progress":`${I}%`,...E},children:[(s||c)&&(0,m.jsxs)(`div`,{className:`slider_header`,children:[s&&(0,m.jsx)(`label`,{className:`slider_label`,htmlFor:k,children:s}),c&&(0,m.jsxs)(`output`,{className:`slider_value`,htmlFor:k,children:[P,f||D[`data-slider-suffix`]||``]})]}),l?(0,m.jsxs)(`div`,{className:`slider_control`,children:[(0,m.jsx)(`button`,{type:`button`,className:`slider_step slider_step-decrease`,"data-ripple":`true`,"aria-label":v,disabled:a||P<=A,onClick:()=>z(P-Number(i||1)),children:(0,m.jsx)(d,{})}),B,(0,m.jsx)(`button`,{type:`button`,className:`slider_step slider_step-increase`,"data-ripple":`true`,"aria-label":y,disabled:a||P>=j,onClick:()=>z(P+Number(i||1)),children:(0,m.jsx)(d,{increase:!0})})]}):B,_&&(0,m.jsx)(`p`,{className:`slider_hint`,children:_}),C]})}var p,m,h,g;function _(){return(_=e((()=>{p=n(),m=r(),h=new Set([`sm`,`md`,`lg`]),g=(e,t,n)=>Math.min(n,Math.max(t,Number(e))),f.__docgenInfo={description:``,methods:[],displayName:`Slider`,props:{min:{defaultValue:{value:`0`,computed:!1},required:!1},max:{defaultValue:{value:`100`,computed:!1},required:!1},defaultValue:{defaultValue:{value:`50`,computed:!1},required:!1},step:{defaultValue:{value:`1`,computed:!1},required:!1},disabled:{defaultValue:{value:`false`,computed:!1},required:!1},vertical:{defaultValue:{value:`false`,computed:!1},required:!1},showValue:{defaultValue:{value:`false`,computed:!1},required:!1},stepper:{defaultValue:{value:`false`,computed:!1},required:!1},stepperAlways:{defaultValue:{value:`false`,computed:!1},required:!1},valueSuffix:{defaultValue:{value:`''`,computed:!1},required:!1},decreaseLabel:{defaultValue:{value:`'값 줄이기'`,computed:!1},required:!1},increaseLabel:{defaultValue:{value:`'값 늘리기'`,computed:!1},required:!1},size:{defaultValue:{value:`'md'`,computed:!1},required:!1},className:{defaultValue:{value:`''`,computed:!1},required:!1},ripple:{defaultValue:{value:`true`,computed:!1},required:!1}}}})))()}var v=t({Basic:()=>T,Color:()=>j,Form:()=>N,Label:()=>E,Playground:()=>C,Size:()=>D,State:()=>M,Step:()=>k,Stepper:()=>A,Type:()=>w,Width:()=>O,__namedExportsOrder:()=>P,default:()=>S}),y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P;function F(){return(F=e((()=>{n(),u(),i(),_(),y=r(),b=e=>()=>(0,y.jsx)(`div`,{className:`demo-stack`,children:e}),x={min:0,max:100,value:50,step:1,disabled:!1,vertical:!1,label:`라벨`,showValue:!1,stepper:!1,stepperAlways:!1,valueSuffix:``,hint:``,decreaseLabel:``,increaseLabel:``,size:`md`},S={title:`폼/Slider`,id:`components-slider`,component:f,tags:[`autodocs`],argTypes:{min:{control:`number`,type:{name:`number`,summary:`number`}},max:{control:`number`,type:{name:`number`,summary:`number`}},value:{control:`number`,type:{name:`number`,summary:`number`}},step:{control:`number`,type:{name:`number`,summary:`number`}},disabled:{control:`boolean`,type:{name:`boolean`,summary:`boolean`}},vertical:{control:`boolean`,type:{name:`boolean`,summary:`boolean`}},label:{control:`text`,type:{name:`string`,summary:`string`}},showValue:{control:`boolean`,type:{name:`boolean`,summary:`boolean`}},stepper:{control:`boolean`,type:{name:`boolean`,summary:`boolean`}},stepperAlways:{control:`boolean`,type:{name:`boolean`,summary:`boolean`}},valueSuffix:{control:`text`,type:{name:`string`,summary:`string`}},hint:{control:`text`,type:{name:`string`,summary:`string`}},decreaseLabel:{control:`text`,type:{name:`string`,summary:`string`}},increaseLabel:{control:`text`,type:{name:`string`,summary:`string`}},size:{control:`select`,options:[`sm`,`md`,`lg`],type:{name:`enum`,summary:`'sm' | 'md' | 'lg'`}}},parameters:{controls:{disable:!1},layout:`padded`,apiSections:l,docs:{description:{component:`범위 값을 조절하는 Slider 컴포넌트입니다.`}}}},C={parameters:{controls:{disable:!1}},args:{...x},render:(e,{updateArgs:t})=>(0,y.jsx)(f,{...e,onChange:e=>t({value:e})})},w={name:`유형`,parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"접근 가능한 이름 지정 방식별 예시입니다. 보이는 레이블이 있으면 `label for` 또는 `aria-labelledby`를, 레이블 없이 아이콘·단독 UI만 있으면 `aria-label`을 사용합니다. 보조 설명은 `aria-describedby`, 스크린 리더용 값 표현은 `aria-valuetext`와 `output`을 조합합니다."},source:{code:`import Slider from '@uxkm/react/slider';
...
}`,language:`tsx`}}},render:b((0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(f,{id:`slider-type-label`,className:`slider_fit`,label:`label + for — 기본`,value:40,showValue:!0}),(0,y.jsx)(f,{className:`slider_fit`,value:55,"aria-label":`단독 슬라이더 — aria-label`}),(0,y.jsxs)(`p`,{className:`slider_hint`,children:[`레이블 없이 사용할 때는 `,(0,y.jsx)(`code`,{children:`aria-label`}),`로 접근 가능한 이름을 지정합니다.`]}),(0,y.jsx)(f,{id:`slider-type-labelledby`,className:`slider_fit`,label:`aria-labelledby — 외부 레이블`,value:16,min:12,max:24,step:1,"aria-describedby":`slider-type-labelledby-hint`,"data-slider-valuetext-suffix":`픽셀`,showValue:!0}),(0,y.jsx)(`p`,{className:`slider_hint`,id:`slider-type-labelledby-hint`,children:`12~24px 사이 글자 크기`}),(0,y.jsx)(f,{id:`slider-type-describedby`,className:`slider_fit`,label:`aria-describedby — 보조 설명`,value:70,"aria-describedby":`slider-type-describedby-hint`,"data-slider-suffix":`%`,"data-slider-valuetext-suffix":`퍼센트`,showValue:!0}),(0,y.jsxs)(`p`,{className:`slider_hint`,id:`slider-type-describedby-hint`,children:[`0%는 최소, 100%는 최대 대비입니다. 힌트 id를 `,(0,y.jsx)(`code`,{children:`aria-describedby`}),`에 연결합니다.`]}),(0,y.jsx)(f,{id:`slider-type-valuetext`,className:`slider_fit`,label:`aria-valuetext — 읽기 쉬운 값`,value:3,min:1,max:5,step:1,"data-slider-valuetext-map":`1:매우 낮음,2:낮음,3:보통,4:높음,5:매우 높음`,showValue:!0}),(0,y.jsxs)(`p`,{className:`slider_hint`,children:[`숫자 대신 `,(0,y.jsx)(`code`,{children:`aria-valuetext`}),`로 “보통”처럼 읽기 쉬운 값을 전달합니다. 시각적 output은 `,(0,y.jsx)(`code`,{children:`aria-hidden="true"`}),`로 중복 낭독을 줄일 수 있습니다.`]})]}))},T={name:`기본`,parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:`slider 래퍼 안에 slider_input을 배치합니다. min · max · value로 범위와 초기값을 지정합니다.`},source:{code:`import Slider from '@uxkm/react/slider';

export function BasicExample() {
  return <Slider className="slider_fit" value={30} aria-label="기본 슬라이더" />;
}`,language:`tsx`}}},render:b((0,y.jsx)(f,{className:`slider_fit`,value:30,"aria-label":`기본 슬라이더`}))},E={name:`레이블 · 값 표시`,parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:`slider_header에 slider_label과 output.slider_value를 함께 사용합니다. output의 for 속성은 대응하는 input id와 연결합니다.`},source:{code:`import Slider from '@uxkm/react/slider';
...
}`,language:`tsx`}}},render:b((0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(f,{id:`slider-volume`,className:`slider_fit`,label:`볼륨`,value:60,showValue:!0}),(0,y.jsx)(f,{id:`slider-brightness`,className:`slider_fit`,label:`밝기`,value:40,"data-slider-suffix":`%`,showValue:!0})]}))},D={name:`크기`,parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:`slider_sm · slider(기본) · slider_lg로 트랙·썸·텍스트 크기를 조절합니다.`},source:{code:`import Slider from '@uxkm/react/slider';
...
}`,language:`tsx`}}},render:b((0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(f,{id:`slider-size-sm`,size:`sm`,className:`slider_fit`,label:`Small — slider_sm`,value:30,showValue:!0}),(0,y.jsx)(f,{id:`slider-size-md`,className:`slider_fit`,label:`Medium — 기본`,value:50,showValue:!0}),(0,y.jsx)(f,{id:`slider-size-lg`,size:`lg`,className:`slider_fit`,label:`Large — slider_lg`,value:70,showValue:!0})]}))},O={name:`너비`,parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:`기본은 부모 100%입니다. slider_fit으로 --slider-max-width(320px)까지 제한하고, slider_block으로 전체 너비를 사용합니다.`},source:{code:`import Slider from '@uxkm/react/slider';
...
}`,language:`tsx`}}},render:b((0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(f,{id:`slider-color-primary`,className:`color_primary slider_fit`,label:`Primary`,value:60,showValue:!0}),(0,y.jsx)(f,{id:`slider-color-success`,className:`color_success slider_fit`,label:`Success`,value:70,showValue:!0}),(0,y.jsx)(f,{id:`slider-color-danger`,className:`color_danger slider_fit`,label:`Danger`,value:40,showValue:!0}),(0,y.jsx)(f,{id:`slider-color-warning`,className:`color_warning slider_fit`,label:`Warning`,value:80,showValue:!0})]}))},M={name:`상태`,parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:`비활성·오류(is-error) 상태를 지원합니다.`},source:{code:`import Slider from '@uxkm/react/slider';
...
}`,language:`tsx`}}},render:b((0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(f,{className:`slider_fit`,label:`기본`,value:50,showValue:!0}),(0,y.jsx)(f,{className:`slider_fit`,label:`비활성`,value:30,disabled:!0,showValue:!0})]}))},N={name:`폼 레이아웃`,parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:`form_field · form_vertical · form_horizontal과 함께 사용합니다.`},source:{code:`import FormLayout from '@uxkm/react/form-layout';
...
}`,language:`tsx`}}},render:b((0,y.jsxs)(y.Fragment,{children:[(0,y.jsxs)(a,{layout:`vertical`,fit:!0,children:[(0,y.jsxs)(`div`,{className:`form_field`,children:[(0,y.jsx)(`label`,{className:`form_field-label`,htmlFor:`slider-form-opacity`,children:`불투명도`}),(0,y.jsx)(f,{id:`slider-form-opacity`,value:85,"data-slider-suffix":`%`}),(0,y.jsx)(`p`,{className:`form_field-hint`,children:`0~100% 사이 값`})]}),(0,y.jsxs)(`div`,{className:`form_field`,children:[(0,y.jsx)(`label`,{className:`form_field-label`,htmlFor:`slider-form-zoom`,children:`확대 비율`}),(0,y.jsx)(f,{id:`slider-form-zoom`,label:`현재 값`,value:125,min:50,max:200,step:25,"data-slider-suffix":`%`,showValue:!0})]})]}),(0,y.jsx)(a,{layout:`horizontal`,fit:!0,children:(0,y.jsxs)(`div`,{className:`form_field`,children:[(0,y.jsx)(`label`,{className:`form_field-label`,htmlFor:`slider-form-horizontal`,children:`선 굵기`}),(0,y.jsx)(f,{id:`slider-form-horizontal`,value:3,min:1,max:10}),(0,y.jsx)(`p`,{className:`form_field-hint`,children:`1~10px`})]})})]}))},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...N.parameters?.docs?.source}}},P=[`Playground`,`Type`,`Basic`,`Label`,`Size`,`Width`,`Step`,`Stepper`,`Color`,`State`,`Form`]})))()}export{D as a,k as c,O as d,F as f,E as i,A as l,l as m,j as n,v as o,u as p,N as r,M as s,T as t,w as u};