...
`,(0,u.jsx)(t.p,{children:`UXKM 컴포넌트는 여섯 브라우저 구현과 WebSquare XML에서 같은 이름, 의미, 상태와 시각 결과를 제공하도록 구성합니다. HTML 구현을 시맨틱 마크업 기준으로 삼고 공통 스타일은 한 곳에서 관리합니다.`}),`
`,(0,u.jsx)(t.h2,{id:`소유-위치`,children:`소유 위치`}),`
`,(0,u.jsx)(s,{columns:[`영역`,`위치`],rows:[[`HTML 기준 구현`,`apps/html/src/components`],[`Nunjucks 구현`,`apps/gulp/src/components`],[`Vue 구현·테스트`,`apps/vue/src/components`],[`React 구현·테스트`,`apps/react/src/components`],[`Nuxt·Next 전용 통합`,`apps/nuxt, apps/next`],[`WebSquare XML 원본`,`apps/websquare/src/components`],[`공통 스타일`,`packages/styles/components`],[`통합 문서와 예제`,`apps/storybook/src`]],codeColumns:[1]}),`
