import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{a as n,c as r,d as i,f as a,i as o,l as s,m as c,n as l,o as u,p as ee,r as te,s as ne,t as re,u as ie}from"./Card.stories-Dy526uXP.js";import{d as ae,i as d,l as oe}from"./blocks-DKrjMPN_.js";import{n as se,t as f}from"./FrameworkTabs-duseEU1T.js";import{i as ce,r as le}from"./react-CQ14Jk9E.js";import{n as ue,t as de}from"./ComponentApiDocs-C9VNL7Yh.js";function p(e,t){return e.match(RegExp(`\\b${t}="([^"]*)"`))?.[1]??``}function m(e){return`'${e.replaceAll(`\\`,`\\\\`).replaceAll(`'`,`\\'`)}'`}function fe(e,t,n){let r=[],i=new Set(n.filter(e=>e!==`card`)),a=e=>i.delete(e);a(`card_shadow`)?r.push(`variant='shadow'`):a(`card_elevated`)?r.push(`variant='elevated'`):a(`card_ghost`)?r.push(`variant='flat'`):a(`card_borderless`)&&r.push(`variant='borderless'`);for(let e of[`sm`,`lg`,`compact`])a(`card_${e}`)&&r.push(`size='${e}'`);a(`card_horizontal`)&&r.push(`horizontal=true`),a(`card_hover`)&&r.push(`hoverable=true`),a(`card_accent`)&&r.push(`accent=true`),a(`is-disabled`)&&r.push(`disabled=true`);let o=[...i].find(e=>e.startsWith(`color_`));o&&(i.delete(o),r.push(`color='${o.slice(6)}'`));let s=p(t,`href`),c=p(t,`role`),l=p(t,`tabindex`),u=p(t,`style`);return e===`a`&&!s&&r.push(`tag='a'`),s&&r.push(`href=${m(s)}`),c&&r.push(`role=${m(c)}`),l&&r.push(`tabIndex=${m(l)}`),u&&r.push(`style=${m(u)}`),(s||c===`link`||c===`button`)&&i.has(`card_clickable`)&&i.delete(`card_clickable`),i.size&&r.push(`className=${m([...i].join(` `))}`),r.join(`, `)}function pe(e,t=``){let n=[],r=new Set(p(e,`class`).split(/\s+/).filter(Boolean));r.delete(`btn`);let i=[`filled`,`outline`,`ghost`,`text`,`select`].find(e=>r.delete(`btn_${e}`)),a=[...r].find(e=>e.startsWith(`color_`)),o=[`sm`,`lg`].find(e=>r.delete(`btn_${e}`));i&&n.push(`variant='${i}'`),a&&(r.delete(a),n.push(`color='${a.slice(6)}'`)),o&&n.push(`size='${o}'`);for(let[e,t]of Object.entries({"btn_icon-only":`iconOnly`,btn_round:`round`,btn_block:`block`,btn_fit:`fit`}))r.delete(e)&&n.push(`${t}=true`);let s=p(e,`aria-label`);return s&&n.push(`ariaLabel=${m(s)}`),/\bdisabled(?:\s|$)/.test(e)&&n.push(`disabled=true`),r.size&&n.push(`className=${m([...r].join(` `))}`),t&&n.push(`label=${m(t)}`),n.join(`, `)}function me(e){return e.replace(/<button\b([^>]*)>\s*<span class="btn_label">([^<]*)<\/span>\s*<\/button>/g,(e,t,n)=>`{{ button(${pe(t,n)}) }}`).replace(/<button\b([^>]*)>([\s\S]*?)<\/button>/g,(e,t,n)=>{let r=pe(t);return/<circle cx="12" cy="12" r="1"\/>/.test(n)&&/<circle cx="19" cy="12" r="1"\/>/.test(n)?`{{ button(${r}${r?`, `:``}iconBefore='more') }}`:`{% call button(${r}) %}${n.trim()}{% endcall %}`})}function h(e,t){let n=/<\/?div\b[^>]*>/g;n.lastIndex=t;let r=0,i;for(;i=n.exec(e);)if(r+=i[0].startsWith(`</div`)?-1:1,r===0)return n.lastIndex;return-1}function he(e){let t=e.indexOf(`<div class="card_header">`);if(t<0)return e;let n=h(e,t);if(n<0)return e;let r=e.slice(t,n);if(!r.includes(`class="avatar `))return e;let i=r.indexOf(`<div class="card_header-main">`),a=h(r,i),o=r.indexOf(`<div class="card_extra">`,a),s=h(r,o);if(i<0||a<0||o<0||s<0)return e;let c=r.slice(i+30,a-6),l=`{% set cardHeaderExtra %}${r.slice(o+24,s-6)}{% endset %}{% call cardHeader(extra=cardHeaderExtra) %}${c}{% endcall %}`;return e.slice(0,t)+l+e.slice(n)}function ge(e){return e.replace(/<span class="avatar(?:\s+color_(\w+))?"(?:\s+aria-hidden="true")?>([^<]*)<\/span>/g,(e,t,n)=>`{{ avatar(${t?`color='${t}', `:``}initials=${m(n)}, ariaHidden=true) }}`).replace(/<span class="tag(?:\s+tag_(sm|lg))?(?:\s+color_(\w+))?">([^<]*)<\/span>/g,(e,t,n,r)=>`{{ tag(${[t?`size='${t}'`:``,n?`color='${n}'`:``,`label=${m(r)}`].filter(Boolean).join(`, `)}) }}`)}function _e(e){let t=e.replace(/\s*(\{%\s*call\b[^%]*%\})\s*/g,`
$1
...
`)}function ve(e){let t=[],n=ge(he(me(e))).replace(/<div class="card_header"><div class="card_header-main"><h3 class="card_title">([^<]*)<\/h3>(?:<p class="card_subtitle">([^<]*)<\/p>)?<\/div><\/div>/g,(e,t,n)=>`{{ cardHeader(title=${m(t)}${n?`, subtitle=${m(n)}`:``}) }}`).replace(/<div class="card_header"><h3 class="card_title">([^<]*)<\/h3><\/div>/g,(e,t)=>`{{ cardHeader(title=${m(t)}) }}`).replace(/<(\/)?(article|a|div)\b([^>]*)>/g,(e,n,r,i)=>{if(n)return t.pop()?.macro?`{% endcall %}`:e;let a=p(i,`class`).split(/\s+/).filter(Boolean);if(a.includes(`card`)&&(r===`article`||r===`a`)){let e=fe(r,i,a);return t.push({tag:r,macro:!0}),`{% call card(${e}) %}`}if(r===`div`&&a.includes(`card_deck`)){let e=a.find(e=>/^card_deck-[23]$/.test(e)),n=e?`columns=${e.slice(-1)}`:``;return t.push({tag:r,macro:!0}),`{% call cardDeck(${n}) %}`}if(r===`div`&&a.length===1&&a[0]===`card_body`)return t.push({tag:r,macro:!0}),`{% call cardBody() %}`;if(r===`div`&&a.includes(`card_footer`)){let e=a.includes(`card_footer-between`);return t.push({tag:r,macro:!0}),`{% call cardFooter(${e?`between=true`:``}) %}`}if(r===`div`&&a.includes(`tag_group`)){let e=a.includes(`tag_group-tight`);return t.push({tag:r,macro:!0}),`{% call tagGroup(${e?`tight=true`:``}) %}`}return t.push({tag:r,macro:!1}),e});return`${[ye,n.includes(`button(`)?be:``,n.includes(`avatar(`)?xe:``,n.includes(`tag(`)||n.includes(`tagGroup(`)?Se:``].filter(Boolean).join(`
`)}\n\n${_e(n)}`}function g(e,t,n,r){let i=`import { Card, CardBody, CardFooter, CardHeader } from '@uxkm/react/card';\nimport Avatar from '@uxkm/react/avatar';\nimport Button from '@uxkm/react/button';\nimport Stat from '@uxkm/react/stat';\nimport { Tag, TagGroup } from '@uxkm/react/tag';\n\nexport function Example() {\n  return (\n${n}\n  );\n}`,a=`<script setup>\nimport { Card, CardBody, CardFooter, CardHeader } from '@uxkm/vue/card';\nimport Avatar from '@uxkm/vue/avatar';\nimport Button from '@uxkm/vue/button';\nimport Stat from '@uxkm/vue/stat';\nimport { Tag, TagGroup } from '@uxkm/vue/tag';\n<\/script>\n\n<template>\n${r}\n</template>`;return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/data-display/Card/Card.html · ${e}`,code:t},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/data-display/Card/card.njk · ${e}`,code:ve(t)},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/card · ${e}`,code:a},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/card · ${e}`,code:a},{id:`react`,label:`React`,fileName:`@uxkm/react/card · ${e}`,code:i},{id:`next`,label:`Next`,fileName:`@uxkm/react/card · ${e}`,code:i}]}var ye,be,xe,Se,_,v,y,b,x,S;function C(){return(C=e((()=>{ye=`{% from "components/data-display/Card/card.njk" import card, cardHeader, cardBody, cardFooter, cardDeck %}`,be=`{% from "components/basic/Button/button.njk" import button %}`,xe=`{% from "components/data-display/Avatar/avatar.njk" import avatar %}`,Se=`{% from "components/data-display/Tag/tag.njk" import tag, tagGroup %}`,_=`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg>`,v=`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></svg>`,y=`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>`,b=`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>`,x=`<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>`,S={basic:g(`basic`,`<article class="card" style="max-width: 360px; width: 100%;">
  ...
  <div class="card_footer"><button type="button" class="btn btn_filled color_primary btn_sm"><span class="btn_label">확인</span></button><button type="button" class="btn btn_ghost btn_sm"><span class="btn_label">취소</span></button></div>
    ...
    <CardBody>카드 본문 영역입니다. 관련 콘텐츠, 설명, 데이터를 담을 수 있습니다.</CardBody>
    <CardFooter><Button variant="filled" color="primary" size="sm" label="확인" /><Button variant="ghost" size="sm" label="취소" /></CardFooter>
  </Card>`),simple:g(`simple`,`<article class="card card_shadow card_compact" style="max-width: 280px; width: 100%;"><div class="card_body"><p class="card_title">알림</p>새로운 메시지가 도착했습니다. 확인해 주세요.</div></article>
<article class="card card_compact" style="max-width: 280px; width: 100%;"><div class="card_body">컴팩트 카드 — 좁은 패딩으로 밀도 높은 정보를 표시합니다.</div></article>`,`    <>
  ...
  <Card size="compact" style="max-width: 280px; width: 100%;"><CardBody>컴팩트 카드 — 좁은 패딩으로 밀도 높은 정보를 표시합니다.</CardBody></Card>`),skin:g(`skin`,`<div class="card_deck card_deck-2">
  ...
  <article class="card card_ghost"><div class="card_body">Ghost — 투명 배경</div></article>
    ...
    <Card variant="flat"><CardBody>Ghost — 투명 배경</CardBody></Card>
  </div>`),size:g(`size`,`<div class="card_deck card_deck-2">
  ...
  <article class="card card_lg"><div class="card_header"><h3 class="card_title">Large</h3></div><div class="card_body">큰 카드 — 넓은 패딩과 큰 제목.</div></article>
    ...
    <Card><CardHeader title="Medium" /><CardBody>기본 크기 카드입니다.</CardBody></Card>
    <Card size="lg"><CardHeader title="Large" /><CardBody>큰 카드 — 넓은 패딩과 큰 제목.</CardBody></Card>
  </div>`),accent:g(`accent`,`<div class="card_deck card_deck-2">
  ...
  </div>`),disabled:g(`disabled`,`<article class="card is-disabled" style="max-width: 280px; width: 100%;"><div class="card_body"><h3 class="card_title">비활성 카드</h3><p class="card_subtitle">현재 이용할 수 없습니다.</p></div></article>`,`    <Card className="is-disabled" style={{ maxWidth: 280, width: '100%' }}><CardBody><h3 className="card_title">비활성 카드</h3><p className="card_subtitle">현재 이용할 수 없습니다.</p></CardBody></Card>`,`  <Card class="is-disabled" style="max-width: 280px; width: 100%;"><CardBody><h3 class="card_title">비활성 카드</h3><p class="card_subtitle">현재 이용할 수 없습니다.</p></CardBody></Card>`),grid:g(`grid`,`<div class="card_deck">
  ...
  <article class="card card_hover"><div class="card_header"><h3 class="card_title">Feature C</h3></div><div class="card_body">Pure SCSS로 커스터마이즈 가능.</div></article>
    ...
    <Card hoverable><CardHeader title="Feature B" /><CardBody>접근성을 고려한 마크업 구조.</CardBody></Card>
    <Card hoverable><CardHeader title="Feature C" /><CardBody>Pure SCSS로 커스터마이즈 가능.</CardBody></Card>
  </div>`)}})))()}var w;function T(){return(T=e((()=>{w=`<!-- Card 원본 구현: 데이터 표시 구조와 시각 상태를 공통 CSS 클래스 및 접근성 속성으로 표현합니다. -->
...
`})))()}var E;function D(){return(D=e((()=>{E=`{# Card 원본 구현: 시맨틱 루트와 공통 CSS 클래스를 조합하고 내부 영역을 macro로 구성합니다. #}
...
`))}var G,Te,K,Ee,q;function De(){return(De=e((()=>{C(),T(),D(),k(),j(),N(),F(),L(),we(),G=[A,`<!-- CardHeader.vue -->\n${Ce}`,`<!-- CardBody.vue -->\n${M}`,`<!-- CardFooter.vue -->\n${I}`,`<!-- CardDeck.vue -->\n${P}`].join(`

`),Te=[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/data-display/Card/Card.html`,code:w},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/data-display/Card/card.njk`,code:E},{id:`vue`,label:`Vue`,fileName:`apps/vue/src/components/data-display/Card/Card*.vue`,code:G},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/card → Card*.vue`,code:G},{id:`react`,label:`React`,fileName:`apps/react/src/components/data-display/Card/Card.jsx`,code:O},{id:`next`,label:`Next`,fileName:`@uxkm/react/card → Card.jsx`,code:O}],K=(e,t=2)=>e.split(`
...
`]}),`
`,(0,Q.jsx)(f,{examples:Te,showFullCode:!0}),`
...
`,(0,Q.jsx)(d,{of:re,sourceState:`none`}),`
`,(0,Q.jsx)(f,{examples:q.accent}),`
`,(0,Q.jsx)(t.h2,{id:`미디어`,children:`미디어`}),`
`,(0,Q.jsxs)(t.p,{children:[(0,Q.jsx)(t.code,{children:`card_media`}),`로 상단 이미지·썸네일 영역을 추가합니다.`]}),`
`,(0,Q.jsx)(d,{of:s,sourceState:`none`}),`
`,(0,Q.jsx)(f,{examples:q.media}),`
...
`,(0,Q.jsx)(d,{of:ne,sourceState:`none`}),`
`,(0,Q.jsx)(f,{examples:q.horizontal}),`
...
`,(0,Q.jsx)(d,{of:r,sourceState:`none`}),`
`,(0,Q.jsx)(f,{examples:q.iconStat}),`
...
`,(0,Q.jsx)(d,{of:ie,sourceState:`none`}),`
`,(0,Q.jsx)(f,{examples:q.profile}),`
...
`,(0,Q.jsx)(d,{of:o,sourceState:`none`}),`
`,(0,Q.jsx)(f,{examples:q.clickable}),`
`,(0,Q.jsx)(t.h2,{id:`비활성`,children:`비활성`}),`
`,(0,Q.jsxs)(t.p,{children:[(0,Q.jsx)(t.code,{children:`is-disabled`}),`로 비활성 상태를 표시합니다.`]}),`
`,(0,Q.jsx)(d,{of:n,sourceState:`none`}),`
`,(0,Q.jsx)(f,{examples:q.disabled}),`
...
`,(0,Q.jsx)(d,{of:u,sourceState:`none`}),`
`,(0,Q.jsx)(f,{examples:q.grid}),`
`,(0,Q.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,Q.jsxs)(t.p,{children:[(0,Q.jsx)(t.code,{children:`href`}),`가 있으면 링크, 클릭 핸들러가 있으면 버튼, 그 외에는 `,(0,Q.jsx)(t.code,{children:`article`}),` 루트를 사용합니다. 비활성 인터랙티브 Card는 동작을 막고 `,(0,Q.jsx)(t.code,{children:`aria-disabled`}),`와 `,(0,Q.jsx)(t.code,{children:`tabIndex=-1`}),`을 적용합니다. 미디어·제목 등에는 `,(0,Q.jsx)(t.code,{children:`role`}),`·`,(0,Q.jsx)(t.code,{children:`aria-label`}),`로 의미를 보완할 수 있습니다.`]}),`
`,(0,Q.jsx)(de,{sections:Ae})]})}function Ne(e={}){let{wrapper:t}={...ce(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(Me,{...e})}):Me(e)}var Q;function $(){return($=e((()=>{Q=t(),le(),ae(),se(),ue(),De(),je(),c()})))()}$();export{Ne as default};