...
`,(0,j.jsxs)(t.p,{children:[`숨김 파일 input은 트리거·드롭존·카드 레이블과 `,(0,j.jsx)(t.code,{children:`for`}),`/`,(0,j.jsx)(t.code,{children:`id`}),`로 연결합니다. 형식·크기·개수 검증 실패는 `,(0,j.jsx)(t.code,{children:`onError`}),`로 전달하고, 선택·삭제 후 목록을 갱신합니다. 서버에서도 파일 내용과 형식을 다시 검증해야 합니다.`]}),`
