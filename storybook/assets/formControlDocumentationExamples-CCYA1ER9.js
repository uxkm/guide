...
`).map(e=>`${n}${e}`).join(`
`)}function r(e,t){let r=t.react.includes(`<ButtonClearable`),i=t.react.includes(`<ImplicitInput`),a=t.react.includes(`<Button`)||r,s=t.react.includes(`<Icon`)||r,c=[r?`import { useId, useRef, useState } from 'react';`:``,`import Input from '@uxkm/react/input';`,a?`import Button from '@uxkm/react/button';`:``,s?`import Icon from '@uxkm/react/icon';`:``].filter(Boolean).join(`
`),l=[`import Input from '@uxkm/vue/input';`,t.vue.includes(`<Button`)?`import Button from '@uxkm/vue/button';`:``,t.vue.includes(`<Icon`)?`import Icon from '@uxkm/vue/icon';`:``].filter(Boolean).join(`
`),u=[r?te:``,i?ne:``].filter(Boolean).join(`

`),d=`${c}${u?`\n\n${u}`:``}\n\nexport function Example() {\n  return (\n${n(t.react,/^\s*<>/.test(t.react)?2:4)}\n  );\n}`,f=`<script setup>\n${l}\n<\/script>\n\n<template>\n${n(t.vue,2)}\n</template>`,p=t.html.replace(/<input(?![^>]*data-component=)/g,`<input data-component="Input"`),m=`${o}\n\n${ee[e]}`;return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/Input/Input.html · ${e}`,code:p},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/Input/input.njk · ${e}`,code:m},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/input · ${e}`,code:f},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/input · ${e}`,code:f},{id:`react`,label:`React`,fileName:`@uxkm/react/input · ${e}`,code:d},{id:`next`,label:`Next`,fileName:`@uxkm/react/input · ${e}`,code:d}]}var i,a,o,s,c,l,u,d,ee,te,ne,f;function p(){return(p=e((()=>{i=`<svg class="icon" data-component="Icon" data-icon="close" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"></path></svg>`,a=`<svg class="icon" data-component="Icon" data-icon="search" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="7"></circle><path d="m20 20-4-4"></path></svg>`,o=`{% from "components/form/Input/input.njk" import input, inputField, inputGroup, inputCollection %}`,s=(e,t,n,r=``)=>`<div class="form_field"><label class="form_field-label" for="${e}">${t}</label>${n}${r}</div>`,c=(e,t,n,r=``)=>`<div className="form_field"><label className="form_field-label" htmlFor="${e}">${t}</label>${n}${r}</div>`,l=(e,t,n,r=``)=>`<div class="form_field"><label class="form_field-label" for="${e}">${t}</label>${n}${r}</div>`,u=(e,t)=>`<label class="input_group-label_hidden" for="${e}">${t}</label>`,d={basic:{html:s(`input-name`,`이름`,t(`<input id="input-name" class="input" type="text" placeholder="이름을 입력하세요">`),`<p class="form_field-hint">2~20자 이내로 입력해 주세요.</p>`),react:c(`input-name`,`이름`,`<ButtonClearable id="input-name" placeholder="이름을 입력하세요" />`,`<p className="form_field-hint">2~20자 이내로 입력해 주세요.</p>`),vue:l(`input-name`,`이름`,`<Input id="input-name" clearable placeholder="이름을 입력하세요" />`,`<p class="form_field-hint">2~20자 이내로 입력해 주세요.</p>`)},standalone:{html:`<div class="input_field input_field_fit"><label class="form_field-label" for="input-search">검색어</label>${t(`<input id="input-search" class="input" type="text" placeholder="플레이스홀더">`)}</div>
...
${u(`standalone-search`,`검색`)}${t(`<input id="standalone-search" class="input" type="search" placeholder="검색어를 입력하세요">`,{prefix:a})}`,react:`<>
...
${u(`standalone-search`,`검색`)}<Input id="standalone-search" type="search" clearable placeholder="검색어를 입력하세요"><template #prefix><Icon name="search" /></template></Input>`},type:{html:[s(`input-type-text`,`텍스트`,t(`<input id="input-type-text" class="input" type="text" placeholder="텍스트">`)),s(`input-type-password`,`비밀번호`,t(`<input id="input-type-password" class="input" type="password" placeholder="비밀번호">`)),s(`input-type-email`,`이메일`,t(`<input id="input-type-email" class="input" type="email" placeholder="name@example.com">`)),s(`input-type-tel`,`전화번호`,t(`<input id="input-type-tel" class="input" type="tel" placeholder="전화번호">`)),s(`input-type-url`,`URL`,t(`<input id="input-type-url" class="input" type="url" placeholder="URL">`)),s(`input-type-search`,`검색`,t(`<input id="input-type-search" class="input" type="search" placeholder="검색">`)),s(`input-type-number`,`숫자`,`<input id="input-type-number" class="input" type="number" placeholder="숫자">`),s(`input-type-date`,`날짜`,`<input id="input-type-date" class="input" type="date" placeholder="날짜">`),s(`input-type-time`,`시간`,`<input id="input-type-time" class="input" type="time" placeholder="시간">`)].join(`
`),react:`<>
  ${c(`input-type-text`,`텍스트`,`<ButtonClearable id="input-type-text" type="text" placeholder="텍스트" />`)}
  ${c(`input-type-password`,`비밀번호`,`<ButtonClearable id="input-type-password" type="password" placeholder="비밀번호" />`)}
  ${c(`input-type-email`,`이메일`,`<ButtonClearable id="input-type-email" type="email" placeholder="name@example.com" />`)}
  ${c(`input-type-tel`,`전화번호`,`<ButtonClearable id="input-type-tel" type="tel" placeholder="전화번호" />`)}
  ${c(`input-type-url`,`URL`,`<ButtonClearable id="input-type-url" type="url" placeholder="URL" />`)}
  ${c(`input-type-search`,`검색`,`<ButtonClearable id="input-type-search" type="search" placeholder="검색" />`)}
  ...
  ${c(`input-type-time`,`시간`,`<Input id="input-type-time" type="time" placeholder="시간" />`)}
</>`,vue:`${l(`input-type-text`,`텍스트`,`<Input id="input-type-text" type="text" clearable placeholder="텍스트" />`)}
${l(`input-type-password`,`비밀번호`,`<Input id="input-type-password" type="password" clearable placeholder="비밀번호" />`)}
${l(`input-type-email`,`이메일`,`<Input id="input-type-email" type="email" clearable placeholder="name@example.com" />`)}
${l(`input-type-tel`,`전화번호`,`<Input id="input-type-tel" type="tel" clearable placeholder="전화번호" />`)}
${l(`input-type-url`,`URL`,`<Input id="input-type-url" type="url" clearable placeholder="URL" />`)}
${l(`input-type-search`,`검색`,`<Input id="input-type-search" type="search" clearable placeholder="검색" />`)}
${l(`input-type-number`,`숫자`,`<Input id="input-type-number" type="number" placeholder="숫자" />`)}
${l(`input-type-date`,`날짜`,`<Input id="input-type-date" type="date" placeholder="날짜" />`)}
${l(`input-type-time`,`시간`,`<Input id="input-type-time" type="time" placeholder="시간" />`)}`},kind:{html:`<div class="form_field"><p class="form_field-label" id="card-label">카드번호</p><div class="input_split" role="group" aria-labelledby="card-label">${[1,2,3,4].map(e=>`${e>1?`<span class="input_split_sep" aria-hidden="true">-</span>`:``}<label class="display_contents"><span class="input_group-label_hidden">카드번호 ${e}번째 묶음</span><input class="input" type="${e>2?`password`:`text`}" inputmode="numeric" maxlength="4" placeholder="0000"></label>`).join(``)}</div><p class="form_field-hint">뒤 8자리는 마스킹 처리할 수 있습니다.</p></div>
...
${s(`phone`,`휴대폰 번호`,`<div class="input_group"><span class="input_group-addon">+82</span><input id="phone" class="input" type="tel" placeholder="10-0000-0000"><button class="btn btn_outline color_primary btn_sm" type="button"><span class="btn_label">인증요청</span></button></div>`)}
${s(`amount`,`결제 금액`,t(`<input id="amount" class="input" type="text" inputmode="numeric" placeholder="0">`,{prefix:`₩`,suffix:`원`}))}`,react:`<>
  ...
  ${c(`phone`,`휴대폰 번호`,`<div className="input_group"><span className="input_group-addon">+82</span><Input id="phone" type="tel" placeholder="10-0000-0000" /><Button variant="outline" size="sm" label="인증요청" /></div>`)}
  ${c(`amount`,`결제 금액`,`<ButtonClearable id="amount" inputMode="numeric" placeholder="0" prefix="₩" suffix="원" />`)}
...
${l(`phone`,`휴대폰 번호`,`<div class="input_group"><span class="input_group-addon">+82</span><Input id="phone" type="tel" placeholder="10-0000-0000" /><Button variant="outline" size="sm" label="인증요청" /></div>`)}
${l(`amount`,`결제 금액`,`<Input id="amount" inputmode="numeric" clearable placeholder="0"><template #prefix>₩</template><template #suffix>원</template></Input>`)}`},size:{html:`${s(`input-sm`,`SM`,t(`<input id="input-sm" class="input input_sm" type="text" placeholder="input_sm">`))}
${s(`input-md`,`MD`,t(`<input id="input-md" class="input" type="text" placeholder="기본 크기">`))}
${s(`input-lg`,`LG`,t(`<input id="input-lg" class="input input_lg" type="text" placeholder="input_lg">`))}`,react:`<>
  ${c(`input-sm`,`SM`,`<ButtonClearable id="input-sm" size="sm" placeholder="input_sm" />`)}
  ${c(`input-md`,`MD`,`<ButtonClearable id="input-md" size="md" placeholder="기본 크기" />`)}
  ${c(`input-lg`,`LG`,`<ButtonClearable id="input-lg" size="lg" placeholder="input_lg" />`)}
</>`,vue:`${l(`input-sm`,`SM`,`<Input id="input-sm" size="sm" clearable placeholder="input_sm" />`)}
${l(`input-md`,`MD`,`<Input id="input-md" size="md" clearable placeholder="기본 크기" />`)}
${l(`input-lg`,`LG`,`<Input id="input-lg" size="lg" clearable placeholder="input_lg" />`)}`},width:{html:`${s(`input-full`,`전체 너비`,t(`<input id="input-full" class="input" type="text" placeholder="width: 100%">`))}
...
${u(`width-addon`,`아이디`)}${t(`<input id="width-addon" class="input" type="text" placeholder="애드온 그룹 최대 320px">`,{prefix:`@`,fit:!0})}`,react:`<>
  ${c(`input-full`,`전체 너비`,`<ButtonClearable id="input-full" placeholder="width: 100%" />`)}
...
</>`,vue:`${l(`input-full`,`전체 너비`,`<Input id="input-full" clearable placeholder="width: 100%" />`)}
...
${u(`width-addon`,`아이디`)}<Input id="width-addon" class="input_fit" clearable placeholder="애드온 그룹 최대 320px"><template #prefix>@</template></Input>`},group:{html:`${u(`group-domain`,`도메인`)}${t(`<input id="group-domain" class="input" type="text" placeholder="example.com">`,{prefix:`https://`})}
${u(`group-user`,`사용자명`)}${t(`<input id="group-user" class="input" type="text" placeholder="username">`,{prefix:`@`})}
${u(`group-amount`,`결제 금액`)}${t(`<input id="group-amount" class="input" type="text" inputmode="numeric" placeholder="0">`,{prefix:`₩`,suffix:`KRW`})}`,react:`<>
...
</>`,vue:`${u(`group-domain`,`도메인`)}<Input id="group-domain" clearable placeholder="example.com"><template #prefix>https://</template></Input>
${u(`group-user`,`사용자명`)}<Input id="group-user" clearable placeholder="username"><template #prefix>@</template></Input>
${u(`group-amount`,`결제 금액`)}<Input id="group-amount" clearable inputmode="numeric" placeholder="0"><template #prefix>₩</template><template #suffix>KRW</template></Input>`},required:{html:`<div class="form_field form_field_fit"><label class="form_field-label" for="required-email">이메일<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span></label>${t(`<input id="required-email" class="input" type="email" placeholder="name@example.com" required aria-required="true">`)}<p class="form_field-hint">업무용 이메일을 입력해 주세요.</p></div>`,react:`<div className="form_field form_field_fit"><label className="form_field-label" htmlFor="required-email">이메일<span className="form_field-required"><span aria-hidden="true">*</span><span className="form_field-required-text">필수 항목</span></span></label><ButtonClearable id="required-email" type="email" placeholder="name@example.com" required aria-required="true" /><p className="form_field-hint">업무용 이메일을 입력해 주세요.</p></div>`,vue:`<div class="form_field form_field_fit"><label class="form_field-label" for="required-email">이메일<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span></label><Input id="required-email" type="email" clearable placeholder="name@example.com" required aria-required="true" /><p class="form_field-hint">업무용 이메일을 입력해 주세요.</p></div>`},state:{html:`${s(`state-default`,`기본`,t(`<input id="state-default" class="input" type="text" placeholder="입력 가능">`))}
${s(`state-disabled`,`비활성`,t(`<input id="state-disabled" class="input" type="text" value="수정할 수 없음" disabled>`,{value:`수정할 수 없음`,inactive:!0}))}
${s(`state-readonly`,`읽기 전용`,t(`<input id="state-readonly" class="input" type="text" value="읽기만 가능" readonly>`,{value:`읽기만 가능`,inactive:!0}))}
${s(`state-error`,`에러`,t(`<input id="state-error" class="input is-error" type="text" value="invalid-email" aria-invalid="true" aria-describedby="state-error-message">`,{value:`invalid-email`}),`<p class="form_field-error" id="state-error-message" role="alert">올바른 이메일 형식이 아닙니다.</p>`)}
${s(`state-success`,`성공`,t(`<input id="state-success" class="input is-success" type="text" value="uxkm_user" aria-describedby="state-success-message">`,{value:`uxkm_user`}),`<p class="form_field-success" id="state-success-message" role="status">사용 가능한 아이디입니다.</p>`)}`,react:`<>
  ${c(`state-default`,`기본`,`<ButtonClearable id="state-default" placeholder="입력 가능" />`)}
  ${c(`state-disabled`,`비활성`,`<ButtonClearable id="state-disabled" defaultValue="수정할 수 없음" disabled />`)}
  ${c(`state-readonly`,`읽기 전용`,`<ButtonClearable id="state-readonly" defaultValue="읽기만 가능" readOnly />`)}
  ${c(`state-error`,`에러`,`<ButtonClearable id="state-error" error defaultValue="invalid-email" aria-describedby="state-error-message" />`,`<p className="form_field-error" id="state-error-message" role="alert">올바른 이메일 형식이 아닙니다.</p>`)}
  ${c(`state-success`,`성공`,`<ButtonClearable id="state-success" className="is-success" defaultValue="uxkm_user" aria-describedby="state-success-message" />`,`<p className="form_field-success" id="state-success-message" role="status">사용 가능한 아이디입니다.</p>`)}
</>`,vue:`${l(`state-default`,`기본`,`<Input id="state-default" clearable placeholder="입력 가능" />`)}
${l(`state-disabled`,`비활성`,`<Input id="state-disabled" clearable model-value="수정할 수 없음" disabled />`)}
${l(`state-readonly`,`읽기 전용`,`<Input id="state-readonly" clearable model-value="읽기만 가능" readonly />`)}
${l(`state-error`,`에러`,`<Input id="state-error" clearable error model-value="invalid-email" aria-describedby="state-error-message" />`,`<p class="form_field-error" id="state-error-message" role="alert">올바른 이메일 형식이 아닙니다.</p>`)}
${l(`state-success`,`성공`,`<Input id="state-success" clearable class="is-success" model-value="uxkm_user" aria-describedby="state-success-message" />`,`<p class="form_field-success" id="state-success-message" role="status">사용 가능한 아이디입니다.</p>`)}`},clearable:{html:`${u(`clear-text`,`텍스트`)}${t(`<input id="clear-text" class="input" type="text" value="지울 수 있는 값">`,{value:`지울 수 있는 값`})}
${u(`clear-search`,`검색`)}${t(`<input id="clear-search" class="input" type="search" value="검색어">`,{value:`검색어`,prefix:a})}
${u(`clear-readonly`,`읽기 전용`)}${t(`<input id="clear-readonly" class="input" type="text" value="수정 불가" readonly>`,{value:`수정 불가`,inactive:!0})}`,react:`<>
...
</>`,vue:`${u(`clear-text`,`텍스트`)}<Input id="clear-text" clearable model-value="지울 수 있는 값" />
${u(`clear-search`,`검색`)}<Input id="clear-search" type="search" clearable model-value="검색어"><template #prefix><Icon name="search" /></template></Input>
${u(`clear-readonly`,`읽기 전용`)}<Input id="clear-readonly" clearable model-value="수정 불가" readonly />`},example:{html:`<form class="form form_vertical form_fit form_compact"><div class="alert color_danger" role="alert"><strong>입력 내용을 확인해 주세요</strong></div>${s(`login-id`,`아이디`,t(`<input id="login-id" class="input is-success" type="text" value="uxkm_user" aria-invalid="false" aria-describedby="login-id-success">`,{value:`uxkm_user`}),`<p id="login-id-success" class="form_field-success" role="status">사용 가능한 아이디입니다.</p>`)}${s(`login-password`,`비밀번호`,t(`<input id="login-password" class="input is-error input_masked" type="password" value="1234" aria-invalid="true" aria-describedby="login-password-error">`,{value:`1234`}),`<p id="login-password-error" class="form_field-error" role="alert">8자 이상 입력해 주세요.</p>`)}<div class="form_actions"><button class="btn btn_filled color_primary" type="submit"><span class="btn_label">로그인</span></button><button class="btn btn_ghost" type="button"><span class="btn_label">취소</span></button></div></form>`,react:`<form className="form form_vertical form_fit form_compact" onSubmit={(event) => event.preventDefault()}>
  <div className="alert color_danger" role="alert"><strong>입력 내용을 확인해 주세요</strong></div>
  ${c(`login-id`,`아이디`,`<ButtonClearable id="login-id" className="is-success" defaultValue="uxkm_user" aria-invalid="false" aria-describedby="login-id-success" />`,`<p id="login-id-success" className="form_field-success" role="status">사용 가능한 아이디입니다.</p>`)}
  ${c(`login-password`,`비밀번호`,`<ButtonClearable id="login-password" type="password" error defaultValue="1234" aria-describedby="login-password-error" />`,`<p id="login-password-error" className="form_field-error" role="alert">8자 이상 입력해 주세요.</p>`)}
  ...
  ${l(`login-id`,`아이디`,`<Input id="login-id" clearable class="is-success" model-value="uxkm_user" aria-invalid="false" aria-describedby="login-id-success" />`,`<p id="login-id-success" class="form_field-success" role="status">사용 가능한 아이디입니다.</p>`)}
  ${l(`login-password`,`비밀번호`,`<Input id="login-password" type="password" clearable error model-value="1234" aria-describedby="login-password-error" />`,`<p id="login-password-error" class="form_field-error" role="alert">8자 이상 입력해 주세요.</p>`)}
  <div class="form_actions"><Button type="submit" label="로그인" /><Button variant="ghost" label="취소" /></div>
</form>`}},ee={basic:`{% set control %}{{ input(id='input-name', placeholder='이름을 입력하세요', clearable=true) }}{% endset %}
{{ inputField(id='input-name', label='이름', control=control, hint='2~20자 이내로 입력해 주세요.') }}`,standalone:`{% from "components/basic/Icon/icon.njk" import icon %}
{% set fields = [
...
{{ inputField(id='standalone-search', ariaLabel='검색', control=search) }}`,type:`{% set fields = [
...
{% endfor %}`,kind:`{% from "components/basic/Button/button.njk" import button %}
...
{{ inputField(id='amount', label='결제 금액', control=amount) }}`,size:`{% set sizes = [
...
{% endfor %}`,width:`{% set full %}{{ input(id='input-full', placeholder='width: 100%', clearable=true) }}{% endset %}
...
{{ inputField(id='width-addon', ariaLabel='아이디', control=addon) }}`,group:`{% set groups = [
...
{% endfor %}`,required:`{% set control %}{{ input(id='required-email', type='email', placeholder='name@example.com', required=true, clearable=true) }}{% endset %}
{{ inputField(id='required-email', label='이메일', control=control, required=true, fit=true, hint='업무용 이메일을 입력해 주세요.') }}`,state:`{% set states = [
...
{% endfor %}`,clearable:`{% from "components/basic/Icon/icon.njk" import icon %}
{% set searchIcon %}{{ icon(name='search') }}{% endset %}
{% set fields = [
...
{% endfor %}`,example:`{% from "components/basic/Button/button.njk" import button %}
<form class="form form_vertical form_fit form_compact">
  ...
  <div class="form_actions">{{ button(type='submit', label='로그인') }}{{ button(variant='ghost', label='취소') }}</div>
</form>`},te=`function ButtonClearable({ defaultValue = '', prefix, suffix, wrapperClassName = '', label, ...props }) {
...
}`,ne=`function ImplicitInput({ label, ...props }) {
  return <label className="display_contents"><span className="input_group-label_hidden">{label}</span><Input {...props} /></label>;
}`,f=Object.fromEntries(Object.entries(d).map(([e,t])=>[e,r(e,t)]))})))()}function m(e,t){let n=` `.repeat(t);return e.split(`
`).map(e=>`${n}${e}`).join(`
`)}function re(e,t){let n=t.react.includes(`<ImplicitSelect`),r=t.react.includes(`setRegion`),i=`${r?`import { useState } from 'react';
...
function ImplicitSelect({ label, ...props }) {
  ...
  const [region, setRegion] = useState('');`:``}\n  return (\n${m(t.react,/^\s*<>/.test(t.react)?2:4)}\n  );\n}`,a=`<script setup>\n${t.vue.includes(`v-model`)?`import { ref } from 'vue';
`:``}import Select from '@uxkm/vue/select';${t.vue.includes(`v-model`)?`
const region = ref('');`:``}\n<\/script>\n\n<template>\n${m(t.vue,2)}\n</template>`,o=t.html.replace(/<select(?![^>]*data-component=)/g,`<select data-component="Select"`);return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/Select/Select.html · ${e}`,code:o},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/Select/select.njk · ${e}`,code:`${ie}\n\n${oe[e]}`},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/select · ${e}`,code:a},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/select · ${e}`,code:a},{id:`react`,label:`React`,fileName:`@uxkm/react/select · ${e}`,code:i},{id:`next`,label:`Next`,fileName:`@uxkm/react/select · ${e}`,code:i}]}var ie,h,g,_,v,y,ae,oe,se;function ce(){return(ce=e((()=>{ie=`{% from "components/form/Select/select.njk" import select, selectField %}`,h=`<option value="seoul">서울</option><option value="busan">부산</option><option value="jeju">제주</option>`,g=`<option value="seoul">서울</option><option value="busan">부산</option><option value="jeju">제주</option>`,_=(e,t,n,r=``)=>`<div class="form_field"><label class="form_field-label" for="${e}">${t}</label>${n}${r}</div>`,v=(e,t,n,r=``)=>`<div className="form_field"><label className="form_field-label" htmlFor="${e}">${t}</label>${n}${r}</div>`,y=(e,t,n,r=``)=>`<div class="form_field"><label class="form_field-label" for="${e}">${t}</label>${n}${r}</div>`,ae={basic:{html:_(`select-region`,`지역`,`<select id="select-region" class="input input_fit" required><option value="" disabled selected>지역을 선택하세요</option>${h}</select>`,`<p class="form_field-hint">거주 지역을 선택해 주세요.</p>`),react:v(`select-region`,`지역`,`<Select id="select-region" fit required placeholder="지역을 선택하세요">${g}</Select>`,`<p className="form_field-hint">거주 지역을 선택해 주세요.</p>`),vue:y(`select-region`,`지역`,`<Select id="select-region" fit required placeholder="지역을 선택하세요">${h}</Select>`,`<p class="form_field-hint">거주 지역을 선택해 주세요.</p>`)},standalone:{html:`<div class="input_field input_field_fit"><label class="form_field-label" for="select-language">언어</label><select id="select-language" class="input"><option value="ko">한국어</option><option value="en">English</option></select></div>
...
{{ selectField(id='select-sort', ariaLabel='정렬 기준', control=sort) }}`,size:`{% set options = [
  { value: 'seoul', label: '서울' },
  { value: 'busan', label: '부산' },
  { value: 'jeju', label: '제주' }
] %}
...
{{ selectField(id='select-fit', label='제한 너비', control=limited, fit=true) }}`,group:`{% set groups = [
  { label: '제품', options: [
...
{{ selectField(id='select-team', label='소속 팀', control=control) }}`,multiple:`{% set options = [
...
{{ selectField(id='select-skills', label='관심 분야', control=control, hint='여러 항목을 선택할 수 있습니다.') }}`,required:`{% set options = [
...
{{ selectField(id='select-required', label='문의 유형', control=control, required=true, fit=true) }}`,state:`{% set options = [
  { value: 'seoul', label: '서울' },
  { value: 'busan', label: '부산' },
  { value: 'jeju', label: '제주' }
] %}
...
{{ selectField(id='select-error', label='에러', control=errorSelect, errorMessage='지역을 선택해 주세요.') }}`,example:`{% from "components/basic/Button/button.njk" import button %}
{% set options = [
  { value: 'seoul', label: '서울' },
  { value: 'busan', label: '부산' },
  { value: 'jeju', label: '제주' }
...
</form>`},se=Object.fromEntries(Object.entries(ae).map(([e,t])=>[e,re(e,t)]))})))()}function le(e,t){let n=` `.repeat(t);return e.split(`
`).map(e=>`${n}${e}`).join(`
`)}function ue(e,t){let n=`import Textarea from '@uxkm/react/textarea';${t.react.includes(`<ImplicitTextarea`)?`
...
}`:``}\n\nexport function Example() {\n  return (\n${le(t.react,/^\s*<>/.test(t.react)?2:4)}\n  );\n}`,r=`<script setup>\nimport Textarea from '@uxkm/vue/textarea';\n<\/script>\n\n<template>\n${le(t.vue,2)}\n</template>`,i=t.html.replace(/<textarea(?![^>]*data-component=)/g,`<textarea data-component="Textarea"`);return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/Textarea/Textarea.html · ${e}`,code:i},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/Textarea/textarea.njk · ${e}`,code:`${fe}\n\n${pe[e]}`},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/textarea · ${e}`,code:r},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/textarea · ${e}`,code:r},{id:`react`,label:`React`,fileName:`@uxkm/react/textarea · ${e}`,code:n},{id:`next`,label:`Next`,fileName:`@uxkm/react/textarea · ${e}`,code:n}]}var de,fe,b,x,S,C,pe,w,me,he;function ge(){return(ge=e((()=>{de=`<svg class="icon" data-component="Icon" data-icon="close" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"></path></svg>`,fe=`{% from "components/form/Textarea/textarea.njk" import textarea, textareaField %}`,b=(e,t,n,r=``)=>`<div class="form_field"><label class="form_field-label" for="${e}">${t}</label>${n}${r}</div>`,x=(e,t,n,r=``)=>`<div className="form_field"><label className="form_field-label" htmlFor="${e}">${t}</label>${n}${r}</div>`,S=(e,t,n,r=``)=>`<div class="form_field"><label class="form_field-label" for="${e}">${t}</label>${n}${r}</div>`,C=(e,t={})=>{let n=t.value??``,r=t.max??200;return`<div class="textarea_wrap textarea_show-count"><textarea id="${e}" class="${[`textarea`,t.size&&t.size!==`md`&&`textarea_${t.size}`,t.resize&&`textarea_resize_${t.resize}`,t.error&&`is-error`].filter(Boolean).join(` `)}" rows="${t.rows??4}" maxlength="${r}" aria-describedby="${e}-count"${t.error?` aria-invalid="true"`:``}>${n}</textarea><span id="${e}-count" class="textarea_count" role="status" aria-live="polite" aria-atomic="true"><span class="textarea_count_visual" aria-hidden="true">${n.length}/${r}</span><span class="textarea_count_announcer">${n.length}자 입력, 최대 ${r}자</span></span></div>`},pe={basic:`{% set control %}{{ textarea(id='textarea-message', rows=4, placeholder='메시지를 입력하세요') }}{% endset %}
{{ textareaField(id='textarea-message', label='메시지', control=control, hint='문의 내용을 자세히 작성해 주세요.') }}`,standalone:`{% set note %}{{ textarea(id='textarea-note', rows=3, placeholder='메모를 입력하세요') }}{% endset %}
...
{{ textareaField(id='textarea-request', ariaLabel='추가 요청사항', control=request) }}`,size:`{% set sizes = ['sm', 'md', 'lg'] %}
{% for size in sizes %}
...
{% endfor %}`,width:`{% set full %}{{ textarea(id='textarea-full', rows=3) }}{% endset %}
{{ textareaField(id='textarea-full', label='전체 너비', control=full) }}

{% set limited %}{{ textarea(id='textarea-fit', rows=3, fit=true) }}{% endset %}
{{ textareaField(id='textarea-fit', label='제한 너비', control=limited, fit=true) }}`,resize:`{% set directions = ['none', 'vertical', 'horizontal', 'both'] %}
...
{% endfor %}`,required:`{% set control %}{{ textarea(id='textarea-required', rows=4, required=true) }}{% endset %}
{{ textareaField(
...
{% endfor %}`,count:`{% set control %}{{ textarea(id='textarea-count', rows=5, maxLength=200, showCount=true, ariaDescribedby='textarea-count-hint') }}{% endset %}
{{ textareaField(id='textarea-count', label='자기소개', control=control, hint='200자 이내로 작성해 주세요.') }}`,clearable:`{% set fields = [
...
</form>`},w=(e,t={})=>{let n=t.value??``,r=n&&!t.inactive?` is-filled`:``,i=t.max,a=i==null?``:`<span id="${e}-count" class="textarea_count" role="status" aria-live="polite" aria-atomic="true"><span class="textarea_count_visual" aria-hidden="true">${n.length}/${i}</span><span class="textarea_count_announcer">${n.length}자 입력, 최대 ${i}자</span></span>`,o=[`textarea_wrap`,`textarea_clearable`,i!=null&&`textarea_show-count`,r].filter(Boolean).join(` `),s=i==null?``:` aria-describedby="${e}-count"`,c=n&&!t.inactive?``:` hidden`;return`<div class="${o}"><textarea id="${e}" class="textarea" rows="${t.rows??4}"${i==null?``:` maxlength="${i}"`}${s}${t.inactive?` readonly`:``}>${n}</textarea><button type="button" class="textarea_clear" data-ripple="surface" aria-label="입력 지우기"${c}>${de}</button>${a}</div>`},me={basic:{html:b(`textarea-message`,`메시지`,`<textarea id="textarea-message" class="textarea textarea_resize_none" rows="4" placeholder="메시지를 입력하세요"></textarea>`,`<p class="form_field-hint">문의 내용을 자세히 작성해 주세요.</p>`),react:x(`textarea-message`,`메시지`,`<Textarea id="textarea-message" rows={4} placeholder="메시지를 입력하세요" />`,`<p className="form_field-hint">문의 내용을 자세히 작성해 주세요.</p>`),vue:S(`textarea-message`,`메시지`,`<Textarea id="textarea-message" :rows="4" placeholder="메시지를 입력하세요" />`,`<p class="form_field-hint">문의 내용을 자세히 작성해 주세요.</p>`)},standalone:{html:`<div class="input_field input_field_fit"><label class="form_field-label" for="textarea-note">메모</label><textarea id="textarea-note" class="textarea" rows="3" placeholder="메모를 입력하세요"></textarea></div>
...
<label class="display_contents"><span class="input_group-label_hidden">추가 요청사항</span><Textarea :rows="3" placeholder="추가 요청사항" /></label>`},size:{html:[`sm`,`md`,`lg`].map(e=>b(`textarea-${e}`,e.toUpperCase(),`<textarea id="textarea-${e}" class="textarea${e===`md`?``:` textarea_${e}`}" rows="3"></textarea>`)).join(`
`),react:"<>{['sm', 'md', 'lg'].map((size) => <div className=\"form_field\" key={size}><label className=\"form_field-label\" htmlFor={`textarea-${size}`}>{size.toUpperCase()}</label><Textarea id={`textarea-${size}`} size={size} rows={3} /></div>)}</>",vue:`<div v-for="size in ['sm', 'md', 'lg']" :key="size" class="form_field"><label class="form_field-label" :for="\`textarea-\${size}\`">{{ size.toUpperCase() }}</label><Textarea :id="\`textarea-\${size}\`" :size="size" :rows="3" /></div>`},width:{html:`${b(`textarea-full`,`전체 너비`,`<textarea id="textarea-full" class="textarea" rows="3"></textarea>`)}<div class="form_field form_field_fit"><label class="form_field-label" for="textarea-fit">제한 너비</label><textarea id="textarea-fit" class="textarea" rows="3"></textarea></div>`,react:`<>
  ${x(`textarea-full`,`전체 너비`,`<Textarea id="textarea-full" rows={3} />`)}
...
</>`,vue:`${S(`textarea-full`,`전체 너비`,`<Textarea id="textarea-full" :rows="3" />`)}<div class="form_field form_field_fit"><label class="form_field-label" for="textarea-fit">제한 너비</label><Textarea id="textarea-fit" :rows="3" /></div>`},resize:{html:[`none`,`vertical`,`horizontal`,`both`].map(e=>b(`textarea-resize-${e}`,e,`<textarea id="textarea-resize-${e}" class="textarea textarea_resize_${e}" rows="3"></textarea>`)).join(`
`),react:"<>{['none', 'vertical', 'horizontal', 'both'].map((resize) => <div className=\"form_field\" key={resize}><label className=\"form_field-label\" htmlFor={`textarea-resize-${resize}`}>{resize}</label><Textarea id={`textarea-resize-${resize}`} resize={resize} rows={3} /></div>)}</>",vue:`<div v-for="resize in ['none', 'vertical', 'horizontal', 'both']" :key="resize" class="form_field"><label class="form_field-label" :for="\`textarea-resize-\${resize}\`">{{ resize }}</label><Textarea :id="\`textarea-resize-\${resize}\`" :resize="resize" :rows="3" /></div>`},required:{html:`<div class="form_field form_field_fit"><label class="form_field-label" for="textarea-required">문의 내용<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span></label><textarea id="textarea-required" class="textarea" rows="4" required aria-required="true"></textarea><p class="form_field-hint">답변에 필요한 내용을 작성해 주세요.</p></div>`,react:`<div className="form_field form_field_fit"><label className="form_field-label" htmlFor="textarea-required">문의 내용<span className="form_field-required"><span aria-hidden="true">*</span><span className="form_field-required-text">필수 항목</span></span></label><Textarea id="textarea-required" rows={4} required aria-required="true" /><p className="form_field-hint">답변에 필요한 내용을 작성해 주세요.</p></div>`,vue:`<div class="form_field form_field_fit"><label class="form_field-label" for="textarea-required">문의 내용<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span></label><Textarea id="textarea-required" :rows="4" required aria-required="true" /><p class="form_field-hint">답변에 필요한 내용을 작성해 주세요.</p></div>`},state:{html:`${b(`textarea-disabled`,`비활성`,`<textarea id="textarea-disabled" class="textarea" rows="3" disabled>수정할 수 없음</textarea>`)}${b(`textarea-readonly`,`읽기 전용`,`<textarea id="textarea-readonly" class="textarea" rows="3" readonly>읽기만 가능</textarea>`)}${b(`textarea-error`,`에러`,`<textarea id="textarea-error" class="textarea is-error" rows="3" aria-invalid="true" aria-describedby="textarea-error-message">너무 짧은 내용</textarea>`,`<p id="textarea-error-message" class="form_field-error" role="alert">10자 이상 입력해 주세요.</p>`)}`,react:`<>
  ${x(`textarea-disabled`,`비활성`,`<Textarea id="textarea-disabled" rows={3} defaultValue="수정할 수 없음" disabled />`)}
  ${x(`textarea-readonly`,`읽기 전용`,`<Textarea id="textarea-readonly" rows={3} defaultValue="읽기만 가능" readOnly />`)}
  ${x(`textarea-error`,`에러`,`<Textarea id="textarea-error" rows={3} error defaultValue="너무 짧은 내용" aria-describedby="textarea-error-message" />`,`<p id="textarea-error-message" className="form_field-error" role="alert">10자 이상 입력해 주세요.</p>`)}
</>`,vue:`${S(`textarea-disabled`,`비활성`,`<Textarea id="textarea-disabled" :rows="3" model-value="수정할 수 없음" disabled />`)}${S(`textarea-readonly`,`읽기 전용`,`<Textarea id="textarea-readonly" :rows="3" model-value="읽기만 가능" readonly />`)}${S(`textarea-error`,`에러`,`<Textarea id="textarea-error" :rows="3" error model-value="너무 짧은 내용" aria-describedby="textarea-error-message" />`,`<p id="textarea-error-message" class="form_field-error" role="alert">10자 이상 입력해 주세요.</p>`)}`},count:{html:b(`textarea-count`,`자기소개`,C(`textarea-count`,{rows:5}),`<p class="form_field-hint">200자 이내로 작성해 주세요.</p>`),react:x(`textarea-count`,`자기소개`,`<Textarea id="textarea-count" rows={5} maxLength={200} showCount />`,`<p className="form_field-hint">200자 이내로 작성해 주세요.</p>`),vue:S(`textarea-count`,`자기소개`,`<Textarea id="textarea-count" :rows="5" :max-length="200" show-count />`,`<p class="form_field-hint">200자 이내로 작성해 주세요.</p>`)},clearable:{html:`${b(`textarea-clear`,`메모`,w(`textarea-clear`,{value:`지울 수 있는 내용`}))}${b(`textarea-clear-count`,`자기소개`,w(`textarea-clear-count`,{value:`글자 수와 지우기를 함께 사용합니다.`,max:200}))}${b(`textarea-clear-readonly`,`읽기 전용`,w(`textarea-clear-readonly`,{value:`수정 불가`,inactive:!0,rows:3}))}`,react:`<>
  ${x(`textarea-clear`,`메모`,`<Textarea id="textarea-clear" rows={4} clearable defaultValue="지울 수 있는 내용" />`)}
  ${x(`textarea-clear-count`,`자기소개`,`<Textarea id="textarea-clear-count" rows={4} clearable showCount maxLength={200} defaultValue="글자 수와 지우기를 함께 사용합니다." />`)}
  ${x(`textarea-clear-readonly`,`읽기 전용`,`<Textarea id="textarea-clear-readonly" rows={3} clearable readOnly defaultValue="수정 불가" />`)}
</>`,vue:`${S(`textarea-clear`,`메모`,`<Textarea id="textarea-clear" :rows="4" clearable model-value="지울 수 있는 내용" />`)}${S(`textarea-clear-count`,`자기소개`,`<Textarea id="textarea-clear-count" :rows="4" clearable show-count :max-length="200" model-value="글자 수와 지우기를 함께 사용합니다." />`)}${S(`textarea-clear-readonly`,`읽기 전용`,`<Textarea id="textarea-clear-readonly" :rows="3" clearable model-value="수정 불가" readonly />`)}`},example:{html:`<form class="form form_vertical form_fit form_compact">${b(`review`,`후기`,C(`review`,{value:`좋아요`,max:300,rows:6,error:!0}).replace(`aria-describedby="review-count"`,`aria-describedby="review-error review-count"`),`<p id="review-error" class="form_field-error" role="alert">후기를 10자 이상 작성해 주세요.</p>`)}<div class="form_actions"><button class="btn btn_filled color_primary" type="submit"><span class="btn_label">등록</span></button><button class="btn btn_ghost" type="button"><span class="btn_label">취소</span></button></div></form>`,react:`<form className="form form_vertical form_fit form_compact" onSubmit={(event) => event.preventDefault()}>${x(`review`,`후기`,`<Textarea id="review" rows={6} showCount maxLength={300} error defaultValue="좋아요" required aria-describedby="review-error" />`,`<p id="review-error" className="form_field-error" role="alert">후기를 10자 이상 작성해 주세요.</p>`)}<div className="form_actions"><button className="btn btn_filled color_primary" type="submit"><span className="btn_label">등록</span></button></div></form>`,vue:`<form class="form form_vertical form_fit form_compact" @submit.prevent>${S(`review`,`후기`,`<Textarea id="review" :rows="6" show-count :max-length="300" error model-value="좋아요" required aria-describedby="review-error" />`,`<p id="review-error" class="form_field-error" role="alert">후기를 10자 이상 작성해 주세요.</p>`)}<div class="form_actions"><button class="btn btn_filled color_primary" type="submit"><span class="btn_label">등록</span></button></div></form>`}},he=Object.fromEntries(Object.entries(me).map(([e,t])=>[e,ue(e,t)]))})))()}function _e(e,t){let n=ye[e];return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/Checkbox/Checkbox.html · ${e}`,code:t.html},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/Checkbox/checkbox.njk · ${e}`,code:n},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/checkbox · ${e}`,code:t.vue},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/checkbox · ${e}`,code:t.vue},{id:`react`,label:`React`,fileName:`@uxkm/react/checkbox · ${e}`,code:t.react},{id:`next`,label:`Next`,fileName:`@uxkm/react/checkbox · ${e}`,code:t.react}]}var ve,T,E,ye,be;function xe(){return(xe=e((()=>{ve={type:{html:`<div class="checkbox" data-ripple="true">
...
</template>`}},T=`{% from "components/form/Checkbox/checkbox.njk" import checkbox, checkboxGroup, checkboxField %}`,E=`{% from "components/data-display/Card/card.njk" import card, cardBody, cardDeck %}`,ye={type:`${T}
${E}
...
{{ checkbox(id='checkbox-large-end', label='Large — checkbox_lg', labelEnd=true, checked=true, className='checkbox_lg') }}`,basic:`${T}
...
{{ checkbox(id='checkbox-lg', label='Large — checkbox_lg', checked=true, className='checkbox_lg') }}`,width:`${T}
...
{{ checkbox(id='checkbox-checked-disabled', label='선택됨 (비활성)', checked=true, disabled=true) }}`,group:`${T}
...
<form class="form form_horizontal form_fit">
  {% call checkboxField(label='권한', labelId='checkbox-form-horizontal-label') %}
    ...
    {% endcall %}
  {% endcall %}
</form>`},be=Object.fromEntries(Object.entries(ve).map(([e,t])=>[e,_e(e,t)]))})))()}function Se(e,t){let n=O[e];return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/Radio/Radio.html · ${e}`,code:t.html},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/Radio/radio.njk · ${e}`,code:n},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/radio · ${e}`,code:t.vue},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/radio · ${e}`,code:t.vue},{id:`react`,label:`React`,fileName:`@uxkm/react/radio · ${e}`,code:t.react},{id:`next`,label:`Next`,fileName:`@uxkm/react/radio · ${e}`,code:t.react}]}var Ce,D,O,k;function A(){return(A=e((()=>{Ce={type:{html:`<div class="radio" data-ripple="true">
...
</template>`}},D=`{% from "components/form/Radio/radio.njk" import radio, radioGroup, radioField %}`,O={type:`${D}
...
{{ radio(id='radio-large-end', name='radio-size-large', label='Large — radio_lg', labelEnd=true, checked=true, className='radio_lg') }}`,basic:`${D}
...
{{ radio(id='radio-checked-disabled', name='radio-disabled-state', label='선택됨 (비활성)', checked=true, disabled=true) }}`,group:`${D}
...
{% endcall %}`,cardType:`${D}
{% from "components/data-display/Card/card.njk" import card, cardBody, cardDeck %}
...
<form class="form form_horizontal form_fit">
  {% call radioField(label='역할', labelId='radio-form-horizontal-label') %}
    ...
    {% endcall %}
  {% endcall %}
</form>`},k=Object.fromEntries(Object.entries(Ce).map(([e,t])=>[e,Se(e,t)]))})))()}function we(e,t){let n=Ee[e];return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/Switch/Switch.html · ${e}`,code:t.html},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/Switch/switch.njk · ${e}`,code:n},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/switch · ${e}`,code:t.vue},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/switch · ${e}`,code:t.vue},{id:`react`,label:`React`,fileName:`@uxkm/react/switch · ${e}`,code:t.react},{id:`next`,label:`Next`,fileName:`@uxkm/react/switch · ${e}`,code:t.react}]}var Te,j,Ee,De;function Oe(){return(Oe=e((()=>{Te={type:{html:`<label class="switch" data-ripple="true">
...
</template>`}},j=`{% from "components/form/Switch/switch.njk" import switch, switchGroup, switchField %}`,Ee={type:`${j}

{{ switch(id='switch-default', label='기본 — switch', checked=true) }}
{{ switch(id='switch-label-end', label='레이블 뒤 — switch_label-end', labelEnd=true) }}`,labelEnd:`${j}
...
{{ switch(id='switch-on-disabled', label='켜짐 (비활성)', checked=true, disabled=true) }}`,group:`${j}
...
<form class="form form_horizontal form_fit">
  ...
  {% endcall %}
</form>`},De=Object.fromEntries(Object.entries(Te).map(([e,t])=>[e,we(e,t)]))})))()}function ke(e,t){let n=je[e];return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/Slider/Slider.html · ${e}`,code:t.html},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/Slider/slider.njk · ${e}`,code:n},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/slider · ${e}`,code:t.vue},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/slider · ${e}`,code:t.vue},{id:`react`,label:`React`,fileName:`@uxkm/react/slider · ${e}`,code:t.react},{id:`next`,label:`Next`,fileName:`@uxkm/react/slider · ${e}`,code:t.react}]}var Ae,M,je,Me;function Ne(){return(Ne=e((()=>{Ae={type:{html:`<div class="slider slider_fit" data-component="Slider" data-ripple="true">
...
</template>`}},M=`{% from "components/form/Slider/slider.njk" import slider, sliderField %}`,je={type:`${M}

{{ slider(id='slider-horizontal', value=40, ariaLabel='가로 슬라이더') }}
{{ slider(id='slider-vertical', value=60, vertical=true, ariaLabel='세로 슬라이더', style='height: 180px;') }}`,basic:`${M}

{{ slider(id='slider-volume', label='볼륨', value=50, showValue=true, valueSuffix='%') }}`,label:`${M}

{{ slider(id='slider-brightness', label='밝기', value=70, showValue=true, valueSuffix='%') }}
{{ slider(id='slider-temperature', label='온도', min=16, max=30, value=22, showValue=true, valueSuffix='°C', hint='16°C부터 30°C까지 설정할 수 있습니다.') }}`,size:`${M}

{{ slider(id='slider-sm', value=30, size='sm', ariaLabel='작은 슬라이더') }}
{{ slider(id='slider-md', value=50, ariaLabel='중간 슬라이더') }}
{{ slider(id='slider-lg', value=70, size='lg', ariaLabel='큰 슬라이더') }}`,width:`${M}

{{ slider(id='slider-fit', label='Fit', value=35, fit=true) }}
{{ slider(id='slider-block', label='Block', value=65, block=true) }}`,step:`${M}
...
{{ slider(id='slider-disabled-stepper', label='비활성', value=50, stepper=true, disabled=true) }}`,color:`${M}
...
{{ slider(id='slider-disabled', label='비활성', value=50, disabled=true) }}`,form:`${M}
...
/>`},avatar:{html:`<div class="upload" data-component="Upload"><label class="upload_avatar" for="upload-avatar">${P(`upload-avatar`,` accept="image/*"`)}<span class="avatar avatar_xl"><img class="avatar_image" src="/images/samples/avatar/avatar-sample.svg" alt="프로필 사진"></span><span class="upload_avatar-overlay" aria-hidden="true"><svg class="icon icon_lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path><path d="m16 6-4-4-4 4M12 2v13"></path></svg></span></label></div>`,react:`<Upload variant="avatar" accept="image/*" avatarSrc="/images/samples/avatar/avatar-sample.svg" avatarAlt="프로필 사진" />`,vue:`<Upload variant="avatar" accept="image/*" avatar-src="/images/samples/avatar/avatar-sample.svg" avatar-alt="프로필 사진" />`},size:{html:[`sm`,`md`,`lg`].map(e=>`<div class="upload${e===`md`?``:` upload_${e}`}" data-component="Upload"><label class="upload_dropzone" for="upload-${e}">${P(`upload-${e}`)}<span class="upload_dropzone-title">${e.toUpperCase()} 업로드</span></label></div>`).join(`
...
<Upload variant="drag" fit title="전체 너비 업로드" />`},state:{html:`<div class="upload is-disabled" data-component="Upload"><label class="upload_trigger">${P(`upload-disabled`,` disabled`)}<span class="btn">파일 선택</span></label></div>\n<div class="upload" data-component="Upload"><label class="upload_dropzone is-error">업로드 오류</label></div>`,react:`<><Upload disabled /><Upload variant="drag" error title="업로드 오류" /></>`,vue:`<Upload disabled />
<Upload variant="drag" error title="업로드 오류" />`},example:{html:`<form class="form form_vertical form_fit"><div class="form_field"><p class="form_field-label">첨부 파일</p><div class="upload" data-component="Upload" data-max-size="10485760" data-max-files="3">${P(`attachments`,` accept=".pdf,.doc,.docx" multiple`)}<ul class="upload_list" data-upload-list></ul></div></div></form>`,react:`<Upload files={files} onChange={setFiles} multiple accept=".pdf,.doc,.docx" maxSize={10 * 1024 * 1024} maxFiles={3} />`,vue:`<Upload v-model="files" multiple accept=".pdf,.doc,.docx" :max-size="10 * 1024 * 1024" :max-files="3" />`}},F=`{% from "components/form/Upload/upload.njk" import upload, uploadField %}`,Ve={basic:`${F}

{{ upload(id='upload-basic', buttonLabel='파일 선택', hint='PDF 또는 문서 파일을 첨부해 주세요.') }}`,dropzone:`${F}
...
{{ upload(variant='list', fit=true, files=files) }}`,cards:`${F}
...
{{ upload(id='upload-cards', variant='picture-card', multiple=true, accept='image/*', maxFiles=5, files=files, buttonLabel='업로드') }}`,avatar:`${F}
...
{{ upload(id='upload-fit-width', variant='drag', fit=true, title='전체 너비 업로드', description='파일을 끌어다 놓거나 선택하세요.') }}`,state:`${F}

{{ upload(id='upload-disabled', disabled=true) }}
{{ upload(id='upload-error', variant='drag', error=true, title='업로드 오류') }}`,example:`${F}
...
`),He=Object.fromEntries(Object.entries(Be).map(([e,t])=>[e,ze(e,t)]))})))()}function We(e,t){let n=` `.repeat(t);return e.split(`
`).map(e=>`${n}${e}`).join(`
`)}function Ge(e,t){let n=e===`example`,r=`${n?`import { useState } from 'react';
`:``}import DatePicker from '@uxkm/react/date-picker';\n\nexport function Example() {${n?`
  const [date, setDate] = useState('');`:``}\n  return (\n${We(t.react,/^\s*<>/.test(t.react)?2:4)}\n  );\n}`,i=`<script setup>\n${n?`import { ref } from 'vue';
`:``}import DatePicker from '@uxkm/vue/date-picker';${n?`
const date = ref('');`:``}\n<\/script>\n\n<template>\n${We(t.vue,2)}\n</template>`;return[{id:`html`,label:`HTML`,fileName:`DatePicker.html · ${e}`,code:t.html},{id:`gulp`,label:`Gulp`,fileName:`date-picker.njk · ${e}`,code:qe[e]},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/date-picker · ${e}`,code:i},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/date-picker · ${e}`,code:i},{id:`react`,label:`React`,fileName:`@uxkm/react/date-picker · ${e}`,code:r},{id:`next`,label:`Next`,fileName:`@uxkm/react/date-picker · ${e}`,code:r}]}var L,R,z,Ke,B,qe,Je;function Ye(){return(Ye=e((()=>{L=(e,t,n,r=``)=>`<div class="form_field"><label class="form_field-label" for="${e}">${t}</label>${n}${r}</div>`,R=(e,t,n,r=``)=>`<div className="form_field"><label className="form_field-label" htmlFor="${e}">${t}</label>${n}${r}</div>`,z=(e,t=``,n=``)=>`<div class="date_picker${t}" data-component="DatePicker"${n?` data-value="${n}"`:``}><div class="date_picker_trigger"><input id="${e}" class="date_picker_input" placeholder="날짜를 선택하세요" readonly aria-haspopup="dialog"><button class="date_picker_btn" type="button" aria-label="달력 열기">달력</button></div><div class="date_picker_panel" role="dialog" aria-label="날짜 선택"></div></div>`,Ke={basic:{html:L(`date-basic`,`예약일`,z(`date-basic`,` date_picker_fit`,`2024-06-15`),`<p class="form_field-hint">달력에서 날짜를 선택해 주세요.</p>`),react:R(`date-basic`,`예약일`,`<DatePicker id="date-basic" fit defaultValue="2024-06-15" />`,`<p className="form_field-hint">달력에서 날짜를 선택해 주세요.</p>`),vue:L(`date-basic`,`예약일`,`<DatePicker id="date-basic" fit model-value="2024-06-15" />`,`<p class="form_field-hint">달력에서 날짜를 선택해 주세요.</p>`)},size:{html:[`sm`,`md`,`lg`].map(e=>L(`date-${e}`,e.toUpperCase(),z(`date-${e}`,e===`md`?``:` date_picker_${e}`,`2024-06-15`))).join(`
`),react:`<>{['sm', 'md', 'lg'].map((size) => <DatePicker key={size} size={size} defaultValue="2024-06-15" />)}</>`,vue:`<DatePicker v-for="size in ['sm', 'md', 'lg']" :key="size" :size="size" model-value="2024-06-15" />`},width:{html:`${L(`date-full`,`전체 너비`,z(`date-full`,` date_picker_block`,`2024-06-15`))}${L(`date-fit`,`제한 너비`,z(`date-fit`,` date_picker_fit`,`2024-06-15`))}`,react:`<><DatePicker block defaultValue="2024-06-15" /><DatePicker fit defaultValue="2024-06-15" /></>`,vue:`<DatePicker block model-value="2024-06-15" />
<DatePicker fit model-value="2024-06-15" />`},limits:{html:L(`date-limits`,`프로모션 기간`,z(`date-limits`,``,`2024-06-15`).replace(`data-value=`,`data-min="2024-06-10" data-max="2024-06-20" data-value=`)),react:R(`date-limits`,`프로모션 기간`,`<DatePicker id="date-limits" defaultValue="2024-06-15" min="2024-06-10" max="2024-06-20" />`),vue:L(`date-limits`,`프로모션 기간`,`<DatePicker id="date-limits" model-value="2024-06-15" min="2024-06-10" max="2024-06-20" />`)},state:{html:`${L(`date-disabled`,`비활성`,z(`date-disabled`,` is-disabled`,`2024-06-15`).replace(`<input `,`<input disabled `))}${L(`date-error`,`에러`,z(`date-error`,` is-error`),`<p class="form_field-error" role="alert">날짜를 선택해 주세요.</p>`)}`,react:`<><DatePicker disabled defaultValue="2024-06-15" /><DatePicker error aria-describedby="date-error" /><p id="date-error" className="form_field-error" role="alert">날짜를 선택해 주세요.</p></>`,vue:`<DatePicker disabled model-value="2024-06-15" />
<DatePicker error aria-describedby="date-error" /><p id="date-error" class="form_field-error" role="alert">날짜를 선택해 주세요.</p>`},example:{html:`<form class="form form_vertical form_fit">${L(`visit-date`,`방문일`,z(`visit-date`,` is-error`),`<p class="form_field-error" role="alert">방문일을 선택해 주세요.</p>`)}</form>`,react:`<DatePicker id="visit-date" name="visitDate" value={date} onChange={setDate} required error={!date} />`,vue:`<DatePicker id="visit-date" name="visitDate" v-model="date" required :error="!date" />`}},B=`{% from "components/form/DatePicker/date-picker.njk" import datePicker, datePickerField %}`,qe={basic:`${B}

{% set reservationPicker %}{{ datePicker(id='date-basic', value='2024-06-15', fit=true) }}{% endset %}
{{ datePickerField(id='date-basic', label='예약일', control=reservationPicker, hint='달력에서 날짜를 선택해 주세요.') }}`,size:`${B}
...
{{ datePickerField(id='date-fit', label='제한 너비', control=fitPicker) }}`,limits:`${B}

{% set promotionPicker %}{{ datePicker(id='date-limits', value='2024-06-15', min='2024-06-10', max='2024-06-20') }}{% endset %}
{{ datePickerField(id='date-limits', label='프로모션 기간', control=promotionPicker) }}`,state:`${B}
...
{{ datePickerField(id='date-error', label='에러', control=errorPicker, errorMessage='날짜를 선택해 주세요.') }}`,example:`${B}
...
</form>`},Je=Object.fromEntries(Object.entries(Ke).map(([e,t])=>[e,Ge(e,t)]))})))()}var Xe;function Ze(){return(Ze=e((()=>{Xe=`<!-- Input 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Qe;function $e(){return($e=e((()=>{Qe=`{# Input 원본 구현: 입력, 애드온, 지우기 액션과 필드 메시지를 Input 계열 macro로 구성합니다. #}
...
`})))()}var nt;function rt(){return(rt=e((()=>{nt=`<!--
  Input 원본 구현.
  폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다.
-->
<script setup>
...
`})))()}var it;function at(){return(at=e((()=>{it=`<!-- Textarea 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
<div class="form_field">
  <!-- 값이 있을 때 우상단 지우기 버튼을 표시하고 클릭 후 포커스를 복원합니다. -->
  <label class="form_field-label" for="textarea-clear">메모</label>
  <div class="textarea_wrap textarea_clearable is-filled">
    <textarea
      id="textarea-clear"
      class="textarea"
      rows="4"
      data-component="Textarea"
    >지울 수 있는 내용</textarea>
    <button class="textarea_clear" type="button" data-ripple="surface" aria-label="입력 지우기">
      <svg
        class="icon"
        data-component="Icon"
        data-icon="close"
...
`})))()}var ot;function st(){return(st=e((()=>{ot=`{# Textarea 원본 구현: 여러 줄 입력, 글자 수와 상태 메시지를 Textarea 계열 macro로 구성합니다. #}
{% import "components/basic/Button/button.njk" as Button %}
...
const VALID_SIZES = ['sm', 'md', 'lg']; // 지원하는 크기 이름입니다.
const VALID_RESIZE = ['none', 'vertical', 'horizontal', 'both']; // 지원하는 크기 조절 방향입니다.
...
export function Textarea({
  ...
  const [innerValue, setInnerValue] = useState(() => value ?? defaultValue ?? '');
  const currentValue =
    controlled && (typeof value === 'string' || typeof value === 'number')
      ? String(value)
      : controlled
        ? ''
        : innerValue; // 화면에 표시할 최종 값입니다.
  const resolvedSize = VALID_SIZES.includes(size) ? size : 'md'; // 지원 범위로 보정한 크기입니다.
  const resolvedResize = VALID_RESIZE.includes(resize) ? resize : 'none'; // 지원 범위로 보정한 resize입니다.
  ...
  const classes = useMemo(
    () =>
      [
        ...
        .filter(Boolean)
        .join(' '),
    [resolvedSize, resolvedResize, showCount, clearable, fit, error, className],
  );
  ...
  return (
    ...
    >
      ...
      {showCount ? (
        <span
          id={countId}
          className={['textarea_count', hasLimit && count >= nativeMaxLength && 'is-limit']
            .filter(Boolean)
            .join(' ')}
          role="status"
          aria-live="polite"
...
`})))()}var ft;function pt(){return(pt=e((()=>{ft=`<!-- Select 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var mt;function ht(){return(ht=e((()=>{mt=`{# Select 원본 구현: 선택 옵션과 필드 상태를 Select 계열 macro로 구성합니다. #}
...
`})))()}var bt;function xt(){return(xt=e((()=>{bt=`<!-- Checkbox 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var St;function Ct(){return(Ct=e((()=>{St=`{# Checkbox 원본 구현: 체크박스·그룹·폼 필드를 macro 조합으로 구성합니다. #}
...
`})))()}var Ot;function kt(){return(kt=e((()=>{Ot=`<!-- Radio 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var At;function jt(){return(jt=e((()=>{At=`{# Radio 원본 구현: 라디오·그룹·폼 필드를 macro 조합으로 구성합니다. #}
...
{%- endset -%}
{%- if standalone -%}
<label class="radio_control{{ (' ' + className) if className else '' }}" data-ripple="{{ 'true' if ripple else 'false' }}">
  {{ input | safe }}
  <span class="radio_box" aria-hidden="true"></span>
</label>
{%- elif button -%}
<label class="radio radio_button{{ (' ' + className) if className else '' }}" data-ripple="{{ 'true' if ripple else 'false' }}">
  {{ input | safe }}
  <span class="radio_label">{{ content | safe }}</span>
</label>
{%- else -%}
<label class="radio{{ ' radio_label-end' if labelEnd else '' }}{{ (' ' + className) if className else '' }}" data-ripple="{{ 'true' if ripple else 'false' }}">
  {% if labelEnd %}<span class="radio_label">{{ content | safe }}</span>{% endif %}
  <span class="radio_control">
    {{ input | safe }}
    <span class="radio_box" aria-hidden="true"></span>
  </span>
  {% if not labelEnd %}<span class="radio_label">{{ content | safe }}</span>{% endif %}
</label>
{%- endif -%}
{% endmacro %}
...
<fieldset
  class="radio_group{{ ' radio_group_horizontal' if horizontal else '' }}{{ ' radio_group_block' if block else '' }}{{ (' ' + className) if className else '' }}"
  {% if ariaLabelledby %}aria-labelledby="{{ ariaLabelledby }}"{% endif %}
  {% if style %}style="{{ style }}"{% endif %}
>
  {% if legend %}<legend class="radio_group-legend">{{ legend }}</legend>{% endif %}
  {% if caller %}{{ caller() | safe }}{% endif %}
</fieldset>
{% endmacro %}
...
{# include 시 기본 데모 (from import 시에는 실행되지 않음) #}
{{ radio(id='radio-example', name='radio-example', value='default', label='라디오') }}
...
`})))()}var Pt;function Ft(){return(Ft=e((()=>{Pt=`<!--
  Radio 원본 구현.
  폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다.
-->
<script setup>
...
`})))()}var It;function Lt(){return(Lt=e((()=>{It=`<!-- Switch 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Rt;function zt(){return(zt=e((()=>{Rt=`{# Switch 원본 구현: 스위치·그룹·폼 필드를 macro 조합으로 구성합니다. #}
...
`})))()}var Wt;function Gt(){return(Gt=e((()=>{Wt=`<!-- Slider 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var Kt;function qt(){return(qt=e((()=>{Kt=`{# Slider 원본 구현: 범위 입력과 폼 필드를 macro 조합으로 구성합니다. #}
{% macro slider(
...
`})))()}var Jt;function Yt(){return(Yt=e((()=>{Jt=`/**
 * Slider 원본 구현.
 * 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다.
 */
...
`})))()}var Qt;function $t(){return($t=e((()=>{Qt=`<!-- Rate 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var en;function tn(){return(tn=e((()=>{en=`{# Rate 원본 구현: 편집·읽기 전용 별점과 폼 필드를 macro로 구성합니다. #}
{% macro starGraphic(half = false) %}
<span class="rate_star-graphic" aria-hidden="true">
  <svg class="rate_star-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>
  <svg class="rate_star-icon rate_star-icon-filled" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>
  {% if half %}<span class="rate_star-icon-half"><svg class="rate_star-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg></span>{% endif %}
</span>
{% endmacro %}

{% macro rate(value = '', count = 5, allowHalf = false, clearable = false, readOnly = false, disabled = false, size = 'md', legend = '', name = 'rate-example', color = '', ripple = true, ariaLabel = '', className = '') %}
{% set resolvedCount = count if count > 0 else 5 %}
{% set resolvedSize = size if size in ['sm', 'md', 'lg'] else 'md' %}
{% set classes = 'rate' + ((' rate_' + resolvedSize) if resolvedSize != 'md' else '') + (' rate_allow-half' if allowHalf else '') + (' rate_clearable' if clearable else '') + (' is-readonly' if readOnly else '') + ((' color_' + color) if color else '') + ((' ' + className) if className else '') %}
{% if readOnly %}
<div class="{{ classes }}" data-component="Rate" role="img" aria-label="{{ ariaLabel if ariaLabel else (resolvedCount + '점 만점 중 ' + (value if value != '' else 0) + '점') }}">
  <div class="rate_stars">
    {% for star in range(1, resolvedCount + 1) %}
      {% set state = 'is-filled' if value >= star else ('is-half' if allowHalf and value >= star - 0.5 else '') %}
      <span class="rate_star-readonly{{ (' ' + state) if state else '' }}">{{ starGraphic(state == 'is-half') }}</span>
    {% endfor %}
  </div>
  {% if value != '' %}<span class="rate_value">{{ value }}</span>{% endif %}
</div>
{% else %}
<fieldset class="{{ classes }}" data-component="Rate"{% if ripple %} data-ripple="true"{% endif %}{% if disabled %} disabled{% endif %}{% if ariaLabel %} aria-label="{{ ariaLabel }}"{% endif %}>
  {% if legend %}<legend class="rate_legend">{{ legend }}</legend>{% endif %}
  <div class="rate_control">
    <div class="rate_stars">
      {% for star in range(1, resolvedCount + 1) %}
      <label class="rate_star"{% if ripple %} data-ripple="true"{% endif %}>
        {% if allowHalf %}<input class="rate_input rate_input-half" type="radio" name="{{ name }}" value="{{ star - 0.5 }}"{% if value == star - 0.5 %} checked{% endif %}{% if disabled %} disabled{% endif %}><button type="button" class="rate_star-half rate_star-half-left" tabindex="-1" aria-hidden="true"{% if disabled %} disabled{% endif %}></button>{% endif %}
        <input class="rate_input" type="radio" name="{{ name }}" value="{{ star }}"{% if value == star %} checked{% endif %}{% if disabled %} disabled{% endif %}>
        {% if allowHalf %}<button type="button" class="rate_star-half rate_star-half-right" tabindex="-1" aria-hidden="true"{% if disabled %} disabled{% endif %}></button>{% endif %}
        {{ starGraphic(allowHalf) }}
        <span class="rate_star-label">{{ star }}점</span>
      </label>
      {% endfor %}
    </div>
    {% if clearable %}<button class="rate_clear" type="button"{% if ripple %} data-ripple="true"{% endif %} aria-label="별점 초기화" title="초기화">×</button>{% endif %}
    {% if value != '' %}<output class="rate_value">{{ value }}점</output>{% endif %}
  </div>
</fieldset>
{% endif %}
{% endmacro %}

{% macro rateField(label = '', labelId = '', hint = '', errorMessage = '', required = false, className = '') %}
<div class="form_field{{ (' ' + className) if className else '' }}">
  {% if label %}<span class="form_field-label"{% if labelId %} id="{{ labelId }}"{% endif %}>{{ label }}{% if required %}<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span>{% endif %}</span>{% endif %}
  {% if caller %}{{ caller() | safe }}{% endif %}
  {% if errorMessage %}<p class="form_field-error" role="alert">{{ errorMessage }}</p>{% elif hint %}<p class="form_field-hint">{{ hint }}</p>{% endif %}
...
export default Rate;
`})))()}var an;function on(){return(on=e((()=>{an=`<!--
  Rate 원본 구현.
  폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다.
-->
<script setup>
...
`})))()}var sn;function cn(){return(cn=e((()=>{sn=`<!-- Upload 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var ln;function un(){return(un=e((()=>{ln=`{# Upload 원본 구현: 업로드 변형·파일 목록·폼 필드를 macro 조합으로 구성합니다. #}
...
`})))()}var pn;function mn(){return(mn=e((()=>{pn=`<!--
  Upload 원본 구현.
  폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다.
-->
<script setup>
...
`})))()}var hn;function gn(){return(gn=e((()=>{hn=`<!-- DatePicker 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var _n;function vn(){return(vn=e((()=>{_n=`{# DatePicker 원본 구현: 날짜 선택기와 폼 필드를 macro 조합으로 구성합니다. #}
{% macro datePicker(
  id = '', name = '', value = '', placeholder = '날짜를 선택하세요',
  size = 'md', fit = false, block = false, disabled = false,
  required = false, error = false, success = false, clearable = true,
  min = '', max = '', panelAlign = 'start', ariaLabel = '날짜 선택',
  ariaDescribedby = '', className = ''
) %}
{% set resolvedSize = size if size in ['sm', 'md', 'lg'] else 'md' %}
{% set panelId = id + '-panel' %}
<div
  class="date_picker{{ (' date_picker_' + resolvedSize) if resolvedSize != 'md' else '' }}{{ ' date_picker_fit' if fit else '' }}{{ ' date_picker_block' if block else '' }}{{ ' is-disabled' if disabled else '' }}{{ ' is-error' if error else '' }}{{ ' is-success' if success else '' }}{{ (' ' + className) if className else '' }}"
...
>
  <div class="date_picker_trigger">
    ...
    {% if clearable %}<button class="date_picker_clear" type="button" aria-label="날짜 지우기"{% if not value or disabled %} hidden{% endif %}>
      <svg class="icon" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m6 6 12 12M18 6 6 18"></path></svg>
    </button>{% endif %}
    <button class="date_picker_btn" type="button" aria-label="달력 열기" aria-controls="{{ panelId }}" aria-expanded="false"{% if disabled %} disabled{% endif %}>
      <svg class="icon" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="5" width="18" height="16" rx="2"></rect><path d="M16 3v4M8 3v4M3 10h18"></path></svg>
    </button>
  </div>
  <div
    id="{{ panelId }}"
    class="date_picker_panel{{ ' date_picker_panel-end' if panelAlign == 'end' else '' }}"
    role="dialog"
    aria-modal="false"
    aria-label="{{ ariaLabel }}"
    hidden
...
{% macro datePickerField(id = '', label = '', control = '', hint = '', errorMessage = '', required = false, className = '') %}
{% set content = caller() if caller else control %}
<div class="form_field{{ (' ' + className) if className else '' }}">
  {% if label %}<label class="form_field-label"{% if id %} for="{{ id }}"{% endif %}>{{ label }}{% if required %}<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span>{% endif %}</label>{% endif %}
  {{ content | safe }}
  {% if errorMessage %}<p id="{{ id }}-error" class="form_field-error" role="alert">{{ errorMessage }}</p>{% elif hint %}<p id="{{ id }}-hint" class="form_field-hint">{{ hint }}</p>{% endif %}
</div>
{% endmacro %}

{# include 시 기본 데모 (from import 시에는 실행되지 않음) #}
{{ datePicker(id='date-picker-example') }}
...
`})))()}var xn;function Sn(){return(Sn=e((()=>{xn=`<!--
  DatePicker 원본 구현.
  폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다.
-->
<script setup>
...
`})))()}function V(e,t,n){return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/${e}/${e}.html`,code:n.html},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/${e}/${t}.njk`,code:n.gulp},{id:`vue`,label:`Vue`,fileName:`apps/vue/src/components/form/${e}/${e}.vue`,code:n.vue},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/${t} → ${e}.vue`,code:n.vue},{id:`react`,label:`React`,fileName:`apps/react/src/components/form/${e}/${e}.jsx`,code:n.react},{id:`next`,label:`Next`,fileName:`@uxkm/react/${t} → ${e}.jsx`,code:n.react}]}function Cn(e){let t=X[e]??X.basic,n=`<xf:input id="${e}Input" class="input${t.classes?` ${t.classes}`:``}" type="${t.type??`text`}" ref="data:${e}Value"${t.attributes?` ${t.attributes}`:``}></xf:input>`,r=e===`group`?`<w2:group id="${e}Group" class="input_group input_fit">
...
</w2:group>`}function wn(e){let t=Z[e]??Z.basic,n=`<xf:textarea id="${e}Textarea" class="textarea${t.classes?` ${t.classes}`:``}" ref="data:${e}Value"${t.attributes?` ${t.attributes}`:``}></xf:textarea>`,r=e===`count`||e===`example`?`<w2:group id="${e}Wrap" class="textarea_wrap textarea_show-count">
  ${n}
  <w2:textbox id="${e}Count" class="textarea_count" role="status" aria-live="polite" label="0/${e===`count`?`200`:`500`}"></w2:textbox>
</w2:group>`:e===`clearable`?`<w2:group id="${e}Wrap" class="textarea_wrap textarea_clearable is-filled">
  ${n}
  <xf:trigger id="${e}Clear" type="button" class="textarea_clear" ev:onclick="scwin.textarea_clear">
    <xf:label><![CDATA[입력 지우기]]></xf:label>
  </xf:trigger>
</w2:group>`:n;return`<w2:group id="${e}Field" class="form_field form_field_fit">
...
</w2:group>`}function Tn(e){let t=Q[e]??Q.basic;return`<w2:group id="${e}Field" class="form_field form_field_fit">
...
`,`
  `)}
  ${o}
</w2:group>`}function En(e){switch(e){case`standalone`:return`<w2:group id="standaloneControl" class="checkbox_control" tagname="label" aria-label="항목 선택">
...
`,`
  `)}
  ${s}
</w2:group>`}function Dn(e){switch(e){case`standalone`:return`<w2:group id="standaloneGroup" class="radio_group radio_group_horizontal">
...
`,`
  `)}
</w2:group>`}function On(e){switch(e){case`standalone`:return[G(`standaloneOff`,``,{ariaLabel:`기능 켜기`}),G(`standaloneOn`,``,{ariaLabel:`기능 끄기`,attributes:`checked="true"`})].join(`
...
`,`
  `)}${c}
</w2:group>`}function kn(e){switch(e){case`type`:return[K(`typeBasic`,`기본 — slider`,{value:`40`}),K(`typeStepper`,`스텝 버튼 — slider_stepper`,{value:`40`,stepper:!0,classes:`slider_fit`})].join(`
...
</w2:group>`}function An(e){switch(e){case`type`:return[q(`typeBasic`,`기본 — rate`,{value:`3`}),q(`typeHalf`,`반점 — rate_allow-half`,{value:`3.5`,classes:`rate_allow-half`})].join(`
...
`,`
  `)}
  ${i}
</w2:group>`}function Mn(e){switch(e){case`size`:return[Y(`sizeSm`,`Small`,{classes:`date_picker_sm`,value:`2024-06-15`}),Y(`sizeMd`,`Medium`,{value:`2024-06-15`}),Y(`sizeLg`,`Large`,{classes:`date_picker_lg`,value:`2024-06-15`})].join(`
...
`,`
  `)}
</w2:group>`;default:return Y(`basic`,`예약일`,{classes:`date_picker_fit`,value:`2024-06-15`,hint:`달력에서 날짜를 선택해 주세요.`})}}var Nn,Pn,Fn,In,Ln,Rn,zn,Bn,Vn,Hn,X,Z,Q,$,Un,Wn,Gn,Kn,qn,Jn,Yn,Xn,Zn;function Qn(){return(Qn=e((()=>{p(),ce(),ge(),xe(),A(),Oe(),Ne(),Re(),Ue(),Ye(),Ze(),$e(),tt(),rt(),at(),st(),lt(),dt(),pt(),ht(),_t(),yt(),xt(),Ct(),Tt(),Dt(),kt(),jt(),Nt(),Ft(),Lt(),zt(),Vt(),Ut(),Gt(),qt(),Yt(),Zt(),$t(),tn(),rn(),on(),cn(),un(),fn(),mn(),gn(),vn(),bn(),Sn(),Nn=V(`Input`,`input`,{html:Xe,gulp:Qe,react:et,vue:nt}),Pn=V(`Textarea`,`textarea`,{html:it,gulp:ot,react:ct,vue:ut}),Fn=V(`Select`,`select`,{html:ft,gulp:mt,react:gt,vue:vt}),In=V(`Checkbox`,`checkbox`,{html:bt,gulp:St,react:wt,vue:Et}),Ln=V(`Radio`,`radio`,{html:Ot,gulp:At,react:Mt,vue:Pt}),Rn=V(`Switch`,`switch`,{html:It,gulp:Rt,react:Bt,vue:Ht}),zn=V(`Slider`,`slider`,{html:Wt,gulp:Kt,react:Jt,vue:Xt}),Bn=V(`Rate`,`rate`,{html:Qt,gulp:en,react:nn,vue:an}),Vn=V(`Upload`,`upload`,{html:sn,gulp:ln,react:dn,vue:pn}),Hn=V(`DatePicker`,`date-picker`,{html:hn,gulp:_n,react:yn,vue:xn}),X={basic:{label:`이름`,attributes:`placeholder="이름을 입력하세요"`},standalone:{label:`검색어`,type:`search`,classes:`input_fit`,attributes:`placeholder="검색어를 입력하세요"`},type:{label:`이메일`,type:`email`,attributes:`placeholder="name@example.com"`},kind:{label:`인증번호`,classes:`input_otp`,attributes:`displayFormat="####" maxlength="4"`},size:{label:`Large`,classes:`input_lg`},width:{label:`제한 너비`,classes:`input_fit`},group:{label:`도메인`,type:`url`,classes:`input_fit`,attributes:`placeholder="example.com"`},required:{label:`이메일`,type:`email`,attributes:`mandatory="true" aria-required="true"`},state:{label:`오류 입력`,attributes:`aria-invalid="true" aria-describedby="inputError"`},clearable:{label:`검색어`,type:`search`,attributes:`placeholder="검색어를 입력하세요"`},example:{label:`사용자 이름`,attributes:`mandatory="true" aria-describedby="inputExampleHint"`}},Z={basic:{label:`메시지`,classes:`textarea_resize_none`,attributes:`rows="4" placeholder="메시지를 입력하세요"`},standalone:{label:`자기소개`,classes:`textarea_fit`,attributes:`rows="4"`},size:{label:`Large`,classes:`textarea_lg textarea_resize_none`,attributes:`rows="5"`},width:{label:`제한 너비`,classes:`textarea_fit textarea_resize_none`,attributes:`rows="4"`},resize:{label:`세로 크기 조절`,classes:`textarea_resize_vertical`,attributes:`rows="5"`},required:{label:`문의 내용`,classes:`textarea_resize_none`,attributes:`rows="4" mandatory="true"`},state:{label:`오류 내용`,classes:`textarea_resize_none is-error`,attributes:`rows="4" aria-invalid="true"`},count:{label:`자기소개`,classes:`textarea_resize_none`,attributes:`rows="5" maxlength="200"`},clearable:{label:`메모`,classes:`textarea_resize_none`,attributes:`rows="4"`},example:{label:`문의 내용`,classes:`textarea_resize_none is-error`,attributes:`rows="5" maxlength="500" mandatory="true"`}},Q={basic:{label:`지역`,classes:`input_fit`,attributes:`chooseOption="true"`},standalone:{label:`언어`,classes:`input_fit`},size:{label:`Large`,classes:`input_lg`},width:{label:`제한 너비`,classes:`input_fit`},group:{label:`소속 팀`,attributes:`chooseOption="true"`},multiple:{label:`관심 분야`,attributes:`appearance="minimal" multiple="true"`},required:{label:`문의 유형`,attributes:`mandatory="true" chooseOption="true"`},state:{label:`오류 선택`,classes:`is-error`,attributes:`aria-invalid="true"`},example:{label:`배송 지역`,classes:`input_fit is-error`,attributes:`mandatory="true" chooseOption="true"`}},$=H(f,`Input`,Cn),Un=H(he,`Textarea`,wn),Wn=H(se,`Select`,Tn),Gn=H(be,`Checkbox`,En),Kn=H(k,`Radio`,Dn),qn=H(De,`Switch`,On),Jn=H(Me,`Slider`,kn),Yn=H(Le,`Rate`,An),Xn=H(He,`Upload`,jn),Zn=H(Je,`DatePicker`,Mn)})))()}export{qn as _,Qn as a,Vn as b,Ln as c,Yn as d,Fn as f,Rn as g,Jn as h,Zn as i,Kn as l,zn as m,Gn as n,Nn as o,Wn as p,Hn as r,$ as s,In as t,Bn as u,Pn as v,Xn as x,Un as y};