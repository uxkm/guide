...
}`,language:`tsx`}}},render:f((0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(o,{checked:!0,label:`다크 모드`}),(0,d.jsx)(o,{label:`자동 저장`})]}))},y={name:`단독 사용`,parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"레이블 없이 스위치만 사용할 수 있습니다. `aria-label`로 접근 가능한 이름을 지정합니다."},source:{code:`import Switch from '@uxkm/react/switch';
...
}`,language:`tsx`}}},render:f((0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(o,{ariaLabel:`기능 켜기`}),(0,d.jsx)(o,{checked:!0,ariaLabel:`기능 끄기`}),(0,d.jsx)(o,{disabled:!0,ariaLabel:`비활성`})]}))},b={name:`크기`,parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:`switch_sm · switch(기본) · switch_lg로 트랙·텍스트 크기를 조절합니다.`},source:{code:`import Switch from '@uxkm/react/switch';
...
}`,...T.parameters?.docs?.source}}},E=[`Playground`,`Type`,`LabelEnd`,`Basic`,`Standalone`,`Size`,`Width`,`Color`,`State`,`Group`,`Form`]})))()}export{_ as a,C as c,x as d,D as f,w as i,u as l,S as n,b as o,T as r,y as s,v as t,g as u};