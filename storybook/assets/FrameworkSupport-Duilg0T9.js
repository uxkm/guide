...
`,(0,u.jsx)(t.li,{children:`WebSquare는 HTML 예제를 XML 호환 마크업으로 변환하며, 복잡한 컴포넌트는 전용 예제로 대체할 수 있습니다.`}),`
`,(0,u.jsx)(t.li,{children:`Container, Grid, Flex, Divider, Space, Button, Typography, Icon, Link는 WebSquare 컴포넌트·이벤트·리소스 특성을 반영한 전용 XML 예제를 제공합니다.`}),`
...
`,(0,u.jsx)(t.li,{children:`변경 시 일곱 구현 코드와 Storybook 문서를 같은 작업 범위에서 확인합니다.`}),`
`]}),`
