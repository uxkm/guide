import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{a as n,c as r,d as i,f as a,i as o,l as s,m as c,n as l,o as ee,p as u,r as d,s as f,t as p,u as m}from"./Tag.stories-BOwM8Tqt.js";import{i as h,r as g}from"./react-pLZlIR__.js";import{c as _,r as v,u as y}from"./blocks-B4JiLJlK.js";import{i as b,n as x,r as S,t as te}from"./ComponentApiDocs-DwOtyIDn.js";import{i as ne,r as C}from"./dataDisplayApiSections-w1k9tZfi.js";var w;function T(){return(T=e((()=>{w=`<!-- Tag 원본 구현: 데이터 표시 구조와 시각 상태를 공통 CSS 클래스 및 접근성 속성으로 표현합니다. -->
<!-- 기본 · 스킨 · 크기 -->
...
import Icon from '@uxkm/react/icon';`:``}\n\nexport function Example() {\n  return (\n  <>\n${n.split(`
`).map(e=>e.trim()?`    ${e}`:``).join(`
`)}\n  </>\n  );\n}`},{id:`websquare`,label:`WebSquare`,fileName:`Tag.xml · ${e}`,code:J[e]}]]}))})))()}function Z(e){let t={code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...h(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(_,{of:a}),`
...
`]}),`
`,(0,Q.jsx)(S,{examples:U,showFullCode:!0}),`
...
`,(0,Q.jsx)(S,{examples:Y.group}),`
`,(0,Q.jsx)(te,{sections:ne})]})}function re(e={}){let{wrapper:t}={...h(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(Z,{...e})}):Z(e)}var Q;function $(){return($=e((()=>{Q=t(),g(),y(),b(),x(),X(),C(),c()})))()}$();export{re as default};