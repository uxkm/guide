import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{d as n,i as r,l as i}from"./blocks-DKrjMPN_.js";import{n as ee,t as a}from"./FrameworkTabs-duseEU1T.js";import{a as te,c as ne,i as o,l as re,n as ie,o as s,r as ae,s as oe,t as se,u as ce}from"./FormLayout.stories-DFw6_Hsm.js";import{i as c,r as le}from"./react-CQ14Jk9E.js";import{n as l,t as ue}from"./ComponentApiDocs-C9VNL7Yh.js";function u(e,t){let n=` `.repeat(t);return e.split(`
`).map(e=>`${n}${e}`).join(`
`)}function de(e,t){let n=`import FormLayout, { FormActions, FormField } from '@uxkm/react/form-layout';\n\nexport function Example() {\n  return (\n${u(t.react,/^\s*<>/.test(t.react)?2:4)}\n  );\n}`,r=`<script setup>\nimport FormLayout, { FormActions, FormField } from '@uxkm/vue/form-layout';\n<\/script>\n\n<template>\n${u(t.vue,2)}\n</template>`;return[{id:`html`,label:`HTML`,fileName:`apps/html/src/components/form/FormLayout/FormLayout.html · ${e}`,code:t.html},{id:`gulp`,label:`Gulp`,fileName:`apps/gulp/src/components/form/FormLayout/form-layout.njk · ${e}`,code:b[e]},{id:`vue`,label:`Vue`,fileName:`@uxkm/vue/form-layout · ${e}`,code:r},{id:`nuxt`,label:`Nuxt`,fileName:`@uxkm/vue/form-layout · ${e}`,code:r},{id:`react`,label:`React`,fileName:`@uxkm/react/form-layout · ${e}`,code:n},{id:`next`,label:`Next`,fileName:`@uxkm/react/form-layout · ${e}`,code:n}]}var d,f,p,m,h,g,_,v,y,b,x;function S(){return(S=e((()=>{d=(e,t,n=``,r=``)=>`<div class="form_field">
  <label class="form_field-label" for="${e}">${t}</label>
  <div class="form_field-control"><input id="${e}" class="input" type="text"${r}></div>${n}
</div>`,f=(e,t,n=``,r=``)=>`<FormField label="${t}" htmlFor="${e}"${n}>
  <input id="${e}" className="input" type="text"${r} />
</FormField>`,p=(e,t,n=``,r=``)=>`<FormField label="${t}" for="${e}"${n}>
  <input id="${e}" class="input" type="text"${r}>
</FormField>`,m=e=>`${e}<span class="form_field-required"><span aria-hidden="true">*</span><span class="form_field-required-text">필수 항목</span></span>`,h=`<div class="form_actions"><button class="btn btn_filled color_primary" type="submit">저장</button><button class="btn btn_ghost" type="button">취소</button></div>`,g=`<FormActions><button className="btn btn_filled color_primary" type="submit">저장</button><button className="btn btn_ghost" type="button">취소</button></FormActions>`,_=`<FormActions><button class="btn btn_filled color_primary" type="submit">저장</button><button class="btn btn_ghost" type="button">취소</button></FormActions>`,v={vertical:{html:`<form class="form form_vertical form_fit">${d(`name`,m(`이름`),`
  <p class="form_field-hint">실명을 입력해 주세요.</p>`,` required`)}${d(`email`,`이메일`)}${h}</form>`,react:`<FormLayout fit>${f(`name`,`이름`,` required hint="실명을 입력해 주세요."`,` required`)}${f(`email`,`이메일`)}${g}</FormLayout>`,vue:`<FormLayout fit>${p(`name`,`이름`,` required hint="실명을 입력해 주세요."`,` required`)}${p(`email`,`이메일`)}${_}</FormLayout>`},horizontal:{html:`<form class="form form_horizontal">${d(`name`,m(`이름`),``,` required`)}${d(`email`,`이메일`)}${h}</form>`,react:`<FormLayout layout="horizontal">${f(`name`,`이름`,` required`,` required`)}${f(`email`,`이메일`)}${g}</FormLayout>`,vue:`<FormLayout layout="horizontal">${p(`name`,`이름`,` required`,` required`)}${p(`email`,`이메일`)}${_}</FormLayout>`},horizontalAlign:{html:`<div class="demo-stack"><form class="form form_horizontal form_label-width-sm form_label-align-start">${d(`city`,`도시`)}${d(`zip`,`우편번호`)}</form><form class="form form_horizontal form_label-width-lg">${d(`company`,`회사명`)}${d(`team`,`부서`)}</form></div>`,react:`<div className="demo-stack"><FormLayout layout="horizontal" labelWidth="sm" labelAlign="start">${f(`city`,`도시`)}${f(`zip`,`우편번호`)}</FormLayout><FormLayout layout="horizontal" labelWidth="lg">${f(`company`,`회사명`)}${f(`team`,`부서`)}</FormLayout></div>`,vue:`<div class="demo-stack"><FormLayout layout="horizontal" label-width="sm" label-align="start">${p(`city`,`도시`)}${p(`zip`,`우편번호`)}</FormLayout><FormLayout layout="horizontal" label-width="lg">${p(`company`,`회사명`)}${p(`team`,`부서`)}</FormLayout></div>`},inline:{html:`<form class="form form_inline">${d(`query`,`검색어`)}<div class="form_field"><label class="form_field-label" for="status">상태</label><div class="form_field-control"><select id="status" class="input"><option>전체</option><option>완료</option></select></div></div><div class="form_actions"><button class="btn btn_filled color_primary" type="submit">검색</button></div></form>`,react:`<FormLayout layout="inline">${f(`query`,`검색어`)}<FormField label="상태" htmlFor="status"><select id="status" className="input"><option>전체</option><option>완료</option></select></FormField><FormActions><button className="btn btn_filled color_primary" type="submit">검색</button></FormActions></FormLayout>`,vue:`<FormLayout layout="inline">${p(`query`,`검색어`)}<FormField label="상태" for="status"><select id="status" class="input"><option>전체</option><option>완료</option></select></FormField><FormActions><button class="btn btn_filled color_primary" type="submit">검색</button></FormActions></FormLayout>`},grid:{html:`<form class="form form_vertical"><div class="grid grid_cols-1 grid_cols-md-2">${d(`name`,`이름`)}${d(`team`,`부서`)}</div>${d(`email`,`이메일`)}${h}</form>`,react:`<FormLayout><div className="grid grid_cols-1 grid_cols-md-2">${f(`name`,`이름`)}${f(`team`,`부서`)}</div>${f(`email`,`이메일`)}${g}</FormLayout>`,vue:`<FormLayout><div class="grid grid_cols-1 grid_cols-md-2">${p(`name`,`이름`)}${p(`team`,`부서`)}</div>${p(`email`,`이메일`)}${_}</FormLayout>`},width:{html:`<div class="demo-stack"><form class="form form_vertical">${d(`width-default`,`기본 너비`)}</form><form class="form form_vertical form_fit">${d(`width-fit`,`제한 너비`)}</form><form class="form form_horizontal">${d(`width-horizontal`,`가로 레이아웃`)}</form></div>`,react:`<div className="demo-stack"><FormLayout>${f(`width-default`,`기본 너비`)}</FormLayout><FormLayout fit>${f(`width-fit`,`제한 너비`)}</FormLayout><FormLayout layout="horizontal">${f(`width-horizontal`,`가로 레이아웃`)}</FormLayout></div>`,vue:`<div class="demo-stack"><FormLayout>${p(`width-default`,`기본 너비`)}</FormLayout><FormLayout fit>${p(`width-fit`,`제한 너비`)}</FormLayout><FormLayout layout="horizontal">${p(`width-horizontal`,`가로 레이아웃`)}</FormLayout></div>`},actions:{html:`<div class="demo-stack"><form class="form form_vertical">${d(`actions-vertical`,`제목`)}${h}</form><form class="form form_horizontal">${d(`actions-horizontal`,`제목`)}${h}</form></div>`,react:`<div className="demo-stack"><FormLayout>${f(`actions-vertical`,`제목`)}${g}</FormLayout><FormLayout layout="horizontal">${f(`actions-horizontal`,`제목`)}${g}</FormLayout></div>`,vue:`<div class="demo-stack"><FormLayout>${p(`actions-vertical`,`제목`)}${_}</FormLayout><FormLayout layout="horizontal">${p(`actions-horizontal`,`제목`)}${_}</FormLayout></div>`},example:{html:`<form class="form form_vertical form_compact"><div class="grid grid_cols-1 grid_cols-md-2">${d(`example-id`,m(`아이디`),`
  <p class="form_field-hint">영문·숫자 4~16자</p>`,` required`)}${d(`example-password`,m(`비밀번호`),``,` required`)}${d(`example-name`,m(`이름`),``,` required`)}${d(`example-email`,`이메일`)}<div class="form_field grid_col-span-md-2"><label class="form_field-label" for="example-memo">메모</label><div class="form_field-control"><textarea id="example-memo" class="textarea" rows="3"></textarea></div></div></div>${h.replace(`저장`,`가입하기`)}</form>`,react:`<FormLayout compact><div className="grid grid_cols-1 grid_cols-md-2">${f(`example-id`,`아이디`,` required hint="영문·숫자 4~16자"`,` required`)}${f(`example-password`,`비밀번호`,` required`,` required`)}${f(`example-name`,`이름`,` required`,` required`)}${f(`example-email`,`이메일`)}<FormField className="grid_col-span-md-2" label="메모" htmlFor="example-memo"><textarea id="example-memo" className="textarea" rows={3} /></FormField></div>${g.replace(`저장`,`가입하기`)}</FormLayout>`,vue:`<FormLayout compact><div class="grid grid_cols-1 grid_cols-md-2">${p(`example-id`,`아이디`,` required hint="영문·숫자 4~16자"`,` required`)}${p(`example-password`,`비밀번호`,` required`,` required`)}${p(`example-name`,`이름`,` required`,` required`)}${p(`example-email`,`이메일`)}<FormField class="grid_col-span-md-2" label="메모" for="example-memo"><textarea id="example-memo" class="textarea" rows="3"></textarea></FormField></div>${_.replace(`저장`,`가입하기`)}</FormLayout>`}},y=`{% from "components/form/FormLayout/form-layout.njk" import formLayout, formField, formActions %}
...
{% from "components/layout/Grid/grid.njk" import grid, gridCol %}`,b={vertical:`${y}
...
{% call formLayout(compact=true) %}
  ...
  {% call formActions() %}
    ...
    {{ button(variant='ghost', color='', label='취소') }}
  {% endcall %}
{% endcall %}`},x=Object.fromEntries(Object.entries(v).map(([e,t])=>[e,de(e,t)]))})))()}var C;function w(){return(w=e((()=>{C=`<!-- FormLayout 원본 구현: 폼 값·검증·비활성 상태를 제어하고 레이블, 키보드 동작, 사용자 이벤트를 연결합니다. -->
...
`})))()}var T;function E(){return(E=e((()=>{T=`{# FormLayout 원본 구현: 폼·필드·액션 영역을 macro 조합으로 구성합니다. #}
...
`]}),`
`,(0,Q.jsx)(a,{examples:R,showFullCode:!0}),`
...
`,(0,Q.jsx)(a,{examples:H.horizontalAlign}),`
...
`,(0,Q.jsx)(a,{examples:H.example}),`
`,(0,Q.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,Q.jsxs)(t.p,{children:[(0,Q.jsx)(t.code,{children:`FormField`}),`는 레이블과 입력 id를 `,(0,Q.jsx)(t.code,{children:`for`}),`/`,(0,Q.jsx)(t.code,{children:`id`}),`로 연결합니다. 필수는 시각 별표와 스크린 리더용 “필수 항목” 텍스트를 제공하되, 실제 컨트롤에도 네이티브 `,(0,Q.jsx)(t.code,{children:`required`}),`를 지정해야 합니다. 오류 메시지는 `,(0,Q.jsx)(t.code,{children:`role="alert"`}),`를 사용하고 도움말보다 우선 표시합니다.`]}),`
`,(0,Q.jsx)(ue,{sections:Y})]})}function fe(e={}){let{wrapper:t}={...c(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(Z,{...e})}):Z(e)}var Q;function $(){return($=e((()=>{Q=t(),le(),n(),ee(),l(),U(),X(),ce()})))()}$();export{fe as default};