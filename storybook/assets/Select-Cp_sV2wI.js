...
`]}),`
`,(0,j.jsx)(o,{examples:C,showFullCode:!0}),`
...
`,(0,j.jsx)(r,{of:s,sourceState:`none`}),`
`,(0,j.jsx)(o,{examples:w.required}),`
...
`,(0,j.jsx)(o,{examples:w.state}),`
`,(0,j.jsx)(t.h2,{id:`조합-예시`,children:`조합 예시`}),`
`,(0,j.jsx)(t.p,{children:`제어 값, 필수 선택, 유효성 오류 메시지를 조합한 예시입니다.`}),`
`,(0,j.jsx)(r,{of:f,sourceState:`none`}),`
`,(0,j.jsx)(o,{examples:w.example}),`
`,(0,j.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,j.jsxs)(t.p,{children:[`일반 필드는 `,(0,j.jsx)(t.code,{children:`label[for]`}),`와 `,(0,j.jsx)(t.code,{children:`id`}),`를 연결하고, 보이는 label이 없는 단독 선택은 숨김 label과 select를 암묵적으로 연결합니다. placeholder는 선택할 수 없는 빈 option이며, 오류·성공 상태는 테두리 색과 함께 상태 클래스로 전달합니다.`]}),`
