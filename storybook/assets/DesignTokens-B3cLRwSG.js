import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{d as n,l as r}from"./blocks-DKrjMPN_.js";import{i,r as a}from"./react-CQ14Jk9E.js";import{n as o,t as s}from"./IntroductionCards-DatdkIgS.js";function c(e){let t={code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...i(),...e.components};return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(r,{title:`디자인 토큰`}),`
`,(0,u.jsx)(t.h1,{id:`디자인-토큰`,children:`디자인 토큰`}),`
`,(0,u.jsxs)(t.p,{children:[`색상, 간격, 모서리, 타이포그래피, 모션과 레이아웃 값을 의미 있는 CSS 변수로 관리합니다. 프레임워크가 달라도 같은 토큰을 참조하므로 디자인 변경과 테마 전환이 모든 앱에 일관되게 반영됩니다. 앱별 CSS 연결은 `,(0,u.jsx)(t.strong,{children:`설치 및 사용 › 프레임워크별 스타일 적용`}),`, 간격·타이포 적용 원칙은 `,(0,u.jsx)(t.strong,{children:`가이드라인 › 파운데이션`}),`을 참고합니다.`]}),`
...
`,(0,u.jsxs)(t.p,{children:[(0,u.jsx)(t.code,{children:`:root`}),`와 `,(0,u.jsx)(t.code,{children:`[data-theme="light"]`}),`에는 라이트 테마가, `,(0,u.jsx)(t.code,{children:`[data-theme="dark"]`}),`에는 다크 테마가 적용됩니다. 명시적인 속성이 없으면 `,(0,u.jsx)(t.code,{children:`prefers-color-scheme`}),` 미디어 쿼리가 시스템 설정을 선택합니다. 테마별로는 의미 색상의 값만 달라지고 컴포넌트 선택자와 마크업은 바뀌지 않습니다. 앱에서 `,(0,u.jsx)(t.code,{children:`data-theme`}),`을 설정하는 위치는 `,(0,u.jsx)(t.strong,{children:`설치 및 사용 › 프레임워크별 스타일 적용`}),`을 참고합니다.`]}),`
...
`]})]})}function l(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,u.jsx)(t,{...e,children:(0,u.jsx)(c,{...e})}):c(e)}var u;function d(){return(d=e((()=>{u=t(),a(),n(),o()})))()}d();export{l as default};