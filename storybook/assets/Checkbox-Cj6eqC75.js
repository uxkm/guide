...
`,(0,F.jsx)(o,{examples:E.standalone}),`
...
`,(0,F.jsx)(o,{examples:E.buttonType}),`
...
`,(0,F.jsx)(o,{examples:E.form}),`
`,(0,F.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,F.jsxs)(t.p,{children:[`보이는 레이블은 input과 명시적·암묵적으로 연결하고, 단독 사용은 `,(0,F.jsx)(t.code,{children:`aria-label`}),`로 이름을 제공합니다. 관련 항목은 `,(0,F.jsx)(t.code,{children:`fieldset`}),`과 `,(0,F.jsx)(t.code,{children:`legend`}),`(또는 `,(0,F.jsx)(t.code,{children:`aria-labelledby`}),`)로 그룹 목적을 전달합니다. `,(0,F.jsx)(t.code,{children:`indeterminate`}),`는 DOM `,(0,F.jsx)(t.code,{children:`indeterminate`}),`로 부분 선택을 표현합니다.`]}),`
