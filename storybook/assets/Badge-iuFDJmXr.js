import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{a as n,i as r,n as i,o as a,r as o,s,t as c}from"./Badge.stories-BYO5Dxom.js";import{d as l,i as u,l as d}from"./blocks-DKrjMPN_.js";import{n as f,t as p}from"./FrameworkTabs-duseEU1T.js";import{i as m,r as h}from"./react-CQ14Jk9E.js";import{n as g,t as _}from"./ComponentApiDocs-C9VNL7Yh.js";import{n as v,r as y}from"./dataDisplayApiSections-w1k9tZfi.js";var b;function x(){return(x=e((()=>{b=`<!-- Badge 원본 구현: 데이터 표시 구조와 시각 상태를 공통 CSS 클래스 및 접근성 속성으로 표현합니다. -->
...
</w2:group>`},W=Object.fromEntries(Object.keys(B).map(e=>[e,L(e)]))})))()}function K(e){let t={code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...m(),...e.components};return(0,J.jsxs)(J.Fragment,{children:[(0,J.jsx)(d,{of:c}),`
...
`,(0,J.jsx)(t.li,{children:`상태·개수·알림처럼 짧은 메타에 사용합니다. 필터·선택·닫기 가능한 라벨은 Tag, 사용자 식별은 Avatar를 사용합니다.`}),`
`]}),`
...
`]}),`
`,(0,J.jsx)(p,{examples:z,showFullCode:!0}),`
...
`,(0,J.jsx)(u,{of:i,sourceState:`none`}),`
`,(0,J.jsx)(p,{examples:W.basic}),`
`,(0,J.jsx)(t.h2,{id:`크기`,children:`크기`}),`
`,(0,J.jsx)(t.p,{children:`small, medium, large 세 가지 크기를 제공합니다.`}),`
`,(0,J.jsx)(u,{of:a,sourceState:`none`}),`
`,(0,J.jsx)(p,{examples:W.sizes}),`
...
`,(0,J.jsx)(u,{of:r,sourceState:`none`}),`
`,(0,J.jsx)(p,{examples:W.dot}),`
...
`,(0,J.jsx)(u,{of:o,sourceState:`none`}),`
`,(0,J.jsx)(p,{examples:W.count}),`
...
`,(0,J.jsx)(u,{of:n,sourceState:`none`}),`
`,(0,J.jsx)(p,{examples:W.overlay}),`
`,(0,J.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,J.jsxs)(t.p,{children:[`텍스트 없는 `,(0,J.jsx)(t.code,{children:`dotOnly`}),`는 `,(0,J.jsx)(t.code,{children:`role="status"`}),`와 `,(0,J.jsx)(t.code,{children:`ariaLabel`}),`로 상태 의미를 제공합니다. 카운트·상태 값이 바뀌면 표시 텍스트와 접근성 이름을 함께 갱신합니다. 겹침 대상이 클릭 가능하면 Badge에 별도 클릭을 중복 연결하지 않습니다.`]}),`
`,(0,J.jsx)(_,{sections:v})]})}function q(e={}){let{wrapper:t}={...m(),...e.components};return t?(0,J.jsx)(t,{...e,children:(0,J.jsx)(K,{...e})}):K(e)}var J;function Y(){return(Y=e((()=>{J=t(),h(),l(),f(),g(),G(),y(),s()})))()}Y();export{q as default};