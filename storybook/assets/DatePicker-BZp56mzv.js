...
`]}),`
`,(0,O.jsx)(o,{examples:x,showFullCode:!0}),`
...
`,(0,O.jsx)(o,{examples:b.example}),`
`,(0,O.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,O.jsxs)(t.p,{children:[`트리거 입력은 읽기 전용으로 두고 달력 버튼·패널로 선택을 완료합니다. Escape와 바깥 영역 클릭으로 패널을 닫으며, `,(0,O.jsx)(t.code,{children:`clearable`}),`로 지운 뒤에는 트리거로 포커스를 복원합니다. `,(0,O.jsx)(t.code,{children:`min`}),`·`,(0,O.jsx)(t.code,{children:`max`}),` 밖 날짜는 선택하지 못합니다.`]}),`
`,(0,O.jsx)(v,{sections:w})]})}function D(e={}){let{wrapper:t}={...h(),...e.components};return t?(0,O.jsx)(t,{...e,children:(0,O.jsx)(E,{...e})}):E(e)}var O;function k(){return(k=e((()=>{O=t(),g(),n(),a(),_(),y(),T(),c()})))()}k();export{D as default};