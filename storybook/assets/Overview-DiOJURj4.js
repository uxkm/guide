...
`,(0,u.jsxs)(t.li,{children:[(0,u.jsx)(t.strong,{children:`프레임워크별 구현`}),` — 각 컴포넌트 문서에서 여섯 브라우저 구현과 WebSquare 화면 XML을 비교할 수 있습니다.`]}),`
...
`,(0,u.jsxs)(t.p,{children:[`현재 WebSquare 지원은 별도 실행 앱이나 WebSquare 엔진을 포함하지 않는 `,(0,u.jsx)(t.strong,{children:`코드 예제 지원`}),`입니다. 정적 표현은 공통 CSS와 마크업을 재사용하고, 데이터 바인딩·화면 전환·WebSquare 컴포넌트 이벤트가 필요한 예제는 프로젝트의 `,(0,u.jsx)(t.code,{children:`scwin`}),` 함수와 데이터 객체 규칙에 맞게 연결합니다.`]}),`
`,(0,u.jsxs)(t.p,{children:[`여기서 `,(0,u.jsx)(t.strong,{children:`화면`}),`은 페이지 단위 WebSquare XML 문서이고, `,(0,u.jsx)(t.strong,{children:`scwin`}),`은 WebSquare가 화면에 만들어 주는 기본 스크립트 객체명입니다. 클릭·변경 이벤트는 `,(0,u.jsx)(t.code,{children:`ev:onclick="scwin.btnSave_onclick"`}),`처럼 XML Events로 화면 스크립트에 연결하고, 입력값은 `,(0,u.jsx)(t.code,{children:`ref="data:..."`}),`로 DataMap·DataList 경로에 바인딩합니다. `,(0,u.jsx)(t.code,{children:`scwin`}),`은 `,(0,u.jsx)(t.code,{children:`config.xml`}),`의 SPA `,(0,u.jsx)(t.code,{children:`variable`}),`에서 바꿀 수 있으므로, 프로젝트가 다른 이름을 쓰면 예제를 그 이름에 맞춥니다. UXKM은 공통 화면 스크립트를 제공하지 않으므로 함수 이름, 데이터 객체, 화면 파일 구조는 프로젝트 규칙을 따릅니다. Container·Grid·Flex 같은 구조 컴포넌트는 화면 스크립트나 DataList가 필요하지 않습니다.`]}),`
`,(0,u.jsxs)(t.p,{children:[`자동 변환으로 표현하기 어려운 컴포넌트는 Story에서 `,(0,u.jsx)(t.code,{children:`id: 'websquare'`}),` 전용 예제를 선언해 교체할 수 있습니다.`]}),`
