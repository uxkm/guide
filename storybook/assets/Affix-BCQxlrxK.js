...
`,(0,D.jsxs)(t.li,{children:[`스크롤해도 항상 보여야 하는 툴바·앵커·하단 액션에만 사용합니다. 단순 고정은 CSS `,(0,D.jsx)(t.code,{children:`position: sticky`}),`로 충분할 수 있고, 전역 상단 내비는 Navbar를 우선합니다.`]}),`
`]}),`
...
`]}),`
`,(0,D.jsx)(p,{examples:b,showFullCode:!0}),`
...
`,(0,D.jsx)(u,{of:o,sourceState:`none`}),`
`,(0,D.jsx)(p,{examples:y.basic}),`
`,(0,D.jsx)(t.h2,{id:`상단-오프셋`,children:`상단 오프셋`}),`
`,(0,D.jsx)(u,{of:n,sourceState:`none`}),`
`,(0,D.jsx)(p,{examples:y.offset}),`
`,(0,D.jsx)(t.h2,{id:`앵커-내비게이션`,children:`앵커 내비게이션`}),`
`,(0,D.jsx)(u,{of:i,sourceState:`none`}),`
`,(0,D.jsx)(p,{examples:y.anchor}),`
`,(0,D.jsx)(t.h2,{id:`하단-고정`,children:`하단 고정`}),`
`,(0,D.jsx)(u,{of:r,sourceState:`none`}),`
`,(0,D.jsx)(p,{examples:y.bottom}),`
`,(0,D.jsx)(t.h2,{id:`페이지-스크롤`,children:`페이지 스크롤`}),`
`,(0,D.jsx)(u,{of:a,sourceState:`none`}),`
`,(0,D.jsx)(p,{examples:y.window}),`
`,(0,D.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,D.jsxs)(t.p,{children:[`앵커 스킨에는 목적을 설명하는 `,(0,D.jsx)(t.code,{children:`aria-label`}),`이 있는 `,(0,D.jsx)(t.code,{children:`nav`}),`를 사용합니다. 고정 상태에서도 키보드 포커스 순서와 버튼의 이름은 변하지 않습니다.`]}),`
`,(0,D.jsx)(_,{sections:C})]})}function E(e={}){let{wrapper:t}={...m(),...e.components};return t?(0,D.jsx)(t,{...e,children:(0,D.jsx)(T,{...e})}):T(e)}var D;function O(){return(O=e((()=>{D=t(),h(),l(),f(),g(),v(),w(),s()})))()}O();export{E as default};