...
`]}),`
`,(0,A.jsx)(g,{examples:C,showFullCode:!0}),`
...
`,(0,A.jsx)(p,{of:n,sourceState:`none`}),`
`,(0,A.jsx)(g,{examples:x.closable}),`
`,(0,A.jsx)(t.h2,{id:`액션`,children:`액션`}),`
`,(0,A.jsx)(t.p,{children:`본문 아래 보조 액션 버튼을 배치합니다.`}),`
`,(0,A.jsx)(p,{of:u,sourceState:`none`}),`
`,(0,A.jsx)(g,{examples:x.actions}),`
`,(0,A.jsx)(t.h2,{id:`배너`,children:`배너`}),`
`,(0,A.jsxs)(t.p,{children:[(0,A.jsx)(t.code,{children:`alert_banner`}),`로 전체 너비 배너 형태를 제공합니다.`]}),`
`,(0,A.jsx)(p,{of:c,sourceState:`none`}),`
`,(0,A.jsx)(g,{examples:x.banner}),`
`,(0,A.jsx)(t.h2,{id:`문맥-속-사용`,children:`문맥 속 사용`}),`
`,(0,A.jsx)(t.p,{children:`폼·페이지 문맥에서 검증·안내 메시지를 표시합니다.`}),`
`,(0,A.jsx)(p,{of:s,sourceState:`none`}),`
`,(0,A.jsx)(g,{examples:x.context}),`
`,(0,A.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,A.jsxs)(t.p,{children:[`기본 접근성 역할은 `,(0,A.jsx)(t.code,{children:`role="alert"`}),`이며 의미 색상(`,(0,A.jsx)(t.code,{children:`color_info`}),` 등)과 함께 사용합니다. 닫기 가능한 알림은 닫은 뒤 DOM에서 제거하고 `,(0,A.jsx)(t.code,{children:`close`}),`/`,(0,A.jsx)(t.code,{children:`onClose`}),`를 발생시킵니다.`]}),`
`,(0,A.jsx)(b,{sections:E})]})}function k(e={}){let{wrapper:t}={..._(),...e.components};return t?(0,A.jsx)(t,{...e,children:(0,A.jsx)(O,{...e})}):O(e)}var A;function j(){return(j=e((()=>{A=t(),v(),f(),h(),y(),S(),D(),d()})))()}j();export{k as default};