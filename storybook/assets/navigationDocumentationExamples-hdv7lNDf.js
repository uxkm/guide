...
>
  <div class="navbar_container">
    ...
    <a
      href="#"
      class="navbar_brand{% if brandBackground %} navbar_brand-bg{% endif %}"
      {% if brandBackground %}
      style="--navbar-brand-bg-image: url('{{ brandBackground }}')"
      aria-label="{{ brandAlt | default(brand | default('UXKM')) }}"
      {% endif %}
      >{% if brandBackground %}<span class="navbar_brand-sr">{{ brand | default('UXKM') }}</span>{% elif brandSrc %}<img
        class="navbar_brand-image"
        src="{{ brandSrc }}"
        alt="{{ brandAlt | default(brand | default('')) }}"
      />{% if brand %}{{ brand }}{% endif %}{% else %}{% if brandIcon %}{{ brandIcon | safe }}{% endif %}{{ brand |
      default('UXKM') }}{% endif %}</a
    >
