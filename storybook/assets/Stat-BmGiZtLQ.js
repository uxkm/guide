import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{d as n,i as r,l as i}from"./blocks-DKrjMPN_.js";import{n as a,t as o}from"./FrameworkTabs-duseEU1T.js";import{a as s,c,i as l,l as u,n as d,o as f,r as p,s as m,t as h,u as g}from"./Stat.stories-h5rX2Pzi.js";import{i as _,r as v}from"./react-CQ14Jk9E.js";import{n as y,t as b}from"./ComponentApiDocs-C9VNL7Yh.js";import{i as x,m as S,n as C,p as w,u as T}from"./dataDisplayDocumentationApiSections-CN97v_dN.js";function E(e){let t={code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,..._(),...e.components};return(0,O.jsxs)(O.Fragment,{children:[(0,O.jsx)(i,{of:m}),`
...
`,(0,O.jsx)(t.h2,{id:`사용-기준`,children:`사용 기준`}),`
`,(0,O.jsxs)(t.ul,{children:[`
`,(0,O.jsx)(t.li,{children:`대시보드 핵심 수치·추세 요약에 사용합니다. 본문·액션이 많은 묶음은 Card, 표 형태 수치는 Table을 사용합니다.`}),`
`]}),`
`,(0,O.jsx)(t.h2,{id:`컴포넌트-구현-코드`,children:`컴포넌트 구현 코드`}),`
`,(0,O.jsxs)(t.p,{children:[`아래 코드는 `,(0,O.jsx)(t.code,{children:`Stat`}),` 컴포넌트 자체의 구현입니다. React와 Vue는 prop에 따라 구조·크기·카드 스킨·추세 색상을 선택하고, HTML은 같은 구조를 마크업에 직접 적용하며, Gulp는 `,(0,O.jsx)(t.code,{children:`stat`}),` Nunjucks macro로 동일한 계약을 제공합니다. Next.js는 React 구현을, Nuxt는 Vue 구현을 그대로 재사용합니다.`]}),`
`,(0,O.jsx)(o,{examples:w,showFullCode:!0}),`
...
`,(0,O.jsx)(r,{of:h,sourceState:`none`}),`
`,(0,O.jsx)(o,{examples:S.basic}),`
`,(0,O.jsx)(t.h2,{id:`접두접미`,children:`접두·접미`}),`
`,(0,O.jsx)(t.p,{children:`통화·백분율·단위 등을 값과 분리해 표현합니다.`}),`
`,(0,O.jsx)(r,{of:l,sourceState:`none`}),`
`,(0,O.jsx)(o,{examples:S.prefixSuffix}),`
...
`,(0,O.jsx)(r,{of:d,sourceState:`none`}),`
`,(0,O.jsx)(o,{examples:S.group}),`
`,(0,O.jsx)(t.h2,{id:`접근성`,children:`접근성`}),`
`,(0,O.jsx)(t.p,{children:`라벨·값·접두·접미·추세는 분리된 텍스트로 제공해 보조기술이 수치와 설명을 구분할 수 있게 합니다. 증감 의미는 색상만으로 전달하지 않고 추세 텍스트와 함께 갱신합니다.`}),`
`,(0,O.jsx)(b,{sections:x})]})}function D(e={}){let{wrapper:t}={..._(),...e.components};return t?(0,O.jsx)(t,{...e,children:(0,O.jsx)(E,{...e})}):E(e)}var O;function k(){return(k=e((()=>{O=t(),v(),n(),a(),y(),T(),C(),g()})))()}k();export{D as default};