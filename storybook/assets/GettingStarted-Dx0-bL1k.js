...
`,(0,u.jsxs)(t.p,{children:[`현재 저장소는 `,(0,u.jsx)(t.code,{children:`pnpm`}),` 워크스페이스에서 여섯 브라우저 앱, WebSquare XML 소스 앱과 Storybook을 함께 관리합니다. 기존 프레임워크별 Storybook의 설치 안내를 통합 저장소의 실제 스크립트와 경로 기준으로 정리했습니다.`]}),`
