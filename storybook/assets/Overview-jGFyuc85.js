...
`,(0,u.jsxs)(t.p,{children:[`HTML, Gulp/Nunjucks, Vue, React, Nuxt, Next.js에서 같은 디자인 언어와 컴포넌트 API를 제공하는 통합 UI 가이드입니다. 기존 `,(0,u.jsx)(t.code,{children:`gulp-storybook`}),`, `,(0,u.jsx)(t.code,{children:`vue-storybook`}),`, `,(0,u.jsx)(t.code,{children:`react-storybook`}),`의 소개 내용을 현재 모노레포 구조에 맞춰 한곳에 모았습니다.`]}),`
...
`,(0,u.jsxs)(t.li,{children:[(0,u.jsx)(t.strong,{children:`프레임워크별 구현`}),` — 각 컴포넌트 문서에서 여섯 프레임워크의 구현 방식을 비교할 수 있습니다.`]}),`
...
`,(0,u.jsx)(s,{columns:[{label:`프레임워크`},{label:`앱`},{label:`구현 기준`},{label:`역할`}],rows:[[`HTML`,`@uxkm/html`,`HTML · CSS · JavaScript`,`프레임워크 없는 기본 마크업`],[`Gulp / Nunjucks`,`@uxkm/gulp`,`Nunjucks · Gulp`,`정적 템플릿 기반 가이드`],[`Vue`,`@uxkm/vue`,`Vue 3 · Vite`,`Vue 컴포넌트 원본`],[`React`,`@uxkm/react`,`React · Vite`,`React 컴포넌트 원본`],[`Nuxt`,`@uxkm/nuxt`,`Vue · Nuxt`,`Vue 컴포넌트의 Nuxt 통합`],[`Next.js`,`@uxkm/next`,`React · App Router`,`React 컴포넌트의 Next.js 통합`]],codeColumns:[1]}),`
