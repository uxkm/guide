...
`,(0,d.jsx)(o,{label:`프레임워크별 회원가입 데모`,columns:[`프레임워크`,`로컬 실행 명령`,`데모 페이지`],rows:[[`Gulp / Nunjucks`,`pnpm dev:gulp`,(0,d.jsx)(t.a,{href:`/apps/gulp/signup.html`,target:`_blank`,rel:`noopener noreferrer`,children:`Gulp 회원가입 데모 (새 창)`})],[`Vue`,`pnpm dev:vue`,(0,d.jsx)(t.a,{href:`/apps/vue/signup/`,target:`_blank`,rel:`noopener noreferrer`,children:`Vue 회원가입 데모 (새 창)`})],[`React`,`pnpm dev:react`,(0,d.jsx)(t.a,{href:`/apps/react/signup/`,target:`_blank`,rel:`noopener noreferrer`,children:`React 회원가입 데모 (새 창)`})]],codeColumns:[1]}),`
