import{d as La,r as M,u as Pa,c as Fa,n as Ma,j as a,a as D,b as Da}from"./iframe-DS-82CEY.js";import{F as A}from"./FormLayout-2QMxR3Rv.js";import{w as r}from"./story-renders-DjJEfxtm.js";import{f as Ia,a as Ba}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const Ta=Da("Radio",{booleanProps:new Set(["checked","disabled","labelEnd","button","ripple"]),selfClosing:!0});function e({ripple:d,label:o,name:i,checked:n,defaultChecked:t,disabled:m,value:p,labelEnd:s,button:l,ariaLabel:u,children:c,className:b,onChange:E,id:B,...T}){const{rippleAttrs:za}=La({ripple:d},{defaultEnabled:!1}),_=M.useRef(null),h=c??o,L=!(!!o||c!=null&&c!==""),W=M.useMemo(()=>d===!1?{"data-ripple":"false"}:d===!0||L||l?{"data-ripple":"true"}:{},[d,L,l]);Pa(Ta,{ripple:d,label:o,name:i,checked:n,disabled:m,value:p,labelEnd:s,button:l,ariaLabel:u},Fa({default:h}),_,{className:b,id:B,onChange:E,...T});const U=M.useMemo(()=>{const F=["radio"];return s&&F.push("radio_label-end"),l&&F.push("radio_button"),F},[s,l]),{class:Qa,...Ca}=T,Sa=Ma(Ca),Ea=E!=null?{checked:!!n,onChange:E}:n!=null?{defaultChecked:!!n}:t!=null?{defaultChecked:!!t}:{},P=a.jsx("input",{id:B,type:"radio",className:"radio_input",name:i,value:p,disabled:m,...Ea,...Sa});return L?a.jsxs("label",{ref:_,className:D("radio_control",b),"aria-label":u,...W,children:[P,a.jsx("span",{className:"radio_box","aria-hidden":"true"})]}):l?a.jsxs("label",{ref:_,className:D(U,b),...W,children:[P,a.jsx("span",{className:"radio_label",children:h})]}):a.jsxs("label",{ref:_,className:D(U,b),...za,children:[s?a.jsx("span",{className:"radio_label",children:h}):null,a.jsxs("span",{className:"radio_control",children:[P,a.jsx("span",{className:"radio_box","aria-hidden":"true"})]}),s?null:a.jsx("span",{className:"radio_label",children:h})]})}e.__docgenInfo={description:"",methods:[],displayName:"Radio"};const Wa=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Ua=[{name:"label",type:"string",default:"—",description:"라벨 텍스트. children으로 대체"},{name:"name",type:"string",default:"—",description:"radio 그룹 name 속성"},{name:"value",type:"string",default:"—",description:"radio value 속성"},{name:"checked",type:"boolean",default:"false",description:"선택 상태"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"labelEnd",type:"boolean",default:"false",description:"라벨을 라디오 앞에 배치"},{name:"button",type:"boolean",default:"false",description:"버튼형 (radio_button)"},{name:"ariaLabel",type:"string",default:"—",description:"라벨 없는 단독 라디오 시 필수"},{name:"className",type:"string",default:"—",description:"radio 루트에 추가 클래스"},{name:"onChange",type:"(event) => void",default:"—",description:"선택 상태 변경 콜백"},Ia],Aa=[{key:"name",label:"Children"},{key:"description",label:"설명"}],Va=[{name:"label",description:"라벨 텍스트. children으로 대체 가능"},{name:"children",description:"라벨 텍스트 (label prop 대체, Vue default 슬롯 대응). radio_content · radio_hint 조합 가능"}],Ga=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Xa=[{name:"radio",description:"라디오 래퍼"},{name:"radio_control · radio_input · radio_box",description:"입력·커스텀 원"},{name:"radio_label",description:"라벨"},{name:"radio_label-end · radio_button",description:"레이아웃 변형"},{name:"radio_group",description:"fieldset 그룹"},{name:"radio_card · radio_card-clickable",description:"카드형 — clickable은 data-ripple + JS 위임"},...Ba],Ja=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Oa=[{name:"--radio-size · --radio-size-sm · --radio-size-lg",default:"var(--checkbox-size) · … · …",description:"라디오 원 크기 (checkbox 토큰 참조)"},{name:"--radio-gap · --radio-gap-sm · --radio-gap-lg",default:"var(--checkbox-gap) · … · …",description:"라벨 간격"},{name:"--radio-font-size · --radio-line-height",default:"var(--checkbox-font-size) · var(--checkbox-line-height)",description:"라벨 타이포"},{name:"--radio-label-weight · --radio-hint-size",default:"var(--checkbox-label-weight) · var(--checkbox-hint-size)",description:"라벨·힌트"},{name:"--radio-control-offset",default:"var(--checkbox-control-offset)",description:"원 수직 정렬"},{name:"--radio-group-gap",default:"var(--checkbox-group-gap)",description:"그룹 간격"},{name:"--radio-button-padding-y · --radio-button-padding-x",default:"var(--checkbox-button-padding-y) · var(--checkbox-button-padding-x)",description:"버튼형 패딩"}],Ha=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. HTML·Vue 문서의 kebab-case(예: label-end, aria-label)와 동일한 의미입니다.",tables:[{columns:Wa,rows:Ua,codeColumn:"name"}]},{title:"API · Children",description:"Vue default 슬롯에 대응하는 React label·children prop입니다.",tables:[{columns:Aa,rows:Va,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Ga,rows:Xa,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Ja,rows:Oa,codeColumn:"name"}]}],$a={label:"라벨",name:"playground",checked:!1,disabled:!1,value:"1",labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},de={title:"Components/폼/Radio",id:"components-radio",component:e,tags:["autodocs"],argTypes:{label:{control:"text",type:{name:"string",summary:"string"}},name:{control:"text",type:{name:"string",summary:"string"}},checked:{control:"boolean",type:{name:"boolean",summary:"boolean"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},value:{control:"text",type:{name:"string",summary:"string"}},labelEnd:{control:"boolean",type:{name:"boolean",summary:"boolean"}},button:{control:"boolean",type:{name:"boolean",summary:"boolean"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Ha,docs:{description:{component:"단일 선택이 가능한 라디오 버튼 컴포넌트입니다."}}}},g={parameters:{controls:{disable:!1}},args:{...$a},render:(d,{updateArgs:o})=>a.jsx(e,{...d,onChange:i=>o({checked:i.target.checked})})},f={name:"유형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"기본은 wrapping `label.radio` 안에 `span.radio_control` + `span.radio_label` 순서입니다. 보이는 레이블이 없으면 `label.radio_control`로 input을 암묵 연결합니다. `radio_label-end`는 레이블 → 라디오 순서이며, 기본 너비는 콘텐츠 기준입니다."},source:{code:`import Radio from '@uxkm/ui-react/components/Radio.jsx';
...
}`,...(ra=(ea=N.parameters)==null?void 0:ea.docs)==null?void 0:ra.source}}};var da,oa,la;k.parameters={...k.parameters,docs:{...(da=k.parameters)==null?void 0:da.docs,source:{originalSource:`{
  name: '크기',
  parameters: {
    controls: {
      disable: false
...
}`,...(la=(oa=k.parameters)==null?void 0:oa.docs)==null?void 0:la.source}}};var ia,sa,na;y.parameters={...y.parameters,docs:{...(ia=y.parameters)==null?void 0:ia.docs,source:{originalSource:`{
  name: '너비',
  parameters: {
    controls: {
      disable: false
...
}`,...(na=(sa=y.parameters)==null?void 0:sa.docs)==null?void 0:na.source}}};var ca,ta,ma;R.parameters={...R.parameters,docs:{...(ca=R.parameters)==null?void 0:ca.docs,source:{originalSource:`{
  name: '색상',
  parameters: {
    controls: {
      disable: false
...
}`,...(ma=(ta=R.parameters)==null?void 0:ta.docs)==null?void 0:ma.source}}};var pa,ua,ba;j.parameters={...j.parameters,docs:{...(pa=j.parameters)==null?void 0:pa.docs,source:{originalSource:`{
  name: '상태',
  parameters: {
    controls: {
      disable: false
...
}`,...(va=(xa=z.parameters)==null?void 0:xa.docs)==null?void 0:va.source}}};var Na,ka,ya;C.parameters={...C.parameters,docs:{...(Na=C.parameters)==null?void 0:Na.docs,source:{originalSource:`{
  name: '카드형',
  parameters: {
    controls: {
      disable: false
...
}`,...(ya=(ka=C.parameters)==null?void 0:ka.docs)==null?void 0:ya.source}}};var Ra,ja,wa;S.parameters={...S.parameters,docs:{...(Ra=S.parameters)==null?void 0:Ra.docs,source:{originalSource:`{
  name: '폼 레이아웃',
  parameters: {
    controls: {
      disable: false
...
}`,...(wa=(ja=S.parameters)==null?void 0:ja.docs)==null?void 0:wa.source}}};const oe=["Playground","Type","LabelEnd","Basic","Standalone","Size","Width","Color","State","Group","ButtonType","CardType","Form"];export{v as Basic,z as ButtonType,C as CardType,R as Color,S as Form,w as Group,x as LabelEnd,g as Playground,k as Size,N as Standalone,j as State,f as Type,y as Width,oe as __namedExportsOrder,de as default};
