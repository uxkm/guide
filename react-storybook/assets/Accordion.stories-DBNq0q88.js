...
}`,language:"tsx"}}},render:f(e.jsxs(d,{variant:"bordered",narrow:!0,children:[e.jsx(n,{label:"알림",open:!0,content:"이메일·푸시 알림 수신 여부를 설정합니다."}),e.jsx(n,{label:"개인정보",content:"프로필 공개 범위와 데이터 다운로드를 관리합니다."}),e.jsx(n,{label:"보안",content:"비밀번호 변경과 2단계 인증을 설정합니다."})]}))},O={name:"보조 정보",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"extra prop으로 배지·메타 텍스트를 트리거 오른쪽에 배치합니다."},source:{code:`import Accordion from '@uxkm/ui-react/components/Accordion.jsx';
import AccordionItem from '@uxkm/ui-react/components/AccordionItem.jsx';
...
}`,...(re=(oe=N.parameters)==null?void 0:oe.docs)==null?void 0:re.source}}};var ne,ce,te;M.parameters={...M.parameters,docs:{...(ne=M.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  name: '보더',
  parameters: {
    controls: {
      disable: false
...
}`,...(te=(ce=M.parameters)==null?void 0:ce.docs)==null?void 0:te.source}}};var ae,se,ie;O.parameters={...O.parameters,docs:{...(ae=O.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  name: '보조 정보',
  parameters: {
    controls: {
      disable: false
...
}`,...(ie=(se=O.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var de,le,me;B.parameters={...B.parameters,docs:{...(de=B.parameters)==null?void 0:de.docs,source:{originalSource:`{
  name: '비활성',
  parameters: {
    controls: {
      disable: false
...
}`,...(me=(le=B.parameters)==null?void 0:le.docs)==null?void 0:me.source}}};var pe,ue,be;T.parameters={...T.parameters,docs:{...(pe=T.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  name: '크기',
  parameters: {
    controls: {
      disable: false
...
}`,...(be=(ue=T.parameters)==null?void 0:ue.docs)==null?void 0:be.source}}};const qe=["Playground","Basic","Multiple","Flush","Bordered","Extra","Disabled","Size"];export{E as Basic,M as Bordered,B as Disabled,O as Extra,N as Flush,D as Multiple,R as Playground,T as Size,qe as __namedExportsOrder,$e as default};
