import{j as e,B as h}from"./iframe-DS-82CEY.js";import{F as le}from"./FormLayout-2QMxR3Rv.js";import{S as l}from"./Select-3arHRQ3Q.js";import{w as t}from"./story-renders-DjJEfxtm.js";import{e as te,a as oe}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const se=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ie=[{name:"value",type:"string | number",default:"—",description:"제어 컴포넌트 값 (Vue model-value 대응)"},{name:"defaultValue",type:"string | number",default:"—",description:"비제어 초기 값"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"input_sm · btn_sm 등 크기"},{name:"listSize",type:"number",default:"—",description:"네이티브 size — multiple 표시 행 수"},{name:"placeholder",type:"string",default:"—",description:"미선택 placeholder"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"error",type:"boolean",default:"false",description:"오류 상태 (is-error)"},{name:"open",type:"boolean",default:"false",description:"custom 트리거 열림 (is-open)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100%"},{name:"custom",type:"boolean",default:"false",description:"button 트리거 + listbox 패턴"},{name:"selectText",type:"boolean",default:"false",description:"텍스트형 트리거 (btn_select-text)"},{name:"className",type:"string",default:"—",description:"select/input 또는 custom 트리거에 추가 클래스"},{name:"onChange",type:"(event) => void",default:"—",description:"값 변경 콜백 (Vue update:modelValue 대응)"},te],ae=[{key:"name",label:"Children"},{key:"description",label:"설명"}],re=[{name:"default",description:"option 요소 또는 custom 트리거 라벨"}],ce=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],ne=[{name:"input (native)",description:"네이티브 select 스타일"},{name:"btn_select · btn_select-text · btn_select-caret",description:"custom 트리거"},{name:"btn_select-placeholder · is-open",description:"트리거 상태"},{name:"select_dropdown · select_option",description:"드롭다운 패널 (HTML 마크업)"},{name:"is-error · is-disabled",description:"상태"},...oe],de=[{key:"name",label:"이벤트"},{key:"description",label:"설명"}],pe=[{name:"onChange",description:"선택 값 변경 시 (Vue update:modelValue 대응)"}],me=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ue=[{name:"--select-padding-right · --select-padding-right-sm · --select-padding-right-lg",default:"2.25rem · 2rem · 2.5rem",description:"캐럿 공간(우측 패딩)"},{name:"--select-caret-offset · --select-caret-offset-sm · --select-caret-offset-lg",default:"0.65rem · 0.5rem · 0.85rem",description:"캐럿 위치"},{name:"--select-caret-size · --select-caret-size-sm · --select-caret-size-lg",default:"1em · 0.875em · 1.125em",description:"캐럿 아이콘 크기"}],fe=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 model-value · select-text · list-size는 value · selectText · listSize로 다룹니다.",tables:[{columns:se,rows:ie,codeColumn:"name"}]},{title:"API · Children",description:"Vue default 슬롯에 대응하는 React children입니다.",tables:[{columns:ae,rows:re,codeColumn:"name"}]},{title:"API · Events",description:"Vue update:modelValue는 React onChange(event)에 대응합니다.",tables:[{columns:de,rows:pe,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ce,rows:ne,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:me,rows:ue,codeColumn:"name"}]}],be={size:"md",disabled:!1,error:!1,placeholder:"선택하세요",open:!0,block:!1,custom:!1,selectText:!1},je={title:"Components/폼/Select",id:"components-select",component:l,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placeholder:{control:"text",type:{name:"string",summary:"string"}},open:{control:"boolean",type:{name:"boolean",summary:"boolean"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},custom:{control:"boolean",type:{name:"boolean",summary:"boolean"}},selectText:{control:"boolean",type:{name:"boolean",summary:"boolean"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:fe,docs:{description:{component:"네이티브 select와 커스텀 트리거를 제공하는 Select 컴포넌트입니다."}}}},o={parameters:{controls:{disable:!1}},args:{...be},render:(b,{updateArgs:$})=>b.custom?e.jsx(l,{...b}):e.jsxs(l,{...b,onChange:ee=>$({value:ee.target.value}),children:[e.jsx("option",{value:"1",children:"옵션 1"}),e.jsx("option",{value:"2",children:"옵션 2"})]})},s={name:"유형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"네이티브 select는 브라우저 기본 목록을 사용합니다. 커스텀 트리거는 Dropdown·Popover와 조합해 검색·다중 선택 등 확장 UI에 적합합니다."},source:{code:`import Select from '@uxkm/ui-react/components/Select.jsx';
...
}`,...(v=(_=o.parameters)==null?void 0:_.docs)==null?void 0:v.source}}};var S,N,j;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: '유형',
  parameters: {
    controls: {
      disable: false
...
}`,...(j=(N=s.parameters)==null?void 0:N.docs)==null?void 0:j.source}}};var g,y,w;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: false
...
}`,...(w=(y=i.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var k,z,F;a.parameters={...a.parameters,docs:{...(k=a.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: '단독 사용',
  parameters: {
    controls: {
      disable: false
...
}`,...(F=(z=a.parameters)==null?void 0:z.docs)==null?void 0:F.source}}};var C,P,E;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: '크기',
  parameters: {
    controls: {
      disable: false
...
}`,...(E=(P=r.parameters)==null?void 0:P.docs)==null?void 0:E.source}}};var q,T,B;c.parameters={...c.parameters,docs:{...(q=c.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: '너비',
  parameters: {
    controls: {
      disable: false
...
}`,...(B=(T=c.parameters)==null?void 0:T.docs)==null?void 0:B.source}}};var V,R,L;n.parameters={...n.parameters,docs:{...(V=n.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: '플레이스홀더',
  parameters: {
    controls: {
      disable: false
...
}`,...(L=(R=n.parameters)==null?void 0:R.docs)==null?void 0:L.source}}};var D,A,U;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: '옵션 그룹',
  parameters: {
    controls: {
      disable: false
...
}`,...(U=(A=d.parameters)==null?void 0:A.docs)==null?void 0:U.source}}};var M,I,X;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: '다중 선택',
  parameters: {
    controls: {
      disable: false
...
}`,...(X=(I=p.parameters)==null?void 0:I.docs)==null?void 0:X.source}}};var O,W,H;m.parameters={...m.parameters,docs:{...(O=m.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: '상태',
  parameters: {
    controls: {
      disable: false
...
}`,...(H=(W=m.parameters)==null?void 0:W.docs)==null?void 0:H.source}}};var G,J,K;u.parameters={...u.parameters,docs:{...(G=u.parameters)==null?void 0:G.docs,source:{originalSource:`{
  name: '커스텀 트리거',
  parameters: {
    controls: {
      disable: false
...
}`,...(K=(J=u.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var Q,Y,Z;f.parameters={...f.parameters,docs:{...(Q=f.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  name: '조합 예시',
  parameters: {
    controls: {
      disable: false
...
}`,...(Z=(Y=f.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};const ge=["Playground","Type","Basic","Standalone","Size","Width","Placeholder","Optgroup","Multiple","State","Custom","Example"];export{i as Basic,u as Custom,f as Example,p as Multiple,d as Optgroup,n as Placeholder,o as Playground,r as Size,a as Standalone,m as State,s as Type,c as Width,ge as __namedExportsOrder,je as default};
