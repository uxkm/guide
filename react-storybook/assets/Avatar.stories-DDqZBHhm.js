import{r as F,u as T,c as V,n as W,j as a,a as M,b as O,I as B}from"./iframe-DS-82CEY.js";import{a as d}from"./avatar-sample-Dq40Sw96.js";import{A as r}from"./Avatar-DeSaEyhK.js";import{w as e,b as U}from"./story-renders-DjJEfxtm.js";import"./preload-helper-DUxc-Dqw.js";const J=O("AvatarGroup",{selfClosing:!1});function m({ariaLabel:p,children:u,className:v,...g}){const A=F.useRef(null);T(J,{ariaLabel:p},V({default:u}),A,{className:v,...g});const N=W(g);return a.jsx("div",{ref:A,className:M("avatar_group",v),"aria-label":p,...N,children:u})}m.__docgenInfo={description:"",methods:[],displayName:"AvatarGroup"};const K=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Q=[{name:"src",type:"string",default:"—",description:"이미지 URL (avatar_image)"},{name:"alt",type:"string",default:"—",description:"이미지 대체 텍스트"},{name:"initials",type:"string",default:"—",description:"이니셜 텍스트 (이미지·아이콘 없을 때)"},{name:"color",type:"string",default:"—",description:"이니셜·아이콘 배경 color_*"},{name:"size",type:"'sm' | 'md' | 'lg' | 'xl'",default:"md",description:"avatar_sm · avatar_lg · avatar_xl"},{name:"square",type:"boolean",default:"false",description:"사각형 모서리 (avatar_square)"},{name:"badgeColor",type:"string",default:"—",description:"상태 점 색상 (avatar_badge)"},{name:"badgeLabel",type:"string",default:"—",description:"상태 점 aria-label"},{name:"ariaHidden",type:"boolean",default:"false",description:"그룹 내 장식용 아바타"}],X=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Y=[{name:"ariaLabel",type:"string",default:"—",description:"그룹 접근성 라벨 (권장)"}],Z=[{key:"name",label:"Children / Prop"},{key:"description",label:"설명"}],$=[{name:"initials",description:"이니셜 텍스트 (이미지·아이콘 없을 때)"},{name:"icon",description:"아이콘 콘텐츠 (Vue #icon 슬롯 대응, avatar_icon 클래스)"}],aa=[{key:"name",label:"Children / Prop"},{key:"description",label:"설명"}],ra=[{name:"children",description:"Avatar 자식 목록 (Vue default 슬롯 대응)"}],ea=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],ia=[{name:"avatar",description:"아바타 루트 (원형)"},{name:"avatar_image",description:"프로필 이미지"},{name:"avatar_icon",description:"아이콘 크기"},{name:"avatar_badge",description:"상태 점"},{name:"avatar_sm · avatar_lg · avatar_xl",description:"크기 변형"},{name:"avatar_square",description:"사각형"},{name:"avatar_group",description:"겹침 그룹 컨테이너"},{name:"color_*",description:"공통 색상 유틸"}],oa=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ta=[{name:"--avatar-size-sm · --avatar-size · --avatar-size-lg · --avatar-size-xl",default:"1.5rem · 2rem · 2.5rem · 3.5rem",description:"아바타 지름"},{name:"--avatar-group-overlap",default:"-0.5rem",description:"그룹 겹침 오프셋"},{name:"--avatar-badge-size · --avatar-badge-size-sm · --avatar-badge-size-lg",default:"8px · 6px · 10px",description:"상태 점 크기"}],sa=[{title:"API · Avatar Props",description:"React에서는 camelCase prop을 사용합니다. HTML·Vue 문서의 kebab-case(예: badge-color → badgeColor, aria-hidden → ariaHidden)와 동일한 의미입니다.",tables:[{columns:K,rows:Q,codeColumn:"name"}]},{title:"API · AvatarGroup Props",description:"React에서는 camelCase prop을 사용합니다. HTML·Vue 문서의 kebab-case(예: aria-label → ariaLabel)와 동일한 의미입니다.",tables:[{columns:X,rows:Y,codeColumn:"name"}]},{title:"API · Avatar Children",description:"Vue 슬롯(icon)에 대응하는 React prop입니다.",tables:[{columns:Z,rows:$,codeColumn:"name"}]},{title:"API · AvatarGroup Children",description:"Vue default 슬롯에 대응하는 React children입니다.",tables:[{columns:aa,rows:ra,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ea,rows:ia,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:oa,rows:ta,codeColumn:"name"}]}],na={src:d,alt:"홍길동",initials:"홍",color:"primary",size:"md",square:!1,badgeColor:"",badgeLabel:"온라인",ariaHidden:!1},ua={title:"Components/데이터 표시/Avatar",id:"components-avatar",component:r,tags:["autodocs"],argTypes:{src:{control:"text",type:{name:"string",summary:"string"}},alt:{control:"text",type:{name:"string",summary:"string"}},initials:{control:"text",type:{name:"string",summary:"string"}},color:{control:"select",options:["default","primary","success","warning","danger","info"],type:{name:"enum",summary:"'default' | 'primary' | 'success' | 'warning' | 'danger' | 'info'"}},size:{control:"select",options:["sm","md","lg","xl"],type:{name:"enum",summary:"'sm' | 'md' | 'lg' | 'xl'"}},square:{control:"boolean",type:{name:"boolean",summary:"boolean"}},badgeColor:{control:"select",options:["","success","warning","danger"],labels:{"":"없음",success:"success",warning:"warning",danger:"danger"},type:{name:"enum",summary:"'success' | 'warning' | 'danger'"}},badgeLabel:{control:"text",type:{name:"string",summary:"string"}},ariaHidden:{control:"boolean",type:{name:"boolean",summary:"boolean"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:sa,docs:{description:{component:"사용자·엔티티를 나타내는 프로필 이미지, 이니셜, 아이콘 표시 컴포넌트입니다."}}}},i={parameters:{controls:{disable:!1}},args:{...na},render:U(r)},o={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"이미지, 이니셜 텍스트, 아이콘 세 가지 형태를 지원합니다."},source:{code:`import Avatar from '@uxkm/ui-react/components/Avatar.jsx';
...
}`,...(P=(S=s.parameters)==null?void 0:S.docs)==null?void 0:P.source}}};var G,L,z;n.parameters={...n.parameters,docs:{...(G=n.parameters)==null?void 0:G.docs,source:{originalSource:`{
  name: '색상',
  parameters: {
    controls: {
      disable: false
...
}`,...(z=(L=n.parameters)==null?void 0:L.docs)==null?void 0:z.source}}};var h,I,E;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: '상태 배지',
  parameters: {
    controls: {
      disable: false
