import{d as fe,r as R,u as xe,c as Ee,n as ye,j as e,a as Ne,b as je}from"./iframe-DS-82CEY.js";import{F as M}from"./FormLayout-2QMxR3Rv.js";import{w as a}from"./story-renders-DjJEfxtm.js";import{r as ve,a as Le}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const Ce=new Set(["sm","md","lg"]),ze=je("Switch",{defaults:{size:"md"},booleanProps:new Set(["checked","disabled","labelEnd","ripple"]),selfClosing:!1});function l({ripple:r,label:c,checked:s,defaultChecked:y,disabled:N,labelEnd:t,size:j="md",ariaLabel:v,children:k,className:L,onChange:f,id:C,name:z,value:F,...P}){const{rippleAttrs:ue}=fe({ripple:r}),W=R.useRef(null),i=Ce.has(j)?j:"md",x=k??c,E=!!c||k!=null&&k!=="";xe(ze,{ripple:r,label:c,checked:s,disabled:N,labelEnd:t,size:i,ariaLabel:v},Ee({default:x}),W,{className:L,id:C,name:z,value:F,onChange:f,...P});const _e=R.useMemo(()=>{const n=["switch"];return t&&n.push("switch_label-end"),i==="sm"&&n.push("switch_sm"),i==="lg"&&n.push("switch_lg"),n},[t,i]),{class:Ve,...ge}=P,Se=ye(ge),ke=f!=null?{checked:!!s,onChange:f}:s!=null?{defaultChecked:!!s}:y!=null?{defaultChecked:!!y}:{},D=E?void 0:v;return e.jsxs("label",{ref:W,className:Ne(_e,L),"aria-label":D,...ue,children:[E&&t?e.jsx("span",{className:"switch_label",children:x}):null,e.jsxs("span",{className:"switch_control",children:[e.jsx("input",{id:C,type:"checkbox",className:"switch_input",role:"switch",name:z,value:F,disabled:N,"aria-label":D,...ke,...Se}),e.jsx("span",{className:"switch_track","aria-hidden":"true",children:e.jsx("span",{className:"switch_thumb"})})]}),E&&!t?e.jsx("span",{className:"switch_label",children:x}):null]})}l.__docgenInfo={description:"",methods:[],displayName:"Switch",props:{size:{defaultValue:{value:"'md'",computed:!1},required:!1}}};const Fe=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Pe=[{name:"label",type:"string",default:"—",description:"라벨 텍스트. children으로 대체"},{name:"checked",type:"boolean",default:"false",description:"켜짐 상태"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"labelEnd",type:"boolean",default:"false",description:"라벨을 스위치 뒤에 배치"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"switch_sm · switch_lg"},{name:"ariaLabel",type:"string",default:"—",description:"라벨 없을 때 접근성 라벨"},{name:"className",type:"string",default:"—",description:"switch 루트에 추가 클래스"},{name:"onChange",type:"(event) => void",default:"—",description:"상태 변경 콜백"},ve],We=[{key:"name",label:"Children"},{key:"description",label:"설명"}],De=[{name:"label",description:"라벨 텍스트. children으로 대체 가능"},{name:"children",description:"라벨 텍스트 (label prop 대체, Vue default 슬롯 대응). switch_content · switch_hint 조합 가능"}],Re=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Me=[{name:"switch",description:"스위치 루트 label"},{name:"switch_sm · switch_lg · switch_label-end",description:"크기·레이아웃"},{name:"switch_control · switch_input · switch_track · switch_thumb",description:"입력·트랙"},{name:"switch_label",description:"라벨"},{name:"switch_group",description:"여러 스위치 묶음"},...Le],Ae=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Te=[{name:"--switch-width · --switch-height",default:"2.75rem · 1.5rem",description:"트랙 크기 (md)"},{name:"--switch-width-sm · --switch-width-lg",default:"2.25rem · 3.25rem",description:"크기 변형"},{name:"--switch-gap · --switch-radius",default:"—",description:"라벨 간격·모서리"}],Be=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. HTML·Vue 문서의 kebab-case(예: label-end, aria-label)와 동일한 의미입니다.",tables:[{columns:Fe,rows:Pe,codeColumn:"name"}]},{title:"API · Children",description:"Vue default 슬롯에 대응하는 React label·children prop입니다.",tables:[{columns:We,rows:De,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Re,rows:Me,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Ae,rows:Te,codeColumn:"name"}]}],Ie={label:"라벨",checked:!1,disabled:!1,labelEnd:!1,size:"md",ariaLabel:"접근성 라벨"},Je={title:"Components/폼/Switch",id:"components-switch",component:l,tags:["autodocs"],argTypes:{label:{control:"text",type:{name:"string",summary:"string"}},checked:{control:"boolean",type:{name:"boolean",summary:"boolean"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},labelEnd:{control:"boolean",type:{name:"boolean",summary:"boolean"}},size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Be,docs:{description:{component:"켜짐·꺼짐을 전환하는 Switch 컴포넌트입니다."}}}},o={parameters:{controls:{disable:!1}},args:{...Ie},render:(r,{updateArgs:c})=>e.jsx(l,{...r,onChange:s=>c({checked:s.target.checked})})},d={name:"유형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"기본은 `switch_control` → `switch_label` 순서입니다. `switch_label-end`는 레이블 → 스위치 순서이며, 설정 화면에서 자주 사용합니다."},source:{code:`import Switch from '@uxkm/ui-react/components/Switch.jsx';
