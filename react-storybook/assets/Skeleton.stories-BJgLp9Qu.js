import{r as h,u as z,c as G,n as J,j as e,a as n,b as K}from"./iframe-DS-82CEY.js";import{w as p}from"./story-renders-DjJEfxtm.js";import"./preload-helper-DUxc-Dqw.js";const Q=K("Skeleton",{defaults:{active:!0},booleanProps:new Set(["active","avatar","round"]),selfClosing:!1}),S=["","skeleton_w-md","skeleton_w-sm"];function U(a){return a===!0?3:typeof a=="number"?a:0}function s({active:a=!0,avatar:u,paragraph:x=!1,round:f,ariaLabel:g="콘텐츠 로딩 중",children:v,className:_,style:b,...y}){const w=h.useRef(null),k=U(x);z(Q,{active:a,avatar:u,paragraph:x,round:f,ariaLabel:g},G({default:v}),w,{className:_,style:b,...y});const O=h.useMemo(()=>{const t=["skeleton_group"];return a||t.push("skeleton_static"),t},[a]),o=h.useMemo(()=>{const t=["skeleton"];return a||t.push("skeleton_static"),t},[a]),{class:re,...q}=y,H=J(q),M=!!(u||f);return e.jsxs("div",{ref:w,className:n(O,_),style:b,role:"status","aria-live":"polite","aria-busy":"true","aria-label":g,...H,children:[M?u?e.jsxs("div",{className:"skeleton_row",children:[e.jsx("span",{className:n(o,"skeleton_circle"),"aria-hidden":"true"}),k>0?e.jsx("div",{className:"skeleton_row-body",children:Array.from({length:k},(t,r)=>e.jsx("span",{className:n(o,"skeleton_text",S[r]||"skeleton_w-lg"),"aria-hidden":"true"},r))}):null]}):e.jsx("span",{className:n(o,"skeleton_circle"),"aria-hidden":"true"}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:n(o,"skeleton_title"),"aria-hidden":"true"}),Array.from({length:k||3},(t,r)=>e.jsx("span",{className:n(o,"skeleton_text",S[r]||""),"aria-hidden":"true"},r))]}),v]})}s.__docgenInfo={description:"",methods:[],displayName:"Skeleton",props:{active:{defaultValue:{value:"true",computed:!1},required:!1},paragraph:{defaultValue:{value:"false",computed:!1},required:!1},ariaLabel:{defaultValue:{value:"'콘텐츠 로딩 중'",computed:!1},required:!1}}};const X=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Y=[{name:"active",type:"boolean",default:"true",description:"쉬머 애니메이션. false면 skeleton_static"},{name:"avatar",type:"boolean",default:"false",description:"아바타 + 본문 행 레이아웃"},{name:"paragraph",type:"boolean | number",default:"false",description:"본문 줄 수. true면 3줄"},{name:"round",type:"boolean",default:"false",description:"원형만 표시"},{name:"ariaLabel",type:"string",default:"콘텐츠 로딩 중",description:"role=status 라벨"},{name:"className",type:"string",default:"—",description:"skeleton_group 루트에 추가 클래스"}],Z=[{key:"name",label:"Children"},{key:"description",label:"설명"}],$=[{name:"children",description:"커스텀 skeleton 막대 추가"}],ee=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],ae=[{name:"skeleton · skeleton_text · skeleton_title · skeleton_circle",description:"막대·제목·원형"},{name:"skeleton_button · skeleton_image · skeleton_block",description:"버튼·이미지·블록 형태"},{name:"skeleton_w-sm · skeleton_w-md · skeleton_w-lg",description:"줄 너비"},{name:"skeleton_group · skeleton_row · skeleton_row-body",description:"레이아웃"},{name:"skeleton_static · skeleton_sm · skeleton_lg",description:"애니메이션·크기"}],se=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],te=[{name:"--skeleton-bg · --skeleton-shine",default:"—",description:"배경·쉬머"},{name:"--skeleton-text-height · --skeleton-title-height",default:"0.875rem · 1.125rem",description:"줄 높이"},{name:"--skeleton-avatar-size · --skeleton-gap · --skeleton-duration",default:"—",description:"아바타·간격·주기"}],ne=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 aria-label은 ariaLabel로 다룹니다. paragraph는 boolean 또는 number입니다.",tables:[{columns:X,rows:Y,codeColumn:"name"}]},{title:"API · Children",description:"Vue 슬롯에 대응하는 React children입니다.",tables:[{columns:Z,rows:$,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ee,rows:ae,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:se,rows:te,codeColumn:"name"}]}],oe={active:!0,avatar:!1,paragraph:!1,round:!1,ariaLabel:"콘텐츠 로딩 중"},ce={title:"Components/피드백/Skeleton",id:"components-skeleton",component:s,tags:["autodocs"],argTypes:{active:{control:"boolean",type:{name:"boolean",summary:"boolean"}},avatar:{control:"boolean",type:{name:"boolean",summary:"boolean"}},paragraph:{control:"number",type:{name:"union",summary:"boolean | number"}},round:{control:"boolean",type:{name:"boolean",summary:"boolean"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:ne,docs:{description:{component:"콘텐츠 로딩 중 플레이스홀더를 표시하는 Skeleton 컴포넌트입니다."}}}},l={parameters:{controls:{disable:!1}},args:{...oe},render:a=>e.jsx(s,{...a})},i={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"`skeleton`에 `skeleton_text` · `skeleton_title` 형태 클래스를 조합합니다."},source:{code:`import Skeleton from '@uxkm/ui-react/components/Skeleton.jsx';
