import{r as i,u as z,c as F,n as B,j as e,a as P,b as R,d as la,B as L,I,Q as ia}from"./iframe-Ec8Bs185.js";import{p as ma,j as pa,W as ua,b as Ca,a as ha,d as fa,J as Y,c as Ce,E as xa}from"./calendar-demo-BOe-Cb6U.js";import{w as ya}from"./story-renders-Bo_F9MSp.js";import{r as ga,g as ba,a as _a}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const va=new Set(["","sm","lg"]),ka=R("Calendar",{defaults:{role:"application"},booleanProps:new Set(["noHeader","minimal","compact","borderless","shadow","ghost","week","readonly","disabled","weekends","agenda","wheel"]),selfClosing:!1});function C({ref:a,title:n,ariaLabel:s,noHeader:r,minimal:d,compact:l,borderless:t,shadow:m,ghost:u,week:h,readonly:x,disabled:o,weekends:c,agenda:p,wheel:f,size:_="",role:j="application",header:W,weekdays:E,footer:A,children:N,className:H,...k}){const $=i.useRef(null),J=va.has(_)?_:"";function y(g){$.current=g,typeof a=="function"?a(g):a&&typeof a=="object"&&(a.current=g)}z(ka,{title:n,ariaLabel:s,noHeader:r,minimal:d,compact:l,borderless:t,shadow:m,ghost:u,week:h,readonly:x,disabled:o,weekends:c,agenda:p,wheel:f,size:J,role:j},F({default:N,header:W,weekdays:E,footer:A}),$,{className:H,...k},{when:g=>!g.wheel});const U=i.useMemo(()=>{const g=["calendar"];return r&&g.push("calendar_no-header"),d&&g.push("calendar_minimal"),l&&g.push("calendar_compact"),t&&g.push("calendar_borderless"),m&&g.push("calendar_shadow"),u&&g.push("calendar_ghost"),h&&g.push("calendar_week"),x&&g.push("calendar_readonly"),o&&g.push("is-disabled"),c&&g.push("calendar_weekends"),p&&g.push("calendar_agenda"),f&&g.push("calendar_wheel"),J==="sm"&&g.push("calendar_sm"),J==="lg"&&g.push("calendar_lg"),g},[r,d,l,t,m,u,h,x,o,c,p,f,J]),{class:fn,...ta}=k,oa=B(ta),ca=n&&!r&&!d?e.jsx("div",{className:"calendar_header",children:e.jsx("span",{className:"calendar_title",children:n})}):null;return e.jsxs("div",{ref:y,className:P(U,H),role:j,"aria-label":s,"aria-disabled":o?"true":void 0,...oa,children:[W!==void 0?W:ca,E,N,A]})}C.__docgenInfo={description:"",methods:[],displayName:"Calendar",props:{size:{defaultValue:{value:"''",computed:!1},required:!1},role:{defaultValue:{value:"'application'",computed:!1},required:!1}}};function me({ripple:a,day:n,otherMonth:s,today:r,selected:d,disabled:l,sunday:t,saturday:m,rangeStart:u,rangeEnd:h,inRange:x,event:o,readonly:c,className:p,...f}){const{rippleAttrs:_}=la({ripple:a}),j=i.useMemo(()=>{const k=["calendar_day"];return s&&k.push("is-other-month"),r&&k.push("is-today"),d&&k.push("is-selected"),l&&k.push("is-disabled"),t&&k.push("is-sunday"),m&&k.push("is-saturday"),u&&k.push("is-range-start"),h&&k.push("is-range-end"),x&&k.push("is-in-range"),o&&k.push("has-event"),k},[s,r,d,l,t,m,u,h,x,o]),E=!!(l||s&&!(d||x||u||h)),{class:A,...N}=f,H=B(N);return e.jsx("button",{type:"button",className:P(j,p),disabled:E||void 0,"aria-current":r?"date":void 0,"aria-selected":d?"true":void 0,..._,...H,children:n})}me.__docgenInfo={description:"",methods:[],displayName:"CalendarDay"};const wa=R("CalendarFooter",{selfClosing:!1});function pe({children:a,className:n,...s}){const r=i.useRef(null);z(wa,{},F({default:a}),r,{className:n,...s});const{class:d,...l}=s,t=B(l);return e.jsxs("div",{ref:r,className:P("calendar_footer",n),...t,children:[e.jsx(L,{variant:"text",color:"primary",size:"sm",label:"오늘"}),e.jsx("div",{className:"calendar_footer-actions",children:a??e.jsxs(e.Fragment,{children:[e.jsx(L,{variant:"ghost",size:"sm",label:"초기화"}),e.jsx(L,{variant:"filled",color:"primary",size:"sm",label:"확인"})]})})]})}pe.__docgenInfo={description:"",methods:[],displayName:"CalendarFooter"};function ue({week:a,children:n,className:s,...r}){const d=i.useMemo(()=>["calendar_grid",a&&"calendar_grid-week"],[a]),{class:l,...t}=r,m=B(t);return e.jsx("div",{className:P(d,s),role:"grid",...m,children:n})}ue.__docgenInfo={description:"",methods:[],displayName:"CalendarGrid"};const ja=R("CalendarGroup",{selfClosing:!1});function K({children:a,className:n,...s}){const r=i.useRef(null);z(ja,{},F({default:a}),r,{className:n,...s});const{class:d,...l}=s,t=B(l);return e.jsx("div",{ref:r,className:P("calendar_group",n),...t,children:a})}K.__docgenInfo={description:"",methods:[],displayName:"CalendarGroup"};const Na=R("CalendarHeader",{selfClosing:!1});function w({title:a,prevLabel:n="이전 달",nextLabel:s="다음 달",showNav:r=!0,showPrev:d,showNext:l,children:t,className:m,...u}){const h=i.useRef(null),x=d??r,o=l??r;z(Na,{title:a,prevLabel:n,nextLabel:s,showNav:r,showPrev:d,showNext:l},F({default:t}),h,{className:m,...u});const{class:c,...p}=u,f=B(p);return e.jsxs("div",{ref:h,className:P("calendar_header",m),...f,children:[x?e.jsx(L,{variant:"ghost",size:"sm",iconOnly:!0,ariaLabel:n,iconBefore:e.jsx(I,{name:"chevron-left",size:"sm"})}):null,e.jsx("span",{className:"calendar_title",children:a}),o?e.jsx(L,{variant:"ghost",size:"sm",iconOnly:!0,ariaLabel:s,iconBefore:e.jsx(I,{name:"chevron-right",size:"sm"})}):null,t]})}w.__docgenInfo={description:"",methods:[],displayName:"CalendarHeader",props:{prevLabel:{defaultValue:{value:"'이전 달'",computed:!1},required:!1},nextLabel:{defaultValue:{value:"'다음 달'",computed:!1},required:!1},showNav:{defaultValue:{value:"true",computed:!1},required:!1}}};function La(a,n={}){return ia("CalendarMonth",a,{},n,{booleanProps:new Set(["weekends","week","readonly"]),skipProps:["preset"],selfClosing:!0,arrayPropPlaceholders:{days:"days",events:"EVENT_DAYS",disabled:"disabledDays"}})}function b({days:a,preset:n="",selected:s,today:r,disabled:d,events:l,rangeStart:t,rangeEnd:m,weekends:u,partial:h,week:x,readonly:o,className:c,...p}){const f=i.useRef(null);z((N,H,k)=>La(N,k),{days:a,preset:n,selected:s,today:r,disabled:d,events:l,rangeStart:t,rangeEnd:m,weekends:u,partial:h,week:x,readonly:o},{},f,{className:c,...p});const _=i.useMemo(()=>a!=null&&a.length?a:h?ma(h,{today:r,selected:s}):n==="june2024"||!n?pa({selected:s,today:r,disabled:d,events:l,rangeStart:t,rangeEnd:m}):[],[a,h,n,s,r,d,l,t,m]),j=i.useMemo(()=>u?_.map((N,H)=>({...N,sunday:N.sunday??H%7===0,saturday:N.saturday??H%7===6})):_,[_,u]),{class:W,...E}=p,A=B(E);return e.jsx("div",{ref:f,className:P("calendar_month",c),style:{display:"contents"},...A,children:e.jsx(ue,{week:x,children:j.map((N,H)=>e.jsx(me,{...N,readonly:o},`${N.day}-${H}`))})})}b.__docgenInfo={description:"",methods:[],displayName:"CalendarMonth",props:{preset:{defaultValue:{value:"''",computed:!1},required:!1}}};const Wa=R("CalendarNav",{selfClosing:!1});function ce({label:a,prevLabel:n="이전 주",nextLabel:s="다음 주",className:r,...d}){const l=i.useRef(null);z(Wa,{label:a,prevLabel:n,nextLabel:s},F({}),l,{className:r,...d});const{class:t,...m}=d,u=B(m);return e.jsxs("div",{ref:l,className:P("calendar_nav",r),...u,children:[e.jsx(L,{variant:"ghost",size:"sm",iconOnly:!0,ariaLabel:n,iconBefore:e.jsx(I,{name:"chevron-left",size:"sm"})}),e.jsx("span",{className:"calendar_nav-label",children:a}),e.jsx(L,{variant:"ghost",size:"sm",iconOnly:!0,ariaLabel:s,iconBefore:e.jsx(I,{name:"chevron-right",size:"sm"})})]})}ce.__docgenInfo={description:"",methods:[],displayName:"CalendarNav",props:{prevLabel:{defaultValue:{value:"'이전 주'",computed:!1},required:!1},nextLabel:{defaultValue:{value:"'다음 주'",computed:!1},required:!1}}};const Ea=R("CalendarWeekdays",{selfClosing:!1});function v({labels:a=ua,className:n,...s}){const r=i.useRef(null);z(Ea,{labels:a},F({}),r,{className:n,...s});const{class:d,...l}=s,t=B(l);return e.jsx("div",{ref:r,className:P("calendar_weekdays",n),"aria-hidden":"true",...t,children:a.map(m=>e.jsx("span",{className:"calendar_weekday",children:m},m))})}v.__docgenInfo={description:"",methods:[],displayName:"CalendarWeekdays",props:{labels:{defaultValue:{value:"WEEKDAYS",computed:!0},required:!1}}};const Ma=R("CalendarWheel",{booleanProps:new Set(["shadow","borderless","footer","toolbar"]),selfClosing:!1});function V({title:a,shadow:n,borderless:s,footer:r=!1,toolbar:d=!0,cancelLabel:l,confirmLabel:t,ariaLabel:m,toolbarContent:u,footerContent:h,children:x,className:o,...c}){const p=i.useRef(null);z(Ma,{title:a,shadow:n,borderless:s,footer:r,toolbar:d,cancelLabel:l,confirmLabel:t,ariaLabel:m},F({default:x,toolbar:u,footer:h}),p,{className:o,...c});const f=!!(d&&(u||a||l||t)),_=!!(r||h),{class:j,...W}=c,E=B(W),A=e.jsxs(e.Fragment,{children:[l?e.jsx(L,{variant:"text",size:"sm",label:l}):null,a?e.jsx("span",{className:"calendar_wheel-title",children:a}):null,t?e.jsx(L,{variant:"text",color:"primary",size:"sm",label:t}):null]});return e.jsxs(C,{ref:p,wheel:!0,shadow:n,borderless:s,role:"group",ariaLabel:m,className:o,...E,children:[f?e.jsx("div",{className:"calendar_wheel-toolbar","data-demo-slot":"toolbar",children:u??A}):null,e.jsxs("div",{className:"calendar_wheel-body",children:[e.jsx("div",{className:"calendar_wheel-highlight","aria-hidden":"true"}),e.jsx("div",{className:"calendar_wheel-columns",children:x}),e.jsx("div",{className:"calendar_wheel-fade","aria-hidden":"true"})]}),_?e.jsx("div",{className:"calendar_wheel-footer","data-demo-slot":"footer",children:h}):null]})}V.__docgenInfo={description:"",methods:[],displayName:"CalendarWheel",props:{footer:{defaultValue:{value:"false",computed:!1},required:!1},toolbar:{defaultValue:{value:"true",computed:!1},required:!1}}};function ie(a){return[...a.querySelectorAll(".calendar_wheel-item")]}function sa(a){const n=a.getBoundingClientRect();return n.top+n.height/2}function da(a){const n=a.getBoundingClientRect();return n.top+n.height/2}function Da(a){const n=ie(a),s=sa(a);let r=null,d=1/0;return n.forEach(l=>{const t=Math.abs(da(l)-s);t<d&&(d=t,r=l)}),r}function Sa(a,{onSelect:n}={}){const s=i.useRef(!1),r=i.useRef(null),d=i.useRef(n);d.current=n;const l=i.useCallback((o,{skipScroll:c=!1}={})=>{var _,j;const p=a.current;if(!p||!o)return;if(!c){const W=da(o)-sa(p);Math.abs(W)>1&&(s.current=!0,p.scrollTop+=W,requestAnimationFrame(()=>{s.current=!1}))}const f=(_=o.textContent)==null?void 0:_.trim();f&&((j=d.current)==null||j.call(d,f))},[a]),t=i.useCallback(({skipScroll:o=!1}={})=>{const c=a.current;if(!c)return;const p=Da(c);p&&l(p,{skipScroll:o})},[a,l]),m=i.useCallback(()=>{t()},[t]),u=i.useCallback(()=>{const o=a.current;if(!o)return;const c=o.querySelector(".calendar_wheel-item.is-selected");c&&requestAnimationFrame(()=>l(c))},[a,l]),h=i.useCallback(o=>{const c=a.current;if(!c)return;const f=ie(c)[o];f&&l(f)},[a,l]),x=i.useCallback(o=>{const c=a.current;if(!c)return;const p=ie(c),f=c.querySelector(".calendar_wheel-item.is-selected"),j=p.indexOf(f)+o;j<0||j>=p.length||l(p[j])},[a,l]);return i.useEffect(()=>{const o=a.current;if(!o)return;function c(){s.current||(t({skipScroll:!0}),clearTimeout(r.current),r.current=setTimeout(m,80))}return o.addEventListener("scroll",c,{passive:!0}),requestAnimationFrame(()=>u()),()=>{o.removeEventListener("scroll",c),clearTimeout(r.current)}},[a,t,m,u]),{scrollToSelected:u,selectByIndex:h,moveSelection:x}}const Ha=R("CalendarWheelColumn",{booleanProps:new Set(["showSteps"]),selfClosing:!1});function M({ripple:a,label:n,items:s=[],selected:r,showSteps:d=!0,prevLabel:l,nextLabel:t,className:m,...u}){const{rippleAttrs:h,childRippleAttrs:x}=la({ripple:a},{mode:"container"}),o=i.useRef(null),c=i.useRef(null),[p,f]=i.useState(r);z(Ha,{ripple:a,label:n,items:s,selected:r,showSteps:d,prevLabel:l,nextLabel:t},F({}),o,{className:m,...u});const{scrollToSelected:_,selectByIndex:j,moveSelection:W}=Sa(c,{onSelect(y){f(y)}});i.useEffect(()=>{f(r);const y=requestAnimationFrame(()=>_());return()=>cancelAnimationFrame(y)},[r,_]),i.useEffect(()=>{const y=requestAnimationFrame(()=>_());return()=>cancelAnimationFrame(y)},[s,_]);const E=i.useMemo(()=>s.map(y=>{if(typeof y=="string"||typeof y=="number"){const U=String(y);return{label:U,selected:U===String(p)}}return{label:y.label,selected:y.selected??y.label===String(p)}}),[s,p]),A=i.useMemo(()=>E.findIndex(y=>y.selected),[E]),N=A<=0,H=A<0||A>=E.length-1,{class:k,...$}=u,J=B($);return e.jsxs("div",{ref:o,className:P("calendar_wheel-column",m),...h,...J,children:[d&&l?e.jsx(L,{variant:"ghost",size:"sm",iconOnly:!0,className:"calendar_wheel-step calendar_wheel-step-prev",ariaLabel:l,disabled:N,iconBefore:e.jsx(I,{name:"chevron-up",size:"sm"}),onClick:()=>W(-1),...x}):null,e.jsx("ul",{ref:c,className:"calendar_wheel-list",role:"listbox","aria-label":n,"data-wheel":"",children:E.map((y,U)=>e.jsx("li",{children:e.jsx("button",{type:"button",className:P("calendar_wheel-item",y.selected&&"is-selected"),"aria-selected":y.selected?"true":void 0,onClick:()=>j(U),...x,children:y.label})},y.label))}),d&&t?e.jsx(L,{variant:"ghost",size:"sm",iconOnly:!0,className:"calendar_wheel-step calendar_wheel-step-next",ariaLabel:t,disabled:H,iconBefore:e.jsx(I,{name:"chevron-down",size:"sm"}),onClick:()=>W(1),...x}):null]})}M.__docgenInfo={description:"",methods:[],displayName:"CalendarWheelColumn",props:{items:{defaultValue:{value:"[]",computed:!1},required:!1},showSteps:{defaultValue:{value:"true",computed:!1},required:!1}}};const G=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Aa=G,Pa=[{name:"title",type:"string",default:"—",description:"내장 헤더 제목 (header prop 없을 때)"},{name:"ariaLabel",type:"string",default:"—",description:"캘린더 접근성 라벨 (권장)"},{name:"role",type:"string",default:"application",description:"루트 role 속성"},{name:"size",type:"'sm' | 'lg'",default:"—",description:"calendar_sm · calendar_lg"},{name:"noHeader",type:"boolean",default:"false",description:"헤더 영역 숨김 (calendar_no-header)"},{name:"minimal",type:"boolean",default:"false",description:"최소 스타일 (calendar_minimal)"},{name:"compact",type:"boolean",default:"false",description:"좁은 셀 (calendar_compact)"},{name:"borderless",type:"boolean",default:"false",description:"테두리 없음"},{name:"shadow",type:"boolean",default:"false",description:"그림자 (calendar_shadow)"},{name:"ghost",type:"boolean",default:"false",description:"투명 배경 (calendar_ghost)"},{name:"week",type:"boolean",default:"false",description:"주간 뷰 레이아웃"},{name:"weekends",type:"boolean",default:"false",description:"주말 강조 (calendar_weekends)"},{name:"agenda",type:"boolean",default:"false",description:"아젠다 레이아웃"},{name:"wheel",type:"boolean",default:"false",description:"휠 피커 레이아웃"},{name:"readonly",type:"boolean",default:"false",description:"날짜 선택 불가"},{name:"disabled",type:"boolean",default:"false",description:"전체 비활성 (is-disabled)"},{name:"className",type:"string",default:"—",description:"calendar 루트에 추가 클래스"}],Ba=G,za=[{name:"title",type:"string",default:"—",description:"월·기간 제목 (calendar_title)"},{name:"prevLabel",type:"string",default:"이전 달",description:"이전 버튼 aria-label"},{name:"nextLabel",type:"string",default:"다음 달",description:"다음 버튼 aria-label"},{name:"showNav",type:"boolean",default:"true",description:"이전·다음 네비게이션 표시"},{name:"showPrev",type:"boolean",default:"—",description:"이전 버튼만 제어 (showNav 대체)"},{name:"showNext",type:"boolean",default:"—",description:"다음 버튼만 제어"}],Ga=G,Ia=[{name:"label",type:"string",default:"—",description:"주간 네비 라벨"},{name:"prevLabel",type:"string",default:"이전 주",description:"이전 버튼 aria-label"},{name:"nextLabel",type:"string",default:"다음 주",description:"다음 버튼 aria-label"}],Fa=G,Ra=[{name:"labels",type:"string[]",default:"일~토",description:"요일 라벨 배열"}],Va=G,Ja=[{name:"days",type:"object[]",default:"—",description:"CalendarDay용 셀 데이터 배열"},{name:"preset",type:"string",default:"june2024",description:"데모용 월 프리셋"},{name:"selected",type:"number",default:"—",description:"선택일 (프리셋·partial용)"},{name:"today",type:"number",default:"—",description:"오늘 날짜 (프리셋·partial용)"},{name:"disabled",type:"number[]",default:"—",description:"비활성 날짜 목록"},{name:"events",type:"number[]",default:"—",description:"이벤트 표시 날짜"},{name:"rangeStart",type:"number",default:"—",description:"범위 시작일"},{name:"rangeEnd",type:"number",default:"—",description:"범위 종료일"},{name:"weekends",type:"boolean",default:"false",description:"주말 셀 표시"},{name:"partial",type:"number",default:"—",description:"부분 월 데모 일수"},{name:"week",type:"boolean",default:"false",description:"주간 그리드"},{name:"readonly",type:"boolean",default:"false",description:"날짜 버튼 비활성"}],Ua=G,Ka=[{name:"week",type:"boolean",default:"false",description:"7열 주간 그리드 (calendar_grid-week)"}],$a=G,Ya=[{name:"day",type:"number | string",default:"—",description:"날짜 숫자 (필수)"},{name:"otherMonth",type:"boolean",default:"false",description:"다른 달 (is-other-month)"},{name:"today",type:"boolean",default:"false",description:"오늘 (is-today)"},{name:"selected",type:"boolean",default:"false",description:"선택 (is-selected)"},{name:"disabled",type:"boolean",default:"false",description:"비활성 (is-disabled)"},{name:"sunday",type:"boolean",default:"false",description:"일요일 (is-sunday)"},{name:"saturday",type:"boolean",default:"false",description:"토요일 (is-saturday)"},{name:"rangeStart",type:"boolean",default:"false",description:"범위 시작 (is-range-start)"},{name:"rangeEnd",type:"boolean",default:"false",description:"범위 끝 (is-range-end)"},{name:"inRange",type:"boolean",default:"false",description:"범위 내 (is-in-range)"},{name:"event",type:"boolean",default:"false",description:"이벤트 점 (has-event)"},{name:"readonly",type:"boolean",default:"false",description:"클릭 불가"},ga],Oa=G,Ta=[{name:"title",type:"string",default:"—",description:"툴바 제목"},{name:"ariaLabel",type:"string",default:"—",description:"휠 피커 접근성 라벨"},{name:"shadow",type:"boolean",default:"false",description:"Calendar에 전달"},{name:"borderless",type:"boolean",default:"false",description:"Calendar에 전달"},{name:"footer",type:"boolean",default:"false",description:"하단 푸터 영역 표시"},{name:"toolbar",type:"boolean",default:"true",description:"상단 툴바 표시"},{name:"toolbarContent",type:"ReactNode",default:"—",description:"툴바 커스텀 (Vue #toolbar 슬롯 대응)"},{name:"footerContent",type:"ReactNode",default:"—",description:"푸터 커스텀 (Vue #footer 슬롯 대응)"},{name:"cancelLabel",type:"string",default:"—",description:"취소 버튼 텍스트"},{name:"confirmLabel",type:"string",default:"—",description:"확인 버튼 텍스트"}],qa=G,Qa=[{name:"label",type:"string",default:"—",description:"listbox aria-label"},{name:"items",type:"array",default:"[]",description:"문자열·숫자 또는 { label, selected } 객체"},{name:"selected",type:"string | number",default:"—",description:"선택 값"},{name:"showSteps",type:"boolean",default:"true",description:"위·아래 스텝 버튼"},{name:"prevLabel",type:"string",default:"—",description:"이전 스텝 aria-label"},{name:"nextLabel",type:"string",default:"—",description:"다음 스텝 aria-label"},ba],he=[{key:"name",label:"Children / Prop"},{key:"description",label:"설명"}],Za=[{name:"header",description:"헤더 (Vue #header 슬롯 대응, CalendarHeader 등)"},{name:"weekdays",description:"요일 행 (Vue #weekdays 슬롯 대응, CalendarWeekdays)"},{name:"children",description:"월 그리드·아젠다·휠 등 본문 (Vue default 슬롯 대응)"},{name:"footer",description:"푸터 (Vue #footer 슬롯 대응, CalendarFooter)"}],O=[{key:"name",label:"Children"},{key:"description",label:"설명"}],Xa=[{name:"children",description:"헤더 우측 추가 콘텐츠 (Vue default 슬롯 대응)"}],en=[{name:"children",description:"CalendarDay 자식 (Vue default 슬롯 대응)"}],an=[{name:"children",description:"푸터 액션 (Vue default 슬롯 대응, 기본: 초기화·확인)"}],nn=[{name:"children",description:"여러 Calendar 나란히 (Vue default 슬롯 대응)"}],rn=[{name:"toolbarContent",description:"상단 툴바 커스텀 (Vue #toolbar 슬롯 대응)"},{name:"children",description:"CalendarWheelColumn 목록 (Vue default 슬롯 대응)"},{name:"footerContent",description:"하단 푸터 (Vue #footer 슬롯 대응)"}],ln=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],sn=[{name:"calendar",description:"캘린더 루트"},{name:"calendar_sm · calendar_lg · calendar_compact",description:"크기"},{name:"calendar_borderless · calendar_shadow · calendar_ghost · calendar_minimal",description:"스킨"},{name:"calendar_week · calendar_weekends · calendar_agenda · calendar_wheel",description:"레이아웃 모드"},{name:"calendar_header · calendar_title · calendar_nav",description:"헤더·네비"},{name:"calendar_weekdays · calendar_weekday",description:"요일 행"},{name:"calendar_grid · calendar_grid-week",description:"날짜 그리드"},{name:"calendar_day",description:"날짜 셀 버튼"},{name:"calendar_footer · calendar_group",description:"푸터·다중 캘린더"},{name:"calendar_wheel-*",description:"휠 피커 파트"},{name:"is-today · is-selected · is-in-range · is-range-start · is-range-end",description:"날짜 상태"},{name:"is-other-month · is-sunday · is-saturday · is-disabled · has-event",description:"날짜 상태"},..._a],dn=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],tn=[{name:"--calendar-cell-size · --calendar-cell-size-sm · --calendar-cell-size-lg",default:"—",description:"날짜 셀 크기"},{name:"--calendar-gap",default:"2px",description:"그리드 간격"},{name:"--calendar-wheel-height · --calendar-wheel-row-height",default:"—",description:"휠 피커 높이"},{name:"--calendar-agenda-gap · --calendar-agenda-date-width",default:"—",description:"아젠다 레이아웃"}],on=[{title:"API · Calendar Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 aria-label · no-header는 ariaLabel · noHeader로 다룹니다.",tables:[{columns:Aa,rows:Pa,codeColumn:"name"}]},{title:"API · CalendarHeader Props",tables:[{columns:Ba,rows:za,codeColumn:"name"}]},{title:"API · CalendarNav Props",tables:[{columns:Ga,rows:Ia,codeColumn:"name"}]},{title:"API · CalendarWeekdays Props",tables:[{columns:Fa,rows:Ra,codeColumn:"name"}]},{title:"API · CalendarMonth Props",tables:[{columns:Va,rows:Ja,codeColumn:"name"}]},{title:"API · CalendarGrid Props",tables:[{columns:Ua,rows:Ka,codeColumn:"name"}]},{title:"API · CalendarDay Props",tables:[{columns:$a,rows:Ya,codeColumn:"name"}]},{title:"API · CalendarWheel Props",description:"Vue toolbar · footer 슬롯은 React toolbarContent · footerContent prop에 대응합니다.",tables:[{columns:Oa,rows:Ta,codeColumn:"name"}]},{title:"API · CalendarWheelColumn Props",tables:[{columns:qa,rows:Qa,codeColumn:"name"}]},{title:"API · Calendar Children",description:"Vue header · weekdays · footer · default 슬롯은 React header · weekdays · footer · children prop에 대응합니다.",tables:[{columns:he,rows:Za,codeColumn:"name"}]},{title:"API · CalendarHeader · Footer · Group Children",tables:[{columns:O,rows:Xa,codeColumn:"name"},{columns:O,rows:an,codeColumn:"name"},{columns:O,rows:nn,codeColumn:"name"}]},{title:"API · CalendarGrid · CalendarWheel Children",tables:[{columns:O,rows:en,codeColumn:"name"},{columns:he,rows:rn,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ln,rows:sn,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:dn,rows:tn,codeColumn:"name"}]}],D=a=>ya(a,a),cn=Array.from({length:11},(a,n)=>`${2019+n}년`),mn=Array.from({length:12},(a,n)=>`${n+1}월`),pn=Array.from({length:31},(a,n)=>`${n+1}일`),un=Ca(),Cn=ha(),hn=fa(14,{today:7,selected:9}),S={title:"제목",ariaLabel:"접근성 라벨",noHeader:!1,minimal:!1,compact:!1,borderless:!1,shadow:!1,ghost:!1,week:!1,readonly:!1,disabled:!1,weekends:!1,agenda:!1,wheel:!1,size:"sm",role:"application"},vn={title:"Components/데이터 표시/Calendar",id:"components-calendar",component:C,subcomponents:{CalendarDay:me,CalendarFooter:pe,CalendarGrid:ue,CalendarGroup:K,CalendarHeader:w,CalendarMonth:b,CalendarNav:ce,CalendarWeekdays:v,CalendarWheel:V,CalendarWheelColumn:M},tags:["autodocs"],argTypes:{title:{control:"text",type:{name:"string",summary:"string"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}},noHeader:{control:"boolean",type:{name:"boolean",summary:"boolean"}},minimal:{control:"boolean",type:{name:"boolean",summary:"boolean"}},compact:{control:"boolean",type:{name:"boolean",summary:"boolean"}},borderless:{control:"boolean",type:{name:"boolean",summary:"boolean"}},shadow:{control:"boolean",type:{name:"boolean",summary:"boolean"}},ghost:{control:"boolean",type:{name:"boolean",summary:"boolean"}},week:{control:"boolean",type:{name:"boolean",summary:"boolean"}},readonly:{control:"boolean",type:{name:"boolean",summary:"boolean"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},weekends:{control:"boolean",type:{name:"boolean",summary:"boolean"}},agenda:{control:"boolean",type:{name:"boolean",summary:"boolean"}},wheel:{control:"boolean",type:{name:"boolean",summary:"boolean"}},size:{control:"select",options:["sm","lg"],type:{name:"enum",summary:"'sm' | 'lg'"}},role:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"fullscreen",apiSections:on}},T={parameters:{controls:{disable:!1}},args:{...S},render:a=>e.jsx(C,{...a,ariaLabel:"2024년 6월",header:e.jsx(w,{title:"2024년 6월"}),weekdays:e.jsx(v,{}),children:e.jsx(b,{})})},q={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"calendar_header · calendar_weekdays · calendar_grid로 월간 뷰를 구성합니다. is-today · is-selected · is-disabled · is-other-month로 날짜 상태를 표현합니다."},source:{code:`import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
...
}`,language:"tsx"}}},args:{...S},render:D(e.jsxs(e.Fragment,{children:[e.jsxs(C,{week:!0,shadow:!0,ariaLabel:`2024년 ${Y}`,children:[e.jsx(ce,{label:Y}),e.jsx(v,{}),e.jsx(b,{week:!0,days:Ce})]}),e.jsxs(C,{week:!0,compact:!0,borderless:!0,ariaLabel:`2024년 ${Y} (컴팩트)`,children:[e.jsx(ce,{label:Y}),e.jsx(b,{week:!0,days:Ce})]})]}))},ee={name:"휠 (iOS 스타일)",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"calendar_wheel · calendar_wheel-step(이전/다음) · calendar_wheel-columns으로 년·월·일 휠 피커를 구성합니다. 필요한 열만 배치하면 열 수에 맞춰 가로 너비가 줄고 가운데 정렬됩니다."},source:{code:`import Button from '@uxkm/ui-react/components/Button.jsx';
...
}`,language:"tsx"}}},args:{...S},render:D(e.jsxs(e.Fragment,{children:[e.jsxs(V,{shadow:!0,title:"날짜 선택",cancelLabel:"취소",confirmLabel:"완료",ariaLabel:"날짜 휠 선택",children:[e.jsx(M,{label:"년",items:cn,selected:"2024년",prevLabel:"이전 년",nextLabel:"다음 년"}),e.jsx(M,{label:"월",items:mn,selected:"6월",prevLabel:"이전 월",nextLabel:"다음 월"}),e.jsx(M,{label:"일",items:pn,selected:"15일",prevLabel:"이전 일",nextLabel:"다음 일"})]}),e.jsxs(V,{borderless:!0,footer:!0,toolbar:!1,ariaLabel:"날짜 휠 선택 (하단 버튼)",footerContent:e.jsxs(e.Fragment,{children:[e.jsx(L,{variant:"ghost",size:"sm",label:"취소"}),e.jsx(L,{variant:"filled",color:"primary",size:"sm",label:"확인"})]}),children:[e.jsx(M,{label:"년",items:["2024년"],selected:"2024년",prevLabel:"이전 년",nextLabel:"다음 년"}),e.jsx(M,{label:"월",items:["6월"],selected:"6월",prevLabel:"이전 월",nextLabel:"다음 월"}),e.jsx(M,{label:"일",items:["15일"],selected:"15일",prevLabel:"이전 일",nextLabel:"다음 일"})]}),e.jsxs(K,{className:"calendar_group-center",children:[e.jsx(V,{shadow:!0,title:"년도",ariaLabel:"년도 선택",children:e.jsx(M,{label:"년",items:["2024년"],selected:"2024년",prevLabel:"이전 년",nextLabel:"다음 년"})}),e.jsxs(V,{shadow:!0,title:"년·월",ariaLabel:"년·월 선택",toolbar:!0,toolbarContent:e.jsx("span",{className:"calendar_wheel-title",children:"년·월"}),children:[e.jsx(M,{label:"년",items:["2024년"],selected:"2024년",showSteps:!1}),e.jsx(M,{label:"월",items:["6월"],selected:"6월",showSteps:!1})]}),e.jsxs(V,{shadow:!0,title:"월·일",ariaLabel:"월·일 선택",toolbar:!0,toolbarContent:e.jsx("span",{className:"calendar_wheel-title",children:"월·일"}),children:[e.jsx(M,{label:"월",items:["6월"],selected:"6월",showSteps:!1}),e.jsx(M,{label:"일",items:["15일"],selected:"15일",showSteps:!1})]})]})]}))},ae={name:"범위 선택",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"is-range-start · is-in-range · is-range-end로 기간 선택을 표현합니다. 시작·종료일은 is-selected와 함께 사용합니다."},source:{code:`import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
import CalendarMonth from '@uxkm/ui-react/components/CalendarMonth.jsx';
import CalendarWeekdays from '@uxkm/ui-react/components/CalendarWeekdays.jsx';
...
}`,language:"tsx"}}},args:{...S},render:D(e.jsxs(K,{children:[e.jsx(C,{compact:!0,shadow:!0,weekends:!0,ariaLabel:"2024년 6월",header:e.jsxs("div",{className:"calendar_header",children:[e.jsx(L,{variant:"ghost",size:"sm",iconOnly:!0,ariaLabel:"이전 달",iconBefore:e.jsx(I,{name:"chevron-left",size:"sm"})}),e.jsx("span",{className:"calendar_title",children:"2024년 6월"})]}),weekdays:e.jsx(v,{}),children:e.jsx(b,{days:un,weekends:!0})}),e.jsx(C,{compact:!0,shadow:!0,weekends:!0,ariaLabel:"2024년 7월",header:e.jsxs("div",{className:"calendar_header",children:[e.jsx("span",{className:"calendar_title",children:"2024년 7월"}),e.jsx(L,{variant:"ghost",size:"sm",iconOnly:!0,ariaLabel:"다음 달",iconBefore:e.jsx(I,{name:"chevron-right",size:"sm"})})]}),weekdays:e.jsx(v,{}),children:e.jsx(b,{days:Cn,weekends:!0})})]}))},te={name:"세로 일정",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"calendar_agenda · calendar_agenda-list · calendar_agenda-day로 날짜별 일정을 세로로 표시합니다. calendar_agenda-event에 시간·제목·설명을 담습니다."},source:{code:`import Calendar from '@uxkm/ui-react/components/Calendar.jsx';
import CalendarHeader from '@uxkm/ui-react/components/CalendarHeader.jsx';
...
}`,...(ye=(xe=T.parameters)==null?void 0:xe.docs)==null?void 0:ye.source}}};var ge,be,_e;q.parameters={...q.parameters,docs:{...(ge=q.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: false
...
}`,...(_e=(be=q.parameters)==null?void 0:be.docs)==null?void 0:_e.source}}};var ve,ke,we;Q.parameters={...Q.parameters,docs:{...(ve=Q.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  name: '헤더 없음',
  parameters: {
    controls: {
      disable: false
...
}`,...(we=(ke=Q.parameters)==null?void 0:ke.docs)==null?void 0:we.source}}};var je,Ne,Le;Z.parameters={...Z.parameters,docs:{...(je=Z.parameters)==null?void 0:je.docs,source:{originalSource:`{
  name: '날짜만',
  parameters: {
    controls: {
      disable: false
...
}`,...(Le=(Ne=Z.parameters)==null?void 0:Ne.docs)==null?void 0:Le.source}}};var We,Ee,Me;X.parameters={...X.parameters,docs:{...(We=X.parameters)==null?void 0:We.docs,source:{originalSource:`{
  name: '주간',
  parameters: {
    controls: {
      disable: false
...
}`,...(Me=(Ee=X.parameters)==null?void 0:Ee.docs)==null?void 0:Me.source}}};var De,Se,He;ee.parameters={...ee.parameters,docs:{...(De=ee.parameters)==null?void 0:De.docs,source:{originalSource:`{
  name: '휠 (iOS 스타일)',
  parameters: {
    controls: {
      disable: false
...
}`,...(He=(Se=ee.parameters)==null?void 0:Se.docs)==null?void 0:He.source}}};var Ae,Pe,Be;ae.parameters={...ae.parameters,docs:{...(Ae=ae.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  name: '범위 선택',
  parameters: {
    controls: {
      disable: false
...
}`,...(Be=(Pe=ae.parameters)==null?void 0:Pe.docs)==null?void 0:Be.source}}};var ze,Ge,Ie;ne.parameters={...ne.parameters,docs:{...(ze=ne.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  name: '이벤트 마커',
  parameters: {
    controls: {
      disable: false
...
}`,...(Ie=(Ge=ne.parameters)==null?void 0:Ge.docs)==null?void 0:Ie.source}}};var Fe,Re,Ve;re.parameters={...re.parameters,docs:{...(Fe=re.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  name: '스킨',
  parameters: {
    controls: {
      disable: false
...
}`,...(Ve=(Re=re.parameters)==null?void 0:Re.docs)==null?void 0:Ve.source}}};var Je,Ue,Ke;le.parameters={...le.parameters,docs:{...(Je=le.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  name: '크기',
  parameters: {
    controls: {
      disable: false
...
}`,...(Ke=(Ue=le.parameters)==null?void 0:Ue.docs)==null?void 0:Ke.source}}};var $e,Ye,Oe;se.parameters={...se.parameters,docs:{...($e=se.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  name: '푸터',
  parameters: {
    controls: {
      disable: false
...
}`,...(Oe=(Ye=se.parameters)==null?void 0:Ye.docs)==null?void 0:Oe.source}}};var Te,qe,Qe;de.parameters={...de.parameters,docs:{...(Te=de.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  name: '이중 패널',
  parameters: {
    controls: {
      disable: false
...
}`,...(Qe=(qe=de.parameters)==null?void 0:qe.docs)==null?void 0:Qe.source}}};var Ze,Xe,ea;te.parameters={...te.parameters,docs:{...(Ze=te.parameters)==null?void 0:Ze.docs,source:{originalSource:`{
  name: '세로 일정',
  parameters: {
    controls: {
      disable: false
...
}`,...(ea=(Xe=te.parameters)==null?void 0:Xe.docs)==null?void 0:ea.source}}};var aa,na,ra;oe.parameters={...oe.parameters,docs:{...(aa=oe.parameters)==null?void 0:aa.docs,source:{originalSource:`{
  name: '상태',
  parameters: {
    controls: {
      disable: false
...
}`,...(ra=(na=oe.parameters)==null?void 0:na.docs)==null?void 0:ra.source}}};const kn=["Playground","Basic","NoHeader","Minimal","Week","Wheel","Range","Event","Skin","Size","Footer","Dual","Agenda","State"];export{te as Agenda,q as Basic,de as Dual,ne as Event,se as Footer,Z as Minimal,Q as NoHeader,T as Playground,ae as Range,le as Size,re as Skin,oe as State,X as Week,ee as Wheel,kn as __namedExportsOrder,vn as default};
