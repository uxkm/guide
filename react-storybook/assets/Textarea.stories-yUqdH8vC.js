import{j as e,B as u}from"./iframe-DS-82CEY.js";import{F as Y}from"./FormLayout-2QMxR3Rv.js";import{I as Z}from"./Input-uQ67Uwxs.js";import{T as a}from"./Textarea-DhRHigo6.js";import{w as r}from"./story-renders-DjJEfxtm.js";import"./preload-helper-DUxc-Dqw.js";const $=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ee=[{name:"value",type:"string",default:"—",description:"제어 컴포넌트 값 (Vue model-value 대응)"},{name:"defaultValue",type:"string",default:"''",description:"비제어 초기 값"},{name:"rows",type:"number | string",default:"3",description:"textarea rows 속성"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"textarea_sm · textarea_lg"},{name:"placeholder",type:"string",default:"—",description:"placeholder 속성"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"error",type:"boolean",default:"false",description:"오류 상태 (is-error)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100% (textarea_block)"},{name:"className",type:"string",default:"—",description:"textarea 루트에 추가 클래스"},{name:"onChange",type:"(event) => void",default:"—",description:"값 변경 콜백 (Vue update:modelValue 대응)"}],ae=[{key:"name",label:"Children"},{key:"description",label:"설명"}],re=[{name:"children",description:"초기 텍스트. React에서는 value/defaultValue 사용을 권장합니다."}],te=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],se=[{name:"textarea",description:"텍스트영역 루트"},{name:"textarea_sm · textarea_lg · textarea_block",description:"크기·너비"},{name:"is-error · is-disabled",description:"상태"}],le=[{key:"name",label:"이벤트"},{key:"description",label:"설명"}],ie=[{name:"onChange",description:"입력 값 변경 시 (Vue update:modelValue 대응)"}],oe=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],de=[{name:"--textarea-min-height",default:"5rem",description:"최소 높이"},{name:"--textarea-count-inset-x · --textarea-count-inset-y",default:"0.75rem · 0.5rem",description:"글자 수 카운터 위치"}],me=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. Vue의 model-value는 value · onChange로 다룹니다.",tables:[{columns:$,rows:ee,codeColumn:"name"}]},{title:"API · Children",description:"Vue default 슬롯에 대응하는 React children입니다.",tables:[{columns:ae,rows:re,codeColumn:"name"}]},{title:"API · Events",description:"Vue update:modelValue는 React onChange(event)에 대응합니다.",tables:[{columns:le,rows:ie,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:te,rows:se,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:oe,rows:de,codeColumn:"name"}]}],ce={size:"md",disabled:!1,error:!1,placeholder:"입력하세요",block:!1,rows:3,value:""},he={title:"Components/폼/Textarea",id:"components-textarea",component:a,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placeholder:{control:"text",type:{name:"string",summary:"string"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},rows:{control:"number",type:{name:"number",summary:"number"}},value:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:me,docs:{description:{component:"다행 텍스트 입력을 위한하는 Textarea 컴포넌트입니다."}}}},t={parameters:{controls:{disable:!1}},args:{...ce},render:(Q,{updateArgs:U})=>e.jsx(a,{...Q,onChange:X=>U({value:X.target.value})})},s={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"레이블과 힌트 텍스트가 포함된 폼 필드입니다."},source:{code:`import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
export function BasicExample() {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'form_field 없이 textarea만 사용할 수 있습니다. 메모·댓글 입력 등 간단한 다중 입력에 적합합니다.'
      },
      source: {
        code: \`import Textarea from '@uxkm/ui-react/components/Textarea.jsx';
...
}`,...(k=(q=o.parameters)==null?void 0:q.docs)==null?void 0:k.source}}};var C,L,S;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: '행 수',
  parameters: {
    controls: {
      disable: false
...
}`,...(S=(L=d.parameters)==null?void 0:L.docs)==null?void 0:S.source}}};var P,R,E;m.parameters={...m.parameters,docs:{...(P=m.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: '리사이즈',
  parameters: {
    controls: {
      disable: false
...
}`,...(E=(R=m.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};var B,V,I;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: '필수 필드',
  parameters: {
    controls: {
      disable: false
...
}`,...(I=(V=c.parameters)==null?void 0:V.docs)==null?void 0:I.source}}};var D,A,M;n.parameters={...n.parameters,docs:{...(D=n.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: '글자 수 카운터',
  parameters: {
    controls: {
      disable: false
...
}`,...(M=(A=n.parameters)==null?void 0:A.docs)==null?void 0:M.source}}};var W,H,O;x.parameters={...x.parameters,docs:{...(W=x.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: '상태',
  parameters: {
    controls: {
      disable: false
...
}`,...(K=(J=f.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const _e=["Playground","Basic","Standalone","Size","Width","Rows","Resize","Required","Count","State","Example"];export{s as Basic,n as Count,f as Example,t as Playground,c as Required,m as Resize,d as Rows,i as Size,l as Standalone,x as State,o as Width,_e as __namedExportsOrder,he as default};
