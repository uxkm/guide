import{j as e,I as a}from"./iframe-Ec8Bs185.js";import{L as n}from"./Link-BAvBRCrJ.js";import{w as o,b as Z}from"./story-renders-Bo_F9MSp.js";import{r as $,a as ee}from"./ripple-api-CjGOCEZT.js";import"./preload-helper-DUxc-Dqw.js";const ne=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ae=[{name:"color",type:"'primary' | 'muted' | 'success' | 'warning' | 'danger'",default:"primary",description:"공통 color_* 클래스"},{name:"size",type:"'sm' | 'lg' | 'xl'",default:"—",description:"공통 size_* 클래스"},{name:"underline",type:"boolean",default:"false",description:"항상 밑줄 (link_underline)"},{name:"noUnderline",type:"boolean",default:"false",description:"밑줄 없음 (link_no-underline)"},{name:"standalone",type:"boolean",default:"false",description:"터치 영역 확대 (link_standalone)"},{name:"nav",type:"boolean",default:"false",description:"내비게이션 링크 스타일 (link_nav)"},{name:"block",type:"boolean",default:"false",description:"블록 링크 (link_block)"},{name:"back",type:"boolean",default:"false",description:"뒤로가기 링크 (link_back)"},{name:"iconOnly",type:"boolean",default:"false",description:"아이콘만 표시 (link_icon-only)"},{name:"active",type:"boolean",default:"false",description:"현재 페이지·활성 상태 (is-active)"},{name:"disabled",type:"boolean",default:"false",description:"비활성 (is-disabled, aria-disabled, tabindex -1)"},{name:"label",type:"string",default:"—",description:"링크 텍스트. children으로 대체 가능"},{name:"href",type:"string",default:"#",description:"이동 URL"},{name:"target",type:"string",default:"—",description:"a target 속성 (예: _blank)"},{name:"rel",type:"string",default:"—",description:"a rel 속성 (예: noopener noreferrer)"},{name:"ariaLabel",type:"string",default:"—",description:"iconOnly 등 텍스트 없을 때 접근성 라벨"},$],oe=[{key:"name",label:"Children / Prop"},{key:"description",label:"설명"}],le=[{name:"label",description:"링크 텍스트. children으로 대체 가능"},{name:"children",description:"링크 텍스트 (label prop 대체). 아이콘·보조 텍스트를 함께 넣을 수 있음"},{name:"icon",description:"텍스트 앞 아이콘 (Vue #icon 슬롯 대응, link_icon 클래스)"}],re=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],se=[{name:"link",description:"하이퍼링크 루트"},{name:"link_underline · link_no-underline · link_standalone",description:"밑줄·터치 영역"},{name:"link_nav · link_back · link_block · link_icon-only",description:"용도별 변형"},{name:"link_icon",description:"링크 내 아이콘"},{name:"link_row · link_group · link_group-inline",description:"링크 묶음 레이아웃"},{name:"is-active · is-disabled",description:"상태 클래스"},{name:"color_* · size_*",description:"공통 색상·크기 유틸"},...ee],ie=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ce=[{name:"--link-gap",default:"var(--space-xs)",description:"아이콘·텍스트 간격"},{name:"--link-font-weight",default:"500",description:"링크 두께"},{name:"--link-underline-offset",default:"2px",description:"밑줄 오프셋"},{name:"--link-nav-padding-y · --link-nav-padding-x",default:"0.35rem · 0.5rem",description:"네비 링크 패딩"},{name:"--link-standalone-padding-y · --link-standalone-padding-x",default:"0.25rem · 0.15rem",description:"독립 링크 터치 영역"},{name:"--link-icon-only-size",default:"2rem",description:"아이콘만 링크 크기"}],te=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. HTML·Vue 문서의 kebab-case(예: no-underline → noUnderline, aria-label → ariaLabel)와 동일한 의미입니다.",tables:[{columns:ne,rows:ae,codeColumn:"name"}]},{title:"API · Children",description:"Vue 슬롯(default · icon)에 대응하는 React prop·children입니다.",tables:[{columns:oe,rows:le,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:re,rows:se,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:ie,rows:ce,codeColumn:"name"}]}],me={color:"primary",size:"",underline:!1,noUnderline:!1,standalone:!1,nav:!1,block:!1,back:!1,iconOnly:!1,active:!1,disabled:!1,label:"라벨",href:"#",target:"",rel:"",ariaLabel:"접근성 라벨"},be={title:"Components/기본 요소/Link",id:"components-link",component:n,tags:["autodocs"],argTypes:{color:{control:"select",options:["primary","muted","success","warning","danger"],type:{name:"enum",summary:"'primary' | 'muted' | 'success' | 'warning' | 'danger'"}},size:{control:"select",options:["","sm","lg","xl"],labels:{"":"기본",sm:"sm",lg:"lg",xl:"xl"},type:{name:"enum",summary:"'sm' | 'lg' | 'xl' (기본: base)"}},underline:{control:"boolean",type:{name:"boolean",summary:"boolean"}},noUnderline:{control:"boolean",type:{name:"boolean",summary:"boolean"}},standalone:{control:"boolean",type:{name:"boolean",summary:"boolean"}},nav:{control:"boolean",type:{name:"boolean",summary:"boolean"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},back:{control:"boolean",type:{name:"boolean",summary:"boolean"}},iconOnly:{control:"boolean",type:{name:"boolean",summary:"boolean"}},active:{control:"boolean",type:{name:"boolean",summary:"boolean"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},label:{control:"text",type:{name:"string",summary:"string"}},href:{control:"text",type:{name:"string",summary:"string"}},target:{control:"text",type:{name:"string",summary:"string"}},rel:{control:"text",type:{name:"string",summary:"string"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:te,docs:{description:{component:"페이지 이동·액션 트리거용 하이퍼링크 컴포넌트입니다. 본문 안 인라인 링크는 Typography의 typo_link를 사용합니다."}}}},l={parameters:{controls:{disable:!1}},args:{...me},render:Z(n)},r={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"기본 색상은 primary입니다. hover 시 밑줄이 표시됩니다."},source:{code:`import Link from '@uxkm/ui-react/components/Link.jsx';
...
}`,...(z=(C=c.parameters)==null?void 0:C.docs)==null?void 0:z.source}}};var P,S,E;t.parameters={...t.parameters,docs:{...(P=t.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: '내비게이션',
  parameters: {
    controls: {
      disable: false
...
}`,...(E=(S=t.parameters)==null?void 0:S.docs)==null?void 0:E.source}}};var H,O,D;m.parameters={...m.parameters,docs:{...(H=m.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: '블록 · 그룹',
  parameters: {
    controls: {
      disable: false
...
}`,...(D=(O=m.parameters)==null?void 0:O.docs)==null?void 0:D.source}}};var V,R,B;d.parameters={...d.parameters,docs:{...(V=d.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: '아이콘 전용',
  parameters: {
    controls: {
      disable: false
