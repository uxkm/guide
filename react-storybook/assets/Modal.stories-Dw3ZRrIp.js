import{r as N,d as ra,E as ta,n as da,j as a,v as o,I as sa,a as ia}from"./iframe-DbjMrqYU.js";import{w as ma}from"./story-renders-CrEYzOkG.js";import{f as na,a as ca}from"./ripple-api-B9h0vjZK.js";import"./preload-helper-DUxc-Dqw.js";const pa=new Set(["sm","md","lg","fullscreen"]);function l({ripple:e,id:t,size:h="md",scrollable:x,backdrop:j=!0,title:v,open:i,header:y,footer:_,children:X,className:B,...M}){const k=N.useRef(null),{rippleAttrs:Y}=ra({ripple:e}),s=pa.has(h)?h:"md",z=`${t}-title`;ta({ripple:e,id:t,size:s,scrollable:x,backdrop:j,title:v,open:i},k,{className:B,...M});const aa=N.useMemo(()=>{const d=["modal"];return s==="sm"&&d.push("modal_sm"),s==="lg"&&d.push("modal_lg"),s==="fullscreen"&&d.push("modal_fullscreen"),x&&d.push("modal_scrollable"),i&&d.push("is-open"),d},[s,x,i]),{class:Ma,...oa}=M,la=da(oa),ea=!!(y||v);return a.jsxs("div",{ref:k,id:t,className:ia(aa,B),"data-modal":"","data-modal-backdrop":j?void 0:"false",role:"dialog","aria-modal":"true","aria-labelledby":z,tabIndex:-1,hidden:!i||void 0,...la,children:[a.jsx("div",{className:"modal_backdrop","data-modal-close":"","aria-hidden":"true"}),a.jsxs("div",{className:"modal_dialog",children:[ea?a.jsxs("div",{className:"modal_header","data-demo-slot":"header",children:[y??a.jsx("h2",{className:"modal_title",id:z,children:v}),a.jsx(o,{variant:"ghost",iconOnly:!0,className:"modal_close","data-modal-close":"",ariaLabel:"닫기",iconBefore:a.jsx(sa,{name:"close",size:"sm",className:"modal_close-icon"}),...Y})]}):null,a.jsx("div",{className:"modal_body","data-demo-slot":"default",children:X}),_?a.jsx("div",{className:"modal_footer","data-demo-slot":"footer",children:_}):null]})]})}l.__docgenInfo={description:"",methods:[],displayName:"Modal",props:{size:{defaultValue:{value:"'md'",computed:!1},required:!1},backdrop:{defaultValue:{value:"true",computed:!1},required:!1}}};const ua=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],fa=[{name:"id",type:"string",default:"—",description:"루트 id (필수, data-modal-trigger 연결)"},{name:"title",type:"string",default:"—",description:"기본 헤더 제목 (modal_title)"},{name:"size",type:"'sm' | 'md' | 'lg' | 'fullscreen'",default:"md",description:"modal_sm · modal_lg · modal_fullscreen"},{name:"scrollable",type:"boolean",default:"false",description:"본문 스크롤 (modal_scrollable)"},{name:"backdrop",type:"boolean",default:"true",description:'백드롭 표시 (false → data-modal-backdrop="false")'},{name:"open",type:"boolean",default:"false",description:"열림 상태 (is-open, hidden 해제)"},na],ga=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],ba=[{name:"modal · modal_backdrop · modal_dialog",description:"루트·백드롭·대화상자"},{name:"modal_header · modal_title · modal_close · modal_body · modal_footer",description:"구조 파트"},{name:"modal_sm · modal_lg · modal_fullscreen · modal_scrollable",description:"크기·스크롤"},{name:"data-modal · data-modal-trigger · data-modal-close",description:"JS 연동 속성"},{name:"is-open · hidden",description:"열림·닫힘 상태"},{name:'role="dialog" · aria-modal="true"',description:"접근성 시맨틱"},...ca],xa=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],va=[{name:"--modal-z-index",default:"300",description:"레이어 순서"},{name:"--modal-width · --modal-width-sm · --modal-width-lg",default:"32rem · 24rem · 48rem",description:"대화상자 너비"},{name:"--modal-bg · --modal-radius · --modal-shadow",default:"—",description:"배경·모서리·그림자"}],ha=[{key:"name",label:"Prop / Children"},{key:"description",label:"설명"}],ja=[{name:"header",description:"헤더 (title 대체)"},{name:"children",description:"본문 (modal_body, Vue default 슬롯)"},{name:"footer",description:"하단 액션 (modal_footer)"}],ya=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다.",tables:[{columns:ua,rows:fa,codeColumn:"name"}]},{title:"API · Children / Slots",description:"Vue 슬롯에 대응하는 React prop·children입니다.",tables:[{columns:ha,rows:ja,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ga,rows:ba,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:xa,rows:va,codeColumn:"name"}]}];function _a(e){return a.jsx("div",{className:"modal_demo-frame",children:a.jsx("div",{className:"modal_demo-content",children:e})})}function r(e){const t=()=>_a(e);return ma(t,t)}const Ba={id:"story-modal",size:"md",scrollable:!1,backdrop:!0,title:"제목",open:!0},wa={title:"Components/피드백/Modal",id:"components-modal",component:l,tags:["autodocs"],argTypes:{id:{control:"text",type:{name:"string",summary:"string"}},size:{control:"select",options:["sm","md","lg","fullscreen"],type:{name:"enum",summary:"'sm' | 'md' | 'lg' | 'fullscreen'"}},scrollable:{control:"boolean",type:{name:"boolean",summary:"boolean"}},backdrop:{control:"boolean",type:{name:"boolean",summary:"boolean"}},title:{control:"text",type:{name:"string",summary:"string"}},open:{control:"boolean",type:{name:"boolean",summary:"boolean"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:ya,docs:{description:{component:"중앙 대화상자 Modal 컴포넌트입니다."}}}},m={parameters:{controls:{disable:!1}},args:{...Ba},render:e=>a.jsxs("div",{className:"modal_demo-frame",children:[a.jsx("div",{className:"modal_demo-content",children:a.jsx("p",{children:"Controls로 open · size · scrollable · backdrop을 조절하세요."})}),a.jsx(l,{...e,className:e.open?"modal_demo-static":void 0,footer:a.jsxs(a.Fragment,{children:[a.jsx(o,{variant:"ghost",label:"취소","data-modal-close":""}),a.jsx(o,{variant:"filled",color:"primary",label:"확인","data-modal-close":""})]}),children:a.jsx("p",{children:"모달 본문입니다."})})]})},n={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"data-modal-trigger로 대화상자를 열고, 백드롭·닫기 버튼·Esc로 닫습니다."},source:{code:`import Button from '@uxkm/ui-react/components/Button.jsx';
