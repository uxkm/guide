import{j as l,B as o}from"./iframe-DS-82CEY.js";import{F as a}from"./FormLayout-2QMxR3Rv.js";import{G as V}from"./Grid-CZbW72XU.js";import{I as e}from"./Input-uQ67Uwxs.js";import{w as r}from"./story-renders-DjJEfxtm.js";import{S as M}from"./Select-3arHRQ3Q.js";import{T as K}from"./Textarea-DhRHigo6.js";import"./preload-helper-DUxc-Dqw.js";const U=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],X=[{name:"layout",type:"'vertical' | 'horizontal' | 'inline'",default:"vertical",description:"form_vertical · form_horizontal · form_inline"},{name:"fit",type:"boolean",default:"false",description:"콘텐츠 너비에 맞춤 (form_fit)"},{name:"compact",type:"boolean",default:"false",description:"좁은 필드 간격 (form_compact)"},{name:"labelAlignStart",type:"boolean",default:"false",description:"라벨 상단·왼쪽 정렬 (form_label-align-start)"},{name:"labelWidth",type:"'sm' | 'lg'",default:"—",description:"가로 레이아웃 라벨 너비 (form_label-width-sm · form_label-width-lg)"},{name:"tag",type:"string",default:"form",description:"루트 HTML 태그 (form · div 등)"},{name:"className",type:"string",default:"—",description:"form 루트에 추가 클래스"}],O=[{key:"name",label:"Children"},{key:"description",label:"설명"}],q=[{name:"children",description:"form_field · form_actions 등 폼 콘텐츠 (Vue default 슬롯 대응)"}],J=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Q=[{name:"form",description:"폼 루트"},{name:"form_vertical · form_horizontal · form_inline",description:"레이아웃 방향"},{name:"form_fit · form_compact · form_label-align-start",description:"간격·정렬"},{name:"form_label-width-sm · form_label-width-lg",description:"라벨 너비"},{name:"form_field · form_field-label · form_field-hint · form_field-error",description:"필드 블록"},{name:"form_actions",description:"제출·취소 버튼 묶음"},{name:"form_required",description:"필수 표시 마크"}],Y=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Z=[{name:"--form-label-width · --form-label-width-sm · --form-label-width-lg",default:"7.5rem · 5rem · 10rem",description:"가로 레이아웃 라벨 너비"},{name:"--form-field-gap",default:"var(--space-lg)",description:"필드 간격"},{name:"--form-inline-field-min-width",default:"8rem",description:"인라인 필드 최소 너비"},{name:"--form-actions-gap",default:"var(--space-sm)",description:"액션 버튼 간격"}],$=[{title:"API · Props",description:"React에서는 camelCase prop을 사용합니다. HTML·Vue 문서의 kebab-case(예: label-align-start, label-width)와 동일한 의미입니다.",tables:[{columns:U,rows:X,codeColumn:"name"}]},{title:"API · Children",description:"Vue default 슬롯에 대응하는 React children입니다.",tables:[{columns:O,rows:q,codeColumn:"name"}]},{title:"클래스 · 속성",description:"React 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:J,rows:Q,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Y,rows:Z,codeColumn:"name"}]}],ll={layout:"vertical",fit:!1,compact:!1,labelAlignStart:!1,labelWidth:"",tag:"form"};function el({args:u}){return l.jsxs(a,{...u,noValidate:!0,children:[l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"pg-input",children:"이름"}),l.jsx(e,{id:"pg-input",placeholder:"입력"})]}),l.jsx("div",{className:"form_actions",children:l.jsx(o,{type:"submit",variant:"filled",color:"primary",label:"제출"})})]})}const fl={title:"Components/폼/FormLayout",id:"components-form-layout",component:a,tags:["autodocs"],argTypes:{layout:{control:"select",options:["vertical","horizontal","inline"],type:{name:"enum",summary:"'vertical' | 'horizontal' | 'inline'"}},fit:{control:"boolean",type:{name:"boolean",summary:"boolean"}},compact:{control:"boolean",type:{name:"boolean",summary:"boolean"}},labelAlignStart:{control:"boolean",type:{name:"boolean",summary:"boolean"}},labelWidth:{control:"select",options:["","sm","lg"],labels:{"":"기본",sm:"sm",lg:"lg"},type:{name:"enum",summary:"'sm' | 'lg'"}},tag:{control:"select",options:["form","div"],type:{name:"enum",summary:"'form' | 'div'"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:$,docs:{description:{component:"form_field · form_actions를 세로·가로·인라인으로 배치하는 폼 레이아웃 래퍼입니다."}}}},t={parameters:{controls:{disable:!1}},args:{...ll},render:u=>l.jsx(el,{args:u})},i={name:"세로",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"레이블이 입력 위에 오는 기본 레이아웃입니다. form_vertical을 명시하거나 form_field만 나열해도 동일하게 동작합니다."},source:{code:`import FormLayout from '@uxkm/ui-react/components/FormLayout.jsx';
...
}`,language:"tsx"}}},render:r(l.jsxs(a,{layout:"vertical",children:[l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-name",children:"이름"}),l.jsx(e,{id:"fl-name",placeholder:"이름을 입력하세요"}),l.jsx("p",{className:"form_field-hint",children:"2~20자 이내로 입력해 주세요."})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-email",children:"이메일"}),l.jsx(e,{id:"fl-email",type:"email",placeholder:"name@example.com"})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-role",children:"역할"}),l.jsxs(M,{id:"fl-role",placeholder:"선택하세요",children:[l.jsx("option",{value:"",children:"선택하세요"}),l.jsx("option",{children:"관리자"}),l.jsx("option",{children:"편집자"}),l.jsx("option",{children:"뷰어"})]})]})]}))},m={name:"가로",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"레이블이 왼쪽, 입력이 오른쪽에 배치됩니다. 레이블은 기본적으로 오른쪽 정렬됩니다."},source:{code:`import FormLayout from '@uxkm/ui-react/components/FormLayout.jsx';
import Input from '@uxkm/ui-react/components/Input.jsx';
...
}`,language:"tsx"}}},render:r(l.jsxs(a,{layout:"inline",children:[l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-i-keyword",children:"키워드"}),l.jsx(e,{id:"fl-i-keyword",type:"search",placeholder:"검색어"})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-i-status",children:"상태"}),l.jsxs(M,{id:"fl-i-status",children:[l.jsx("option",{children:"전체"}),l.jsx("option",{children:"활성"}),l.jsx("option",{children:"비활성"})]})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-i-date",children:"기간"}),l.jsx(e,{id:"fl-i-date",type:"date"})]}),l.jsxs("div",{className:"form_actions",children:[l.jsx(o,{variant:"filled",color:"primary",type:"submit",label:"검색"}),l.jsx(o,{variant:"ghost",type:"reset",label:"초기화"})]})]}))},f={name:"그리드",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"Grid 유틸리티와 조합해 2열·3열 폼을 구성합니다. grid_item-span-6이면 12열 기준 한 행에 2개씩 배치됩니다."},source:{code:`import FormLayout from '@uxkm/ui-react/components/FormLayout.jsx';
...
}`,language:"tsx"}}},render:r(l.jsx(a,{layout:"vertical",children:l.jsxs(V,{itemSpan:6,children:[l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-g-first",children:"이름"}),l.jsx(e,{id:"fl-g-first",placeholder:"이름"})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-g-last",children:"성"}),l.jsx(e,{id:"fl-g-last",placeholder:"성"})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-g-phone",children:"전화번호"}),l.jsx(e,{id:"fl-g-phone",type:"tel",placeholder:"010-0000-0000"})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-g-mobile",children:"휴대폰"}),l.jsx(e,{id:"fl-g-mobile",type:"tel",placeholder:"010-0000-0000"})]}),l.jsxs("div",{className:"form_field grid_col-span-12",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-g-address",children:"주소"}),l.jsx(e,{id:"fl-g-address",placeholder:"도로명 주소"})]})]})}))},c={name:"너비",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"폼 필드는 기본적으로 부모 너비 100%를 사용합니다. form_fit을 사용하면 --input-max-width(320px)로 제한할 수 있습니다."},source:{code:`import FormLayout from '@uxkm/ui-react/components/FormLayout.jsx';
import Input from '@uxkm/ui-react/components/Input.jsx';
...
}`,language:"tsx"}}},render:r(l.jsxs(a,{layout:"vertical",compact:!0,children:[l.jsxs(V,{itemSpan:6,children:[l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-ex-id",children:"아이디"}),l.jsx(e,{id:"fl-ex-id",placeholder:"아이디"}),l.jsx("p",{className:"form_field-hint",children:"영문·숫자 4~16자"})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-ex-pw",children:"비밀번호"}),l.jsx(e,{id:"fl-ex-pw",type:"password",placeholder:"비밀번호"})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-ex-name",children:"이름"}),l.jsx(e,{id:"fl-ex-name",placeholder:"이름"})]}),l.jsxs("div",{className:"form_field",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-ex-email",children:"이메일"}),l.jsx(e,{id:"fl-ex-email",type:"email",placeholder:"name@example.com"})]}),l.jsxs("div",{className:"form_field grid_col-span-12",children:[l.jsx("label",{className:"form_field-label",htmlFor:"fl-ex-memo",children:"메모"}),l.jsx(K,{id:"fl-ex-memo",rows:3,placeholder:"추가 정보"})]})]}),l.jsxs("div",{className:"form_actions",children:[l.jsx(o,{variant:"filled",color:"primary",type:"submit",label:"가입하기"}),l.jsx(o,{variant:"ghost",type:"button",label:"취소"})]})]}))};var h,b,x;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(_=(v=i.parameters)==null?void 0:v.docs)==null?void 0:_.source}}};var N,F,j;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: '가로',
  parameters: {
    controls: {
      disable: false
...
}`,...(j=(F=m.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var g,L,I;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: '가로 — 레이블 정렬·너비',
  parameters: {
    controls: {
      disable: false
...
}`,...(I=(L=s.parameters)==null?void 0:L.docs)==null?void 0:I.source}}};var w,k,S;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: '인라인',
  parameters: {
    controls: {
      disable: false
...
}`,...(S=(k=d.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};var z,B,G;f.parameters={...f.parameters,docs:{...(z=f.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: '그리드',
  parameters: {
    controls: {
      disable: false
...
}`,...(G=(B=f.parameters)==null?void 0:B.docs)==null?void 0:G.source}}};var C,P,T;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: '너비',
  parameters: {
    controls: {
      disable: false
...
}`,...(T=(P=c.parameters)==null?void 0:P.docs)==null?void 0:T.source}}};var E,A,W;n.parameters={...n.parameters,docs:{...(E=n.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: '액션 영역',
  parameters: {
    controls: {
      disable: false
...
}`,...(W=(A=n.parameters)==null?void 0:A.docs)==null?void 0:W.source}}};var R,D,H;p.parameters={...p.parameters,docs:{...(R=p.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: '전체 예시',
  parameters: {
    controls: {
      disable: false
...
}`,...(H=(D=p.parameters)==null?void 0:D.docs)==null?void 0:H.source}}};const cl=["Playground","Vertical","Horizontal","HorizontalAlign","Inline","GridDemo","Width","Actions","Example"];export{n as Actions,p as Example,f as GridDemo,m as Horizontal,s as HorizontalAlign,d as Inline,t as Playground,i as Vertical,c as Width,cl as __namedExportsOrder,fl as default};
