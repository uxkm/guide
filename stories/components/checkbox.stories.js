import html from '../../src/components/checkbox.html?raw';
import {
  extractDemoSections,
  extractApiSections,
  renderDemo,
...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "다중 선택을 위한 Checkbox 컴포넌트입니다. 기본 너비는 인라인(콘텐츠)이며, checkbox_block · checkbox_group_block으로 전체 너비를 사용합니다.",
      },
    },
  },
};
