import html from '../../src/components/collapse.html?raw';
import {
  extractDemoSections,
  extractApiSections,
  renderDemo,
...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '콘텐츠 영역을 접었다 펼 수 있는 컴포넌트입니다. 외부 버튼으로 단일 영역을 제어하거나, 패널 그룹으로 여러 섹션을 구성할 수 있습니다. aria-expanded · aria-controls로 접근성을 보장합니다.',
      },
    },
  },
};
