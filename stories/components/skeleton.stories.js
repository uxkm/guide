import html from '../../src/components/skeleton.html?raw';
import {
  extractDemoSections,
  extractApiSections,
  renderDemo,
...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '콘텐츠가 로드되기 전 레이아웃을 미리 보여 주는 Skeleton 컴포넌트입니다. 텍스트·아바타·이미지·버튼 형태와 조합 레이아웃을 지원하며 role="status" · aria-busy · aria-label로 접근성을 보장합니다.',
      },
    },
  },
};
