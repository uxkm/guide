import html from '../../src/components/list.html?raw';
import {
  extractDemoSections,
  extractApiSections,
  renderDemo,
...
export const Demo12 = {
  ...
  parameters: { docs: { ...gulpSource(demos[12].previewHtml).docs, description: { story: demos[12].description } } },
};
export const Demo13 = {
  name: '정의 목록 · 인라인',
  render: () => renderDemo(demos[13]),
  parameters: { docs: { ...gulpSource(demos[13].previewHtml).docs, description: { story: demos[13].description } } },
};
export const Demo14 = {
  name: '정의 목록 · 값 우측 정렬',
  render: () => renderDemo(demos[14]),
  parameters: { docs: { ...gulpSource(demos[14].previewHtml).docs, description: { story: demos[14].description } } },
};
