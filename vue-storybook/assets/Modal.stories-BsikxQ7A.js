import{k as aa,l as oa,u as ea,a as la,ab as ua,o as b,c as g,d as s,r as A,t as ta,e as y,w as na,_ as ra,p as M,s as da,q as u,g as _,j as k,h as sa}from"./iframe-_Cy3TTd_.js";import{s as Ca,w as ma}from"./story-renders-BkwSCuFa.js";import{e as ia,a as ca}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const pa=["id","data-modal-backdrop","hidden"],Ba={class:"modal_dialog"},fa={key:0,class:"modal_header","data-demo-slot":"header"},Da={class:"modal_body","data-demo-slot":"default"},ba={key:1,class:"modal_footer","data-demo-slot":"footer"},e=Object.assign({inheritAttrs:!1},{__name:"Modal",props:{ripple:aa,id:{type:String,required:!0},size:{type:String,default:"md",validator:a=>["sm","md","lg","fullscreen"].includes(a)},scrollable:Boolean,backdrop:{type:Boolean,default:!0},title:String,open:Boolean},setup(a){const l=a,{rippleAttrs:X}=oa(l);ea();const r=la(),v=sa(null),E=`${l.id}-title`;ua(l,v,r);const Y=k(()=>{const o=["modal"];return l.size==="sm"&&o.push("modal_sm"),l.size==="lg"&&o.push("modal_lg"),l.size==="fullscreen"&&o.push("modal_fullscreen"),l.scrollable&&o.push("modal_scrollable"),l.open&&o.push("is-open"),r.class&&o.push(r.class),o}),Z=k(()=>{const{class:o,...d}=r;return d});return(o,d)=>(b(),g("div",M({ref_key:"rootRef",ref:v,id:a.id,class:Y.value,"data-modal":"","data-modal-backdrop":a.backdrop?void 0:"false",role:"dialog","aria-modal":"true","aria-labelledby":E,tabindex:"-1",hidden:!a.open||void 0},Z.value),[d[0]||(d[0]=s("div",{class:"modal_backdrop","data-modal-close":"","aria-hidden":"true"},null,-1)),s("div",Ba,[o.$slots.header||a.title?(b(),g("div",fa,[A(o.$slots,"header",{},()=>[s("h2",{class:"modal_title",id:E},ta(a.title),1)]),y(u,M({variant:"ghost","icon-only":"",class:"modal_close","data-modal-close":"","aria-label":"닫기"},da(X)),{"icon-before":na(()=>[y(ra,{name:"close",size:"sm",class:"modal_close-icon"})]),_:1},16)])):_("",!0),s("div",Da,[A(o.$slots,"default")]),o.$slots.footer?(b(),g("div",ba,[A(o.$slots,"footer")])):_("",!0)])],16,pa))}});e.__docgenInfo=Object.assign({displayName:e.name??e.__name},{exportName:"default",displayName:"Modal",description:"",tags:{},props:[{name:"ripple",description:"클릭 파장(ripple). true 활성 · false 비활성 · 미지정 시 컴포넌트 기본",type:{name:"rippleProp"}},{name:"id",type:{name:"string"},required:!0},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md","lg","fullscreen"]},{name:"scrollable",type:{name:"boolean"}},{name:"backdrop",description:'백드롭 표시. false 시 data-modal-backdrop="false"',type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"title",type:{name:"string"}},{name:"open",type:{name:"boolean"}}],slots:[{name:"header"},{name:"default"},{name:"footer"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Modal.vue"]});const ga=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Aa=[{name:"id",type:"string",default:"—",description:"루트 id (필수, data-modal-trigger 연결)"},{name:"title",type:"string",default:"—",description:"기본 헤더 제목 (modal_title)"},{name:"size",type:"'sm' | 'md' | 'lg' | 'fullscreen'",default:"md",description:"modal_sm · modal_lg · modal_fullscreen"},{name:"scrollable",type:"boolean",default:"false",description:"본문 스크롤 (modal_scrollable)"},{name:"backdrop",type:"boolean",default:"true",description:'백드롭 표시 (false → data-modal-backdrop="false")'},{name:"open",type:"boolean",default:"false",description:"열림 상태 (is-open, hidden 해제)"},ia],va=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Ea=[{name:"header",description:"헤더 (title 대체)"},{name:"default",description:"본문 (modal_body)"},{name:"footer",description:"하단 액션 (modal_footer)"}],ya=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ma=[{name:"modal · modal_backdrop · modal_dialog",description:"루트·백드롭·대화상자"},{name:"modal_header · modal_title · modal_close · modal_body · modal_footer",description:"구조 파트"},{name:"modal_sm · modal_lg · modal_fullscreen · modal_scrollable",description:"크기·스크롤"},{name:"data-modal · data-modal-trigger · data-modal-close",description:"JS 연동 속성"},{name:"is-open · hidden",description:"열림·닫힘 상태"},{name:'role="dialog" · aria-modal="true"',description:"접근성 시맨틱"},...ca],_a=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ka=[{name:"--modal-z-index",default:"300",description:"레이어 순서"},{name:"--modal-width · --modal-width-sm · --modal-width-lg",default:"32rem · 24rem · 48rem",description:"대화상자 너비"},{name:"--modal-bg · --modal-radius · --modal-shadow",default:"—",description:"배경·모서리·그림자"}],za=[{title:"API · Props",tables:[{columns:ga,rows:Aa,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:va,rows:Ea,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ya,rows:Ma,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:_a,rows:ka,codeColumn:"name"}]}];function t(a){return ma(a,a)}function n(a){return`
    <div class="modal_demo-frame">
      <div class="modal_demo-content">
        ${a}
      </div>
    </div>
  `}const Sa={title:"Components/피드백/Modal",id:"components-modal",component:e,tags:["autodocs"],argTypes:{id:{control:"text",type:{name:"string",summary:"string"}},size:{control:"select",options:["sm","md","lg","fullscreen"],type:{name:"enum",summary:"'sm' | 'md' | 'lg' | 'fullscreen'"}},scrollable:{control:"boolean",type:{name:"boolean",summary:"boolean"}},backdrop:{control:"boolean",type:{name:"boolean",summary:"boolean"}},title:{control:"text",type:{name:"string",summary:"string"}},open:{control:"boolean",type:{name:"boolean",summary:"boolean"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:za}},C={parameters:{controls:{disable:!1}},args:{id:"story-modal",size:"md",scrollable:!1,backdrop:!0,title:"제목",open:!0},render:(a,l)=>({components:{Modal:e},setup(){return{args:Ca(l)}},template:`
      <div class="modal_demo-frame">
        <div class="modal_demo-content">
...
</template>`,language:"vue"}}},args:{id:"story-modal",size:"md",title:"제목"},render:t(()=>({components:{Button:u,Modal:e},template:n(`
      <Button variant="filled" color="primary" label="모달 열기" data-modal-trigger="#modal-basic" aria-controls="modal-basic" />
      <Modal id="modal-basic" title="알림">
...
</template>`,language:"vue"}}},args:{id:"story-modal",size:"sm",title:"제목"},render:t(()=>({components:{Button:u,Modal:e},template:n(`
      <Button variant="filled" color="danger" label="삭제" data-modal-trigger="#modal-confirm" aria-controls="modal-confirm" />
...
</template>`,language:"vue"}}},args:{id:"story-modal",size:"md",scrollable:!0,title:"제목"},render:t(()=>({components:{Button:u,Modal:e},template:n(`
      <Button variant="ghost" label="이용 약관 보기" data-modal-trigger="#modal-scroll" aria-controls="modal-scroll" />
      <Modal id="modal-scroll" scrollable title="이용 약관">
...
</template>`,language:"vue"}}},args:{id:"story-modal",size:"sm",backdrop:!1,title:"제목"},render:t(()=>({components:{Button:u,Modal:e},template:n(`
      <Button variant="ghost" label="백드롭 없이 열기" data-modal-trigger="#modal-no-backdrop" aria-controls="modal-no-backdrop" />
      <Modal id="modal-no-backdrop" size="sm" title="백드롭 없음" :backdrop="false">
...
}`,...($=(L=i.parameters)==null?void 0:L.docs)==null?void 0:$.source}}};var N,I,R;c.parameters={...c.parameters,docs:{...(N=c.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: "헤더·푸터",
  parameters: {
    controls: {
      disable: false
...
}`,...(R=(I=c.parameters)==null?void 0:I.docs)==null?void 0:R.source}}};var V,O,T;p.parameters={...p.parameters,docs:{...(V=p.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: "확인 대화상자",
  parameters: {
    controls: {
      disable: false
...
}`,...(T=(O=p.parameters)==null?void 0:O.docs)==null?void 0:T.source}}};var j,q,H;B.parameters={...B.parameters,docs:{...(j=B.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: "폼",
  parameters: {
    controls: {
      disable: false
...
}`,...(H=(q=B.parameters)==null?void 0:q.docs)==null?void 0:H.source}}};var J,U,G;f.parameters={...f.parameters,docs:{...(J=f.parameters)==null?void 0:J.docs,source:{originalSource:`{
  name: "스크롤 본문",
  parameters: {
    controls: {
      disable: false
...
}`,...(G=(U=f.parameters)==null?void 0:U.docs)==null?void 0:G.source}}};var K,Q,W;D.parameters={...D.parameters,docs:{...(K=D.parameters)==null?void 0:K.docs,source:{originalSource:`{
  name: "백드롭 없음",
  parameters: {
    controls: {
      disable: false
...
}`,...(W=(Q=D.parameters)==null?void 0:Q.docs)==null?void 0:W.source}}};const Pa=["Playground","Basic","Size","Footer","Confirm","Form","Scroll","NoBackdrop"];export{m as Basic,p as Confirm,c as Footer,B as Form,D as NoBackdrop,C as Playground,f as Scroll,i as Size,Pa as __namedExportsOrder,Sa as default};
