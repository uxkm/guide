...
`,Ji=`${Qi}<template>
  ...
  <Carousel aria-label="프로모션 슬라이드">
    ...
    </Carousel>`}))},lt={name:"커버플로우 · 축소",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:'coverflow-style="rise"로 측면만 축소합니다. 슬라이드 크기는 coverflow-sides와 관계없이 동일하며, 좌·우 노출(1 · 1.5 · 2)은 간격으로 조절합니다.'},source:ie(Zi)}},args:{...fe,effect:"coverflow",coverflowStyle:"rise",coverflowSides:1.5,spaceBetween:16,initialSlide:0,loop:!0,pagination:!1,ariaLabel:"커버플로우 축소 좌우 1.5"},argTypes:{coverflowSides:{control:"select",options:[1,1.5,2],type:{name:"union",summary:"1 | 1.5 | 2 | 'auto'"}}},render:ce(()=>({components:ne,setup(){return{carouselCoverflowSlides:Ga}},template:`<div class="demo_preview-block">
      <h3 class="typo_overline">좌우 1개씩</h3>
      <p class="typo_caption">:coverflow-sides="1" — 슬라이드 크기 기준. 좌·우에 1개씩.</p>
      <Carousel
        aria-label="커버플로우 축소 좌우 1"
    ...
    </Carousel>`})};var Ft,Gt,Ht;je.parameters={...je.parameters,docs:{...(Ft=je.parameters)==null?void 0:Ft.docs,source:{originalSource:`{
  name: "기본",
  parameters: {
    controls: {
      disable: false
...
}`,...(Ht=(Gt=je.parameters)==null?void 0:Gt.docs)==null?void 0:Ht.source}}};var Rt,Vt,Xt;Ue.parameters={...Ue.parameters,docs:{...(Rt=Ue.parameters)==null?void 0:Rt.docs,source:{originalSource:`{
  name: "페이드",
  parameters: {
    controls: {
      disable: false
