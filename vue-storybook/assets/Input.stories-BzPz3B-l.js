import{_ as e}from"./Input-CzWCGHEa.js";import{w as l,s as ee}from"./story-renders-BkwSCuFa.js";import{_ as C,q as n,Y as le}from"./iframe-_Cy3TTd_.js";import{_ as Q}from"./FormLayout-DtgRIXTB.js";import{_ as ne}from"./Select-BYfbfYk9.js";import{a as ue}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const ae=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ie=[{name:"model-value",type:"string",default:"—",description:"v-model 바인딩 값"},{name:"type",type:"string",default:"text",description:"input type 속성"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"input_sm · input_lg"},{name:"placeholder",type:"string",default:"—",description:"placeholder 속성"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"error",type:"boolean",default:"false",description:"오류 상태 (is-error, aria-invalid)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100% (input_block)"}],te=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],re=[{name:"prefix",description:"앞쪽 애드온 (input_group-addon)"},{name:"suffix",description:"뒤쪽 애드온"}],pe=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],de=[{name:"input",description:"텍스트 입력 루트"},{name:"input_sm · input_lg · input_block",description:"크기·너비"},{name:"input_masked",description:'마스킹 입력값 표시 시 자동 적용 (type="password" + 값 있음)'},{name:"input_group · input_group-addon",description:"애드온 묶음"},{name:"input_clearable · input_clear",description:'지우기 버튼 — input_clear에 data-ripple="surface"'},{name:"is-error · is-disabled",description:"상태"},...ue],se=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],oe=[{name:"--input-max-width",default:"320px",description:"데모·폼 최대 너비"},{name:"--input-clear-size · --input-clear-offset",default:"—",description:"클리어 버튼"},{name:"--input-font-masked · --input-masked-letter-spacing",default:"—",description:"마스킹 입력"}],me=[{key:"name",label:"이벤트"},{key:"description",label:"설명"}],ce=[{name:"update:modelValue",description:"입력 값 변경 시 (v-model)"}],fe=[{title:"API · Props",tables:[{columns:ae,rows:ie,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:te,rows:re,codeColumn:"name"}]},{title:"API · Events",tables:[{columns:me,rows:ce,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:pe,rows:de,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:se,rows:oe,codeColumn:"name"}]}],ye={title:"Components/폼/Input",id:"components-input",component:e,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placeholder:{control:"text",type:{name:"string",summary:"string"}},type:{control:"select",options:["text","email","password","number","tel","url","search"],type:{name:"enum",summary:"'text' | 'email' | 'password' | 'number' | 'tel' | 'url' | 'search'"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},modelValue:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:fe}},u={parameters:{controls:{disable:!1}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:(Ce,Z)=>({components:{Input:e},setup(){return{args:ee(Z)}},template:'<Input v-bind="args" />'})},a={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"레이블과 힌트 텍스트가 포함된 폼 필드입니다."},source:{code:`<script setup>
...
</template>`,language:"vue"}}},args:{size:"md",placeholder:"입력하세요",type:"text",modelValue:""},render:l(()=>({components:{Button:n,Icon:C,Input:e},template:`        <div class="form_field">
        <label class="form_field-label" for="input-name">이름</label>
        <div class="input_clearable">
        <Input id="input-name" placeholder="이름을 입력하세요" />
        <Button class="input_clear" aria-label="입력 지우기" icon-only hidden>
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Button:n,Icon:C,Input:e},template:`        <div class="input_field">
        <label class="form_field-label" for="input-standalone-placeholder">검색어</label>
        <div class="input_clearable">
        <Input id="input-standalone-placeholder" placeholder="플레이스홀더" />
        <Button class="input_clear" aria-label="입력 지우기" icon-only hidden>
...
<template>
  ...
  <div class="form_field">
    ...
    <Input id="input-type-time" type="time" />
        ...
        <label class="form_field-label" for="input-type-time">시간</label>
        <Input id="input-type-time" type="time" />
        </div>`}))},r={name:"입력 종류",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"결제·본인인증·사업자 정보 등 도메인별 입력 패턴입니다. 예시는 부모 너비 100%를 기본으로 하며, 필요 시 form_field_fit · input_fit으로 최대 너비를 제한할 수 있습니다. input_split · input_otp · input_group · input_row를 조합해 구성합니다."},source:{code:`<script setup>
import Button from '@uxkm/ui/components/Button.vue';
import Input from '@uxkm/ui/components/Input.vue';
...
<template>
  ...
  <p class="form_field-hint">천 단위 구분은 표시용으로 별도 포맷팅합니다.</p>
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Button:n,Input:e,Select:ne},template:`        <div class="form_field">
        <label class="form_field-label" for="input-kind-card-1">카드번호</label>
        <div class="input_split" role="group" aria-labelledby="input-kind-card-1" data-input-split data-input-numeric>
        <Input id="input-kind-card-1" inputmode="numeric" maxlength="4" autocomplete="cc-number" aria-label="카드번호 1~4자리" placeholder="0000" />
        <span class="input_split_sep" aria-hidden="true">-</span>
        ...
        <p class="form_field-hint">천 단위 구분은 표시용으로 별도 포맷팅합니다.</p>
        </div>`}))},p={name:"크기",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"input_sm · input(기본) · input_lg로 padding·font-size를 조절합니다. 너비와는 별개이며 input_fit 등과 자유롭게 조합할 수 있습니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <Input id="input-size-lg" size="lg" placeholder="input_lg" />
        ...
        <label class="form_field-label" for="input-size-lg">Large</label>
        <Input id="input-size-lg" size="lg" placeholder="input_lg" />
        </div>`}))},d={name:"너비",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"크기와 독립적으로 너비를 제어합니다. 기본은 부모 100%, input_fit · input_field_fit · form_field_fit · form_fit으로 --input-max-width(320px)까지 제한합니다."},source:{code:`<script setup>
...
<template>
  ...
  <template #prefix>@</template>
        ...
        <Input class="input_fit" placeholder="input_group input_fit — Medium" aria-label="아이디">
        <template #prefix>@</template>
        </Input>`}))},s={name:"Input Group",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"input_group으로 앞뒤에 텍스트·아이콘 애드온을 붙일 수 있습니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <template #suffix>KRW</template>
        ...
        <template #prefix>₩</template>
        <template #suffix>KRW</template>
        </Input>`}))},o={name:"필수 필드",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"required 속성과 form_field-required로 필수 입력을 표시합니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <Input id="input-required-name" placeholder="홍길동" required aria-required="true" />
        ...
        <Input id="input-required-name" placeholder="홍길동" required aria-required="true" />
        </div>`}))},m={name:"상태",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"disabled · readonly · is-error · is-success로 입력 상태를 표현합니다. 오류·성공 메시지는 색상만으로 전달하지 않고 텍스트와 aria 속성을 함께 사용합니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <p class="form_field-error" id="input-state-error-msg" role="alert">올바른 이메일 형식이 아닙니다.</p>
        ...
        <Input id="input-state-error" type="email" error model-value="invalid-email" aria-describedby="input-state-error-msg" />
        <p class="form_field-error" id="input-state-error-msg" role="alert">올바른 이메일 형식이 아닙니다.</p>
        </div>`}))},c={name:"입력 삭제",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"`input_clearable` 래퍼로 값이 있을 때 우측에 지우기 버튼을 표시합니다. `readonly` · `disabled` 상태에서는 버튼이 나타나지 않습니다."},source:{code:`<script setup>
import Button from '@uxkm/ui/components/Button.vue';
import Icon from '@uxkm/ui/components/Icon.vue';
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
  ...
  <div class="form_field form_field_fit">
    ...
    <div class="input_clearable">
      ...
      <Button class="input_clear" aria-label="입력 지우기" icon-only hidden>
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Button:n,Icon:C,Input:e},template:`        <div class="form_field form_field_fit">
        <label class="form_field-label" for="input-clear-text">텍스트</label>
        <div class="input_clearable">
        <Input id="input-clear-text" placeholder="입력 후 우측 X 버튼 확인" />
        <Button class="input_clear" aria-label="입력 지우기" icon-only hidden>
        ...
        </div>`}))},f={name:"조합 예시",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"유효성 검사 후 성공·실패 상태를 조합한 로그인 폼입니다. aria-invalid · aria-describedby · role=&quot;alert&quot; · role=&quot;status&quot;로 스크린 리더에 피드백을 전달합니다."},source:{code:`<script setup>
...
<template>
  ...
  <div class="form_actions">
    ...
    <Button variant="ghost" size="sm" type="button" label="취소" />
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:l(()=>({components:{Alert:le,Button:n,FormLayout:Q,Input:e},template:`        <FormLayout layout="vertical" compact novalidate aria-labelledby="example-heading">
        <Alert
        id="input-ex-form-error"
        color="danger"
        title="입력 내용을 확인해 주세요"
        ...
        </FormLayout>`}))};var b,B,_;u.parameters={...u.parameters,docs:{...(b=u.parameters)==null?void 0:b.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(_=(B=u.parameters)==null?void 0:B.docs)==null?void 0:_.source}}};var v,h,D;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  name: "기본",
  parameters: {
    controls: {
      disable: false
...
}`,...(D=(h=a.parameters)==null?void 0:h.docs)==null?void 0:D.source}}};var I,y,x;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: "단독 사용",
  parameters: {
    controls: {
      disable: false
...
}`,...(x=(y=i.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var g,A,k;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: "입력 타입",
  parameters: {
    controls: {
      disable: false
...
}`,...(k=(A=t.parameters)==null?void 0:A.docs)==null?void 0:k.source}}};var w,E,z;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: "입력 종류",
  parameters: {
    controls: {
      disable: false
...
}`,...(z=(E=r.parameters)==null?void 0:E.docs)==null?void 0:z.source}}};var F,q,S;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    controls: {
      disable: false
...
}`,...(S=(q=p.parameters)==null?void 0:q.docs)==null?void 0:S.source}}};var L,M,P;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: "너비",
  parameters: {
    controls: {
      disable: false
...
}`,...(P=(M=d.parameters)==null?void 0:M.docs)==null?void 0:P.source}}};var V,R,Y;s.parameters={...s.parameters,docs:{...(V=s.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: "Input Group",
  parameters: {
    controls: {
      disable: false
...
}`,...(Y=(R=s.parameters)==null?void 0:R.docs)==null?void 0:Y.source}}};var T,O,K;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: "필수 필드",
  parameters: {
    controls: {
      disable: false
...
}`,...(K=(O=o.parameters)==null?void 0:O.docs)==null?void 0:K.source}}};var U,W,$;m.parameters={...m.parameters,docs:{...(U=m.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: "상태",
  parameters: {
    controls: {
      disable: false
...
}`,...($=(W=m.parameters)==null?void 0:W.docs)==null?void 0:$.source}}};var G,X,H;c.parameters={...c.parameters,docs:{...(G=c.parameters)==null?void 0:G.docs,source:{originalSource:`{
  name: "입력 삭제",
  parameters: {
    controls: {
      disable: false
...
}`,...(H=(X=c.parameters)==null?void 0:X.docs)==null?void 0:H.source}}};var j,J,N;f.parameters={...f.parameters,docs:{...(j=f.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: "조합 예시",
  parameters: {
    controls: {
      disable: false
...
}`,...(N=(J=f.parameters)==null?void 0:J.docs)==null?void 0:N.source}}};const xe=["Playground","Basic","Standalone","Type","Kind","Size","Width","Group","Required","State","Clearable","Example"];export{a as Basic,c as Clearable,f as Example,s as Group,r as Kind,u as Playground,o as Required,p as Size,i as Standalone,m as State,t as Type,d as Width,xe as __namedExportsOrder,ye as default};
