import{_ as e}from"./Textarea-DSL1ARb7.js";import{w as a,s as K}from"./story-renders-BkwSCuFa.js";import{q as N}from"./iframe-_Cy3TTd_.js";import{_ as Q}from"./FormLayout-DtgRIXTB.js";import{_ as U}from"./Input-CzWCGHEa.js";import"./preload-helper-PMqzWbAN.js";const X=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Y=[{name:"model-value",type:"string",default:"—",description:"v-model 바인딩 값"},{name:"rows",type:"number | string",default:"3",description:"textarea rows 속성"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"textarea_sm · textarea_lg"},{name:"placeholder",type:"string",default:"—",description:"placeholder 속성"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"error",type:"boolean",default:"false",description:"오류 상태 (is-error)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100% (textarea_block)"}],Z=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],ee=[{name:"default",description:"초기 텍스트 (model-value 대체)"}],ae=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],re=[{name:"textarea",description:"텍스트영역 루트"},{name:"textarea_sm · textarea_lg · textarea_block",description:"크기·너비"},{name:"is-error · is-disabled",description:"상태"}],te=[{key:"name",label:"이벤트"},{key:"description",label:"설명"}],le=[{name:"update:modelValue",description:"입력 값 변경 시 (v-model)"}],se=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ne=[{name:"--textarea-min-height",default:"5rem",description:"최소 높이"},{name:"--textarea-count-inset-x · --textarea-count-inset-y",default:"0.75rem · 0.5rem",description:"글자 수 카운터 위치"}],ue=[{title:"API · Props",tables:[{columns:X,rows:Y,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:Z,rows:ee,codeColumn:"name"}]},{title:"API · Events",tables:[{columns:te,rows:le,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:ae,rows:re,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:se,rows:ne,codeColumn:"name"}]}],xe={title:"Components/폼/Textarea",id:"components-textarea",component:e,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placeholder:{control:"text",type:{name:"string",summary:"string"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},modelValue:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:ue}},r={parameters:{controls:{disable:!1}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",block:!1,rows:3,modelValue:""},render:(oe,J)=>({components:{Textarea:e},setup(){return{args:K(J)}},template:'<Textarea v-bind="args" />'})},t={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"레이블과 힌트 텍스트가 포함된 폼 필드입니다."},source:{code:`<script setup>
...
</template>`,language:"vue"}}},args:{size:"md",placeholder:"입력하세요",rows:3,modelValue:""},render:a(()=>({components:{Textarea:e},template:`<div class="form_field">
        <label class="form_field-label" for="textarea-bio">자기소개</label>
        <Textarea id="textarea-bio" :rows="4" placeholder="간단한 자기소개를 입력하세요" />
        <p class="form_field-hint">500자 이내로 작성해 주세요.</p>
      </div>`}))},l={name:"단독 사용",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"form_field 없이 textarea만 사용할 수 있습니다. 메모·댓글 입력 등 간단한 다행 입력에 적합합니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",block:!1,rows:3,modelValue:""},render:a(()=>({components:{Textarea:e},template:`<Textarea :rows="3" placeholder="플레이스홀더" />
      <Textarea :rows="3" model-value="입력된 내용이 여기에 표시됩니다." />
      <Textarea :rows="3" placeholder="비활성" disabled />`}))},s={name:"크기",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"textarea_sm · textarea(기본) · textarea_lg로 padding·font-size를 조절합니다. 너비와는 별개이며 textarea_fit 등과 자유롭게 조합할 수 있습니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
  ...
  <div class="form_field">
    ...
    <Textarea id="textarea-size-lg" size="lg" :rows="3" placeholder="textarea_lg" />
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",block:!1,rows:3,modelValue:""},render:a(()=>({components:{Textarea:e},template:`<div class="form_field">
        <label class="form_field-label" for="textarea-size-sm">Small</label>
        <Textarea id="textarea-size-sm" size="sm" :rows="3" placeholder="textarea_sm" />
      </div>
      <div class="form_field">
      ...
      <div class="form_field">
        <label class="form_field-label" for="textarea-size-lg">Large</label>
        <Textarea id="textarea-size-lg" size="lg" :rows="3" placeholder="textarea_lg" />
      </div>`}))},n={name:"너비",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"크기와 독립적으로 너비를 제어합니다. 기본은 부모 100%, textarea_fit · form_field_fit으로 --input-max-width(320px)까지 제한합니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
<template>
  ...
  <Textarea class="textarea_fit" :rows="3" placeholder="textarea_fit 단독 — 최대 320px" />
      ...
      <Textarea class="textarea_fit" :rows="3" placeholder="textarea_fit 단독 — 최대 320px" />`}))},u={name:"행 수",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"HTML rows 속성으로 초기 높이를 지정합니다. 리사이즈가 허용된 경우 사용자가 높이를 조절할 수 있습니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
  ...
  <div class="form_field">
    ...
    <Textarea id="textarea-rows-8" :rows="8" placeholder='rows="8" — 긴 본문용' />
      ...
      <div class="form_field">
        <label class="form_field-label" for="textarea-rows-8">8행</label>
        <Textarea id="textarea-rows-8" :rows="8" placeholder='rows="8" — 긴 본문용' />
      </div>`}))},o={name:"리사이즈",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"textarea_resize_* 클래스로 사용자 리사이즈 동작을 제어합니다. 기본값은 리사이즈 없음(resize: none)입니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
  ...
  <div class="form_field">
    ...
    <Textarea id="textarea-resize-both" class="textarea_resize_both" :rows="3" placeholder="textarea_resize_both" />
      ...
      <div class="form_field">
        <label class="form_field-label" for="textarea-resize-both">양방향</label>
        <Textarea id="textarea-resize-both" class="textarea_resize_both" :rows="3" placeholder="textarea_resize_both" />
      </div>`}))},i={name:"필수 필드",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"required 속성과 form_field-required로 필수 입력을 표시합니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
  ...
  <div class="form_field">
    ...
    <Textarea id="textarea-required-memo" size="sm" :rows="2" placeholder="필수 메모" required aria-required="true" />
      ...
      <div class="form_field">
        ...
        <Textarea id="textarea-required-memo" size="sm" :rows="2" placeholder="필수 메모" required aria-required="true" />
      </div>`}))},d={name:"글자 수 카운터",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:'`textarea_wrap textarea_show-count`로 textarea 우측 하단에 현재 글자 수를 표시합니다. `maxlength`와 함께 사용하면 `0/200` 형식으로 최대 글자 수를 함께 보여 줍니다. 카운터를 사용할 때는 `form_field-hint`로 글자 수 안내 문구(예: 200자 이내로 작성해 주세요.)를 함께 제공합니다. 입력 시 스크린 리더에는 `textarea_count_announcer`가 `role="status"` · `aria-live="polite"`로 현재·최대 글자 수를 음성 안내합니다.'},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
  ...
  <div class="form_field form_field_fit">
    ...
    <p class="form_field-hint" id="textarea-count-fit-hint">200자 이내로 작성해 주세요.</p>
      ...
      <div class="form_field form_field_fit">
        ...
        <p class="form_field-hint" id="textarea-count-fit-hint">200자 이내로 작성해 주세요.</p>
      </div>`}))},c={name:"상태",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"disabled · readonly · is-error · is-success로 입력 상태를 표현합니다. 오류·성공 메시지는 색상만으로 전달하지 않고 텍스트와 aria 속성을 함께 사용합니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
  ...
  <div class="form_field">
    ...
    <p class="form_field-error" id="textarea-state-error-msg" role="alert">10자 이상 입력해 주세요.</p>
      ...
      <div class="form_field">
        ...
        <Textarea id="textarea-state-error" :rows="3" error model-value="짧음" aria-describedby="textarea-state-error-msg" />
        <p class="form_field-error" id="textarea-state-error-msg" role="alert">10자 이상 입력해 주세요.</p>
      </div>`}))},m={name:"조합 예시",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"문의 폼에서 필수 입력·글자 수 안내·유효성 피드백을 조합한 예시입니다. aria-invalid · aria-describedby · maxlength로 접근성을 보완합니다."},source:{code:`<script setup>
...
<template>
  <FormLayout layout="vertical" compact novalidate aria-labelledby="example-heading">
    ...
    <div class="form_actions">
...
</template>`,language:"vue"}}},args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",block:!1,rows:3,modelValue:""},render:a(()=>({components:{Button:N,FormLayout:Q,Input:U,Textarea:e},template:`<FormLayout layout="vertical" compact novalidate aria-labelledby="example-heading">
        <div class="form_field">
          <label class="form_field-label" for="textarea-ex-subject">
            제목<span class="form_field-required" aria-hidden="true">*</span>
          </label>
      ...
      </FormLayout>`}))};var C,f,x;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(x=(f=r.parameters)==null?void 0:f.docs)==null?void 0:x.source}}};var p,b,_;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: "기본",
  parameters: {
    controls: {
      disable: false
...
}`,...(_=(b=t.parameters)==null?void 0:b.docs)==null?void 0:_.source}}};var B,v,h;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: "단독 사용",
  parameters: {
    controls: {
      disable: false
...
}`,...(h=(v=l.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var w,D,A;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    controls: {
      disable: false
...
}`,...(A=(D=s.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};var T,z,g;n.parameters={...n.parameters,docs:{...(T=n.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: "너비",
  parameters: {
    controls: {
      disable: false
...
}`,...(g=(z=n.parameters)==null?void 0:z.docs)==null?void 0:g.source}}};var y,E,k;u.parameters={...u.parameters,docs:{...(y=u.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: "행 수",
  parameters: {
    controls: {
      disable: false
...
}`,...(k=(E=u.parameters)==null?void 0:E.docs)==null?void 0:k.source}}};var q,F,S;o.parameters={...o.parameters,docs:{...(q=o.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: "리사이즈",
  parameters: {
    controls: {
      disable: false
...
}`,...(S=(F=o.parameters)==null?void 0:F.docs)==null?void 0:S.source}}};var P,V,L;i.parameters={...i.parameters,docs:{...(P=i.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: "필수 필드",
  parameters: {
    controls: {
      disable: false
...
}`,...(L=(V=i.parameters)==null?void 0:V.docs)==null?void 0:L.source}}};var R,I,j;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: "글자 수 카운터",
  parameters: {
    controls: {
      disable: false
...
}`,...(j=(I=d.parameters)==null?void 0:I.docs)==null?void 0:j.source}}};var M,H,O;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: "상태",
  parameters: {
    controls: {
      disable: false
...
}`,...(O=(H=c.parameters)==null?void 0:H.docs)==null?void 0:O.source}}};var $,W,G;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "조합 예시",
  parameters: {
    controls: {
      disable: false
...
}`,...(G=(W=m.parameters)==null?void 0:W.docs)==null?void 0:G.source}}};const pe=["Playground","Basic","Standalone","Size","Width","Rows","Resize","Required","Count","State","Example"];export{t as Basic,d as Count,m as Example,r as Playground,i as Required,o as Resize,u as Rows,s as Size,l as Standalone,c as State,n as Width,pe as __namedExportsOrder,xe as default};
