import{k as we,l as De,u as ge,a as fe,a8 as be,o as d,c as s,d as i,g as m,r as C,t as ve,e as F,w as Ae,_ as ie,p as z,s as Ee,q as n,n as ye,j as p,h as _e}from"./iframe-_Cy3TTd_.js";import{s as ke,w as he}from"./story-renders-BkwSCuFa.js";import{_ as xe}from"./Tag-D_yC1csu.js";import{e as Fe,a as ze}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const Se=["id","data-drawer-backdrop","data-drawer-open-on-load","data-drawer-draggable","hidden"],Pe={key:0,class:"drawer_handle","data-drawer-drag-handle":"",role:"presentation","aria-hidden":"true"},Le={key:1,class:"drawer_header","data-demo-slot":"header"},Oe={key:0,class:"drawer_extra","data-demo-slot":"extra"},Te={class:"drawer_body","data-demo-slot":"default"},Ie={key:2,class:"drawer_footer","data-demo-slot":"footer"},a=Object.assign({inheritAttrs:!1},{__name:"Drawer",props:{ripple:we,id:{type:String,required:!0},size:{type:String,default:"md",validator:r=>["sm","md","lg"].includes(r)},placement:{type:String,default:"right",validator:r=>["left","right","top","bottom"].includes(r)},noBackdrop:Boolean,openOnLoad:Boolean,draggable:Boolean,title:String,open:Boolean},setup(r){const t=r,{rippleAttrs:pe}=De(t);ge();const c=fe(),h=_e(null),x=`${t.id}-title`,k=p(()=>t.draggable&&t.placement==="bottom");be(t,h,c);const ce=p(()=>({left:"drawer_placement-left",right:"drawer_placement-right",top:"drawer_placement-top",bottom:"drawer_placement-bottom"})[t.placement]),me=p(()=>{const e=["drawer_panel",ce.value];return t.size==="sm"&&e.push("drawer_sm"),t.size==="lg"&&e.push("drawer_lg"),k.value&&e.push("drawer_draggable"),e}),Ce=p(()=>{const e=["drawer"];return t.open&&e.push("is-open"),c.class&&e.push(c.class),e}),Be=p(()=>{const{class:e,...l}=c;return l});return(e,l)=>(d(),s("div",z({ref_key:"rootRef",ref:h,id:r.id,class:Ce.value,"data-drawer":"","data-drawer-backdrop":r.noBackdrop?"false":void 0,"data-drawer-open-on-load":r.openOnLoad?"true":void 0,"data-drawer-draggable":k.value?"true":void 0,role:"dialog","aria-modal":"true","aria-labelledby":x,tabindex:"-1",hidden:!r.open||void 0},Be.value),[l[1]||(l[1]=i("div",{class:"drawer_backdrop","data-drawer-close":"","aria-hidden":"true"},null,-1)),i("div",{class:ye(me.value)},[k.value?(d(),s("div",Pe,[...l[0]||(l[0]=[i("span",{class:"drawer_handle-bar"},null,-1)])])):m("",!0),e.$slots.header||r.title?(d(),s("div",Le,[C(e.$slots,"header",{},()=>[i("h2",{class:"drawer_title",id:x},ve(r.title),1)]),e.$slots.extra?(d(),s("div",Oe,[C(e.$slots,"extra")])):m("",!0),F(n,z({variant:"ghost","icon-only":"",class:"drawer_close","data-drawer-close":"","aria-label":"닫기"},Ee(pe)),{"icon-before":Ae(()=>[F(ie,{name:"close",size:"sm",class:"drawer_close-icon"})]),_:1},16)])):m("",!0),i("div",Te,[C(e.$slots,"default")]),e.$slots.footer?(d(),s("div",Ie,[C(e.$slots,"footer")])):m("",!0)],2)],16,Se))}});a.__docgenInfo=Object.assign({displayName:a.name??a.__name},{exportName:"default",displayName:"Drawer",description:"",tags:{},props:[{name:"ripple",description:"클릭 파장(ripple). true 활성 · false 비활성 · 미지정 시 컴포넌트 기본",type:{name:"rippleProp"}},{name:"id",type:{name:"string"},required:!0},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md","lg"]},{name:"placement",type:{name:"string"},defaultValue:{func:!1,value:"'right'"},values:["left","right","top","bottom"]},{name:"noBackdrop",type:{name:"boolean"}},{name:"openOnLoad",type:{name:"boolean"}},{name:"draggable",description:'하단 패널 핸들·헤더 드래그로 펼침/접힘 (placement="bottom")',type:{name:"boolean"}},{name:"title",type:{name:"string"}},{name:"open",type:{name:"boolean"}}],slots:[{name:"header"},{name:"extra"},{name:"default"},{name:"footer"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Drawer.vue"]});const $e=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],qe=[{name:"id",type:"string",default:"—",description:"루트 id (필수)"},{name:"title",type:"string",default:"—",description:"패널 제목 (drawer_title)"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"drawer_sm · drawer_lg"},{name:"placement",type:"'left' | 'right' | 'top' | 'bottom'",default:"right",description:"drawer_placement-*"},{name:"no-backdrop",type:"boolean",default:"false",description:'data-drawer-backdrop="false"'},{name:"open-on-load",type:"boolean",default:"false",description:'data-drawer-open-on-load="true"'},{name:"draggable",type:"boolean",default:"false",description:'하단 패널 핸들·헤더 드래그 펼침/접힘 (placement="bottom", data-drawer-draggable)'},{name:"open",type:"boolean",default:"false",description:"열림 상태 (is-open)"},Fe],Ne=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Re=[{name:"header",description:"헤더 (title 대체)"},{name:"extra",description:"헤더 보조 영역 (drawer_extra)"},{name:"default",description:"본문 (drawer_body)"},{name:"footer",description:"하단 액션 (drawer_footer)"}],Ve=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Me=[{name:"drawer · drawer_backdrop · drawer_panel",description:"루트·백드롭·패널"},{name:"drawer_header · drawer_title · drawer_extra · drawer_close",description:"헤더 파트"},{name:"drawer_body · drawer_footer",description:"본문·푸터"},{name:"drawer_placement-left · drawer_placement-right · drawer_placement-top · drawer_placement-bottom",description:"슬라이드 방향"},{name:"drawer_sm · drawer_lg",description:"패널 크기"},{name:"drawer_handle · drawer_handle-bar · drawer_draggable",description:"하단 드래그 핸들"},{name:"data-drawer · data-drawer-trigger · data-drawer-close",description:"JS 연동 속성"},{name:"data-drawer-open-on-load",description:"페이지 로드 후 자동 열기"},{name:"data-drawer-draggable · data-drawer-drag-handle",description:"하단 드래그 펼침/접힘"},{name:"is-open · is-opening · is-closing · is-expanded · is-dragging · hidden",description:"열림·닫힘·드래그·애니메이션 상태"},...ze],je=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],He=[{name:"--drawer-z-index",default:"250",description:"레이어 순서"},{name:"--drawer-width · --drawer-width-sm · --drawer-width-lg",default:"24rem · 18rem · 36rem",description:"좌·우 패널 너비"},{name:"--drawer-height · --drawer-height-sm · --drawer-height-lg",default:"18rem · 14rem · 26rem",description:"상·하 패널 높이"},{name:"--drawer-height-expanded",default:"90%",description:"하단 드래그 펼침 높이"},{name:"--drawer-panel-duration-x · --drawer-panel-duration-y",default:"0.32s · 0.36s",description:"좌·우 / 상·하 슬라이드 시간"},{name:"--drawer-panel-easing-x · --drawer-panel-easing-y",default:"cubic-bezier(0.32, 0.72, 0, 1) · cubic-bezier(0.33, 1, 0.68, 1)",description:"방향별 이징"}],Je=[{title:"API · Props",tables:[{columns:$e,rows:qe,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:Ne,rows:Re,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Ve,rows:Me,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:je,rows:He,codeColumn:"name"}]}];function u(r){return he(r,r)}function o(r){return`
...
<template>
  ...
  <Drawer id="drawer-no-backdrop" size="sm" title="백드롭 없음" no-backdrop>
    ...
    `)}))};var S,P,L;B.parameters={...B.parameters,docs:{...(S=B.parameters)==null?void 0:S.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(L=(P=B.parameters)==null?void 0:P.docs)==null?void 0:L.source}}};var O,T,I;w.parameters={...w.parameters,docs:{...(O=w.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: "기본",
  parameters: {
    controls: {
      disable: false
...
}`,...(I=(T=w.parameters)==null?void 0:T.docs)==null?void 0:I.source}}};var $,q,N;D.parameters={...D.parameters,docs:{...($=D.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "위치",
  parameters: {
    controls: {
      disable: false
...
}`,...(N=(q=D.parameters)==null?void 0:q.docs)==null?void 0:N.source}}};var R,V,M;g.parameters={...g.parameters,docs:{...(R=g.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    controls: {
      disable: false
...
}`,...(M=(V=g.parameters)==null?void 0:V.docs)==null?void 0:M.source}}};var j,H,J;f.parameters={...f.parameters,docs:{...(j=f.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: "헤더·푸터",
  parameters: {
    controls: {
      disable: false
...
}`,...(J=(H=f.parameters)==null?void 0:H.docs)==null?void 0:J.source}}};var U,G,K;b.parameters={...b.parameters,docs:{...(U=b.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: "헤더 추가 영역",
  parameters: {
    controls: {
      disable: false
...
}`,...(K=(G=b.parameters)==null?void 0:G.docs)==null?void 0:K.source}}};var Q,W,X;v.parameters={...v.parameters,docs:{...(Q=v.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  name: "메뉴",
  parameters: {
    controls: {
      disable: false
