import{_ as e}from"./Input-CACUek-A.js";import{_ as l}from"./Alert-Da87oqmP.js";import{_ as n}from"./Button-C3SXv-sJ.js";import{_ as u}from"./FormLayout-CRfgE2Bq.js";import{_ as B}from"./Icon-D97OEunV.js";import{_ as i}from"./Select-C-jOCy5R.js";import{a as le}from"./ripple-api-C5ZjLJl-.js";import"./vue.esm-bundler-BaZlnz8B.js";import"./useDemoCode-B9b0dRAo.js";import"./useRipple-oORGvIsP.js";const ne=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ue=[{name:"model-value",type:"string",default:"—",description:"v-model 바인딩 값"},{name:"type",type:"string",default:"text",description:"input type 속성"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"input_sm · input_lg"},{name:"placeholder",type:"string",default:"—",description:"placeholder 속성"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"error",type:"boolean",default:"false",description:"오류 상태 (is-error, aria-invalid)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100% (input_block)"}],ie=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],ae=[{name:"prefix",description:"앞쪽 애드온 (input_group-addon)"},{name:"suffix",description:"뒤쪽 애드온"}],te=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],re=[{name:"input",description:"텍스트 입력 루트"},{name:"input_sm · input_lg · input_block",description:"크기·너비"},{name:"input_masked",description:'마스킹 입력값 표시 시 자동 적용 (type="password" + 값 있음)'},{name:"input_group · input_group-addon",description:"애드온 묶음"},{name:"input_clearable · input_clear",description:'지우기 버튼 — input_clear에 data-ripple="surface"'},{name:"is-error · is-disabled",description:"상태"},...le],pe=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],de=[{name:"--input-max-width",default:"320px",description:"데모·폼 최대 너비"},{name:"--input-clear-size · --input-clear-offset",default:"—",description:"클리어 버튼"},{name:"--input-font-masked · --input-masked-letter-spacing",default:"—",description:"마스킹 입력"}],oe=[{key:"name",label:"이벤트"},{key:"description",label:"설명"}],se=[{name:"update:modelValue",description:"입력 값 변경 시 (v-model)"}],me=[{title:"API · Props",tables:[{columns:ne,rows:ue,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:ie,rows:ae,codeColumn:"name"}]},{title:"API · Events",tables:[{columns:oe,rows:se,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:te,rows:re,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:pe,rows:de,codeColumn:"name"}]}],ye={title:"Components/폼/Input",id:"components-input",component:e,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placeholder:{control:"text",type:{name:"string",summary:"string"}},type:{control:"select",options:["text","email","password","number","tel","url","search"],type:{name:"enum",summary:"'text' | 'email' | 'password' | 'number' | 'tel' | 'url' | 'search'"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},modelValue:{control:"text",type:{name:"string",summary:"string"}}},parameters:{layout:"padded",apiSections:me}},a={args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",type:"text",block:!1,modelValue:""},render:ee=>({components:{Input:e},setup(){return{args:ee}},template:'<Input v-bind="args" />'})},t={name:"기본",parameters:{demoPreview:{stack:!0},docs:{description:{story:"레이블과 힌트 텍스트가 포함된 폼 필드입니다."},source:{code:`<script setup>
...
<template>
  <div class="form_field">
    ...
    <p class="form_field-hint">2~20자 이내로 입력해 주세요.</p>
...
</template>`,language:"vue"}}},render:()=>({components:{Input:e,Alert:l,Button:n,FormLayout:u,Icon:B,Select:i},template:`<div class="form_field">
      <label class="form_field-label" for="input-name">이름</label>
      <div class="input_clearable">
        <Input id="input-name" placeholder="이름을 입력하세요" />
      ...
      <p class="form_field-hint">2~20자 이내로 입력해 주세요.</p>
    </div>`})},r={name:"단독 사용",parameters:{demoPreview:{stack:!0},docs:{description:{story:"form_field 래퍼 없이 <code>input_field</code>로 레이블과 input을 묶을 수 있습니다. 접근 가능한 이름은 반드시 지정합니다. 보이는 레이블이 있으면 <code>label.form_field-label</code> + <code>for</code>를, 아이콘만 있는 검색창·툴바 등에는 <code>label.input_group</code>으로 input을 감싸고 <code>input_group-label_hidden</code>으로 이름을 제공합니다."},source:{code:`<script setup>
import Button from '@uxkm/ui/components/Button.vue';
import Icon from '@uxkm/ui/components/Icon.vue';
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <p class="form_field-hint">아이콘만 있는 툴바 검색은 <code>label.input_group</code>으로 input을 감싸고, 화면에 보이지 않는 <code>input_group-label_hidden</code>으로 접근 가능한 이름을 지정합니다.</p>
</template>`,language:"vue"}}},render:()=>({components:{Input:e,Alert:l,Button:n,FormLayout:u,Icon:B,Select:i},template:`<div class="input_field">
      <label class="form_field-label" for="input-standalone-placeholder">검색어</label>
      <div class="input_clearable">
        <Input id="input-standalone-placeholder" placeholder="플레이스홀더" />
        <Button class="input_clear" variant="text" color="muted" :ripple="false" aria-label="입력 지우기" icon-only hidden>
    ...
    <p class="form_field-hint">아이콘만 있는 툴바 검색은 <code>label.input_group</code>으로 input을 감싸고, 화면에 보이지 않는 <code>input_group-label_hidden</code>으로 접근 가능한 이름을 지정합니다.</p>`})},p={name:"입력 타입",parameters:{demoPreview:{stack:!0},docs:{description:{story:"HTML input type에 따라 브라우저 기본 UI가 적용됩니다. class=&quot;input&quot;은 모든 타입에 공통으로 사용합니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
...
</template>`,language:"vue"}}},render:()=>({components:{Input:e,Alert:l,Button:n,FormLayout:u,Select:i},template:`<div class="form_field">
      <label class="form_field-label" for="input-type-text">텍스트</label>
      <Input id="input-type-text" placeholder="일반 텍스트" />
    </div>
    <div class="form_field">
    ...
    <div class="form_field">
      <label class="form_field-label" for="input-type-time">시간</label>
      <Input id="input-type-time" type="time" />
    </div>`})},d={name:"입력 종류",parameters:{demoPreview:{stack:!0},docs:{description:{story:"결제·본인인증·사업자 정보 등 도메인별 입력 패턴입니다. 예시는 부모 너비 100%를 기본으로 하며, 필요 시 form_field_fit · input_fit으로 최대 너비를 제한할 수 있습니다. input_split · input_otp · input_group · input_row를 조합해 구성합니다."},source:{code:`<script setup>
import Button from '@uxkm/ui/components/Button.vue';
import Input from '@uxkm/ui/components/Input.vue';
...
<template>
  ...
  <p class="form_field-hint">천 단위 구분은 표시용으로 별도 포맷팅합니다.</p>
    ...
    <div class="form_field">
      ...
      <p class="form_field-hint">천 단위 구분은 표시용으로 별도 포맷팅합니다.</p>
    </div>`})},o={name:"크기",parameters:{demoPreview:{stack:!0},docs:{description:{story:"input_sm · input(기본) · input_lg로 padding·font-size를 조절합니다. 너비와는 별개이며 input_fit 등과 자유롭게 조합할 수 있습니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <div class="form_field">
      <label class="form_field-label" for="input-size-lg">Large</label>
      <Input id="input-size-lg" size="lg" placeholder="input_lg" />
    </div>`})},s={name:"너비",parameters:{demoPreview:{stack:!0},docs:{description:{story:"크기와 독립적으로 너비를 제어합니다. 기본은 부모 100%, input_fit · input_field_fit · form_field_fit · form_fit으로 --input-max-width(320px)까지 제한합니다."},source:{code:`<script setup>
...
<template>
  ...
  <template #prefix>@</template>
    ...
    <Input class="input_fit" placeholder="input_group input_fit — Medium" aria-label="아이디">
      <template #prefix>@</template>
    </Input>`})},m={name:"Input Group",parameters:{demoPreview:{stack:!0},docs:{description:{story:"input_group으로 앞뒤에 텍스트·아이콘 애드온을 붙일 수 있습니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <template #suffix>KRW</template>
...
</template>`,language:"vue"}}},render:()=>({components:{Input:e,Alert:l,Button:n,FormLayout:u,Select:i},template:`<Input placeholder="example.com" aria-label="도메인">
      <template #prefix>https://</template>
    </Input>
    <Input placeholder="username" aria-label="사용자명">
      <template #prefix>@</template>
    ...
    <Input type="number" placeholder="0" aria-label="결제 금액">
      <template #prefix>₩</template>
      <template #suffix>KRW</template>
    </Input>`})},c={name:"필수 필드",parameters:{demoPreview:{stack:!1},docs:{description:{story:"required 속성과 form_field-required로 필수 입력을 표시합니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <div class="form_field">
      ...
      <Input id="input-required-name" placeholder="홍길동" required aria-required="true" />
    </div>`})},f={name:"상태",parameters:{demoPreview:{stack:!0},docs:{description:{story:"disabled · readonly · is-error · is-success로 입력 상태를 표현합니다. 오류·성공 메시지는 색상만으로 전달하지 않고 텍스트와 aria 속성을 함께 사용합니다."},source:{code:`<script setup>
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <div class="form_field">
      ...
      <Input id="input-state-error" type="email" error model-value="invalid-email" aria-describedby="input-state-error-msg" />
      <p class="form_field-error" id="input-state-error-msg" role="alert">올바른 이메일 형식이 아닙니다.</p>
    </div>`})},C={name:"입력 삭제",parameters:{demoPreview:{stack:!0},docs:{description:{story:"<code>input_clearable</code> 래퍼로 값이 있을 때 우측에 지우기 버튼을 표시합니다. <code>readonly</code> · <code>disabled</code> 상태에서는 버튼이 나타나지 않습니다."},source:{code:`<script setup>
import Button from '@uxkm/ui/components/Button.vue';
import Icon from '@uxkm/ui/components/Icon.vue';
import Input from '@uxkm/ui/components/Input.vue';
<\/script>
...
<template>
  ...
  <div class="form_field form_field_fit">
...
</template>`,language:"vue"}}},render:()=>({components:{Input:e,Alert:l,Button:n,FormLayout:u,Icon:B,Select:i},template:`<div class="form_field form_field_fit">
      <label class="form_field-label" for="input-clear-text">텍스트</label>
      <div class="input_clearable">
        <Input id="input-clear-text" placeholder="입력 후 우측 X 버튼 확인" />
        <Button class="input_clear" variant="text" color="muted" :ripple="false" aria-label="입력 지우기" icon-only hidden>
    ...
    </div>`})},b={name:"조합 예시",parameters:{demoPreview:{stack:!0},docs:{description:{story:"유효성 검사 후 성공·실패 상태를 조합한 로그인 폼입니다. aria-invalid · aria-describedby · role=&quot;alert&quot; · role=&quot;status&quot;로 스크린 리더에 피드백을 전달합니다."},source:{code:`<script setup>
...
<template>
  ...
  <div class="form_actions">
...
</template>`,language:"vue"}}},render:()=>({components:{Input:e,Alert:l,Button:n,FormLayout:u,Select:i},template:`<FormLayout layout="vertical" compact novalidate aria-labelledby="example-heading">
      <Alert
        id="input-ex-form-error"
        color="danger"
        title="입력 내용을 확인해 주세요"
    ...
    </FormLayout>`})};var _,v,h;a.parameters={...a.parameters,docs:{...(_=a.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    size: "md",
    disabled: false,
    error: false,
...
}`,...(h=(v=a.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var D,I,y;t.parameters={...t.parameters,docs:{...(D=t.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: "기본",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(y=(I=t.parameters)==null?void 0:I.docs)==null?void 0:y.source}}};var x,A,g;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: "단독 사용",
  parameters: {
    demoPreview: {
      stack: true
    ...
    docs: {
      description: {
        story: "form_field 래퍼 없이 <code>input_field</code>로 레이블과 input을 묶을 수 있습니다. 접근 가능한 이름은 반드시 지정합니다. 보이는 레이블이 있으면 <code>label.form_field-label</code> + <code>for</code>를, 아이콘만 있는 검색창·툴바 등에는 <code>label.input_group</code>으로 input을 감싸고 <code>input_group-label_hidden</code>으로 이름을 제공합니다."
      },
      source: {
        code: "<script setup>\\nimport Button from '@uxkm/ui/components/Button.vue';\\nimport Icon from '@uxkm/ui/components/Icon.vue';\\nimport Input from '@uxkm/ui/components/Input.vue';\\n<\/script>\\n\\n<template>\\n  <div class=\\"input_field\\">\\n    <label class=\\"form_field-label\\" for=\\"input-standalone-placeholder\\">검색어</label>\\n    <div class=\\"input_clearable\\">\\n      <Input id=\\"input-standalone-placeholder\\" placeholder=\\"플레이스홀더\\" />\\n      <Button class=\\"input_clear\\" aria-label=\\"입력 지우기\\" icon-only hidden>\\n        <template #icon-before>\\n          <Icon name=\\"close\\" />\\n        </template>\\n      </Button>\\n    </div>\\n  </div>\\n  <div class=\\"input_field\\">\\n    <label class=\\"form_field-label\\" for=\\"input-standalone-value\\">닉네임</label>\\n    <div class=\\"input_clearable\\">\\n      <Input id=\\"input-standalone-value\\" model-value=\\"입력된 값\\" />\\n      <Button class=\\"input_clear\\" aria-label=\\"입력 지우기\\" icon-only>\\n        <template #icon-before>\\n          <Icon name=\\"close\\" />\\n        </template>\\n      </Button>\\n    </div>\\n  </div>\\n  <div class=\\"input_field\\">\\n    <label class=\\"form_field-label\\" for=\\"input-standalone-disabled\\">코드</label>\\n    <Input id=\\"input-standalone-disabled\\" placeholder=\\"비활성\\" disabled />\\n  </div>\\n  <Input type=\\"search\\" placeholder=\\"검색어를 입력하세요\\" aria-label=\\"검색\\">\\n    <template #prefix>\\n      <Icon name=\\"search\\" size=\\"sm\\" />\\n    </template>\\n  </Input>\\n  <p class=\\"form_field-hint\\">아이콘만 있는 툴바 검색은 <code>label.input_group</code>으로 input을 감싸고, 화면에 보이지 않는 <code>input_group-label_hidden</code>으로 접근 가능한 이름을 지정합니다.</p>\\n</template>",
        language: 'vue'
...
}`,...(g=(A=r.parameters)==null?void 0:A.docs)==null?void 0:g.source}}};var k,w,E;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: "입력 타입",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(E=(w=p.parameters)==null?void 0:w.docs)==null?void 0:E.source}}};var F,z,q;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: "입력 종류",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(q=(z=d.parameters)==null?void 0:z.docs)==null?void 0:q.source}}};var S,L,M;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(M=(L=o.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};var P,Y,T;s.parameters={...s.parameters,docs:{...(P=s.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: "너비",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(T=(Y=s.parameters)==null?void 0:Y.docs)==null?void 0:T.source}}};var R,V,O;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: "Input Group",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(O=(V=m.parameters)==null?void 0:V.docs)==null?void 0:O.source}}};var K,U,W;c.parameters={...c.parameters,docs:{...(K=c.parameters)==null?void 0:K.docs,source:{originalSource:`{
  name: "필수 필드",
  parameters: {
    demoPreview: {
      stack: false
...
}`,...(W=(U=c.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};var $,G,X;f.parameters={...f.parameters,docs:{...($=f.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "상태",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(X=(G=f.parameters)==null?void 0:G.docs)==null?void 0:X.source}}};var H,j,J;C.parameters={...C.parameters,docs:{...(H=C.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: "입력 삭제",
  parameters: {
    demoPreview: {
      stack: true
    ...
    docs: {
      description: {
        story: "<code>input_clearable</code> 래퍼로 값이 있을 때 우측에 지우기 버튼을 표시합니다. <code>readonly</code> · <code>disabled</code> 상태에서는 버튼이 나타나지 않습니다."
      },
      source: {
        code: "<script setup>\\nimport Button from '@uxkm/ui/components/Button.vue';\\nimport Icon from '@uxkm/ui/components/Icon.vue';\\nimport Input from '@uxkm/ui/components/Input.vue';\\n<\/script>\\n\\n<template>\\n  <div class=\\"form_field form_field_fit\\">\\n    <label class=\\"form_field-label\\" for=\\"input-clear-text\\">텍스트</label>\\n    <div class=\\"input_clearable\\">\\n      <Input id=\\"input-clear-text\\" placeholder=\\"입력 후 우측 X 버튼 확인\\" />\\n      <Button class=\\"input_clear\\" aria-label=\\"입력 지우기\\" icon-only hidden>\\n        <template #icon-before>\\n          <Icon name=\\"close\\" />\\n        </template>\\n      </Button>\\n    </div>\\n  </div>\\n  <div class=\\"form_field form_field_fit\\">\\n    <label class=\\"form_field-label\\" for=\\"input-clear-search\\">검색</label>\\n    <div class=\\"input_group\\">\\n      <span class=\\"input_group-addon\\" aria-hidden=\\"true\\">\\n        <Icon name=\\"search\\" size=\\"sm\\" />\\n      </span>\\n      <span class=\\"input_clearable\\">\\n        <Input id=\\"input-clear-search\\" type=\\"search\\" placeholder=\\"검색어 입력\\" />\\n        <Button class=\\"input_clear\\" aria-label=\\"입력 지우기\\" icon-only hidden>\\n          <template #icon-before>\\n            <Icon name=\\"close\\" />\\n          </template>\\n        </Button>\\n      </span>\\n    </div>\\n  </div>\\n  <div class=\\"form_field form_field_fit\\">\\n    <label class=\\"form_field-label\\" for=\\"input-clear-readonly\\">읽기 전용 (삭제 버튼 없음)</label>\\n    <div class=\\"input_clearable\\">\\n      <Input id=\\"input-clear-readonly\\" model-value=\\"수정 불가\\" readonly />\\n      <Button class=\\"input_clear\\" aria-label=\\"입력 지우기\\" icon-only hidden>\\n        <template #icon-before>\\n          <Icon name=\\"close\\" />\\n        </template>\\n      </Button>\\n    </div>\\n  </div>\\n</template>",
        language: 'vue'
...
}`,...(J=(j=C.parameters)==null?void 0:j.docs)==null?void 0:J.source}}};var N,Q,Z;b.parameters={...b.parameters,docs:{...(N=b.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: "조합 예시",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(Z=(Q=b.parameters)==null?void 0:Q.docs)==null?void 0:Z.source}}};const xe=["Playground","Basic","Standalone","Type","Kind","Size","Width","Group","Required","State","Clearable","Example"];export{t as Basic,C as Clearable,b as Example,m as Group,d as Kind,a as Playground,c as Required,o as Size,r as Standalone,f as State,p as Type,s as Width,xe as __namedExportsOrder,ye as default};
