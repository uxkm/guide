import{k as ye,l as ge,u as he,a as Pe,a5 as Ae,o as t,c as i,d as xe,p as P,s as A,e as x,_ as I,g as w,w as we,q as Ce,n as Ee,r as ze,j as s,h as We}from"./iframe-BHuoLYUS.js";import{w as r,s as Ie}from"./story-renders-C_n8_MI3.js";import{_ as v,a as B,b as y,c as E,d as Fe,e as Me,j as He,f as Se}from"./CalendarWeekdays-n_5x3ZfO.js";import{_ as be}from"./Input-CJh_gXs9.js";import{h as Le,a as Re}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const je={key:0,class:"date_picker_trigger"},Je=["id","value","placeholder","disabled","aria-expanded","aria-label","aria-invalid"],Ge={key:0,type:"button",class:"date_picker_clear","data-ripple":"surface","aria-label":"날짜 지우기"},l=Object.assign({inheritAttrs:!1},{__name:"DatePicker",props:{ripple:ye,size:{type:String,default:"md",validator:a=>["sm","md","lg"].includes(a)},disabled:Boolean,error:Boolean,success:Boolean,open:Boolean,placeholder:String,value:String,fit:Boolean,block:Boolean,inline:Boolean,clearable:Boolean,panelWide:Boolean,inputId:String,ariaLabel:String,ariaInvalid:[Boolean,String]},setup(a){const e=a,{rippleAttrs:De,childRippleAttrs:z}=ge(e,{mode:"container"});he();const g=Pe(),W=We(null);Ae(e,W,g);const ke=s(()=>{const n=["date_picker"];return e.size==="sm"&&n.push("date_picker_sm"),e.size==="lg"&&n.push("date_picker_lg"),e.fit&&n.push("date_picker_fit"),e.block&&n.push("date_picker_block"),e.inline&&n.push("date_picker_inline"),e.disabled&&n.push("is-disabled"),e.error&&n.push("is-error"),e.success&&n.push("is-success"),e.open&&n.push("is-open"),g.class&&n.push(g.class),n}),_e=s(()=>{const n=["date_picker_input"];return!e.value&&e.placeholder&&n.push("date_picker_placeholder"),n}),ve=s(()=>!e.inline),h=s(()=>e.open),Be=s(()=>!!e.value);return(n,Xe)=>(t(),i("div",P({ref_key:"rootRef",ref:W,class:ke.value},A(De)),[ve.value?(t(),i("div",je,[xe("input",P(A(z),{id:a.inputId,type:"text",class:_e.value,value:a.value,placeholder:a.placeholder,readonly:"",disabled:a.disabled,"aria-haspopup":"dialog","aria-expanded":h.value?"true":"false","aria-label":a.ariaLabel,"aria-invalid":a.ariaInvalid===!0||a.ariaInvalid==="true"?"true":a.ariaInvalid===!1||a.ariaInvalid==="false"?"false":void 0}),null,16,Je),a.clearable&&Be.value?(t(),i("button",Ge,[x(I,{name:"close",size:"sm"})])):w("",!0),x(Ce,P(A(z),{variant:"ghost","icon-only":"",class:"date_picker_btn",disabled:a.disabled,"aria-label":h.value?"캘린더 닫기":"캘린더 열기",expanded:h.value}),{"icon-before":we(()=>[x(I,{name:"calendar",size:"sm"})]),_:1},16,["disabled","aria-label","expanded"])])):w("",!0),n.$slots.panel||a.inline?(t(),i("div",{key:1,class:Ee(["date_picker_panel",{"date_picker_panel-wide":a.panelWide}]),role:"dialog","aria-label":"날짜 선택","data-demo-slot":"panel"},[ze(n.$slots,"panel")],2)):w("",!0)],16))}});l.__docgenInfo=Object.assign({displayName:l.name??l.__name},{exportName:"default",displayName:"DatePicker",description:"",tags:{},props:[{name:"ripple",description:"클릭 파장(ripple). true 활성 · false 비활성 · 미지정 시 컴포넌트 기본",type:{name:"rippleProp"}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md","lg"]},{name:"disabled",type:{name:"boolean"}},{name:"error",type:{name:"boolean"}},{name:"success",type:{name:"boolean"}},{name:"open",type:{name:"boolean"}},{name:"placeholder",type:{name:"string"}},{name:"value",type:{name:"string"}},{name:"fit",type:{name:"boolean"}},{name:"block",type:{name:"boolean"}},{name:"inline",type:{name:"boolean"}},{name:"clearable",type:{name:"boolean"}},{name:"panelWide",type:{name:"boolean"}},{name:"inputId",type:{name:"string"}},{name:"ariaLabel",type:{name:"string"}},{name:"ariaInvalid",type:{name:"boolean|string"}}],slots:[{name:"panel"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/DatePicker.vue"]});const $e=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],qe=[{name:"value",type:"string",default:"—",description:"표시할 날짜 문자열"},{name:"placeholder",type:"string",default:"—",description:"미선택 placeholder"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"date_picker_sm · date_picker_lg"},{name:"disabled",type:"boolean",default:"false",description:"비활성 (is-disabled)"},{name:"error",type:"boolean",default:"false",description:"오류 (is-error)"},{name:"success",type:"boolean",default:"false",description:"성공 (is-success)"},{name:"open",type:"boolean",default:"false",description:"패널 열림 (is-open)"},{name:"fit",type:"boolean",default:"false",description:"콘텐츠 너비 (date_picker_fit)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100%"},{name:"inline",type:"boolean",default:"false",description:"트리거 없이 패널만 (date_picker_inline)"},{name:"clearable",type:"boolean",default:"false",description:"지우기 버튼"},{name:"panel-wide",type:"boolean",default:"false",description:"넓은 패널 (date_picker_panel-wide)"},{name:"input-id",type:"string",default:"—",description:"입력 필드 id (label for 연결)"},{name:"aria-label",type:"string",default:"—",description:"입력 접근성 라벨"},{name:"aria-invalid",type:"boolean | string",default:"—",description:"입력 aria-invalid"},Le],Oe=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Te=[{name:"panel",description:"캘린더 패널 (Calendar 등)"}],Ue=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ne=[{name:"date_picker",description:"루트"},{name:"date_picker_sm · date_picker_lg · date_picker_fit · date_picker_block",description:"크기·너비"},{name:"date_picker_inline",description:"인라인 패널"},{name:"date_picker_trigger · date_picker_input · date_picker_btn",description:"트리거 영역"},{name:"date_picker_clear · date_picker_placeholder",description:'지우기(data-ripple="surface")·placeholder'},{name:"date_picker_panel · date_picker_panel-wide",description:"드롭다운 패널"},{name:"is-open · is-error · is-success · is-disabled",description:"상태"},...Re],Ve=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Ke=[{name:"--date-picker-input-padding-y · --date-picker-input-padding-x",default:"0.5rem · 0.75rem",description:"입력 패딩"},{name:"--date-picker-btn-size · --date-picker-icon-size",default:"2.25rem · 1rem",description:"캘린더 버튼·아이콘"}],Qe=[{title:"API · Props",tables:[{columns:$e,rows:qe,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:Oe,rows:Te,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Ue,rows:Ne,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:Ve,rows:Ke,codeColumn:"name"}]}],ra={title:"Components/폼/DatePicker",id:"components-date-picker",component:l,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}},success:{control:"boolean",type:{name:"boolean",summary:"boolean"}},open:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placeholder:{control:"text",type:{name:"string",summary:"string"}},value:{control:"text",type:{name:"string",summary:"string"}},fit:{control:"boolean",type:{name:"boolean",summary:"boolean"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},inline:{control:"boolean",type:{name:"boolean",summary:"boolean"}},clearable:{control:"boolean",type:{name:"boolean",summary:"boolean"}},panelWide:{control:"boolean",type:{name:"boolean",summary:"boolean"}},inputId:{control:"text",type:{name:"string",summary:"string"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"fullscreen",apiSections:Qe}},d={parameters:{controls:{disable:!1}},args:{size:"md",disabled:!1,error:!1,success:!1,open:!0,placeholder:"입력하세요",value:"1",fit:!1,block:!1,inline:!1,clearable:!1,panelWide:!1,inputId:"값",ariaLabel:"접근성 라벨"},render:(a,e)=>({components:{DatePicker:l},setup(){return{args:Ie(e)}},template:'<DatePicker v-bind="args" />'})},u={name:"유형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"네이티브 input type=&quot;date&quot;는 브라우저 기본 UI를 사용합니다. date_picker는 읽기 전용 입력과 캘린더 아이콘 버튼으로 트리거하고, date_picker_panel에 Calendar를 배치합니다."},source:{code:`<script setup>
...
}`,...(G=(J=o.parameters)==null?void 0:J.docs)==null?void 0:G.source}}};var $,q,O;p.parameters={...p.parameters,docs:{...($=p.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    controls: {
      disable: false
...
}`,...(O=(q=p.parameters)==null?void 0:q.docs)==null?void 0:O.source}}};var T,U,N;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: "패널 열림",
  parameters: {
    controls: {
      disable: false
...
}`,...(N=(U=c.parameters)==null?void 0:U.docs)==null?void 0:N.source}}};var V,K,Q;m.parameters={...m.parameters,docs:{...(V=m.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: "푸터 액션",
  parameters: {
    controls: {
      disable: false
