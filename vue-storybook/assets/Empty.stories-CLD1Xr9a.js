import{u as q,a as U,a9 as Z,o,c as r,r as y,aa as J,g as B,s as K,f as Q,t as W,n as X,j as E,h as Y,q as ee}from"./iframe-_Cy3TTd_.js";import{w as a,s as te}from"./story-renders-BkwSCuFa.js";import{_ as ne}from"./Card-PBzOgZZn.js";import"./preload-helper-PMqzWbAN.js";const se={key:0,class:"empty_image","aria-hidden":"true","data-demo-slot":"image"},ae={key:1,class:"empty_desc"},oe={key:2,class:"empty_footer","data-demo-slot":"footer"},e=Object.assign({inheritAttrs:!1},{__name:"Empty",props:{description:String,size:{type:String,default:"md",validator:s=>["sm","md","lg"].includes(s)},simple:Boolean,block:Boolean},setup(s){const n=s,g=q(),C=U(),v=Y(null);Z(n,v,C);const I=E(()=>{const t=["empty"];return n.size==="sm"&&t.push("empty_sm"),n.size==="lg"&&t.push("empty_lg"),n.simple&&t.push("empty_simple"),n.block&&t.push("empty_block"),C.class&&t.push(C.class),t}),G=E(()=>!n.simple),H=E(()=>!!g.footer);return(t,f)=>(o(),r("div",{ref_key:"rootRef",ref:v,class:X(I.value),role:"status"},[G.value?(o(),r("div",se,[y(t.$slots,"image",{},()=>[f[0]||(f[0]=J('<svg viewBox="0 0 64 41" fill="none" aria-hidden="true"><ellipse cx="32" cy="34" rx="30" ry="5" fill="currentColor" opacity="0.12"></ellipse><path d="M55 13 45 2.5A2 2 0 0 0 43.2 2H20.8a2 2 0 0 0-1.8 1.5L9 13v9h46v-9Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"></path><path d="M9 22v9.5A3.5 3.5 0 0 0 12.5 35h39a3.5 3.5 0 0 0 3.5-3.5V22" stroke="currentColor" stroke-width="2" stroke-linejoin="round"></path><path d="M24 22v-4.5c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2V22" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path></svg>',1))])])):B("",!0),s.description||K(g).description?(o(),r("p",ae,[y(t.$slots,"description",{},()=>[Q(W(s.description),1)])])):B("",!0),H.value?(o(),r("div",oe,[y(t.$slots,"footer")])):B("",!0)],2))}});e.__docgenInfo=Object.assign({displayName:e.name??e.__name},{exportName:"default",displayName:"Empty",description:"",tags:{},props:[{name:"description",type:{name:"string"}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md","lg"]},{name:"simple",type:{name:"boolean"}},{name:"block",type:{name:"boolean"}}],slots:[{name:"image"},{name:"description"},{name:"footer"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Empty.vue"]});const re=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],ue=[{name:"description",type:"string",default:"—",description:"설명 텍스트. description 슬롯으로 대체"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"empty_sm · empty_lg"},{name:"simple",type:"boolean",default:"false",description:"아이콘 숨김 (empty_simple)"},{name:"block",type:"boolean",default:"false",description:"가운데 블록 정렬 (empty_block)"}],me=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],ie=[{name:"image",description:"일러스트·아이콘 (empty_image)"},{name:"description",description:"설명 (description prop 대체)"},{name:"footer",description:"액션 버튼·링크 (empty_footer)"}],pe=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],le=[{name:"empty · empty_image · empty_desc · empty_footer",description:"루트·이미지·설명·푸터"},{name:"empty_sm · empty_lg · empty_simple · empty_block",description:"크기·변형"},{name:'role="status"',description:"빈 상태 시맨틱"}],ce=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],de=[{name:"--empty-gap · --empty-padding-y · --empty-padding-x",default:"—",description:"간격·패딩"},{name:"--empty-image-size · --empty-image-size-sm · --empty-image-size-lg",default:"4rem · 3rem · 5rem",description:"아이콘 크기"},{name:"--empty-desc-size · --empty-desc-max-width",default:"var(--text-size-sm) · 20rem",description:"설명 타이포"}],Ce=[{title:"API · Props",tables:[{columns:re,rows:ue,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:me,rows:ie,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:pe,rows:le,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:ce,rows:de,codeColumn:"name"}]}],ve={title:"Components/피드백/Empty",id:"components-empty",component:e,tags:["autodocs"],argTypes:{description:{control:"text",type:{name:"string",summary:"string"}},size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},simple:{control:"boolean",type:{name:"boolean",summary:"boolean"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Ce}},u={parameters:{controls:{disable:!1}},args:{description:"설명 텍스트입니다.",size:"md",simple:!1,block:!1},render:(s,n)=>({components:{Empty:e},setup(){return{args:te(n)}},template:'<Empty v-bind="args" />'})},m={name:"기본",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"`empty_image` · `empty_desc`로 아이콘과 설명을 표시합니다."},source:{code:`<script setup>
import Empty from '@uxkm/ui/components/Empty.vue';
<\/script>

<template>
  <Empty description="데이터가 없습니다" />
</template>`,language:"vue"}}},args:{description:"설명 텍스트입니다.",size:"md"},render:a(()=>({components:{Empty:e},template:'<Empty description="데이터가 없습니다" />'}))},i={name:"액션",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:"`empty_footer`에 버튼·링크를 배치해 다음 행동을 유도합니다."},source:{code:`<script setup>
...
</template>`,language:"vue"}}},args:{description:"설명 텍스트입니다.",size:"md",simple:!1,block:!1},render:a(()=>({components:{Button:ee,Empty:e},template:`        <Empty description="등록된 프로젝트가 없습니다. 새 프로젝트를 만들어 시작해 보세요.">
        <template #footer>
        <Button variant="filled" color="primary" size="sm" label="프로젝트 만들기" />
        </template>
...
</template>`,language:"vue"}}},args:{description:"설명 텍스트입니다.",size:"md",simple:!1,block:!1},render:a(()=>({components:{Empty:e},template:`        <Empty description="검색 결과가 없습니다. 다른 키워드로 다시 검색해 보세요.">
        <template #image>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
        <circle cx="11" cy="11" r="7" />
        <path d="m20 20-3.5-3.5" />
...
</template>`,language:"vue"}}},args:{description:"설명 텍스트입니다.",size:"md",simple:!1,block:!1},render:a(()=>({components:{Empty:e},template:`<Empty size="sm" description="Small" />
      <Empty description="Medium (기본)" style="margin-top: var(--space-md);" />
...
</template>`,language:"vue"}}},args:{description:"설명 텍스트입니다.",size:"md",simple:!1,block:!1},render:a(()=>({components:{Card:ne,Empty:e},template:`<Card variant="shadow" style="max-width: var(--input-max-width); width: 100%;">
        <div class="card_header">
          <h3 class="card_title">알림 목록</h3>
        </div>
        <div class="card_body">
...
}`,...(V=(R=l.parameters)==null?void 0:R.docs)==null?void 0:V.source}}};var L,N,j;c.parameters={...c.parameters,docs:{...(L=c.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: "설명만",
  parameters: {
    controls: {
      disable: false
...
}`,...(j=(N=c.parameters)==null?void 0:N.docs)==null?void 0:j.source}}};var O,T,$;d.parameters={...d.parameters,docs:{...(O=d.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: "블록 · 컨테이너",
  parameters: {
    controls: {
      disable: false
...
}`,...($=(T=d.parameters)==null?void 0:T.docs)==null?void 0:$.source}}};const fe=["Playground","Basic","Footer","Custom","Size","Simple","Block"];export{m as Basic,d as Block,p as Custom,i as Footer,u as Playground,c as Simple,l as Size,fe as __namedExportsOrder,ve as default};
