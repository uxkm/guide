import{k as Ee,l as we,u as Fe,a as Le,a3 as Se,b as Pe,a4 as ze,x as Re,o as i,c as t,d as o,p as r,s,r as F,f as L,t as S,g as T,h as U,i as Me,j as k}from"./iframe-_Cy3TTd_.js";import{w as l,s as Ie}from"./story-renders-BkwSCuFa.js";import{_ as Te}from"./FormLayout-DtgRIXTB.js";import{g as Ue,a as Je}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const Ne=["aria-label"],We=["checked","disabled"],Oe=["id","checked","disabled"],Ve={class:"checkbox_label"},Xe=["for"],$e={class:"checkbox_control"},je=["id","checked","disabled"],Ge=["for"],e=Object.assign({inheritAttrs:!1},{__name:"Checkbox",props:{ripple:Ee,label:String,checked:Boolean,disabled:Boolean,indeterminate:Boolean,labelEnd:Boolean,button:Boolean,ariaLabel:String},setup(c){const a=c,{rippleAttrs:De}=we(a,{defaultEnabled:!1}),P=k(()=>a.ripple===!1?{"data-ripple":"false"}:a.ripple===!0||M.value||a.button?{"data-ripple":"true"}:{}),z=Fe(),d=Le(),b=U(null),u=U(null),h=Se(),ye=Me("Checkbox",{booleanProps:new Set(["checked","disabled","indeterminate","labelEnd","button","ripple"]),selfClosing:!0});Pe(ye,a,z,b,d);const R=k(()=>{const n=["checkbox"];return a.labelEnd&&n.push("checkbox_label-end"),a.button&&n.push("checkbox_button"),d.class&&n.push(d.class),n}),Ae=k(()=>!!(a.label||z.default)),M=k(()=>!Ae.value);function I(){u.value&&(u.value.indeterminate=a.indeterminate)}return ze(I),Re(()=>a.indeterminate,I),(n,C)=>M.value?(i(),t("label",r({key:0,ref_key:"rootRef",ref:b},P.value,{class:"checkbox_control","aria-label":c.ariaLabel}),[o("input",r({ref_key:"inputRef",ref:u,type:"checkbox",class:"checkbox_input",checked:c.checked,disabled:c.disabled},s(d)),null,16,We),C[0]||(C[0]=o("span",{class:"checkbox_box","aria-hidden":"true"},null,-1))],16,Ne)):c.button?(i(),t("label",r({key:1,ref_key:"rootRef",ref:b},P.value,{class:R.value}),[o("input",r({id:s(h),ref_key:"inputRef",ref:u,type:"checkbox",class:"checkbox_input",checked:c.checked,disabled:c.disabled},s(d)),null,16,Oe),o("span",Ve,[F(n.$slots,"default",{},()=>[L(S(c.label),1)])])],16)):(i(),t("div",r({key:2,ref_key:"rootRef",ref:b},s(De),{class:R.value}),[c.labelEnd?(i(),t("label",{key:0,class:"checkbox_label",for:s(h)},[F(n.$slots,"default",{},()=>[L(S(c.label),1)])],8,Xe)):T("",!0),o("span",$e,[o("input",r({id:s(h),ref_key:"inputRef",ref:u,type:"checkbox",class:"checkbox_input",checked:c.checked,disabled:c.disabled},s(d)),null,16,je),C[1]||(C[1]=o("span",{class:"checkbox_box","aria-hidden":"true"},null,-1))]),c.labelEnd?T("",!0):(i(),t("label",{key:1,class:"checkbox_label",for:s(h)},[F(n.$slots,"default",{},()=>[L(S(c.label),1)])],8,Ge))],16))}});e.__docgenInfo=Object.assign({displayName:e.name??e.__name},{exportName:"default",displayName:"Checkbox",description:"",tags:{},props:[{name:"ripple",description:"클릭 파장(ripple). true 활성 · false 비활성 · 미지정 시 컴포넌트 기본",type:{name:"rippleProp"}},{name:"label",type:{name:"string"}},{name:"checked",type:{name:"boolean"}},{name:"disabled",type:{name:"boolean"}},{name:"indeterminate",type:{name:"boolean"}},{name:"labelEnd",type:{name:"boolean"}},{name:"button",type:{name:"boolean"}},{name:"ariaLabel",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Checkbox.vue"]});const He=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],qe=[{name:"label",type:"string",default:"—",description:"라벨 텍스트. default 슬롯으로 대체"},{name:"checked",type:"boolean",default:"false",description:"체크 상태"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"indeterminate",type:"boolean",default:"false",description:"부분 선택 (전체 선택 등)"},{name:"label-end",type:"boolean",default:"false",description:"라벨을 체크박스 앞에 배치"},{name:"button",type:"boolean",default:"false",description:"버튼형 토글 (checkbox_button)"},{name:"aria-label",type:"string",default:"—",description:"라벨 없는 단독 체크박스 시 필수"},Ue],Ke=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Qe=[{name:"default",description:"라벨 텍스트 (label prop 대체)"}],Ye=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ze=[{name:"checkbox",description:"체크박스 래퍼"},{name:"checkbox_control · checkbox_input · checkbox_box",description:"입력·커스텀 박스"},{name:"checkbox_label",description:"라벨"},{name:"checkbox_label-end · checkbox_button",description:"레이아웃 변형"},{name:"checkbox_group",description:"여러 체크박스 묶음"},{name:"checkbox_card · checkbox_card-clickable",description:"카드형 — clickable은 data-ripple + JS 위임"},{name:"is-checked · is-disabled",description:"상태 (CSS·JS 토글)"},...Je],ec=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],cc=[{name:"--checkbox-size · --checkbox-size-sm · --checkbox-size-lg",default:"1rem · 0.875rem · 1.125rem",description:"체크박스 박스 크기"},{name:"--checkbox-border-width · --checkbox-radius",default:"1px · 4px",description:"테두리·모서리"},{name:"--checkbox-gap · --checkbox-gap-sm · --checkbox-gap-lg",default:"var(--space-sm) · 0.375rem · 0.625rem",description:"라벨 간격"},{name:"--checkbox-font-size · --checkbox-line-height",default:"var(--text-size-base) · 1.5",description:"라벨 타이포(md)"},{name:"--checkbox-label-weight",default:"400",description:"라벨 두께"},{name:"--checkbox-hint-size",default:"var(--text-size-sm)",description:"힌트 텍스트"},{name:"--checkbox-control-offset",default:"0.125rem",description:"박스 수직 정렬"},{name:"--checkbox-group-gap",default:"var(--space-sm)",description:"그룹 간격"},{name:"--checkbox-button-padding-y · --checkbox-button-padding-x",default:"0.35rem · 0.75rem",description:"버튼형 패딩"}],ac=[{title:"API · Props",tables:[{columns:He,rows:qe,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:Ke,rows:Qe,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Ye,rows:Ze,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:ec,rows:cc,codeColumn:"name"}]}],rc={title:"Components/폼/Checkbox",id:"components-checkbox",component:e,tags:["autodocs"],argTypes:{label:{control:"text",type:{name:"string",summary:"string"}},checked:{control:"boolean",type:{name:"boolean",summary:"boolean"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},indeterminate:{control:"boolean",type:{name:"boolean",summary:"boolean"}},labelEnd:{control:"boolean",type:{name:"boolean",summary:"boolean"}},button:{control:"boolean",type:{name:"boolean",summary:"boolean"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:ac}},p={parameters:{controls:{disable:!1}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:(c,a)=>({components:{Checkbox:e},setup(){return{args:Ie(a)}},template:'<Checkbox v-bind="args" />'})},x={name:"유형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"기본은 `span.checkbox_control` + `label.checkbox_label for`(명시 연결) 순서입니다. 보이는 레이블이 없으면 `label.checkbox_control`로 input을 암묵 연결합니다. `checkbox_label-end`는 레이블 → 체크박스 순서이며, 기본 너비는 콘텐츠 기준입니다."},source:{code:`<script setup>
...
</template>`,language:"vue"}}},args:{label:"라벨",ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<Checkbox checked label="기본 — checkbox" />
      <Checkbox label-end label="레이블 뒤 — checkbox_label-end" />
      <fieldset class="checkbox_group checkbox_group_horizontal">
        <Checkbox button checked label="버튼형" />
        <Checkbox button label="UI" />
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<Checkbox label-end checked label="푸시 알림 받기" />
      <Checkbox label-end>
        <span class="checkbox_content">
          <span class="checkbox_label">마케팅 정보 수신</span>
          <span class="checkbox_hint">이벤트·할인 소식을 이메일로 받습니다.</span>
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<div class="form_field">
        <span class="form_field-label" id="checkbox-notify-label">알림 설정</span>
        <fieldset class="checkbox_group" aria-labelledby="checkbox-notify-label">
          <Checkbox checked>
            <span class="checkbox_content">
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<Checkbox aria-label="항목 선택" />
      <Checkbox checked aria-label="선택됨" />
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<Checkbox class="checkbox_sm" checked label="Small — checkbox_sm" />
      <Checkbox checked label="Medium — 기본" />
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<Checkbox checked label="기본 — 인라인 너비" />
      <Checkbox class="checkbox_block" checked label="checkbox_block — 전체 너비" />
      <fieldset class="checkbox_group checkbox_group_block" style="max-width: 360px; width: 100%;">
        <legend class="checkbox_group-legend">checkbox_group_block</legend>
        <Checkbox checked label="항목 1" />
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<Checkbox class="color_primary" checked label="Primary" />
      <Checkbox class="color_success" checked label="Success" />
      <Checkbox class="color_danger" checked label="Danger" />
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<Checkbox label="미선택" />
      <Checkbox checked label="선택됨" />
      <Checkbox checked indeterminate label="불확정" />
      <Checkbox disabled label="비활성" />
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<fieldset class="checkbox_group">
        <legend class="checkbox_group-legend">관심 분야 (세로)</legend>
        <Checkbox checked label="디자인" />
        <Checkbox label="개발" />
        <Checkbox label="기획" />
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e},template:`<fieldset class="checkbox_group checkbox_group_horizontal">
        <Checkbox button checked label="전체" />
        <Checkbox button label="진행 중" />
        <Checkbox button label="완료" />
        <Checkbox button disabled label="보류 (비활성)" />
...
<template>
  ...
  <FormLayout layout="horizontal" fit>
    <div class="form_field">
...
</template>`,language:"vue"}}},args:{label:"라벨",checked:!1,disabled:!1,indeterminate:!1,labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:l(()=>({components:{Checkbox:e,FormLayout:Te},template:`<FormLayout layout="vertical" fit>
        <div class="form_field">
          <span class="form_field-label" id="checkbox-form-vertical-label">수신 동의</span>
          <fieldset class="checkbox_group" aria-labelledby="checkbox-form-vertical-label">
            <Checkbox checked label="마케팅 정보 수신" />
      ...
      </FormLayout>`}))};var J,N,W;p.parameters={...p.parameters,docs:{...(J=p.parameters)==null?void 0:J.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(W=(N=p.parameters)==null?void 0:N.docs)==null?void 0:W.source}}};var O,V,X;x.parameters={...x.parameters,docs:{...(O=x.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: "유형",
  parameters: {
    controls: {
      disable: false
...
}`,...(X=(V=x.parameters)==null?void 0:V.docs)==null?void 0:X.source}}};var $,j,G;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "레이블 뒤",
  parameters: {
    controls: {
      disable: false
