import{u as tu,a as Cu,b as nu,a4 as au,ae as ou,o as iu,c as su,d as M,r as ru,n as fu,p as lu,h as Bu,i as pu,j as b,q as x}from"./iframe-_Cy3TTd_.js";import{s as cu,w as du}from"./story-renders-BkwSCuFa.js";import"./preload-helper-PMqzWbAN.js";function H(e,u){const C=parseInt(e,10);return Number.isFinite(C)?C:u}function mu(e){let u=e.parentElement;for(;u;){const C=getComputedStyle(u),r=C.transform,f=C.filter,d=C.backdropFilter||C.webkitBackdropFilter,t=C.perspective,n=C.contain,i=C.willChange,m=!!(r&&r!=="none"),p=!!(f&&f!=="none"||d&&d!=="none"),a=!!(t&&t!=="none"),c=!!(n&&/paint|layout|strict|content/.test(n)),F=!!(i&&/transform|filter|perspective/.test(i));if(m||p||a||c||F)return u.getBoundingClientRect();if(u===document.documentElement)break;u=u.parentElement}return{left:0,top:0,right:window.innerWidth,bottom:window.innerHeight,width:window.innerWidth,height:window.innerHeight}}function Du(e){if(e.dataset.affixInit)return()=>{};const u=e.getAttribute("data-target");let C=null;if(u)try{C=document.querySelector(u)}catch{C=null}const r=H(e.getAttribute("data-offset-top"),0),f=e.hasAttribute("data-offset-bottom"),d=f?H(e.getAttribute("data-offset-bottom"),0):0,t=e.querySelector(".affix_target");if(!t)return()=>{};e.dataset.affixInit="1";let n=e.querySelector(".affix_placeholder");n||(n=document.createElement("div"),n.className="affix_placeholder",n.setAttribute("aria-hidden","true"),e.insertBefore(n,t));let i=!1,m=!1;function p(){return C?C.getBoundingClientRect():{top:0,bottom:window.innerHeight,left:0,right:window.innerWidth}}function a(){t.style.position="",t.style.top="",t.style.bottom="",t.style.left="",t.style.width="",t.style.zIndex=""}function c(s,o,l){const E=mu(t),z=f?s.bottom-t.offsetHeight-d:s.top+r;t.style.position="fixed",t.style.width=`${o}px`,t.style.left=`${l-E.left}px`,t.style.top=`${z-E.top}px`,t.style.bottom="",t.style.zIndex=getComputedStyle(e).getPropertyValue("--affix-z-index").trim()||"10"}function F(s,o){if(s===i){s&&o&&c(o.targetRect,o.width,o.left);return}if(i=s,e.classList.toggle("is-affixed",i),t.classList.toggle("is-fixed",i),i){const l=t.offsetHeight;n.style.height=`${l}px`,n.style.width=`${o.width}px`,n.hidden=!1,c(o.targetRect,o.width,o.left)}else n.hidden=!0,n.style.height="",n.style.width="",a()}function D(){m||(m=!0,requestAnimationFrame(()=>{m=!1;const s=p(),o=e.getBoundingClientRect(),l=i?n.getBoundingClientRect():o,E=l.width||o.width,z=l.left,Z={targetRect:s,width:E,left:z};let A=i;if(f){if(A=s.bottom-l.bottom<=d,A&&C){const S=t.offsetHeight;l.bottom-s.top<S+d&&(A=!1)}}else if(A=l.top-s.top<=r,A&&C){const S=t.offsetHeight;s.bottom-l.top<S+r&&(A=!1)}F(A,Z)}))}const P=C||window;return P.addEventListener("scroll",D,{passive:!0}),C&&window.addEventListener("scroll",D,{passive:!0,capture:!0}),window.addEventListener("resize",D,{passive:!0}),D(),()=>{P.removeEventListener("scroll",D),C&&window.removeEventListener("scroll",D,{capture:!0}),window.removeEventListener("resize",D),delete e.dataset.affixInit,e.classList.remove("is-affixed"),t.classList.remove("is-fixed"),n.hidden=!0,n.style.height="",n.style.width="",a()}}const B=Object.assign({inheritAttrs:!1},{__name:"Affix",props:{target:String,offsetTop:{type:[Number,String],default:0},offsetBottom:[Number,String],skin:{type:String,default:"",validator:e=>["","bar","anchor"].includes(e)},interactive:{type:Boolean,default:!0}},setup(e){const u=e,C=tu(),r=Cu(),f=Bu(null),d=pu("Affix",{defaults:{offsetTop:0,interactive:!0},booleanProps:new Set(["interactive"]),selfClosing:!1});nu(d,u,C,f,r);const t=b(()=>{const a=["affix"];return r.class&&a.push(r.class),a}),n=b(()=>{const a=["affix_target"];return u.skin==="bar"&&a.push("affix_bar"),u.skin==="anchor"&&a.push("affix_anchor"),a}),i=b(()=>{const a={};return u.interactive&&(a["data-affix"]=""),u.target&&(a["data-target"]=u.target),u.offsetTop&&Number(u.offsetTop)!==0&&(a["data-offset-top"]=String(u.offsetTop)),u.offsetBottom!==void 0&&u.offsetBottom!==null&&u.offsetBottom!==""&&(a["data-offset-bottom"]=String(u.offsetBottom)),a}),m=b(()=>{const{class:a,...c}=r;return c});let p=null;return au(()=>{!u.interactive||!f.value||(p=Du(f.value))}),ou(()=>{p==null||p(),p=null}),(a,c)=>(iu(),su("div",lu({ref_key:"rootRef",ref:f,class:t.value},{...m.value,...i.value}),[c[0]||(c[0]=M("div",{class:"affix_placeholder","aria-hidden":"true",hidden:""},null,-1)),M("div",{class:fu(n.value)},[ru(a.$slots,"default")],2)],16))}});B.__docgenInfo=Object.assign({displayName:B.name??B.__name},{exportName:"default",displayName:"Affix",description:"",tags:{},props:[{name:"target",description:"스크롤 컨테이너 CSS 선택자. 생략 시 window",type:{name:"string"}},{name:"offsetTop",description:"상단 고정 시 상단 여백(px)",type:{name:"number|string"},defaultValue:{func:!1,value:"0"}},{name:"offsetBottom",description:"하단 고정 시 하단 여백(px). 지정하면 하단 고정 모드",type:{name:"number|string"}},{name:"skin",description:"스킨: bar(액션 바) · anchor(앵커 내비게이션)",type:{name:"string"},defaultValue:{func:!1,value:"''"},values:["bar","anchor"]},{name:"interactive",description:"false면 data-affix 미부여(초기화 비활성)",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}}],slots:[{name:"default"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Affix.vue"]});const Au=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],xu=[{name:"target",type:"string",default:"—",description:"스크롤 컨테이너 선택자 (data-target). 생략 시 window"},{name:"offset-top",type:"number | string",default:"0",description:"상단 고정 시 상단 여백(px, data-offset-top)"},{name:"offset-bottom",type:"number | string",default:"—",description:"하단 고정 시 하단 여백(px, data-offset-bottom). 지정 시 하단 고정 모드"},{name:"skin",type:"'' | 'bar' | 'anchor'",default:"—",description:"affix_bar · affix_anchor 스킨"},{name:"interactive",type:"boolean",default:"true",description:"false면 data-affix 미부여(초기화 비활성)"}],vu=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Eu=[{name:"default",description:"고정 대상 콘텐츠 (라벨·버튼·앵커 링크 등)"}],bu=[{key:"name",label:"속성"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],gu=[{name:"data-affix",type:"boolean",default:"—",description:"Affix 활성화. 루트 .affix 요소에 지정"},{name:"data-target",type:"string",default:"window",description:"스크롤 컨테이너 CSS 선택자. 생략 시 window 스크롤 기준"},{name:"data-offset-top",type:"number",default:"0",description:"상단 고정 시 뷰포트·컨테이너 상단과의 간격(px)"},{name:"data-offset-bottom",type:"number",default:"0",description:"하단 고정 시 하단과의 간격(px). 속성을 지정하면 하단 고정 모드"}],hu=[{key:"name",label:"요소"},{key:"description",label:"설명"}],yu=[{name:".affix",description:"루트 래퍼. data-affix · data-target · data-offset-* 속성을 지정"},{name:".affix_placeholder",description:'고정 시 레이아웃 점프 방지용 플레이스홀더 (aria-hidden="true", hidden)'},{name:".affix_target",description:"실제 고정·해제되는 대상. affix_bar 또는 affix_anchor 스킨과 조합"}],wu=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],_u=[{name:"affix_bar",description:"액션 바 스킨. 라벨 + 버튼 영역"},{name:"affix_bar-label",description:"바 좌측 라벨"},{name:"affix_bar-actions",description:"바 우측 버튼 그룹. Button 컴포넌트 조합"},{name:"affix_anchor",description:"섹션 앵커 링크 내비게이션 스킨"},{name:"is-affixed",description:"고정 상태 (루트 .affix에 JS가 자동 추가)"},{name:"is-fixed",description:"고정 상태 (.affix_target에 JS가 자동 추가)"}],ku=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Fu=[{name:"--affix-z-index",default:"10",description:"고정 바 z-index"},{name:"--affix-bar-gap",default:"var(--space-sm)",description:"바 내부 간격"},{name:"--affix-bar-padding-y · --affix-bar-padding-x",default:"var(--space-sm) · var(--space-md)",description:"바 패딩"},{name:"--affix-bar-bg",default:"var(--color-surface)",description:"바 배경"},{name:"--affix-bar-border",default:"var(--color-border-subtle)",description:"바 테두리"},{name:"--affix-bar-shadow",default:"0 1px 4px rgb(0 0 0 / 0.08)",description:"바 그림자"}],zu=[{title:"API · Props",tables:[{columns:Au,rows:xu,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:vu,rows:Eu,codeColumn:"name"}]},{title:"API · Data Attributes",tables:[{columns:bu,rows:gu,codeColumn:"name"}]},{title:"API · 마크업 구조",tables:[{columns:hu,rows:yu,codeColumn:"name"}]},{title:"클래스 · 스킨",description:"OOCSS 구조 클래스와 스킨 클래스입니다. affix_bar-actions 안의 버튼은 Button 컴포넌트로 조합합니다.",tables:[{columns:wu,rows:_u,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:ku,rows:Fu,codeColumn:"name"}]}];function v(e){return du(e,e)}const Hu={title:"Components/기타/Affix",id:"components-affix",component:B,tags:["autodocs"],parameters:{controls:{disable:!1},layout:"padded",docs:{description:{component:"스크롤 시 지정한 위치에 요소를 고정하는 컴포넌트입니다. 툴바·앵커 내비게이션·액션 버튼 등에 사용하며, `data-target`으로 스크롤 컨테이너를 지정할 수 있습니다."}},apiSections:zu},argTypes:{target:{control:"text",description:"스크롤 컨테이너 선택자 (data-target). 생략 시 window",type:{name:"string",summary:"string"}},offsetTop:{control:"number",description:"상단 고정 시 상단 여백(px)",type:{name:"number",summary:"number | string"}},offsetBottom:{control:"number",description:"하단 고정 시 하단 여백(px). 지정 시 하단 고정 모드",type:{name:"number",summary:"number | string"}},skin:{control:"select",options:["bar","anchor"],description:"affix_bar · affix_anchor 스킨",type:{name:"enum",summary:"'bar' | 'anchor'"}},interactive:{control:"boolean",description:"false면 data-affix 미부여(초기화 비활성)",type:{name:"boolean",summary:"boolean"}}}},g={parameters:{controls:{disable:!1}},args:{offsetTop:0,skin:"bar",interactive:!0},render:(e,u)=>({components:{Affix:B,Button:x},setup(){return{args:cu(u)}},template:`<div class="affix_demo-narrow">
...
</template>`}}},render:v(()=>({components:{Affix:B,Button:x},template:`<div class="affix_demo-narrow">
      <div id="affix-scroll-basic" class="affix_demo-scroll">
        <div class="affix_demo-content">
          <p>주문 상세 페이지입니다. 아래로 스크롤하면 액션 바가 상단에 고정됩니다.</p>
          <p>배송지: 서울특별시 강남구 테헤란로 123, 4층</p>
...
</template>`}}},render:v(()=>({components:{Affix:B},template:`<div class="affix_demo-narrow">
      <div id="affix-scroll-anchor" class="affix_demo-scroll">
        <div class="affix_demo-content">
          <p>설정 페이지입니다. 아래 목차가 스크롤 시 상단에 고정됩니다.</p>
          <Affix target="#affix-scroll-anchor" skin="anchor">
...
<template>
  ...
  >
    ...
    </div>`}))};var T,R,O;g.parameters={...g.parameters,docs:{...(T=g.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: false
    }
...
}`,...(O=(R=g.parameters)==null?void 0:R.docs)==null?void 0:O.source}}};var I,L,N;h.parameters={...h.parameters,docs:{...(I=h.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: '기본',
  parameters: {
    controls: {
      disable: true
...
}`,...(N=(L=h.parameters)==null?void 0:L.docs)==null?void 0:N.source}}};var V,G,$;y.parameters={...y.parameters,docs:{...(V=y.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: '상단 오프셋',
  parameters: {
    controls: {
      disable: true
...
}`,...($=(G=y.parameters)==null?void 0:G.docs)==null?void 0:$.source}}};var U,W,q;w.parameters={...w.parameters,docs:{...(U=w.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: '앵커 내비게이션',
  parameters: {
    controls: {
      disable: true
...
}`,...(q=(W=w.parameters)==null?void 0:W.docs)==null?void 0:q.source}}};var j,J,Q;_.parameters={..._.parameters,docs:{...(j=_.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: '하단 고정',
  parameters: {
    controls: {
      disable: true
...
}`,...(Y=(X=k.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};const Tu=["Playground","Basic","Offset","Anchor","Bottom","Window"];export{w as Anchor,h as Basic,_ as Bottom,y as Offset,g as Playground,k as Window,Tu as __namedExportsOrder,Hu as default};
