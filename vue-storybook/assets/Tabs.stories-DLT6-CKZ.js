...
<template>
  <Tabs aria-label="프로젝트 정보">
    ...
    <TabPanel label="활동">
      ...
      </Tabs>`}))},G={name:"동적 패널",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"mode=&quot;dynamic&quot;은 탭 메뉴만 나열하고 패널은 하나입니다. 탭 클릭 시 #panel 슬롯 내용이 전환됩니다."},source:{code:`<script setup>
  ...
  <Tabs mode="dynamic" aria-label="동적 탭 (TabMenu)">
    ...
    <template #panel="{ value }">
      ...
      <p v-else>TabMenu로 선언한 동적 패널 — 활동</p>
        ...
        </Tabs>`}))},H={name:"슬라이드 인디케이터",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"indicator=&quot;slide&quot;로 선택 탭 아래(또는 pill 배경) 인디케이터가 부드럽게 이동합니다. line·pill 스킨과 조합합니다."},source:{code:`<script setup>
import TabPanel from '@uxkm/ui/components/TabPanel.vue';
import Tabs from '@uxkm/ui/components/Tabs.vue';
<\/script>
...
}`,...(Ra=($a=K.parameters)==null?void 0:$a.docs)==null?void 0:Ra.source}}};var Na,Oa,ja;J.parameters={...J.parameters,docs:{...(Na=J.parameters)==null?void 0:Na.docs,source:{originalSource:`{
  name: "기본 (라인)",
  parameters: {
    controls: {
      disable: false
...
}`,...(ja=(Oa=J.parameters)==null?void 0:Oa.docs)==null?void 0:ja.source}}};var Ua,Wa,Ka;G.parameters={...G.parameters,docs:{...(Ua=G.parameters)==null?void 0:Ua.docs,source:{originalSource:`{
  name: "동적 패널",
  parameters: {
    controls: {
      disable: false
...
}`,...(Ka=(Wa=G.parameters)==null?void 0:Wa.docs)==null?void 0:Ka.source}}};var Ja,Ga,Ha;H.parameters={...H.parameters,docs:{...(Ja=H.parameters)==null?void 0:Ja.docs,source:{originalSource:`{
  name: "슬라이드 인디케이터",
  parameters: {
    controls: {
      disable: false
...
}`,...(Ha=(Ga=H.parameters)==null?void 0:Ga.docs)==null?void 0:Ha.source}}};var Qa,Xa,Ya;Q.parameters={...Q.parameters,docs:{...(Qa=Q.parameters)==null?void 0:Qa.docs,source:{originalSource:`{
  name: "균등 분할",
  parameters: {
    controls: {
      disable: false
...
}`,...(_e=(Fe=sa.parameters)==null?void 0:Fe.docs)==null?void 0:_e.source}}};const In=["Playground","Basic","Dynamic","IndicatorSlide","LayoutEqual","LayoutScroll","Card","Pill","Size","IconDemo","BadgeDemo","Extra","Scroll","Disabled","Vertical"];export{na as BadgeDemo,J as Basic,Y as Card,ta as Disabled,G as Dynamic,la as Extra,ea as IconDemo,H as IndicatorSlide,Q as LayoutEqual,X as LayoutScroll,Z as Pill,K as Playground,ua as Scroll,aa as Size,sa as Vertical,In as __namedExportsOrder,Ln as default};
