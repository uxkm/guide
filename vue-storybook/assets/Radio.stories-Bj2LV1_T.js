import{k as ka,l as Da,u as ya,a as Aa,b as Ea,o as s,c,d as r,p as o,r as E,f as w,t as x,g as P,s as wa,h as xa,i as za,j as u}from"./iframe-_Cy3TTd_.js";import{w as d,s as Fa}from"./story-renders-BkwSCuFa.js";import{_ as La}from"./FormLayout-DtgRIXTB.js";import{g as Sa,a as Pa}from"./ripple-api-Dpyr2TOk.js";import"./preload-helper-PMqzWbAN.js";const Ma=["aria-label"],Ta=["name","value","checked","disabled"],Ua=["name","value","checked","disabled"],Ia={class:"radio_label"},Va={key:0,class:"radio_label"},Na={class:"radio_control"},Wa=["name","value","checked","disabled"],Oa={key:1,class:"radio_label"},e=Object.assign({inheritAttrs:!1},{__name:"Radio",props:{ripple:ka,label:String,name:String,checked:Boolean,disabled:Boolean,value:String,labelEnd:Boolean,button:Boolean,ariaLabel:String},setup(a){const l=a,{rippleAttrs:fa}=Da(l,{defaultEnabled:!1}),z=u(()=>l.ripple===!1?{"data-ripple":"false"}:l.ripple===!0||S.value||l.button?{"data-ripple":"true"}:{}),F=ya(),t=Aa(),p=xa(null),ga=za("Radio",{booleanProps:new Set(["checked","disabled","labelEnd","button","ripple"]),selfClosing:!0});Ea(ga,l,F,p,t);const L=u(()=>{const i=["radio"];return l.labelEnd&&i.push("radio_label-end"),l.button&&i.push("radio_button"),t.class&&i.push(t.class),i}),Ra=u(()=>!!(l.label||F.default)),S=u(()=>!Ra.value),A=u(()=>{const{class:i,...n}=t;return n});return(i,n)=>S.value?(s(),c("label",o({key:0,ref_key:"rootRef",ref:p},z.value,{class:"radio_control","aria-label":a.ariaLabel}),[r("input",o({type:"radio",class:"radio_input",name:a.name,value:a.value,checked:a.checked,disabled:a.disabled},A.value),null,16,Ta),n[0]||(n[0]=r("span",{class:"radio_box","aria-hidden":"true"},null,-1))],16,Ma)):a.button?(s(),c("label",o({key:1,ref_key:"rootRef",ref:p},z.value,{class:L.value}),[r("input",o({type:"radio",class:"radio_input",name:a.name,value:a.value,checked:a.checked,disabled:a.disabled},A.value),null,16,Ua),r("span",Ia,[E(i.$slots,"default",{},()=>[w(x(a.label),1)])])],16)):(s(),c("label",o({key:2,ref_key:"rootRef",ref:p},wa(fa),{class:L.value}),[a.labelEnd?(s(),c("span",Va,[E(i.$slots,"default",{},()=>[w(x(a.label),1)])])):P("",!0),r("span",Na,[r("input",o({type:"radio",class:"radio_input",name:a.name,value:a.value,checked:a.checked,disabled:a.disabled},A.value),null,16,Wa),n[1]||(n[1]=r("span",{class:"radio_box","aria-hidden":"true"},null,-1))]),a.labelEnd?P("",!0):(s(),c("span",Oa,[E(i.$slots,"default",{},()=>[w(x(a.label),1)])]))],16))}});e.__docgenInfo=Object.assign({displayName:e.name??e.__name},{exportName:"default",displayName:"Radio",description:"",tags:{},props:[{name:"ripple",description:"클릭 파장(ripple). true 활성 · false 비활성 · 미지정 시 컴포넌트 기본",type:{name:"rippleProp"}},{name:"label",type:{name:"string"}},{name:"name",type:{name:"string"}},{name:"checked",type:{name:"boolean"}},{name:"disabled",type:{name:"boolean"}},{name:"value",type:{name:"string"}},{name:"labelEnd",type:{name:"boolean"}},{name:"button",type:{name:"boolean"}},{name:"ariaLabel",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/dyuel/uxkm/guide/packages/ui/src/components/Radio.vue"]});const Xa=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],$a=[{name:"label",type:"string",default:"—",description:"라벨 텍스트. default 슬롯으로 대체"},{name:"name",type:"string",default:"—",description:"radio 그룹 name 속성"},{name:"value",type:"string",default:"—",description:"radio value 속성"},{name:"checked",type:"boolean",default:"false",description:"선택 상태"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"label-end",type:"boolean",default:"false",description:"라벨을 라디오 앞에 배치"},{name:"button",type:"boolean",default:"false",description:"버튼형 (radio_button)"},{name:"aria-label",type:"string",default:"—",description:"라벨 없는 단독 라디오 시 필수"},Sa],ja=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Ja=[{name:"default",description:"라벨 텍스트 (label prop 대체)"}],Ga=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],Ha=[{name:"radio",description:"라디오 래퍼"},{name:"radio_control · radio_input · radio_box",description:"입력·커스텀 원"},{name:"radio_label",description:"라벨"},{name:"radio_label-end · radio_button",description:"레이아웃 변형"},{name:"radio_group",description:"fieldset 그룹"},{name:"radio_card · radio_card-clickable",description:"카드형 — clickable은 data-ripple + JS 위임"},...Pa],qa=[{key:"name",label:"토큰"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],Ka=[{name:"--radio-size · --radio-size-sm · --radio-size-lg",default:"var(--checkbox-size) · … · …",description:"라디오 원 크기 (checkbox 토큰 참조)"},{name:"--radio-gap · --radio-gap-sm · --radio-gap-lg",default:"var(--checkbox-gap) · … · …",description:"라벨 간격"},{name:"--radio-font-size · --radio-line-height",default:"var(--checkbox-font-size) · var(--checkbox-line-height)",description:"라벨 타이포"},{name:"--radio-label-weight · --radio-hint-size",default:"var(--checkbox-label-weight) · var(--checkbox-hint-size)",description:"라벨·힌트"},{name:"--radio-control-offset",default:"var(--checkbox-control-offset)",description:"원 수직 정렬"},{name:"--radio-group-gap",default:"var(--checkbox-group-gap)",description:"그룹 간격"},{name:"--radio-button-padding-y · --radio-button-padding-x",default:"var(--checkbox-button-padding-y) · var(--checkbox-button-padding-x)",description:"버튼형 패딩"}],Qa=[{title:"API · Props",tables:[{columns:Xa,rows:$a,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:ja,rows:Ja,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Ga,rows:Ha,codeColumn:"name"}]},{title:"디자인 토큰",tables:[{columns:qa,rows:Ka,codeColumn:"name"}]}],le={title:"Components/폼/Radio",id:"components-radio",component:e,tags:["autodocs"],argTypes:{label:{control:"text",type:{name:"string",summary:"string"}},name:{control:"text",type:{name:"string",summary:"string"}},checked:{control:"boolean",type:{name:"boolean",summary:"boolean"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},value:{control:"text",type:{name:"string",summary:"string"}},labelEnd:{control:"boolean",type:{name:"boolean",summary:"boolean"}},button:{control:"boolean",type:{name:"boolean",summary:"boolean"}},ariaLabel:{control:"text",type:{name:"string",summary:"string"}}},parameters:{controls:{disable:!1},layout:"padded",apiSections:Qa}},b={parameters:{controls:{disable:!1}},args:{label:"라벨",name:"search",checked:!1,disabled:!1,value:"1",labelEnd:!1,button:!1,ariaLabel:"접근성 라벨"},render:(a,l)=>({components:{Radio:e},setup(){return{args:Fa(l)}},template:'<Radio v-bind="args" />'})},m={name:"유형",parameters:{controls:{disable:!1},demoPreview:{stack:!0},docs:{description:{story:"기본은 `span.radio_control` + `label.radio_label for`(명시 연결) 순서입니다. 보이는 레이블이 없으면 `label.radio_control`로 input을 암묵 연결합니다. `radio_label-end`는 레이블 → 라디오 순서이며, 기본 너비는 콘텐츠 기준입니다."},source:{code:`<script setup>
...
}`,...(U=(T=b.parameters)==null?void 0:T.docs)==null?void 0:U.source}}};var I,V,N;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: "유형",
  parameters: {
    controls: {
      disable: false
...
}`,...(N=(V=m.parameters)==null?void 0:V.docs)==null?void 0:N.source}}};var W,O,X;C.parameters={...C.parameters,docs:{...(W=C.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: "레이블 뒤",
  parameters: {
    controls: {
      disable: false
...
}`,...(X=(O=C.parameters)==null?void 0:O.docs)==null?void 0:X.source}}};var $,j,J;_.parameters={..._.parameters,docs:{...($=_.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "기본",
  parameters: {
    controls: {
      disable: false
...
}`,...(J=(j=_.parameters)==null?void 0:j.docs)==null?void 0:J.source}}};var G,H,q;v.parameters={...v.parameters,docs:{...(G=v.parameters)==null?void 0:G.docs,source:{originalSource:`{
  name: "단독 사용",
  parameters: {
    controls: {
      disable: false
