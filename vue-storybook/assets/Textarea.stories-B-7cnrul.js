import{_ as e}from"./Textarea-BQDkYif5.js";import{_ as a}from"./Button-C3SXv-sJ.js";import{_ as t}from"./FormLayout-CRfgE2Bq.js";import{_ as r}from"./Input-CACUek-A.js";import"./vue.esm-bundler-BaZlnz8B.js";import"./useDemoCode-B9b0dRAo.js";import"./useRipple-oORGvIsP.js";import"./Icon-D97OEunV.js";const Q=[{key:"name",label:"Prop"},{key:"type",label:"타입"},{key:"default",label:"기본값"},{key:"description",label:"설명"}],U=[{name:"model-value",type:"string",default:"—",description:"v-model 바인딩 값"},{name:"rows",type:"number | string",default:"3",description:"textarea rows 속성"},{name:"size",type:"'sm' | 'md' | 'lg'",default:"md",description:"textarea_sm · textarea_lg"},{name:"placeholder",type:"string",default:"—",description:"placeholder 속성"},{name:"disabled",type:"boolean",default:"false",description:"비활성"},{name:"error",type:"boolean",default:"false",description:"오류 상태 (is-error)"},{name:"block",type:"boolean",default:"false",description:"부모 너비 100% (textarea_block)"}],X=[{key:"name",label:"슬롯"},{key:"description",label:"설명"}],Y=[{name:"default",description:"초기 텍스트 (model-value 대체)"}],Z=[{key:"name",label:"클래스"},{key:"description",label:"설명"}],ee=[{name:"textarea",description:"텍스트영역 루트"},{name:"textarea_sm · textarea_lg · textarea_block",description:"크기·너비"},{name:"is-error · is-disabled",description:"상태"}],ae=[{key:"name",label:"이벤트"},{key:"description",label:"설명"}],te=[{name:"update:modelValue",description:"입력 값 변경 시 (v-model)"}],re=[{title:"API · Props",tables:[{columns:Q,rows:U,codeColumn:"name"}]},{title:"API · Slots",tables:[{columns:X,rows:Y,codeColumn:"name"}]},{title:"API · Events",tables:[{columns:ae,rows:te,codeColumn:"name"}]},{title:"클래스 · 속성",description:"Vue 컴포넌트가 렌더하는 OOCSS 클래스입니다. HTML 마크업으로 직접 작성할 때 동일하게 조합합니다.",tables:[{columns:Z,rows:ee,codeColumn:"name"}]}],me={title:"Components/폼/Textarea",id:"components-textarea",component:e,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],type:{name:"enum",summary:"'sm' | 'md' | 'lg'"}},disabled:{control:"boolean",type:{name:"boolean",summary:"boolean"}},error:{control:"boolean",type:{name:"boolean",summary:"boolean"}},placeholder:{control:"text",type:{name:"string",summary:"string"}},block:{control:"boolean",type:{name:"boolean",summary:"boolean"}},modelValue:{control:"text",type:{name:"string",summary:"string"}}},parameters:{layout:"padded",apiSections:re}},l={args:{size:"md",disabled:!1,error:!1,placeholder:"입력하세요",block:!1,rows:3,modelValue:""},render:N=>({components:{Textarea:e},setup(){return{args:N}},template:'<Textarea v-bind="args" />'})},u={name:"기본",parameters:{demoPreview:{stack:!1},docs:{description:{story:"레이블과 힌트 텍스트가 포함된 폼 필드입니다."},source:{code:`<script setup>
...
</template>`,language:"vue"}}},render:()=>({components:{Textarea:e,Button:a,FormLayout:t,Input:r},template:`<div class="form_field">
      <label class="form_field-label" for="textarea-bio">자기소개</label>
      <Textarea id="textarea-bio" :rows="4" placeholder="간단한 자기소개를 입력하세요" />
      <p class="form_field-hint">500자 이내로 작성해 주세요.</p>
    </div>`})},s={name:"단독 사용",parameters:{demoPreview:{stack:!0},docs:{description:{story:"form_field 없이 textarea만 사용할 수 있습니다. 메모·댓글 입력 등 간단한 다행 입력에 적합합니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
</template>`,language:"vue"}}},render:()=>({components:{Textarea:e,Button:a,FormLayout:t,Input:r},template:`<Textarea :rows="3" placeholder="플레이스홀더" />
    <Textarea :rows="3" model-value="입력된 내용이 여기에 표시됩니다." />
    <Textarea :rows="3" placeholder="비활성" disabled />`})},n={name:"크기",parameters:{demoPreview:{stack:!0},docs:{description:{story:"textarea_sm · textarea(기본) · textarea_lg로 padding·font-size를 조절합니다. 너비와는 별개이며 textarea_fit 등과 자유롭게 조합할 수 있습니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <div class="form_field">
      <label class="form_field-label" for="textarea-size-lg">Large</label>
      <Textarea id="textarea-size-lg" size="lg" :rows="3" placeholder="textarea_lg" />
    </div>`})},o={name:"너비",parameters:{demoPreview:{stack:!0},docs:{description:{story:"크기와 독립적으로 너비를 제어합니다. 기본은 부모 100%, textarea_fit · form_field_fit으로 --input-max-width(320px)까지 제한합니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
<template>
  ...
  <Textarea class="textarea_fit" :rows="3" placeholder="textarea_fit 단독 — 최대 320px" />
    ...
    <Textarea class="textarea_fit" :rows="3" placeholder="textarea_fit 단독 — 최대 320px" />`})},i={name:"행 수",parameters:{demoPreview:{stack:!0},docs:{description:{story:"HTML rows 속성으로 초기 높이를 지정합니다. 리사이즈가 허용된 경우 사용자가 높이를 조절할 수 있습니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <div class="form_field">
      <label class="form_field-label" for="textarea-rows-8">8행</label>
      <Textarea id="textarea-rows-8" :rows="8" placeholder='rows="8" — 긴 본문용' />
    </div>`})},d={name:"리사이즈",parameters:{demoPreview:{stack:!0},docs:{description:{story:"textarea_resize_* 클래스로 사용자 리사이즈 동작을 제어합니다. 기본값은 리사이즈 없음(resize: none)입니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <div class="form_field">
      <label class="form_field-label" for="textarea-resize-both">양방향</label>
      <Textarea id="textarea-resize-both" class="textarea_resize_both" :rows="3" placeholder="textarea_resize_both" />
    </div>`})},c={name:"필수 필드",parameters:{demoPreview:{stack:!1},docs:{description:{story:"required 속성과 form_field-required로 필수 입력을 표시합니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
<template>
  ...
  <div class="form_field form_field_fit">
    ...
    <div class="form_field form_field_fit">
      ...
      <p class="form_field-hint" id="textarea-count-fit-hint">200자 이내로 작성해 주세요.</p>
    </div>`})},C={name:"상태",parameters:{demoPreview:{stack:!0},docs:{description:{story:"disabled · readonly · is-error · is-success로 입력 상태를 표현합니다. 오류·성공 메시지는 색상만으로 전달하지 않고 텍스트와 aria 속성을 함께 사용합니다."},source:{code:`<script setup>
import Textarea from '@uxkm/ui/components/Textarea.vue';
<\/script>
...
<template>
  ...
  <div class="form_field">
    ...
    <div class="form_field">
      ...
      <Textarea id="textarea-state-error" :rows="3" error model-value="짧음" aria-describedby="textarea-state-error-msg" />
      <p class="form_field-error" id="textarea-state-error-msg" role="alert">10자 이상 입력해 주세요.</p>
    </div>`})},x={name:"조합 예시",parameters:{demoPreview:{stack:!0},docs:{description:{story:"문의 폼에서 필수 입력·글자 수 안내·유효성 피드백을 조합한 예시입니다. aria-invalid · aria-describedby · maxlength로 접근성을 보완합니다."},source:{code:`<script setup>
...
<template>
  <FormLayout layout="vertical" compact novalidate aria-labelledby="example-heading">
...
</template>`,language:"vue"}}},render:()=>({components:{Textarea:e,Button:a,FormLayout:t,Input:r},template:`<FormLayout layout="vertical" compact novalidate aria-labelledby="example-heading">
      <div class="form_field">
        <label class="form_field-label" for="textarea-ex-subject">
          제목<span class="form_field-required" aria-hidden="true">*</span>
        </label>
    ...
    </FormLayout>`})};var f,p,_;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    size: "md",
    disabled: false,
    error: false,
...
}`,...(_=(p=l.parameters)==null?void 0:p.docs)==null?void 0:_.source}}};var b,B,v;u.parameters={...u.parameters,docs:{...(b=u.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: "기본",
  parameters: {
    demoPreview: {
      stack: false
...
}`,...(v=(B=u.parameters)==null?void 0:B.docs)==null?void 0:v.source}}};var h,w,D;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: "단독 사용",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(D=(w=s.parameters)==null?void 0:w.docs)==null?void 0:D.source}}};var A,T,y;n.parameters={...n.parameters,docs:{...(A=n.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: "크기",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(y=(T=n.parameters)==null?void 0:T.docs)==null?void 0:y.source}}};var z,g,E;o.parameters={...o.parameters,docs:{...(z=o.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: "너비",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(E=(g=o.parameters)==null?void 0:g.docs)==null?void 0:E.source}}};var F,q,k;i.parameters={...i.parameters,docs:{...(F=i.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: "행 수",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(k=(q=i.parameters)==null?void 0:q.docs)==null?void 0:k.source}}};var L,I,S;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: "리사이즈",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(S=(I=d.parameters)==null?void 0:I.docs)==null?void 0:S.source}}};var P,j,M;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: "필수 필드",
  parameters: {
    demoPreview: {
      stack: false
...
}`,...(M=(j=c.parameters)==null?void 0:j.docs)==null?void 0:M.source}}};var R,V,H;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: "글자 수 카운터",
  parameters: {
    demoPreview: {
      stack: true
    ...
    docs: {
      description: {
        story: "<code>textarea_wrap textarea_show-count</code>로 textarea 우측 하단에 현재 글자 수를 표시합니다. <code>maxlength</code>와 함께 사용하면 <code>0/200</code> 형식으로 최대 글자 수를 함께 보여 줍니다. 카운터를 사용할 때는 <code>form_field-hint</code>로 글자 수 안내 문구(예: 200자 이내로 작성해 주세요.)를 함께 제공합니다. 입력 시 스크린 리더에는 <code>textarea_count_announcer</code>가 <code>role=&quot;status&quot;</code> · <code>aria-live=&quot;polite&quot;</code>로 현재·최대 글자 수를 음성 안내합니다."
      },
      source: {
        code: "<script setup>\\nimport Textarea from '@uxkm/ui/components/Textarea.vue';\\n<\/script>\\n\\n<template>\\n  <div class=\\"form_field\\">\\n    <label class=\\"form_field-label\\" for=\\"textarea-count-basic\\">메모</label>\\n    <div class=\\"textarea_wrap textarea_show-count\\">\\n      <Textarea\\n      id=\\"textarea-count-basic\\"\\n      :rows=\\"4\\"\\n      maxlength=\\"200\\"\\n      placeholder=\\"내용을 입력하세요\\"\\n      aria-describedby=\\"textarea-count-basic-hint textarea-count-basic-count\\"\\n      />\\n      <span class=\\"textarea_count\\" id=\\"textarea-count-basic-count\\" role=\\"status\\" aria-live=\\"polite\\" aria-atomic=\\"true\\">\\n        <span class=\\"textarea_count_visual\\" aria-hidden=\\"true\\">0/200</span>\\n        <span class=\\"textarea_count_announcer\\">0자 입력, 최대 200자</span>\\n      </span>\\n    </div>\\n    <p class=\\"form_field-hint\\" id=\\"textarea-count-basic-hint\\">200자 이내로 작성해 주세요.</p>\\n  </div>\\n  <div class=\\"form_field\\">\\n    <label class=\\"form_field-label\\" for=\\"textarea-count-sm\\">Small + 카운터</label>\\n    <div class=\\"textarea_wrap textarea_show-count\\">\\n      <Textarea\\n      id=\\"textarea-count-sm\\"\\n      size=\\"sm\\"\\n      :rows=\\"3\\"\\n      maxlength=\\"100\\"\\n      placeholder=\\"textarea_sm\\"\\n      aria-describedby=\\"textarea-count-sm-hint textarea-count-sm-count\\"\\n      />\\n      <span class=\\"textarea_count\\" id=\\"textarea-count-sm-count\\" role=\\"status\\" aria-live=\\"polite\\" aria-atomic=\\"true\\">\\n        <span class=\\"textarea_count_visual\\" aria-hidden=\\"true\\">0/100</span>\\n        <span class=\\"textarea_count_announcer\\">0자 입력, 최대 100자</span>\\n      </span>\\n    </div>\\n    <p class=\\"form_field-hint\\" id=\\"textarea-count-sm-hint\\">100자 이내로 작성해 주세요.</p>\\n  </div>\\n  <div class=\\"form_field form_field_fit\\">\\n    <label class=\\"form_field-label\\" for=\\"textarea-count-fit\\">제한 너비 + 카운터</label>\\n    <div class=\\"textarea_wrap textarea_show-count textarea_wrap_fit\\">\\n      <Textarea\\n      id=\\"textarea-count-fit\\"\\n      :rows=\\"3\\"\\n      maxlength=\\"200\\"\\n      placeholder=\\"textarea_wrap_fit\\"\\n      model-value=\\"입력된 내용이 있습니다.\\"\\n      aria-describedby=\\"textarea-count-fit-hint textarea-count-fit-count\\"\\n      />\\n      <span class=\\"textarea_count\\" id=\\"textarea-count-fit-count\\" role=\\"status\\" aria-live=\\"polite\\" aria-atomic=\\"true\\">\\n        <span class=\\"textarea_count_visual\\" aria-hidden=\\"true\\">12/200</span>\\n        <span class=\\"textarea_count_announcer\\">12자 입력, 최대 200자</span>\\n      </span>\\n    </div>\\n    <p class=\\"form_field-hint\\" id=\\"textarea-count-fit-hint\\">200자 이내로 작성해 주세요.</p>\\n  </div>\\n</template>",
        language: 'vue'
...
}`,...(H=(V=m.parameters)==null?void 0:V.docs)==null?void 0:H.source}}};var O,$,W;C.parameters={...C.parameters,docs:{...(O=C.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: "상태",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(W=($=C.parameters)==null?void 0:$.docs)==null?void 0:W.source}}};var G,J,K;x.parameters={...x.parameters,docs:{...(G=x.parameters)==null?void 0:G.docs,source:{originalSource:`{
  name: "조합 예시",
  parameters: {
    demoPreview: {
      stack: true
...
}`,...(K=(J=x.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const Ce=["Playground","Basic","Standalone","Size","Width","Rows","Resize","Required","Count","State","Example"];export{u as Basic,m as Count,x as Example,l as Playground,c as Required,d as Resize,i as Rows,n as Size,s as Standalone,C as State,o as Width,Ce as __namedExportsOrder,me as default};
