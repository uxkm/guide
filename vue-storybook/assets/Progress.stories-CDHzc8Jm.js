...
</template>`,language:"vue"}}},args:{percent:0,status:"success",size:"md",showInfo:!1,label:"라벨",color:"primary",striped:!1,animated:!1,indeterminate:!1,inside:!1,block:!1,ariaLabel:"진행률"},render:a(()=>({components:{Progress:r},template:`<Progress :percent="25" inside />
      <Progress :percent="80" inside size="lg" color="success" />`}))},w={name:"원형",parameters:{controls:{disable:!1},demoPreview:{stack:!1},docs:{description:{story:'`progress_circle`로 원형 진행률을 표시합니다. `style="--progress-percent: …"`로 채움 비율을 지정합니다.'},source:{code:`<script setup>
