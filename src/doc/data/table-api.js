...
export const tableProps = [
  ...
  { name: 'sticky-top', type: 'boolean', default: 'false', description: 'thead 상단 고정 (table_sticky-top)' },
  { name: 'sticky-left', type: 'boolean', default: 'false', description: '좌측 열 고정 (table_sticky-left)' },
  {
    name: 'sticky-cols',
    type: '1 | 2 | 3 | 4',
    default: '1',
    description: '좌측 고정 열 개수 (table_sticky-cols-n). sticky-left와 함께 사용',
  },
  {
    name: 'sticky-left-offsets',
