...
export const flexProps = [
  ...
  { name: 'itemSpan', type: 'number | string', default: '—', description: '모든 자식의 12단위 너비 (flex_items-span-*)' },
  ...
  { name: 'autoFit', type: 'boolean', default: 'false', description: '최소 너비를 기준으로 항목 자동 배치' },
];
...
export const flexSlots = [
  { name: 'children', description: 'Flex 자식 콘텐츠 (Vue default 슬롯 대응)' },
];
...
export const flexItemProps = [
  {
    ...
    type: 'string',
    default: `'div'`,
    description: 'FlexItem이 렌더링할 HTML 요소 (예: header, aside, section, footer)',
  },
  ...
  { name: 'fit', type: 'boolean', default: 'false', description: '콘텐츠 너비 유지 (flex_fit)' },
  {
    ...
    default: '—',
    description: '해당 항목의 교차축 정렬',
  },
  { name: 'order', type: '1–12', default: '—', description: '시각적 배치 순서' },
];

export const flexItemSlotColumns = flexSlotColumns;
export const flexItemSlots = [
  { name: 'children', description: 'Flex 항목 내부 콘텐츠 (Vue default 슬롯 대응)' },
];
...
export const flexClasses = [
  ...
  {
    name: 'flex_items-span-* · flex_items-span-md-* · flex_items-span-lg-*',
    description: '모든 자식의 12단위 너비',
  },
...
export const flexTokens = [
  ...
  {
    name: '--flex-gap-sm · --flex-gap-lg',
    default: 'var(--space-sm) · var(--space-lg)',
    description: '간격 변형',
  },
