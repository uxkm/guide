...
export const radiusTokens = [
  ...
  { name: '--radius-md', default: '10px', usage: '코드 블록, 프리뷰 영역' },
...
export const textSizeTokens = [
  ...
  { name: '--text-size-base', default: '0.875rem', usage: '본문·버튼 기본값 (별도 유틸리티 클래스 없음)' },
...
export const interactionTokens = [
  { name: '--ripple-color', default: 'currentColor', usage: '클릭 파장 색상' },
  { name: '--ripple-opacity', default: '0.18', usage: '클릭 파장 불투명도' },
  { name: '--ripple-duration', default: '550ms', usage: '클릭 파장 지속 시간' },
  { name: '--ripple-easing', default: 'cubic-bezier(0, 0, 0.2, 1)', usage: '클릭 파장 가속도' },
  { name: '--focus-outline-width', default: '2px', usage: '키보드 포커스 링 두께' },
  { name: '--focus-outline-offset', default: '2px', usage: '포커스 링과 요소 사이 간격' },
  { name: '--focus-shadow-width', default: '3px', usage: '그림자형 포커스 링 너비' },
];
...
export const surfaceColorTokens = [
  ...
  { name: '--color-header-bg', role: '반투명 헤더 배경', usage: '고정 가이드 헤더' },
  { name: '--color-overlay', role: '오버레이 배경', usage: '모달·드로어 뒤 딤드 영역' },
  { name: '--shadow-sm', role: '낮은 표면 그림자', usage: '카드, 툴팁, 캘린더' },
  { name: '--shadow-md', role: '높은 표면 그림자', usage: '강조 패널, 떠 있는 콘텐츠' },
];

export const semanticColorTokens = [
  { name: '--color-accent', role: 'Primary · 채움', usage: '.color_primary 채움 버튼, 활성 탭' },
  { name: '--color-accent-hover', role: 'Primary · 채움 호버', usage: '채움 버튼 호버·활성 상태' },
  { name: '--color-accent-text', role: 'Primary · 텍스트', usage: '링크, 고스트 버튼, 강조 텍스트' },
  { name: '--color-accent-text-hover', role: 'Primary · 텍스트 호버', usage: '링크·텍스트 버튼 호버' },
  { name: '--color-accent-muted', role: 'Primary · 약한 배경', usage: '배지, 선택 영역, 강조 배경' },
  ...
  { name: '--color-success-hover', role: 'Success · 채움 호버', usage: '성공 버튼 호버·활성 상태' },
  { name: '--color-success-text', role: 'Success · 텍스트', usage: '성공 메시지, 체크 아이콘' },
  { name: '--color-success-text-hover', role: 'Success · 텍스트 호버', usage: '성공 링크·텍스트 버튼 호버' },
  { name: '--color-danger', role: 'Danger · 채움', usage: '.color_danger 삭제·오류 강조' },
  { name: '--color-danger-hover', role: 'Danger · 채움 호버', usage: '위험 버튼 호버·활성 상태' },
  { name: '--color-danger-text', role: 'Danger · 텍스트', usage: '오류 메시지, 위험 링크' },
  { name: '--color-danger-text-hover', role: 'Danger · 텍스트 호버', usage: '위험 링크·텍스트 버튼 호버' },
  { name: '--color-warning', role: 'Warning · 채움', usage: '.color_warning 경고 배지·버튼' },
  { name: '--color-warning-hover', role: 'Warning · 채움 호버', usage: '경고 버튼 호버·활성 상태' },
  { name: '--color-warning-text', role: 'Warning · 텍스트', usage: '경고 설명, 주의 문구' },
  { name: '--color-warning-text-hover', role: 'Warning · 텍스트 호버', usage: '경고 링크·텍스트 버튼 호버' },
...
export const scssUsageCode = `// 컴포넌트 SCSS에서 토큰과 헬퍼 참조
@use "../mixins" as *;
