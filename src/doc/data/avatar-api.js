...
export const avatarProps = [
  { name: 'as', type: 'string | Component', default: 'span', description: '루트 요소 또는 커스텀 컴포넌트' },
  { name: 'name', type: 'string', default: '—', description: 'common-icons 키. avatar_icon으로 렌더합니다' },
  { name: 'src', type: 'string | { src: string }', default: '—', description: '이미지 URL 또는 정적 이미지 객체 (avatar_image)' },
  ...
  { name: 'aria-label', type: 'string', default: '—', description: '아이콘·커스텀 아바타의 접근성 라벨' },
];
...
export const avatarSlots = [
  { name: 'default', description: '이미지·아이콘·컴포넌트 등 커스텀 콘텐츠' },
