...
export const alertProps = [
  ...
  { name: 'description', type: 'string', default: '—', description: '본문. children으로 대체' },
  { name: 'closable', type: 'boolean', default: 'false', description: '닫기 버튼 (alert_close)' },
  { name: 'showIcon', type: 'boolean', default: 'true', description: '기본 아이콘 표시' },
...
export const alertChildColumns = [
...
export const alertSlotColumns = alertChildColumns;

/** @deprecated */
export const alertSlots = alertChildren;
...
export const alertEvents = [
  { name: 'onClose', description: '닫기 버튼 클릭 시' },
];
