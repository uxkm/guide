...
<template>
  ...
  <ApiSection heading-id="api-props-heading" title="API · Breadcrumb Props">
    <ApiTable :columns="breadcrumbPropColumns" :rows="breadcrumbProps" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="api-item-props-heading" title="API · BreadcrumbItem Props">
    <ApiTable :columns="breadcrumbItemPropColumns" :rows="breadcrumbItemProps" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="api-slots-heading" title="API · Breadcrumb Slots">
    <ApiTable :columns="breadcrumbSlotColumns" :rows="breadcrumbSlots" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="api-item-slots-heading" title="API · BreadcrumbItem Slots">
    <ApiTable :columns="breadcrumbItemSlotColumns" :rows="breadcrumbItemSlots" code-column="name" />
  </ApiSection>
  ...
  >
    <ApiTable :columns="breadcrumbClassColumns" :rows="breadcrumbClasses" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="tokens-heading" title="디자인 토큰">
    <ApiTable :columns="breadcrumbTokenColumns" :rows="breadcrumbTokens" code-column="name" />
  </ApiSection>
</template>
