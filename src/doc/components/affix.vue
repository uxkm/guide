...
<template>
  ...
  <DemoSection
    ...
    title="앵커 내비게이션"
    description="<code class=&quot;typo_code&quot;>affix_anchor</code> 스킨으로 섹션 앵커 링크를 고정합니다. 긴 문서·설정 페이지의 목차에 적합합니다."
    :code="anchorCode"
  >
    <div class="affix_demo-narrow">
      <div id="affix-scroll-anchor" class="affix_demo-scroll">
  ...
  <ApiSection heading-id="api-props-heading" title="API · Props">
    <ApiTable :columns="affixPropColumns" :rows="affixProps" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="api-slots-heading" title="API · Slots">
    <ApiTable :columns="affixSlotColumns" :rows="affixSlots" code-column="name" />
  </ApiSection>
  ...
  <ApiSection heading-id="api-markup-heading" title="API · 마크업 구조">
    <ApiTable :columns="affixMarkupColumns" :rows="affixMarkup" code-column="name" />
  </ApiSection>
  ...
  >
    <ApiTable :columns="affixClassColumns" :rows="affixClasses" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="tokens-heading" title="디자인 토큰">
    <ApiTable :columns="affixTokenColumns" :rows="affixTokens" code-column="name" />
  </ApiSection>
</template>
