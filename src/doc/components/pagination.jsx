...
const sizeCode = `import Pagination from '@/components/Pagination.jsx';
...
const roundCode = `import Pagination from '@/components/Pagination.jsx';

export function RoundExample() {
  return <Pagination current={7} total={80} pageSize={10} round />;
}`;

const ellipsisCode = `import Pagination from '@/components/Pagination.jsx';

export function EllipsisExample() {
  return <Pagination current={10} total={500} pageSize={10} />;
}`;

const simpleCode = `import Pagination from '@/components/Pagination.jsx';
...
const toolbarCode = `import Pagination from '@/components/Pagination.jsx';
...
const alignCode = `import Pagination from '@/components/Pagination.jsx';
...
const stateCode = `import Pagination from '@/components/Pagination.jsx';
