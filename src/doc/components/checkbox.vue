...
const buttonTypeCode = `<script setup>
import Checkbox from '@/components/Checkbox.vue';
<\/script>
...
const cardTypeCode = `<script setup>
import Checkbox from '@/components/Checkbox.vue';
<\/script>
...
<template>
  ...
  <DemoSection
    heading-id="button-type-heading"
    title="버튼형"
  ...
  <ApiSection heading-id="api-props-heading" title="API · Props">
    <ApiTable :columns="checkboxPropColumns" :rows="checkboxProps" code-column="name" />
  </ApiSection>
  ...
  >
    <ApiTable :columns="checkboxClassColumns" :rows="checkboxClasses" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="tokens-heading" title="디자인 토큰">
    <ApiTable :columns="checkboxTokenColumns" :rows="checkboxTokens" code-column="name" />
  </ApiSection>
</template>
