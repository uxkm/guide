      ...
      <div className="page_intro">
        ...
        >
          <Timeline card>
            ...
            <TimelineItem color="info" time="2024-06-25 11:30" datetime="2024-06-25" title="문서 업데이트 예정" description="Button · Timeline 컴포넌트 가이드가 추가됩니다." meta={(
              <>
        ...
        <ApiSection headingId="api-slots-heading" title="API · Timeline Slots">
          <ApiTable columns={timelineSlotColumns} rows={timelineSlots} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-item-slots-heading" title="API · TimelineItem Slots">
          <ApiTable columns={timelineSlotColumns} rows={timelineItemSlots} codeColumn="name" />
        </ApiSection>
