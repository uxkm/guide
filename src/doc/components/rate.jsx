    ...
    <>
      <div className="page_intro">
        ...
        >
          ...
          <Rate legend="aria-label — 단독" name="rate-type-aria" ariaLabel="별점 5점 만점" />
        </DemoSection>
        ...
        >
          ...
          <p className="rate_hint">별 왼쪽을 클릭하면 반별, 오른쪽을 클릭하면 정수 점수가 선택됩니다.</p>
        </DemoSection>
        ...
        >
          <FormLayout layout="vertical" fit>
            <div className="form_field">
              <span className="form_field-label" id="rate-form-label">상품 만족도</span>
              <Rate name="rate-form" ariaLabelledby="rate-form-label" />
