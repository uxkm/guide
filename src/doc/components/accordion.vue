...
<template>
  ...
  <ApiSection heading-id="api-item-props-heading" title="API · AccordionItem Props">
  ...
  >
    <ApiTable :columns="accordionClassColumns" :rows="accordionClasses" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="tokens-heading" title="디자인 토큰">
    <ApiTable :columns="accordionTokenColumns" :rows="accordionTokens" code-column="name" />
  </ApiSection>
</template>
