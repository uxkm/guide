    ...
    <>
      <div className="page_intro">
        ...
        <DemoSection
          ...
          title="상태 요약"
          description="각 상태 클래스의 시각적 의미입니다. 현재 단계에는 <code class=&quot;typo_code&quot;>aria-current=&quot;step&quot;</code>을 함께 지정합니다."
          stack
        >
        ...
        <ApiSection headingId="api-slots-heading" title="API · Slots">
          <ApiTable columns={stepsSlotColumns} rows={stepsSlots} codeColumn="name" />
        </ApiSection>
