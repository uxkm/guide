  ...
  return (
    <>
      <div className="page_intro">
        <h1>Back Top</h1>
        <p className="lead">긴 콘텐츠를 스크롤한 뒤 페이지(또는 지정 영역) 맨 위로 빠르게 이동하는 플로팅 버튼입니다. <code className="typo_code">data-target</code>으로 스크롤 컨테이너를 지정하고, <code className="typo_code">data-visibility-height</code>으로 표시 임계값을 조절할 수 있습니다.</p>
      </div>
        ...
        <DemoSection
          ...
          title="크기"
          description="<code class=&quot;typo_code&quot;>back_top_sm</code> · <code class=&quot;typo_code&quot;>back_top_lg</code> 클래스로 버튼 크기를 조절합니다."
          stack
        >
          <div className="back_top_demo-wrap">
        ...
        >
          <p style={{ margin: '0', fontSize: 'var(--text-size-sm)', color: 'var(--color-text-muted)' }}>페이지를 충분히 스크롤한 뒤 우측 하단 플로팅 버튼을 확인하세요. 클릭하면 페이지 최상단으로 부드럽게 이동합니다.</p>
        ...
        <ApiSection headingId="api-slots-heading" title="API · Slots">
          <ApiTable columns={backTopSlotColumns} rows={backTopSlots} codeColumn="name" />
        </ApiSection>
