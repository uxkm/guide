...
import CollapseGroup from '@/components/CollapseGroup.jsx';
  ...
  return (
    <>
      <div className="page_intro">
        ...
        >
          <CollapseExternal triggerLabel="주문 상세 보기" narrow lead={(
              <>
      ...
      <List
        ...
        <DemoSection
          ...
          title="보조 텍스트"
          description="extra 슬롯으로 트리거 오른쪽에 메타 정보를 표시합니다."
        >
          <CollapseGroup narrow>
            <CollapsePanel label="진행 중" open content="현재 처리 중인 요청 3건입니다." extraCode="3건" extra={(
              <>
              3건
              </>
            )} />
        ...
        >
          <div className="demo_preview-block">
            <h3 className="typo_overline">패널 그룹</h3>
            <CollapseGroup narrow effect="slide">
              <CollapsePanel
                label="배송 정보"
                open
        ...
        <ApiSection headingId="api-external-slots-heading" title="API · CollapseExternal Slots">
          <ApiTable columns={collapseSlotColumns} rows={collapseExternalSlots} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-group-props-heading" title="API · CollapseGroup Props">
          <ApiTable columns={collapseGroupPropColumns} rows={collapseGroupProps} codeColumn="name" />
        </ApiSection>
        ...
        <ApiSection headingId="api-panel-slots-heading" title="API · CollapsePanel Slots">
          <ApiTable columns={collapseSlotColumns} rows={collapsePanelSlots} codeColumn="name" />
        </ApiSection>
