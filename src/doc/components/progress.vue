...
<template>
  ...
  <DemoSection
    heading-id="indeterminate-heading"
    title="불확정"
  ...
  <ApiSection heading-id="api-props-heading" title="API · Progress Props">
    <ApiTable :columns="progressPropColumns" :rows="progressProps" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="api-circle-props-heading" title="API · ProgressCircle Props">
    <ApiTable :columns="progressCirclePropColumns" :rows="progressCircleProps" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="api-slots-heading" title="API · Slots">
    <ApiTable :columns="progressSlotColumns" :rows="progressSlots" code-column="name" />
  </ApiSection>
  ...
  >
    <ApiTable :columns="progressClassColumns" :rows="progressClasses" code-column="name" />
    <p class="form_field-hint" style="margin-top: var(--space-md);">
      진행률은 <code class="typo_code">progress_bar</code>의 <code class="typo_code">width</code> 또는 JS로 업데이트합니다.
      시각적 값과 <code class="typo_code">aria-valuenow</code>를 함께 맞춰 주세요.
    </p>
  </ApiSection>

  <ApiSection heading-id="tokens-heading" title="디자인 토큰">
    <ApiTable :columns="progressTokenColumns" :rows="progressTokens" code-column="name" />
  </ApiSection>
</template>
