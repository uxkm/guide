  ...
  return (
    <>
      <div className="page_intro">
        ...
        >
          <Tag color="primary" label="Design" icon={(
              <>
          ...
          <Tag variant="outline" color="success" label="Verified" icon={(
              <>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Tag variant="solid" color="danger" label="Error" icon={(
              <>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Tag size="sm" round color="default" label="User" icon={(
              <>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        >
          ...
          <TagGroup tight>
            <Tag closable round color="success" label="Frontend" closeLabel="Frontend 태그 제거" icon={(
              <>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                          <path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" />
                        </svg>
        ...
        >
          <Tag add round label="태그 추가" icon={(
              <>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        >
          ...
          <Tag href="#" round variant="outline" color="success" label="외부 링크" icon={(
              <>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        >
          ...
          <div>
            <p className="color_muted size_sm" style={{ marginBottom: '0.5rem' }}>선택된 기술 스택</p>
            <TagGroup tight>
        ...
        <ApiSection headingId="api-props-heading" title="API · Tag Props">
          ...
          <p className="form_field-hint" style={{ marginTop: 'var(--space-md)' }}>
            <code className="typo_code">closable</code> 태그는 <code className="typo_code">@close</code> 이벤트를 발생시킵니다.
          </p>
        </ApiSection>
        ...
        <ApiSection headingId="api-slots-heading" title="API · Tag Slots">
          <ApiTable columns={tagSlotColumns} rows={tagSlots} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-group-slots-heading" title="API · TagGroup Slots">
