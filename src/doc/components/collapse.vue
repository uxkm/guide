...
<template>
  ...
  <DemoSection
    ...
    stack
  >
    <CollapseGroup effect="slide" narrow>
      <CollapsePanel
        label="배송 정보"
        open
    ...
    <CollapseExternal trigger-label="상세 보기" effect="slide" narrow>
  ...
  <ApiSection heading-id="api-external-slots-heading" title="API · CollapseExternal Slots">
    <ApiTable :columns="collapseSlotColumns" :rows="collapseExternalSlots" code-column="name" />
  </ApiSection>

  <ApiSection heading-id="api-group-props-heading" title="API · CollapseGroup Props">
    <ApiTable :columns="collapseGroupPropColumns" :rows="collapseGroupProps" code-column="name" />
  </ApiSection>
  ...
  <ApiSection heading-id="api-panel-slots-heading" title="API · CollapsePanel Slots">
    <ApiTable :columns="collapseSlotColumns" :rows="collapsePanelSlots" code-column="name" />
  </ApiSection>
