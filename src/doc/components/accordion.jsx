    ...
    <>
      <div className="page_intro">
        ...
        <DemoSection
          ...
          title="기본"
          description="accordion_bordered가 기본 스킨입니다. 한 번에 하나의 패널만 열리며(단일 모드), 화살표 키로 트리거 간 포커스를 이동할 수 있습니다."
        >
          <Accordion narrow>
            <AccordionItem
              label="배송은 얼마나 걸리나요?"
        ...
        <DemoSection
          ...
          title="보조 정보"
          description="extra 슬롯으로 배지·메타 텍스트를 트리거 오른쪽에 배치합니다."
        >
          <Accordion narrow>
            <AccordionItem
              label="미해결 문의"
              ...
              extraCode='<span className="badge badge_count color_danger badge_sm">3</span>'
        ...
        <ApiSection headingId="api-slots-heading" title="API · AccordionItem Slots">
          <ApiTable columns={accordionSlotColumns} rows={accordionItemSlots} codeColumn="name" />
        </ApiSection>
