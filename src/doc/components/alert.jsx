    ...
    <>
      <div className="page_intro">
        ...
        <DemoSection
          ...
          stack
        >
          <Alert color="danger" title="저장 실패" description="변경 사항을 저장하지 못했습니다. 다시 시도해 주세요." actions={(
              <>
          ...
          <Alert color="info" title="이용 약관 변경" description="2026년 3월 1일부터 새 약관이 적용됩니다." actions={(
              <>
              <div className="alert_actions">
        ...
        <DemoSection
          ...
          stack
        >
          <Alert className="alert_banner" color="warning" closable description="시스템 점검으로 일부 기능이 제한될 수 있습니다." />
        </DemoSection>
        ...
        >
          ...
          <form className="form_layout" noValidate>
            ...
            <div className="form_field">
              <label className="form_label" htmlFor="alert-ex-email">이메일</label>
        ...
        <ApiSection headingId="api-slots-heading" title="API · Slots">
          <ApiTable columns={alertSlotColumns} rows={alertSlots} codeColumn="name" />
        </ApiSection>
