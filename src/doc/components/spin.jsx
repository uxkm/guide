  ...
  return (
    <>
      <div className="page_intro">
        <h1>Spin</h1>
        <p className="lead">로딩·처리 중 상태를 표시하는 Spin 컴포넌트입니다. 인라인 스피너, 설명 텍스트, 컨테이너 오버레이를 지원하며 <code className="typo_code">role="status"</code> · <code className="typo_code">aria-busy</code> · <code className="typo_code">aria-label</code>로 접근성을 보장합니다.</p>
      </div>
        ...
        >
          ...
          <Button variant="filled" color="primary" loading disabled ariaBusy="true" label="제출 중…" />
        </DemoSection>
        ...
        <DemoSection
          ...
          stack
        >
          <SpinWrap block loading tip="데이터 로딩 중…" ariaLabel="데이터 로딩 중" style={{ maxWidth: 'var(--input-max-width)' }}>
            <Card variant="shadow">
          ...
          <SpinWrap block blur loading ariaLabel="처리 중" style={{ maxWidth: 'var(--input-max-width)', marginTop: 'var(--space-md)' }}>
            <Card variant="shadow">
              <CardHeader title="블러 효과" />
              <CardBody>
                <p><code className="typo_code">spin_wrap-blur</code>를 함께 사용하면 콘텐츠에 블러가 적용됩니다.</p>
              </CardBody>
            </Card>
          </SpinWrap>
        </DemoSection>
        ...
        <section className="section" aria-labelledby="usage-heading">
          <h2 id="usage-heading">마크업</h2>
            <p>독립 스피너는 <code className="typo_code">role="status"</code>와 <code className="typo_code">aria-busy="true"</code>를 지정합니다. 오버레이는 <code className="typo_code">spin_wrap</code>에 <code className="typo_code">is-loading</code>을 토글합니다.</p>
        ...
        <ApiSection headingId="api-slots-heading" title="API · Spin Slots">
          <ApiTable columns={spinSlotColumns} rows={spinSlots} codeColumn="name" />
        </ApiSection>

        <ApiSection headingId="api-wrap-slots-heading" title="API · SpinWrap Slots">
          <ApiTable columns={spinWrapSlotColumns} rows={spinWrapSlots} codeColumn="name" />
        </ApiSection>
        ...
        >
          ...
          <p className="form_field-hint" style={{ marginTop: 'var(--space-md)' }}>
            버튼 내부 로딩은 <code className="typo_code">.btn.is-loading</code> + <code className="typo_code">.btn_spinner</code>를 사용합니다.
            독립 스피너·영역 오버레이는 이 Spin 컴포넌트를 사용하세요.
          </p>
        </ApiSection>
